...
.method public static addRoutesToNetwork(Landroid/net/INetd;ILjava/lang/String;Ljava/util/List;)V
    ...
    .line 181
    .local p3, "routes":Ljava/util/List;, "Ljava/util/List<Landroid/net/RouteInfo;>;"
    ...
    invoke-direct {v1, v2, v3, p2, v4}, Landroid/net/RouteInfo;-><init>(Landroid/net/IpPrefix;Ljava/net/InetAddress;Ljava/lang/String;I)V

    invoke-static {p0, v0, p1, v1}, Lcom/android/net/module/util/NetdUtils;->modifyRoute(Landroid/net/INetd;Lcom/android/net/module/util/NetdUtils$ModifyOperation;ILandroid/net/RouteInfo;)V
...
.method public static removeRoutesFromNetwork(Landroid/net/INetd;ILjava/util/List;)I
    ...
    invoke-static {p0, v3, p1, v2}, Lcom/android/net/module/util/NetdUtils;->modifyRoute(Landroid/net/INetd;Lcom/android/net/module/util/NetdUtils$ModifyOperation;ILandroid/net/RouteInfo;)V
    :try_end_0
