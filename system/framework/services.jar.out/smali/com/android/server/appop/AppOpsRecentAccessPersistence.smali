...
.method private readAttributionOp(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v2, v5, v6, v7}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeLong(Ljava/lang/String;Ljava/lang/String;J)J
    ...
    .line 246
    .local v5, "proxyPkg":Ljava/lang/String;
    ...
    .line 249
    .local v7, "proxyAttributionTag":Ljava/lang/String;
    move-wide/from16 v18, v3

    .end local v3    # "key":J
    .local v18, "key":J
    const-string/jumbo v3, "pdv"
    ...
    .end local v5    # "proxyPkg":Ljava/lang/String;
    .end local v10    # "rejectTime":J
    .local v11, "proxyPkg":Ljava/lang/String;
    .local v20, "rejectTime":J
    invoke-virtual {v3, v3, v4, v1}, Lcom/android/server/appop/AppOpsService$Op;->getOrCreateAttribution(Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;Ljava/lang/String;)Lcom/android/server/appop/AttributedOp;

    move-result-object v5

    .line 257
    .local v5, "attributedOp":Lcom/android/server/appop/AttributedOp;
    cmp-long v10, v8, v16
    ...
    .end local v7    # "proxyAttributionTag":Ljava/lang/String;
    .end local v20    # "rejectTime":J
    .local v0, "rejectTime":J
    .local v2, "deviceId":Ljava/lang/String;
    .local v6, "accessTime":J
    .local v8, "accessDuration":J
    .local v10, "proxyUid":I
    .local v12, "proxyAttributionTag":Ljava/lang/String;
    .local v13, "proxyDeviceId":Ljava/lang/String;
    ...
    .end local v10    # "proxyUid":I
    .end local v13    # "proxyDeviceId":Ljava/lang/String;
    .restart local v1    # "deviceId":Ljava/lang/String;
    .local v2, "proxyDeviceId":Ljava/lang/String;
    .local v6, "proxyUid":I
    .restart local v7    # "proxyAttributionTag":Ljava/lang/String;
    .local v8, "accessTime":J
    .local v12, "accessDuration":J
    ...
    .local v6, "accessTime":J
    .local v8, "accessDuration":J
    .restart local v10    # "proxyUid":I
    .local v12, "proxyAttributionTag":Ljava/lang/String;
    .restart local v13    # "proxyDeviceId":Ljava/lang/String;
    :goto_0
    cmp-long v16, v0, v16
    ...
    .line 262
    invoke-virtual {v5, v0, v1, v14, v15}, Lcom/android/server/appop/AttributedOp;->rejected(JII)V
...
.method private readOp(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$UidState;Ljava/lang/String;)V
    ...
    .end local p2    # "uidState":Lcom/android/server/appop/AppOpsService$UidState;
    ...
    .line 217
    .local p3, "tagName":Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v2, v1}, Lcom/android/server/appop/AppOpsRecentAccessPersistence;->readAttributionOp(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/appop/AppOpsService$Op;Ljava/lang/String;)V
    ...
    .line 226
    :cond_4
    iget-object p3, v4, Lcom/android/server/appop/AppOpsService$UidState;->pkgOps:Landroid/util/ArrayMap;

    invoke-virtual {p3, v5}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Lcom/android/server/appop/AppOpsService$Ops;

    .line 227
    .local p3, "ops":Lcom/android/server/appop/AppOpsService$Ops;
    if-nez p3, :cond_5
    ...
    invoke-virtual {v1, v5, p3}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private writeDeviceAttributedOps(Lcom/android/modules/utils/TypedXmlSerializer;Lcom/android/server/appop/AppOpsService$Op;)V
    ...
    invoke-interface {v0, v7, v9, v6}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v0, v7, v9, v10, v11}, Lcom/android/modules/utils/TypedXmlSerializer;->attributeLong(Ljava/lang/String;Ljava/lang/String;J)Lorg/xmlpull/v1/XmlSerializer;
