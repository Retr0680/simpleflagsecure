...
.method public getContentCaptureConditions(Ljava/lang/String;Lcom/android/internal/os/IResultReceiver;)V
    ...
    .line 1232
    .end local v2    # "service":Lcom/android/server/contentcapture/ContentCapturePerUserService;
    .local v3, "conditions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/contentcapture/ContentCaptureCondition;>;"
    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1234
    :try_start_1
    invoke-static {v3}, Lcom/android/internal/util/SyncResultReceiver;->bundleFor(Ljava/util/ArrayList;)Landroid/os/Bundle;

    move-result-object v1

    const/4 v2, 0x0

    invoke-interface {p2, v2, v1}, Lcom/android/internal/os/IResultReceiver;->send(ILandroid/os/Bundle;)V
    :try_end_1
    ...
    .line 1232
    .end local v3    # "conditions":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/contentcapture/ContentCaptureCondition;>;"
    :catchall_0
    move-exception v2
...
.method public getServiceComponentName(Lcom/android/internal/os/IResultReceiver;)V
    ...
    .line 1127
    .end local v2    # "service":Lcom/android/server/contentcapture/ContentCapturePerUserService;
    .local v3, "connectedServiceComponentName":Landroid/content/ComponentName;
    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1129
    :try_start_1
    invoke-static {v3}, Lcom/android/internal/util/SyncResultReceiver;->bundleFor(Landroid/os/Parcelable;)Landroid/os/Bundle;
    ...
    .line 1127
    .end local v3    # "connectedServiceComponentName":Landroid/content/ComponentName;
    :catchall_0
    move-exception v2
...
.method public startSession(Landroid/os/IBinder;Landroid/os/IBinder;Landroid/content/ComponentName;IILcom/android/internal/os/IResultReceiver;)V
    ...
    .line 1099
    .local v5, "activityPresentationInfo":Landroid/content/pm/ActivityPresentationInfo;
    iget-object v0, p0, Lcom/android/server/contentcapture/ContentCaptureManagerService$ContentCaptureManagerServiceStub;->this$0:Lcom/android/server/contentcapture/ContentCaptureManagerService;
    ...
    invoke-static {v0, v1}, Lcom/android/server/contentcapture/ContentCaptureManagerService;->access$100(Lcom/android/server/contentcapture/ContentCaptureManagerService;I)Lcom/android/server/infra/AbstractPerUserSystemService;
    ...
    invoke-static {v0, v1}, Lcom/android/server/contentcapture/ContentCaptureManagerService;->-$$Nest$misDefaultServiceLocked(Lcom/android/server/contentcapture/ContentCaptureManagerService;I)Z
    ...
    invoke-static {v0, v3}, Lcom/android/server/contentcapture/ContentCaptureManagerService;->-$$Nest$misCalledByServiceLocked(Lcom/android/server/contentcapture/ContentCaptureManagerService;Ljava/lang/String;)Z
    ...
    :try_start_2
    invoke-static {v9, v0, v3}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/android/server/contentcapture/ContentCapturePerUserService;->startSessionLocked(Landroid/os/IBinder;Landroid/os/IBinder;Landroid/content/pm/ActivityPresentationInfo;IIILcom/android/internal/os/IResultReceiver;)V
