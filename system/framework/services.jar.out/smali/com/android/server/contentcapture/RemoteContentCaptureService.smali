...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/service/contentcapture/IContentCaptureServiceCallback;ILcom/android/server/contentcapture/ContentCapturePerUserService;ZZI)V
    ...
    iput-object v1, p0, Lcom/android/server/contentcapture/RemoteContentCaptureService;->mServerCallback:Landroid/os/IBinder;

    .line 65
    move/from16 v1, p9

    iput v1, p0, Lcom/android/server/contentcapture/RemoteContentCaptureService;->mIdleUnbindTimeoutMs:I
...
.method private static synthetic lambda$onSessionStarted$0(Landroid/view/contentcapture/ContentCaptureContext;IILcom/android/internal/os/IResultReceiver;ILandroid/service/contentcapture/IContentCaptureService;)V
    ...
    .local p0, "s":Landroid/service/contentcapture/IContentCaptureService;
    .local p1, "context":Landroid/view/contentcapture/ContentCaptureContext;
    .local p2, "sessionId":I
    .local p3, "uid":I
    .local p4, "clientReceiver":Lcom/android/internal/os/IResultReceiver;
    .local p5, "initialState":I
...
.method public onSessionStarted(Landroid/view/contentcapture/ContentCaptureContext;IILcom/android/internal/os/IResultReceiver;I)V
    ...
    .end local p5    # "initialState":I
    .local v1, "context":Landroid/view/contentcapture/ContentCaptureContext;
    .local v2, "sessionId":I
    .local v3, "uid":I
    .local v4, "clientReceiver":Lcom/android/internal/os/IResultReceiver;
    .local v5, "initialState":I
    ...
    invoke-static {v2, p2, v5, p1, p3}, Lcom/android/server/contentcapture/ContentCaptureMetricsLogger;->writeSessionEvent(IIILandroid/content/ComponentName;Z)V
