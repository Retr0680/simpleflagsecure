...
.method constructor <init>(Lcom/android/server/contentcapture/ContentCaptureManagerService;Ljava/lang/Object;ZI)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/contentcapture/ContentCapturePerUserService$ContentCaptureServiceRemoteCallback;-><init>(Lcom/android/server/contentcapture/ContentCapturePerUserService;Lcom/android/server/contentcapture/ContentCapturePerUserService-IA;)V
...
.method private updateRemoteServiceLocked(Z)V
    ...
    const-string/jumbo v1, "updateRemoteService(): no service component name"
    ...
    const-string/jumbo v2, "updateRemoteService(): creating new remote service for "
...
.method public startSessionLocked(Landroid/os/IBinder;Landroid/os/IBinder;Landroid/content/pm/ActivityPresentationInfo;IIILcom/android/internal/os/IResultReceiver;)V
    ...
    const-string v3, "basic activity info is null"
    ...
    invoke-static {v6, v1, v0}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V
    ...
    .line 267
    :cond_0
    iget v7, v12, Landroid/content/pm/ActivityPresentationInfo;->taskId:I

    .line 268
    .local v7, "taskId":I
    iget v8, v12, Landroid/content/pm/ActivityPresentationInfo;->displayId:I

    .line 269
    .local v8, "displayId":I
    iget-object v5, v12, Landroid/content/pm/ActivityPresentationInfo;->componentName:Landroid/content/ComponentName;
    ...
    invoke-virtual {v1, v3, v5}, Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;->isWhitelisted(ILandroid/content/ComponentName;)Z
    ...
    .line 271
    invoke-virtual {v1, v10, v11}, Lcom/android/server/contentcapture/ContentCaptureManagerService$GlobalContentCaptureOptions;->isWhitelisted(ILjava/lang/String;)Z
    ...
    .line 274
    .local v14, "serviceComponentName":Landroid/content/ComponentName;
    ...
    iget v11, v4, Lcom/android/server/infra/AbstractPerUserSystemService;->mUserId:I
    ...
    iget-object v3, v4, Lcom/android/server/infra/AbstractPerUserSystemService;->mMaster:Lcom/android/server/infra/AbstractMasterSystemService;
    ...
    .line 289
    invoke-static {v6, v3, v0}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V

    .line 292
    const/4 v0, 0x0

    invoke-static {v9, v1, v3, v14, v0}, Lcom/android/server/contentcapture/ContentCaptureMetricsLogger;->writeSessionEvent(IIILandroid/content/ComponentName;Z)V
    ...
    const-string v3, "): hold your horses"
    ...
    invoke-static {v9, v3, v0, v14, v1}, Lcom/android/server/contentcapture/ContentCaptureMetricsLogger;->writeSessionEvent(IIILandroid/content/ComponentName;Z)V
    ...
    .line 324
    .local v0, "existingSession":Lcom/android/server/contentcapture/ContentCaptureServerSession;
    const-string v1, ", token="

    const-string/jumbo v3, "startSession(id="
    ...
    iget-object v1, v0, Lcom/android/server/contentcapture/ContentCaptureServerSession;->mActivityToken:Landroid/os/IBinder;
    ...
    invoke-static {v6, v1, v3}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V
    ...
    invoke-static {v9, v3, v1, v14, v5}, Lcom/android/server/contentcapture/ContentCaptureMetricsLogger;->writeSessionEvent(IIILandroid/content/ComponentName;Z)V
    ...
    iget-object v8, v4, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;

    if-nez v8, :cond_b

    .line 338
    invoke-direct {v4, v5}, Lcom/android/server/contentcapture/ContentCapturePerUserService;->updateRemoteServiceLocked(Z)V

    .line 341
    :cond_b
    iget-object v5, v4, Lcom/android/server/contentcapture/ContentCapturePerUserService;->mRemoteService:Lcom/android/server/contentcapture/RemoteContentCaptureService;
    ...
    invoke-static {v6, v3, v1}, Landroid/service/contentcapture/ContentCaptureService;->setClientState(Lcom/android/internal/os/IResultReceiver;ILandroid/os/IBinder;)V
    ...
    invoke-static {v9, v5, v3, v14, v1}, Lcom/android/server/contentcapture/ContentCaptureMetricsLogger;->writeSessionEvent(IIILandroid/content/ComponentName;Z)V
    ...
    .end local v0    # "existingSession":Lcom/android/server/contentcapture/ContentCaptureServerSession;
    .local v1, "existingSession":Lcom/android/server/contentcapture/ContentCaptureServerSession;
    new-instance v0, Lcom/android/server/contentcapture/ContentCaptureServerSession;

    move-object v3, v1

    .end local v1    # "existingSession":Lcom/android/server/contentcapture/ContentCaptureServerSession;
    ...
    invoke-direct {v3, v7, v8}, Landroid/app/assist/ActivityId;-><init>(ILandroid/os/IBinder;)V
    ...
    .local v5, "componentName":Landroid/content/ComponentName;
    .restart local v8    # "displayId":I
    .local v16, "existingSession":Lcom/android/server/contentcapture/ContentCaptureServerSession;
    ...
    .line 362
    invoke-static/range {v17 .. v17}, Landroid/content/ComponentName;->flattenToShortString(Landroid/content/ComponentName;)Ljava/lang/String;
