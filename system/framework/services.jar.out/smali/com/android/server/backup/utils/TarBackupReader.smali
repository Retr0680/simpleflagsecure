...
.method private readPaxExtendedHeader(Lcom/android/server/backup/FileMetadata;)Z
    ...
    invoke-direct {v13, v4, v15, v11, v14}, Ljava/lang/String;-><init>([BIILjava/lang/String;)V
    ...
    .line 747
    iput-object v13, v1, Lcom/android/server/backup/FileMetadata;->path:Ljava/lang/String;
    ...
    iput-wide v14, v1, Lcom/android/server/backup/FileMetadata;->size:J
    ...
    const-string v11, "Invalid pax declaration"
    ...
    const-string v8, "Invalid pax data"
    ...
    const-string v5, "Unable to read full pax header"
    ...
    const-string v4, "Suspiciously large pax header size "
    ...
    const-string v4, "Sanity failure: pax header size "
...
.method public chooseRestorePolicy(Landroid/content/pm/PackageManager;ZLcom/android/server/backup/FileMetadata;[Landroid/content/pm/Signature;Landroid/content/pm/PackageManagerInternal;ILandroid/content/Context;)Lcom/android/server/backup/restore/RestorePolicy;
    ...
    invoke-static {p1, p5, p6, v8}, Lcom/android/server/backup/utils/BackupEligibilityRules;->forBackup(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageManagerInternal;ILandroid/content/Context;)Lcom/android/server/backup/utils/BackupEligibilityRules;
...
.method public chooseRestorePolicy(Landroid/content/pm/PackageManager;ZLcom/android/server/backup/FileMetadata;[Landroid/content/pm/Signature;Landroid/content/pm/PackageManagerInternal;ILcom/android/server/backup/utils/BackupEligibilityRules;Landroid/content/Context;)Lcom/android/server/backup/restore/RestorePolicy;
    ...
    invoke-virtual {v11, v12, v0, v15, v13}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V
    :try_end_3
    ...
    invoke-virtual {v4, v11, v0, v15, v13}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V
    ...
    invoke-static {v15, v7, v8}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->putMonitoringExtra(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {v8, v11, v2}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->putMonitoringExtra(Landroid/os/Bundle;Ljava/lang/String;Z)Landroid/os/Bundle;
    ...
    invoke-virtual {v11, v12, v15, v13, v8}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v8, v15, v13, v7}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V
...
.method public readAppManifestAndReturnSignatures(Lcom/android/server/backup/FileMetadata;)[Landroid/content/pm/Signature;
    ...
    const-string v13, "Missing signature on backed-up package "
    ...
    .line 334
    invoke-static {v10, v3, v13}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->putMonitoringExtra(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual {v7, v14, v10, v9, v13}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V
    ...
    const-string v12, "Expected package "
    ...
    const-string v12, " but restore manifest claims "
    ...
    const-string v12, "android.app.backup.extra.LOG_MANIFEST_PACKAGE_NAME"

    invoke-static {v7, v12, v0}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->putMonitoringExtra(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v12

    .line 345
    .end local v7    # "monitoringExtras":Landroid/os/Bundle;
    .local v12, "monitoringExtras":Landroid/os/Bundle;
    iget-object v7, v1, Lcom/android/server/backup/utils/TarBackupReader;->mBackupManagerMonitorEventSender:Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;

    const/16 v13, 0x2b

    invoke-virtual {v7, v13, v10, v9, v12}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V

    .line 351
    .end local v0    # "manifestPackage":Ljava/lang/String;
    .end local v12    # "monitoringExtras":Landroid/os/Bundle;
    :goto_2
    goto :goto_3
    ...
    invoke-virtual {v0, v12, v10, v9, v7}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;->monitorEvent(ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)V
    :try_end_0
    ...
    const-string v11, "Corrupt restore manifest for package "

    invoke-virtual {v7, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v11, v2, Lcom/android/server/backup/FileMetadata;->packageName:Ljava/lang/String;
