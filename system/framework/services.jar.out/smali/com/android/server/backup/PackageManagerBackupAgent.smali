...
.method private getRestoreDataConsumer(I)Lcom/android/server/backup/PackageManagerBackupAgent$RestoreDataConsumer;
    ...
    invoke-direct {v1, p0, v0}, Lcom/android/server/backup/PackageManagerBackupAgent$AncestralVersion1RestoreDataConsumer;-><init>(Lcom/android/server/backup/PackageManagerBackupAgent;Lcom/android/server/backup/PackageManagerBackupAgent-IA;)V
    ...
    invoke-direct {v1, p0, v0}, Lcom/android/server/backup/PackageManagerBackupAgent$LegacyRestoreDataConsumer;-><init>(Lcom/android/server/backup/PackageManagerBackupAgent;Lcom/android/server/backup/PackageManagerBackupAgent-IA;)V
...
.method public onBackup(Landroid/os/ParcelFileDescriptor;Landroid/app/backup/BackupDataOutput;Landroid/os/ParcelFileDescriptor;)V
    ...
    .line 216
    .local v4, "outputBufferStream":Ljava/io/DataOutputStream;
    ...
    const-string v7, "Previous metadata "

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v7, p0, Lcom/android/server/backup/PackageManagerBackupAgent;->mStoredIncrementalVersion:Ljava/lang/String;

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v7, " mismatch vs "
    ...
    .line 241
    .local v5, "upgradingAncestralRecordVersion":Z
    :try_start_0
    ...
    .line 243
    const-string v7, "No ancestral record version in the old state. Storing ancestral record version key"
    ...
    invoke-static {v1, v0, v7}, Lcom/android/server/backup/PackageManagerBackupAgent;->writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V
    ...
    .line 250
    :cond_2
    iget v7, p0, Lcom/android/server/backup/PackageManagerBackupAgent;->mStoredAncestralRecordVersion:I

    if-eq v7, v8, :cond_3

    .line 252
    const-string v7, "Ancestral record version has changed from old state. Storingancestral record version key"
    ...
    invoke-static {v1, v2, v0}, Lcom/android/server/backup/PackageManagerBackupAgent;->writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V
    ...
    .line 288
    :goto_1
    iget-object v0, p0, Lcom/android/server/backup/PackageManagerBackupAgent;->mAllPackages:Ljava/util/List;
    ...
    iget v11, p0, Lcom/android/server/backup/PackageManagerBackupAgent;->mUserId:I

    .line 297
    const/high16 v12, 0x8000000

    invoke-virtual {v0, v9, v12, v11}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    iget-object v12, p0, Lcom/android/server/backup/PackageManagerBackupAgent;->mStateVersions:Ljava/util/HashMap;
    ...
    iget-wide v12, v12, Lcom/android/server/backup/PackageManagerBackupAgent$Metadata;->versionCode:J
    ...
    .line 321
    :cond_6
    iget-object v10, v0, Landroid/content/pm/PackageInfo;->signingInfo:Landroid/content/pm/SigningInfo;

    .line 322
    .local v10, "signingInfo":Landroid/content/pm/SigningInfo;
    if-nez v10, :cond_7
    ...
    const-string v12, "Not backing up package "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v11, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v12, " since it appears to have no signatures."
    ...
    .line 341
    iget v11, v0, Landroid/content/pm/PackageInfo;->versionCodeMajor:I
    ...
    .line 349
    .local v11, "infoSignatures":[Landroid/content/pm/Signature;
    nop

    .line 350
    invoke-static {v11}, Lcom/android/server/backup/BackupUtils;->hashSignatureArray([Landroid/content/pm/Signature;)Ljava/util/ArrayList;
    ...
    invoke-static {v1, v9, v12}, Lcom/android/server/backup/PackageManagerBackupAgent;->writeEntity(Landroid/app/backup/BackupDataOutput;Ljava/lang/String;[B)V

    .line 366
    .end local v0    # "info":Landroid/content/pm/PackageInfo;
    .end local v8    # "pkg":Landroid/content/pm/PackageInfo;
    .end local v9    # "packName":Ljava/lang/String;
    .end local v10    # "signingInfo":Landroid/content/pm/SigningInfo;
    .end local v11    # "infoSignatures":[Landroid/content/pm/Signature;
    goto/16 :goto_2

    .line 299
    .restart local v8    # "pkg":Landroid/content/pm/PackageInfo;
    .restart local v9    # "packName":Ljava/lang/String;
    .local v10, "info":Landroid/content/pm/PackageInfo;
    :catch_1
    move-exception v0
    ...
    iget-object v11, p0, Lcom/android/server/backup/PackageManagerBackupAgent;->mExisting:Ljava/util/HashSet;
    ...
    const-string v8, "Ancestral state updated - Deleting uninstalled package: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v8, " from existing backup"
    ...
    invoke-virtual {v1, v2, v7}, Landroid/app/backup/BackupDataOutput;->writeEntityHeader(Ljava/lang/String;I)I
    ...
    invoke-static {v0, v2}, Lcom/android/server/backup/PackageManagerBackupAgent;->writeStateFile(Ljava/util/List;Landroid/os/ParcelFileDescriptor;)V
    ...
    .line 403
    .local v0, "e":Ljava/io/IOException;
    const-string v7, "Unable to write package backup data file!"
