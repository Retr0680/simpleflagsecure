...
.method public backupManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/server/backup/fullbackup/AppMetadataBackupWriter;->getManifestBytes(Landroid/content/pm/PackageInfo;Z)[B

    move-result-object v1

    .line 91
    .local v1, "manifestBytes":[B
    ...
    iget-object v10, p0, Lcom/android/server/backup/fullbackup/AppMetadataBackupWriter;->mOutput:Landroid/app/backup/FullBackupDataOutput;
...
.method public backupManifest(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;Z)V
    ...
    .end local p2    # "manifestFile":Ljava/io/File;
    .end local p3    # "filesDir":Ljava/io/File;
    .end local p4    # "withApk":Z
    .local v1, "packageInfo":Landroid/content/pm/PackageInfo;
    .local v2, "manifestFile":Ljava/io/File;
...
.method public backupObb(ILandroid/content/pm/PackageInfo;)V
    ...
    .line 270
    .local v7, "obbDirName":Ljava/lang/String;
    array-length v10, v3
    ...
    .line 270
    .end local v11    # "obb":Ljava/io/File;
    ...
    .end local v7    # "obbDirName":Ljava/lang/String;
    :cond_0
    return-void
.end method
...
.method public backupWidget(Landroid/content/pm/PackageInfo;Ljava/io/File;Ljava/io/File;[B)V
    ...
    .line 181
    invoke-direct {p0, v8, p4}, Lcom/android/server/backup/fullbackup/AppMetadataBackupWriter;->writeWidgetData(Ljava/io/DataOutputStream;[B)V
