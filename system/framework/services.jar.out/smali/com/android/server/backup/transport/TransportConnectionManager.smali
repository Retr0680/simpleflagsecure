...
.method private getTransportClient(Landroid/content/ComponentName;Ljava/lang/String;Landroid/content/Intent;)Lcom/android/server/backup/transport/TransportConnection;
    ...
    .end local p3    # "bindIntent":Landroid/content/Intent;
    ...
    invoke-static {p3, v9, p2}, Lcom/android/server/backup/transport/TransportUtils;->formatMessage(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, p1, p2}, Lcom/android/server/backup/transport/TransportUtils;->log(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .restart local p3    # "bindIntent":Landroid/content/Intent;
    :catchall_1
    move-exception v0
    ...
    .end local p2    # "caller":Ljava/lang/String;
    .end local p3    # "bindIntent":Landroid/content/Intent;
    .restart local v6    # "bindIntent":Landroid/content/Intent;
    .restart local v7    # "transportComponent":Landroid/content/ComponentName;
    .restart local v9    # "caller":Ljava/lang/String;
    :goto_0
    monitor-exit v1
    :try_end_1
