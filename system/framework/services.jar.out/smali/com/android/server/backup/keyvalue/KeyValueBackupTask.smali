...
.method private SHA1Checksum([B)Ljava/lang/String;
    ...
    .line 1003
    .end local v0    # "string":Ljava/lang/StringBuilder;
...
.method private agentDoQuotaExceeded(Landroid/app/IBackupAgent;Ljava/lang/String;J)V
    ...
    .line 1150
    .local v7, "quota":J
    new-instance v3, Lcom/android/server/backup/keyvalue/KeyValueBackupTask$$ExternalSyntheticLambda0;
    :try_end_0
    ...
    .local v5, "size":J
    :try_start_1
    invoke-direct/range {v3 .. v8}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask$$ExternalSyntheticLambda0;-><init>(Landroid/app/IBackupAgent;JJ)V
    ...
    .line 1150
    invoke-direct {p0, v3, p3, p4, p1}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->remoteCall(Lcom/android/server/backup/remote/RemoteCallable;JLjava/lang/String;)Lcom/android/server/backup/remote/RemoteResult;
    :try_end_1
    ...
    invoke-virtual {p3, p1}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onAgentDoQuotaExceededError(Ljava/lang/Exception;)V
    ...
    .end local v4    # "agent":Landroid/app/IBackupAgent;
    .end local v5    # "size":J
    .local p1, "agent":Landroid/app/IBackupAgent;
    .restart local p3    # "size":J
    :cond_0
    move-object v4, p1
...
.method private bindAgent(Landroid/content/pm/PackageInfo;)Landroid/app/IBackupAgent;
    ...
    invoke-virtual {v1, v2, v4, v3}, Lcom/android/server/backup/BackupAgentConnectionManager;->bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;II)Landroid/app/IBackupAgent;
...
.method private extractAgentData(Landroid/content/pm/PackageInfo;)V
    ...
    invoke-virtual {v1, v0}, Lcom/android/server/backup/BackupWakeLock;->setWorkSource(Landroid/os/WorkSource;)V
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/backup/BackupWakeLock;->setWorkSource(Landroid/os/WorkSource;)V
...
.method private extractAgentData(Landroid/content/pm/PackageInfo;Landroid/app/IBackupAgent;)V
    ...
    .line 918
    .local v0, "savedStateFileForAgent":Ljava/io/File;
    nop
    ...
    invoke-virtual {v3, v1, v4}, Lcom/android/server/backup/transport/BackupTransportClient;->getBackupQuota(Ljava/lang/String;Z)J
    ...
    .line 940
    .local v11, "transportFlags":I
    const/4 v2, 0x1

    .line 941
    new-instance v6, Lcom/android/server/backup/keyvalue/KeyValueBackupTask$$ExternalSyntheticLambda1;
    :try_end_4
    ...
    .local v8, "agent":Landroid/app/IBackupAgent;
    :try_start_5
    invoke-direct/range {v6 .. v11}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/backup/keyvalue/KeyValueBackupTask;Landroid/app/IBackupAgent;JI)V

    iget-object p2, v7, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    .line 942
    invoke-direct {p0, v6, v4, v5, p2}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->remoteCall(Lcom/android/server/backup/remote/RemoteCallable;JLjava/lang/String;)Lcom/android/server/backup/remote/RemoteResult;
    ...
    .line 960
    .end local v0    # "savedStateFileForAgent":Ljava/io/File;
    .end local v3    # "transport":Lcom/android/server/backup/transport/BackupTransportClient;
    .end local v9    # "quota":J
    .end local v11    # "transportFlags":I
    .local p2, "agentResult":Lcom/android/server/backup/remote/RemoteResult;
    nop
    ...
    .line 953
    .end local p2    # "agentResult":Lcom/android/server/backup/remote/RemoteResult;
    :catch_1
    move-exception v0

    goto :goto_1

    .end local v8    # "agent":Landroid/app/IBackupAgent;
    ...
    .end local p2    # "agent":Landroid/app/IBackupAgent;
    .restart local v8    # "agent":Landroid/app/IBackupAgent;
    :goto_1
    nop

    .line 954
    .local v0, "e":Ljava/lang/Exception;
    iget-object p2, v7, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    invoke-virtual {p2, v1, v2, v0}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onCallAgentDoBackupError(Ljava/lang/String;ZLjava/lang/Exception;)V

    .line 955
    if-eqz v2, :cond_2

    .line 956
    invoke-static {v0}, Lcom/android/server/backup/keyvalue/AgentException;->transitory(Ljava/lang/Exception;)Lcom/android/server/backup/keyvalue/AgentException;
...
.method private finishTask(I)V
    ...
    invoke-virtual {v4}, Lcom/android/server/backup/BackupWakeLock;->release()V
...
.method private synthetic lambda$extractAgentData$0(Landroid/app/IBackupAgent;JILandroid/app/backup/IBackupCallback;)V
    ...
    .end local p1    # "agent":Landroid/app/IBackupAgent;
    .end local p2    # "quota":J
    .end local p4    # "transportFlags":I
    .end local p5    # "callback":Landroid/app/backup/IBackupCallback;
    .local v0, "agent":Landroid/app/IBackupAgent;
    .local v4, "quota":J
    .local v6, "callback":Landroid/app/backup/IBackupCallback;
    .local v7, "transportFlags":I
...
.method private revertTask()V
    ...
    .line 1251
    invoke-static {v0, v3, v1, v2, v4}, Lcom/android/server/backup/KeyValueBackupJob;->schedule(ILandroid/content/Context;JLcom/android/server/backup/UserBackupManagerService;)V
...
.method public static start(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/OperationStorage;Lcom/android/server/backup/transport/TransportConnection;Ljava/lang/String;Ljava/util/List;Lcom/android/server/backup/DataChangedJournal;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZLcom/android/server/backup/utils/BackupEligibilityRules;)Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
    ...
    .local p9, "pendingFullBackups":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    new-instance v0, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;

    new-instance v1, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;

    move-object/from16 v2, p7

    invoke-direct {v1, v2}, Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;-><init>(Landroid/app/backup/IBackupManagerMonitor;)V

    move-object/from16 v4, p0

    move-object/from16 v3, p6

    invoke-direct {v0, v4, v3, v1}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;-><init>(Lcom/android/server/backup/UserBackupManagerService;Landroid/app/backup/IBackupObserver;Lcom/android/server/backup/utils/BackupManagerMonitorEventSender;)V

    move-object v10, v0

    .line 230
    .local v10, "reporter":Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
    new-instance v3, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
    ...
    invoke-direct/range {v3 .. v15}, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;-><init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/OperationStorage;Lcom/android/server/backup/transport/TransportConnection;Ljava/lang/String;Ljava/util/List;Lcom/android/server/backup/DataChangedJournal;Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZLcom/android/server/backup/utils/BackupEligibilityRules;)V

    .line 244
    .local v3, "task":Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
    ...
    const-string/jumbo v4, "key-value-backup-"

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    sget-object v4, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->THREAD_COUNT:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v1}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onNewThread(Ljava/lang/String;)V
...
.method private startTask()V
    ...
    .line 625
    .restart local v1    # "transport":Lcom/android/server/backup/transport/BackupTransportClient;
    ...
    .restart local v3    # "pmState":Ljava/io/File;
    .restart local p0    # "this":Lcom/android/server/backup/keyvalue/KeyValueBackupTask;
    :cond_6
    :goto_4
    nop
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;->onInitializeTransportError(Ljava/lang/Exception;)V
    ...
    .line 638
    .local v1, "e":Lcom/android/server/backup/keyvalue/TaskException;
    throw v1

    .line 593
    .end local v0    # "backupPm":Z
    .end local v1    # "e":Lcom/android/server/backup/keyvalue/TaskException;
    .end local v3    # "pmState":Ljava/io/File;
    :cond_7
    iget-object v0, p0, Lcom/android/server/backup/keyvalue/KeyValueBackupTask;->mReporter:Lcom/android/server/backup/keyvalue/KeyValueBackupReporter;
...
.method public handleCancel(I)V
    ...
    :goto_0
    const-string v1, "Key-value backup task cannot time out"
