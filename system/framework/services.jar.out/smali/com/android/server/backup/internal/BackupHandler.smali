...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v0}, Lcom/android/server/backup/BackupWakeLock;->quit()V
    ...
    const-string v5, "Timeout for token="
    ...
    invoke-virtual {v0, v4, v6}, Lcom/android/server/backup/UserBackupManagerService;->handleCancel(II)V
    ...
    iget-object v10, v0, Lcom/android/server/backup/params/BackupParams;->mBackupEligibilityRules:Lcom/android/server/backup/utils/BackupEligibilityRules;
    ...
    .line 387
    .end local v4    # "sets":Ljava/util/List;, "Ljava/util/List<Landroid/app/backup/RestoreSet;>;"
    .local v10, "sets":Ljava/util/List;, "Ljava/util/List<Landroid/app/backup/RestoreSet;>;"
    :goto_f
    iget-object v0, v7, Lcom/android/server/backup/params/RestoreGetSetsParams;->observer:Landroid/app/backup/IRestoreObserver;
    ...
    .end local v7    # "params":Lcom/android/server/backup/params/RestoreGetSetsParams;
    .end local v8    # "callerLogString":Ljava/lang/String;
    .end local v10    # "sets":Ljava/util/List;, "Ljava/util/List<Landroid/app/backup/RestoreSet;>;"
    :pswitch_b
    iget-object v0, v2, Landroid/os/Message;->obj:Ljava/lang/Object;
    ...
    .line 306
    new-instance v7, Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;
    ...
    iget v0, v5, Lcom/android/server/backup/params/RestoreParams;->pmToken:I
    ...
    iget-object v0, v5, Lcom/android/server/backup/params/RestoreParams;->listener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    move-object/from16 v19, v0

    iget-object v0, v5, Lcom/android/server/backup/params/RestoreParams;->backupEligibilityRules:Lcom/android/server/backup/utils/BackupEligibilityRules;
    ...
    .line 321
    .local v7, "task":Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;
    iget-object v0, v1, Lcom/android/server/backup/internal/BackupHandler;->backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    .end local v7    # "task":Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;
    :pswitch_d
    iget-object v0, v2, Landroid/os/Message;->obj:Ljava/lang/Object;
    ...
    iget-boolean v2, v0, Lcom/android/server/backup/params/AdbBackupParams;->includeSystem:Z
    ...
    .line 298
    .local v4, "task":Lcom/android/server/backup/fullbackup/PerformAdbBackupTask;
    ...
    .end local v4    # "task":Lcom/android/server/backup/fullbackup/PerformAdbBackupTask;
    :pswitch_e
    iget-object v0, v1, Lcom/android/server/backup/internal/BackupHandler;->backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    .line 158
    .local v9, "transportConnection":Lcom/android/server/backup/transport/TransportConnection;
    if-eqz v9, :cond_c

    .line 159
    invoke-virtual {v9, v2}, Lcom/android/server/backup/transport/TransportConnection;->connect(Ljava/lang/String;)Lcom/android/server/backup/transport/BackupTransportClient;
    ...
    .line 164
    invoke-virtual {v3, v9, v2}, Lcom/android/server/backup/TransportManager;->disposeOfTransportClient(Lcom/android/server/backup/transport/TransportConnection;Ljava/lang/String;)V
    ...
    .line 172
    .local v11, "queue":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    iget-object v0, v1, Lcom/android/server/backup/internal/BackupHandler;->backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    .line 173
    .local v12, "oldJournal":Lcom/android/server/backup/DataChangedJournal;
    iget-object v0, v1, Lcom/android/server/backup/internal/BackupHandler;->backupManagerService:Lcom/android/server/backup/UserBackupManagerService;
    ...
    iget-object v10, v8, Lcom/android/server/backup/keyvalue/BackupRequest;->packageName:Ljava/lang/String;
    ...
    :try_start_11
    invoke-virtual {v4}, Lcom/android/server/backup/transport/BackupTransportClient;->getBackupManagerMonitor()Landroid/app/backup/IBackupManagerMonitor;
    ...
    .local v14, "monitor":Landroid/app/backup/IBackupManagerMonitor;
    :goto_18
    const/4 v5, 0x1
    ...
    invoke-direct {v15, v3, v9}, Lcom/android/server/backup/internal/BackupHandler$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/backup/TransportManager;Lcom/android/server/backup/transport/TransportConnection;)V
    ...
    .line 229
    invoke-virtual {v4}, Lcom/android/server/backup/transport/BackupTransportClient;->transportDirName()Ljava/lang/String;
    ...
    .end local v5    # "staged":Z
    .end local v9    # "transportConnection":Lcom/android/server/backup/transport/TransportConnection;
    .end local v11    # "queue":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v12    # "oldJournal":Lcom/android/server/backup/DataChangedJournal;
    .end local v14    # "monitor":Landroid/app/backup/IBackupManagerMonitor;
    :cond_13
    :goto_1a
    return-void
    ...
    .restart local v9    # "transportConnection":Lcom/android/server/backup/transport/TransportConnection;
    .restart local v11    # "queue":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v12    # "oldJournal":Lcom/android/server/backup/DataChangedJournal;
    :goto_1b
    :try_start_15
    monitor-exit v7
    :try_end_15
