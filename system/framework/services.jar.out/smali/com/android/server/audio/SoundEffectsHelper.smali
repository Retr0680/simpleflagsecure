...
.method private loadSoundAssets()V
    ...
    .line 405
    invoke-virtual {v5, v7}, Landroid/media/AudioManager;->setNavigationRepeatSoundEffectsEnabled(Z)V
    ...
    .line 408
    invoke-virtual {v5, v7}, Landroid/media/AudioManager;->setHomeSoundEffectEnabled(Z)V
    :try_end_2
    ...
    .end local v6    # "homeSoundParsed":Z
    :cond_9
    nop
...
.method private onLoadSoundEffects(Lcom/android/server/audio/SoundEffectsHelper$OnEffectsLoadCompleteHandler;)V
    ...
    .line 231
    iget-object v2, v3, Lcom/android/server/audio/SoundEffectsHelper;->mSoundPoolLoader:Lcom/android/server/audio/SoundEffectsHelper$SoundPoolLoader;
...
.method loadSoundEffects(Lcom/android/server/audio/SoundEffectsHelper$OnEffectsLoadCompleteHandler;)V
    ...
    .end local p1    # "onComplete":Lcom/android/server/audio/SoundEffectsHelper$OnEffectsLoadCompleteHandler;
    .local v4, "onComplete":Lcom/android/server/audio/SoundEffectsHelper$OnEffectsLoadCompleteHandler;
...
.method onPlaySoundEffect(II)V
    ...
    .line 264
    iget v0, p0, Lcom/android/server/audio/SoundEffectsHelper;->mSfxAttenuationDb:I
    ...
    iget v0, v9, Lcom/android/server/audio/SoundEffectsHelper$Resource;->mSampleId:I

    if-eqz v0, :cond_1

    iget-boolean v0, v9, Lcom/android/server/audio/SoundEffectsHelper$Resource;->mLoaded:Z
    ...
    .line 279
    invoke-virtual {v2, v4}, Landroid/media/MediaPlayer;->setVolume(F)V

    .line 280
    new-instance v3, Lcom/android/server/audio/SoundEffectsHelper$3;

    invoke-direct {v3, p0}, Lcom/android/server/audio/SoundEffectsHelper$3;-><init>(Lcom/android/server/audio/SoundEffectsHelper;)V

    invoke-virtual {v2, v3}, Landroid/media/MediaPlayer;->setOnCompletionListener(Landroid/media/MediaPlayer$OnCompletionListener;)V

    .line 285
    new-instance v3, Lcom/android/server/audio/SoundEffectsHelper$4;

    invoke-direct {v3, p0}, Lcom/android/server/audio/SoundEffectsHelper$4;-><init>(Lcom/android/server/audio/SoundEffectsHelper;)V
