...
.method constructor <init>(ILandroid/os/ParcelFileDescriptor;Landroid/content/Context;I)V
    .locals 8
    ...
    .line 41
    new-instance v2, Lcom/android/server/companion/securechannel/SecureChannel;
    ...
    .local v7, "flags":I
    invoke-direct/range {v2 .. v7}, Lcom/android/server/companion/securechannel/SecureChannel;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;Lcom/android/server/companion/securechannel/SecureChannel$Callback;Landroid/content/Context;I)V

    iput-object v2, v5, Lcom/android/server/companion/transport/SecureTransport;->mSecureChannel:Lcom/android/server/companion/securechannel/SecureChannel;

    .line 42
    return-void
.end method

.method constructor <init>(ILandroid/os/ParcelFileDescriptor;Landroid/content/Context;[BLcom/android/server/companion/securechannel/AttestationVerifier;I)V
    .locals 9
    .param p1, "associationId"    # I
    .param p2, "fd"    # Landroid/os/ParcelFileDescriptor;
    .param p3, "context"    # Landroid/content/Context;
    ...
    .end local p5    # "verifier":Lcom/android/server/companion/securechannel/AttestationVerifier;
    .end local p6    # "flags":I
    .local v6, "preSharedKey":[B
    .local v7, "verifier":Lcom/android/server/companion/securechannel/AttestationVerifier;
    .local v8, "flags":I
    invoke-direct/range {v2 .. v8}, Lcom/android/server/companion/securechannel/SecureChannel;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;Lcom/android/server/companion/securechannel/SecureChannel$Callback;[BLcom/android/server/companion/securechannel/AttestationVerifier;I)V
