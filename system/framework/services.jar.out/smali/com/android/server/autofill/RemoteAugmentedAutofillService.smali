...
.method constructor <init>(Landroid/content/Context;ILandroid/content/ComponentName;ILcom/android/server/autofill/RemoteAugmentedAutofillService$RemoteAugmentedAutofillServiceCallbacks;ZZII)V
    ...
    iput v2, p0, Lcom/android/server/autofill/RemoteAugmentedAutofillService;->mRequestTimeoutMs:I
    ...
    .line 91
    new-instance v4, Lcom/android/server/autofill/AutofillUriGrantsManager;

    invoke-direct {v4, p2}, Lcom/android/server/autofill/AutofillUriGrantsManager;-><init>(I)V

    iput-object v4, p0, Lcom/android/server/autofill/RemoteAugmentedAutofillService;->mUriGrantsManager:Lcom/android/server/autofill/AutofillUriGrantsManager;
...
.method private synthetic lambda$onRequestAutofillLocked$0(Landroid/view/autofill/IAutoFillManagerClient;IILandroid/content/ComponentName;Landroid/view/autofill/AutofillId;Landroid/view/autofill/AutofillValue;JLandroid/view/inputmethod/InlineSuggestionsRequest;Ljava/util/function/Function;Ljava/lang/Runnable;Lcom/android/server/autofill/RemoteInlineSuggestionRenderService;ILandroid/os/IBinder;Ljava/util/concurrent/atomic/AtomicReference;Landroid/service/autofill/augmented/IAugmentedAutofillService;)Ljava/util/concurrent/CompletableFuture;
    ...
    new-instance v1, Lcom/android/server/autofill/RemoteAugmentedAutofillService$1;
...
.method private synthetic lambda$onRequestAutofillLocked$1(Ljava/util/concurrent/atomic/AtomicReference;Landroid/content/ComponentName;ILjava/lang/Void;Ljava/lang/Throwable;)V
    ...
    .end local p2    # "activityComponent":Landroid/content/ComponentName;
    .end local p3    # "sessionId":I
    .local v3, "activityComponent":Landroid/content/ComponentName;
    ...
    .line 222
    .end local v3    # "activityComponent":Landroid/content/ComponentName;
    .end local v4    # "sessionId":I
    .restart local p2    # "activityComponent":Landroid/content/ComponentName;
    .restart local p3    # "sessionId":I
    :cond_1
    move-object v3, p2
    ...
    .end local p2    # "activityComponent":Landroid/content/ComponentName;
    .end local p3    # "sessionId":I
    .restart local v3    # "activityComponent":Landroid/content/ComponentName;
    ...
    const-string v0, "exception handling getAugmentedAutofillClient() for "
    ...
    invoke-static {p2, p3, p5}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private maybeRequestShowInlineSuggestions(ILandroid/view/inputmethod/InlineSuggestionsRequest;Ljava/util/List;Landroid/os/Bundle;Landroid/view/autofill/AutofillId;Landroid/view/autofill/AutofillValue;Ljava/util/function/Function;Landroid/view/autofill/IAutoFillManagerClient;Ljava/lang/Runnable;Lcom/android/server/autofill/RemoteInlineSuggestionRenderService;ILandroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    .line 268
    :cond_0
    iget-object v1, p0, Lcom/android/server/autofill/RemoteAugmentedAutofillService;->mCallbacks:Lcom/android/server/autofill/RemoteAugmentedAutofillService$RemoteAugmentedAutofillServiceCallbacks;

    invoke-interface {v1, p1}, Lcom/android/server/autofill/RemoteAugmentedAutofillService$RemoteAugmentedAutofillServiceCallbacks;->setLastResponse(I)V
    ...
    .end local v5    # "filterText":Ljava/lang/String;
    .local v12, "filterText":Ljava/lang/String;
    move-object v13, v2

    .line 278
    .local v13, "inlineFillUiInfo":Lcom/android/server/autofill/ui/InlineFillUi$InlineFillUiInfo;
    new-instance v1, Lcom/android/server/autofill/RemoteAugmentedAutofillService$2;
    ...
    .line 279
    invoke-static {v13, v0, v1}, Lcom/android/server/autofill/ui/InlineFillUi;->forAugmentedAutofill(Lcom/android/server/autofill/ui/InlineFillUi$InlineFillUiInfo;Ljava/util/List;Lcom/android/server/autofill/ui/InlineFillUi$InlineSuggestionUiCallback;)Lcom/android/server/autofill/ui/InlineFillUi;

    move-result-object v1

    .line 366
    .local v1, "inlineFillUi":Lcom/android/server/autofill/ui/InlineFillUi;
    ...
    .line 367
    iget-object v4, p0, Lcom/android/server/autofill/RemoteAugmentedAutofillService;->mCallbacks:Lcom/android/server/autofill/RemoteAugmentedAutofillService$RemoteAugmentedAutofillServiceCallbacks;

    move-object/from16 v5, p4

    invoke-interface {v4, p1, v5}, Lcom/android/server/autofill/RemoteAugmentedAutofillService$RemoteAugmentedAutofillServiceCallbacks;->logAugmentedAutofillShown(ILandroid/os/Bundle;)V
    ...
    .line 258
    .end local v1    # "inlineFillUi":Lcom/android/server/autofill/ui/InlineFillUi;
    .end local v12    # "filterText":Ljava/lang/String;
    .end local v13    # "inlineFillUiInfo":Lcom/android/server/autofill/ui/InlineFillUi$InlineFillUiInfo;
    :cond_3
    move-object/from16 v5, p4
...
.method public onRequestAutofillLocked(ILandroid/view/autofill/IAutoFillManagerClient;ILandroid/content/ComponentName;Landroid/os/IBinder;Landroid/view/autofill/AutofillId;Landroid/view/autofill/AutofillValue;Landroid/view/inputmethod/InlineSuggestionsRequest;Ljava/util/function/Function;Ljava/lang/Runnable;Lcom/android/server/autofill/RemoteInlineSuggestionRenderService;I)V
    ...
    .line 163
    .local v16, "cancellationRef":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<Landroid/os/ICancellationSignal;>;"
    new-instance v0, Lcom/android/server/autofill/RemoteAugmentedAutofillService$$ExternalSyntheticLambda3;
    ...
    .end local v16    # "cancellationRef":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<Landroid/os/ICancellationSignal;>;"
    .local v0, "cancellationRef":Ljava/util/concurrent/atomic/AtomicReference;, "Ljava/util/concurrent/atomic/AtomicReference<Landroid/os/ICancellationSignal;>;"
    ...
    new-instance v3, Lcom/android/server/autofill/RemoteAugmentedAutofillService$$ExternalSyntheticLambda4;

    move/from16 v4, p1

    move-object/from16 v5, p4

    invoke-direct {v3, v1, v0, v5, v4}, Lcom/android/server/autofill/RemoteAugmentedAutofillService$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/autofill/RemoteAugmentedAutofillService;Ljava/util/concurrent/atomic/AtomicReference;Landroid/content/ComponentName;I)V
