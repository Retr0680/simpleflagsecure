...
.method private static synthetic lambda$calculateScores$2(Landroid/os/RemoteCallback;Ljava/util/List;[Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/util/ArrayMap;Landroid/util/ArrayMap;Landroid/service/autofill/IAutofillFieldClassificationService;)V
    ...
    .local p0, "service":Landroid/service/autofill/IAutofillFieldClassificationService;
    .local p1, "callback":Landroid/os/RemoteCallback;
    .local p2, "actualValues":Ljava/util/List;
    .local p3, "userDataValues":[Ljava/lang/String;
    .local p4, "categoryIds":[Ljava/lang/String;
    .local p5, "defaultAlgorithm":Ljava/lang/String;
    .local p6, "defaultArgs":Landroid/os/Bundle;
    .local p7, "algorithms":Landroid/util/ArrayMap;
    .local p8, "args":Landroid/util/ArrayMap;
...
.method calculateScores(Landroid/os/RemoteCallback;Ljava/util/List;[Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Landroid/util/ArrayMap;Landroid/util/ArrayMap;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/autofill/FieldClassificationStrategy;->connectAndRun(Lcom/android/server/autofill/FieldClassificationStrategy$Command;)V
