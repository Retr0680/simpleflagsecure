...
.method private getOnUserCompletedEventRunnable(Lcom/android/server/utils/TimingsTraceAndSlog;Lcom/android/server/SystemService;Ljava/lang/String;Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$UserCompletedEventType;)Ljava/lang/Runnable;
    ...
    .end local p2    # "service":Lcom/android/server/SystemService;
    .end local p3    # "serviceName":Ljava/lang/String;
    .end local p4    # "curUser":Lcom/android/server/SystemService$TargetUser;
    .end local p5    # "eventType":Lcom/android/server/SystemService$UserCompletedEventType;
    .local v2, "oldTrace":Lcom/android/server/utils/TimingsTraceAndSlog;
    .local v3, "curUser":Lcom/android/server/SystemService$TargetUser;
    .local v4, "eventType":Lcom/android/server/SystemService$UserCompletedEventType;
    .local v5, "serviceName":Ljava/lang/String;
    .local v6, "service":Lcom/android/server/SystemService;
...
.method private onUser(Lcom/android/server/utils/TimingsTraceAndSlog;Ljava/lang/String;Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$TargetUser;)V
    ...
    .local v2, "onWhat":Ljava/lang/String;
    .local v3, "prevUser":Lcom/android/server/SystemService$TargetUser;
    .local v4, "curUser":Lcom/android/server/SystemService$TargetUser;
...
.method private onUser(Lcom/android/server/utils/TimingsTraceAndSlog;Ljava/lang/String;Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$TargetUser;Lcom/android/server/SystemService$UserCompletedEventType;)V
    ...
    .line 524
    invoke-direct {v1, v9, v7}, Lcom/android/server/SystemServiceManager;->useThreadPool(ILjava/lang/String;)Z

    move-result v11

    .line 526
    .local v11, "useThreadPool":Z
    if-eqz v11, :cond_1
    ...
    .line 528
    .local v13, "threadPool":Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {v3, v5}, Lcom/android/server/SystemService;->isUserSupported(Lcom/android/server/SystemService$TargetUser;)Z
    ...
    .line 537
    invoke-virtual {v3, v8}, Lcom/android/server/SystemService;->isUserSupported(Lcom/android/server/SystemService$TargetUser;)Z
    ...
    invoke-direct {v1, v7, v15}, Lcom/android/server/SystemServiceManager;->useThreadPoolForService(Ljava/lang/String;I)Z
    ...
    .line 552
    .local v12, "submitToThreadPool":Z
    :goto_4
    if-nez v12, :cond_5
    ...
    .end local v9    # "curUserId":I
    .end local v11    # "useThreadPool":Z
    .end local v12    # "submitToThreadPool":Z
    .end local v13    # "threadPool":Ljava/util/concurrent/ExecutorService;
    .end local v14    # "serviceLen":I
    .end local v15    # "i":I
    ...
    .restart local v9    # "curUserId":I
    .restart local v11    # "useThreadPool":Z
    .restart local v12    # "submitToThreadPool":Z
    .restart local v13    # "threadPool":Ljava/util/concurrent/ExecutorService;
    .restart local v14    # "serviceLen":I
    ...
    .line 563
    invoke-direct {v1, v2, v3, v5}, Lcom/android/server/SystemServiceManager;->getOnUserStartingRunnable(Lcom/android/server/utils/TimingsTraceAndSlog;Lcom/android/server/SystemService;Lcom/android/server/SystemService$TargetUser;)Ljava/lang/Runnable;
    ...
    invoke-direct {v1, v7, v5, v4, v0}, Lcom/android/server/SystemServiceManager;->logFailure(Ljava/lang/String;Lcom/android/server/SystemService$TargetUser;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    .end local v11    # "useThreadPool":Z
    .end local v12    # "submitToThreadPool":Z
    .local v6, "useThreadPool":Z
    .local v21, "submitToThreadPool":Z
    ...
    invoke-direct {v1, v11, v12, v3, v0}, Lcom/android/server/SystemServiceManager;->warnIfTooLong(JLcom/android/server/SystemService;Ljava/lang/String;)V
    ...
    .line 590
    .end local v6    # "useThreadPool":Z
    .end local v21    # "submitToThreadPool":Z
    .restart local v11    # "useThreadPool":Z
    .restart local v12    # "submitToThreadPool":Z
    :cond_8
    move v6, v11
    ...
    .end local v16    # "supported":Z
    .end local v19    # "time":J
    .restart local v6    # "useThreadPool":Z
    :goto_a
    ...
    invoke-direct {v1, v7, v5, v3, v0}, Lcom/android/server/SystemServiceManager;->logFailure(Ljava/lang/String;Lcom/android/server/SystemService$TargetUser;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-direct {v1, v7, v5, v0, v3}, Lcom/android/server/SystemServiceManager;->logFailure(Ljava/lang/String;Lcom/android/server/SystemService$TargetUser;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public onUserCompletedEvent(II)V
    ...
    .line 492
    .local v6, "targetUser":Lcom/android/server/SystemService$TargetUser;
    if-nez v6, :cond_1
