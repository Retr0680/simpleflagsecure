...
.method constructor <init>(Landroid/content/Context;Landroid/os/ParcelFileDescriptor;Landroid/app/admin/StartInstallingUpdateCallback;Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;Lcom/android/server/devicepolicy/DevicePolicyConstants;)V
    ...
    .local v0, "constants":Lcom/android/server/devicepolicy/DevicePolicyConstants;
    .local p2, "context":Landroid/content/Context;
    .local p3, "updateFileDescriptor":Landroid/os/ParcelFileDescriptor;
    .local p4, "callback":Landroid/app/admin/StartInstallingUpdateCallback;
    .local p5, "injector":Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;
    const/4 v1, 0x0

    iput-boolean v1, p1, Lcom/android/server/devicepolicy/AbUpdateInstaller;->mUpdateInstalled:Z
...
.method private applyPayload(Ljava/lang/String;)V
    ...
    .line 192
    .local v7, "headerKeyValuePairs":[Ljava/lang/String;
    ...
    .line 193
    const-string v0, "Failed to find payload entry in the given package."
    ...
    .line 202
    .local v1, "updateEngine":Landroid/os/UpdateEngine;
    :try_start_0
    ...
    .end local p1    # "updatePath":Ljava/lang/String;
    ...
    .end local v2    # "updatePath":Ljava/lang/String;
    .restart local p1    # "updatePath":Ljava/lang/String;
    :catch_1
    move-exception v0
    ...
    .line 207
    .restart local v2    # "updatePath":Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v0}, Lcom/android/server/devicepolicy/UpdateInstaller;->notifyCallbackOnError(ILjava/lang/String;)V
