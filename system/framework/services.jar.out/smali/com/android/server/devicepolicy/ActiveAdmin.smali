...
.field private static final PROVISIONING_CONTEXT_LENGTH_LIMIT:I = 0x3e8
...
.field private static final TAG_PROVISIONING_CONTEXT:Ljava/lang/String; = "provisioning-context"
...
.method readFromXml(Lcom/android/modules/utils/TypedXmlPullParser;Z)V
    ...
    .line 1016
    const-string/jumbo v1, "provisioning-context"
...
.method public setProvisioningContext(Ljava/lang/String;)V
    .locals 2
    .param p1, "provisioningContext"    # Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/devicepolicy/ActiveAdmin;->mProvisioningContext:Ljava/lang/String;
...
.method writeToXml(Lcom/android/modules/utils/TypedXmlSerializer;)V
    ...
    invoke-static {v7, v0, v8, v15}, Lcom/android/server/utils/Slogf;->e(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->crossProfileWidgetProviders:Ljava/util/List;

    const-string v7, "cross-profile-widget-providers"

    invoke-virtual {v1, v2, v7, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValuesToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;)V

    .line 560
    :cond_1f
    const-string/jumbo v0, "permitted-accessiblity-services"

    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->permittedAccessiblityServices:Ljava/util/List;

    invoke-virtual {v1, v2, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writePackageListToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->permittedNotificationListeners:Ljava/util/List;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->keepUninstalledPackages:Ljava/util/List;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->meteredDisabledPackages:Ljava/util/List;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->protectedPackages:Ljava/util/List;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->suspendedPackages:Ljava/util/List;

    invoke-virtual {v1, v2, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writePackageListToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/util/List;)V

    .line 569
    invoke-virtual {v1}, Lcom/android/server/devicepolicy/ActiveAdmin;->hasUserRestrictions()Z
    ...
    invoke-static {v2, v0, v6}, Lcom/android/server/pm/UserRestrictionsUtils;->writeRestrictions(Lcom/android/modules/utils/TypedXmlSerializer;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->defaultEnabledRestrictionsAlreadySet:Ljava/util/Set;
    ...
    invoke-virtual {v1, v2, v6, v0}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeTextToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 586
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->parentAdmin:Lcom/android/server/devicepolicy/ActiveAdmin;

    invoke-virtual {v6, v2}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeToXml(Lcom/android/modules/utils/TypedXmlSerializer;)V
    ...
    sget v6, Lcom/android/server/devicepolicy/ActiveAdmin;->DEF_ORGANIZATION_COLOR:I
    ...
    iget v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->organizationColor:I
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->organizationName:Ljava/lang/String;

    invoke-virtual {v1, v2, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeTextToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->isLogoutEnabled:Z

    invoke-virtual {v1, v2, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Z)V
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->startUserSessionMessage:Ljava/lang/String;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->endUserSessionMessage:Ljava/lang/String;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mCrossProfileCalendarPackages:Ljava/util/List;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mCrossProfilePackages:Ljava/util/List;
    ...
    .line 614
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mFactoryResetProtectionPolicy:Landroid/app/admin/FactoryResetProtectionPolicy;

    invoke-virtual {v6, v2}, Landroid/app/admin/FactoryResetProtectionPolicy;->writeToXml(Lcom/android/modules/utils/TypedXmlSerializer;)V
    ...
    iget-boolean v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mSuspendPersonalApps:Z

    invoke-virtual {v1, v2, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Z)V

    .line 620
    :cond_2c
    iget-wide v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mProfileMaximumTimeOffMillis:J
    ...
    invoke-virtual {v1, v2, v0, v6, v7}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;J)V
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mAlwaysOnVpnPackage:Ljava/lang/String;

    invoke-virtual {v1, v2, v0, v6}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mAlwaysOnVpnLockdown:Z
    ...
    iget-boolean v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mCommonCriteriaMode:Z
    ...
    iget v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mPasswordComplexity:I
    ...
    iget v7, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mNearbyNotificationStreamingPolicy:I

    invoke-virtual {v1, v2, v0, v7}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;I)V
    ...
    iget v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mNearbyAppStreamingPolicy:I
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mOrganizationId:Ljava/lang/String;
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mEnrollmentSpecificId:Ljava/lang/String;
    ...
    iget-boolean v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mAdminCanGrantSensorsPermissions:Z
    ...
    iget-boolean v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mUsbDataSignalingEnabled:Z
    ...
    iget v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mWifiMinimumSecurityLevel:I
    ...
    iget-object v6, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mWifiSsidPolicy:Landroid/app/admin/WifiSsidPolicy;

    invoke-virtual {v6}, Landroid/app/admin/WifiSsidPolicy;->getPolicyType()I
    ...
    invoke-virtual {v1, v2, v4, v7, v0}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValuesToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;)V
    ...
    check-cast v6, Landroid/app/admin/PreferentialNetworkServiceConfig;

    .line 673
    .local v6, "config":Landroid/app/admin/PreferentialNetworkServiceConfig;
    invoke-virtual {v6, v2}, Landroid/app/admin/PreferentialNetworkServiceConfig;->writeToXml(Lcom/android/modules/utils/TypedXmlSerializer;)V

    .line 674
    .end local v6    # "config":Landroid/app/admin/PreferentialNetworkServiceConfig;
    goto :goto_6
    ...
    iget-object v4, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mDialerPackage:Ljava/lang/String;
    ...
    iget-object v4, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mSmsPackage:Ljava/lang/String;

    invoke-virtual {v1, v2, v0, v4}, Lcom/android/server/devicepolicy/ActiveAdmin;->writeAttributeValueToXml(Lcom/android/modules/utils/TypedXmlSerializer;Ljava/lang/String;Ljava/lang/String;)V

    .line 698
    :cond_40
    iget-object v0, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mProvisioningContext:Ljava/lang/String;
    ...
    .line 700
    iget-object v4, v1, Lcom/android/server/devicepolicy/ActiveAdmin;->mProvisioningContext:Ljava/lang/String;

    invoke-interface {v2, v3, v5, v4}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
