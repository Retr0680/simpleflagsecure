...
.method public constructor <init>(Lcom/android/server/devicepolicy/DevicePolicyManagerService;Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;Landroid/os/Handler;)V
    ...
    iget-object v1, v0, Lcom/android/server/devicepolicy/DevicePolicyManagerService$Injector;->mContext:Landroid/content/Context;
...
.method private buildNotification(Landroid/os/UserHandle;I)Landroid/app/Notification;
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getProfileParentId(I)I
    ...
    .restart local v4    # "smallIconId":I
    goto :goto_0
    ...
    .line 205
    .local v11, "targetInfo":Landroid/content/pm/ActivityInfo;
    if-eqz v11, :cond_2
    ...
    .line 215
    .local v3, "arguments":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    ...
    invoke-direct {v5, v2, v6}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v6}, Landroid/util/PluralsMessageFormatter;->format(Landroid/content/res/Resources;Ljava/util/Map;I)Ljava/lang/String;
    ...
    .line 223
    invoke-virtual {v5, v9}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;
    ...
    .end local v1    # "notifyIntent":Landroid/app/PendingIntent;
    .end local v2    # "userContext":Landroid/content/Context;
    .end local v3    # "arguments":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;"
    .end local v4    # "dialogIntent":Landroid/content/Intent;
    .end local v8    # "parentUserId":I
    .end local v9    # "contentText":Ljava/lang/String;
    .end local v10    # "smallIconId":I
    .end local v11    # "targetInfo":Landroid/content/pm/ActivityInfo;
    :catch_0
    move-exception v0
    ...
    invoke-static {v3, v0, v1, v2}, Lcom/android/server/utils/Slogf;->e(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public installCaCert(Landroid/os/UserHandle;[B)Ljava/lang/String;
    ...
    invoke-interface {v5, v4}, Landroid/security/IKeyChainService;->installCaCertificate([B)Ljava/lang/String;
    ...
    invoke-static {v1, v0, v3}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    invoke-static {v1, v0, v3}, Lcom/android/server/utils/Slogf;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
