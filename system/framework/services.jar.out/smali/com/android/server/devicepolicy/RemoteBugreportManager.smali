...
.method private buildNotification(I)Landroid/app/Notification;
    ...
    .line 141
    .local v0, "targetInfo":Landroid/content/pm/ActivityInfo;
    if-eqz v0, :cond_0
    ...
    const-string v2, "Failed to resolve intent for remote bugreport dialog"
    ...
    .line 151
    .local p1, "pendingDialogIntent":Landroid/app/PendingIntent;
    ...
    .line 159
    invoke-virtual {v1, v5}, Landroid/app/Notification$Builder;->extend(Landroid/app/Notification$Extender;)Landroid/app/Notification$Builder;
    ...
    .line 164
    invoke-virtual {v5, v6, v6, v2}, Landroid/app/Notification$Builder;->setProgress(IIZ)Landroid/app/Notification$Builder;
    ...
    .line 175
    .local v2, "pendingIntentAccept":Landroid/app/PendingIntent;
    iget-object v5, p0, Lcom/android/server/devicepolicy/RemoteBugreportManager;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v7, v8, v9, v2}, Landroid/app/Notification$Action$Builder;-><init>(Landroid/graphics/drawable/Icon;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    .line 190
    .end local v2    # "pendingIntentAccept":Landroid/app/PendingIntent;
