...
.method public constructor <init>(Landroid/content/Context;Landroid/credentials/CredentialProviderInfo;Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;ILcom/android/server/credentials/RemoteCredentialService;Landroid/service/credentials/ClearCredentialStateRequest;)V
    ...
    .end local p3    # "callbacks":Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;
    .end local p4    # "userId":I
    .end local p5    # "remoteCredentialService":Lcom/android/server/credentials/RemoteCredentialService;
    .end local p6    # "providerRequest":Landroid/service/credentials/ClearCredentialStateRequest;
    .local v1, "context":Landroid/content/Context;
    .local v2, "providerRequest":Landroid/service/credentials/ClearCredentialStateRequest;
    .local v3, "callbacks":Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;
    .local v5, "userId":I
...
.method public static createNewSession(Landroid/content/Context;ILandroid/credentials/CredentialProviderInfo;Lcom/android/server/credentials/ClearRequestSession;Lcom/android/server/credentials/RemoteCredentialService;)Lcom/android/server/credentials/ProviderClearSession;
    ...
    .line 57
    .local v8, "providerRequest":Landroid/service/credentials/ClearCredentialStateRequest;
    ...
    .end local p2    # "providerInfo":Landroid/credentials/CredentialProviderInfo;
    .end local p3    # "clearRequestSession":Lcom/android/server/credentials/ClearRequestSession;
    .end local p4    # "remoteCredentialService":Lcom/android/server/credentials/RemoteCredentialService;
    .local v3, "context":Landroid/content/Context;
    .local v4, "providerInfo":Landroid/credentials/CredentialProviderInfo;
    .local v5, "clearRequestSession":Lcom/android/server/credentials/ClearRequestSession;
    .local v6, "userId":I
    .local v7, "remoteCredentialService":Lcom/android/server/credentials/RemoteCredentialService;
