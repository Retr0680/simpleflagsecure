...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/credentials/RequestSession$SessionLifetime;Ljava/lang/Object;IILandroid/credentials/IGetCandidateCredentialsCallback;Landroid/credentials/GetCredentialRequest;Landroid/service/credentials/CallingAppInfo;Ljava/util/Set;Landroid/os/CancellationSignal;Landroid/os/IBinder;)V
    ...
    iput-object v1, p0, Lcom/android/server/credentials/GetCandidateRequestSession;->mClientBinder:Landroid/os/IBinder;
    ...
    const-string v3, "autofill_session_id"
    ...
    iput v2, p0, Lcom/android/server/credentials/GetCandidateRequestSession;->mAutofillSessionId:I
    ...
    const-string v3, "autofill_request_id"

    invoke-virtual {v2, v3, v4}, Landroid/os/Bundle;->getInt(Ljava/lang/String;I)I

    move-result v2

    iput v2, p0, Lcom/android/server/credentials/GetCandidateRequestSession;->mAutofillRequestId:I
    ...
    const-string v3, "android.credentials.AUTOFILL_RESULT_RECEIVER"
    ...
    iput-object v2, p0, Lcom/android/server/credentials/GetCandidateRequestSession;->mAutofillCallback:Landroid/os/ResultReceiver;

    .line 88
    iget-object v2, p0, Lcom/android/server/credentials/GetCandidateRequestSession;->mClientBinder:Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v2}, Lcom/android/server/credentials/RequestSession;->setUpClientCallbackListener(Landroid/os/IBinder;)V
