...
.method protected constructor <init>(Landroid/content/Context;ILcom/android/server/credentials/GetRequestSession;Landroid/service/credentials/CallingAppInfo;Ljava/lang/String;Landroid/credentials/CredentialOption;)V
    ...
    .end local p3    # "session":Lcom/android/server/credentials/GetRequestSession;
    .end local p6    # "requestOption":Landroid/credentials/CredentialOption;
    .local v1, "context":Landroid/content/Context;
    .local v2, "requestOption":Landroid/credentials/CredentialOption;
    .local v3, "session":Lcom/android/server/credentials/GetRequestSession;
    .local v5, "userId":I
    ...
    iput-object p1, v0, Lcom/android/server/credentials/ProviderRegistryGetSession;->mUiCredentialEntries:Ljava/util/Map;
    ...
    iput-object p1, v0, Lcom/android/server/credentials/ProviderRegistryGetSession;->mCredentialDescriptionRegistry:Lcom/android/server/credentials/CredentialDescriptionRegistry;
    ...
    iput-object p1, v0, Lcom/android/server/credentials/ProviderRegistryGetSession;->mElementKeys:Ljava/util/Set;
    ...
    iput-object p1, v0, Lcom/android/server/credentials/ProviderSession;->mStatus:Lcom/android/server/credentials/ProviderSession$Status;
...
.method protected constructor <init>(Landroid/content/Context;ILcom/android/server/credentials/PrepareGetRequestSession;Landroid/service/credentials/CallingAppInfo;Ljava/lang/String;Landroid/credentials/CredentialOption;)V
    ...
    .end local p1    # "context":Landroid/content/Context;
    .end local p2    # "userId":I
    .end local p3    # "session":Lcom/android/server/credentials/PrepareGetRequestSession;
    .end local p6    # "requestOption":Landroid/credentials/CredentialOption;
    .local v1, "context":Landroid/content/Context;
    .local v2, "requestOption":Landroid/credentials/CredentialOption;
    .local v3, "session":Lcom/android/server/credentials/PrepareGetRequestSession;
    .local v5, "userId":I
    invoke-direct/range {v0 .. v6}, Lcom/android/server/credentials/ProviderSession;-><init>(Landroid/content/Context;Ljava/lang/Object;Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;Landroid/content/ComponentName;ILcom/android/server/credentials/RemoteCredentialService;)V
...
.method public static createNewSession(Landroid/content/Context;ILcom/android/server/credentials/GetRequestSession;Landroid/service/credentials/CallingAppInfo;Ljava/lang/String;Landroid/credentials/CredentialOption;)Lcom/android/server/credentials/ProviderRegistryGetSession;
    ...
    .end local p2    # "getRequestSession":Lcom/android/server/credentials/GetRequestSession;
    .end local p3    # "callingAppInfo":Landroid/service/credentials/CallingAppInfo;
    .end local p4    # "credentialProviderPackageName":Ljava/lang/String;
    .end local p5    # "requestOption":Landroid/credentials/CredentialOption;
    .local v1, "context":Landroid/content/Context;
    .local v2, "userId":I
    .local v3, "getRequestSession":Lcom/android/server/credentials/GetRequestSession;
    .local v4, "callingAppInfo":Landroid/service/credentials/CallingAppInfo;
    .local v5, "credentialProviderPackageName":Ljava/lang/String;
    .local v6, "requestOption":Landroid/credentials/CredentialOption;
...
.method public static createNewSession(Landroid/content/Context;ILcom/android/server/credentials/PrepareGetRequestSession;Landroid/service/credentials/CallingAppInfo;Ljava/lang/String;Landroid/credentials/CredentialOption;)Lcom/android/server/credentials/ProviderRegistryGetSession;
    ...
    .end local p0    # "context":Landroid/content/Context;
    .end local p1    # "userId":I
    .end local p2    # "getRequestSession":Lcom/android/server/credentials/PrepareGetRequestSession;
    .end local p3    # "callingAppInfo":Landroid/service/credentials/CallingAppInfo;
    .end local p4    # "credentialProviderPackageName":Ljava/lang/String;
    .end local p5    # "requestOption":Landroid/credentials/CredentialOption;
    .local v1, "context":Landroid/content/Context;
    .local v2, "userId":I
    .local v3, "getRequestSession":Lcom/android/server/credentials/PrepareGetRequestSession;
    .local v4, "callingAppInfo":Landroid/service/credentials/CallingAppInfo;
    .local v5, "credentialProviderPackageName":Ljava/lang/String;
    .local v6, "requestOption":Landroid/credentials/CredentialOption;
