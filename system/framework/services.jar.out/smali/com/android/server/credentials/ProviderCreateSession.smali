...
.method private constructor <init>(Landroid/content/Context;Landroid/credentials/CredentialProviderInfo;Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;ILcom/android/server/credentials/RemoteCredentialService;Landroid/service/credentials/BeginCreateCredentialRequest;Landroid/service/credentials/CreateCredentialRequest;Ljava/lang/String;)V
    ...
    .end local p3    # "callbacks":Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;, "Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback<Landroid/credentials/CreateCredentialResponse;>;"
    .end local p4    # "userId":I
    .end local p5    # "remoteCredentialService":Lcom/android/server/credentials/RemoteCredentialService;
    .end local p6    # "beginCreateRequest":Landroid/service/credentials/BeginCreateCredentialRequest;
    .local v1, "context":Landroid/content/Context;
    .local v2, "beginCreateRequest":Landroid/service/credentials/BeginCreateCredentialRequest;
    .local v3, "callbacks":Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;, "Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback<Landroid/credentials/CreateCredentialResponse;>;"
    .local v5, "userId":I
    .local v6, "remoteCredentialService":Lcom/android/server/credentials/RemoteCredentialService;
    ...
    .line 148
    iput-object p7, v0, Lcom/android/server/credentials/ProviderCreateSession;->mCompleteRequest:Landroid/service/credentials/CreateCredentialRequest;
    ...
    invoke-direct {p1, p0, p3}, Lcom/android/server/credentials/ProviderCreateSession$ProviderResponseDataHandler;-><init>(Lcom/android/server/credentials/ProviderCreateSession;Landroid/content/ComponentName;)V

    iput-object p1, v0, Lcom/android/server/credentials/ProviderCreateSession;->mProviderResponseDataHandler:Lcom/android/server/credentials/ProviderCreateSession$ProviderResponseDataHandler;
...
.method public static createNewSession(Landroid/content/Context;ILandroid/credentials/CredentialProviderInfo;Lcom/android/server/credentials/CreateRequestSession;Lcom/android/server/credentials/RemoteCredentialService;)Lcom/android/server/credentials/ProviderCreateSession;
    ...
    .line 81
    .local v7, "providerCreateRequest":Landroid/service/credentials/CreateCredentialRequest;
    if-eqz v7, :cond_0
