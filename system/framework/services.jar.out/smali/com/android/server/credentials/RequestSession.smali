...
.method protected constructor <init>(Landroid/content/Context;Lcom/android/server/credentials/RequestSession$SessionLifetime;Ljava/lang/Object;IILjava/lang/Object;Ljava/lang/Object;Ljava/lang/String;Landroid/service/credentials/CallingAppInfo;Ljava/util/Set;Landroid/os/CancellationSignal;JZ)V
    ...
    invoke-direct {v1, v0, v2}, Lcom/android/server/credentials/RequestSession$RequestSessionDeathRecipient;-><init>(Lcom/android/server/credentials/RequestSession;Lcom/android/server/credentials/RequestSession-IA;)V
    ...
    .line 150
    invoke-direct {v0}, Lcom/android/server/credentials/RequestSession;->setCancellationListener()V
...
.method private isRespondingWithError(I)Z
    .locals 1
...
.method private isRespondingWithSuccess(I)Z
    .locals 1
    .param p1, "apiStatus"    # I
...
.method private isRespondingWithUserCanceledError(I)Z
    .locals 1
    .param p1, "apiStatus"    # I
...
.method private logTrackOneCandidatesAndPrepareFinalPhaseLogs(I)V
    .locals 3
    .param p1, "apiStatus"    # I
    ...
    .line 275
    invoke-direct {p0, p1}, Lcom/android/server/credentials/RequestSession;->isRespondingWithError(I)Z
    ...
    sget-object v2, Lcom/android/server/credentials/metrics/ProviderStatusForMetrics;->FINAL_FAILURE:Lcom/android/server/credentials/metrics/ProviderStatusForMetrics;

    invoke-virtual {v0, v1, v2}, Lcom/android/server/credentials/metrics/RequestSessionMetric;->collectFinalPhaseProviderMetricStatus(ZLcom/android/server/credentials/metrics/ProviderStatusForMetrics;)V

    goto :goto_0

    .line 278
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/server/credentials/RequestSession;->isRespondingWithUserCanceledError(I)Z
    ...
    .line 282
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/server/credentials/RequestSession;->isRespondingWithSuccess(I)Z
    ...
    sget-object v2, Lcom/android/server/credentials/metrics/ProviderStatusForMetrics;->FINAL_SUCCESS:Lcom/android/server/credentials/metrics/ProviderStatusForMetrics;
...
.method protected finishSession(ZI)V
    ...
    .line 263
    invoke-direct {p0, p2}, Lcom/android/server/credentials/RequestSession;->logTrackOneCandidatesAndPrepareFinalPhaseLogs(I)V
...
.method protected respondToClientWithErrorAndFinish(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "Issue while responding to client with error : "
...
.method protected respondToClientWithResponseAndFinish(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0, v2}, Lcom/android/server/credentials/RequestSession;->finishSession(ZI)V
