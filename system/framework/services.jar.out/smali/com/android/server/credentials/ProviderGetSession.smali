...
.method public constructor <init>(Landroid/content/Context;Landroid/credentials/CredentialProviderInfo;Lcom/android/server/credentials/ProviderSession$ProviderInternalCallback;ILcom/android/server/credentials/RemoteCredentialService;Landroid/service/credentials/BeginGetCredentialRequest;Landroid/credentials/GetCredentialRequest;Landroid/service/credentials/CallingAppInfo;Ljava/util/Map;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/credentials/ProviderSession;->setStatus(Lcom/android/server/credentials/ProviderSession$Status;)V
    ...
    iput-object v1, p0, Lcom/android/server/credentials/ProviderGetSession;->mBeginGetOptionToCredentialOptionMap:Ljava/util/Map;

    .line 254
    new-instance v1, Lcom/android/server/credentials/ProviderGetSession$ProviderResponseDataHandler;
    ...
    invoke-direct {v1, p0, v3}, Lcom/android/server/credentials/ProviderGetSession$ProviderResponseDataHandler;-><init>(Lcom/android/server/credentials/ProviderGetSession;Landroid/content/ComponentName;)V

    iput-object v1, p0, Lcom/android/server/credentials/ProviderGetSession;->mProviderResponseDataHandler:Lcom/android/server/credentials/ProviderGetSession$ProviderResponseDataHandler;
...
.method private addToInitialRemoteResponse(Landroid/service/credentials/BeginGetCredentialResponse;Z)V
    ...
    .end local p2    # "isInitialResponse":Z
    .local v5, "isInitialResponse":Z
...
.method public static createNewSession(Landroid/content/Context;ILandroid/credentials/CredentialProviderInfo;Lcom/android/server/credentials/GetCandidateRequestSession;Lcom/android/server/credentials/RemoteCredentialService;)Lcom/android/server/credentials/ProviderGetSession;
    ...
    .line 134
    .local v7, "filteredRequest":Landroid/credentials/GetCredentialRequest;
    if-eqz v7, :cond_0
    ...
    .line 137
    .local v9, "beginGetOptionToCredentialOptionMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/credentials/CredentialOption;>;"
    ...
    .line 153
    .end local v9    # "beginGetOptionToCredentialOptionMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Landroid/credentials/CredentialOption;>;"
    :cond_0
