...
.method private createGameSessionLocked(I)V
    ...
    .line 517
    .local v4, "existingGameSessionRecord":Lcom/android/server/app/GameSessionRecord;
    ...
    const-string v3, "No existing game session record found for task (id: "
    ...
    const-string v2, "Existing game session for task (id: "

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, ") is not awaiting game session request. Ignoring."
    ...
    const-string v3, "Failed to create view host configuration for task (id"
    ...
    new-instance v1, Lcom/android/server/app/GameServiceProviderInstanceImpl$$ExternalSyntheticLambda4;

    invoke-direct {v1, p0, v4, p1}, Lcom/android/server/app/GameServiceProviderInstanceImpl$$ExternalSyntheticLambda4;-><init>(Lcom/android/server/app/GameServiceProviderInstanceImpl;Lcom/android/server/app/GameSessionRecord;I)V
    ...
    .line 568
    .local v6, "createGameSessionResultFuture":Lcom/android/internal/infra/AndroidFuture;, "Lcom/android/internal/infra/AndroidFuture<Landroid/service/games/CreateGameSessionResult;>;"
    ...
    .line 580
    .local p1, "unusedPostCreateGameSessionFuture":Lcom/android/internal/infra/AndroidFuture;, "Lcom/android/internal/infra/AndroidFuture<Ljava/lang/Void;>;"
    return-void
.end method
...
.method private restartGame(I)V
    ...
    invoke-virtual {v0, p1, v2}, Lcom/android/server/wm/ActivityTaskManagerInternal;->restartTaskActivityProcessIfVisible(ILjava/lang/String;)V
...
.method takeScreenshot(ILcom/android/internal/infra/AndroidFuture;)V
    ...
    .line 848
    .local v7, "gameSessionRecord":Lcom/android/server/app/GameSessionRecord;
    if-nez v7, :cond_0
    ...
    const-string v3, "No game session found for id: "
    ...
    .line 853
    .end local v7    # "gameSessionRecord":Lcom/android/server/app/GameSessionRecord;
    :catchall_0
    move-exception v0
    ...
    .restart local v7    # "gameSessionRecord":Lcom/android/server/app/GameSessionRecord;
    :cond_0
    :try_start_2
    monitor-exit v1
    :try_end_2
    ...
    :goto_1
    iget-object v1, p0, Lcom/android/server/app/GameServiceProviderInstanceImpl;->mBackgroundExecutor:Ljava/util/concurrent/Executor;
    ...
    .end local p1    # "taskId":I
    .end local p2    # "callback":Lcom/android/internal/infra/AndroidFuture;
    .local v5, "taskId":I
    .local v6, "callback":Lcom/android/internal/infra/AndroidFuture;
    ...
    .end local v6    # "callback":Lcom/android/internal/infra/AndroidFuture;
    .end local v7    # "gameSessionRecord":Lcom/android/server/app/GameSessionRecord;
    .restart local p1    # "taskId":I
    .restart local p2    # "callback":Lcom/android/internal/infra/AndroidFuture;
    :catchall_1
    move-exception v0
    ...
    .restart local v6    # "callback":Lcom/android/internal/infra/AndroidFuture;
    :goto_2
    :try_start_3
    monitor-exit v1
    :try_end_3
