...
.method public callJobFinishedInner(IZLjava/lang/String;)V
    ...
    .line 187
    invoke-virtual {v9, v0}, Lcom/android/server/content/SyncLogger;->jobParametersToString(Landroid/app/job/JobParameters;)Ljava/lang/String;
    ...
    .end local p3    # "why":Ljava/lang/String;
    .local v11, "why":Ljava/lang/String;
    :try_start_1
    ...
    .line 184
    invoke-virtual {v2, p3}, Lcom/android/server/content/SyncLogger;->log([Ljava/lang/Object;)V
    ...
    .line 191
    sget-object p3, Lcom/android/server/content/SyncJobService;->sJobParamsMap:Landroid/util/SparseArray;
    ...
    .line 195
    .end local v11    # "why":Ljava/lang/String;
    .restart local p3    # "why":Ljava/lang/String;
    :catchall_1
    move-exception v0
    ...
    .end local p3    # "why":Ljava/lang/String;
    .restart local v11    # "why":Ljava/lang/String;
    :goto_1
    monitor-exit v1
    :try_end_1
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 86
    :cond_0
    iget-object v0, v4, Lcom/android/server/content/SyncOperation;->target:Lcom/android/server/content/SyncStorageEngine$EndPoint;

    iget v0, v0, Lcom/android/server/content/SyncStorageEngine$EndPoint;->userId:I

    invoke-static {v0}, Lcom/android/server/content/SyncManager;->readyToSync(I)Z
    ...
    .line 95
    iget-boolean v1, v4, Lcom/android/server/content/SyncOperation;->isPeriodic:Z
