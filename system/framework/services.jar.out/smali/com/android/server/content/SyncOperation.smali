...
.method public constructor <init>(Landroid/accounts/Account;IILjava/lang/String;IILjava/lang/String;Landroid/os/Bundle;ZI)V
    ...
    invoke-direct {v1, p1, v9, p2}, Lcom/android/server/content/SyncStorageEngine$EndPoint;-><init>(Landroid/accounts/Account;Ljava/lang/String;I)V
...
.method static maybeCreateFromJobExtras(Landroid/os/PersistableBundle;)Lcom/android/server/content/SyncOperation;
    ...
    .line 294
    .local v13, "owningPackage":Ljava/lang/String;
    ...
    .line 306
    .local v8, "syncExtras":Landroid/os/PersistableBundle;
    if-eqz v8, :cond_2
    ...
    .end local v8    # "syncExtras":Landroid/os/PersistableBundle;
    .local v25, "syncExtras":Landroid/os/PersistableBundle;
    invoke-virtual {v0, v10}, Landroid/os/PersistableBundle;->getPersistableBundle(Ljava/lang/String;)Landroid/os/PersistableBundle;

    move-result-object v8

    .line 314
    .local v8, "accountsBundle":Landroid/os/PersistableBundle;
    ...
    invoke-direct {v9, v10, v1}, Landroid/accounts/Account;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v25    # "syncExtras":Landroid/os/PersistableBundle;
    ...
    .end local v8    # "syncExtras":Landroid/os/PersistableBundle;
    .end local v10    # "key":Ljava/lang/String;
    .restart local v25    # "syncExtras":Landroid/os/PersistableBundle;
    :goto_1
    ...
    .line 320
    .end local v25    # "syncExtras":Landroid/os/PersistableBundle;
    .restart local v8    # "syncExtras":Landroid/os/PersistableBundle;
    :cond_4
    ...
    iput v3, v10, Lcom/android/server/content/SyncOperation;->jobId:I

    .line 327
    const-string v3, "expectedRuntime"

    invoke-virtual {v0, v3}, Landroid/os/PersistableBundle;->getLong(Ljava/lang/String;)J

    move-result-wide v3

    iput-wide v3, v10, Lcom/android/server/content/SyncOperation;->expectedRuntime:J
    ...
    iput v3, v10, Lcom/android/server/content/SyncOperation;->retries:I
    ...
    iput-boolean v3, v10, Lcom/android/server/content/SyncOperation;->scheduleEjAsRegularJob:Z
