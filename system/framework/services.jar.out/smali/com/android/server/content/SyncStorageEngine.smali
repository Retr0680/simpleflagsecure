...
.method private parseAuthority(Lcom/android/modules/utils/TypedXmlPullParser;ILcom/android/server/content/SyncStorageEngine$AccountAuthorityValidator;)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    .local v18, "authority":Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    const-string v0, " enabled="
    ...
    invoke-direct {v2, v4, v8, v13}, Lcom/android/server/content/SyncStorageEngine$EndPoint;-><init>(Landroid/accounts/Account;Ljava/lang/String;I)V
    ...
    .line 1913
    .end local v18    # "authority":Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    .restart local v5    # "authority":Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    if-lez p2, :cond_5

    .line 1914
    iget-object v4, v5, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->periodicSyncs:Ljava/util/ArrayList;
    ...
    .line 1917
    .end local v5    # "authority":Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    .restart local v18    # "authority":Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    :cond_3
...
.method private parsePeriodicSync(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;)Landroid/content/PeriodicSync;
    ...
    iget-object v0, p2, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->periodicSyncs:Ljava/util/ArrayList;
...
.method private readAccountInfoLocked()V
    ...
    .line 1725
    .local v12, "random":Ljava/util/Random;
    const v7, 0x15180
    ...
    .line 1723
    .end local v12    # "random":Ljava/util/Random;
    .end local v16    # "parser":Lcom/android/modules/utils/TypedXmlPullParser;
    ...
    .line 1727
    .end local v8    # "parser":Lcom/android/modules/utils/TypedXmlPullParser;
    .restart local v16    # "parser":Lcom/android/modules/utils/TypedXmlPullParser;
    :goto_3
    ...
    invoke-interface/range {v16 .. v16}, Lcom/android/modules/utils/TypedXmlPullParser;->getDepth()I
    ...
    invoke-direct {v1, v10, v13, v12}, Lcom/android/server/content/SyncStorageEngine;->parseAuthority(Lcom/android/modules/utils/TypedXmlPullParser;ILcom/android/server/content/SyncStorageEngine$AccountAuthorityValidator;)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    .local v15, "highestAuthorityId":I
    goto/16 :goto_7

    .line 1740
    .end local v15    # "highestAuthorityId":I
    ...
    .end local v5    # "highestAuthorityId":I
    .local v17, "highestAuthorityId":I
    :try_start_6
    ...
    .line 1760
    .end local v17    # "highestAuthorityId":I
    .end local v18    # "nextId":I
    ...
    .end local v0    # "nextId":I
    .end local v5    # "highestAuthorityId":I
    .restart local v17    # "highestAuthorityId":I
    .restart local v18    # "nextId":I
    goto/16 :goto_7
    ...
    .line 1748
    invoke-direct {v1, v10}, Lcom/android/server/content/SyncStorageEngine;->parseListenForTickles(Lcom/android/modules/utils/TypedXmlPullParser;)V
    ...
    .line 1752
    invoke-direct {v1, v10, v8}, Lcom/android/server/content/SyncStorageEngine;->parsePeriodicSync(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;)Landroid/content/PeriodicSync;
    ...
    invoke-direct {v1, v10, v0}, Lcom/android/server/content/SyncStorageEngine;->parseExtra(Lcom/android/modules/utils/TypedXmlPullParser;Landroid/os/Bundle;)V
    ...
    :cond_10
    :goto_a
    invoke-direct {v1}, Lcom/android/server/content/SyncStorageEngine;->maybeMigrateSettingsForRenamedAuthorities()Z
...
.method private requestSync(Landroid/accounts/Account;IILjava/lang/String;Landroid/os/Bundle;III)V
    ...
    invoke-direct {v2, p1, p4, p2}, Lcom/android/server/content/SyncStorageEngine$EndPoint;-><init>(Landroid/accounts/Account;Ljava/lang/String;I)V
...
.method private requestSync(Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;ILandroid/os/Bundle;III)V
    ...
    .end local p4    # "syncExemptionFlag":I
    .end local p5    # "callingUid":I
    .end local p6    # "callingPid":I
    .local v3, "reason":I
    .local v4, "extras":Landroid/os/Bundle;
    .local v5, "syncExemptionFlag":I
    ...
    .restart local v5    # "syncExemptionFlag":I
    ...
    .line 2445
    invoke-virtual {p2, v4}, Landroid/content/SyncRequest$Builder;->setExtras(Landroid/os/Bundle;)Landroid/content/SyncRequest$Builder;

    move-result-object p2

    .line 2446
    .local p2, "req":Landroid/content/SyncRequest$Builder;
    ...
    iget-object p4, p1, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->target:Lcom/android/server/content/SyncStorageEngine$EndPoint;

    iget-object p4, p4, Lcom/android/server/content/SyncStorageEngine$EndPoint;->provider:Ljava/lang/String;

    invoke-virtual {p2, p3, p4}, Landroid/content/SyncRequest$Builder;->setSyncAdapter(Landroid/accounts/Account;Ljava/lang/String;)Landroid/content/SyncRequest$Builder;
    ...
    invoke-static {p3}, Landroid/content/ContentResolver;->requestSync(Landroid/content/SyncRequest;)V

    .line 2449
    .end local p2    # "req":Landroid/content/SyncRequest$Builder;
    :goto_0
    return-void
.end method
...
.method private setSyncableStateForEndPoint(Lcom/android/server/content/SyncStorageEngine$EndPoint;III)V
    ...
    :try_start_0
    invoke-direct {p0, p1, v2, v0}, Lcom/android/server/content/SyncStorageEngine;->getOrCreateAuthorityLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;IZ)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    .line 832
    .restart local v4    # "aInfo":Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    :cond_1
    :goto_0
    :try_start_2
...
.method private writeStatusInfoLocked(Ljava/io/OutputStream;)V
    ...
    .local v19, "periodicSyncTimesSize":I
    .local v20, "lastEventsSize":I
    const-wide v8, 0x20300000011L
    ...
    .end local v19    # "periodicSyncTimesSize":I
    .end local v20    # "lastEventsSize":I
    ...
    .end local v8    # "periodicSyncTimesSize":I
    .end local v9    # "lastEventsSize":I
    .restart local v19    # "periodicSyncTimesSize":I
    .restart local v20    # "lastEventsSize":I
    ...
    .end local v3    # "j":I
    .local v16, "lastFailureTimesSize":I
    .local v21, "j":I
    const-wide v2, 0x20300000012L
    ...
    .end local v16    # "lastFailureTimesSize":I
    .restart local v2    # "lastFailureTimesSize":I
    :cond_3
    move/from16 v16, v2
    ...
    .end local v2    # "lastFailureTimesSize":I
    .end local v3    # "j":I
    .restart local v16    # "lastFailureTimesSize":I
...
.method public removeStaleAccounts([Landroid/accounts/Account;I)V
    ...
    iget v6, v6, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->authorityId:I
...
.method public setBackoff(Lcom/android/server/content/SyncStorageEngine$EndPoint;JJ)V
    ...
    invoke-direct {p0, p1, v0, v10}, Lcom/android/server/content/SyncStorageEngine;->getOrCreateAuthorityLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;IZ)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    :cond_3
    iput-wide p2, v0, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->backoffTime:J

    .line 913
    iput-wide v7, v0, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->backoffDelay:J
    ...
    .line 919
    invoke-virtual {p0, v10, p1}, Lcom/android/server/content/SyncStorageEngine;->reportChange(ILcom/android/server/content/SyncStorageEngine$EndPoint;)V
...
.method public setMasterSyncAutomatically(ZIIII)V
    ...
    invoke-virtual {p0, v0, v2, p2}, Lcom/android/server/content/SyncStorageEngine;->reportChange(ILjava/lang/String;I)V
...
.method public setSyncAutomatically(Landroid/accounts/Account;ILjava/lang/String;ZIII)V
    ...
    invoke-direct {v0, v5, v9, v3}, Lcom/android/server/content/SyncStorageEngine$EndPoint;-><init>(Landroid/accounts/Account;Ljava/lang/String;I)V

    const/4 v6, 0x0

    const/4 v7, -0x1

    invoke-direct {v1, v0, v7, v6}, Lcom/android/server/content/SyncStorageEngine;->getOrCreateAuthorityLocked(Lcom/android/server/content/SyncStorageEngine$EndPoint;IZ)Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;
    ...
    const-string/jumbo v8, "setSyncAutomatically: already set to "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v8, ", doing nothing"
    ...
    iget v6, v0, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->syncable:I

    if-ne v6, v8, :cond_3

    .line 765
    iput v7, v0, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->syncable:I

    .line 767
    :cond_3
    iput-boolean v2, v0, Lcom/android/server/content/SyncStorageEngine$AuthorityInfo;->enabled:Z

    .line 768
    invoke-direct {v1}, Lcom/android/server/content/SyncStorageEngine;->writeAccountInfoLocked()V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/content/SyncStorageEngine;->reportChange(ILcom/android/server/content/SyncStorageEngine$EndPoint;)V

    .line 777
    invoke-virtual {v1}, Lcom/android/server/content/SyncStorageEngine;->queueBackup()V
...
.method public stopSyncEvent(JJLjava/lang/String;JJLjava/lang/String;I)V
    ...
    invoke-virtual {v1}, Lcom/android/server/content/SyncStorageEngine;->isClockValid()Z
    ...
    invoke-direct {v1}, Lcom/android/server/content/SyncStorageEngine;->getCurrentDayLocked()I
    ...
    .restart local v19    # "i":I
    :goto_6
    iget-object v3, v1, Lcom/android/server/content/SyncStorageEngine;->mDayStats:[Lcom/android/server/content/SyncStorageEngine$DayStats;
    ...
    .end local v2    # "writeStatisticsNow":Z
    .local v17, "writeStatisticsNow":Z
    iget v2, v12, Landroid/content/SyncStatusInfo$Stats;->numFailures:I

    const/16 v16, 0x1

    add-int/lit8 v2, v2, 0x1

    iput v2, v12, Landroid/content/SyncStatusInfo$Stats;->numFailures:I

    .line 1347
    iget-object v2, v15, Landroid/content/SyncStatusInfo;->todayStats:Landroid/content/SyncStatusInfo$Stats;

    iget v12, v2, Landroid/content/SyncStatusInfo$Stats;->numFailures:I

    add-int/lit8 v12, v12, 0x1

    iput v12, v2, Landroid/content/SyncStatusInfo$Stats;->numFailures:I

    .line 1349
    iget v2, v0, Lcom/android/server/content/SyncStorageEngine$SyncHistoryItem;->source:I

    invoke-virtual {v15, v2, v9, v10, v6}, Landroid/content/SyncStatusInfo;->setLastFailure(IJLjava/lang/String;)V

    .line 1351
    iget v2, v3, Lcom/android/server/content/SyncStorageEngine$DayStats;->failureCount:I

    const/16 v16, 0x1

    add-int/lit8 v2, v2, 0x1

    iput v2, v3, Lcom/android/server/content/SyncStorageEngine$DayStats;->failureCount:I
    ...
    .line 1355
    .end local v11    # "writeStatusNow":Z
    .end local v17    # "writeStatisticsNow":Z
    ...
    .end local v9    # "lastSyncTime":J
    .local v2, "day":I
    .restart local v17    # "writeStatisticsNow":Z
    ...
    .local v12, "ds":Lcom/android/server/content/SyncStorageEngine$DayStats;
    .local v16, "day":I
    const-wide/32 v2, 0x927c0

    invoke-virtual {v9, v10, v2, v3}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z

    goto :goto_c

    .line 1386
    .end local v12    # "ds":Lcom/android/server/content/SyncStorageEngine$DayStats;
    .end local v16    # "day":I
    ...
    .end local v2    # "day":I
    .end local v3    # "ds":Lcom/android/server/content/SyncStorageEngine$DayStats;
    .restart local v12    # "ds":Lcom/android/server/content/SyncStorageEngine$DayStats;
