...
.method public final findService(ILandroid/content/pm/IPackageManager;Lcom/android/server/appbinding/AppBindingConstants;)Landroid/content/pm/ServiceInfo;
    ...
    .end local p2    # "ipm":Landroid/content/pm/IPackageManager;
    .local v4, "userId":I
    ...
    .line 134
    .local p1, "service":Landroid/content/pm/ServiceInfo;
    if-nez p1, :cond_2
    ...
    .end local p1    # "service":Landroid/content/pm/ServiceInfo;
    ...
    .restart local v9    # "errorMessage":Ljava/lang/StringBuilder;
    .restart local p1    # "service":Landroid/content/pm/ServiceInfo;
    :cond_2
    ...
    .line 151
    :cond_3
    const-string v0, "Valid service found"

    .line 152
    .restart local v0    # "message":Ljava/lang/String;
    iget-object v2, p0, Lcom/android/server/appbinding/finders/AppServiceFinder;->mLastMessages:Landroid/util/SparseArray;

    const-string v5, "Valid service found"

    invoke-virtual {v2, v4, v5}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    .line 153
    iget-object v2, p0, Lcom/android/server/appbinding/finders/AppServiceFinder;->mTargetServices:Landroid/util/SparseArray;
    ...
    .end local v9    # "errorMessage":Ljava/lang/StringBuilder;
    .local p1, "userId":I
    .local p2, "ipm":Landroid/content/pm/IPackageManager;
    :catchall_2
    move-exception v0
