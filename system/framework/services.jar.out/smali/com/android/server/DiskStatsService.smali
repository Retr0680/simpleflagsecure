...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v0, v1, Lcom/android/server/DiskStatsService;->mContext:Landroid/content/Context;
    ...
    .local v11, "error":Ljava/io/IOException;
    :goto_6
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
    ...
    invoke-direct {v1, v14, v3}, Lcom/android/server/DiskStatsService;->hasOption([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v15

    .line 94
    .local v15, "protoFormat":Z
    const/4 v3, 0x0
    ...
    invoke-virtual {v3, v6, v7, v5}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V
    ...
    invoke-virtual {v3, v5, v6, v7}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V
    ...
    .restart local v8    # "tmp":Ljava/io/File;
    :goto_8
    move-object v5, v3
    ...
    .end local v16    # "junk":[B
    .end local v17    # "tmp":Ljava/io/File;
    .restart local v7    # "junk":[B
    .restart local v8    # "tmp":Ljava/io/File;
    ...
    .end local v7    # "junk":[B
    .end local v8    # "tmp":Ljava/io/File;
    .restart local v16    # "junk":[B
    .restart local v17    # "tmp":Ljava/io/File;
    if-eqz v11, :cond_8

    .line 107
    const-string v5, "Test-Error: "
    ...
    .line 112
    const-string/jumbo v5, "ms [512B Data Write]"
    ...
    .line 117
    invoke-direct {v1, v5}, Lcom/android/server/DiskStatsService;->reportDiskWriteSpeedProto(Landroid/util/proto/ProtoOutputStream;)V

    goto :goto_b

    .line 119
    :cond_9
    invoke-direct {v1, v2}, Lcom/android/server/DiskStatsService;->reportDiskWriteSpeed(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v5, v7, v8, v3}, Landroid/util/proto/ProtoOutputStream;->write(JI)V
    ...
    .line 145
    invoke-direct {v1, v5}, Lcom/android/server/DiskStatsService;->reportCachedValuesProto(Landroid/util/proto/ProtoOutputStream;)V

    goto :goto_d

    .line 147
    :cond_d
    invoke-direct {v1, v4}, Lcom/android/server/DiskStatsService;->reportCachedValues(Ljava/io/PrintWriter;)V
