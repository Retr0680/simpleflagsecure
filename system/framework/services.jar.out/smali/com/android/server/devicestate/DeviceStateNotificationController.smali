...
.method constructor <init>(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/Runnable;)V
    ...
    .end local p3    # "cancelStateRunnable":Ljava/lang/Runnable;
    .local v1, "context":Landroid/content/Context;
    .local v2, "handler":Landroid/os/Handler;
    .local v3, "cancelStateRunnable":Ljava/lang/Runnable;
...
.method showStateActiveNotificationIfNeeded(II)V
    ...
    check-cast v8, Lcom/android/server/devicestate/DeviceStateNotificationController$NotificationInfo;

    .line 103
    .local v8, "info":Lcom/android/server/devicestate/DeviceStateNotificationController$NotificationInfo;
    if-eqz v8, :cond_0

    invoke-virtual {v8}, Lcom/android/server/devicestate/DeviceStateNotificationController$NotificationInfo;->hasActiveNotification()Z
    ...
    .line 106
    :cond_1
    invoke-direct {p0, p2}, Lcom/android/server/devicestate/DeviceStateNotificationController;->getApplicationLabel(I)Ljava/lang/String;

    move-result-object v9

    .line 107
    .local v9, "requesterApplicationLabel":Ljava/lang/String;
    if-eqz v9, :cond_2

    .line 108
    new-instance v1, Landroid/content/Intent;

    const-string v2, "com.android.server.devicestate.INTENT_ACTION_CANCEL_STATE"
    ...
    iget-object v1, v8, Lcom/android/server/devicestate/DeviceStateNotificationController$NotificationInfo;->name:Ljava/lang/String;

    iget-object v2, v8, Lcom/android/server/devicestate/DeviceStateNotificationController$NotificationInfo;->activeNotificationTitle:Ljava/lang/String;

    iget-object v3, v8, Lcom/android/server/devicestate/DeviceStateNotificationController$NotificationInfo;->activeNotificationContent:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/server/devicestate/DeviceStateNotificationController;->mContext:Landroid/content/Context;
    ...
    .line 104
    .end local v9    # "requesterApplicationLabel":Ljava/lang/String;
    :goto_1
    return-void
.end method
