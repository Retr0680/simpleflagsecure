...
.method connectLocked(Ljava/lang/String;Ljava/lang/String;ILandroid/accessibilityservice/IBrailleDisplayController;)V
    ...
    iput-object v2, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mController:Landroid/accessibilityservice/IBrailleDisplayController;
    ...
    invoke-static {v4, v3}, Ljava/nio/file/Path;->of(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;

    move-result-object v3

    .line 175
    .local v3, "devicePath":Ljava/nio/file/Path;
    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    .line 176
    .local v4, "result":Ljava/util/List;, "Ljava/util/List<Landroid/util/Pair<Ljava/io/File;[B>;>;"
    iget-object v5, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mScanner:Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;

    invoke-interface {v5, v3}, Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;->getHidrawNodePaths(Ljava/nio/file/Path;)Ljava/util/Collection;

    move-result-object v5

    .line 177
    .local v5, "hidrawNodePaths":Ljava/util/Collection;, "Ljava/util/Collection<Ljava/nio/file/Path;>;"
    const/4 v6, 0x1

    const-string v7, "BrailleDisplayConnection"
    ...
    .line 179
    invoke-direct {v1, v6}, Lcom/android/server/accessibility/BrailleDisplayConnection;->sendConnectionErrorLocked(I)V
    ...
    .line 184
    .local v8, "unableToGetDescriptor":Z
    ...
    .line 185
    .local v10, "path":Ljava/nio/file/Path;
    ...
    invoke-interface {v11, v10}, Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;->getDeviceReportDescriptor(Ljava/nio/file/Path;)[B

    move-result-object v11

    .line 186
    .local v11, "descriptor":[B
    if-nez v11, :cond_1
    ...
    .line 191
    :cond_1
    iget-object v12, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mScanner:Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;

    invoke-interface {v12, v10}, Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;->getUniqueId(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .local v14, "matchesIdentifier":Z
    goto :goto_2

    .line 198
    .end local v14    # "matchesIdentifier":Z
    :cond_2
    move-object/from16 v13, p1

    iget-object v14, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mScanner:Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;

    invoke-interface {v14, v10}, Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;->getName(Ljava/nio/file/Path;)Ljava/lang/String;
    ...
    .local v14, "matchesIdentifier":Z
    :goto_2
    invoke-static {v11}, Lcom/android/server/accessibility/BrailleDisplayConnection;->isBrailleDisplay([B)Z

    move-result v16

    if-eqz v16, :cond_5

    iget-object v0, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mScanner:Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;

    .line 202
    invoke-interface {v0, v10}, Lcom/android/server/accessibility/BrailleDisplayConnection$BrailleDisplayScanner;->getDeviceBusType(Ljava/nio/file/Path;)I
    ...
    .line 206
    .end local v10    # "path":Ljava/nio/file/Path;
    .end local v11    # "descriptor":[B
    ...
    .line 215
    const-string v9, "Unable to access some HIDRAW node\'s descriptor"
    ...
    .line 218
    :cond_8
    const-string v9, "Unable to find a unique Braille display matching the provided device"
    ...
    iput-object v9, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mHidrawNode:Ljava/io/File;
    ...
    .line 230
    .local v9, "reportDescriptor":[B
    sget-object v0, Lcom/android/server/accessibility/BrailleDisplayConnection;->sConnectedNodes:Ljava/util/Set;

    iget-object v10, v1, Lcom/android/server/accessibility/BrailleDisplayConnection;->mHidrawNode:Ljava/io/File;
    ...
    .line 238
    invoke-direct {v1}, Lcom/android/server/accessibility/BrailleDisplayConnection;->startReadingLocked()V
    ...
    invoke-interface {v0, v1, v9}, Landroid/accessibilityservice/IBrailleDisplayController;->onConnected(Landroid/accessibilityservice/IBrailleDisplayConnection;[B)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 244
    .local v0, "e":Landroid/os/RemoteException;
    const-string v10, "Error calling onConnected"

    invoke-static {v7, v10, v0}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 245
    invoke-virtual {v1}, Lcom/android/server/accessibility/BrailleDisplayConnection;->disconnect()V
