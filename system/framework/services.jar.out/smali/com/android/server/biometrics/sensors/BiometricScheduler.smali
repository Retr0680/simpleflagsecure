...
.method public constructor <init>(ILcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;)V
    ...
    .end local p2    # "gestureAvailabilityDispatcher":Lcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;
...
.method public constructor <init>(Landroid/os/Handler;ILcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;Ljava/util/function/Supplier;Lcom/android/server/biometrics/sensors/UserSwitchProvider;)V
    ...
    .end local p3    # "gestureAvailabilityDispatcher":Lcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;
    .end local p4    # "currentUserRetriever":Ljava/util/function/Supplier;, "Ljava/util/function/Supplier<Ljava/lang/Integer;>;"
    .end local p5    # "userSwitchProvider":Lcom/android/server/biometrics/sensors/UserSwitchProvider;, "Lcom/android/server/biometrics/sensors/UserSwitchProvider<TT;TU;>;"
    .local v2, "handler":Landroid/os/Handler;
    .local v3, "sensorType":I
    .local v4, "gestureAvailabilityDispatcher":Lcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;
    .local v7, "currentUserRetriever":Ljava/util/function/Supplier;, "Ljava/util/function/Supplier<Ljava/lang/Integer;>;"
    .local v8, "userSwitchProvider":Lcom/android/server/biometrics/sensors/UserSwitchProvider;, "Lcom/android/server/biometrics/sensors/UserSwitchProvider<TT;TU;>;"
...
.method protected checkCurrentUserAndStartNextOperation()V
    ...
    const-string v4, "checkCurrentUserAndStartNextOperation nextUserId:"
    ...
    const-string v4, " isStartUserOperation:"
    ...
    invoke-virtual {v4}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;->isStartUserOperation()Z

    move-result v4

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v4, " mPendingOperation:"
    ...
    iget-object v5, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mUserSwitchProvider:Lcom/android/server/biometrics/sensors/UserSwitchProvider;

    if-eqz v5, :cond_4

    .line 325
    iget-object v4, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mUserSwitchProvider:Lcom/android/server/biometrics/sensors/UserSwitchProvider;

    .line 326
    invoke-interface {v4, v2}, Lcom/android/server/biometrics/sensors/UserSwitchProvider;->getStartUserClient(I)Lcom/android/server/biometrics/sensors/StartUserClient;

    move-result-object v4

    .line 327
    .local v4, "startClient":Lcom/android/server/biometrics/sensors/BaseClientMonitor;
    new-instance v5, Lcom/android/server/biometrics/sensors/BiometricScheduler$UserSwitchClientCallback;

    invoke-direct {v5, p0, v4}, Lcom/android/server/biometrics/sensors/BiometricScheduler$UserSwitchClientCallback;-><init>(Lcom/android/server/biometrics/sensors/BiometricScheduler;Lcom/android/server/biometrics/sensors/BaseClientMonitor;)V
    ...
    invoke-direct {v1, v4, v5, v3}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;-><init>(Lcom/android/server/biometrics/sensors/BaseClientMonitor;Lcom/android/server/biometrics/sensors/ClientMonitorCallback;I)V
    ...
    .line 333
    invoke-virtual {v4, v5}, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->start(Lcom/android/server/biometrics/sensors/ClientMonitorCallback;)V

    .line 334
    .end local v4    # "startClient":Lcom/android/server/biometrics/sensors/BaseClientMonitor;
    ...
    .line 339
    invoke-interface {v4, v0}, Lcom/android/server/biometrics/sensors/UserSwitchProvider;->getStopUserClient(I)Lcom/android/server/biometrics/sensors/StopUserClient;

    move-result-object v4

    iput-object v4, p0, Lcom/android/server/biometrics/sensors/BiometricScheduler;->mStopUserClient:Lcom/android/server/biometrics/sensors/StopUserClient;

    .line 340
    new-instance v4, Lcom/android/server/biometrics/sensors/BiometricScheduler$UserSwitchClientCallback;
    ...
    invoke-direct {v4, p0, v5}, Lcom/android/server/biometrics/sensors/BiometricScheduler$UserSwitchClientCallback;-><init>(Lcom/android/server/biometrics/sensors/BiometricScheduler;Lcom/android/server/biometrics/sensors/BaseClientMonitor;)V

    .line 343
    .local v4, "finishedCallback":Lcom/android/server/biometrics/sensors/BiometricScheduler$UserSwitchClientCallback;, "Lcom/android/server/biometrics/sensors/BiometricScheduler<TT;TU;>.UserSwitchClientCallback;"
    ...
    invoke-direct {v1, v5, v4, v3}, Lcom/android/server/biometrics/sensors/BiometricSchedulerOperation;-><init>(Lcom/android/server/biometrics/sensors/BaseClientMonitor;Lcom/android/server/biometrics/sensors/ClientMonitorCallback;I)V
    ...
    invoke-virtual {v1, v4}, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->start(Lcom/android/server/biometrics/sensors/ClientMonitorCallback;)V

    .line 348
    .end local v4    # "finishedCallback":Lcom/android/server/biometrics/sensors/BiometricScheduler$UserSwitchClientCallback;, "Lcom/android/server/biometrics/sensors/BiometricScheduler<TT;TU;>.UserSwitchClientCallback;"
    goto :goto_1
    ...
    const-string v4, "Cannot start next operation, remove unknow operation:"
    ...
    const-string v4, "Cannot start next operation, can\'t access operation:"
...
.method public scheduleClientMonitor(Lcom/android/server/biometrics/sensors/BaseClientMonitor;Lcom/android/server/biometrics/sensors/ClientMonitorCallback;)V
    ...
    const-string v1, "[SKIP] Operation from user of cloned app: "
    ...
    const-string v1, "[Cancelling Interruptable]: "
...
.method public startWatchdog()V
    ...
    const-string v2, "Current operation is null,no need to start watchdog"
