...
# instance fields
.field private final mEnrolledIdsFrameworkArray:[I

.field private final mEnrolledIdsHalList:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field private mIsDanglingFramework:Z

.field private mIsDanglingHal:Z
...
.method protected constructor <init>(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/os/IBinder;ILjava/lang/String;Ljava/util/List;Lcom/android/server/biometrics/sensors/BiometricUtils;ILcom/android/server/biometrics/log/BiometricLogger;Lcom/android/server/biometrics/log/BiometricContext;)V
    ...
    iput-object v1, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mUnknownHALTemplates:Ljava/util/List;
    ...
    iput-object v1, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mEnrolledIdsHalList:Ljava/util/List;

    .line 65
    move-object/from16 v1, p6

    iput-object v1, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mEnrolledList:Ljava/util/List;
    ...
    iput v2, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mInitialEnrolledSize:I

    .line 67
    move-object/from16 v2, p7

    iput-object v2, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mUtils:Lcom/android/server/biometrics/sensors/BiometricUtils;

    .line 69
    iget v3, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mInitialEnrolledSize:I

    new-array v3, v3, [I

    iput-object v3, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mEnrolledIdsFrameworkArray:[I
    ...
    .local v3, "i":I
    :goto_0
    iget v4, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mInitialEnrolledSize:I

    if-ge v3, v4, :cond_0

    .line 71
    iget-object v4, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mEnrolledIdsFrameworkArray:[I

    iget-object v5, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mEnrolledList:Ljava/util/List;
...
.method private doTemplateCleanup()V
    ...
    invoke-virtual {v4, v5, v7, v6}, Lcom/android/server/biometrics/log/BiometricLogger;->logOnUnEnrolled(III)V
...
.method private logEnumerationResult()V
    .locals 5
    ...
    invoke-direct {p0, v1}, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->listToArray(Ljava/util/List;)[I

    move-result-object v1

    .line 169
    .local v1, "idsHalArray":[I
    invoke-virtual {p0}, Lcom/android/server/biometrics/sensors/BaseClientMonitor;->getLogger()Lcom/android/server/biometrics/log/BiometricLogger;
    ...
    .line 169
    invoke-virtual {v2, v3, v0, v1, v4}, Lcom/android/server/biometrics/log/BiometricLogger;->logOnEnumerated(II[I[I)V
...
.method public onEnumerationResult(Landroid/hardware/biometrics/BiometricAuthenticator$Identifier;I)V
    ...
    iput-boolean v0, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mIsDanglingHal:Z
    ...
    iput-boolean v0, p0, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->mIsDanglingFramework:Z

    .line 86
    invoke-direct {p0}, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->doTemplateCleanup()V

    .line 87
    invoke-direct {p0}, Lcom/android/server/biometrics/sensors/InternalEnumerateClient;->logEnumerationResult()V
