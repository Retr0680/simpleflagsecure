...
.method private synthetic lambda$new$2(Ljava/lang/String;)Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;
    ...
    invoke-static {v1}, Landroid/hardware/fingerprint/FingerprintSensorConfigurations;->getIFingerprint(Ljava/lang/String;)Landroid/hardware/biometrics/fingerprint/IFingerprint;

    move-result-object v2

    .line 1058
    .local v2, "fp":Landroid/hardware/biometrics/fingerprint/IFingerprint;
    new-instance v0, Ljava/lang/StringBuilder;
    ...
    .line 1062
    :try_start_0
    new-instance v4, Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;

    invoke-virtual {p0}, Lcom/android/server/SystemService;->getContext()Landroid/content/Context;

    move-result-object v5

    iget-object v6, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mBiometricStateCallback:Lcom/android/server/biometrics/sensors/BiometricStateCallback;

    iget-object v7, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mAuthenticationStateListeners:Lcom/android/server/biometrics/sensors/AuthenticationStateListeners;
    ...
    iget-object v10, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mLockoutResetDispatcher:Lcom/android/server/biometrics/sensors/LockoutResetDispatcher;

    iget-object v11, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mGestureAvailabilityDispatcher:Lcom/android/server/biometrics/sensors/fingerprint/GestureAvailabilityDispatcher;

    iget-object v12, p0, Lcom/android/server/biometrics/sensors/fingerprint/FingerprintService;->mBiometricContext:Lcom/android/server/biometrics/log/BiometricContext;
    :try_end_0
    ...
    const-string v0, "Unable to get declared service: "
...
.method private synthetic lambda$new$3(Landroid/util/Pair;Z)Lcom/android/server/biometrics/sensors/fingerprint/aidl/FingerprintProvider;
    ...
    .local v9, "resetLockoutRequiresHardwareAuthToken":Z
