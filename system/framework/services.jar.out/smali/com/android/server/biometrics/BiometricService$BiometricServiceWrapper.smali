...
.method synthetic constructor <init>(Lcom/android/server/biometrics/BiometricService;Lcom/android/server/biometrics/BiometricService-IA;)V
    .locals 0
...
.method public canAuthenticate(Ljava/lang/String;III)I
    ...
    invoke-static {v0, p4}, Lcom/android/server/biometrics/Utils;->isValidAuthenticatorConfig(Landroid/content/Context;I)Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1297
    .local v5, "clearSchedulerBuffer":Z
    new-instance v0, Ljava/lang/StringBuilder;
    ...
    iget-object v4, v4, Lcom/android/server/biometrics/BiometricService;->mSensors:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 1303
    invoke-interface {v7, v5}, Landroid/hardware/biometrics/IBiometricAuthenticator;->dumpSensorServiceStateProto(Z)[B
    ...
    invoke-virtual {v0, v8, v9, v7}, Landroid/util/proto/ProtoOutputStream;->write(J[B)V
    ...
    .end local v5    # "clearSchedulerBuffer":Z
    goto :goto_2
...
.method public getAuthenticatorIds(I)[J
    ...
    .line 1125
    invoke-interface {v2, p1}, Lcom/nothing/server/ext/INtDualAppsService;->isDualAppsUserId(I)Z
...
.method public getSensorProperties(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, v1, Lcom/android/server/biometrics/BiometricService;->mSensors:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public hasEnrolledBiometrics(ILjava/lang/String;)Z
    ...
    .line 1012
    invoke-interface {v0, p1}, Lcom/nothing/server/ext/INtDualAppsService;->isDualAppsUserId(I)Z
...
.method public invalidateAuthenticatorIds(IILandroid/hardware/biometrics/IInvalidationCallback;)V
    ...
    invoke-static {v0, v1, p1, p2, p3}, Lcom/android/server/biometrics/BiometricService$InvalidationTracker;->start(Landroid/content/Context;Ljava/util/List;IILandroid/hardware/biometrics/IInvalidationCallback;)Lcom/android/server/biometrics/BiometricService$InvalidationTracker;
...
.method public registerAuthenticator(IIILandroid/hardware/biometrics/IBiometricAuthenticator;)V
    ...
    new-instance v1, Lcom/android/server/biometrics/BiometricService$BiometricServiceWrapper$1;
    ...
    .local v5, "modality":I
    .local v6, "strength":I
    .local v7, "authenticator":Landroid/hardware/biometrics/IBiometricAuthenticator;
    ...
    .line 1074
    iget-object p1, v2, Lcom/android/server/biometrics/BiometricService$BiometricServiceWrapper;->this$0:Lcom/android/server/biometrics/BiometricService;
    ...
    .end local v7    # "authenticator":Landroid/hardware/biometrics/IBiometricAuthenticator;
...
.method public registerEnabledOnKeyguardCallback(Landroid/hardware/biometrics/IBiometricEnabledOnKeyguardCallback;)V
    ...
    invoke-virtual {v4, v3, v5}, Lcom/android/server/biometrics/BiometricService$SettingObserver;->getEnabledOnKeyguard(II)Z

    move-result v4

    invoke-interface {p1, v4, v3, v5}, Landroid/hardware/biometrics/IBiometricEnabledOnKeyguardCallback;->onChanged(ZII)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
