...
.method filterAndApplyChunkInternal(Landroid/hardware/broadcastradio/ProgramListChunk;II)Ljava/util/List;
    ...
    .line 214
    .local v3, "modified":Ljava/util/Set;, "Ljava/util/Set<Landroid/hardware/radio/RadioManager$ProgramInfo;>;"
    const/4 v0, 0x0
    ...
    const-string v2, "BcRadioAidlSrv.cache"
    ...
    .line 223
    .local v2, "primaryId":Landroid/hardware/radio/ProgramSelector$Identifier;
    invoke-direct {p0, v2}, Lcom/android/server/broadcastradio/aidl/ProgramInfoCache;->passesFilter(Landroid/hardware/radio/ProgramSelector$Identifier;)Z
    ...
    invoke-direct {p0, v1}, Lcom/android/server/broadcastradio/aidl/ProgramInfoCache;->shouldIncludeInModified(Landroid/hardware/radio/RadioManager$ProgramInfo;)Z
    ...
    .end local v2    # "primaryId":Landroid/hardware/radio/ProgramSelector$Identifier;
    :cond_3
    :goto_1
    add-int/lit8 v0, v0, 0x1
    ...
    .line 230
    .local v5, "removed":Ljava/util/Set;, "Ljava/util/Set<Landroid/hardware/radio/UniqueProgramIdentifier;>;"
    ...
    .line 234
    .local v1, "removedId":Landroid/hardware/radio/ProgramSelector$Identifier;
    if-nez v1, :cond_5
    ...
    const-string v6, "Removed identifier %s in program list chunk is not valid"

    invoke-static {v2, v6, v4}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 231
    .end local v1    # "removedId":Landroid/hardware/radio/ProgramSelector$Identifier;
    :cond_6
    :goto_3
    add-int/lit8 v0, v0, 0x1
    ...
    .end local p2    # "maxNumModifiedPerChunk":I
    .end local p3    # "maxNumRemovedPerChunk":I
    .local v4, "maxNumModifiedPerChunk":I
    .local v6, "maxNumRemovedPerChunk":I
...
.method filterAndUpdateFromInternal(Lcom/android/server/broadcastradio/aidl/ProgramInfoCache;ZII)Ljava/util/List;
    ...
    .line 169
    .local v2, "modified":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/hardware/radio/RadioManager$ProgramInfo;>;"
    new-instance v4, Landroid/util/ArraySet;

    invoke-direct {v4}, Landroid/util/ArraySet;-><init>()V

    .line 170
    .local v4, "removed":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/hardware/radio/UniqueProgramIdentifier;>;"
    const/4 p2, 0x0
    ...
    .line 184
    .local v6, "newInfo":Landroid/hardware/radio/RadioManager$ProgramInfo;
    invoke-direct {p0, v6}, Lcom/android/server/broadcastradio/aidl/ProgramInfoCache;->shouldIncludeInModified(Landroid/hardware/radio/RadioManager$ProgramInfo;)Z
    ...
    .line 187
    :cond_4
    invoke-direct {p0, v6}, Lcom/android/server/broadcastradio/aidl/ProgramInfoCache;->putInfo(Landroid/hardware/radio/RadioManager$ProgramInfo;)V

    .line 188
    invoke-virtual {v2, v6}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z

    .line 180
    .end local v6    # "newInfo":Landroid/hardware/radio/RadioManager$ProgramInfo;
    :goto_4
    ...
    .line 194
    .end local p2    # "removedIndex":I
    iget-boolean p2, p1, Lcom/android/server/broadcastradio/aidl/ProgramInfoCache;->mComplete:Z
    ...
    .end local p3    # "maxNumModifiedPerChunk":I
    .end local p4    # "maxNumRemovedPerChunk":I
    .local v3, "maxNumModifiedPerChunk":I
    .local v5, "maxNumRemovedPerChunk":I
