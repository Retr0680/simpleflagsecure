...
.method private static amfmConfigToBands(Landroid/hardware/broadcastradio/V2_0/AmFmRegionConfig;)[Landroid/hardware/radio/RadioManager$BandDescriptor;
    ...
    check-cast v15, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;

    .line 205
    .local v15, "range":Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;
    iget v3, v15, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->lowerBound:I
    ...
    .line 206
    .local v3, "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    ...
    iget v6, v15, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->lowerBound:I

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo v6, "kHz"
    ...
    const-string v6, "BcRadio2Srv.convert"

    invoke-static {v6, v5}, Lcom/android/server/utils/Slogf;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .end local v3    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    .local v5, "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    new-instance v3, Landroid/hardware/radio/RadioManager$FmBandDescriptor;

    iget v6, v15, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->lowerBound:I

    iget v7, v15, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->upperBound:I

    iget v8, v15, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->spacing:I
    ...
    .end local v5    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    .local v9, "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    const/4 v5, 0x1

    move-object v10, v9

    .end local v9    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    .local v10, "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    const/4 v9, 0x1

    move-object v11, v10

    .end local v10    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    .local v11, "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    const/4 v10, 0x1

    move-object/from16 v16, v11

    .end local v11    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    ...
    .restart local v3    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    :cond_2
    move-object/from16 v16, v3

    .end local v3    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    .restart local v16    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    new-instance v3, Landroid/hardware/radio/RadioManager$AmBandDescriptor;
    ...
    .line 225
    .end local v15    # "range":Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;
    .end local v16    # "bandType":Lcom/android/server/broadcastradio/hal2/FrequencyBand;
    :goto_1
    goto :goto_0
...
.method static propertiesFromHal(ILjava/lang/String;Landroid/hardware/broadcastradio/V2_0/Properties;Landroid/hardware/broadcastradio/V2_0/AmFmRegionConfig;Ljava/util/List;)Landroid/hardware/radio/RadioManager$ModuleProperties;
    ...
    .line 244
    .local v17, "supportedIdentifierTypes":[I
    ...
    iget-object v1, v0, Landroid/hardware/broadcastradio/V2_0/Properties;->vendorInfo:Ljava/util/ArrayList;
