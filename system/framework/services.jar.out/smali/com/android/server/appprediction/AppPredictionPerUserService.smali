...
.method private getRemoteServiceLocked()Lcom/android/server/appprediction/RemoteAppPredictionService;
    ...
    new-instance v2, Lcom/android/server/appprediction/RemoteAppPredictionService;
    ...
    iput-object v2, v7, Lcom/android/server/appprediction/AppPredictionPerUserService;->mRemoteService:Lcom/android/server/appprediction/RemoteAppPredictionService;
    ...
    .line 397
    :goto_0
    iget-object v0, v7, Lcom/android/server/appprediction/AppPredictionPerUserService;->mRemoteService:Lcom/android/server/appprediction/RemoteAppPredictionService;
...
.method public onCreatePredictionSessionLocked(Landroid/app/prediction/AppPredictionContext;Landroid/app/prediction/AppPredictionSessionId;Landroid/os/IBinder;)V
    ...
    .end local v0    # "usesPeopleService":Z
    .local v4, "usesPeopleService":Z
    :goto_0
    ...
    invoke-virtual {p0, p2, v1, v4, v0}, Lcom/android/server/appprediction/AppPredictionPerUserService;->resolveService(Landroid/app/prediction/AppPredictionSessionId;ZZLcom/android/internal/infra/AbstractRemoteService$AsyncRequest;)Z
    ...
    .end local p1    # "context":Landroid/app/prediction/AppPredictionContext;
    .end local p2    # "sessionId":Landroid/app/prediction/AppPredictionSessionId;
    .end local p3    # "token":Landroid/os/IBinder;
    .local v2, "sessionId":Landroid/app/prediction/AppPredictionSessionId;
    .local v3, "context":Landroid/app/prediction/AppPredictionContext;
    ...
    .line 142
    :cond_1
    invoke-virtual {p0, v2}, Lcom/android/server/appprediction/AppPredictionPerUserService;->onDestroyPredictionSessionLocked(Landroid/app/prediction/AppPredictionSessionId;)V

    goto :goto_1

    .line 131
    .end local v1    # "sessionInfo":Lcom/android/server/appprediction/AppPredictionPerUserService$AppPredictionSessionInfo;
    .end local v2    # "sessionId":Landroid/app/prediction/AppPredictionSessionId;
    .end local v3    # "context":Landroid/app/prediction/AppPredictionContext;
    .end local v5    # "token":Landroid/os/IBinder;
    .restart local p1    # "context":Landroid/app/prediction/AppPredictionContext;
    ...
    .end local p2    # "sessionId":Landroid/app/prediction/AppPredictionSessionId;
    .end local p3    # "token":Landroid/os/IBinder;
    .restart local v2    # "sessionId":Landroid/app/prediction/AppPredictionSessionId;
    .restart local v3    # "context":Landroid/app/prediction/AppPredictionContext;
