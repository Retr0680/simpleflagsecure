...
.method static createFromXml(Lorg/xmlpull/v1/XmlPullParser;ILandroid/content/Context;Lcom/android/server/blob/BlobStoreManagerService$SessionStateChangeListener;)Lcom/android/server/blob/BlobStoreSession;
    ...
    .line 607
    .local v7, "ownerPackageName":Ljava/lang/String;
    ...
    .local v5, "blobHandle":Landroid/app/blob/BlobHandle;
    .local v11, "blobAccessMode":Lcom/android/server/blob/BlobAccessMode;
    :cond_1
    :goto_1
    ...
    .line 624
    const-string v10, "blobHandle should be available"

    invoke-static {v2, v10}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 628
    const-string v10, "blobAccessMode should be available"
    ...
    .end local p3    # "stateChangeListener":Lcom/android/server/blob/BlobStoreManagerService$SessionStateChangeListener;
    .local v2, "context":Landroid/content/Context;
    .local v10, "stateChangeListener":Lcom/android/server/blob/BlobStoreManagerService$SessionStateChangeListener;
    ...
    .line 634
    .local v1, "blobStoreSession":Lcom/android/server/blob/BlobStoreSession;
    iget-object p2, v1, Lcom/android/server/blob/BlobStoreSession;->mBlobAccessMode:Lcom/android/server/blob/BlobAccessMode;

    invoke-virtual {p2, v11}, Lcom/android/server/blob/BlobAccessMode;->allow(Lcom/android/server/blob/BlobAccessMode;)V
