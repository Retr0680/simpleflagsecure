...
.method private acquireLeaseInternal(Landroid/app/blob/BlobHandle;ILjava/lang/CharSequence;JILjava/lang/String;)V
    ...
    .line 456
    :try_start_0
    invoke-direct {p0, v1, v7}, Lcom/android/server/blob/BlobStoreManagerService;->getLeasedBlobsCountLocked(ILjava/lang/String;)I
    ...
    iget-wide v2, p1, Landroid/app/blob/BlobHandle;->expiryTimeMillis:J
    ...
    const-string v2, "Lease expiry cannot be later than blobs expiry time"
    ...
    .line 473
    .restart local v9    # "leasesCount":I
    :goto_0
    ...
    .line 474
    .local v10, "blobMetadata":Lcom/android/server/blob/BlobMetadata;
    if-eqz v10, :cond_2

    invoke-virtual {v10, v7, v1}, Lcom/android/server/blob/BlobMetadata;->isAccessAllowedForCaller(Ljava/lang/String;I)Z
    ...
    .line 489
    :cond_3
    invoke-virtual {v10}, Lcom/android/server/blob/BlobMetadata;->getSize()J

    move-result-wide v2

    .line 490
    invoke-direct {p0, v1, v7}, Lcom/android/server/blob/BlobStoreManagerService;->getRemainingLeaseQuotaBytesInternal(ILjava/lang/String;)J
    ...
    .line 500
    invoke-virtual {v10}, Lcom/android/server/blob/BlobMetadata;->getBlobId()J
    ...
    .end local v10    # "blobMetadata":Lcom/android/server/blob/BlobMetadata;
    ...
    .line 505
    .end local v0    # "blobMetadata":Lcom/android/server/blob/BlobMetadata;
    .restart local v10    # "blobMetadata":Lcom/android/server/blob/BlobMetadata;
    :try_start_2
    ...
    const-string v3, "Acquired lease on "
...
.method private createSessionInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)J
    ...
    new-instance v4, Lcom/android/server/blob/BlobStoreSession;

    iget-object v5, p0, Lcom/android/server/blob/BlobStoreManagerService;->mContext:Landroid/content/Context;

    iget-object v11, p0, Lcom/android/server/blob/BlobStoreManagerService;->mSessionStateChangeListener:Lcom/android/server/blob/BlobStoreManagerService$SessionStateChangeListener;
    :try_end_0
    ...
    .local v8, "blobHandle":Landroid/app/blob/BlobHandle;
    .local v9, "callingUid":I
    .local v10, "callingPackage":Ljava/lang/String;
    :try_start_1
    invoke-direct/range {v4 .. v11}, Lcom/android/server/blob/BlobStoreSession;-><init>(Landroid/content/Context;JLandroid/app/blob/BlobHandle;ILjava/lang/String;Lcom/android/server/blob/BlobStoreManagerService$SessionStateChangeListener;)V
    ...
    invoke-direct {p0, v4, p1}, Lcom/android/server/blob/BlobStoreManagerService;->addSessionForUserLocked(Lcom/android/server/blob/BlobStoreSession;I)V
    ...
    .restart local v4    # "session":Lcom/android/server/blob/BlobStoreSession;
    .restart local v6    # "sessionId":J
    :cond_0
    :goto_0
    invoke-direct {p0}, Lcom/android/server/blob/BlobStoreManagerService;->writeBlobSessionsAsync()V
    ...
    .end local v4    # "session":Lcom/android/server/blob/BlobStoreSession;
    .end local v6    # "sessionId":J
    .end local v8    # "blobHandle":Landroid/app/blob/BlobHandle;
    ...
    .end local p2    # "callingUid":I
    .end local p3    # "callingPackage":Ljava/lang/String;
    .restart local v8    # "blobHandle":Landroid/app/blob/BlobHandle;
...
.method private static synthetic lambda$queryBlobsForUserInternal$7(ILjava/util/function/Function;Landroid/app/blob/BlobHandle;Ljava/util/ArrayList;Lcom/android/server/blob/BlobMetadata$Leasee;)V
    ...
    :goto_2
    new-instance v1, Landroid/app/blob/LeaseInfo;
...
.method private static synthetic lambda$queryBlobsForUserInternal$8(ILjava/util/function/Function;Ljava/util/ArrayList;Landroid/app/blob/BlobHandle;Lcom/android/server/blob/BlobMetadata;)V
    ...
    .line 600
    .local v9, "leaseInfos":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/blob/LeaseInfo;>;"
...
.method private onStateChangedInternal(Lcom/android/server/blob/BlobStoreSession;)V
    ...
    :goto_1
    new-instance v11, Lcom/android/server/blob/BlobMetadata$Committer;
    ...
    .line 733
    .local v11, "newCommitter":Lcom/android/server/blob/BlobMetadata$Committer;
    invoke-virtual {v7, v11}, Lcom/android/server/blob/BlobMetadata;->addOrReplaceCommitter(Lcom/android/server/blob/BlobMetadata$Committer;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 735
    :try_start_1
    invoke-direct {v1}, Lcom/android/server/blob/BlobStoreManagerService;->writeBlobsInfoLocked()V
    ...
    .line 742
    :try_start_2
    invoke-virtual {v7, v11}, Lcom/android/server/blob/BlobMetadata;->removeCommitter(Lcom/android/server/blob/BlobMetadata$Committer;)V
    ...
    .line 755
    iget-object v5, v1, Lcom/android/server/blob/BlobStoreManagerService;->mBlobsMap:Landroid/util/ArrayMap;
    ...
    const-string v6, "Successfully committed session "
    ...
    .end local v11    # "newCommitter":Lcom/android/server/blob/BlobMetadata$Committer;
    ...
    .line 775
    :try_start_4
    invoke-direct {v1}, Lcom/android/server/blob/BlobStoreManagerService;->writeBlobSessionsLocked()V
    :try_end_4
...
.method private openBlobInternal(Landroid/app/blob/BlobHandle;ILjava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-virtual {v0, p3, p2}, Lcom/android/server/blob/BlobMetadata;->isAccessAllowedForCaller(Ljava/lang/String;I)Z
    ...
    .line 424
    invoke-virtual {v0, p3, p2}, Lcom/android/server/blob/BlobMetadata;->openForRead(Ljava/lang/String;I)Landroid/os/ParcelFileDescriptor;
    ...
    .line 407
    .restart local v0    # "blobMetadata":Lcom/android/server/blob/BlobMetadata;
    :goto_0
    if-nez v0, :cond_2
...
.method private registerReceivers()V
    ...
    .line 251
    .local v4, "packageChangedFilter":Landroid/content/IntentFilter;
    ...
    invoke-direct {v2, p0, v0}, Lcom/android/server/blob/BlobStoreManagerService$PackageChangedReceiver;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Lcom/android/server/blob/BlobStoreManagerService-IA;)V
    ...
    .line 258
    .local v8, "userActionFilter":Landroid/content/IntentFilter;
    ...
    invoke-direct {v6, p0, v0}, Lcom/android/server/blob/BlobStoreManagerService$UserActionReceiver;-><init>(Lcom/android/server/blob/BlobStoreManagerService;Lcom/android/server/blob/BlobStoreManagerService-IA;)V
