...
.method public writeUid(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats;Landroid/os/BatteryStats$Uid;)V
    ...
    invoke-virtual {v1, v6, v15, v14}, Landroid/os/health/HealthStatsWriter;->addStats(ILjava/lang/String;Landroid/os/health/HealthStatsWriter;)V
    ...
    .line 155
    .local v7, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    new-instance v12, Landroid/os/health/HealthStatsWriter;

    sget-object v13, Landroid/os/health/PackageHealthStats;->CONSTANTS:Landroid/os/health/HealthKeys$Constants;

    invoke-direct {v12, v13}, Landroid/os/health/HealthStatsWriter;-><init>(Landroid/os/health/HealthKeys$Constants;)V

    .line 156
    .local v12, "writer":Landroid/os/health/HealthStatsWriter;
    invoke-interface {v7}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Landroid/os/BatteryStats$Uid$Pkg;

    invoke-virtual {v0, v12, v13}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->writePkg(Landroid/os/health/HealthStatsWriter;Landroid/os/BatteryStats$Uid$Pkg;)V
    ...
    invoke-virtual {v1, v14, v13, v12}, Landroid/os/health/HealthStatsWriter;->addStats(ILjava/lang/String;Landroid/os/health/HealthStatsWriter;)V

    .line 158
    .end local v7    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;+Landroid/os/BatteryStats$Uid$Pkg;>;"
    .end local v12    # "writer":Landroid/os/health/HealthStatsWriter;
    goto :goto_7
    ...
    .line 171
    .local v9, "counter":Landroid/os/BatteryStats$LongCounter;
    ...
    .line 170
    .end local v9    # "counter":Landroid/os/BatteryStats$LongCounter;
    ...
    invoke-virtual {v1, v7, v14, v15}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
    ...
    .line 209
    .restart local v15    # "counter":Landroid/os/BatteryStats$LongCounter;
    invoke-virtual {v15, v8}, Landroid/os/BatteryStats$LongCounter;->getCountLocked(I)J
    ...
    .line 219
    invoke-virtual {v3, v12, v13, v8}, Landroid/os/BatteryStats$Uid;->getWifiRunningTime(JI)J
    ...
    .line 223
    invoke-virtual {v3, v12, v13, v8}, Landroid/os/BatteryStats$Uid;->getFullWifiLockTime(JI)J
    ...
    invoke-virtual {v1, v9, v7, v12, v13}, Landroid/os/health/HealthStatsWriter;->addTimer(IIJ)V
    ...
    .line 232
    invoke-virtual {v3, v12, v13, v8}, Landroid/os/BatteryStats$Uid;->getWifiMulticastTime(JI)J
    ...
    invoke-direct {v0, v1, v12, v9}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v9, v12}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v13, v12}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-direct {v0, v1, v12, v13}, Lcom/android/server/am/HealthStatsBatteryStatsWriter;->addTimer(Landroid/os/health/HealthStatsWriter;ILandroid/os/BatteryStats$Timer;)V
    ...
    invoke-virtual {v1, v15, v13, v14}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
    ...
    invoke-virtual {v1, v10, v13, v14}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
    ...
    invoke-virtual {v1, v13, v9, v10}, Landroid/os/health/HealthStatsWriter;->addMeasurement(IJ)V
