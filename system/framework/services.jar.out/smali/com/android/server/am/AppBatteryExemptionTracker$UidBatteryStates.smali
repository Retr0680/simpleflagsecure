...
.method constructor <init>(ILjava/lang/String;Lcom/android/server/am/BaseAppStateEvents$MaxTrackingDurationConfig;)V
    ...
    .end local p3    # "maxTrackingDurationConfig":Lcom/android/server/am/BaseAppStateEvents$MaxTrackingDurationConfig;
    .local v1, "uid":I
    .local v4, "tag":Ljava/lang/String;
    .local v5, "maxTrackingDurationConfig":Lcom/android/server/am/BaseAppStateEvents$MaxTrackingDurationConfig;
...
.method add(Ljava/util/LinkedList;Ljava/util/LinkedList;)Ljava/util/LinkedList;
    ...
    .end local v0    # "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    .local v25, "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    ...
    invoke-virtual {v8, v0}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->add(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    goto :goto_4

    .end local v25    # "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    .restart local v0    # "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    :cond_8
    move-object/from16 v25, v0

    .line 331
    .end local v0    # "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    .restart local v25    # "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    :goto_4
    if-eqz v6, :cond_9
    ...
    .local v1, "actCur":Z
    .local v17, "itr":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    if-eq v1, v0, :cond_21
    ...
    .line 358
    .local v0, "event":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    if-eqz v1, :cond_20
    ...
    .local v18, "l":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .local v20, "r":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    sub-long v2, v28, v26
    ...
    invoke-direct {v2, v8}, Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;-><init>(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)V

    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;->update(Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;)V
    ...
    invoke-virtual {v8, v2}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->setTo(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .line 358
    .end local v18    # "l":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .end local v19    # "actCur":Z
    .end local v20    # "r":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    ...
    .local v1, "actCur":Z
    .local v2, "l":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .restart local v3    # "r":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .local v5, "actl":Z
    .restart local v6    # "actr":Z
    .restart local v9    # "recentActTs":J
    :cond_20
    ...
    .end local v6    # "actr":Z
    .end local v9    # "recentActTs":J
    .restart local v18    # "l":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .restart local v19    # "actCur":Z
    .restart local v20    # "r":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    ...
    .line 355
    .end local v0    # "event":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .end local v18    # "l":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .end local v19    # "actCur":Z
    .end local v20    # "r":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .end local v22    # "actl":Z
    ...
    .end local v13    # "lts":J
    .end local v15    # "rts":J
    .end local v17    # "itr":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    .end local v18    # "l":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .end local v20    # "r":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    .end local v22    # "actl":Z
    .end local v23    # "recentActTs":J
...
.method addEvent(ZJLcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;I)V
    ...
    .line 249
    .local v5, "last":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    if-eqz v5, :cond_1
    ...
    .line 259
    .end local v5    # "last":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    :goto_0
    return-void

    .line 253
    .restart local v5    # "last":Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;
    :goto_1
    return-void
.end method
...
.method getBatteryUsageSince(JJI)Landroid/util/Pair;
    ...
    .end local v0    # "result":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    .local v1, "i":I
    .local v7, "result":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Lcom/android/server/am/AppBatteryExemptionTracker$UidStateEventWithBattery;>;"
    :goto_0
