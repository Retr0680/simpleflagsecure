...
.method static launchBugReportHandlerApp(Landroid/content/Context;)Z
    ...
    invoke-static {v1}, Lcom/android/server/am/BugReportHandlerUtil;->isBugReportHandlerEnabled(Landroid/content/Context;)Z
    ...
    .line 82
    :cond_0
    invoke-static {v1}, Lcom/android/server/am/BugReportHandlerUtil;->getCustomBugReportHandlerApp(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 87
    :cond_1
    invoke-static {v1}, Lcom/android/server/am/BugReportHandlerUtil;->getCustomBugReportHandlerUser(Landroid/content/Context;)I

    move-result v2

    .line 88
    .local v2, "handlerUser":I
    ...
    .line 89
    invoke-static {v1}, Lcom/android/server/am/BugReportHandlerUtil;->getDefaultBugReportHandlerApp(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 91
    :cond_2
    invoke-static {v1, v0, v2}, Lcom/android/server/am/BugReportHandlerUtil;->getBugReportHandlerAppReceivers(Landroid/content/Context;Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 103
    invoke-static {v1}, Lcom/android/server/am/BugReportHandlerUtil;->resetCustomBugreportHandlerAppAndUser(Landroid/content/Context;)V
    ...
    .end local v2    # "handlerUser":I
    .local v13, "handlerApp":Ljava/lang/String;
    .local v14, "handlerUser":I
    :goto_0
    invoke-static {v13}, Lcom/android/server/am/BugReportHandlerUtil;->isShellApp(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_6

    invoke-static {v13}, Lcom/android/server/am/BugReportHandlerUtil;->isValidBugReportHandlerApp(Ljava/lang/String;)Z
    ...
    .line 107
    invoke-static {v1, v13, v14}, Lcom/android/server/am/BugReportHandlerUtil;->getBugReportHandlerAppReceivers(Landroid/content/Context;Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 112
    :cond_4
    invoke-static {v1, v13, v14}, Lcom/android/server/am/BugReportHandlerUtil;->getBugReportHandlerAppResponseReceivers(Landroid/content/Context;Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 117
    invoke-static {v1, v13, v14}, Lcom/android/server/am/BugReportHandlerUtil;->launchBugReportHandlerApp(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    const-string v2, "Getting response from bug report handler app: "
    ...
    const-string v3, "com.android.internal.intent.action.GET_BUGREPORT_HANDLER_RESPONSE"
    ...
    invoke-direct {v7, v13, v14}, Lcom/android/server/am/BugReportHandlerUtil$BugreportHandlerResponseBroadcastReceiver;-><init>(Ljava/lang/String;I)V
    :try_end_1
