...
.method constructor <init>(ILjava/lang/String;IJLjava/lang/String;Lcom/android/server/am/BaseAppStateEvents$MaxTrackingDurationConfig;)V
    ...
    .end local p3    # "numOfEventTypes":I
    .end local p6    # "tag":Ljava/lang/String;
    .end local p7    # "maxTrackingDurationConfig":Lcom/android/server/am/BaseAppStateEvents$MaxTrackingDurationConfig;
    .local v1, "uid":I
    .local v2, "packageName":Ljava/lang/String;
    .local v3, "numOfEventTypes":I
    ...
    iput-object p1, v0, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->mCurSlotStartTime:[J
...
.method add(Lcom/android/server/am/BaseAppStateEvents;)V
    ...
    .local v16, "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    .local v17, "itr":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    int-to-long v7, v15
    ...
    .line 108
    :goto_2
    cmp-long v25, v22, v13

    if-ltz v25, :cond_6

    cmp-long v25, v22, v11
    ...
    .local v15, "events":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .local v24, "dest":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    ...
    .end local v15    # "events":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .end local v24    # "dest":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .restart local v5    # "events":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .restart local v6    # "dest":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    :cond_7
    move-object v15, v5
    ...
    .restart local v15    # "events":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .restart local v24    # "dest":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    iget-object v5, v0, Lcom/android/server/am/BaseAppStateEvents;->mEvents:[Ljava/util/LinkedList;
    ...
    iget-object v6, v2, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->mCurSlotStartTime:[J
    ...
    invoke-virtual {v0, v5, v6}, Lcom/android/server/am/BaseAppStateEvents;->getEarliest(J)J

    move-result-wide v5

    invoke-virtual {v0, v5, v6, v3}, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->trimEvents(JI)V
    ...
    .end local v13    # "minr":J
    .end local v15    # "events":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .end local v16    # "itl":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    .end local v17    # "itr":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/lang/Integer;>;"
    .end local v18    # "latest":J
    .end local v20    # "earliest":J
    .end local v24    # "dest":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    .restart local v5    # "events":Ljava/util/LinkedList;, "Ljava/util/LinkedList<Ljava/lang/Integer;>;"
    :cond_9
    move-object v15, v5
...
.method getTotalEventsSince(JJI)I
    ...
    .line 125
    .local v2, "start":J
    iget-object v4, p0, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->mCurSlotStartTime:[J
    ...
    invoke-virtual {p0, v4, v5}, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->getSlotStartTime(J)J
    ...
    .line 131
    .local v8, "count":I
    iget-object v9, p0, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->mCurSlotStartTime:[J
    ...
    .end local v11    # "val":I
    :cond_2
    iget-wide v11, p0, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->mTimeSlotSize:J
