...
.method handleNewEvent(Ljava/lang/String;I)V
    ...
    .line 90
    .local v0, "pkgEvents":Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$SimpleAppStateTimeslotEvents;, "TU;"
    if-nez v0, :cond_1
    ...
    invoke-virtual {v3, p2, p1, v0}, Lcom/android/server/am/UidProcessMap;->put(ILjava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_1
    ...
    .line 97
    .end local v0    # "pkgEvents":Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$SimpleAppStateTimeslotEvents;, "TU;"
    :catchall_0
    move-exception v0
    ...
    .line 94
    .restart local v0    # "pkgEvents":Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$SimpleAppStateTimeslotEvents;, "TU;"
    :cond_1
    :goto_0
    const/4 v3, 0x0

    :try_start_2
    invoke-virtual {v0, v6, v7, v3}, Lcom/android/server/am/BaseAppStateTimeSlotEvents;->addEvent(JI)V

    .line 95
    invoke-virtual {v0, v6, v7, v3}, Lcom/android/server/am/BaseAppStateEvents;->getTotalEvents(JI)I

    move-result v5

    .line 96
    .local v5, "totalEvents":I
    ...
    invoke-virtual {v4}, Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$BaseAppStateTimeSlotEventsPolicy;->getNumOfEventsThreshold()I
...
.method onNumOfEventsThresholdChanged(I)V
    ...
    .line 116
    .local v0, "pkgEvents":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;TU;>;>;"
    ...
    .line 120
    .local v7, "pkg":Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$SimpleAppStateTimeslotEvents;, "TU;"
    const/4 v8, 0x0
    ...
    .line 127
    .end local v0    # "pkgEvents":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;TU;>;>;"
    .end local v2    # "i":I
    .end local v3    # "pkgs":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;TU;>;"
    .end local v6    # "j":I
    .end local v7    # "pkg":Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$SimpleAppStateTimeslotEvents;, "TU;"
    ...
    .line 118
    .restart local v0    # "pkgEvents":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/ArrayMap<Ljava/lang/String;TU;>;>;"
    ...
    .line 130
    .restart local v7    # "pkg":Lcom/android/server/am/BaseAppStateTimeSlotEventsTracker$SimpleAppStateTimeslotEvents;, "TU;"
    iget-object v0, p0, Lcom/android/server/am/BaseAppStateTracker;->mInjector:Lcom/android/server/am/BaseAppStateTracker$Injector;
    ...
    iget-object v1, v7, Lcom/android/server/am/BaseAppStateEvents;->mPackageName:Ljava/lang/String;
