...
.method private synthetic lambda$onProcessActive$0(Lcom/android/internal/app/procstats/ProcessState;Lcom/android/server/am/ProcessStatsService;ILcom/android/internal/app/procstats/ProcessState;Ljava/lang/String;Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;)V
    ...
    .end local p3    # "attributionUid":I
    .end local p5    # "pkgName":Ljava/lang/String;
    .end local p6    # "holder":Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;
    .local v1, "tracker":Lcom/android/server/am/ProcessStatsService;
    .local v2, "holder":Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;
    .local v3, "pkgName":Ljava/lang/String;
    .local v4, "attributionUid":I
    ...
    .line 296
    iget-object p2, v2, Lcom/android/internal/app/procstats/ProcessStats$ProcessStateHolder;->state:Lcom/android/internal/app/procstats/ProcessState;
    ...
    invoke-virtual {p2}, Lcom/android/internal/app/procstats/ProcessState;->makeActive()V
...
.method addPss(JJJZIJ)V
    ...
    .line 530
    .local v3, "tracker":Lcom/android/internal/app/procstats/ProcessState;
    if-eqz v3, :cond_0
    ...
    .line 532
    .local v15, "pkgList":Lcom/android/server/am/PackageList;
    monitor-enter v15
    :try_end_0
    ...
    .line 537
    .end local v3    # "tracker":Lcom/android/internal/app/procstats/ProcessState;
    .end local v15    # "pkgList":Lcom/android/server/am/PackageList;
...
.method onProcessActive(Landroid/app/IApplicationThread;Lcom/android/server/am/ProcessStatsService;)V
    ...
    .line 280
    .end local v8    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    ...
    .line 280
    .restart local v2    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    .restart local v15    # "pkgList":Lcom/android/server/am/PackageList;
    :catchall_1
    move-exception v0
    ...
    .end local v2    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    .restart local v8    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    :catchall_2
    move-exception v0
    ...
    iget-object v5, v1, Lcom/android/server/am/ProcessProfileRecord;->mApp:Lcom/android/server/am/ProcessRecord;
    ...
    .end local v4    # "attributionUid":I
    .local v10, "attributionUid":I
    ...
    .line 288
    .end local v10    # "attributionUid":I
    .restart local v4    # "attributionUid":I
    .local v5, "baseProcessTracker":Lcom/android/internal/app/procstats/ProcessState;
    ...
    .end local v2    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    .end local v4    # "attributionUid":I
    .end local v5    # "baseProcessTracker":Lcom/android/internal/app/procstats/ProcessState;
...
.method onProcessInactive(Lcom/android/server/am/ProcessStatsService;)V
    ...
    .line 314
    .local v3, "origBase":Lcom/android/internal/app/procstats/ProcessState;
    const/4 v0, 0x0
    ...
    .line 316
    .local v9, "pkgList":Lcom/android/server/am/PackageList;
    monitor-enter v9
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 323
    new-instance v4, Lcom/android/server/am/ProcessProfileRecord$$ExternalSyntheticLambda0;

    invoke-direct {v4, v3}, Lcom/android/server/am/ProcessProfileRecord$$ExternalSyntheticLambda0;-><init>(Lcom/android/internal/app/procstats/ProcessState;)V

    invoke-virtual {v9, v4}, Lcom/android/server/am/PackageList;->forEachPackageProcessStats(Ljava/util/function/Consumer;)V
    :try_end_3
    ...
    .line 332
    .end local v3    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    .end local v9    # "pkgList":Lcom/android/server/am/PackageList;
    :catchall_0
    move-exception v0
    ...
    .line 320
    .restart local v3    # "origBase":Lcom/android/internal/app/procstats/ProcessState;
    .restart local v9    # "pkgList":Lcom/android/server/am/PackageList;
    :catchall_1
    move-exception v0
...
.method setProcessTrackerState(II)V
    ...
    .line 555
    .local v2, "tracker":Lcom/android/internal/app/procstats/ProcessState;
    if-eqz v2, :cond_1
    ...
    .line 565
    .end local v2    # "tracker":Lcom/android/internal/app/procstats/ProcessState;
    .end local v5    # "now":J
    ...
    .end local v3    # "procState":I
    .end local v4    # "memFactor":I
    .restart local v2    # "tracker":Lcom/android/internal/app/procstats/ProcessState;
    .restart local p1    # "procState":I
    .restart local p2    # "memFactor":I
    :cond_0
    move v3, p1
