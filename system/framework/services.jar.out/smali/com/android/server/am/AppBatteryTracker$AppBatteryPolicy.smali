...
.method private hasLocation(IJJ)Z
    ...
    invoke-virtual {v0, v2, v3, p1}, Lcom/android/server/am/BaseAppStateTracker$Injector;->checkPermission(Ljava/lang/String;II)I
    ...
    .line 2030
    .local v4, "controller":Lcom/android/server/am/AppRestrictionController;
    const/16 v10, 0x8
    ...
    .line 2032
    .local v10, "locationDuration":J
    iget-wide v8, p0, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainLocationMinDuration:J
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-super {v1, v7, v2}, Lcom/android/server/am/BaseAppStatePolicy;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    .line 2112
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainRestrictedBucketThreshold:[F
    ...
    .line 2122
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainBgRestrictedThreshold:[F
    ...
    .line 2132
    iget-wide v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainWindowMs:J
    ...
    .line 2136
    iget-wide v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainInteractionGracePeriodMs:J
    ...
    .line 2140
    iget-wide v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainMediaPlaybackMinDuration:J
    ...
    .line 2144
    iget-wide v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainLocationMinDuration:J
    ...
    .line 2148
    iget-boolean v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainEventDurationBasedThresholdEnabled:Z
    ...
    .line 2152
    iget-boolean v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainAutoRestrictAbusiveAppsEnabled:Z
    ...
    .line 2156
    iget v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainRestrictedBucketTypes:I
    ...
    .line 2160
    iget v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainBgRestrictedTypes:I
    ...
    .line 2164
    iget v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainPowerComponents:I
    ...
    .line 2168
    iget v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainExemptedTypes:I
    ...
    .line 2172
    iget-boolean v0, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainHighThresholdByBgLocation:Z
    ...
    .line 2175
    iget v0, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBatteryFullChargeMah:I
    ...
    .line 2180
    iget-object v11, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mLock:Ljava/lang/Object;

    monitor-enter v11

    .line 2181
    :try_start_0
    iget-object v0, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mHighBgBatteryPackages:Landroid/util/SparseArray;
    ...
    .line 2186
    iget-object v2, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mHighBgBatteryPackages:Landroid/util/SparseArray;
    ...
    .line 2187
    .local v2, "uid":I
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mHighBgBatteryPackages:Landroid/util/SparseArray;
    ...
    .line 2189
    .local v14, "pair":Landroid/util/Pair;, "Landroid/util/Pair<[J[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    ...
    .line 2191
    .local v19, "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    move-wide v3, v4

    .end local v4    # "now":J
    .local v3, "now":J
    iget-wide v5, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainWindowMs:J
    ...
    .end local v13    # "i":I
    .local v16, "i":I
    invoke-static/range {v20 .. v20}, Landroid/os/UserHandle;->formatUid(I)Ljava/lang/String;

    move-result-object v13

    iget-object v2, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainRestrictedBucketThreshold:[F
    ...
    iget-object v2, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainBgRestrictedThreshold:[F
    ...
    .line 2198
    invoke-direct/range {v1 .. v6}, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->formatHighBgBatteryRecord(JJLcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;)Ljava/lang/String;
    ...
    .end local v14    # "pair":Landroid/util/Pair;, "Landroid/util/Pair<[J[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    .end local v16    # "i":I
    ...
    .line 2193
    invoke-virtual {v7, v5, v6}, Ljava/io/PrintWriter;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    ...
    .end local v18    # "ts":[J
    .end local v19    # "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    .end local v20    # "uid":I
...
.method handleUidBatteryUsage(ILcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;)V
    ...
    .line 1892
    .local v8, "notifyController":Z
    const/4 v9, 0x0

    .line 1893
    .local v9, "excessive":Z
    const/4 v10, 0x0
    ...
    invoke-direct {v1, v0, v3}, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->sumPercentageOfTypes([DI)D

    move-result-wide v11

    .line 1896
    .local v11, "rbPercentage":D
    invoke-virtual/range {p2 .. p2}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->getPercentage()[D
    ...
    .line 1898
    .local v13, "brPercentage":D
    iget-object v15, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mLock:Ljava/lang/Object;

    monitor-enter v15

    .line 1899
    :try_start_0
    iget-object v0, v1, Lcom/android/server/am/BaseAppStatePolicy;->mTracker:Lcom/android/server/am/BaseAppStateTracker;
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/am/AppRestrictionController;->getRestrictionLevel(I)I
    ...
    :cond_1
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mLastInteractionTime:Landroid/util/SparseLongArray;
    ...
    .line 1905
    .local v16, "lastInteractionTime":J
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    .line 1909
    iget-boolean v6, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainDecoupleThresholds:Z

    .line 1910
    .local v6, "decoupleThresholds":Z
    ...
    .line 1912
    .local v3, "brThreshold":D
    move-wide/from16 v24, v3

    .end local v3    # "brThreshold":D
    .local v24, "brThreshold":D
    const/4 v3, 0x2
    ...
    .end local v5    # "thresholdIndex":I
    .local v27, "thresholdIndex":I
    iget-wide v4, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainInteractionGracePeriodMs:J
    ...
    .end local v18    # "ts":[J
    .local v4, "ts":[J
    aput-wide v20, v4, v26

    .line 1920
    new-array v5, v3, [Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;

    .line 1921
    .end local v19    # "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    .local v5, "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    aput-object p2, v5, v26
    ...
    .end local v6    # "decoupleThresholds":Z
    .local v29, "decoupleThresholds":Z
    ...
    .line 1916
    .end local v4    # "ts":[J
    .end local v5    # "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    .end local v29    # "decoupleThresholds":Z
    .restart local v6    # "decoupleThresholds":Z
    .restart local v18    # "ts":[J
    .restart local v19    # "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    :cond_2
    move/from16 v29, v6

    .line 1926
    .end local v6    # "decoupleThresholds":Z
    .restart local v29    # "decoupleThresholds":Z
    :goto_0
    const/4 v9, 0x1
    ...
    .line 1915
    .end local v27    # "thresholdIndex":I
    .end local v29    # "decoupleThresholds":Z
    .local v5, "thresholdIndex":I
    .restart local v6    # "decoupleThresholds":Z
    :cond_3
    ...
    .end local v5    # "thresholdIndex":I
    .end local v6    # "decoupleThresholds":Z
    .restart local v27    # "thresholdIndex":I
    .restart local v29    # "decoupleThresholds":Z
    :goto_1
    if-eqz v29, :cond_5

    cmpl-double v3, v13, v24
    ...
    .restart local v19    # "usages":[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    :cond_4
    aput-wide v20, v18, v28

    .line 1935
    aput-object p2, v19, v28
    ...
    .line 1941
    .local v3, "pair":Landroid/util/Pair;, "Landroid/util/Pair<[J[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    ...
    .line 1943
    .local v5, "lastRestrictBucketTs":J
    cmpl-double v30, v11, v22
    ...
    .end local v4    # "ts":[J
    .end local v5    # "lastRestrictBucketTs":J
    .local v30, "ts":[J
    .local v31, "lastRestrictBucketTs":J
    iget-wide v4, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainInteractionGracePeriodMs:J
    ...
    .line 1943
    .end local v30    # "ts":[J
    .end local v31    # "lastRestrictBucketTs":J
    .restart local v4    # "ts":[J
    .restart local v5    # "lastRestrictBucketTs":J
    :cond_9
    move-object/from16 v30, v4
    ...
    .restart local v31    # "lastRestrictBucketTs":J
    :goto_2
    ...
    iget-wide v4, v1, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainWindowMs:J
    ...
    .end local v9    # "excessive":Z
    .local v4, "excessive":Z
    goto :goto_5

    .line 1976
    .end local v4    # "excessive":Z
    .restart local v9    # "excessive":Z
    :cond_d
    aput-wide v18, v30, v28
    ...
    .line 1981
    .end local v0    # "curLevel":I
    .end local v3    # "pair":Landroid/util/Pair;, "Landroid/util/Pair<[J[Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    .end local v16    # "lastInteractionTime":J
    .end local v20    # "now":J
    .end local v22    # "rbThreshold":D
    .end local v24    # "brThreshold":D
    .end local v27    # "thresholdIndex":I
    .end local v29    # "decoupleThresholds":Z
    .end local v30    # "ts":[J
    .end local v31    # "lastRestrictBucketTs":J
    ...
    invoke-virtual {v0, v2, v3, v4, v5}, Lcom/android/server/am/AppRestrictionController;->refreshAppRestrictionLevelForUid(IIIZ)V
