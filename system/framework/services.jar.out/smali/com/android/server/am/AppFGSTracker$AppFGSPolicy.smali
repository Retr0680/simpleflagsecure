...
.method constructor <init>(Lcom/android/server/am/BaseAppStateTracker$Injector;Lcom/android/server/am/AppFGSTracker;)V
    ...
    .end local p2    # "tracker":Lcom/android/server/am/AppFGSTracker;
    .local v1, "injector":Lcom/android/server/am/BaseAppStateTracker$Injector;
    .local v2, "tracker":Lcom/android/server/am/AppFGSTracker;
    ...
    iput-wide p1, v0, Lcom/android/server/am/AppFGSTracker$AppFGSPolicy;->mBgFgsLongRunningThresholdMs:J

    .line 854
    const-wide/32 p1, 0xdbba00

    iput-wide p1, v0, Lcom/android/server/am/AppFGSTracker$AppFGSPolicy;->mBgFgsMediaPlaybackThresholdMs:J

    .line 860
    iput-wide p1, v0, Lcom/android/server/am/AppFGSTracker$AppFGSPolicy;->mBgFgsLocationThresholdMs:J
...
.method getExemptionReasonString(Ljava/lang/String;II)Ljava/lang/String;
    ...
    const-string/jumbo v1, "{mediaPlayback="
...
.method onLongRunningFgs(Ljava/lang/String;II)V
    ...
    .line 957
    :cond_2
    iget-object p1, v1, Lcom/android/server/am/BaseAppStatePolicy;->mTracker:Lcom/android/server/am/BaseAppStateTracker;

    check-cast p1, Lcom/android/server/am/AppFGSTracker;

    iget-object p1, p1, Lcom/android/server/am/BaseAppStateTracker;->mAppRestrictionController:Lcom/android/server/am/AppRestrictionController;

    invoke-virtual {p1, v2, v3}, Lcom/android/server/am/AppRestrictionController;->postLongRunningFgsIfNecessary(Ljava/lang/String;I)V
