...
.method appNotResponding(Z)V
    ...
    .end local p1    # "onlyDumpSelf":Z
    .local v9, "onlyDumpSelf":Z
    :try_start_1
    ...
    .line 423
    iget-object p1, p0, Lcom/android/server/am/AnrHelper$AnrRecord;->mTimeoutRecord:Lcom/android/internal/os/TimeoutRecord;

    iget-object p1, p1, Lcom/android/internal/os/TimeoutRecord;->mLatencyTracker:Lcom/android/internal/os/anr/AnrLatencyTracker;

    invoke-virtual {p1}, Lcom/android/internal/os/anr/AnrLatencyTracker;->anrProcessingEnded()V
    ...
    .end local v9    # "onlyDumpSelf":Z
    .restart local p1    # "onlyDumpSelf":Z
    :catchall_1
    move-exception v0
    ...
    .end local p1    # "onlyDumpSelf":Z
    .restart local v9    # "onlyDumpSelf":Z
    :goto_0
    iget-object v0, p0, Lcom/android/server/am/AnrHelper$AnrRecord;->mTimeoutRecord:Lcom/android/internal/os/TimeoutRecord;
