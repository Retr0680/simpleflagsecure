...
.method getUidBatteryExemptedUsageSince(IJJI)Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    ...
    check-cast v0, Lcom/android/server/am/AppBatteryExemptionTracker$UidBatteryStates;
    :try_end_0
    ...
    .line 213
    .local v2, "pkg":Lcom/android/server/am/AppBatteryExemptionTracker$UidBatteryStates;
    if-nez v2, :cond_1
    ...
    .line 217
    .end local v2    # "pkg":Lcom/android/server/am/AppBatteryExemptionTracker$UidBatteryStates;
    :catchall_0
    move-exception v0
    ...
    .line 216
    .restart local v2    # "pkg":Lcom/android/server/am/AppBatteryExemptionTracker$UidBatteryStates;
    :cond_1
    move-wide v3, p2
    ...
    .line 217
    .end local v2    # "pkg":Lcom/android/server/am/AppBatteryExemptionTracker$UidBatteryStates;
    .local p2, "result":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    monitor-exit v1
    :try_end_2
    ...
    .line 220
    iget-object p3, p0, Lcom/android/server/am/BaseAppStateTracker;->mAppRestrictionController:Lcom/android/server/am/AppRestrictionController;

    .line 221
    invoke-virtual {p3, p1}, Lcom/android/server/am/AppRestrictionController;->getUidBatteryUsage(I)Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;

    move-result-object p3

    .line 222
    .local p3, "batteryUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    iget-object p4, p2, Landroid/util/Pair;->first:Ljava/lang/Object;

    check-cast p4, Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    ...
    invoke-virtual {p4, p3}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->add(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    invoke-virtual {p4, p5}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->subtract(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    move-result-object p4

    invoke-virtual {p4}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->unmutate()Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    ...
    .line 224
    .end local p3    # "batteryUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    :cond_2
    ...
    .line 217
    .end local p2    # "result":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    :catchall_1
    move-exception v0
...
.method public onStateChange(ILjava/lang/String;ZJI)V
    ...
    .line 118
    .local v9, "batteryUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    invoke-static {v4}, Lcom/android/server/am/BaseAppStateTracker;->stateTypeToIndex(I)I

    move-result v10

    .line 119
    .local v10, "stateTypeIndex":I
    ...
    .line 126
    .end local v5    # "pkgsStates":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .local v12, "pkgsStates":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    :goto_0
    const/4 v5, 0x0

    .line 127
    .local v5, "states":I
    invoke-virtual {v12, v3}, Landroid/util/ArrayMap;->indexOfKey(Ljava/lang/Object;)I
    ...
    invoke-virtual {v12, v13, v8}, Landroid/util/ArrayMap;->setValueAt(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v12, v13, v7}, Landroid/util/ArrayMap;->setValueAt(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 166
    invoke-virtual {v12, v13}, Landroid/util/ArrayMap;->removeAt(I)Ljava/lang/Object;
    ...
    .end local v12    # "pkgsStates":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .end local v13    # "indexOfPkg":I
    .end local v14    # "states":I
    .end local v15    # "addEvent":Z
    :cond_c
    monitor-exit v11
