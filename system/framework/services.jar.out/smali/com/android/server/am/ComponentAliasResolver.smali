...
.method private static synthetic lambda$resolveService$1(Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    .end local p0    # "service":Landroid/content/Intent;
    .end local p1    # "resolvedType":Ljava/lang/String;
    ...
    .line 437
    .local p0, "rInfo":Landroid/content/pm/ResolveInfo;
    const/4 p1, 0x0

    if-eqz p0, :cond_0

    iget-object p3, p0, Landroid/content/pm/ResolveInfo;->serviceInfo:Landroid/content/pm/ServiceInfo;
    ...
    .line 438
    .local p3, "sInfo":Landroid/content/pm/ServiceInfo;
    :goto_0
    if-nez p3, :cond_1
    ...
    iget-object p4, p3, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget-object p4, p4, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    iget-object v0, p3, Landroid/content/pm/ServiceInfo;->name:Ljava/lang/String;

    invoke-direct {p1, p4, v0}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public resolveReceiver(Landroid/content/Intent;Landroid/content/pm/ResolveInfo;Ljava/lang/String;JIII)Lcom/android/server/am/ComponentAliasResolver$Resolution;
    ...
    invoke-direct {v4, v0, v3}, Lcom/android/server/am/ComponentAliasResolver$Resolution;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual/range {v5 .. v13}, Landroid/content/pm/PackageManagerInternal;->queryIntentReceivers(Landroid/content/Intent;Ljava/lang/String;JIIIZ)Ljava/util/List;
    ...
    invoke-direct {v3, v0, v7}, Lcom/android/server/am/ComponentAliasResolver$Resolution;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public resolveService(Landroid/content/Intent;Ljava/lang/String;III)Lcom/android/server/am/ComponentAliasResolver$Resolution;
    ...
    .line 447
    .local p1, "result":Lcom/android/server/am/ComponentAliasResolver$Resolution;, "Lcom/android/server/am/ComponentAliasResolver$Resolution<Landroid/content/ComponentName;>;"
    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lcom/android/server/am/ComponentAliasResolver$Resolution;->isAlias()Z
    ...
    invoke-virtual {v1, p2}, Landroid/content/Intent;->setOriginalIntent(Landroid/content/Intent;)V
    ...
    .line 452
    invoke-virtual {p1}, Lcom/android/server/am/ComponentAliasResolver$Resolution;->getTarget()Ljava/lang/Object;
