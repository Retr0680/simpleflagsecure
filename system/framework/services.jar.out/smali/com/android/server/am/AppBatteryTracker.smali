...
.method private checkBatteryUsageStats()V
    ...
    .line 439
    .local v7, "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    :try_start_0
    ...
    .line 440
    .local v8, "uidConsumers":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    ...
    .line 447
    .local v11, "actualUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    ...
    invoke-virtual {v11}, Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;->mutate()Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .line 454
    invoke-virtual {v6, v1, v7}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->calcPercentage(ILcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    move-result-object v6

    .line 455
    invoke-virtual {v6}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->unmutate()Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;

    move-result-object v6

    .line 467
    .local v6, "bgUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    invoke-virtual {v7, v1, v6}, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->handleUidBatteryUsage(ILcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;)V

    .line 444
    .end local v0    # "exemptedUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    .end local v1    # "uid":I
    .end local v6    # "bgUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    .end local v11    # "actualUsage":Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    ...
    .end local v8    # "uidConsumers":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    .end local v9    # "size":I
    .end local v10    # "i":I
    :catchall_0
    move-exception v0
    ...
    .restart local v8    # "uidConsumers":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    ...
    .line 471
    iget-object v6, p0, Lcom/android/server/am/AppBatteryTracker;->mDebugUidPercentages:Landroid/util/SparseArray;

    invoke-virtual {v6, v0}, Landroid/util/SparseArray;->keyAt(I)I

    move-result v6

    iget-object v9, p0, Lcom/android/server/am/AppBatteryTracker;->mDebugUidPercentages:Landroid/util/SparseArray;
    ...
    .line 471
    invoke-virtual {v7, v6, v9}, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->handleUidBatteryUsage(ILcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;)V
    :try_end_2
    ...
    .end local v4    # "now":J
    .end local v7    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    ...
    .restart local v7    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
...
.method private dumpUidStats(Landroid/util/proto/ProtoOutputStream;ILcom/android/server/am/AppBatteryTracker$BatteryUsage;)V
    ...
    .local v9, "fgsUsage":D
    invoke-direct {v0, v1, v14, v9, v10}, Lcom/android/server/am/AppBatteryTracker;->dumpProcessStateStats(Landroid/util/proto/ProtoOutputStream;ID)V
    ...
    .local v2, "cachedUsage":D
    invoke-direct {v0, v1, v15, v2, v3}, Lcom/android/server/am/AppBatteryTracker;->dumpProcessStateStats(Landroid/util/proto/ProtoOutputStream;ID)V
...
.method private logAppBatteryTrackerIfNeeded()V
    ...
    :cond_1
    sget-object v6, Lcom/android/server/am/AppBatteryTracker;->BATTERY_USAGE_NONE:Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;

    iget-object v7, v1, Lcom/android/server/am/AppBatteryTracker;->mUidBatteryUsageInWindow:Landroid/util/SparseArray;

    invoke-virtual {v7, v0}, Landroid/util/SparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object v7

    invoke-virtual {v6, v7}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->equals(Ljava/lang/Object;)Z
    ...
    .line 275
    invoke-virtual {v1, v8}, Lcom/android/server/am/AppBatteryTracker;->getTrackerInfoForStatsd(I)[B
...
.method private updateBatteryUsageStatsOnce(J)V
    ...
    iget-object v6, v1, Lcom/android/server/am/AppBatteryTracker;->mTmpUserIds:Landroid/util/ArraySet;

    .line 522
    .local v6, "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    iget-object v4, v1, Lcom/android/server/am/AppBatteryTracker;->mTmpUidBatteryUsage:Landroid/util/SparseArray;

    .line 523
    .local v4, "buf":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$BatteryUsage;>;"
    iget-object v0, v1, Lcom/android/server/am/BaseAppStateTracker;->mInjector:Lcom/android/server/am/BaseAppStateTracker$Injector;
    ...
    .line 524
    .local v7, "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    iget-wide v9, v8, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainWindowMs:J

    .line 526
    .local v9, "windowSize":J
    ...
    .line 529
    :try_start_0
    iget-object v0, v1, Lcom/android/server/am/AppBatteryTracker;->mActiveUserIdStates:Landroid/util/SparseBooleanArray;
    ...
    .line 530
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker;->mActiveUserIdStates:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {v0, v11, v12}, Landroid/os/BatteryUsageStatsQuery$Builder;->setMaxStatsAgeMs(J)Landroid/os/BatteryUsageStatsQuery$Builder;

    move-result-object v5

    .line 545
    .local v5, "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    const-wide/16 v2, 0x0
    ...
    .line 547
    .local v13, "stats":Landroid/os/BatteryUsageStats;
    if-eqz v13, :cond_2

    invoke-virtual {v13}, Landroid/os/BatteryUsageStats;->getStatsStartTimestamp()J
    ...
    invoke-virtual {v13}, Landroid/os/BatteryUsageStats;->getStatsEndTimestamp()J
    ...
    .line 552
    .local v18, "needUpdateUidBatteryUsageInWindow":Z
    cmp-long v0, v2, v9
    ...
    iget-object v11, v1, Lcom/android/server/am/BaseAppStateTracker;->mLock:Ljava/lang/Object;
    ...
    .end local v5    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .end local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .local v12, "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .local v23, "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    ...
    :try_start_2
    invoke-static {v4, v0, v5, v6}, Lcom/android/server/am/AppBatteryTracker;->copyUidBatteryUsage(Landroid/util/SparseArray;Landroid/util/SparseArray;D)V
    ...
    .end local v12    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .end local v23    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v5    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .restart local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    :catchall_2
    move-exception v0
    ...
    .end local v5    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .end local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v12    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .restart local v23    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    :goto_4
    monitor-exit v11
    :try_end_2
    ...
    .restart local v23    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    :goto_5
    iget-object v0, v1, Lcom/android/server/am/AppBatteryTracker;->mTmpUidBatteryUsage2:Landroid/util/SparseArray;
    ...
    invoke-static {v4, v0}, Lcom/android/server/am/AppBatteryTracker;->copyUidBatteryUsage(Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    .local v24, "curDuration":J
    :try_start_3
    iget-wide v2, v1, Lcom/android/server/am/AppBatteryTracker;->mLastUidBatteryUsageStartTs:J

    .line 567
    .local v2, "lastUidBatteryUsageStartTs":J
    iput-wide v14, v1, Lcom/android/server/am/AppBatteryTracker;->mLastUidBatteryUsageStartTs:J
    ...
    .line 574
    invoke-virtual {v0, v2, v3, v14, v15}, Landroid/os/BatteryUsageStatsQuery$Builder;->aggregateSnapshots(JJ)Landroid/os/BatteryUsageStatsQuery$Builder;
    ...
    .end local v2    # "lastUidBatteryUsageStartTs":J
    .local v11, "lastUidBatteryUsageStartTs":J
    const-wide/16 v2, 0x0
    ...
    .end local v11    # "lastUidBatteryUsageStartTs":J
    .end local v23    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .local v21, "lastUidBatteryUsageStartTs":J
    invoke-direct/range {v1 .. v7}, Lcom/android/server/am/AppBatteryTracker;->updateBatteryUsageStatsOnceInternal(JLandroid/util/SparseArray;Landroid/os/BatteryUsageStatsQuery$Builder;Landroid/util/ArraySet;Landroid/os/BatteryStatsInternal;)Landroid/os/BatteryUsageStats;

    move-result-object v2

    .line 581
    .local v2, "statsCommit":Landroid/os/BatteryUsageStats;
    sub-long v11, v14, v21

    add-long v11, v24, v11

    .line 583
    .end local v24    # "curDuration":J
    .local v11, "curDuration":J
    if-eqz v2, :cond_5
    ...
    const-string v0, "Failed to close a stat"

    invoke-static {v3, v0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I

    .line 592
    .end local v2    # "statsCommit":Landroid/os/BatteryUsageStats;
    ...
    .end local v5    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .end local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .end local v11    # "curDuration":J
    .end local v21    # "lastUidBatteryUsageStartTs":J
    .local v2, "lastUidBatteryUsageStartTs":J
    .restart local v12    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .local v23, "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v24    # "curDuration":J
    :cond_6
    ...
    .end local v23    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v21    # "lastUidBatteryUsageStartTs":J
    move-object v2, v12
    ...
    .end local v12    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .end local v24    # "curDuration":J
    .local v2, "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .restart local v11    # "curDuration":J
    :goto_9
    if-eqz v18, :cond_7
    ...
    .end local v2    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .local v23, "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    ...
    :try_start_6
    invoke-static {v4, v0, v2, v3}, Lcom/android/server/am/AppBatteryTracker;->copyUidBatteryUsage(Landroid/util/SparseArray;Landroid/util/SparseArray;D)V
    ...
    .end local v23    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .restart local v2    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    :catchall_4
    move-exception v0
    ...
    .end local v2    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .restart local v23    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    :goto_a
    monitor-exit v5
    :try_end_6
    ...
    .end local v18    # "needUpdateUidBatteryUsageInWindow":Z
    .local v19, "needUpdateUidBatteryUsageInWindow":Z
    :goto_b
    iget-object v2, v1, Lcom/android/server/am/BaseAppStateTracker;->mLock:Ljava/lang/Object;
    ...
    .end local v3    # "size":I
    .local v18, "size":I
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker;->mUidBatteryUsage:Landroid/util/SparseArray;
    ...
    .end local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .local v20, "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    :try_start_9
    iget-object v6, v1, Lcom/android/server/am/AppBatteryTracker;->mLastUidBatteryUsage:Landroid/util/SparseArray;
    :try_end_9
    .catchall {:try_start_9 .. :try_end_9} :catchall_6

    move-object/from16 v26, v7

    .end local v7    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    .local v26, "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    :try_start_a
    ...
    check-cast v6, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    .line 606
    .local v6, "lastUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    invoke-virtual {v4, v0}, Landroid/util/SparseArray;->valueAt(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    .line 609
    .local v7, "curUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    if-ltz v3, :cond_8
    ...
    .end local v0    # "i":I
    .local v24, "i":I
    iget-object v0, v1, Lcom/android/server/am/AppBatteryTracker;->mUidBatteryUsage:Landroid/util/SparseArray;
    ...
    .line 611
    .local v0, "totalUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    sget-object v25, Lcom/android/server/am/AppBatteryTracker;->BATTERY_USAGE_NONE:Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;

    .line 613
    .local v25, "before":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    move/from16 v27, v3

    .end local v3    # "index":I
    .local v27, "index":I
    invoke-virtual {v0, v6}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->subtract(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    move-result-object v3

    invoke-virtual {v3, v7}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->add(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    goto :goto_d

    .line 637
    .end local v0    # "totalUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v5    # "uid":I
    .end local v6    # "lastUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v7    # "curUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v18    # "size":I
    .end local v24    # "i":I
    .end local v25    # "before":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .restart local v6    # "lastUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .restart local v7    # "curUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .local v3, "totalUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    move-object/from16 v25, v0

    .end local v0    # "before":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .restart local v25    # "before":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    iget-object v0, v1, Lcom/android/server/am/AppBatteryTracker;->mUidBatteryUsage:Landroid/util/SparseArray;
    ...
    .line 602
    .end local v3    # "totalUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v5    # "uid":I
    .end local v6    # "lastUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v7    # "curUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v25    # "before":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .end local v0    # "i":I
    .end local v18    # "size":I
    .end local v26    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    .local v7, "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    :catchall_6
    move-exception v0
    ...
    .end local v7    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    .restart local v26    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    goto/16 :goto_12

    .end local v20    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .end local v26    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    .local v6, "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v7    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    :catchall_7
    move-exception v0
    ...
    .end local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .end local v7    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    .restart local v20    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .restart local v26    # "batteryStatsInternal":Landroid/os/BatteryStatsInternal;
    goto/16 :goto_12
    ...
    iget-object v3, v1, Lcom/android/server/am/AppBatteryTracker;->mLastUidBatteryUsage:Landroid/util/SparseArray;

    invoke-static {v0, v3}, Lcom/android/server/am/AppBatteryTracker;->copyUidBatteryUsage(Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    .line 646
    invoke-virtual {v0, v2, v3, v5, v6}, Landroid/os/BatteryUsageStatsQuery$Builder;->aggregateSnapshots(JJ)Landroid/os/BatteryUsageStatsQuery$Builder;

    move-result-object v7

    .line 647
    .end local v23    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .local v7, "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    ...
    .line 668
    :try_start_d
    invoke-virtual {v13}, Landroid/os/BatteryUsageStats;->close()V
    ...
    const-string v5, "Failed to close a stat"
    ...
    .end local v6    # "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    .end local v11    # "curDuration":J
    .end local v19    # "needUpdateUidBatteryUsageInWindow":Z
    .end local v21    # "lastUidBatteryUsageStartTs":J
    .restart local v12    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .local v18, "needUpdateUidBatteryUsageInWindow":Z
    .local v23, "userIds":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Landroid/os/UserHandle;>;"
    ...
    .line 535
    .end local v12    # "builder":Landroid/os/BatteryUsageStatsQuery$Builder;
    .end local v13    # "stats":Landroid/os/BatteryUsageStats;
    .end local v14    # "curStart":J
    .end local v16    # "curEnd":J
    .end local v18    # "needUpdateUidBatteryUsageInWindow":Z
    .end local v24    # "curDuration":J
    :goto_14
    :try_start_10
...
.method private updateBatteryUsageStatsOnceInternal(JLandroid/util/SparseArray;Landroid/os/BatteryUsageStatsQuery$Builder;Landroid/util/ArraySet;Landroid/os/BatteryStatsInternal;)Landroid/os/BatteryUsageStats;
    ...
    .line 685
    invoke-virtual {v8}, Landroid/os/BatteryUsageStatsQuery$Builder;->build()Landroid/os/BatteryUsageStatsQuery;
    ...
    .local v2, "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    sub-long v0, v13, v11
    ...
    .end local v2    # "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    ...
    .end local v0    # "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    .restart local v2    # "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    move-wide v7, v0
    ...
    .line 715
    .local v16, "rawUid":I
    invoke-static/range {v16 .. v16}, Landroid/os/UserHandle;->isIsolated(I)Z
    ...
    .end local v1    # "sharedAppId":I
    .local v18, "sharedAppId":I
    new-instance v1, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    invoke-direct {v1, v15, v0}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;-><init>(Landroid/os/UidBatteryConsumer;Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;)V

    .line 728
    invoke-virtual {v1, v7, v8}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->scale(D)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .end local v0    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    .local v20, "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    ...
    .line 711
    .end local v19    # "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    .end local v20    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    .local v0, "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    .local v2, "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    :cond_8
    move-object/from16 v20, v0
    ...
    .end local v2    # "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    .restart local v19    # "uidConsumers":Ljava/util/List;, "Ljava/util/List<Landroid/os/UidBatteryConsumer;>;"
    .restart local v20    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    goto :goto_9
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v5, v6, v4}, Lcom/android/server/am/AppBatteryTracker;->updateBatteryUsageStatsIfNecessary(JZ)Z

    .line 826
    :cond_0
    invoke-direct {v1}, Lcom/android/server/am/AppBatteryTracker;->scheduleBgBatteryUsageStatsCheck()V
    ...
    .line 846
    .local v7, "newPrefix":Ljava/lang/String;
    iget-object v6, v1, Lcom/android/server/am/BaseAppStateTracker;->mInjector:Lcom/android/server/am/BaseAppStateTracker$Injector;
    ...
    check-cast v6, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;

    .line 847
    .local v6, "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    .line 848
    .local v14, "now":J
    iget-wide v8, v6, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainWindowMs:J
    ...
    .end local v6    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    .end local v7    # "newPrefix":Ljava/lang/String;
    ...
    .restart local v6    # "bgPolicy":Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;
    .restart local v7    # "newPrefix":Ljava/lang/String;
    ...
    check-cast v10, Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;

    .line 857
    invoke-virtual {v10, v11, v6}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->calcPercentage(ILcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    move-result-object v10

    .line 858
    .local v10, "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    move-object/from16 v16, v10

    .end local v10    # "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .local v16, "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .end local v0    # "uidConsumers":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    .local v17, "uidConsumers":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    iget v0, v6, Lcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;->mBgCurrentDrainExemptedTypes:I
    ...
    .end local v16    # "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .local v0, "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    invoke-virtual/range {v10 .. v16}, Lcom/android/server/am/AppRestrictionController;->getUidBatteryExemptedUsageSince(IJJI)Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;
    ...
    new-instance v12, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    invoke-direct {v12, v0}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;-><init>(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)V

    .line 863
    invoke-virtual {v12, v10}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->subtract(Lcom/android/server/am/AppBatteryTracker$BatteryUsage;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;

    move-result-object v12

    .line 864
    invoke-virtual {v12, v11, v6}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->calcPercentage(ILcom/android/server/am/AppBatteryTracker$AppBatteryPolicy;)Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .line 865
    .local v22, "reportedUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .end local v8    # "i":I
    .local v13, "i":I
    invoke-static {v11}, Landroid/os/UserHandle;->formatUid(I)Ljava/lang/String;

    move-result-object v8

    .line 867
    invoke-virtual {v6, v11}, Lcom/android/server/am/BaseAppStatePolicy;->shouldExemptUid(I)I
    ...
    .local v15, "exemptedUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    invoke-virtual {v0}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->toString()Ljava/lang/String;

    move-result-object v10

    .line 869
    invoke-virtual {v0}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->percentageToString()Ljava/lang/String;
    ...
    invoke-virtual {v15}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->toString()Ljava/lang/String;
    ...
    .end local v13    # "i":I
    .local v24, "i":I
    invoke-virtual {v15}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->percentageToString()Ljava/lang/String;
    ...
    .end local v9    # "size":I
    .local v25, "size":I
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->toString()Ljava/lang/String;
    ...
    .end local v15    # "exemptedUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .local v26, "exemptedUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/AppBatteryTracker$BatteryUsage;->percentageToString()Ljava/lang/String;

    move-result-object v15

    move-object/from16 v27, v0

    .end local v0    # "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .local v27, "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    iget-object v0, v1, Lcom/android/server/am/AppBatteryTracker;->mUidBatteryUsage:Landroid/util/SparseArray;
    ...
    .line 874
    invoke-virtual {v0, v11, v1}, Landroid/util/SparseArray;->get(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 865
    invoke-virtual {v2, v1, v8}, Ljava/io/PrintWriter;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;

    .line 854
    nop

    .end local v0    # "uid":I
    .end local v22    # "reportedUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v26    # "exemptedUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    .end local v27    # "bgUsage":Lcom/android/server/am/AppBatteryTracker$BatteryUsage;
    ...
    .end local v17    # "uidConsumers":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/am/AppBatteryTracker$ImmutableBatteryUsage;>;"
    .end local v18    # "now":J
    .end local v20    # "since":J
