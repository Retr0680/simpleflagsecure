...
.method logProcStateChanged(IIIIII)V
    ...
    .end local p4    # "oldprocstate":I
    .end local p5    # "oomadj":I
    .end local p6    # "oldoomadj":I
    .local v1, "uid":I
    .local v2, "pid":I
    .local v4, "procstate":I
    .local v5, "oldprocstate":I
    .local v6, "oomadj":I
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/OomAdjusterDebugLogger;->maybeLogStacktrace(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/am/OomAdjusterDebugLogger;->maybeSleep(I)V
...
.method logUidStateChanged(IIIIII)V
    ...
    .end local p1    # "uid":I
    .end local p2    # "uidstate":I
    .end local p3    # "olduidstate":I
    .end local p4    # "capability":I
    .end local p5    # "oldcapability":I
    .end local p6    # "flags":I
    .local v1, "uid":I
    .local v3, "uidstate":I
    .local v4, "olduidstate":I
    .local v5, "capability":I
    .local v6, "oldcapability":I
    .local v7, "flags":I
