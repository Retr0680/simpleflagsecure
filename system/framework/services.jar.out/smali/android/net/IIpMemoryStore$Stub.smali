...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object v9, Landroid/net/IIpMemoryStore;->DESCRIPTOR:Ljava/lang/String;
    ...
    invoke-static {v4}, Landroid/net/ipmemorystore/IOnNetworkEventCountRetrievedListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/net/ipmemorystore/IOnNetworkEventCountRetrievedListener;

    move-result-object v4

    .line 240
    .local v4, "_arg3":Landroid/net/ipmemorystore/IOnNetworkEventCountRetrievedListener;
    invoke-interface {p0, v1, v2, v3, v4}, Landroid/net/IIpMemoryStore;->retrieveNetworkEventCount(Ljava/lang/String;[J[ILandroid/net/ipmemorystore/IOnNetworkEventCountRetrievedListener;)V
    ...
    .end local v4    # "_arg3":Landroid/net/ipmemorystore/IOnNetworkEventCountRetrievedListener;
    :pswitch_1
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 227
    .local v7, "_arg4":Landroid/net/ipmemorystore/IOnStatusListener;
    move-object v0, p0
    ...
    .end local v7    # "_arg4":Landroid/net/ipmemorystore/IOnStatusListener;
    :pswitch_2
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 212
    .local v3, "_arg2":Landroid/net/ipmemorystore/IOnStatusAndCountListener;
    ...
    .end local v3    # "_arg2":Landroid/net/ipmemorystore/IOnStatusAndCountListener;
    :pswitch_3
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 201
    .restart local v3    # "_arg2":Landroid/net/ipmemorystore/IOnStatusAndCountListener;
    ...
    .line 185
    .local v4, "_arg3":Landroid/net/ipmemorystore/IOnBlobRetrievedListener;
    ...
    .end local v4    # "_arg3":Landroid/net/ipmemorystore/IOnBlobRetrievedListener;
    :pswitch_6
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 172
    .local v2, "_arg1":Landroid/net/ipmemorystore/IOnNetworkAttributesRetrievedListener;
    ...
    .line 158
    .end local v1    # "_arg0":Ljava/lang/String;
    .end local v2    # "_arg1":Landroid/net/ipmemorystore/IOnNetworkAttributesRetrievedListener;
    :pswitch_7
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 163
    .local v3, "_arg2":Landroid/net/ipmemorystore/IOnSameL3NetworkResponseListener;
    ...
    .end local v1    # "_arg0":Ljava/lang/String;
    .end local v2    # "_arg1":Ljava/lang/String;
    .end local v3    # "_arg2":Landroid/net/ipmemorystore/IOnSameL3NetworkResponseListener;
    :pswitch_8
    ...
    .line 151
    .local v1, "_arg0":Landroid/net/ipmemorystore/NetworkAttributesParcelable;
    invoke-virtual {p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;
    ...
    .line 152
    .local v2, "_arg1":Landroid/net/ipmemorystore/IOnL2KeyResponseListener;
    ...
    .line 134
    .end local v1    # "_arg0":Landroid/net/ipmemorystore/NetworkAttributesParcelable;
    .end local v2    # "_arg1":Landroid/net/ipmemorystore/IOnL2KeyResponseListener;
    :pswitch_9
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 142
    .local v4, "_arg3":Landroid/net/ipmemorystore/Blob;
    invoke-virtual {p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;
    ...
    .line 143
    .local v5, "_arg4":Landroid/net/ipmemorystore/IOnStatusListener;
    move-object v0, p0
    ...
    .end local v2    # "_arg1":Ljava/lang/String;
    .end local v3    # "_arg2":Ljava/lang/String;
    .end local v4    # "_arg3":Landroid/net/ipmemorystore/Blob;
    .end local v5    # "_arg4":Landroid/net/ipmemorystore/IOnStatusListener;
    :pswitch_a
    invoke-virtual {p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 127
    .local v2, "_arg1":Landroid/net/ipmemorystore/NetworkAttributesParcelable;
    invoke-virtual {p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;
    ...
    .line 128
    .local v3, "_arg2":Landroid/net/ipmemorystore/IOnStatusListener;
    ...
    .line 248
    .end local v1    # "_arg0":Ljava/lang/String;
    .end local v2    # "_arg1":Landroid/net/ipmemorystore/NetworkAttributesParcelable;
    .end local v3    # "_arg2":Landroid/net/ipmemorystore/IOnStatusListener;
    :goto_0
    return v10
