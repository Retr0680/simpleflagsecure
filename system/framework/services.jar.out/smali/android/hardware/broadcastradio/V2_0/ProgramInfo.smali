...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v4, p0, v6, v7}, Landroid/hardware/broadcastradio/V2_0/ProgramInfo;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v1, p1, v8, v2, v3}, Landroid/hardware/broadcastradio/V2_0/ProgramSelector;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v1, p1, v8, v2, v3}, Landroid/hardware/broadcastradio/V2_0/ProgramIdentifier;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v3, p1, v1, v4, v5}, Landroid/hardware/broadcastradio/V2_0/ProgramIdentifier;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v1, p0, Landroid/hardware/broadcastradio/V2_0/ProgramInfo;->infoFlags:I
    ...
    iput v1, p0, Landroid/hardware/broadcastradio/V2_0/ProgramInfo;->signalQuality:I
    ...
    invoke-virtual {v3, p1, v1, v4, v5}, Landroid/hardware/broadcastradio/V2_0/Metadata;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v3, p1, v1, v4, v5}, Landroid/hardware/broadcastradio/V2_0/VendorKeyValue;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    .line 244
    iget-object v4, p0, Landroid/hardware/broadcastradio/V2_0/ProgramInfo;->vendorInfo:Ljava/util/ArrayList;
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v14, v7, v3, v4}, Landroid/hardware/broadcastradio/V2_0/ProgramIdentifier;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    .line 295
    iget-object v7, v0, Landroid/hardware/broadcastradio/V2_0/ProgramInfo;->metadata:Ljava/util/ArrayList;

    invoke-virtual {v7, v6}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Landroid/hardware/broadcastradio/V2_0/Metadata;

    mul-int/lit8 v8, v6, 0x20

    int-to-long v14, v8

    invoke-virtual {v7, v5, v14, v15}, Landroid/hardware/broadcastradio/V2_0/Metadata;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    .line 304
    .restart local v5    # "childBlob":Landroid/os/HwBlob;
    const/4 v6, 0x0
    ...
    .line 305
    iget-object v7, v0, Landroid/hardware/broadcastradio/V2_0/ProgramInfo;->vendorInfo:Ljava/util/ArrayList;
