...
.method protected computeInterpolatedStateAndDerivatives(DD)V
    ...
    iget-wide v9, v0, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->h:D
    ...
    const-wide/high16 v21, -0x3fe2000000000000L    # -7.5
    ...
    .line 84
    .local v23, "bDot0":D
    const-wide v21, 0x4050e00000000000L    # 67.5
    ...
    const-wide/high16 v25, -0x3fba000000000000L    # -44.0
    ...
    .line 86
    .local v27, "bDot3":D
    const-wide v25, 0x404f400000000000L    # 62.5
    ...
    .local v16, "theta2":D
    iget-object v1, v0, Lorg/apache/commons/math/ode/nonstiff/RungeKuttaStepInterpolator;->yDotK:[[D
    ...
    .end local v1    # "yDot5":D
    .local v35, "yDot5":D
    iget-object v1, v0, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->interpolatedState:[D

    iget-object v2, v0, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->currentState:[D

    aget-wide v37, v2, v13

    mul-double v39, v3, v14

    add-double v37, v37, v39

    mul-double v39, v5, v29

    add-double v37, v37, v39

    mul-double v39, v11, v31

    add-double v37, v37, v39

    mul-double v39, v7, v33
