...
.method public walkInColumnOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;)D
    ...
    .line 853
    invoke-virtual {p0, v3, p1}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->getEntry(II)D

    move-result-wide v4

    .line 854
    .local v4, "oldValue":D
    invoke-interface {v0, v3, p1, v4, v5}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D

    move-result-wide v6

    .line 855
    .local v6, "newValue":D
    invoke-virtual {p0, v3, p1, v6, v7}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->setEntry(IID)V
    ...
    iput-object p1, p0, Lorg/apache/commons/math/linear/AbstractRealMatrix;->lu:Lorg/apache/commons/math/linear/DecompositionSolver;
...
.method public walkInColumnOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;IIII)D
    ...
    .line 886
    invoke-virtual {p0, p2, p1}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->getEntry(II)D

    move-result-wide p3

    .line 887
    .local p3, "oldValue":D
    invoke-interface {v0, p2, p1, p3, p4}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D

    move-result-wide v1

    .line 888
    .local v1, "newValue":D
    invoke-virtual {p0, p2, p1, v1, v2}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->setEntry(IID)V
...
.method public walkInColumnOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;)D
    ...
    invoke-interface {v0, v3, p1, v4, v5}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
...
.method public walkInColumnOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;IIII)D
    ...
    invoke-interface {v0, p2, p1, p3, p4}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;)D
    ...
    .line 787
    invoke-virtual {p0, p1, v3}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->getEntry(II)D

    move-result-wide v4

    .line 788
    .local v4, "oldValue":D
    invoke-interface {v0, p1, v3, v4, v5}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D

    move-result-wide v6

    .line 789
    .local v6, "newValue":D
    invoke-virtual {p0, p1, v3, v6, v7}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->setEntry(IID)V
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;IIII)D
    ...
    .line 820
    invoke-virtual {p0, p1, p2}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->getEntry(II)D

    move-result-wide p3

    .line 821
    .local p3, "oldValue":D
    invoke-interface {v0, p1, p2, p3, p4}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D

    move-result-wide v1

    .line 822
    .local v1, "newValue":D
    invoke-virtual {p0, p1, p2, v1, v2}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->setEntry(IID)V
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;)D
    ...
    invoke-interface {v0, p1, v3, v4, v5}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;IIII)D
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
