...
.method public constructor <init>(DD)V
    ...
    .line 84
    new-instance v0, Lorg/apache/commons/math/optimization/direct/PowellOptimizer$LineSearch;
    ...
    .end local p1    # "lsRelativeTolerance":D
    .end local p3    # "lsAbsoluteTolerance":D
    .local v2, "lsRelativeTolerance":D
    .local v4, "lsAbsoluteTolerance":D
    ...
    iput-object v0, v1, Lorg/apache/commons/math/optimization/direct/PowellOptimizer;->line:Lorg/apache/commons/math/optimization/direct/PowellOptimizer$LineSearch;
...
.method protected doOptimize()Lorg/apache/commons/math/optimization/RealPointValuePair;
    ...
    .local v9, "x1":[D
    :goto_1
    invoke-virtual {v0}, Lorg/apache/commons/math/optimization/general/AbstractScalarDifferentiableOptimizer;->incrementIterationsCounter()V
    ...
    .local v3, "alphaMin":D
    invoke-direct {v0, v6, v5, v3, v4}, Lorg/apache/commons/math/optimization/direct/PowellOptimizer;->newPointAndDirection([D[DD)[[D
    ...
    .line 124
    sub-double v17, v12, v7

    cmpl-double v17, v17, v14
    ...
    .end local v22    # "direc":[[D
    .local v1, "guess":[D
    .local v3, "direc":[[D
    .restart local v4    # "i":I
    .restart local v17    # "alphaMin":D
    :cond_2
    move-object/from16 v21, v1
    ...
    invoke-direct {v3, v6, v7, v8}, Lorg/apache/commons/math/optimization/RealPointValuePair;-><init>([DD)V

    .line 132
    .local v3, "current":Lorg/apache/commons/math/optimization/RealPointValuePair;
    invoke-virtual {v0}, Lorg/apache/commons/math/optimization/general/AbstractScalarDifferentiableOptimizer;->getConvergenceChecker()Lorg/apache/commons/math/optimization/RealConvergenceChecker;

    move-result-object v4

    invoke-virtual {v0}, Lorg/apache/commons/math/optimization/general/AbstractScalarDifferentiableOptimizer;->getIterations()I

    move-result v5

    invoke-interface {v4, v5, v1, v3}, Lorg/apache/commons/math/optimization/RealConvergenceChecker;->converged(ILorg/apache/commons/math/optimization/RealPointValuePair;Lorg/apache/commons/math/optimization/RealPointValuePair;)Z
    ...
    .local v1, "i":I
    .local v24, "previous":Lorg/apache/commons/math/optimization/RealPointValuePair;
    :goto_5
    ...
    .line 148
    invoke-virtual {v0, v5}, Lorg/apache/commons/math/optimization/general/AbstractScalarDifferentiableOptimizer;->computeObjectiveValue([D)D
    ...
    invoke-virtual {v1, v6, v4}, Lorg/apache/commons/math/optimization/direct/PowellOptimizer$LineSearch;->search([D[D)V
    ...
    .end local v17    # "alphaMin":D
    .local v1, "alphaMin":D
    invoke-direct {v0, v6, v4, v1, v2}, Lorg/apache/commons/math/optimization/direct/PowellOptimizer;->newPointAndDirection([D[DD)[[D
    ...
    .line 165
    .local v18, "lastInd":I
    aget-object v29, v22, v18

    aput-object v29, v22, v16

    .line 166
    aget-object v29, v17, v19

    aput-object v29, v22, v18

    goto :goto_6

    .line 157
    .end local v1    # "alphaMin":D
    ...
    .line 169
    .end local v2    # "n":I
    .end local v3    # "current":Lorg/apache/commons/math/optimization/RealPointValuePair;
    .end local v4    # "d":[D
    .end local v5    # "x2":[D
    .end local v10    # "fX":D
    .end local v12    # "fX2":D
    ...
    .end local v17    # "alphaMin":D
    .end local v24    # "previous":Lorg/apache/commons/math/optimization/RealPointValuePair;
    .restart local v23    # "n":I
    :goto_6
    move/from16 v4, v19
