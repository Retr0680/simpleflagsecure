...
.method public solve(DDD)D
    ...
    .end local p1    # "min":D
    .end local p3    # "max":D
    .end local p5    # "startValue":D
    .local v2, "min":D
    .local v4, "max":D
    .local v6, "startValue":D
...
.method public solve(Lorg/apache/commons/math/analysis/UnivariateRealFunction;DDD)D
    ...
    .local v4, "i":I
    :goto_0
    iget v5, p0, Lorg/apache/commons/math/ConvergingAlgorithmImpl;->maximalIterationCount:I

    if-ge v4, v5, :cond_1

    .line 167
    invoke-interface {p1, v2, v3}, Lorg/apache/commons/math/analysis/UnivariateRealFunction;->value(D)D

    move-result-wide v5

    invoke-interface {v0, v2, v3}, Lorg/apache/commons/math/analysis/UnivariateRealFunction;->value(D)D
    ...
    iget-wide v9, p0, Lorg/apache/commons/math/ConvergingAlgorithmImpl;->absoluteAccuracy:D
    ...
    .line 169
    invoke-virtual {p0, v5, v6, v4}, Lorg/apache/commons/math/analysis/solvers/UnivariateRealSolverImpl;->setResult(DI)V
    ...
    .restart local v2    # "x0":D
    .restart local v4    # "i":I
    .restart local v5    # "x1":D
    :cond_0
    move-wide v2, v5
    ...
    .end local v5    # "x1":D
    :cond_1
    new-instance v5, Lorg/apache/commons/math/MaxIterationsExceededException;

    iget v6, p0, Lorg/apache/commons/math/ConvergingAlgorithmImpl;->maximalIterationCount:I

    invoke-direct {v5, v6}, Lorg/apache/commons/math/MaxIterationsExceededException;-><init>(I)V
    ...
    sget-object v2, Lorg/apache/commons/math/exception/util/LocalizedFormats;->FUNCTION_NOT_DIFFERENTIABLE:Lorg/apache/commons/math/exception/util/LocalizedFormats;
