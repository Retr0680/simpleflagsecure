...
.method private findEigenVectors([[D)V
    ...
    mul-double v33, v28, v15

    aput-wide v33, v3, v32
    ...
    .end local v3    # "e":[D
    .local v32, "e":[D
    iget-object v3, v0, Lorg/apache/commons/math/linear/EigenDecompositionImpl;->realEigenvalues:[D
    ...
    sub-double v5, v5, v33

    mul-double/2addr v5, v13

    mul-double v35, v25, v17

    mul-double v35, v35, v30

    add-double v15, v5, v35
    ...
    add-double v35, v33, v9

    aput-wide v35, v3, v5

    .line 558
    mul-double v5, v25, v15
    ...
    .line 560
    aget-object v33, v27, v3

    add-int/lit8 v34, v1, 0x1

    aget-wide v28, v33, v34
    ...
    aget-object v35, v27, v3

    aget-wide v35, v35, v1

    mul-double v35, v35, v13

    mul-double v37, v25, v28

    add-double v35, v35, v37

    aput-wide v35, v33, v34
    ...
    aget-wide v34, v34, v1

    mul-double v34, v34, v25

    mul-double v36, v13, v28

    sub-double v34, v34, v36

    aput-wide v34, v33, v1
    ...
    iget-byte v5, v0, Lorg/apache/commons/math/linear/EigenDecompositionImpl;->maxIter:B

    invoke-direct {v3, v5}, Lorg/apache/commons/math/MaxIterationsExceededException;-><init>(I)V

    invoke-direct {v1, v3}, Lorg/apache/commons/math/linear/InvalidMatrixException;-><init>(Ljava/lang/Throwable;)V
    ...
    .end local v1    # "i":I
    :cond_1a
    new-array v1, v2, [Lorg/apache/commons/math/linear/ArrayRealVector;

    iput-object v1, v0, Lorg/apache/commons/math/linear/EigenDecompositionImpl;->eigenvectors:[Lorg/apache/commons/math/linear/ArrayRealVector;
    ...
    .line 616
    .end local v6    # "j":I
    iget-object v6, v0, Lorg/apache/commons/math/linear/EigenDecompositionImpl;->eigenvectors:[Lorg/apache/commons/math/linear/ArrayRealVector;

    new-instance v7, Lorg/apache/commons/math/linear/ArrayRealVector;

    invoke-direct {v7, v1}, Lorg/apache/commons/math/linear/ArrayRealVector;-><init>([D)V
