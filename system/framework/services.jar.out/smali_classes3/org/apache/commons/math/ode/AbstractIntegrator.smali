...
.method protected acceptStep(Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;[D[DD)D
    ...
    :try_start_0
    invoke-virtual {v2}, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->getGlobalPreviousTime()D

    move-result-wide v4

    .line 242
    .local v4, "previousT":D
    invoke-virtual {v2}, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->getGlobalCurrentTime()D
    ...
    .line 254
    :cond_1
    invoke-virtual {v2}, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->isForward()Z
    ...
    .line 285
    invoke-virtual {v2}, Lorg/apache/commons/math/ode/sampling/AbstractStepInterpolator;->getInterpolatedState()[D
...
.method protected addEndTimeChecker(DDLorg/apache/commons/math/ode/events/CombinedEventsManager;)Lorg/apache/commons/math/ode/events/CombinedEventsManager;
    ...
    .line 395
    .local v1, "newManager":Lorg/apache/commons/math/ode/events/CombinedEventsManager;
    ...
    check-cast v8, Lorg/apache/commons/math/ode/events/EventState;

    .line 396
    .local v8, "state":Lorg/apache/commons/math/ode/events/EventState;
    invoke-virtual {v8}, Lorg/apache/commons/math/ode/events/EventState;->getEventHandler()Lorg/apache/commons/math/ode/events/EventHandler;

    move-result-object v2

    .line 397
    invoke-virtual {v8}, Lorg/apache/commons/math/ode/events/EventState;->getMaxCheckInterval()D

    move-result-wide v3

    .line 398
    invoke-virtual {v8}, Lorg/apache/commons/math/ode/events/EventState;->getConvergence()D

    move-result-wide v5

    .line 399
    invoke-virtual {v8}, Lorg/apache/commons/math/ode/events/EventState;->getMaxIterationCount()I
    ...
    .line 400
    .end local v8    # "state":Lorg/apache/commons/math/ode/events/EventState;
    goto :goto_0
...
.method public addEventHandler(Lorg/apache/commons/math/ode/events/EventHandler;DDI)V
    ...
    new-instance v1, Lorg/apache/commons/math/ode/events/EventState;
    ...
    .end local p1    # "handler":Lorg/apache/commons/math/ode/events/EventHandler;
    ...
    .local v5, "convergence":D
    .local v7, "maxIterationCount":I
