...
.method private basicGuess([Lorg/apache/commons/math/optimization/fitting/WeightedObservedPoint;)[D
    ...
    invoke-direct {p0}, Lorg/apache/commons/math/optimization/fitting/GaussianParametersGuesser;->createWeightedObservedPointComparator()Ljava/util/Comparator;
    ...
    .end local v13    # "fwhmX1":D
    .local v9, "fwhmApprox":D
    goto :goto_0

    .line 96
    .end local v9    # "fwhmApprox":D
    :catch_0
    move-exception v0
    ...
    .line 99
    .end local v0    # "e":Lorg/apache/commons/math/exception/OutOfRangeException;
    .restart local v9    # "fwhmApprox":D
    :goto_0
...
.method private getInterpolationPointsForY([Lorg/apache/commons/math/optimization/fitting/WeightedObservedPoint;IID)[Lorg/apache/commons/math/optimization/fitting/WeightedObservedPoint;
    ...
    .line 200
    new-array p4, p4, [Lorg/apache/commons/math/optimization/fitting/WeightedObservedPoint;
    ...
    invoke-static {p4, p5, v7, v8}, Ljava/lang/Math;->min(DD)D
    ...
    .end local p4    # "y":D
    .restart local v4    # "y":D
    new-instance p4, Lorg/apache/commons/math/exception/ZeroException;

    invoke-direct {p4}, Lorg/apache/commons/math/exception/ZeroException;-><init>()V
