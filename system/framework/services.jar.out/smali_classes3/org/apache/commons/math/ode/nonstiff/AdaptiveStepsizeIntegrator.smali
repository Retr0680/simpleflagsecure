...
.method protected sanityChecks(Lorg/apache/commons/math/ode/FirstOrderDifferentialEquations;D[DD[D)V
    ...
    .end local p1    # "equations":Lorg/apache/commons/math/ode/FirstOrderDifferentialEquations;
    .end local p4    # "y0":[D
    .end local p7    # "y":[D
    .local v0, "y":[D
    .local p2, "equations":Lorg/apache/commons/math/ode/FirstOrderDifferentialEquations;
    .local p3, "t0":D
    .local p5, "y0":[D
    .local p6, "t":D
    instance-of v1, p2, Lorg/apache/commons/math/ode/ExtendedFirstOrderDifferentialEquations;
    ...
    check-cast v1, Lorg/apache/commons/math/ode/ExtendedFirstOrderDifferentialEquations;

    invoke-interface {v1}, Lorg/apache/commons/math/ode/ExtendedFirstOrderDifferentialEquations;->getMainSetDimension()I

    move-result v1

    iput v1, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->mainSetDimension:I
    ...
    .line 193
    :goto_0
    iget-object v1, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->vecAbsoluteTolerance:[D
    ...
    iget v2, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->mainSetDimension:I
    ...
    iget v3, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->mainSetDimension:I
    ...
    iget-object v4, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->vecAbsoluteTolerance:[D
    ...
    invoke-direct {v1, v2, v3}, Lorg/apache/commons/math/ode/IntegratorException;-><init>(Lorg/apache/commons/math/exception/util/Localizable;[Ljava/lang/Object;)V

    throw v1

    .line 198
    :goto_1
    iget-object v1, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->vecRelativeTolerance:[D
    ...
    iget-object v4, p1, Lorg/apache/commons/math/ode/nonstiff/AdaptiveStepsizeIntegrator;->vecRelativeTolerance:[D
