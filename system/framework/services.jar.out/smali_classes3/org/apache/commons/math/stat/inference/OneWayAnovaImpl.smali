...
.method private anovaStats(Ljava/util/Collection;)Lorg/apache/commons/math/stat/inference/OneWayAnovaImpl$AnovaStats;
    ...
    .line 150
    .local v0, "data":[D
    new-instance v8, Lorg/apache/commons/math/stat/descriptive/summary/Sum;

    invoke-direct {v8}, Lorg/apache/commons/math/stat/descriptive/summary/Sum;-><init>()V

    .line 151
    .local v8, "sum":Lorg/apache/commons/math/stat/descriptive/summary/Sum;
    new-instance v9, Lorg/apache/commons/math/stat/descriptive/summary/SumOfSquares;

    invoke-direct {v9}, Lorg/apache/commons/math/stat/descriptive/summary/SumOfSquares;-><init>()V

    .line 152
    .local v9, "sumsq":Lorg/apache/commons/math/stat/descriptive/summary/SumOfSquares;
    const/4 v11, 0x0
    ...
    .line 159
    invoke-virtual {v8, v13, v14}, Lorg/apache/commons/math/stat/descriptive/summary/Sum;->increment(D)V

    .line 160
    invoke-virtual {v9, v13, v14}, Lorg/apache/commons/math/stat/descriptive/summary/SumOfSquares;->increment(D)V
    ...
    .line 168
    invoke-virtual {v9}, Lorg/apache/commons/math/stat/descriptive/summary/SumOfSquares;->getResult()D

    move-result-wide v12

    invoke-virtual {v8}, Lorg/apache/commons/math/stat/descriptive/summary/Sum;->getResult()D
    ...
    .line 170
    .end local v0    # "data":[D
    .end local v8    # "sum":Lorg/apache/commons/math/stat/descriptive/summary/Sum;
    .end local v9    # "sumsq":Lorg/apache/commons/math/stat/descriptive/summary/SumOfSquares;
    .end local v11    # "num":I
    .end local v12    # "ss":D
    ...
    .line 179
    .local v11, "F":D
    new-instance v8, Lorg/apache/commons/math/stat/inference/OneWayAnovaImpl$AnovaStats;
