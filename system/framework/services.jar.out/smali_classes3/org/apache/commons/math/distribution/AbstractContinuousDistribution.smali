...
.method public inverseCumulativeProbability(D)D
    ...
    .line 114
    .local v1, "rootFindingFunction":Lorg/apache/commons/math/analysis/UnivariateRealFunction;
    ...
    .end local v8    # "bracket":[D
    .local v0, "bracket":[D
    .local v9, "lowerBound":D
    .local v11, "upperBound":D
    nop
    ...
    .line 121
    .end local v0    # "bracket":[D
    .end local v2    # "root":D
    .end local v9    # "lowerBound":D
    .end local v11    # "upperBound":D
    .restart local v4    # "lowerBound":D
    .restart local v6    # "upperBound":D
    .restart local v8    # "bracket":[D
    :catch_0
    move-exception v0
    ...
    .end local v4    # "lowerBound":D
    .end local v6    # "upperBound":D
    .local v0, "ex":Lorg/apache/commons/math/ConvergenceException;
    .restart local v9    # "lowerBound":D
    .restart local v11    # "upperBound":D
    invoke-interface {v1, v9, v10}, Lorg/apache/commons/math/analysis/UnivariateRealFunction;->value(D)D
    ...
    .line 130
    :cond_0
    invoke-interface {v1, v11, v12}, Lorg/apache/commons/math/analysis/UnivariateRealFunction;->value(D)D
    ...
    invoke-direct {v2, v0}, Lorg/apache/commons/math/MathException;-><init>(Ljava/lang/Throwable;)V

    throw v2

    .line 91
    .end local v0    # "ex":Lorg/apache/commons/math/ConvergenceException;
    .end local v1    # "rootFindingFunction":Lorg/apache/commons/math/analysis/UnivariateRealFunction;
    .end local v8    # "bracket":[D
    .end local v9    # "lowerBound":D
    .end local v11    # "upperBound":D
    :cond_2
