...
.method public static acos(D)D
    ...
    .line 3204
    :cond_6
    invoke-static/range {v17 .. v18}, Lorg/apache/commons/math/util/FastMath;->doubleHighPart(D)D
    ...
    .local v2, "ra":D
    .local v15, "y":D
    invoke-static {v2, v3, v0, v1, v10}, Lorg/apache/commons/math/util/FastMath;->atan(DDZ)D
...
.method public static asin(D)D
    ...
    .end local v25    # "ra":D
    .local v0, "ra":D
    invoke-static {v0, v1, v6, v7, v8}, Lorg/apache/commons/math/util/FastMath;->atan(DDZ)D
...
.method private static atan(DDZ)D
    ...
    .line 2853
    mul-double v14, v16, p2

    .line 2854
    add-double v22, v16, v14
    ...
    .line 2857
    .local v24, "yab":D
    mul-double v14, v12, p2

    .line 2858
    add-double v28, v12, v14
    ...
    .line 2918
    .local v22, "pia":D
    const-wide v26, 0x3ca1a62633145c07L    # 1.2246467991473532E-16
    ...
    .end local v0    # "zb":D
    .restart local v24    # "zb":D
    sub-double v0, v18, v24
...
.method public static cos(D)D
    ...
    const-wide v18, 0x3e74442d18000000L    # 7.549789948768648E-8
...
.method private static exp(DD[D)D
    ...
    .line 789
    .local v6, "epsilon":D
    const-wide v9, 0x3fa5580030b20837L    # 0.04168701738764507

    .line 790
    .local v9, "z":D
    mul-double v17, v9, v6

    const-wide v25, 0x3fc55555329ee223L    # 0.1666666505023083
    ...
    .end local v9    # "z":D
    .local v17, "z":D
    mul-double v9, v17, v6

    const-wide v25, 0x3fe0000000009631L    # 0.5000000000042687

    add-double v9, v9, v25

    .line 792
    .end local v17    # "z":D
    .restart local v9    # "z":D
    mul-double v17, v9, v6
    ...
    const-wide v25, -0x4418bd44dd9ed4efL    # -3.940510424527919E-20
...
.method private static expm1(D[D)D
    ...
    .line 846
    .local v6, "hiPrec":[D
    invoke-static {v0, v1, v2, v3, v6}, Lorg/apache/commons/math/util/FastMath;->exp(DD[D)D
...
.method private static log(D[D)D
    ...
    sget-object v11, Lorg/apache/commons/math/util/FastMath;->LN_HI_PREC_COEF:[[D
...
.method public static pow(DD)D
    ...
    invoke-static {v8, v9, v0, v1, v5}, Lorg/apache/commons/math/util/FastMath;->exp(DD[D)D
...
.method private static reducePayneHanek(D[D)V
    ...
    .line 2457
    sget-object v42, Lorg/apache/commons/math/util/FastMath;->PI_O_4_BITS:[J
...
.method public static sin(D)D
    ...
    .local v21, "negative":Z
    .local v22, "quadrant":I
    sub-double v0, v15, v9
...
.method public static sinh(D)D
    ...
    .line 396
    .end local v24    # "ya":D
    .restart local v2    # "ya":D
    add-double v15, v2, v11
    ...
    .end local v2    # "negate":Z
    .restart local v23    # "negate":Z
    new-array v2, v8, [D

    .line 401
    .local v2, "hiPrec":[D
    invoke-static {v0, v1, v2}, Lorg/apache/commons/math/util/FastMath;->expm1(D[D)D
    ...
    .line 417
    .local v17, "za":D
    sub-double v24, v7, v17

    .line 419
    .local v24, "zb":D
    mul-double v26, v17, v19

    sub-double v26, v3, v26

    mul-double v28, v17, v21
...
.method public static tan(D)D
    ...
    const-wide v21, 0x3c91a62633145c07L    # 6.123233995736766E-17
    ...
    .line 2715
    const-wide v15, 0x3fe45f306dc9c883L    # 0.6366197723675814
    ...
    const-wide v19, 0x3ff921fb40000000L    # 1.570796251296997

    mul-double v9, v9, v19

    .line 2722
    .local v9, "a":D
    add-double v19, v2, v9
    ...
    const-wide v25, 0x3e74442d18000000L    # 7.549789948768648E-8
    ...
    .line 2727
    .local v9, "b":D
    add-double v19, v14, v9

    .line 2728
    sub-double v25, v19, v9

    move-wide/from16 v27, v9

    .end local v9    # "b":D
    .local v27, "b":D
    sub-double v8, v25, v14
    ...
    .end local v27    # "b":D
    .local v14, "b":D
    add-double v19, v8, v14

    .line 2733
    sub-double v25, v19, v14

    move-wide/from16 v27, v6

    .end local v6    # "xb":D
    .local v27, "xb":D
    sub-double v5, v25, v8
    ...
    .restart local v14    # "b":D
    .restart local v27    # "xb":D
    :cond_6
    nop
    ...
    .line 2710
    .end local v4    # "k":I
    .end local v12    # "remB":D
    .end local v19    # "remA":D
    .end local v27    # "xb":D
    .restart local v6    # "xb":D
    :cond_7
    move-wide/from16 v27, v6
    ...
    .line 2753
    .local v12, "pi2b":D
    sub-double v14, v23, v2

    .line 2754
    .local v14, "a":D
    sub-double v16, v14, v23

    move-wide/from16 v18, v8

    .end local v8    # "pi2a":D
    .local v18, "pi2a":D
    add-double v7, v16, v2

    neg-double v7, v7

    .line 2755
    .local v7, "b":D
    sub-double v9, v21, v5

    add-double/2addr v7, v9

    .line 2757
    add-double v2, v14, v7

    .line 2758
    sub-double v9, v2, v14
    ...
    .line 2765
    invoke-static {v2, v3, v5, v6, v11}, Lorg/apache/commons/math/util/FastMath;->tanQ(DDZ)D
    ...
    invoke-static {v2, v3, v5, v6, v4}, Lorg/apache/commons/math/util/FastMath;->tanQ(DDZ)D
...
.method public static tanh(D)D
    ...
    invoke-static {v4, v5, v8, v9, v3}, Lorg/apache/commons/math/util/FastMath;->exp(DD[D)D
    ...
    invoke-static {v1, v2, v0}, Lorg/apache/commons/math/util/FastMath;->expm1(D[D)D
