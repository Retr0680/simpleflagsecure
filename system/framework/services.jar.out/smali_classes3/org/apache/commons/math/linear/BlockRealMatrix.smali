...
.method public getData()[[D
    ...
    invoke-virtual {v0}, Lorg/apache/commons/math/linear/BlockRealMatrix;->getRowDimension()I

    move-result v1

    invoke-virtual {v0}, Lorg/apache/commons/math/linear/BlockRealMatrix;->getColumnDimension()I
...
.method public getSubMatrix(IIII)Lorg/apache/commons/math/linear/BlockRealMatrix;
    ...
    invoke-direct {v1, v2, v3}, Lorg/apache/commons/math/linear/BlockRealMatrix;-><init>(II)V

    move-object v11, v1

    .line 716
    .local v11, "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
    ...
    .local v15, "iBlock":I
    :goto_0
    iget v1, v11, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockRows:I

    if-ge v15, v1, :cond_4

    .line 724
    invoke-direct {v11, v15}, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockHeight(I)I
    ...
    .local v2, "jBlock":I
    :goto_1
    iget v4, v11, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockColumns:I

    if-ge v2, v4, :cond_3

    .line 727
    invoke-direct {v11, v2}, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockWidth(I)I
    ...
    iget-object v4, v11, Lorg/apache/commons/math/linear/BlockRealMatrix;->blocks:[[D
    ...
    .local v4, "jBlock":I
    invoke-direct {v0, v1}, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockWidth(I)I
    ...
    .local v25, "width":I
    iget-object v1, v0, Lorg/apache/commons/math/linear/BlockRealMatrix;->blocks:[[D
...
.method public multiply(Lorg/apache/commons/math/linear/RealMatrix;)Lorg/apache/commons/math/linear/BlockRealMatrix;
    ...
    .local v3, "r":I
    .local v4, "l":I
    .local v22, "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
    ...
    invoke-interface {v2, v3, v1}, Lorg/apache/commons/math/linear/RealMatrix;->getEntry(II)D
    ...
    .end local v22    # "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
    ...
    .end local v0    # "lEnd":I
    .end local v1    # "q":I
    .end local v3    # "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
    .end local v4    # "blockIndex":I
    .end local v18    # "lStart":I
    .restart local v22    # "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
    ...
    .end local v22    # "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
    .end local v23    # "blockIndex":I
    .restart local v3    # "out":Lorg/apache/commons/math/linear/BlockRealMatrix;
...
.method setColumnMatrix(ILorg/apache/commons/math/linear/BlockRealMatrix;)V
    ...
    .line 1035
    .local v2, "nRows":I
    invoke-virtual {v1}, Lorg/apache/commons/math/linear/BlockRealMatrix;->getRowDimension()I
    ...
    .line 1036
    invoke-virtual {v1}, Lorg/apache/commons/math/linear/BlockRealMatrix;->getColumnDimension()I
...
.method public walkInOptimizedOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;)D
    ...
    .end local p1    # "visitor":Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;
    .local v0, "visitor":Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;
    ...
    invoke-interface {v0, v9, v10, v11, v12}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D
    ...
    .line 1583
    .end local v1    # "iBlock":I
    invoke-interface {v0}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->end()D
...
.method public walkInOptimizedOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;IIII)D
    ...
    invoke-static {v0, v4, v5, v6, v7}, Lorg/apache/commons/math/linear/MatrixUtils;->checkSubMatrixIndex(Lorg/apache/commons/math/linear/AnyMatrix;IIII)V
    ...
    .line 1625
    invoke-direct {v0, v7}, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockWidth(I)I
    ...
    .line 1629
    .local v11, "qEnd":I
    iget-object v12, v0, Lorg/apache/commons/math/linear/BlockRealMatrix;->blocks:[[D

    iget v13, v0, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockColumns:I
    ...
    .end local v2    # "p0":I
    .local v17, "p0":I
    invoke-interface {v2, v13, v15, v0, v1}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D
    ...
    .line 1639
    .end local v1    # "iBlock":I
    invoke-interface {v2}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->end()D
...
.method public walkInOptimizedOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;)D
    ...
    .end local p1    # "visitor":Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;
    .local v0, "visitor":Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;
    ...
    invoke-interface {v0, v9, v10, v11, v12}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
    ...
    .line 1609
    .end local v1    # "iBlock":I
    invoke-interface {v0}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->end()D
...
.method public walkInOptimizedOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;IIII)D
    ...
    .end local v2    # "p0":I
    .local v17, "p0":I
    invoke-interface {v2, v13, v15, v0, v1}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
    ...
    .line 1669
    .end local v1    # "iBlock":I
    invoke-interface {v2}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->end()D
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;)D
    ...
    invoke-interface {v0, v3, v10, v11, v12}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;IIII)D
    ...
    .line 1514
    invoke-direct {v0, v8}, Lorg/apache/commons/math/linear/BlockRealMatrix;->blockWidth(I)I
    ...
    .line 1518
    .local v12, "qEnd":I
    iget-object v13, v0, Lorg/apache/commons/math/linear/BlockRealMatrix;->blocks:[[D
    ...
    .end local v2    # "p0":I
    .local v17, "p0":I
    invoke-interface {v2, v7, v15, v0, v1}, Lorg/apache/commons/math/linear/RealMatrixChangingVisitor;->visit(IID)D
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;)D
    ...
    invoke-interface {v0, v3, v10, v11, v12}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
...
.method public walkInRowOrder(Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;IIII)D
    ...
    .end local v2    # "p0":I
    .local v17, "p0":I
    invoke-interface {v2, v7, v15, v0, v1}, Lorg/apache/commons/math/linear/RealMatrixPreservingVisitor;->visit(IID)V
