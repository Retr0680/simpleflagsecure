...
.method public estimate(Lorg/apache/commons/math/estimation/EstimationProblem;)V
    ...
    .local v6, "previous":D
    :goto_0
    invoke-virtual {v1}, Lorg/apache/commons/math/estimation/AbstractEstimator;->incrementJacobianEvaluationsCounter()V
    ...
    invoke-virtual {v15, v0}, Lorg/apache/commons/math/estimation/WeightedMeasurement;->getPartial(Lorg/apache/commons/math/estimation/EstimatedParameter;)D
    ...
    .local v0, "k":I
    :goto_3
    iget-object v14, v1, Lorg/apache/commons/math/estimation/AbstractEstimator;->parameters:[Lorg/apache/commons/math/estimation/EstimatedParameter;
    ...
    .local v23, "previous":D
    mul-double v6, v19, v21

    invoke-interface {v5, v0, v2, v6, v7}, Lorg/apache/commons/math/linear/RealMatrix;->setEntry(IID)V
    ...
    .end local v17    # "bDecrementData":[D
    ...
    .end local v4    # "bDecrementData":[D
    .end local v6    # "previous":D
    .restart local v17    # "bDecrementData":[D
    .restart local v18    # "grad":[D
    .restart local v23    # "previous":D
    ...
    .local v0, "a":Lorg/apache/commons/math/linear/RealMatrix;
    ...
    .local v2, "b":Lorg/apache/commons/math/linear/RealVector;
    goto :goto_5
    ...
    invoke-virtual {v6}, Lorg/apache/commons/math/estimation/EstimatedParameter;->getEstimate()D
    ...
    invoke-virtual {v4, v6, v7}, Lorg/apache/commons/math/estimation/EstimatedParameter;->setEstimate(D)V
    :try_end_0
    ...
    .end local v23    # "previous":D
    .restart local v6    # "previous":D
    invoke-virtual {v1}, Lorg/apache/commons/math/estimation/AbstractEstimator;->updateResidualsAndCost()V

    .line 225
    .end local v8    # "b":Lorg/apache/commons/math/linear/RealVector;
    .end local v9    # "a":Lorg/apache/commons/math/linear/RealMatrix;
    invoke-virtual {v1}, Lorg/apache/commons/math/estimation/AbstractEstimator;->getCostEvaluations()I
    ...
    sget-object v4, Lorg/apache/commons/math/exception/util/LocalizedFormats;->UNABLE_TO_SOLVE_SINGULAR_PROBLEM:Lorg/apache/commons/math/exception/util/LocalizedFormats;

    const/4 v6, 0x0

    new-array v6, v6, [Ljava/lang/Object;

    invoke-direct {v2, v4, v6}, Lorg/apache/commons/math/estimation/EstimationException;-><init>(Lorg/apache/commons/math/exception/util/Localizable;[Ljava/lang/Object;)V
