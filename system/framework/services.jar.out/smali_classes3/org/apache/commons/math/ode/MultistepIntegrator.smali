...
.method protected constructor <init>(Ljava/lang/String;IIDDDD)V
    ...
    .line 123
    new-instance v1, Lorg/apache/commons/math/ode/nonstiff/DormandPrince853Integrator;
    ...
    invoke-direct/range {v1 .. v9}, Lorg/apache/commons/math/ode/nonstiff/DormandPrince853Integrator;-><init>(DDDD)V

    iput-object v1, p0, Lorg/apache/commons/math/ode/MultistepIntegrator;->starter:Lorg/apache/commons/math/ode/FirstOrderIntegrator;

    .line 126
    iput p2, p0, Lorg/apache/commons/math/ode/MultistepIntegrator;->nSteps:I
    ...
    iput-wide v1, p0, Lorg/apache/commons/math/ode/MultistepIntegrator;->exp:D
    ...
    .line 133
    iget-wide v1, p0, Lorg/apache/commons/math/ode/MultistepIntegrator;->exp:D

    neg-double v1, v1

    const-wide/high16 v3, 0x4000000000000000L    # 2.0

    invoke-static {v3, v4, v1, v2}, Lorg/apache/commons/math/util/FastMath;->pow(DD)D
...
.method protected constructor <init>(Ljava/lang/String;IIDD[D[D)V
    ...
    invoke-direct/range {v1 .. v7}, Lorg/apache/commons/math/ode/nonstiff/DormandPrince853Integrator;-><init>(DD[D[D)V
...
.method protected start(D[DD)V
    ...
    new-instance v1, Lorg/apache/commons/math/ode/MultistepIntegrator$NordsieckInitializer;

    array-length v2, p3

    invoke-direct {v1, p0, v2}, Lorg/apache/commons/math/ode/MultistepIntegrator$NordsieckInitializer;-><init>(Lorg/apache/commons/math/ode/MultistepIntegrator;I)V

    invoke-interface {v0, v1}, Lorg/apache/commons/math/ode/ODEIntegrator;->addStepHandler(Lorg/apache/commons/math/ode/sampling/StepHandler;)V

    .line 226
    :try_start_0
    iget-object v1, p0, Lorg/apache/commons/math/ode/MultistepIntegrator;->starter:Lorg/apache/commons/math/ode/FirstOrderIntegrator;

    new-instance v2, Lorg/apache/commons/math/ode/MultistepIntegrator$CountingDifferentialEquations;

    array-length v0, p3

    invoke-direct {v2, p0, v0}, Lorg/apache/commons/math/ode/MultistepIntegrator$CountingDifferentialEquations;-><init>(Lorg/apache/commons/math/ode/MultistepIntegrator;I)V
    ...
    invoke-interface/range {v1 .. v8}, Lorg/apache/commons/math/ode/FirstOrderIntegrator;->integrate(Lorg/apache/commons/math/ode/FirstOrderDifferentialEquations;D[DD[D)D
    :try_end_0
    ...
    instance-of v1, v0, Lorg/apache/commons/math/ode/MultistepIntegrator$InitializationCompletedMarkerException;
