...
.method public doOptimize()Lorg/apache/commons/math/optimization/VectorialPointValuePair;
    ...
    .line 71
    invoke-virtual {v1}, Lorg/apache/commons/math/optimization/general/AbstractLeastSquaresOptimizer;->incrementIterationsCounter()V
    ...
    invoke-virtual {v1}, Lorg/apache/commons/math/optimization/general/AbstractLeastSquaresOptimizer;->updateResidualsAndCost()V

    .line 76
    invoke-virtual {v1}, Lorg/apache/commons/math/optimization/general/AbstractLeastSquaresOptimizer;->updateJacobian()V
    ...
    .local v18, "converged":Z
    iget v2, v1, Lorg/apache/commons/math/optimization/general/AbstractLeastSquaresOptimizer;->cols:I

    if-ge v0, v2, :cond_1

    .line 99
    aget-wide v20, v15, v0
    ...
    invoke-virtual {v1}, Lorg/apache/commons/math/optimization/general/AbstractLeastSquaresOptimizer;->getIterations()I
