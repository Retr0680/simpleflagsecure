...
.method public evaluateStep(Lorg/apache/commons/math/ode/sampling/StepInterpolator;)Z
    ...
    :try_start_0
    invoke-interface {v2}, Lorg/apache/commons/math/ode/sampling/StepInterpolator;->isForward()Z
    ...
    .end local v3    # "t1":D
    .local v26, "t1":D
    invoke-interface {v2}, Lorg/apache/commons/math/ode/sampling/StepInterpolator;->getInterpolatedState()[D
    ...
    .line 242
    .local v21, "f":Lorg/apache/commons/math/analysis/UnivariateRealFunction;
    ...
    .end local v3    # "gb":D
    .local v28, "gb":D
    iget-wide v2, v1, Lorg/apache/commons/math/ode/events/EventState;->convergence:D

    invoke-direct {v0, v2, v3}, Lorg/apache/commons/math/analysis/solvers/BrentSolver;-><init>(D)V

    move-object v2, v0

    .line 244
    .local v2, "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    mul-double v3, v5, v28
    ...
    .end local v2    # "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    .local v22, "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    iget-wide v2, v1, Lorg/apache/commons/math/ode/events/EventState;->convergence:D
    :try_end_0
    ...
    .end local v21    # "f":Lorg/apache/commons/math/analysis/UnivariateRealFunction;
    .local v2, "f":Lorg/apache/commons/math/analysis/UnivariateRealFunction;
    .local v23, "k":I
    :try_start_1
    invoke-interface {v2, v14, v15}, Lorg/apache/commons/math/analysis/UnivariateRealFunction;->value(D)D
    ...
    .restart local v21    # "f":Lorg/apache/commons/math/analysis/UnivariateRealFunction;
    :try_start_2
    ...
    .line 244
    .end local v3    # "epsilon":D
    .end local v22    # "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    .local v2, "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    .restart local p0    # "this":Lorg/apache/commons/math/ode/events/EventState;
    .restart local p1    # "interpolator":Lorg/apache/commons/math/ode/sampling/StepInterpolator;
    :cond_7
    ...
    .end local v2    # "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    .restart local v22    # "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    move-wide/from16 v24, v14
    ...
    :try_end_3
    .catch Lorg/apache/commons/math/FunctionEvaluationException; {:try_start_3 .. :try_end_3} :catch_4
    ...
    .end local v10    # "tb":D
    .local v19, "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    .local v22, "ta":D
    .local v24, "tb":D
    :try_start_4
    invoke-virtual/range {v19 .. v25}, Lorg/apache/commons/math/analysis/solvers/BrentSolver;->solve(ILorg/apache/commons/math/analysis/UnivariateRealFunction;DD)D

    move-result-wide v2
    :try_end_4
    .catch Lorg/apache/commons/math/FunctionEvaluationException; {:try_start_4 .. :try_end_4} :catch_3
    ...
    .end local v19    # "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    ...
    .end local v10    # "tb":D
    .restart local v19    # "solver":Lorg/apache/commons/math/analysis/solvers/BrentSolver;
    .local v22, "tb":D
    goto :goto_a
    ...
    move-result-wide v2
    :try_end_5
    .catch Lorg/apache/commons/math/FunctionEvaluationException; {:try_start_5 .. :try_end_5} :catch_5
    ...
    .line 276
    :try_start_6
    iget-wide v10, v1, Lorg/apache/commons/math/ode/events/EventState;->previousEventTime:D
    ...
    iget-wide v14, v1, Lorg/apache/commons/math/ode/events/EventState;->convergence:D
    ...
    .end local v4    # "ga":D
    .end local v10    # "ta":D
    .restart local v5    # "ga":D
    .restart local v24    # "ta":D
    :cond_9
    iget-wide v10, v1, Lorg/apache/commons/math/ode/events/EventState;->previousEventTime:D
    ...
    iput-wide v2, v1, Lorg/apache/commons/math/ode/events/EventState;->pendingEventTime:D
    :try_end_6
    .catch Lorg/apache/commons/math/ode/events/EventState$EmbeddedDerivativeException; {:try_start_6 .. :try_end_6} :catch_1
    .catch Lorg/apache/commons/math/ode/events/EventState$EmbeddedEventException; {:try_start_6 .. :try_end_6} :catch_0
