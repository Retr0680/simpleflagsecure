...
.method protected homoscedasticTTest(DDDDDD)D
    ...
    iget-object v6, p0, Lorg/apache/commons/math/stat/inference/TTestImpl;->distribution:Lorg/apache/commons/math/distribution/TDistribution;

    invoke-interface {v6, v2, v3}, Lorg/apache/commons/math/distribution/TDistribution;->setDegreesOfFreedom(D)V
    ...
    invoke-interface {v6, v7, v8}, Lorg/apache/commons/math/distribution/Distribution;->cumulativeProbability(D)D
...
.method public pairedT([D[D)D
    ...
    .line 90
    invoke-static {p1, p2, v1, v2}, Lorg/apache/commons/math/stat/StatUtils;->varianceDifference([D[DD)D
...
.method protected tTest(DDDDDD)D
    ...
    invoke-virtual/range {v4 .. v12}, Lorg/apache/commons/math/stat/inference/TTestImpl;->df(DDDD)D

    move-result-wide v2

    .line 991
    iget-object v5, p0, Lorg/apache/commons/math/stat/inference/TTestImpl;->distribution:Lorg/apache/commons/math/distribution/TDistribution;

    invoke-interface {v5, v2, v3}, Lorg/apache/commons/math/distribution/TDistribution;->setDegreesOfFreedom(D)V
    ...
    invoke-interface {v5, v6, v7}, Lorg/apache/commons/math/distribution/Distribution;->cumulativeProbability(D)D
