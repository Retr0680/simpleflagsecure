...
.method protected createTableau(Z)Lorg/apache/commons/math/linear/RealMatrix;
    ...
    .line 157
    invoke-virtual {v0}, Lorg/apache/commons/math/optimization/linear/SimplexTableau;->getNumObjectiveFunctions()I
    ...
    .line 174
    invoke-virtual {v0}, Lorg/apache/commons/math/optimization/linear/SimplexTableau;->getSlackVariableOffset()I
    ...
    invoke-direct {v0, v9, v7}, Lorg/apache/commons/math/optimization/linear/SimplexTableau;->copyArray([D[D)V
    ...
    .line 190
    invoke-virtual {v4, v2, v7, v8, v9}, Lorg/apache/commons/math/linear/Array2DRowRealMatrix;->setEntry(IID)V
    ...
    sget-object v8, Lorg/apache/commons/math/optimization/linear/Relationship;->LEQ:Lorg/apache/commons/math/optimization/linear/Relationship;
    ...
    invoke-virtual {v4, v2, v7, v10, v11}, Lorg/apache/commons/math/linear/Array2DRowRealMatrix;->setEntry(IID)V
    ...
    sget-object v8, Lorg/apache/commons/math/optimization/linear/Relationship;->GEQ:Lorg/apache/commons/math/optimization/linear/Relationship;
    ...
    sget-object v8, Lorg/apache/commons/math/optimization/linear/Relationship;->EQ:Lorg/apache/commons/math/optimization/linear/Relationship;
    ...
    :cond_a
    :goto_5
    invoke-virtual {v0}, Lorg/apache/commons/math/optimization/linear/SimplexTableau;->getArtificialVariableOffset()I
    ...
    invoke-virtual {v4, v8, v7, v10, v11}, Lorg/apache/commons/math/linear/Array2DRowRealMatrix;->setEntry(IID)V
    ...
    .local v9, "artificialVar":I
    add-int/2addr v7, v13

    invoke-virtual {v4, v2, v7, v10, v11}, Lorg/apache/commons/math/linear/Array2DRowRealMatrix;->setEntry(IID)V

    .line 209
    invoke-virtual {v4, v8}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->getRowVector(I)Lorg/apache/commons/math/linear/RealVector;

    move-result-object v7

    invoke-virtual {v4, v2}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->getRowVector(I)Lorg/apache/commons/math/linear/RealVector;

    move-result-object v13

    invoke-interface {v7, v13}, Lorg/apache/commons/math/linear/RealVector;->subtract(Lorg/apache/commons/math/linear/RealVector;)Lorg/apache/commons/math/linear/RealVector;

    move-result-object v7

    invoke-virtual {v4, v8, v7}, Lorg/apache/commons/math/linear/AbstractRealMatrix;->setRowVector(ILorg/apache/commons/math/linear/RealVector;)V

    move v13, v9

    .line 181
    .end local v2    # "row":I
    .end local v9    # "artificialVar":I
