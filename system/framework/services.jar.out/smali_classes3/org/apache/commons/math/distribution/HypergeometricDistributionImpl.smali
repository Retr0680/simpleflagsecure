...
.method public probability(I)D
    ...
    .line 203
    :cond_1
    iget v1, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->sampleSize:I

    int-to-double v1, v1

    iget v3, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->populationSize:I
    ...
    .line 204
    .local v7, "p":D
    iget v1, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->populationSize:I
    ...
    .line 205
    .local v9, "q":D
    iget v6, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->numberOfSuccesses:I

    move v5, p1

    .end local p1    # "x":I
    .local v5, "x":I
    invoke-static/range {v5 .. v10}, Lorg/apache/commons/math/distribution/SaddlePointExpansion;->logBinomialProbability(IIDD)D
    ...
    iget v3, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->sampleSize:I

    sub-int v5, v3, p1

    iget v3, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->populationSize:I

    iget v4, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->numberOfSuccesses:I
    ...
    .line 210
    .local v3, "p2":D
    iget v5, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->sampleSize:I

    iget v6, p0, Lorg/apache/commons/math/distribution/HypergeometricDistributionImpl;->populationSize:I
    ...
    invoke-static {v11, v12}, Lorg/apache/commons/math/util/FastMath;->exp(D)D
