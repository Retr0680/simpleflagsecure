...
.method public optimize(Lorg/apache/commons/math/analysis/UnivariateRealFunction;Lorg/apache/commons/math/optimization/GoalType;DD)D
    ...
    iput v9, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->totalIterations:I

    .line 234
    iput v9, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->totalEvaluations:I
    ...
    iget-object v4, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optimizer:Lorg/apache/commons/math/optimization/UnivariateRealOptimizer;

    .line 245
    invoke-static {v13, v14, v2, v3}, Lorg/apache/commons/math/util/FastMath;->min(DD)D

    move-result-wide v5

    .line 246
    invoke-static {v13, v14, v2, v3}, Lorg/apache/commons/math/util/FastMath;->max(DD)D

    move-result-wide v7
    :try_end_0
    .catch Lorg/apache/commons/math/FunctionEvaluationException; {:try_start_0 .. :try_end_0} :catch_3
    .catch Lorg/apache/commons/math/ConvergenceException; {:try_start_0 .. :try_end_0} :catch_2
    ...
    aput-wide v2, v0, v10
    :try_end_1
    .catch Lorg/apache/commons/math/FunctionEvaluationException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Lorg/apache/commons/math/ConvergenceException; {:try_start_1 .. :try_end_1} :catch_0

    .line 254
    .end local v13    # "bound1":D
    .end local v15    # "bound2":D
    :goto_3
    goto :goto_6
    ...
    iget-object v5, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optima:[D
    ...
    iget-object v5, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optimaValues:[D
    ...
    .line 276
    .local v10, "prevY":D
    iget-object v8, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optima:[D

    aget-wide v2, v8, v7

    .line 277
    iget-object v8, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optimaValues:[D

    aget-wide v5, v8, v7

    .line 278
    sget-object v8, Lorg/apache/commons/math/optimization/GoalType;->MAXIMIZE:Lorg/apache/commons/math/optimization/GoalType;
    ...
    sget-object v9, Lorg/apache/commons/math/optimization/GoalType;->MAXIMIZE:Lorg/apache/commons/math/optimization/GoalType;
    ...
    .line 284
    iget-object v9, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optima:[D
    ...
    .line 285
    iget-object v9, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optimaValues:[D
    ...
    .line 301
    .end local v7    # "j":I
    iget-object v7, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->optima:[D
    ...
    .line 302
    :cond_e
    new-instance v7, Lorg/apache/commons/math/optimization/OptimizationException;

    sget-object v8, Lorg/apache/commons/math/exception/util/LocalizedFormats;->NO_CONVERGENCE_WITH_ANY_START_POINT:Lorg/apache/commons/math/exception/util/LocalizedFormats;

    iget v9, v1, Lorg/apache/commons/math/optimization/MultiStartUnivariateRealOptimizer;->starts:I
    ...
    invoke-direct {v7, v8, v9}, Lorg/apache/commons/math/optimization/OptimizationException;-><init>(Lorg/apache/commons/math/exception/util/Localizable;[Ljava/lang/Object;)V
