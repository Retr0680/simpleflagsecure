...
.method public nextPoisson(D)J
    ...
    .line 362
    invoke-direct {v0}, Lorg/apache/commons/math/random/RandomDataImpl;->getRan()Lorg/apache/commons/math/random/RandomGenerator;
    ...
    .end local v12    # "rnd":D
    :cond_2
    invoke-static {v1, v2}, Lorg/apache/commons/math/util/FastMath;->floor(D)D
    ...
    .local v51, "aSum":D
    .local v53, "delta":D
    invoke-virtual {v0, v1, v2, v3, v4}, Lorg/apache/commons/math/random/RandomDataImpl;->nextUniform(DD)D

    move-result-wide v55

    .line 406
    .local v55, "u":D
    cmpg-double v22, v55, v32
    ...
    invoke-virtual {v0, v3, v4}, Lorg/apache/commons/math/random/RandomDataImpl;->nextExponential(D)D
    ...
    .line 416
    .restart local v55    # "u":D
    :cond_7
    add-double v1, v32, v34

    cmpl-double v1, v55, v1
    ...
    add-double v57, v40, v3

    mul-double v3, v53, v57
    ...
    add-double v3, v40, v24

    mul-double v3, v3, v40

    mul-double v57, v8, v18

    div-double v2, v3, v57
    ...
    .local v44, "generator":Lorg/apache/commons/math/random/RandomGenerator;
    neg-double v4, v2
    ...
    div-double v4, v4, v45

    sub-double v4, v4, v24

    mul-double v47, v2, v4
    ...
    sub-double v49, v47, v4

    .line 433
    cmpg-double v2, v42, v49
    ...
    .line 440
    :cond_c
    mul-double v2, v40, v12

    add-double v4, v40, v8

    double-to-int v4, v4

    invoke-static {v4}, Lorg/apache/commons/math/util/MathUtils;->factorialLog(I)D
    ...
    .end local v40    # "y":D
    .end local v42    # "v":D
    .end local v44    # "generator":Lorg/apache/commons/math/random/RandomGenerator;
    .end local v45    # "t":D
    .end local v47    # "qr":D
    .end local v49    # "qa":D
