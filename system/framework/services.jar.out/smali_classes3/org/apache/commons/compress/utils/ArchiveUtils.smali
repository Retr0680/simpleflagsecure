...
.method public static isEqual([BII[BII)Z
    ...
    .end local p0    # "buffer1":[B
    .end local p1    # "offset1":I
    .end local p2    # "length1":I
    .end local p3    # "buffer2":[B
    .end local p4    # "offset2":I
    .end local p5    # "length2":I
    .local v0, "buffer1":[B
    .local v1, "offset1":I
    .local v2, "length1":I
    .local v3, "buffer2":[B
...
.method public static isEqual([B[BZ)Z
    ...
    .end local p0    # "buffer1":[B
    .end local p1    # "buffer2":[B
    .end local p2    # "ignoreTrailingNulls":Z
    .local v0, "buffer1":[B
    .local v3, "buffer2":[B
    .local v6, "ignoreTrailingNulls":Z
    invoke-static/range {v0 .. v6}, Lorg/apache/commons/compress/utils/ArchiveUtils;->isEqual([BII[BIIZ)Z
