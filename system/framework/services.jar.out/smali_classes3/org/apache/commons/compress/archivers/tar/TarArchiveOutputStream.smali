...
.method private addPaxHeadersForBigNumbers(Ljava/util/Map;Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;)V
    ...
    .line 593
    const-string v9, "SCHILY.devmajor"
...
.method private encodeExtendedPaxHeadersContents(Ljava/util/Map;)[B
    ...
    .line 502
    :cond_0
    invoke-virtual {v0, v7}, Ljava/io/StringWriter;->write(Ljava/lang/String;)V
...
.method private failForBigNumbers(Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;)V
    ...
    .line 612
    const-string v7, "last modification time"
...
.method public putArchiveEntry(Lorg/apache/commons/compress/archivers/ArchiveEntry;)V
    ...
    check-cast v2, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;

    .line 345
    .local v2, "entry":Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;
    invoke-virtual {v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->isGlobalPaxHeader()Z
    ...
    .line 346
    invoke-virtual {v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->getExtraPaxHeaders()Ljava/util/Map;
    ...
    :cond_0
    invoke-virtual {v2, v1, v3, v10}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->writeEntryHeader([BLorg/apache/commons/compress/archivers/zip/ZipEncoding;Z)V
    ...
    .line 352
    iput-boolean v11, p0, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->haveUnclosedEntry:Z
    ...
    .line 357
    .local v4, "paxHeaders":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    .local v0, "paxHeaderContainsPath":Z
    .local v12, "entryName":Ljava/lang/String;
    invoke-virtual {v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->getLinkName()Ljava/lang/String;

    move-result-object v3

    .line 362
    .local v3, "linkName":Ljava/lang/String;
    if-eqz v3, :cond_2
    ...
    .line 366
    .local v5, "paxHeaderContainsLinkPath":Z
    iget v6, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->bigNumberMode:I
    ...
    .line 367
    invoke-direct {p0, v4, v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->addPaxHeadersForBigNumbers(Ljava/util/Map;Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;)V
    ...
    .line 369
    invoke-direct {p0, v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->failForBigNumbers(Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;)V

    .line 372
    :cond_5
    :goto_1
    iget-boolean v6, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->addPaxHeadersForNonAsciiNames:Z

    if-eqz v6, :cond_6

    if-nez v0, :cond_6

    sget-object v6, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->ASCII:Lorg/apache/commons/compress/archivers/zip/ZipEncoding;

    .line 373
    invoke-interface {v6, v12}, Lorg/apache/commons/compress/archivers/zip/ZipEncoding;->canEncode(Ljava/lang/String;)Z
    ...
    .line 378
    invoke-virtual {v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->isLink()Z

    move-result v6

    if-nez v6, :cond_7

    invoke-virtual {v2}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->isSymbolicLink()Z
    ...
    .line 379
    invoke-interface {v6, v3}, Lorg/apache/commons/compress/archivers/zip/ZipEncoding;->canEncode(Ljava/lang/String;)Z
    ...
    .line 385
    invoke-virtual {p0, v2, v12, v4}, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->writePaxHeaders(Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;Ljava/lang/String;Ljava/util/Map;)V

    .line 388
    :cond_9
    iget-object v6, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->recordBuf:[B

    iget-object v7, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->zipEncoding:Lorg/apache/commons/compress/archivers/zip/ZipEncoding;

    iget v13, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->bigNumberMode:I
    ...
    :cond_a
    invoke-virtual {v2, v6, v7, v10}, Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;->writeEntryHeader([BLorg/apache/commons/compress/archivers/zip/ZipEncoding;Z)V

    .line 389
    iget-object v6, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->recordBuf:[B

    invoke-direct {p0, v6}, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->writeRecord([B)V

    .line 391
    iput-wide v8, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->currBytes:J
    ...
    .line 394
    iput-wide v8, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->currSize:J
    ...
    iput-wide v6, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->currSize:J

    .line 398
    :goto_2
    iput-object v12, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->currName:Ljava/lang/String;

    .line 399
    iput-boolean v11, v1, Lorg/apache/commons/compress/archivers/tar/TarArchiveOutputStream;->haveUnclosedEntry:Z

    .line 401
    .end local v0    # "paxHeaderContainsPath":Z
    .end local v3    # "linkName":Ljava/lang/String;
    .end local v4    # "paxHeaders":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v5    # "paxHeaderContainsLinkPath":Z
    .end local v12    # "entryName":Ljava/lang/String;
    :goto_3
    return-void

    .line 342
    .end local v2    # "entry":Lorg/apache/commons/compress/archivers/tar/TarArchiveEntry;
    :cond_c
    move-object v1, p0
