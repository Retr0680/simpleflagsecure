...
.method private sendMTFValues1(II)I
    ...
    iget v15, v0, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->nMTF:I

    if-ge v9, v15, :cond_a

    .line 834
    add-int/lit8 v15, v9, 0x32
    ...
    .end local v3    # "cost1":S
    .restart local v27    # "cost1":S
    aget-byte v3, v14, v33
    ...
    .end local v3    # "cost2":S
    .restart local v28    # "cost2":S
    aget-byte v3, v16, v33
    ...
    .end local v3    # "cost3":S
    .restart local v29    # "cost3":S
    aget-byte v3, v18, v33
    ...
    .end local v3    # "cost4":S
    .restart local v30    # "cost4":S
    aget-byte v3, v20, v33
    ...
    .line 856
    .end local v3    # "i":I
    aput-short v15, v5, v17

    .line 857
    aput-short v27, v5, v21

    .line 858
    aput-short v28, v5, v23

    .line 859
    aput-short v29, v5, v25

    .line 860
    aput-short v30, v5, v24

    .line 861
    aput-short v31, v5, v19

    .line 863
    .end local v15    # "cost0":S
    .end local v27    # "cost1":S
    .end local v28    # "cost2":S
    .end local v29    # "cost3":S
    .end local v30    # "cost4":S
    ...
    .line 864
    .end local v32    # "rfreq":[[I
    .local v3, "rfreq":[[I
    :cond_3
    move-object/from16 v32, v3

    .end local v3    # "rfreq":[[I
    .restart local v32    # "rfreq":[[I
    move/from16 v3, p1
    ...
    aget-object v29, v8, v27

    move/from16 v30, v3

    .end local v3    # "i":I
    .local v30, "i":I
    aget-byte v3, v29, v15
    ...
    invoke-static {v3, v4, v5, v15, v9}, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->hbMakeCodeLengths([B[ILorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream$Data;II)V
    ...
    .end local v32    # "rfreq":[[I
    .local v2, "dataShadow":Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream$Data;
    .restart local v3    # "rfreq":[[I
    .restart local v4    # "fave":[I
    .restart local v5    # "cost":[S
    :cond_c
    nop
