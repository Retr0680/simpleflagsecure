...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/utils/quota/Categorizer;Lcom/android/server/utils/quota/QuotaTracker$Injector;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/utils/quota/CountQuotaTracker$EarliestEventTimeFunctor;-><init>(Lcom/android/server/utils/quota/CountQuotaTracker-IA;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/utils/quota/CountQuotaTracker$DeleteEventTimesFunctor;-><init>(Lcom/android/server/utils/quota/CountQuotaTracker;Lcom/android/server/utils/quota/CountQuotaTracker-IA;)V
...
.method private synthetic lambda$dump$8(Landroid/util/proto/ProtoOutputStream;ILjava/lang/String;Ljava/lang/String;Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;)V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/server/utils/quota/QuotaTracker;->isIndividualQuotaFreeLocked(ILjava/lang/String;)Z
    ...
    .line 768
    .local v8, "usToken":J
    new-instance v10, Lcom/android/server/utils/quota/Uptc;

    invoke-direct {v10, v1, v2, v3}, Lcom/android/server/utils/quota/Uptc;-><init>(ILjava/lang/String;Ljava/lang/String;)V

    .line 769
    const-wide v11, 0x10b00000001L

    invoke-virtual {v10, p1, v11, v12}, Lcom/android/server/utils/quota/Uptc;->dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    .line 773
    iget-object v10, p0, Lcom/android/server/utils/quota/CountQuotaTracker;->mEventTimes:Lcom/android/server/utils/quota/UptcMap;

    invoke-virtual {v10, v1, v2, v3}, Lcom/android/server/utils/quota/UptcMap;->get(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Landroid/util/LongArrayQueue;

    .line 774
    .local v10, "events":Landroid/util/LongArrayQueue;
    if-eqz v10, :cond_0

    .line 775
    invoke-virtual {v10}, Landroid/util/LongArrayQueue;->size()I
    ...
    .line 777
    .local v11, "eToken":J
    invoke-virtual {v10, v13}, Landroid/util/LongArrayQueue;->get(I)J

    move-result-wide v6

    const-wide v1, 0x10300000001L

    invoke-virtual {p1, v1, v2, v6, v7}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    .line 778
    invoke-virtual {p1, v11, v12}, Landroid/util/proto/ProtoOutputStream;->end(J)V

    .line 775
    .end local v11    # "eToken":J
    add-int/lit8 v13, v13, -0x1
    ...
    .line 784
    .local v1, "statsToken":J
    iget-wide v6, v4, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->expirationTimeElapsed:J

    const-wide v11, 0x10300000001L

    invoke-virtual {p1, v11, v12, v6, v7}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    .line 787
    const-wide v6, 0x10300000002L

    iget-wide v11, v4, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->windowSizeMs:J
    ...
    iget v11, v4, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->countLimit:I

    invoke-virtual {p1, v6, v7, v11}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    .line 791
    const-wide v6, 0x10500000004L

    iget v11, v4, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->countInWindow:I
    ...
    iget-wide v11, v4, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->inQuotaTimeElapsed:J
...
.method private maybeUpdateStatusForPkgLocked(ILjava/lang/String;)Z
    ...
    .line 552
    .local v3, "done":Lcom/android/server/utils/quota/UptcMap;, "Lcom/android/server/utils/quota/UptcMap<Ljava/lang/Boolean;>;"
    ...
    .line 556
    .local v0, "events":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Landroid/util/LongArrayQueue;>;"
    if-nez v0, :cond_1
    ...
    const-string v4, "Events map was null even though mEventTimes said it contained "
    ...
    invoke-static {p1, p2, v4}, Lcom/android/server/utils/quota/Uptc;->string(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 565
    .local v6, "changed":[Z
    new-instance v1, Lcom/android/server/utils/quota/CountQuotaTracker$$ExternalSyntheticLambda2;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/utils/quota/CountQuotaTracker$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/utils/quota/CountQuotaTracker;Lcom/android/server/utils/quota/UptcMap;ILjava/lang/String;[Z)V

    invoke-virtual {v0, v1}, Landroid/util/ArrayMap;->forEach(Ljava/util/function/BiConsumer;)V

    .line 572
    aget-boolean p1, v6, v7
...
.method public dump(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    .line 749
    .local v1, "token":J
    iget-object v3, p0, Lcom/android/server/utils/quota/QuotaTracker;->mLock:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-super {p0, p1, v4, v5}, Lcom/android/server/utils/quota/QuotaTracker;->dump(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    .local v0, "i":I
    :goto_0
    iget-object v6, p0, Lcom/android/server/utils/quota/CountQuotaTracker;->mCategoryCountWindowSizesMs:Landroid/util/ArrayMap;
    ...
    check-cast v6, Lcom/android/server/utils/quota/Category;

    .line 754
    .local v6, "category":Lcom/android/server/utils/quota/Category;
    ...
    .line 755
    .local v7, "clToken":J
    invoke-virtual {v6, p1, v4, v5}, Lcom/android/server/utils/quota/Category;->dumpDebug(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    .line 752
    .end local v6    # "category":Lcom/android/server/utils/quota/Category;
    .end local v7    # "clToken":J
    add-int/lit8 v0, v0, 0x1
    ...
    new-instance v4, Lcom/android/server/utils/quota/CountQuotaTracker$$ExternalSyntheticLambda1;

    invoke-direct {v4, p0, p1}, Lcom/android/server/utils/quota/CountQuotaTracker$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/utils/quota/CountQuotaTracker;Landroid/util/proto/ProtoOutputStream;)V

    invoke-virtual {v0, v4}, Lcom/android/server/utils/quota/UptcMap;->forEach(Lcom/android/server/utils/quota/UptcMap$UptcDataConsumer;)V
...
.method maybeScheduleCleanupAlarmLocked()V
    ...
    .line 539
    .end local v2    # "nextCleanupElapsed":J
    .local v6, "nextCleanupElapsed":J
    :goto_0
    iput-wide v6, p0, Lcom/android/server/utils/quota/CountQuotaTracker;->mNextCleanupTimeElapsed:J
...
.method updateExecutionStatsLocked(ILjava/lang/String;Ljava/lang/String;Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;)V
    ...
    .line 440
    iget v5, v1, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->countInWindow:I

    iget v6, v1, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->countLimit:I

    if-lt v5, v6, :cond_3

    .line 441
    iget-wide v5, v1, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->inQuotaTimeElapsed:J
    ...
    .local v17, "events":Landroid/util/LongArrayQueue;
    ...
    .line 440
    .end local v17    # "events":Landroid/util/LongArrayQueue;
    .end local v18    # "emptyTimeMs":J
    ...
    .restart local v17    # "events":Landroid/util/LongArrayQueue;
    .restart local v18    # "emptyTimeMs":J
    :goto_2
    add-int/lit8 v12, v12, -0x1
    ...
    iput-wide v5, v1, Lcom/android/server/utils/quota/CountQuotaTracker$ExecutionStats;->expirationTimeElapsed:J
