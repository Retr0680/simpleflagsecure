...
.method public acquire(Landroid/os/IBinder;Ljava/lang/String;I)V
    ...
    .line 68
    .local v0, "watcher":Landroid/os/TokenWatcher;
    if-nez v0, :cond_0
    ...
    .line 70
    iget-object p3, v3, Lcom/android/server/utils/UserTokenWatcher;->mWatchers:Landroid/util/SparseArray;

    invoke-virtual {p3, v4, v0}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    goto :goto_0

    .line 73
    .end local v0    # "watcher":Landroid/os/TokenWatcher;
    :catchall_0
    move-exception v0
    ...
    .line 68
    .end local v4    # "userId":I
    .restart local v0    # "watcher":Landroid/os/TokenWatcher;
    .restart local p3    # "userId":I
    :cond_0
    move-object v3, p0
