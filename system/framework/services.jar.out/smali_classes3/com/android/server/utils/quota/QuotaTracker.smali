...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/utils/quota/Categorizer;Lcom/android/server/utils/quota/QuotaTracker$Injector;)V
    ...
    iput-object v2, p0, Lcom/android/server/utils/quota/QuotaTracker;->mAlarmManager:Landroid/app/AlarmManager;

    .line 166
    new-instance v2, Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmQueue;

    iget-object v3, p0, Lcom/android/server/utils/quota/QuotaTracker;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v2, p0, v3, v4, v5}, Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmQueue;-><init>(Lcom/android/server/utils/quota/QuotaTracker;Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/utils/quota/QuotaTracker-IA;)V

    iput-object v2, p0, Lcom/android/server/utils/quota/QuotaTracker;->mInQuotaAlarmQueue:Lcom/android/server/utils/quota/QuotaTracker$InQuotaAlarmQueue;
...
.method private synthetic lambda$scheduleAlarm$0(IJLjava/lang/String;Landroid/app/AlarmManager$OnAlarmListener;)V
    ...
    .end local p5    # "listener":Landroid/app/AlarmManager$OnAlarmListener;
    .local v2, "type":I
    .local v3, "triggerAtMillis":J
    .local v5, "tag":Ljava/lang/String;
    .local v6, "listener":Landroid/app/AlarmManager$OnAlarmListener;
    ...
    .end local v6    # "listener":Landroid/app/AlarmManager$OnAlarmListener;
    .restart local p1    # "type":I
    .restart local p2    # "triggerAtMillis":J
    .restart local p4    # "tag":Ljava/lang/String;
    .restart local p5    # "listener":Landroid/app/AlarmManager$OnAlarmListener;
    :cond_0
    move v2, p1
    ...
    .restart local v6    # "listener":Landroid/app/AlarmManager$OnAlarmListener;
...
.method scheduleAlarm(IJLjava/lang/String;Landroid/app/AlarmManager$OnAlarmListener;)V
    ...
    .local v7, "listener":Landroid/app/AlarmManager$OnAlarmListener;
