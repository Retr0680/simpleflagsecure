...
.method public vibrateIfAvailable(Lcom/android/server/vibrator/VibrationSession$CallerInfo;Landroid/os/CombinedVibration;)Z
    ...
    iget-object v7, p1, Lcom/android/server/vibrator/VibrationSession$CallerInfo;->reason:Ljava/lang/String;
    ...
    .end local p2    # "effect":Landroid/os/CombinedVibration;
    .local v6, "effect":Landroid/os/CombinedVibration;
    :try_start_1
    ...
    .end local v6    # "effect":Landroid/os/CombinedVibration;
    .restart local p2    # "effect":Landroid/os/CombinedVibration;
    :catchall_1
    move-exception v0
    ...
    .end local p2    # "effect":Landroid/os/CombinedVibration;
    .restart local v6    # "effect":Landroid/os/CombinedVibration;
    goto :goto_2
    ...
    .end local p2    # "effect":Landroid/os/CombinedVibration;
    .restart local v6    # "effect":Landroid/os/CombinedVibration;
    iget-object p2, p0, Lcom/android/server/vibrator/InputDeviceDelegate;->mInputDeviceVibrators:Landroid/util/SparseArray;
