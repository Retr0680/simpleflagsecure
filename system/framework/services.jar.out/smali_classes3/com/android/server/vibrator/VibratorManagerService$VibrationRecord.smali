...
# instance fields
.field private final mInfo:Lcom/android/server/vibrator/VibrationSession$DebugInfo;


# direct methods
.method constructor <init>(Lcom/android/server/vibrator/VibrationSession$DebugInfo;)V
    .locals 0
...
.method public dump(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/android/server/vibrator/VibrationSession$DebugInfo;->dump(Landroid/util/proto/ProtoOutputStream;J)V
...
.method public getCreateUptimeMs()J
    ...
    invoke-interface {v0}, Lcom/android/server/vibrator/VibrationSession$DebugInfo;->getCreateUptimeMillis()J
...
.method public mayAggregate(Lcom/android/server/vibrator/GroupedAggregatedLogRecords$SingleLogRecord;)Z
    ...
    iget-object v0, v0, Lcom/android/server/vibrator/VibratorManagerService$VibrationRecord;->mInfo:Lcom/android/server/vibrator/VibrationSession$DebugInfo;

    .line 2470
    .local v0, "info":Lcom/android/server/vibrator/VibrationSession$DebugInfo;
    iget-object v2, p0, Lcom/android/server/vibrator/VibratorManagerService$VibrationRecord;->mInfo:Lcom/android/server/vibrator/VibrationSession$DebugInfo;

    invoke-interface {v2}, Lcom/android/server/vibrator/VibrationSession$DebugInfo;->getCallerInfo()Lcom/android/server/vibrator/VibrationSession$CallerInfo;
    ...
    .line 2472
    invoke-interface {v2}, Lcom/android/server/vibrator/VibrationSession$DebugInfo;->getDumpAggregationKey()Ljava/lang/Object;

    move-result-object v2

    invoke-interface {v0}, Lcom/android/server/vibrator/VibrationSession$DebugInfo;->getDumpAggregationKey()Ljava/lang/Object;
