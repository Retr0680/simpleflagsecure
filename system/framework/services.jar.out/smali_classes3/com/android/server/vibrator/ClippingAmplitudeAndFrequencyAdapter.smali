...
.method private adaptToVibrator(Landroid/os/VibratorInfo;Landroid/os/vibrator/RampSegment;)Landroid/os/vibrator/RampSegment;
    ...
    .line 52
    .local v4, "clampedStartFrequency":F
    ...
    .line 53
    .local v5, "clampedEndFrequency":F
    ...
    invoke-direct {p0, p1, v4, v0}, Lcom/android/server/vibrator/ClippingAmplitudeAndFrequencyAdapter;->clampAmplitude(Landroid/os/VibratorInfo;FF)F
    ...
    invoke-direct {p0, p1, v5, v0}, Lcom/android/server/vibrator/ClippingAmplitudeAndFrequencyAdapter;->clampAmplitude(Landroid/os/VibratorInfo;FF)F
...
.method private clampAmplitude(Landroid/os/VibratorInfo;FF)F
    ...
    .line 71
    .local v0, "mapping":Landroid/os/VibratorInfo$FrequencyProfileLegacy;
    ...
    .line 76
    :cond_0
    invoke-virtual {v0, p2}, Landroid/os/VibratorInfo$FrequencyProfileLegacy;->getMaxAmplitude(F)F
