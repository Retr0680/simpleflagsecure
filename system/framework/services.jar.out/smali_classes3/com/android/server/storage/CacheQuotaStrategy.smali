...
.method private getUnfulfilledRequests()Ljava/util/List;
    ...
    .line 171
    .local v10, "requests":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/CacheQuotaHint;>;"
    ...
    invoke-virtual {v13, v9, v1, v0}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;

    move-result-object v0

    .line 190
    .local v0, "appInfo":Landroid/content/pm/ApplicationInfo;
    new-instance v1, Landroid/app/usage/CacheQuotaHint$Builder;

    invoke-direct {v1}, Landroid/app/usage/CacheQuotaHint$Builder;-><init>()V
    :try_end_0
    ...
    .line 192
    invoke-virtual {v1, v2}, Landroid/app/usage/CacheQuotaHint$Builder;->setVolumeUuid(Ljava/lang/String;)Landroid/app/usage/CacheQuotaHint$Builder;
    ...
    .line 194
    invoke-virtual {v1, v4}, Landroid/app/usage/CacheQuotaHint$Builder;->setUsageStats(Landroid/app/usage/UsageStats;)Landroid/app/usage/CacheQuotaHint$Builder;
    ...
    .end local v16    # "stats":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/UsageStats;>;"
    .end local v17    # "i":I
    .restart local v2    # "stats":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/UsageStats;>;"
    .restart local v3    # "i":I
    :catch_2
    move-exception v0
    ...
    .restart local v16    # "stats":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/UsageStats;>;"
    .restart local v17    # "i":I
    :goto_2
    nop
...
.method private pushProcessedQuotas(Ljava/util/List;)V
    ...
    .line 231
    .local v0, "ex":Lcom/android/server/pm/Installer$InstallerException;
    ...
    .line 235
    .end local v0    # "ex":Lcom/android/server/pm/Installer$InstallerException;
    .end local v2    # "request":Landroid/app/usage/CacheQuotaHint;
    .end local v7    # "proposedQuota":J
    :goto_1
    goto :goto_0
...
.method protected static readFromXml(Ljava/io/InputStream;)Landroid/util/Pair;
    ...
    .line 372
    .local v5, "request":Landroid/app/usage/CacheQuotaHint;
    if-eqz v5, :cond_3
    ...
    .line 377
    .end local v5    # "request":Landroid/app/usage/CacheQuotaHint;
    :cond_3
    move-object v5, v4
