...
.method private addAppsToJson(Lorg/json/JSONObject;)V
    ...
    .end local v11    # "isExternal":Z
    .local v15, "isExternal":Z
    iget-wide v11, v14, Landroid/content/pm/PackageStats;->codeSize:J

    .line 129
    .local v11, "appSize":J
    move-wide/from16 v17, v11

    .end local v11    # "appSize":J
    .local v17, "appSize":J
    iget-wide v11, v14, Landroid/content/pm/PackageStats;->dataSize:J

    .line 130
    .local v11, "appDataSize":J
    move-wide/from16 v19, v11

    .end local v11    # "appDataSize":J
    .local v19, "appDataSize":J
    iget-wide v11, v14, Landroid/content/pm/PackageStats;->cacheSize:J
    ...
    .local v21, "cacheSize":J
    iget-wide v11, v14, Landroid/content/pm/PackageStats;->externalCodeSize:J

    add-long v11, v17, v11

    .line 133
    .end local v17    # "appSize":J
    .local v11, "appSize":J
    move-wide/from16 v17, v11

    .end local v11    # "appSize":J
    .restart local v17    # "appSize":J
    iget-wide v11, v14, Landroid/content/pm/PackageStats;->externalDataSize:J

    add-long v11, v19, v11

    .line 134
    .end local v19    # "appDataSize":J
    .local v11, "appDataSize":J
    move-wide/from16 v19, v11

    .end local v11    # "appDataSize":J
    .restart local v19    # "appDataSize":J
    iget-wide v11, v14, Landroid/content/pm/PackageStats;->externalCacheSize:J
    ...
    .line 136
    .end local v21    # "cacheSize":J
    .local v7, "appDataSize":J
    .local v9, "cacheSize":J
    .local v11, "appSize":J
    .local v17, "appDataSizeSum":J
    .local v19, "cacheSizeSum":J
    :goto_1
    ...
    .line 143
    invoke-virtual {v4, v9, v10}, Lorg/json/JSONArray;->put(J)Lorg/json/JSONArray;

    .line 144
    .end local v7    # "appDataSize":J
    .end local v9    # "cacheSize":J
    .end local v11    # "appSize":J
    ...
    .line 145
    .end local v15    # "isExternal":Z
    .end local v17    # "appDataSizeSum":J
    .end local v19    # "cacheSizeSum":J
    .end local v21    # "appSizeSum":J
    .restart local v5    # "appSizeSum":J
    .local v7, "appDataSizeSum":J
    .local v9, "cacheSizeSum":J
    .local v11, "isExternal":Z
    :cond_1
    ...
    .end local v7    # "appDataSizeSum":J
    .end local v11    # "isExternal":Z
    .restart local v15    # "isExternal":Z
    .restart local v17    # "appDataSizeSum":J
    const-string v7, "packageNames"
