...
.method public run()V
    ...
    .line 218
    .local v12, "tasks":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier$SingleAudioStreamCopyTask;>;"
    const/4 v0, 0x0
    ...
    .line 221
    .local v14, "streamTaskId":Ljava/lang/String;
    new-instance v13, Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier$SingleAudioStreamCopyTask;
    ...
    invoke-static {v7}, Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier;->-$$Nest$fgetmDetectorType(Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier;)I
    ...
    invoke-direct/range {v13 .. v19}, Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier$SingleAudioStreamCopyTask;-><init>(Ljava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/os/ParcelFileDescriptor;III)V

    invoke-interface {v12, v13}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 218
    .end local v6    # "copyTaskInfo":Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier$CopyTaskInfo;
    .end local v14    # "streamTaskId":Ljava/lang/String;
    ...
    .line 227
    const-string v14, "android:record_audio_hotword"

    const-string v18, "Streaming hotword audio to VoiceInteractionService"

    invoke-virtual/range {v13 .. v18}, Landroid/app/AppOpsManager;->startOpNoThrow(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .local v9, "totalStreamSizeBytes":I
    :goto_1
    ...
    .line 257
    .local v0, "task":Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier$SingleAudioStreamCopyTask;
    ...
    .line 258
    .end local v0    # "task":Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier$SingleAudioStreamCopyTask;
    goto :goto_1

    .line 286
    .end local v9    # "totalStreamSizeBytes":I
    :catchall_0
    move-exception v0
    ...
    .line 260
    .restart local v9    # "totalStreamSizeBytes":I
    :cond_2
    new-instance v0, Ljava/lang/StringBuilder;
