...
.method constructor <init>(Lcom/android/server/voiceinteraction/HotwordDetectionConnection$ServiceConnection;Ljava/lang/Object;Landroid/content/Context;Landroid/os/IBinder;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;ILandroid/media/permission/Identity;Ljava/util/concurrent/ScheduledExecutorService;ZLcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl$DetectorRemoteExceptionListener;I)V
    ...
    .line 239
    invoke-direct {v0}, Lcom/android/server/voiceinteraction/DetectorSession;->getDetectorType()I
    ...
    .line 240
    new-instance v13, Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier;
    ...
    iget-object v1, v0, Lcom/android/server/voiceinteraction/DetectorSession;->mVoiceInteractorIdentity:Landroid/media/permission/Identity;
    ...
    iget-object v11, v11, Landroid/media/permission/Identity;->packageName:Ljava/lang/String;
    ...
    iget-object v12, v12, Landroid/media/permission/Identity;->attributionTag:Ljava/lang/String;
    ...
    iput-object v13, v0, Lcom/android/server/voiceinteraction/DetectorSession;->mHotwordAudioStreamCopier:Lcom/android/server/voiceinteraction/HotwordAudioStreamCopier;
...
.method private handleExternalSourceHotwordDetectionLocked(Landroid/os/ParcelFileDescriptor;Landroid/media/AudioFormat;Landroid/os/PersistableBundle;Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;ZZ)V
    ...
    .line 528
    .local v8, "audioSource":Ljava/io/InputStream;
    invoke-static {}, Lcom/android/server/voiceinteraction/DetectorSession;->createPipe()Landroid/util/Pair;

    move-result-object v0

    .line 529
    .local v0, "clientPipe":Landroid/util/Pair;, "Landroid/util/Pair<Landroid/os/ParcelFileDescriptor;Landroid/os/ParcelFileDescriptor;>;"
    if-nez v0, :cond_1
    ...
    .line 534
    .local v7, "serviceAudioSink":Landroid/os/ParcelFileDescriptor;
    ...
    .line 536
    .local v5, "serviceAudioSource":Landroid/os/ParcelFileDescriptor;
    iput-object v7, p0, Lcom/android/server/voiceinteraction/DetectorSession;->mCurrentAudioSink:Landroid/os/ParcelFileDescriptor;
    ...
    .line 539
    iget-object v1, p0, Lcom/android/server/voiceinteraction/DetectorSession;->mAudioCopyExecutor:Ljava/util/concurrent/Executor;

    new-instance v2, Lcom/android/server/voiceinteraction/DetectorSession$$ExternalSyntheticLambda3;

    move-object/from16 v9, p4

    invoke-direct {v2, p0, v8, v7, v9}, Lcom/android/server/voiceinteraction/DetectorSession$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/voiceinteraction/DetectorSession;Ljava/io/InputStream;Landroid/os/ParcelFileDescriptor;Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;)V

    invoke-interface {v1, v2}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    .line 584
    iget-object v11, p0, Lcom/android/server/voiceinteraction/DetectorSession;->mRemoteDetectionService:Lcom/android/server/voiceinteraction/HotwordDetectionConnection$ServiceConnection;

    new-instance v1, Lcom/android/server/voiceinteraction/DetectorSession$$ExternalSyntheticLambda4;
    ...
    invoke-virtual {v11, v1}, Lcom/android/internal/infra/ServiceConnector$Impl;->run(Lcom/android/internal/infra/ServiceConnector$VoidJob;)Z
    ...
    invoke-static {v1, v3, v4}, Lcom/android/server/voiceinteraction/HotwordMetricsLogger;->writeDetectorEvent(III)V
...
.method private synthetic lambda$enforcePermissionsForDataDelivery$5()V
    ...
    invoke-static {v0, v2, v5, v3, v4}, Landroid/content/PermissionChecker;->checkPermissionForPreflight(Landroid/content/Context;Ljava/lang/String;IILjava/lang/String;)I
...
.method private synthetic lambda$handleExternalSourceHotwordDetectionLocked$4(Landroid/os/PersistableBundle;ZLandroid/os/ParcelFileDescriptor;Landroid/media/AudioFormat;Landroid/os/ParcelFileDescriptor;Ljava/io/InputStream;Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;ZLandroid/service/voice/ISandboxedDetectionService;)V
    ...
    .line 591
    .end local v0    # "optionsToSend":Landroid/os/PersistableBundle;
    .local v5, "optionsToSend":Landroid/os/PersistableBundle;
    :goto_0
    const-string v0, "android.service.voice.HotwordDetectionService.KEY_SYSTEM_WILL_CLOSE_AUDIO_STREAM_AFTER_CALLBACK"

    invoke-virtual {v5, v0, p2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    .line 596
    new-instance v6, Lcom/android/server/voiceinteraction/DetectorSession$3;
    ...
    invoke-direct/range {v6 .. v12}, Lcom/android/server/voiceinteraction/DetectorSession$3;-><init>(Lcom/android/server/voiceinteraction/DetectorSession;Landroid/os/ParcelFileDescriptor;Ljava/io/InputStream;Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;ZZ)V
    ...
    invoke-interface/range {v1 .. v6}, Landroid/service/voice/ISandboxedDetectionService;->detectFromMicrophoneSource(Landroid/os/ParcelFileDescriptor;ILandroid/media/AudioFormat;Landroid/os/PersistableBundle;Landroid/service/voice/IDspHotwordDetectionCallback;)V

    .line 727
    invoke-static/range {p3 .. p3}, Lcom/android/server/voiceinteraction/DetectorSession;->bestEffortClose(Ljava/io/Closeable;)V
...
.method startListeningFromExternalSourceLocked(Landroid/os/ParcelFileDescriptor;Landroid/media/AudioFormat;Landroid/os/PersistableBundle;Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;)V
    ...
    .local v4, "callback":Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;
...
.method startListeningFromWearableLocked(Landroid/os/ParcelFileDescriptor;Landroid/media/AudioFormat;Landroid/os/PersistableBundle;Landroid/service/voice/VoiceInteractionManagerInternal$WearableHotwordDetectionCallback;)V
    ...
    .line 426
    new-instance v0, Lcom/android/server/voiceinteraction/DetectorSession$2;

    invoke-direct {v0, p0, p4}, Lcom/android/server/voiceinteraction/DetectorSession$2;-><init>(Lcom/android/server/voiceinteraction/DetectorSession;Landroid/service/voice/VoiceInteractionManagerInternal$WearableHotwordDetectionCallback;)V

    move-object v5, v0

    .line 501
    .local v5, "voiceInteractionCallback":Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;
    const/4 v6, 0x0
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/voiceinteraction/DetectorSession;->handleExternalSourceHotwordDetectionLocked(Landroid/os/ParcelFileDescriptor;Landroid/media/AudioFormat;Landroid/os/PersistableBundle;Landroid/service/voice/IMicrophoneHotwordDetectionVoiceInteractionCallback;ZZ)V
