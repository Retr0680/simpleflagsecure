...
.method constructor <init>(Lcom/android/server/voiceinteraction/HotwordDetectionConnection$ServiceConnection;Ljava/lang/Object;Landroid/content/Context;Landroid/os/IBinder;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;ILandroid/media/permission/Identity;Ljava/util/concurrent/ScheduledExecutorService;ZLcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl$DetectorRemoteExceptionListener;I)V
    ...
    .end local p1    # "remoteHotwordDetectionService":Lcom/android/server/voiceinteraction/HotwordDetectionConnection$ServiceConnection;
    .local v0, "userId":I
    .local p2, "remoteHotwordDetectionService":Lcom/android/server/voiceinteraction/HotwordDetectionConnection$ServiceConnection;
    .local p3, "lock":Ljava/lang/Object;
    .local p4, "context":Landroid/content/Context;
    .local p5, "token":Landroid/os/IBinder;
    .local p6, "callback":Lcom/android/internal/app/IHotwordRecognitionStatusCallback;
    .local p7, "voiceInteractionServiceUid":I
    .local p8, "voiceInteractorIdentity":Landroid/media/permission/Identity;
    .local p9, "scheduledExecutorService":Ljava/util/concurrent/ScheduledExecutorService;
    .local p10, "logging":Z
    .local p11, "listener":Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl$DetectorRemoteExceptionListener;
    const/4 v1, 0x0

    iput-boolean v1, p1, Lcom/android/server/voiceinteraction/DspTrustedHotwordDetectorSession;->mValidatingDspTrigger:Z

    .line 81
    const/4 v1, 0x0

    iput-object v1, p1, Lcom/android/server/voiceinteraction/DspTrustedHotwordDetectorSession;->mLastHotwordRejectedResult:Landroid/service/voice/HotwordRejectedResult;
...
.method private synthetic lambda$detectFromDspSourceLocked$1(Ljava/util/concurrent/atomic/AtomicBoolean;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;Landroid/service/voice/IDspHotwordDetectionCallback;Landroid/service/voice/ISandboxedDetectionService;)V
    ...
    .end local p3    # "recognitionEvent":Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;
    .end local p4    # "internalCallback":Landroid/service/voice/IDspHotwordDetectionCallback;
    .end local p5    # "service":Landroid/service/voice/ISandboxedDetectionService;
    .local v1, "service":Landroid/service/voice/ISandboxedDetectionService;
    .local v2, "recognitionEvent":Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;
    .local v6, "internalCallback":Landroid/service/voice/IDspHotwordDetectionCallback;
...
.method detectFromDspSourceLocked(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;)V
    ...
    .line 105
    .local v4, "timeoutDetected":Ljava/util/concurrent/atomic/AtomicBoolean;
    new-instance v7, Lcom/android/server/voiceinteraction/DspTrustedHotwordDetectorSession$1;

    invoke-direct {v7, p0, v4, p1, p2}, Lcom/android/server/voiceinteraction/DspTrustedHotwordDetectorSession$1;-><init>(Lcom/android/server/voiceinteraction/DspTrustedHotwordDetectorSession;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;Lcom/android/internal/app/IHotwordRecognitionStatusCallback;)V
    ...
    new-instance v2, Lcom/android/server/voiceinteraction/DspTrustedHotwordDetectorSession$$ExternalSyntheticLambda0;
    ...
    .end local p1    # "recognitionEvent":Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;
    .end local p2    # "externalCallback":Lcom/android/internal/app/IHotwordRecognitionStatusCallback;
    .local v5, "externalCallback":Lcom/android/internal/app/IHotwordRecognitionStatusCallback;
    .local v6, "recognitionEvent":Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;
