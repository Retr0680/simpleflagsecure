...
.method private requestShow(Ljava/io/PrintWriter;)I
    ...
    new-instance v0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceShellCommand$1;

    invoke-direct {v0, p0, p1, v3, v2}, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceShellCommand$1;-><init>(Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceShellCommand;Ljava/io/PrintWriter;Ljava/util/concurrent/atomic/AtomicInteger;Ljava/util/concurrent/CountDownLatch;)V

    move-object v8, v0

    .line 116
    .local v8, "callback":Lcom/android/internal/app/IVoiceInteractionSessionShowCallback;
    :try_start_0
    ...
    .line 121
    const-string v4, "showSessionForActiveService() returned false"
    ...
    .line 126
    const-string v4, "Callback not called in %d ms\n"
    ...
    invoke-virtual {p1, v4, v6}, Ljava/io/PrintWriter;->printf(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
