...
.method static createStartingState(Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;)Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderState;
    ...
    .end local p0    # "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .local v1, "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
...
.method newState(ILandroid/service/timezone/TimeZoneProviderEvent;Lcom/android/server/timezonedetector/ConfigurationInternal;Ljava/lang/String;)Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderState;
    ...
    .line 287
    :goto_1
    new-instance v2, Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider$ProviderState;
    ...
    .end local p1    # "newStateEnum":I
    .end local p2    # "event":Landroid/service/timezone/TimeZoneProviderEvent;
    .end local p3    # "currentUserConfig":Lcom/android/server/timezonedetector/ConfigurationInternal;
    .end local p4    # "debugInfo":Ljava/lang/String;
    .local v4, "newStateEnum":I
    .local v5, "event":Landroid/service/timezone/TimeZoneProviderEvent;
    .local v6, "currentUserConfig":Lcom/android/server/timezonedetector/ConfigurationInternal;
    .local v7, "debugInfo":Ljava/lang/String;
    ...
    .line 267
    .end local v4    # "newStateEnum":I
    .end local v5    # "event":Landroid/service/timezone/TimeZoneProviderEvent;
    .end local v6    # "currentUserConfig":Lcom/android/server/timezonedetector/ConfigurationInternal;
    .end local v7    # "debugInfo":Ljava/lang/String;
    .restart local p1    # "newStateEnum":I
    .restart local p2    # "event":Landroid/service/timezone/TimeZoneProviderEvent;
    .restart local p3    # "currentUserConfig":Lcom/android/server/timezonedetector/ConfigurationInternal;
    .restart local p4    # "debugInfo":Ljava/lang/String;
    :cond_2
    move v4, p1
    ...
    .end local p1    # "newStateEnum":I
    .end local p2    # "event":Landroid/service/timezone/TimeZoneProviderEvent;
    .restart local v4    # "newStateEnum":I
    .restart local v5    # "event":Landroid/service/timezone/TimeZoneProviderEvent;
    ...
    .restart local v4    # "newStateEnum":I
    .restart local v5    # "event":Landroid/service/timezone/TimeZoneProviderEvent;
    .restart local v6    # "currentUserConfig":Lcom/android/server/timezonedetector/ConfigurationInternal;
    new-instance p1, Ljava/lang/IllegalArgumentException;
