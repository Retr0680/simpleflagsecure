...
.method handleProviderUncertainty(Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;JLjava/lang/String;)V
    ...
    .line 747
    .local v6, "uncertaintyDelay":Ljava/time/Duration;
    iget-object v0, p0, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;->mUncertaintyTimeoutQueue:Lcom/android/server/timezonedetector/location/ThreadingDomain$SingleRunnableQueue;
    ...
    .end local p1    # "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .end local p2    # "uncertaintyStartedElapsedMillis":J
    .local v3, "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .local v4, "uncertaintyStartedElapsedMillis":J
    ...
    .line 747
    invoke-virtual {v0, v1, p1, p2}, Lcom/android/server/timezonedetector/location/ThreadingDomain$SingleRunnableQueue;->runDelayed(Ljava/lang/Runnable;J)V

    goto :goto_0

    .line 729
    .end local v3    # "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .end local v4    # "uncertaintyStartedElapsedMillis":J
    .end local v6    # "uncertaintyDelay":Ljava/time/Duration;
    .restart local p1    # "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .restart local p2    # "uncertaintyStartedElapsedMillis":J
    :cond_1
    move-object v2, p0
    ...
    .end local p1    # "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .end local p2    # "uncertaintyStartedElapsedMillis":J
    .restart local v3    # "provider":Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;
    .restart local v4    # "uncertaintyStartedElapsedMillis":J
    :goto_0
    iget-object p1, v2, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;->mPrimaryProvider:Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;

    if-ne v3, p1, :cond_2

    .line 759
    iget-object p1, v2, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;->mSecondaryProvider:Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;

    iget-object p2, v2, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;->mCurrentUserConfiguration:Lcom/android/server/timezonedetector/ConfigurationInternal;

    invoke-direct {p0, p1, p2}, Lcom/android/server/timezonedetector/location/LocationTimeZoneProviderController;->tryStartProvider(Lcom/android/server/timezonedetector/location/LocationTimeZoneProvider;Lcom/android/server/timezonedetector/ConfigurationInternal;)V
