...
.method private runDumpControllerState()I
    ...
    .line 248
    .end local v4    # "outFd":Ljava/io/FileDescriptor;
    .local v5, "outputStream":Lcom/android/internal/util/dump/DualDumpOutputStream;
    goto :goto_0

    .line 249
    .end local v5    # "outputStream":Lcom/android/internal/util/dump/DualDumpOutputStream;
    :cond_1
    ...
    .line 253
    .restart local v5    # "outputStream":Lcom/android/internal/util/dump/DualDumpOutputStream;
    :goto_0
    ...
    .line 255
    .local v4, "lastEvent":Lcom/android/server/timezonedetector/LocationAlgorithmEvent;
    const-string v6, "last_event"

    const-wide v7, 0x10b00000001L

    invoke-virtual {v5, v6, v7, v8}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J

    move-result-wide v9

    .line 259
    .local v9, "lastEventToken":J
    invoke-virtual {v4}, Lcom/android/server/timezonedetector/LocationAlgorithmEvent;->getAlgorithmStatus()Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    ...
    invoke-virtual {v5, v11, v12, v13}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J
    ...
    .local v16, "useProto":Z
    const-wide v2, 0x10e00000001L

    invoke-virtual {v5, v14, v2, v3, v13}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V

    .line 264
    invoke-virtual {v5, v11, v12}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V

    .line 267
    invoke-virtual {v4}, Lcom/android/server/timezonedetector/LocationAlgorithmEvent;->getSuggestion()Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;
    ...
    invoke-virtual {v5, v2, v7, v8}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J
    ...
    .local v17, "algorithmStatus":Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    .local v18, "lastSuggestion":Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;
    const-wide v6, 0x20900000001L

    invoke-virtual {v5, v14, v6, v7, v13}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JLjava/lang/String;)V
    ...
    .line 275
    .end local v17    # "algorithmStatus":Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    .end local v18    # "lastSuggestion":Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;
    ...
    .end local v6    # "algorithmStatus":Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    .end local v7    # "lastSuggestion":Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;
    .restart local v17    # "algorithmStatus":Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    .restart local v18    # "lastSuggestion":Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;
    invoke-virtual {v5, v2, v3}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V
    ...
    .restart local v17    # "algorithmStatus":Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    :goto_2
    invoke-virtual {v4}, Lcom/android/server/timezonedetector/LocationAlgorithmEvent;->getDebugInfo()Ljava/util/List;
    ...
    invoke-virtual {v5, v6, v7, v8, v3}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JLjava/lang/String;)V
    ...
    .line 284
    :cond_4
    invoke-virtual {v5, v9, v10}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V

    goto :goto_4

    .line 253
    .end local v4    # "lastEvent":Lcom/android/server/timezonedetector/LocationAlgorithmEvent;
    .end local v9    # "lastEventToken":J
    .end local v11    # "algorithmStatusToken":J
    .end local v16    # "useProto":Z
    .end local v17    # "algorithmStatus":Landroid/app/time/LocationTimeZoneAlgorithmStatus;
    .local v3, "useProto":Z
    :cond_5
    move v15, v2
    ...
    invoke-static {v5, v2}, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerShellCommand;->writeControllerStates(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/util/List;)V
    ...
    invoke-static {v5, v2, v3, v6, v7}, Lcom/android/server/timezonedetector/location/LocationTimeZoneManagerShellCommand;->writeProviderStates(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/util/List;Ljava/lang/String;J)V
