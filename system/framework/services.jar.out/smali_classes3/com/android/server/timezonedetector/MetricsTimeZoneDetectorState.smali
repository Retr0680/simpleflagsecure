...
.method public static create(Lcom/android/server/timezonedetector/OrdinalGenerator;Lcom/android/server/timezonedetector/ConfigurationInternal;Ljava/lang/String;Landroid/app/timezonedetector/ManualTimeZoneSuggestion;Landroid/app/timezonedetector/TelephonyTimeZoneSuggestion;Lcom/android/server/timezonedetector/LocationAlgorithmEvent;)Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;
    ...
    .line 96
    .local v5, "metricDeviceTimeZoneId":Ljava/lang/String;
    nop
    ...
    .line 98
    .local v4, "deviceTimeZoneIdOrdinal":I
    nop
    ...
    .line 101
    .local v6, "latestCanonicalManualSuggestion":Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState$MetricsTimeZoneSuggestion;
    nop
    ...
    .line 105
    .local v7, "latestCanonicalTelephonySuggestion":Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState$MetricsTimeZoneSuggestion;
    const/4 v1, 0x0

    .line 106
    .local v1, "latestCanonicalGeolocationSuggestion":Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState$MetricsTimeZoneSuggestion;
    if-eqz p5, :cond_1
    ...
    invoke-static {p0, v2, v0}, Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;->createMetricsTimeZoneSuggestion(Lcom/android/server/timezonedetector/OrdinalGenerator;Lcom/android/server/timezonedetector/GeolocationTimeZoneSuggestion;Z)Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState$MetricsTimeZoneSuggestion;
    ...
    .line 112
    .end local v1    # "latestCanonicalGeolocationSuggestion":Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState$MetricsTimeZoneSuggestion;
    .local v8, "latestCanonicalGeolocationSuggestion":Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState$MetricsTimeZoneSuggestion;
    :goto_1
    new-instance v2, Lcom/android/server/timezonedetector/MetricsTimeZoneDetectorState;

    move-object v3, p1

    .end local p1    # "configurationInternal":Lcom/android/server/timezonedetector/ConfigurationInternal;
    .local v3, "configurationInternal":Lcom/android/server/timezonedetector/ConfigurationInternal;
