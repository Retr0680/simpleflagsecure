...
.method protected constructor <init>(Lcom/android/server/translation/TranslationManagerService;Ljava/lang/Object;IZ)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/translation/TranslationManagerServiceImpl$TranslationServiceRemoteCallback;-><init>(Lcom/android/server/translation/TranslationManagerServiceImpl;Lcom/android/server/translation/TranslationManagerServiceImpl-IA;)V
...
.method private ensureRemoteServiceLocked()Lcom/android/server/translation/RemoteTranslationService;
    ...
    :try_start_0
    invoke-direct {p0, v6}, Lcom/android/server/translation/TranslationManagerServiceImpl;->isServiceAvailableForUser(Landroid/content/ComponentName;)Z

    move-result v3

    .line 168
    .local v3, "isServiceAvailableForUser":Z
    ...
    .line 173
    .end local v3    # "isServiceAvailableForUser":Z
    :catchall_0
    move-exception v0

    goto :goto_1

    .restart local v3    # "isServiceAvailableForUser":Z
    :cond_2
    :goto_0
    ...
    .line 180
    :cond_3
    new-instance v4, Lcom/android/server/translation/RemoteTranslationService;
    ...
    iput-object v4, p0, Lcom/android/server/translation/TranslationManagerServiceImpl;->mRemoteTranslationService:Lcom/android/server/translation/RemoteTranslationService;
...
.method private invokeCallbacksIfNecessaryLocked(ILandroid/view/translation/TranslationSpec;Landroid/view/translation/TranslationSpec;Ljava/lang/String;Landroid/os/IBinder;I)V
    ...
    .end local v1    # "stateForCallbackInvocation":I
    .local v4, "stateForCallbackInvocation":I
    :goto_2
    if-eqz v0, :cond_4
    ...
    .end local p6    # "translatedAppUid":I
    ...
    .line 438
    .end local v5    # "sourceSpec":Landroid/view/translation/TranslationSpec;
    .end local v6    # "targetSpec":Landroid/view/translation/TranslationSpec;
    .end local v7    # "packageName":Ljava/lang/String;
    .end local v8    # "translatedAppUid":I
    .restart local p2    # "sourceSpec":Landroid/view/translation/TranslationSpec;
    .restart local p3    # "targetSpec":Landroid/view/translation/TranslationSpec;
    .restart local p4    # "packageName":Ljava/lang/String;
    .restart local p6    # "translatedAppUid":I
    :cond_4
    move-object v5, p2
    ...
    .end local p4    # "packageName":Ljava/lang/String;
    .end local p6    # "translatedAppUid":I
    .restart local v5    # "sourceSpec":Landroid/view/translation/TranslationSpec;
    .restart local v6    # "targetSpec":Landroid/view/translation/TranslationSpec;
    .restart local v7    # "packageName":Ljava/lang/String;
    .restart local v8    # "translatedAppUid":I
    :goto_3
    return-void
...
.method private synthetic lambda$invokeCallbacks$0(ILandroid/os/Bundle;Ljava/util/List;Landroid/os/IRemoteCallback;Ljava/lang/Object;)V
    ...
    .end local p1    # "translatedAppUid":I
    .end local p2    # "result":Landroid/os/Bundle;
    .end local p3    # "enabledInputMethods":Ljava/util/List;
    .end local p4    # "callback":Landroid/os/IRemoteCallback;
    .local v3, "translatedAppUid":I
    .local v4, "callback":Landroid/os/IRemoteCallback;
    .local v5, "result":Landroid/os/Bundle;
    .local v6, "enabledInputMethods":Ljava/util/List;
...
.method private updateActiveTranslationsLocked(ILandroid/view/translation/TranslationSpec;Landroid/view/translation/TranslationSpec;Ljava/lang/String;Landroid/os/IBinder;I)V
    ...
    check-cast v15, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;

    .line 314
    .local v15, "activeTranslation":Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;
    const-string v2, "TranslationManagerServiceImpl"
    ...
    .line 345
    iput-boolean v0, v15, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->isPaused:Z
    ...
    new-instance v9, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;
    ...
    invoke-direct/range {v9 .. v14}, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;-><init>(Landroid/view/translation/TranslationSpec;Landroid/view/translation/TranslationSpec;ILjava/lang/String;Lcom/android/server/translation/TranslationManagerServiceImpl-IA;)V
    ...
    const-string v4, "Failed to call linkToDeath for translated app with uid="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v12}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v4, "; activity is already dead"
...
.method public binderDied(Landroid/os/IBinder;)V
    ...
    .line 659
    .local v0, "activeTranslation":Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;
    if-eqz v0, :cond_0

    .line 661
    iget-object v4, v0, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->sourceSpec:Landroid/view/translation/TranslationSpec;

    iget-object v5, v0, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->targetSpec:Landroid/view/translation/TranslationSpec;

    iget-object v6, v0, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->packageName:Ljava/lang/String;

    iget v7, v0, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->translatedAppUid:I
    ...
    .line 665
    .end local v0    # "activeTranslation":Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;
    :catchall_0
    move-exception v0
...
.method public onTranslationFinishedLocked(ZLandroid/os/IBinder;Landroid/content/ComponentName;)V
    ...
    .line 255
    iget-object v0, v2, Lcom/android/server/translation/TranslationManagerServiceImpl;->mWaitingFinishedCallbackActivities:Landroid/util/ArraySet;

    invoke-virtual {v0, p2}, Landroid/util/ArraySet;->remove(Ljava/lang/Object;)Z

    .line 256
    iget-object v0, v2, Lcom/android/server/translation/TranslationManagerServiceImpl;->mActiveTranslations:Landroid/util/ArrayMap;
...
.method public registerUiTranslationStateCallbackLocked(Landroid/os/IRemoteCallback;I)V
    ...
    .line 556
    .local v0, "numActiveTranslations":I
    new-instance v1, Ljava/lang/StringBuilder;
    ...
    .line 564
    .local v8, "enabledInputMethods":Ljava/util/List;, "Ljava/util/List<Landroid/view/inputmethod/InputMethodInfo;>;"
    const/4 v1, 0x0
    ...
    .line 566
    .local v9, "activeTranslation":Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;
    iget v5, v9, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->translatedAppUid:I

    .line 567
    .local v5, "translatedAppUid":I
    ...
    invoke-direct {p0, v6, v3, v4, v10}, Lcom/android/server/translation/TranslationManagerServiceImpl;->createResultForCallback(ILandroid/view/translation/TranslationSpec;Landroid/view/translation/TranslationSpec;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v7

    .line 577
    .local v7, "startedResult":Landroid/os/Bundle;
    move-object v3, p0
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/server/translation/TranslationManagerServiceImpl;->invokeCallback(IILandroid/os/IRemoteCallback;Landroid/os/Bundle;Ljava/util/List;)V

    .line 579
    move-object p1, v7

    .end local v7    # "startedResult":Landroid/os/Bundle;
    .local p1, "startedResult":Landroid/os/Bundle;
    iget-boolean p2, v9, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->isPaused:Z

    if-eqz p2, :cond_2

    .line 581
    iget-object p2, v9, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->sourceSpec:Landroid/view/translation/TranslationSpec;

    iget-object v7, v9, Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;->targetSpec:Landroid/view/translation/TranslationSpec;

    const/4 v11, 0x1

    invoke-direct {p0, v11, p2, v7, v10}, Lcom/android/server/translation/TranslationManagerServiceImpl;->createResultForCallback(ILandroid/view/translation/TranslationSpec;Landroid/view/translation/TranslationSpec;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v7

    .line 584
    .local v7, "pausedResult":Landroid/os/Bundle;
    invoke-direct/range {v3 .. v8}, Lcom/android/server/translation/TranslationManagerServiceImpl;->invokeCallback(IILandroid/os/IRemoteCallback;Landroid/os/Bundle;Ljava/util/List;)V

    .line 564
    .end local v5    # "translatedAppUid":I
    .end local v7    # "pausedResult":Landroid/os/Bundle;
    .end local v9    # "activeTranslation":Lcom/android/server/translation/TranslationManagerServiceImpl$ActiveTranslation;
    .end local v10    # "packageName":Ljava/lang/String;
    .end local p1    # "startedResult":Landroid/os/Bundle;
    :cond_2
    ...
    .local p1, "callback":Landroid/os/IRemoteCallback;
...
.method public updateUiTranslationStateLocked(ILandroid/view/translation/TranslationSpec;Landroid/view/translation/TranslationSpec;Ljava/util/List;Landroid/os/IBinder;ILandroid/view/translation/UiTranslationSpec;)V
    ...
    .line 273
    invoke-virtual {v0, v10, v9}, Lcom/android/server/wm/ActivityTaskManagerInternal;->getAttachedNonFinishingActivityForTask(ILandroid/os/IBinder;)Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;

    move-result-object v11

    .line 274
    .local v11, "candidateActivityTokens":Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;
    ...
    .line 284
    :cond_1
    invoke-virtual {v11}, Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;->getActivityToken()Landroid/os/IBinder;
    ...
    :try_start_0
    invoke-virtual {v11}, Lcom/android/server/wm/ActivityTaskManagerInternal$ActivityTokens;->getApplicationThread()Landroid/app/IApplicationThread;
    ...
    invoke-virtual {v0, v8}, Lcom/android/server/wm/ActivityTaskManagerInternal;->getActivityName(Landroid/os/IBinder;)Landroid/content/ComponentName;
    ...
    invoke-direct {p0, v2, v0, v3}, Lcom/android/server/translation/TranslationManagerServiceImpl;->getAppUidByComponentName(Landroid/content/Context;Landroid/content/ComponentName;I)I
