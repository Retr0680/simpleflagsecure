...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/tv/TvInputHardwareManager$Listener;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/tv/TvInputHardwareManager$HdmiHotplugEventListener;-><init>(Lcom/android/server/tv/TvInputHardwareManager;Lcom/android/server/tv/TvInputHardwareManager-IA;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/tv/TvInputHardwareManager$HdmiDeviceEventListener;-><init>(Lcom/android/server/tv/TvInputHardwareManager;Lcom/android/server/tv/TvInputHardwareManager-IA;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/tv/TvInputHardwareManager$HdmiSystemAudioModeChangeListener;-><init>(Lcom/android/server/tv/TvInputHardwareManager;Lcom/android/server/tv/TvInputHardwareManager-IA;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/tv/TvInputHardwareManager$ListenerHandler;-><init>(Lcom/android/server/tv/TvInputHardwareManager;Lcom/android/server/tv/TvInputHardwareManager-IA;)V
...
.method public acquireHardware(ILandroid/media/tv/ITvInputHardwareCallback;Landroid/media/tv/TvInputInfo;IILjava/lang/String;I)Landroid/media/tv/ITvInputHardware;
    ...
    .line 478
    .local v1, "trm":Landroid/media/tv/tunerresourcemanager/TunerResourceManager;
    ...
    const-string v6, "Invalid deviceId : "
    ...
    .line 485
    .restart local v3    # "connection":Lcom/android/server/tv/TvInputHardwareManager$Connection;
    :cond_0
    new-instance v9, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;

    invoke-direct {v9}, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;-><init>()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 486
    .local v9, "profile":Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    move-object/from16 v10, p6

    :try_start_1
    iput-object v10, v9, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;->tvInputSessionId:Ljava/lang/String;
    :try_end_1
    ...
    :try_start_2
    iput v11, v9, Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;->useCase:I

    .line 488
    invoke-virtual {v3}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->getResourceClientProfileLocked()Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    ...
    .line 489
    .local v12, "holderProfile":Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    if-eqz v12, :cond_1

    if-eqz v1, :cond_1

    .line 490
    invoke-virtual {v1, v9, v12}, Landroid/media/tv/tunerresourcemanager/TunerResourceManager;->isHigherPriority(Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;)Z
    ...
    const-string v6, "Acquiring does not show higher priority than the current holder. Device id:"
    ...
    .line 506
    .end local v3    # "connection":Lcom/android/server/tv/TvInputHardwareManager$Connection;
    .end local v9    # "profile":Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    .end local v12    # "holderProfile":Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    :catchall_1
    move-exception v0
    ...
    .line 495
    .restart local v3    # "connection":Lcom/android/server/tv/TvInputHardwareManager$Connection;
    .restart local v9    # "profile":Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    .restart local v12    # "holderProfile":Landroid/media/tv/tunerresourcemanager/ResourceClientProfile;
    :cond_1
    new-instance v0, Lcom/android/server/tv/TvInputHardwareManager$TvInputHardwareImpl;

    .line 496
    invoke-virtual {v3}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->getHardwareInfoLocked()Landroid/media/tv/TvInputHardwareInfo;

    move-result-object v5

    invoke-direct {v0, p0, v5}, Lcom/android/server/tv/TvInputHardwareManager$TvInputHardwareImpl;-><init>(Lcom/android/server/tv/TvInputHardwareManager;Landroid/media/tv/TvInputHardwareInfo;)V
    :try_end_2
    ...
    .restart local v5    # "hardware":Lcom/android/server/tv/TvInputHardwareManager$TvInputHardwareImpl;
    invoke-virtual {v3}, Lcom/android/server/tv/TvInputHardwareManager$Connection;->getHardwareLocked()Landroid/media/tv/ITvInputHardware;
    ...
    .line 474
    .end local v1    # "trm":Landroid/media/tv/tunerresourcemanager/TunerResourceManager;
    :cond_2
    move-object/from16 v10, p6
...
.method public onDeviceUnavailable(I)V
    ...
    .line 204
    .restart local v2    # "connection":Lcom/android/server/tv/TvInputHardwareManager$Connection;
    :cond_0
    const/4 v7, 0x0
    ...
    invoke-virtual {v3, v4, v5, v5, v0}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public releaseHardware(ILandroid/media/tv/ITvInputHardware;II)V
    ...
    .line 526
    invoke-interface {v0}, Landroid/media/tv/ITvInputHardwareCallback;->asBinder()Landroid/os/IBinder;
...
.method public setPictureProfile(Ljava/lang/String;J)Z
    ...
    .line 611
    invoke-virtual {v9, v1, v8, p2, p3}, Lcom/android/server/tv/TvInputHal;->setPictureProfile(ILandroid/media/tv/TvStreamConfig;J)I
