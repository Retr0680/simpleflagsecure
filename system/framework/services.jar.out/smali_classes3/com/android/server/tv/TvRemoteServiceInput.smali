...
.method public openInputBridge(Landroid/os/IBinder;Ljava/lang/String;III)V
    ...
    .line 84
    :try_start_4
    iget-object p1, p0, Lcom/android/server/tv/TvRemoteServiceInput;->mProvider:Landroid/media/tv/ITvRemoteProvider;

    invoke-interface {p1, v5}, Landroid/media/tv/ITvRemoteProvider;->onInputBridgeConnected(Landroid/os/IBinder;)V
    :try_end_4
    ...
    const-string p3, "Failed remote call to onInputBridgeConnected"
    ...
    .restart local v9    # "maxPointers":I
    goto :goto_4
    ...
    const-string p3, "Token is already dead"
