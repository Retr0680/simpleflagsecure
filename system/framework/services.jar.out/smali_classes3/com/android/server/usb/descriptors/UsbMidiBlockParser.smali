...
.method public calculateMidiType(Landroid/hardware/usb/UsbDeviceConnection;II)I
    ...
    invoke-direct {v0, v9}, Lcom/android/server/usb/descriptors/ByteStream;-><init>([B)V

    .line 187
    .local v0, "stream":Lcom/android/server/usb/descriptors/ByteStream;
    invoke-virtual {v1, v0}, Lcom/android/server/usb/descriptors/UsbMidiBlockParser;->parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I

    .line 188
    iget-object v5, v1, Lcom/android/server/usb/descriptors/UsbMidiBlockParser;->mGroupTerminalBlocks:Ljava/util/ArrayList;
    ...
    .line 189
    const-string v5, "Group Terminal Blocks failed parsing: 1"
    ...
    iget v6, v6, Lcom/android/server/usb/descriptors/UsbMidiBlockParser$GroupTerminalBlock;->mMidiProtocol:I
    ...
    iget v3, v5, Lcom/android/server/usb/descriptors/UsbMidiBlockParser$GroupTerminalBlock;->mMidiProtocol:I

    return v3

    .line 196
    .end local v0    # "stream":Lcom/android/server/usb/descriptors/ByteStream;
    :cond_4
    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "second transfer failed: "
