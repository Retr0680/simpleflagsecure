...
.method public static getUsbDescriptorString(Landroid/hardware/usb/UsbDeviceConnection;B)Ljava/lang/String;
    ...
    .line 220
    .local v1, "usbStr":Ljava/lang/String;
    if-eqz p1, :cond_1

    .line 222
    or-int/lit16 v5, p1, 0x300

    :try_start_0
    sget-object v7, Lcom/android/server/usb/descriptors/UsbDescriptor;->sStringBuffer:[B
    :try_end_0
    ...
    .end local p0    # "connection":Landroid/hardware/usb/UsbDeviceConnection;
    ...
    .end local v1    # "usbStr":Ljava/lang/String;
    .local v0, "usbStr":Ljava/lang/String;
    goto :goto_0

    .line 235
    .end local v0    # "usbStr":Ljava/lang/String;
    .end local p0    # "rdo":I
    .restart local v1    # "usbStr":Ljava/lang/String;
    :catch_0
    move-exception v0
    ...
    .local p0, "connection":Landroid/hardware/usb/UsbDeviceConnection;
    :catch_1
    move-exception v0
    ...
    .end local p0    # "connection":Landroid/hardware/usb/UsbDeviceConnection;
    .restart local v2    # "connection":Landroid/hardware/usb/UsbDeviceConnection;
    :goto_1
    nop

    .line 236
    .local p0, "e":Ljava/lang/Exception;
    const-string v0, "UsbDescriptor"
