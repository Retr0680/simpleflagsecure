...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    .local v18, "numDeviceAttachedActivities":I
    .local v19, "activityNum":I
    invoke-virtual {v11, v2, v15, v6, v7}, Landroid/hardware/usb/DeviceFilter;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    .end local v18    # "numDeviceAttachedActivities":I
    .end local v19    # "activityNum":I
    :catchall_0
    move-exception v0
    ...
    .end local v6    # "numDeviceAttachedActivities":I
    .end local v7    # "activityNum":I
    .restart local v18    # "numDeviceAttachedActivities":I
    .restart local v19    # "activityNum":I
    goto :goto_2
    ...
    .line 217
    invoke-virtual {v1, v6}, Lcom/android/server/usb/UsbUserSettingsManager;->queryIntentActivities(Landroid/content/Intent;)Ljava/util/List;

    move-result-object v6

    .line 218
    .local v6, "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    invoke-interface {v6}, Ljava/util/List;->size()I

    move-result v7

    .line 219
    .local v7, "numAccessoryAttachedActivities":I
    const/4 v8, 0x0

    .local v8, "activityNum":I
    :goto_3
    if-ge v8, v7, :cond_5
    ...
    .line 223
    .local v9, "accessoryAttachedActivity":Landroid/content/pm/ResolveInfo;
    const-string v10, "accessory_attached_activities"

    const-wide v11, 0x20b00000005L

    invoke-virtual {v2, v10, v11, v12}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J

    move-result-wide v10

    .line 226
    .local v10, "accessoryAttachedActivityToken":J
    ...
    invoke-static {v2, v12, v14, v15, v13}, Lcom/android/internal/util/dump/DumpUtils;->writeComponentName(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;JLandroid/content/ComponentName;)V

    .line 230
    iget-object v12, v1, Lcom/android/server/usb/UsbUserSettingsManager;->mPackageManager:Landroid/content/pm/PackageManager;

    invoke-static {v12, v9}, Lcom/android/server/usb/UsbProfileGroupSettingsManager;->getAccessoryFilters(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Ljava/util/ArrayList;

    move-result-object v12

    .line 232
    .local v12, "accessoryFilters":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/usb/AccessoryFilter;>;"
    if-eqz v12, :cond_4
    ...
    .line 234
    .local v13, "numAccessoryFilters":I
    const/16 v16, 0x0

    move/from16 v14, v16

    .local v14, "filterNum":I
    :goto_4
    ...
    .end local v0    # "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .local v16, "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .end local v6    # "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v7    # "numAccessoryAttachedActivities":I
    .local v17, "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .local v20, "numAccessoryAttachedActivities":I
    invoke-virtual {v15, v2, v0, v6, v7}, Landroid/hardware/usb/AccessoryFilter;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    .end local v16    # "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v17    # "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v20    # "numAccessoryAttachedActivities":I
    .restart local v0    # "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v6    # "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v7    # "numAccessoryAttachedActivities":I
    :cond_3
    move-object/from16 v16, v0
    ...
    .end local v6    # "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v7    # "numAccessoryAttachedActivities":I
    .restart local v16    # "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v17    # "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .restart local v20    # "numAccessoryAttachedActivities":I
    goto :goto_5

    .line 232
    .end local v13    # "numAccessoryFilters":I
    .end local v14    # "filterNum":I
    .end local v16    # "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v17    # "accessoryAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    .end local v20    # "numAccessoryAttachedActivities":I
    .restart local v0    # "deviceAttachedActivities":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .restart local v20    # "numAccessoryAttachedActivities":I
    :goto_5
    invoke-virtual {v2, v10, v11}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V

    .line 219
    .end local v9    # "accessoryAttachedActivity":Landroid/content/pm/ResolveInfo;
    .end local v10    # "accessoryAttachedActivityToken":J
    .end local v12    # "accessoryFilters":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/usb/AccessoryFilter;>;"
