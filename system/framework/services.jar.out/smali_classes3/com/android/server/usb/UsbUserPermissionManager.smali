...
.method private synthetic lambda$scheduleWritePermissionsLocked$0()V
    ...
    .end local v4    # "devices":[Landroid/hardware/usb/DeviceFilter;
    .local v17, "devices":[Landroid/hardware/usb/DeviceFilter;
    :try_start_3
    invoke-interface {v0, v4, v3, v13}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v0, v13, v3, v4}, Lcom/android/modules/utils/TypedXmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v0, v4, v3}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    .line 507
    .end local v2    # "out":Ljava/io/FileOutputStream;
    .end local v17    # "devices":[Landroid/hardware/usb/DeviceFilter;
    .restart local v4    # "devices":[Landroid/hardware/usb/DeviceFilter;
    :catchall_2
    move-exception v0
    ...
    .end local v4    # "devices":[Landroid/hardware/usb/DeviceFilter;
    .restart local v17    # "devices":[Landroid/hardware/usb/DeviceFilter;
    goto/16 :goto_a
    ...
    invoke-interface {v0, v15, v13}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v0, v15, v3}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
...
.method private requestPermissionDialog(Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;ZLjava/lang/String;Landroid/app/PendingIntent;I)V
    ...
    invoke-virtual {v0, p4, v4}, Landroid/content/pm/PackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
...
.method dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    .line 578
    .end local v0    # "numMappings":I
    .local v6, "numMappings":I
    const/4 v0, 0x0

    .local v0, "mappingsIdx":I
    :goto_2
    if-ge v0, v6, :cond_3
    ...
    .end local v6    # "numMappings":I
    .end local v7    # "accessory":Landroid/hardware/usb/UsbAccessory;
    .local v14, "numMappings":I
    .local v16, "accessory":Landroid/hardware/usb/UsbAccessory;
    invoke-virtual {v2, v12, v6, v7, v13}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V
    ...
    .end local v14    # "numMappings":I
    .end local v16    # "accessory":Landroid/hardware/usb/UsbAccessory;
    .restart local v6    # "numMappings":I
    ...
    .restart local v14    # "numMappings":I
    .restart local v16    # "accessory":Landroid/hardware/usb/UsbAccessory;
    ...
    .local v11, "permissionsIdx":I
    invoke-virtual {v2, v0, v14, v15, v10}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JZ)V
    ...
    .end local v11    # "permissionsIdx":I
    ...
    invoke-virtual {v2, v8, v11, v12}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J

    move-result-wide v11

    .line 622
    .local v11, "accessoryPermissionToken":J
    const-string v8, "accessory"

    invoke-virtual {v7, v2, v8, v9, v10}, Landroid/hardware/usb/AccessoryFilter;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    invoke-virtual {v2, v15, v9, v10}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J
    ...
    .line 630
    .local v20, "uidPermissionToken":J
    const-string v15, "uid"
    ...
    .end local v0    # "numMappings":I
    .local v10, "numMappings":I
    invoke-virtual {v2, v15, v0, v1, v9}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V
    ...
    invoke-virtual {v2, v9, v0, v1, v15}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JZ)V

    .line 633
    move-wide/from16 v0, v20

    .end local v20    # "uidPermissionToken":J
    .local v0, "uidPermissionToken":J
    invoke-virtual {v2, v0, v1}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V

    .line 627
    .end local v0    # "uidPermissionToken":J
    ...
    .end local v0    # "numMappings":I
    .end local v14    # "permissionsIdx":I
    .restart local v10    # "numMappings":I
    ...
    .end local v11    # "accessoryPermissionToken":J
    .end local v13    # "numPermissions":I
    add-int/lit8 v6, v6, 0x1
...
.method public requestPermission(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;Landroid/app/PendingIntent;II)V
    ...
    invoke-virtual {p3, v0, v2, v1}, Landroid/app/PendingIntent;->send(Landroid/content/Context;ILandroid/content/Intent;)V
    :try_end_0
    ...
    .end local p5    # "uid":I
    .local v3, "accessory":Landroid/hardware/usb/UsbAccessory;
...
.method public requestPermission(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;Landroid/app/PendingIntent;II)V
    ...
    invoke-virtual {p3, v0, v4, v1}, Landroid/app/PendingIntent;->send(Landroid/content/Context;ILandroid/content/Intent;)V
    :try_end_0
    .catch Landroid/app/PendingIntent$CanceledException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 748
    invoke-virtual {v0, p1, p2}, Lcom/android/server/usb/UsbUserSettingsManager;->canBeDefault(Landroid/hardware/usb/UsbDevice;Ljava/lang/String;)Z
