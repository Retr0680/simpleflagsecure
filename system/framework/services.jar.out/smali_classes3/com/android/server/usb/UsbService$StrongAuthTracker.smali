...
.method public declared-synchronized onStrongAuthRequiredChanged(I)V
    ...
    :goto_2
    new-instance v11, Landroid/hardware/usb/IUsbOperationInternal$Default;

    invoke-direct {v11}, Landroid/hardware/usb/IUsbOperationInternal$Default;-><init>()V
    ...
    invoke-virtual/range {v7 .. v13}, Lcom/android/server/usb/UsbService;->enableUsbDataInternal(Ljava/lang/String;ZILandroid/hardware/usb/IUsbOperationInternal;IZ)Z
    :try_end_1
