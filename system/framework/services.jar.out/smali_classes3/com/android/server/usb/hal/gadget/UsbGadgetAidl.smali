...
.method public setCurrentUsbFunctions(IJZIJ)V
    ...
    .line 163
    .local v0, "e":Landroid/os/RemoteException;
    iget-object v2, v1, Lcom/android/server/usb/hal/gadget/UsbGadgetAidl;->mPw:Lcom/android/internal/util/IndentingPrintWriter;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "RemoteException while calling setCurrentUsbFunctions: mRequest="
    ...
    const-string v5, ", mChargingFunctions="
    ...
    invoke-static {v2, v3, v0}, Lcom/android/server/usb/UsbDeviceManager;->logAndPrintException(Lcom/android/internal/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Exception;)V
