...
.method public run()V
    ...
    .line 604
    .end local v10    # "convertedArray":[B
    .restart local v9    # "convertedArray":[B
    :cond_5
    nop
    ...
    .end local v9    # "convertedArray":[B
    .restart local v10    # "convertedArray":[B
    move-object v14, v10

    .line 609
    .end local v10    # "convertedArray":[B
    .local v14, "convertedArray":[B
    :goto_4
    const-string v9, "Output after conversion "

    array-length v10, v14

    invoke-static {v9, v14, v11, v10}, Lcom/android/server/usb/UsbDirectMidiDevice;->-$$Nest$smlogByteArray(Ljava/lang/String;[BII)V
    ...
    .line 620
    .local v9, "transferResult":I
    const/4 v10, 0x0

    .line 621
    .local v10, "retryCount":I
    iget-object v11, v1, Lcom/android/server/usb/UsbDirectMidiDevice$3;->val$endpointFinal:Landroid/hardware/usb/UsbEndpoint;
    ...
    .line 637
    const-string v11, "output thread interrupted after send"
    ...
    .line 645
    const-string v11, "Skipping packet because timeout"
    ...
    .line 618
    .end local v9    # "transferResult":I
    .end local v10    # "retryCount":I
    .end local v16    # "curPacketSize":I
    :cond_8
    :goto_7
    iget-object v9, v1, Lcom/android/server/usb/UsbDirectMidiDevice$3;->val$endpointFinal:Landroid/hardware/usb/UsbEndpoint;
    ...
    .end local v6    # "wasSuccessful":Z
    .end local v7    # "now":J
    .end local v14    # "convertedArray":[B
    .end local v15    # "curPacketStart":I
    :cond_9
    goto/16 :goto_0
