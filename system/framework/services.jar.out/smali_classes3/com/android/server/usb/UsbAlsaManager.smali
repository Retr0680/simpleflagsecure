...
.method private addMidiDevice(Ljava/lang/String;Landroid/hardware/usb/UsbDevice;Lcom/android/server/usb/descriptors/UsbDescriptorParser;Lcom/android/internal/alsa/AlsaCardsParser$AlsaCardRecord;)V
    ...
    .line 411
    .local v3, "midiDevice":Lcom/android/server/usb/UsbAlsaMidiDevice;
    if-eqz v3, :cond_4

    .line 412
    iget-object v5, p0, Lcom/android/server/usb/UsbAlsaManager;->mMidiDevices:Ljava/util/HashMap;

    invoke-virtual {v5, p1, v3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 415
    .end local v2    # "manufacturer":Ljava/lang/String;
    .end local v3    # "midiDevice":Lcom/android/server/usb/UsbAlsaMidiDevice;
    .end local v4    # "properties":Landroid/os/Bundle;
    .end local v7    # "numLegacyMidiInputs":I
    .end local v8    # "numLegacyMidiOutputs":I
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    .local v6, "dump":Lcom/android/internal/util/dump/DualDumpOutputStream;
    ...
    .line 589
    .end local v6    # "dump":Lcom/android/internal/util/dump/DualDumpOutputStream;
    .restart local p1    # "dump":Lcom/android/internal/util/dump/DualDumpOutputStream;
    :cond_1
    move-object v6, p1

    .end local p1    # "dump":Lcom/android/internal/util/dump/DualDumpOutputStream;
    .restart local v6    # "dump":Lcom/android/internal/util/dump/DualDumpOutputStream;
    invoke-virtual {v6, v0, v1}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V
...
.method setPeripheralMidiState(ZII)V
    ...
    iput-object p2, p0, Lcom/android/server/usb/UsbAlsaManager;->mPeripheralMidiDevice:Lcom/android/server/usb/UsbAlsaMidiDevice;
    ...
    .restart local p2    # "card":I
    .restart local p3    # "device":I
    :cond_2
    move v3, p2
    ...
    .end local p2    # "card":I
    .end local p3    # "device":I
    .restart local v3    # "card":I
    .restart local v4    # "device":I
    if-nez p1, :cond_1

    iget-object p2, p0, Lcom/android/server/usb/UsbAlsaManager;->mPeripheralMidiDevice:Lcom/android/server/usb/UsbAlsaMidiDevice;
...
.method usbDeviceAdded(Ljava/lang/String;Landroid/hardware/usb/UsbDevice;Lcom/android/server/usb/descriptors/UsbDescriptorParser;)V
    ...
    .line 312
    .local v10, "cardRec":Lcom/android/internal/alsa/AlsaCardsParser$AlsaCardRecord;
    if-nez v10, :cond_1
    ...
    const-string v2, "usbDeviceAdded(): cannot find sound card for "
    ...
    .line 319
    :cond_1
    invoke-virtual {v10}, Lcom/android/internal/alsa/AlsaCardsParser$AlsaCardRecord;->getCardNum()I

    move-result v0

    const/4 v1, 0x1

    invoke-direct {p0, v0, v1}, Lcom/android/server/usb/UsbAlsaManager;->waitForAlsaDevice(IZ)Z
    ...
    invoke-static {v0, v2, v3}, Lcom/android/server/usb/UsbAlsaManager;->isDeviceDenylisted(III)Z
    ...
    invoke-static {v0, v2, v1}, Lcom/android/server/usb/UsbAlsaManager;->isDeviceDenylisted(III)Z
    ...
    .line 333
    .local v7, "isInputHeadset":Z
    invoke-virtual {p3}, Lcom/android/server/usb/descriptors/UsbDescriptorParser;->isOutputHeadset()Z

    move-result v8

    .line 334
    .local v8, "isOutputHeadset":Z
    invoke-virtual {p3}, Lcom/android/server/usb/descriptors/UsbDescriptorParser;->isDock()Z
    ...
    invoke-direct/range {v0 .. v9}, Lcom/android/server/usb/UsbAlsaDevice;-><init>(Landroid/media/IAudioService;IILjava/lang/String;ZZZZZ)V
    ...
    invoke-virtual {v10}, Lcom/android/internal/alsa/AlsaCardsParser$AlsaCardRecord;->getCardDescription()Ljava/lang/String;

    move-result-object v2

    .line 345
    invoke-virtual {v0, v1, v2}, Lcom/android/server/usb/UsbAlsaDevice;->setDeviceNameAndDescription(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/usb/UsbAlsaManager;->deselectCurrentDevice(I)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/usb/UsbAlsaManager;->deselectAlsaDevice(Lcom/android/server/usb/UsbAlsaDevice;)V

    .line 356
    :cond_7
    :goto_2
    invoke-direct {p0, v0}, Lcom/android/server/usb/UsbAlsaManager;->addAlsaDevice(Lcom/android/server/usb/UsbAlsaDevice;)V
    ...
    .end local v7    # "isInputHeadset":Z
    .end local v8    # "isOutputHeadset":Z
    .end local v9    # "isDock":Z
    :cond_8
    move-object v1, p3

    invoke-direct {p0, p1, p2, p3, v10}, Lcom/android/server/usb/UsbAlsaManager;->addMidiDevice(Ljava/lang/String;Landroid/hardware/usb/UsbDevice;Lcom/android/server/usb/descriptors/UsbDescriptorParser;Lcom/android/internal/alsa/AlsaCardsParser$AlsaCardRecord;)V
