...
.method public constructor <init>(Landroid/content/Context;Landroid/os/UserHandle;Lcom/android/server/usb/UsbSettingsManager;Lcom/android/server/usb/UsbHandlerManager;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$MyPackageMonitor;-><init>(Lcom/android/server/usb/UsbProfileGroupSettingsManager;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
...
.method private getDefaultActivityLocked(Ljava/util/ArrayList;Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Landroid/content/pm/ActivityInfo;
    ...
    invoke-direct {v3, v4, v5, v0}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;-><init>(Ljava/lang/String;Landroid/os/UserHandle;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
...
.method private readPreference(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {v6, v0, v1, v4}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;-><init>(Ljava/lang/String;Landroid/os/UserHandle;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
...
.method private readPreferenceDeniedList(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {v11, v9, v12, v3}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;-><init>(Ljava/lang/String;Landroid/os/UserHandle;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
...
.method private resolveActivity(Landroid/content/Intent;Landroid/hardware/usb/UsbDevice;Z)V
    ...
    .line 929
    invoke-direct {p0, v4, v0}, Lcom/android/server/usb/UsbProfileGroupSettingsManager;->getDefaultActivityLocked(Ljava/util/ArrayList;Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;)Landroid/content/pm/ActivityInfo;
    ...
    .end local p2    # "device":Landroid/hardware/usb/UsbDevice;
    .local v3, "intent":Landroid/content/Intent;
    .local v6, "device":Landroid/hardware/usb/UsbDevice;
    ...
    .end local v6    # "device":Landroid/hardware/usb/UsbDevice;
    .restart local p1    # "intent":Landroid/content/Intent;
    .restart local p2    # "device":Landroid/hardware/usb/UsbDevice;
    :catchall_0
    move-exception v0
    ...
    .restart local v6    # "device":Landroid/hardware/usb/UsbDevice;
    :goto_0
    :try_start_1
    monitor-exit v1
    :try_end_1
...
.method private resolveActivity(Landroid/content/Intent;Ljava/util/ArrayList;Landroid/content/pm/ActivityInfo;Landroid/hardware/usb/UsbDevice;Landroid/hardware/usb/UsbAccessory;)V
    ...
    invoke-direct {v6, v4, v5, v7}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;-><init>(Ljava/lang/String;Landroid/os/UserHandle;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
...
.method public accessoryAttached(Landroid/hardware/usb/UsbAccessory;)V
    ...
    .line 1066
    :try_start_0
    invoke-direct {p0, p1, v3}, Lcom/android/server/usb/UsbProfileGroupSettingsManager;->getAccessoryMatchesLocked(Landroid/hardware/usb/UsbAccessory;Landroid/content/Intent;)Ljava/util/ArrayList;
    ...
    .end local p1    # "accessory":Landroid/hardware/usb/UsbAccessory;
    .restart local v7    # "accessory":Landroid/hardware/usb/UsbAccessory;
    :goto_0
    :try_start_1
    monitor-exit v1
    :try_end_1
...
.method addAccessoryPackagesToDenied(Landroid/hardware/usb/UsbAccessory;[Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v7, v6, p3, v8}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;-><init>(Ljava/lang/String;Landroid/os/UserHandle;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
...
.method public dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    invoke-virtual {p1, v0, v5, v6, v4}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V
    ...
    .line 1602
    .local v4, "filter":Landroid/hardware/usb/DeviceFilter;
    const-string v9, "device_preferences"

    const-wide v10, 0x20b00000002L

    invoke-virtual {p1, v9, v10, v11}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J

    move-result-wide v9

    .line 1605
    .local v9, "devicePrefToken":J
    const-string v11, "filter"

    invoke-virtual {v4, p1, v11, v7, v8}, Landroid/hardware/usb/DeviceFilter;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    invoke-virtual {v7, p1, v8, v5, v6}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V

    .line 1610
    invoke-virtual {p1, v9, v10}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V

    .line 1611
    .end local v4    # "filter":Landroid/hardware/usb/DeviceFilter;
    .end local v9    # "devicePrefToken":J
    goto :goto_0
    ...
    .line 1613
    .local v4, "filter":Landroid/hardware/usb/AccessoryFilter;
    const-string v9, "accessory_preferences"
    ...
    .line 1616
    .local v9, "accessoryPrefToken":J
    const-string v11, "filter"

    invoke-virtual {v4, p1, v11, v7, v8}, Landroid/hardware/usb/AccessoryFilter;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V

    .line 1618
    iget-object v11, p0, Lcom/android/server/usb/UsbProfileGroupSettingsManager;->mAccessoryPreferenceMap:Ljava/util/HashMap;

    invoke-virtual {v11, v4}, Ljava/util/HashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;

    const-string v12, "user_package"

    invoke-virtual {v11, p1, v12, v5, v6}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;->dump(Lcom/android/internal/util/dump/DualDumpOutputStream;Ljava/lang/String;J)V
    ...
    .line 1622
    .end local v4    # "filter":Landroid/hardware/usb/AccessoryFilter;
    .end local v9    # "accessoryPrefToken":J
    goto :goto_1
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/utils/EventLogger;->dump(Lcom/android/server/utils/EventLogger$DumpSink;)V
...
.method setAccessoryPackage(Landroid/hardware/usb/UsbAccessory;Ljava/lang/String;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v3, p2, p3, v4}, Lcom/android/server/usb/UsbProfileGroupSettingsManager$UserPackage;-><init>(Ljava/lang/String;Landroid/os/UserHandle;Lcom/android/server/usb/UsbProfileGroupSettingsManager-IA;)V
