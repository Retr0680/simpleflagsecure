...
.method private logUsbDevice(Lcom/android/server/usb/descriptors/UsbDescriptorParser;)V
    ...
    .line 345
    :cond_1
    invoke-virtual {v0}, Lcom/android/server/usb/descriptors/UsbDescriptorParser;->hasAudioInterface()Z
    ...
    .line 347
    .local v9, "hasHid":Z
    invoke-virtual {v0}, Lcom/android/server/usb/descriptors/UsbDescriptorParser;->hasStorageInterface()Z
...
.method private usbDeviceAdded(Ljava/lang/String;II[B)Z
    ...
    .line 422
    invoke-direct {v1}, Lcom/android/server/usb/UsbHostManager;->getUsbDeviceConnectionHandler()Landroid/content/ComponentName;
    ...
    .line 424
    invoke-direct {v1}, Lcom/android/server/usb/UsbHostManager;->getCurrentUserSettings()Lcom/android/server/usb/UsbProfileGroupSettingsManager;
    ...
    .line 436
    invoke-direct {v1}, Lcom/android/server/usb/UsbHostManager;->generateNewUsbDeviceIdentifier()Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v9, v4}, Lcom/android/server/usb/UsbHostManager;->addConnectionRecord(Ljava/lang/String;I[B)V
    ...
    invoke-static/range {v17 .. v25}, Lcom/android/internal/util/FrameworkStatsLog;->write(IIIZZZIJ)V
