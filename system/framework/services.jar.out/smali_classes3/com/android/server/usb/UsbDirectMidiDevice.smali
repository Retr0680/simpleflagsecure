...
.method private constructor <init>(Landroid/hardware/usb/UsbDevice;Lcom/android/server/usb/descriptors/UsbDescriptorParser;ZLjava/lang/String;)V
    ...
    invoke-direct {v6, v1}, Lcom/android/server/usb/UsbDirectMidiDevice$InputReceiverProxy;-><init>(Lcom/android/server/usb/UsbDirectMidiDevice-IA;)V
...
.method private openLocked()Z
    ...
    .line 331
    .local v2, "inputEndpoints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/usb/UsbEndpoint;>;"
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .line 332
    .local v3, "outputEndpoints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/usb/UsbEndpoint;>;"
    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    .line 333
    .local v4, "inputEndpointCableCounts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    .line 334
    .local v5, "outputEndpointCableCounts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    .line 336
    .local v6, "midiEventMultiSchedulers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/midi/MidiEventMultiScheduler;>;"
    iget-object v7, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbInterfaces:Ljava/util/ArrayList;
    ...
    .line 337
    .local v7, "interfaceDescriptor":Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;
    const/4 v9, 0x0

    .local v9, "endpointIndex":I
    :goto_1
    invoke-virtual {v7}, Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;->getNumEndpoints()B
    ...
    .line 340
    invoke-virtual {v7, v9}, Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;->getEndpointDescriptor(I)Lcom/android/server/usb/descriptors/UsbEndpointDescriptor;
    ...
    .line 344
    invoke-direct {p0, v10}, Lcom/android/server/usb/UsbDirectMidiDevice;->getNumJacks(Lcom/android/server/usb/descriptors/UsbEndpointDescriptor;)I
    ...
    invoke-virtual {v8, v9}, Landroid/hardware/usb/UsbManager;->openDevice(Landroid/hardware/usb/UsbDevice;)Landroid/hardware/usb/UsbDeviceConnection;

    move-result-object v9

    .line 355
    .local v9, "connection":Landroid/hardware/usb/UsbDeviceConnection;
    ...
    invoke-direct {p0, v10, v9}, Lcom/android/server/usb/UsbDirectMidiDevice;->updateUsbInterface(Landroid/hardware/usb/UsbInterface;Landroid/hardware/usb/UsbDeviceConnection;)Z
    ...
    .line 359
    :cond_3
    iget-object v11, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbDeviceConnections:Ljava/util/ArrayList;

    invoke-virtual {v11, v9}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 360
    iget-object v11, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mInputUsbEndpoints:Ljava/util/ArrayList;

    invoke-virtual {v11, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 361
    iget-object v11, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mOutputUsbEndpoints:Ljava/util/ArrayList;

    invoke-virtual {v11, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 362
    iget-object v11, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mInputUsbEndpointCableCounts:Ljava/util/ArrayList;

    invoke-virtual {v11, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 363
    iget-object v11, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mOutputUsbEndpointCableCounts:Ljava/util/ArrayList;

    invoke-virtual {v11, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 364
    iget-object v11, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mMidiEventMultiSchedulers:Ljava/util/ArrayList;

    invoke-virtual {v11, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 329
    .end local v2    # "inputEndpoints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/usb/UsbEndpoint;>;"
    .end local v3    # "outputEndpoints":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/hardware/usb/UsbEndpoint;>;"
    .end local v4    # "inputEndpointCableCounts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    .end local v5    # "outputEndpointCableCounts":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    .end local v6    # "midiEventMultiSchedulers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/midi/MidiEventMultiScheduler;>;"
    .end local v7    # "interfaceDescriptor":Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;
    .end local v9    # "connection":Landroid/hardware/usb/UsbDeviceConnection;
    ...
    .local v2, "connectionIndex":I
    .local v9, "outputIndex":I
    :goto_4
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mMidiEventMultiSchedulers:Ljava/util/ArrayList;
    ...
    .line 379
    .local v4, "multiScheduler":Lcom/android/internal/midi/MidiEventMultiScheduler;
    const/4 v5, 0x0

    .local v5, "cableNumber":I
    :goto_6
    if-ge v5, v3, :cond_6
    ...
    iget-object v7, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mMidiInputPortReceivers:[Lcom/android/server/usb/UsbDirectMidiDevice$InputReceiverProxy;
    ...
    invoke-virtual {v7, v10}, Lcom/android/server/usb/UsbDirectMidiDevice$InputReceiverProxy;->setReceiver(Landroid/media/midi/MidiReceiver;)V
    ...
    .line 374
    .end local v3    # "cableCount":I
    .end local v4    # "multiScheduler":Lcom/android/internal/midi/MidiEventMultiScheduler;
    .end local v5    # "cableNumber":I
    add-int/lit8 v0, v0, 0x1
    ...
    .line 387
    .end local v2    # "connectionIndex":I
    ...
    .line 390
    .local v6, "outputReceivers":[Landroid/media/midi/MidiReceiver;
    const/4 v0, 0x0
    ...
    .local v11, "portStartNumber":I
    .local v12, "endpointIndex":I
    :goto_8
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mInputUsbEndpoints:Ljava/util/ArrayList;
    ...
    .line 405
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbDeviceConnections:Ljava/util/ArrayList;
    ...
    .line 407
    .local v4, "connectionFinal":Landroid/hardware/usb/UsbDeviceConnection;
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mInputUsbEndpoints:Ljava/util/ArrayList;
    ...
    .line 409
    .local v5, "endpointFinal":Landroid/hardware/usb/UsbEndpoint;
    move v7, v11

    .line 410
    .local v7, "portStartFinal":I
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mInputUsbEndpointCableCounts:Ljava/util/ArrayList;
    ...
    const-string v13, "UsbDirectMidiDevice input thread "
    ...
    .line 517
    .end local v6    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    .local v0, "portStartFinal":I
    .local v2, "newThread":Ljava/lang/Thread;
    .local v7, "outputReceivers":[Landroid/media/midi/MidiReceiver;
    invoke-virtual {v2}, Ljava/lang/Thread;->start()V

    .line 518
    iget-object v6, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mThreads:Ljava/util/ArrayList;
    ...
    .line 395
    .end local v0    # "portStartFinal":I
    .end local v2    # "newThread":Ljava/lang/Thread;
    .end local v3    # "cableCountFinal":I
    .end local v4    # "connectionFinal":Landroid/hardware/usb/UsbDeviceConnection;
    .end local v5    # "endpointFinal":Landroid/hardware/usb/UsbEndpoint;
    ...
    .line 394
    .end local v7    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    .restart local v6    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    :cond_9
    move-object v7, v6

    .line 392
    .end local v6    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    .end local v12    # "endpointIndex":I
    .restart local v7    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    ...
    .line 391
    .end local v7    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    .end local v11    # "portStartNumber":I
    .local v0, "portStartNumber":I
    .restart local v6    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    :cond_a
    move-object v7, v6
    ...
    .line 524
    .end local v6    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    .end local v10    # "connectionIndex":I
    .restart local v7    # "outputReceivers":[Landroid/media/midi/MidiReceiver;
    const/4 v0, 0x0
    ...
    .restart local v10    # "connectionIndex":I
    :goto_9
    iget-object v2, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mOutputUsbEndpoints:Ljava/util/ArrayList;
    ...
    .line 528
    .end local v0    # "portStartNumber":I
    .restart local v11    # "portStartNumber":I
    .restart local v12    # "endpointIndex":I
    :goto_a
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mOutputUsbEndpoints:Ljava/util/ArrayList;
    ...
    .line 541
    .local v6, "connectionFinal":Landroid/hardware/usb/UsbDeviceConnection;
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mOutputUsbEndpoints:Ljava/util/ArrayList;
    ...
    .line 543
    .restart local v5    # "endpointFinal":Landroid/hardware/usb/UsbEndpoint;
    move v13, v11

    .line 544
    .local v13, "portStartFinal":I
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mOutputUsbEndpointCableCounts:Ljava/util/ArrayList;
    ...
    .line 546
    .restart local v3    # "cableCountFinal":I
    iget-object v0, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mMidiEventMultiSchedulers:Ljava/util/ArrayList;
    ...
    .line 549
    .local v4, "multiSchedulerFinal":Lcom/android/internal/midi/MidiEventMultiScheduler;
    ...
    const-string v14, "UsbDirectMidiDevice output write thread "
    ...
    .end local v3    # "cableCountFinal":I
    .end local v4    # "multiSchedulerFinal":Lcom/android/internal/midi/MidiEventMultiScheduler;
    .end local v5    # "endpointFinal":Landroid/hardware/usb/UsbEndpoint;
    .end local v6    # "connectionFinal":Landroid/hardware/usb/UsbDeviceConnection;
    .end local v13    # "portStartFinal":I
    add-int/lit8 v12, v12, 0x1
    ...
    iput-boolean v2, p0, Lcom/android/server/usb/UsbDirectMidiDevice;->mIsOpen:Z
...
.method private register(Landroid/content/Context;)Z
    ...
    .line 672
    .local v3, "midiManager":Landroid/media/midi/MidiManager;
    const/4 v2, 0x0

    if-nez v3, :cond_0

    .line 673
    const-string v4, "UsbDirectMidiDevice"

    const-string v5, "No MidiManager in UsbDirectMidiDevice.register()"
    ...
    .line 678
    invoke-direct {v0}, Lcom/android/server/usb/UsbDirectMidiDevice;->calculateDefaultMidiProtocol()I

    move-result v4

    iput v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mDefaultMidiProtocol:I
    ...
    .line 685
    .local v12, "manufacturer":Ljava/lang/String;
    iget-object v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbDevice:Landroid/hardware/usb/UsbDevice;
    ...
    .line 686
    .local v13, "product":Ljava/lang/String;
    iget-object v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbDevice:Landroid/hardware/usb/UsbDevice;

    invoke-virtual {v4}, Landroid/hardware/usb/UsbDevice;->getVersion()Ljava/lang/String;
    ...
    iget-object v6, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUniqueUsbDeviceIdentifier:Ljava/lang/String;
    ...
    .line 696
    iget-boolean v5, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mIsUniversalMidiDevice:Z
    ...
    :goto_4
    iput-object v15, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mName:Ljava/lang/String;

    .line 702
    const-string v4, "name"

    invoke-virtual {v8, v4, v15}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v4, v13}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 705
    const-string v4, "version"

    invoke-virtual {v8, v4, v14}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    .line 706
    iget-object v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbDevice:Landroid/hardware/usb/UsbDevice;

    .line 707
    invoke-virtual {v4}, Landroid/hardware/usb/UsbDevice;->getSerialNumber()Ljava/lang/String;
    ...
    iget-object v5, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mUsbDevice:Landroid/hardware/usb/UsbDevice;
    ...
    iput-boolean v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mServerAvailable:Z
    ...
    iget v10, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mDefaultMidiProtocol:I

    iget-object v11, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mCallback:Landroid/media/midi/MidiDeviceServer$Callback;
    ...
    iput-object v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mServer:Landroid/media/midi/MidiDeviceServer;

    .line 713
    iget-object v4, v0, Lcom/android/server/usb/UsbDirectMidiDevice;->mServer:Landroid/media/midi/MidiDeviceServer;
