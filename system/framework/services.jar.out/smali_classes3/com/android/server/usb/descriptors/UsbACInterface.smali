...
.method private static allocAudioControlDescriptor(Lcom/android/server/usb/descriptors/UsbDescriptorParser;Lcom/android/server/usb/descriptors/ByteStream;IBBI)Lcom/android/server/usb/descriptors/UsbDescriptor;
    ...
    invoke-virtual {p0, v7}, Lcom/android/server/usb/descriptors/UsbDescriptorParser;->setACInterfaceSpec(I)V

    .line 111
    if-ne v7, v0, :cond_3

    .line 112
    new-instance v2, Lcom/android/server/usb/descriptors/Usb20ACHeader;
    ...
    .end local v4    # "type":B
    .end local v5    # "subtype":B
    .end local v6    # "subClass":I
    ...
    .restart local v5    # "subtype":B
    .restart local v6    # "subClass":I
    new-instance v2, Lcom/android/server/usb/descriptors/Usb10ACHeader;
...
.method public static allocDescriptor(Lcom/android/server/usb/descriptors/UsbDescriptorParser;Lcom/android/server/usb/descriptors/ByteStream;IB)Lcom/android/server/usb/descriptors/UsbDescriptor;
    ...
    invoke-virtual {v6}, Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;->getUsbSubclass()I
    ...
    .end local p0    # "parser":Lcom/android/server/usb/descriptors/UsbDescriptorParser;
    .end local p1    # "stream":Lcom/android/server/usb/descriptors/ByteStream;
    .end local p2    # "length":I
    .end local p3    # "type":B
    ...
    .end local v1    # "stream":Lcom/android/server/usb/descriptors/ByteStream;
    .end local v2    # "length":I
    .end local v3    # "type":B
    .restart local p0    # "parser":Lcom/android/server/usb/descriptors/UsbDescriptorParser;
    .restart local p1    # "stream":Lcom/android/server/usb/descriptors/ByteStream;
    .restart local p2    # "length":I
    .restart local p3    # "type":B
    :pswitch_2
    move-object v0, p0
    ...
    .end local p2    # "length":I
    .end local p3    # "type":B
    .restart local v0    # "parser":Lcom/android/server/usb/descriptors/UsbDescriptorParser;
    .restart local v1    # "stream":Lcom/android/server/usb/descriptors/ByteStream;
