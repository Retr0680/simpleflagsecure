...
.method private constructor <init>(IIII)V
    ...
    invoke-direct {v3, p0, v0}, Lcom/android/server/usb/UsbAlsaMidiDevice$InputReceiverProxy;-><init>(Lcom/android/server/usb/UsbAlsaMidiDevice;Lcom/android/server/usb/UsbAlsaMidiDevice-IA;)V
...
.method private openLocked()Z
    ...
    .line 276
    .local v10, "eventSchedulerF":Lcom/android/internal/midi/MidiEventScheduler;
    iget-object v6, p0, Lcom/android/server/usb/UsbAlsaMidiDevice;->mOutputStreams:[Ljava/io/FileOutputStream;

    aget-object v11, v6, v5

    .line 277
    .local v11, "outputStreamF":Ljava/io/FileOutputStream;
    move v12, v5

    .line 279
    .local v12, "portF":I
    new-instance v7, Lcom/android/server/usb/UsbAlsaMidiDevice$3;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "UsbAlsaMidiDevice output thread "
    ...
    invoke-direct/range {v7 .. v12}, Lcom/android/server/usb/UsbAlsaMidiDevice$3;-><init>(Lcom/android/server/usb/UsbAlsaMidiDevice;Ljava/lang/String;Lcom/android/internal/midi/MidiEventScheduler;Ljava/io/FileOutputStream;I)V

    .line 302
    invoke-virtual {v7}, Ljava/lang/Thread;->start()V

    .line 274
    .end local v10    # "eventSchedulerF":Lcom/android/internal/midi/MidiEventScheduler;
    .end local v11    # "outputStreamF":Ljava/io/FileOutputStream;
    .end local v12    # "portF":I
    ...
    iput-boolean v5, v8, Lcom/android/server/usb/UsbAlsaMidiDevice;->mIsOpen:Z
...
.method private register(Landroid/content/Context;Landroid/os/Bundle;)Z
    ...
    .line 311
    .local v1, "midiManager":Landroid/media/midi/MidiManager;
    const/4 v0, 0x0
    ...
    const-string v3, "No MidiManager in UsbAlsaMidiDevice.register()"
    ...
    iput-boolean v10, p0, Lcom/android/server/usb/UsbAlsaMidiDevice;->mServerAvailable:Z
    ...
    .end local p2    # "properties":Landroid/os/Bundle;
    .local v6, "properties":Landroid/os/Bundle;
    ...
    .line 320
    iget-object p2, p0, Lcom/android/server/usb/UsbAlsaMidiDevice;->mServer:Landroid/media/midi/MidiDeviceServer;
