...
.method private handleOnActivityLaunchFinished(JLandroid/content/ComponentName;JI)V
    ...
    .end local v8    # "launchMode":I
    .restart local p1    # "id":J
    .restart local p3    # "name":Landroid/content/ComponentName;
    .restart local p4    # "timestampNs":J
    .restart local p6    # "launchMode":I
    :cond_0
    nop
...
.method private handleOnActivityLaunched(JLandroid/content/ComponentName;II)V
    ...
    .end local p1    # "id":J
    .end local p3    # "name":Landroid/content/ComponentName;
    .end local p4    # "temperature":I
    .end local p5    # "userId":I
    .local v3, "id":J
    .local v5, "name":Landroid/content/ComponentName;
    .local v6, "temperature":I
    .local v7, "userId":I
    ...
    .end local v3    # "id":J
    .end local v5    # "name":Landroid/content/ComponentName;
    .end local v6    # "temperature":I
    .end local v7    # "userId":I
    .restart local p1    # "id":J
    .restart local p3    # "name":Landroid/content/ComponentName;
    .restart local p4    # "temperature":I
