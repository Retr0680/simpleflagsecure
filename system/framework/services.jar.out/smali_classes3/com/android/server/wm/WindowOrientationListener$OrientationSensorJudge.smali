...
.method public onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    .line 1156
    invoke-direct {p0, v4}, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->rotationToLogEnum(I)I
    ...
    invoke-static {v3, v0, v1, v2, v5}, Lcom/android/internal/util/FrameworkStatsLog;->write(IJII)V

    .line 1159
    iget-object v0, p0, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->this$0:Lcom/android/server/wm/WindowOrientationListener;

    invoke-virtual {v0}, Lcom/android/server/wm/WindowOrientationListener;->isRotationResolverEnabled()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowOrientationListener;->isKeyguardShowingAndNotOccluded()Z
    ...
    const-string v1, "Reusing the last rotation resolution: "
    ...
    invoke-static {v0}, Lcom/android/server/wm/WindowOrientationListener;->-$$Nest$fgetmDefaultRotation(Lcom/android/server/wm/WindowOrientationListener;)I
    ...
    iget-object v0, v0, Lcom/android/server/wm/WindowOrientationListener;->mRotationResolverService:Landroid/rotationresolver/RotationResolverInternal;
    ...
    const-class v1, Landroid/rotationresolver/RotationResolverInternal;

    invoke-static {v1}, Lcom/android/server/LocalServices;->getService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroid/rotationresolver/RotationResolverInternal;

    iput-object v1, v0, Lcom/android/server/wm/WindowOrientationListener;->mRotationResolverService:Landroid/rotationresolver/RotationResolverInternal;
    ...
    .line 1177
    invoke-direct {p0, v4}, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->finalizeRotation(I)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    new-instance v0, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge$$ExternalSyntheticLambda0;

    invoke-direct {v0, v8}, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge$$ExternalSyntheticLambda0;-><init>(Landroid/os/CancellationSignal;)V

    iput-object v0, p0, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->mCancelRotationResolverRequest:Ljava/lang/Runnable;
    ...
    iget-wide v5, p0, Lcom/android/server/wm/WindowOrientationListener$OrientationSensorJudge;->mRotationResolverTimeoutMillis:J
    ...
    iget-object v1, v0, Lcom/android/server/wm/WindowOrientationListener;->mRotationResolverService:Landroid/rotationresolver/RotationResolverInternal;
