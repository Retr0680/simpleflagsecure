...
.method private createTaskDisplayArea(Lcom/android/server/wm/RootDisplayArea;Ljava/lang/String;I)Lcom/android/server/wm/TaskDisplayArea;
    ...
    .end local p3    # "taskDisplayAreaFeatureId":I
    .local v3, "name":Ljava/lang/String;
    .local v4, "taskDisplayAreaFeatureId":I
    ...
    new-instance p2, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda0;

    invoke-direct {p2, p1}, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/RootDisplayArea;)V
    ...
    .line 338
    .local p2, "topTaskContainer":Lcom/android/server/wm/DisplayArea;
    if-eqz p2, :cond_0
    ...
    .line 344
    .local p3, "parent":Lcom/android/server/wm/WindowContainer;
    iget-object v1, p3, Lcom/android/server/wm/WindowContainer;->mChildren:Ljava/util/ArrayList;
    ...
    .line 345
    .local v1, "index":I
    invoke-virtual {p3, v0, v1}, Lcom/android/server/wm/WindowContainer;->addChild(Lcom/android/server/wm/WindowContainer;I)V
    ...
    .end local p3    # "parent":Lcom/android/server/wm/WindowContainer;
    :cond_0
    ...
    const-string v2, "Root must either contain TDA or DAG root="
...
.method private createTaskDisplayArea(Lcom/android/server/wm/TaskDisplayArea;Ljava/lang/String;I)Lcom/android/server/wm/TaskDisplayArea;
    ...
    invoke-virtual {p1, v0, p2}, Lcom/android/server/wm/TaskDisplayArea;->addChild(Lcom/android/server/wm/WindowContainer;I)V
...
.method private synthetic lambda$registerOrganizer$1(ILjava/util/List;Landroid/window/IDisplayAreaOrganizer;Lcom/android/server/wm/DisplayContent;)V
    ...
    const-wide v4, -0x2a8def86e341c7bfL    # -4.0459528513661465E103

    const/4 v6, 0x1

    invoke-static {v2, v4, v5, v6, v3}, Lcom/android/internal/protolog/ProtoLogImpl_1767190652;->w(Lcom/android/internal/protolog/common/IProtoLogGroup;JI[Ljava/lang/Object;)V
...
.method public createTaskDisplayArea(Landroid/window/IDisplayAreaOrganizer;IILjava/lang/String;)Landroid/window/DisplayAreaAppearedInfo;
    ...
    .end local v6    # "uid":J
    .local v15, "uid":J
    const-wide v6, 0x476e2f467f9b3523L    # 1.2538221157681851E36

    :try_start_2
    invoke-static {v0, v6, v7, v11, v14}, Lcom/android/internal/protolog/ProtoLogImpl_1767190652;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;JI[Ljava/lang/Object;)V
    ...
    invoke-direct {v6, v4}, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda3;-><init>(I)V

    invoke-virtual {v0, v6}, Lcom/android/server/wm/DisplayArea;->getItemFromDisplayAreas(Ljava/util/function/Function;)Ljava/lang/Object;
    ...
    .line 218
    .local v6, "parentRoot":Lcom/android/server/wm/RootDisplayArea;
    if-nez v6, :cond_1

    .line 221
    new-instance v7, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda4;

    invoke-direct {v7, v4}, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda4;-><init>(I)V

    invoke-virtual {v0, v7}, Lcom/android/server/wm/WindowContainer;->getItemFromTaskDisplayAreas(Ljava/util/function/Function;)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lcom/android/server/wm/TaskDisplayArea;

    .local v7, "parentTda":Lcom/android/server/wm/TaskDisplayArea;
    goto :goto_1

    .line 226
    .end local v7    # "parentTda":Lcom/android/server/wm/TaskDisplayArea;
    :cond_1
    const/4 v7, 0x0

    .line 228
    .restart local v7    # "parentTda":Lcom/android/server/wm/TaskDisplayArea;
    :goto_1
    if-nez v6, :cond_2
    ...
    .line 234
    .local v11, "taskDisplayAreaFeatureId":I
    ...
    .line 237
    .local v12, "state":Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;
    if-eqz v6, :cond_4
    ...
    .line 240
    .local v13, "tda":Lcom/android/server/wm/TaskDisplayArea;
    ...
    .local v17, "display":Lcom/android/server/wm/DisplayContent;
    ...
    .line 207
    .end local v6    # "parentRoot":Lcom/android/server/wm/RootDisplayArea;
    .end local v7    # "parentTda":Lcom/android/server/wm/TaskDisplayArea;
    .end local v11    # "taskDisplayAreaFeatureId":I
    .end local v12    # "state":Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;
    .end local v13    # "tda":Lcom/android/server/wm/TaskDisplayArea;
    .end local v14    # "tdaInfo":Landroid/window/DisplayAreaAppearedInfo;
    .end local v17    # "display":Lcom/android/server/wm/DisplayContent;
    .restart local v0    # "display":Lcom/android/server/wm/DisplayContent;
    :cond_5
    move-object/from16 v17, v0

    .end local v0    # "display":Lcom/android/server/wm/DisplayContent;
    .restart local v17    # "display":Lcom/android/server/wm/DisplayContent;
    :try_start_3
    ...
    const-string v6, "createTaskDisplayArea untrusted displayId="
...
.method public deleteTaskDisplayArea(Landroid/window/WindowContainerToken;)V
    ...
    const-wide v10, -0x1707a85b29a7c0e7L    # -4.549040835844609E197
...
.method onDisplayAreaInfoChanged(Landroid/window/IDisplayAreaOrganizer;Lcom/android/server/wm/DisplayArea;)V
    ...
    const-wide v4, -0xdf9b29faaa7cce4L    # -1.8588966594811073E241
...
.method onDisplayAreaVanished(Landroid/window/IDisplayAreaOrganizer;Lcom/android/server/wm/DisplayArea;)V
    ...
    const-wide v4, 0xdd1f4d4fc1b3a6fL
...
.method public registerOrganizer(Landroid/window/IDisplayAreaOrganizer;I)Landroid/content/pm/ParceledListSlice;
    ...
    const-wide v10, 0x3713507346c530fdL    # 2.165203315745264E-43
    ...
    check-cast v5, Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;

    invoke-virtual {v5}, Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;->destroy()V
    ...
    const-string v7, "Replacing dead organizer for feature="
    ...
    .line 142
    :cond_1
    new-instance v5, Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;

    invoke-direct {v5, p0, p1, p2}, Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;-><init>(Lcom/android/server/wm/DisplayAreaOrganizerController;Landroid/window/IDisplayAreaOrganizer;I)V

    .line 144
    .local v5, "state":Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;
    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    .line 145
    .local v6, "displayAreaInfos":Ljava/util/List;, "Ljava/util/List<Landroid/window/DisplayAreaAppearedInfo;>;"
    iget-object v7, p0, Lcom/android/server/wm/DisplayAreaOrganizerController;->mService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    new-instance v8, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda5;

    invoke-direct {v8, p0, p2, v6, p1}, Lcom/android/server/wm/DisplayAreaOrganizerController$$ExternalSyntheticLambda5;-><init>(Lcom/android/server/wm/DisplayAreaOrganizerController;ILjava/util/List;Landroid/window/IDisplayAreaOrganizer;)V

    invoke-virtual {v7, v8}, Lcom/android/server/wm/RootWindowContainer;->forAllDisplays(Ljava/util/function/Consumer;)V
    ...
    .line 161
    .end local v5    # "state":Lcom/android/server/wm/DisplayAreaOrganizerController$DisplayAreaOrganizerState;
    .end local v6    # "displayAreaInfos":Ljava/util/List;, "Ljava/util/List<Landroid/window/DisplayAreaAppearedInfo;>;"
    :goto_1
    :try_start_2
    monitor-exit v4
    :try_end_2
...
.method public unregisterOrganizer(Landroid/window/IDisplayAreaOrganizer;)V
    ...
    const-wide v10, -0xd17fa2edcfbcb43L    # -3.28056544953695E245
