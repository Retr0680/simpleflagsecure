...
.field private mDimmingContainer:Lcom/android/server/wm/WindowState;

.field private mGeometryParent:Lcom/android/server/wm/WindowContainer;
...
.method static bridge synthetic -$$Nest$fgetmDimmingContainer(Lcom/android/server/wm/DimmerAnimationHelper$Change;)Lcom/android/server/wm/WindowState;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmGeometryParent(Lcom/android/server/wm/DimmerAnimationHelper$Change;)Lcom/android/server/wm/WindowContainer;
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmDimmingContainer(Lcom/android/server/wm/DimmerAnimationHelper$Change;Lcom/android/server/wm/WindowState;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$fputmGeometryParent(Lcom/android/server/wm/DimmerAnimationHelper$Change;Lcom/android/server/wm/WindowContainer;)V
    .locals 0
...
# virtual methods
.method copyFrom(Lcom/android/server/wm/DimmerAnimationHelper$Change;)V
    .locals 1
    .param p1, "other"    # Lcom/android/server/wm/DimmerAnimationHelper$Change;
    ...
    .line 67
    iget-object v0, p1, Lcom/android/server/wm/DimmerAnimationHelper$Change;->mGeometryParent:Lcom/android/server/wm/WindowContainer;
...
.method hasSameDimmingContainer(Lcom/android/server/wm/DimmerAnimationHelper$Change;)Z
    ...
    .line 76
    iget-object v0, p0, Lcom/android/server/wm/DimmerAnimationHelper$Change;->mDimmingContainer:Lcom/android/server/wm/WindowState;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/wm/DimmerAnimationHelper$Change;->mDimmingContainer:Lcom/android/server/wm/WindowState;

    iget-object v1, p1, Lcom/android/server/wm/DimmerAnimationHelper$Change;->mDimmingContainer:Lcom/android/server/wm/WindowState;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/server/wm/DimmerAnimationHelper$Change;->mGeometryParent:Lcom/android/server/wm/WindowContainer;
