...
.method restoreTasksForUserLocked(ILcom/android/server/wm/TaskPersister$RecentTaskFiles;Landroid/util/IntArray;)Ljava/util/ArrayList;
    ...
    .local v18, "in":Lcom/android/modules/utils/TypedXmlPullParser;
    ...
    .local v21, "recentTask":Lcom/android/server/wm/TaskPersister$RecentTaskFile;
    :try_start_3
    iget-object v9, v1, Lcom/android/server/wm/TaskPersister;->mRecentTasks:Lcom/android/server/wm/RecentTasks;

    invoke-virtual {v9, v0}, Lcom/android/server/wm/RecentTasks;->getTask(I)Lcom/android/server/wm/Task;
    ...
    const-string v10, "Existing persisted task with taskId "
    ...
    .end local v18    # "in":Lcom/android/modules/utils/TypedXmlPullParser;
    .end local v19    # "persistedTask":Z
    :catchall_0
    move-exception v0
    ...
    .line 357
    .end local v21    # "recentTask":Lcom/android/server/wm/TaskPersister$RecentTaskFile;
    ...
    .restart local v18    # "in":Lcom/android/modules/utils/TypedXmlPullParser;
    .restart local v19    # "persistedTask":Z
    :cond_2
    move-object/from16 v21, v9

    .line 363
    .end local v9    # "recentTask":Lcom/android/server/wm/TaskPersister$RecentTaskFile;
    .restart local v21    # "recentTask":Lcom/android/server/wm/TaskPersister$RecentTaskFile;
    :cond_3
    if-nez v19, :cond_4

    iget-object v9, v1, Lcom/android/server/wm/TaskPersister;->mService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    invoke-virtual {v9, v0, v10}, Lcom/android/server/wm/RootWindowContainer;->anyTaskForId(II)Lcom/android/server/wm/Task;
    ...
    const-string v10, "Existing task with taskId "
    ...
    const-string v9, "Task with userId "
    ...
    .line 375
    :cond_5
    iget-object v7, v1, Lcom/android/server/wm/TaskPersister;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    invoke-virtual {v7, v0, v2}, Lcom/android/server/wm/ActivityTaskSupervisor;->setNextTaskIdForUser(II)V

    .line 376
    const/4 v10, 0x1

    iput-boolean v10, v5, Lcom/android/server/wm/Task;->isPersistable:Z
    ...
    invoke-static {v11, v5, v0}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
