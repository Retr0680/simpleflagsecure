...
.method public constructor <init>(IILandroid/view/DisplayInfo;Z)V
    ...
    .line 59
    iget v0, p3, Landroid/view/DisplayInfo;->installOrientation:I

    add-int/2addr v0, p1

    rem-int/lit8 v0, v0, 0x4

    iput v0, p0, Lcom/android/server/wm/SeamlessRotator;->mFixedTransformHint:I
    ...
    invoke-static {p1, v2, v0, v4}, Lcom/android/server/wm/utils/CoordinateTransforms;->transformLogicalToPhysicalCoordinates(IIILandroid/graphics/Matrix;)V

    .line 66
    invoke-static {p2, v2, v0, v3}, Lcom/android/server/wm/utils/CoordinateTransforms;->transformPhysicalToLogicalCoordinates(IIILandroid/graphics/Matrix;)V
...
.method public unrotate(Landroid/view/SurfaceControl$Transaction;Lcom/android/server/wm/WindowContainer;)V
    ...
    iget v1, p0, Lcom/android/server/wm/SeamlessRotator;->mFixedTransformHint:I

    invoke-virtual {p1, v0, v1}, Landroid/view/SurfaceControl$Transaction;->setFixedTransformHint(Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;
