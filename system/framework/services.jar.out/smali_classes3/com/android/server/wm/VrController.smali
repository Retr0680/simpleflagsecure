...
.method public onVrModeChanged(Lcom/android/server/wm/ActivityRecord;)Z
    ...
    .line 188
    iget-object v1, p0, Lcom/android/server/wm/VrController;->mVrService:Lcom/android/server/vr/VrManagerInternal;
    ...
    .line 199
    .local v3, "changed":Z
    iget-object v4, p0, Lcom/android/server/wm/VrController;->mGlobalAmLock:Ljava/lang/Object;

    monitor-enter v4

    .line 200
    :try_start_0
    iget-object v5, p1, Lcom/android/server/wm/ActivityRecord;->requestedVrComponent:Landroid/content/ComponentName;
    ...
    .line 202
    .local v5, "requestedPackage":Landroid/content/ComponentName;
    ...
    .line 206
    .local v7, "callingPackage":Landroid/content/ComponentName;
    iget-object v8, p1, Lcom/android/server/wm/ActivityRecord;->app:Lcom/android/server/wm/WindowProcessController;

    invoke-direct {p0, v0, v8}, Lcom/android/server/wm/VrController;->changeVrModeLocked(ZLcom/android/server/wm/WindowProcessController;)Z
    ...
    .line 211
    .end local v0    # "vrMode":Z
    .end local v5    # "requestedPackage":Landroid/content/ComponentName;
    .end local v6    # "userId":I
    .end local v7    # "callingPackage":Landroid/content/ComponentName;
    :catchall_0
    move-exception v0
    ...
    .restart local v0    # "vrMode":Z
    .restart local v5    # "requestedPackage":Landroid/content/ComponentName;
    .restart local v6    # "userId":I
    .restart local v7    # "callingPackage":Landroid/content/ComponentName;
    :cond_2
    :goto_0
    :try_start_2
    monitor-exit v4
