...
.field private mOverrideSettings:Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettings;
...
.method public static synthetic $r8$lambda$b0RL9JPXUM35c9H8FLHfRJnOKvU(Ljava/util/function/Consumer;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    ...
    .line 0
    invoke-static {p0, p1, p2}, Lcom/android/server/wm/DisplayWindowSettingsProvider;->lambda$removeStaleDisplaySettingsLocked$1(Ljava/util/function/Consumer;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
...
.method public static synthetic $r8$lambda$eM_ZFLJ2IWWSfNJX2VvEsDuGSdI(Lcom/android/server/wm/DisplayWindowSettingsProvider;Ljava/util/Set;Landroid/view/DisplayInfo;)V
    ...
    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/DisplayWindowSettingsProvider;->lambda$removeStaleDisplaySettingsLocked$0(Ljava/util/Set;Landroid/view/DisplayInfo;)V
...
.method private static getOverrideSettingsFileForUser(I)Landroid/util/AtomicFile;
    .locals 4
    .param p0, "userId"    # I
    ...
    .line 403
    .local v1, "overrideSettingsFile":Ljava/io/File;
...
.method private synthetic lambda$removeStaleDisplaySettingsLocked$0(Ljava/util/Set;Landroid/view/DisplayInfo;)V
    .locals 1
    .param p1, "displayIdentifiers"    # Ljava/util/Set;
    ...
    invoke-virtual {v0, p2}, Lcom/android/server/wm/DisplayWindowSettingsProvider$ReadableSettings;->getIdentifier(Landroid/view/DisplayInfo;)Ljava/lang/String;
...
.method private static synthetic lambda$removeStaleDisplaySettingsLocked$1(Ljava/util/function/Consumer;Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/DisplayContent;)V
    .locals 4
    .param p0, "addDisplayIdentifier"    # Ljava/util/function/Consumer;
    ...
    invoke-virtual {p1, v0}, Lcom/android/server/wm/WindowManagerService;->getPossibleDisplayInfoLocked(I)Ljava/util/List;

    move-result-object v0

    .line 175
    .local v0, "displayInfos":Ljava/util/List;, "Ljava/util/List<Landroid/view/DisplayInfo;>;"
...
.method private static readSettings(Lcom/android/server/wm/DisplayWindowSettingsProvider$ReadableSettingsStorage;)Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;
    ...
    invoke-direct {v4, v2}, Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;-><init>(Lcom/android/server/wm/DisplayWindowSettingsProvider-IA;)V

    .line 416
    .local v4, "fileData":Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;
    const/4 v2, 0x0
    ...
    .line 438
    invoke-static {v5, v4}, Lcom/android/server/wm/DisplayWindowSettingsProvider;->readDisplay(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;)V
    ...
    .line 440
    invoke-static {v5, v4}, Lcom/android/server/wm/DisplayWindowSettingsProvider;->readConfig(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;)V
    ...
    .end local v4    # "fileData":Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;
    ...
    .restart local v4    # "fileData":Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;
    ...
    .line 467
    iget-object v0, v4, Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;->mSettings:Ljava/util/Map;
...
.method private static writeSettings(Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettingsStorage;Lcom/android/server/wm/DisplayWindowSettingsProvider$FileData;)V
    ...
    .line 604
    :cond_5
    iget v11, v10, Lcom/android/server/wm/DisplayWindowSettings$SettingsProvider$SettingsEntry;->mForcedDensityRatio:F
    ...
    .line 605
    const-string v11, "forcedDensityRatio"

    iget v12, v10, Lcom/android/server/wm/DisplayWindowSettings$SettingsProvider$SettingsEntry;->mForcedDensityRatio:F

    invoke-interface {v6, v8, v11, v12}, Lcom/android/modules/utils/TypedXmlSerializer;->attributeFloat(Ljava/lang/String;Ljava/lang/String;F)Lorg/xmlpull/v1/XmlSerializer;
...
.method removeStaleDisplaySettingsLocked(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/RootWindowContainer;)V
    .locals 3
    .param p1, "wms"    # Lcom/android/server/wm/WindowManagerService;
    ...
    .line 165
    .local v0, "displayIdentifiers":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 167
    .local v1, "addDisplayIdentifier":Ljava/util/function/Consumer;, "Ljava/util/function/Consumer<Landroid/view/DisplayInfo;>;"
    ...
    .line 180
    iget-object v2, p0, Lcom/android/server/wm/DisplayWindowSettingsProvider;->mOverrideSettings:Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettings;

    invoke-virtual {v2, v0}, Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettings;->removeStaleDisplaySettings(Ljava/util/Set;)V
...
.method setOverrideSettingsForUser(I)V
    .locals 2
    .param p1, "userId"    # I
    ...
    .line 148
    .local v0, "settingsFile":Landroid/util/AtomicFile;
    new-instance v1, Lcom/android/server/wm/DisplayWindowSettingsProvider$AtomicFileStorage;

    invoke-direct {v1, v0}, Lcom/android/server/wm/DisplayWindowSettingsProvider$AtomicFileStorage;-><init>(Landroid/util/AtomicFile;)V

    invoke-virtual {p0, v1}, Lcom/android/server/wm/DisplayWindowSettingsProvider;->setOverrideSettingsStorage(Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettingsStorage;)V

    .line 149
    return-void
.end method

.method setOverrideSettingsStorage(Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettingsStorage;)V
    .locals 1
    .param p1, "overrideSettingsStorage"    # Lcom/android/server/wm/DisplayWindowSettingsProvider$WritableSettingsStorage;
