...
.method public onSensorChanged(Landroid/hardware/SensorEvent;)V
    ...
    .line 747
    .restart local v0    # "x":F
    .restart local v2    # "magnitude":F
    .restart local v4    # "skipSample":Z
    .restart local v5    # "y":F
    .restart local v6    # "isAccelerating":Z
    .restart local v7    # "z":F
    ...
    :cond_5
    :goto_4
    invoke-direct {v1}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->clearPredictedRotationLocked()V
    ...
    .line 751
    :cond_6
    invoke-direct {v1, v2}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->isAcceleratingLocked(F)Z
    ...
    .line 764
    .local v2, "tiltAngle":I
    int-to-float v3, v2

    invoke-direct {v1, v8, v9, v3}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->addTiltHistoryEntryLocked(JF)V
    ...
    invoke-direct {v1, v8, v9, v3}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->isSwingingLocked(JF)Z
    ...
    iput-boolean v3, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mOverhead:Z
    ...
    :cond_b
    :goto_5
    iget-boolean v3, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mOverhead:Z
    ...
    .end local v18    # "isAccelerating":Z
    .restart local v4    # "skipSample":Z
    .restart local v6    # "isAccelerating":Z
    :cond_c
    move/from16 v17, v4
    ...
    .restart local v18    # "isAccelerating":Z
    :goto_6
    invoke-direct {v1}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->clearPredictedRotationLocked()V
    ...
    .line 813
    :cond_11
    invoke-direct {v1, v4, v2}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->isTiltAngleAcceptableLocked(II)Z
    ...
    .line 814
    invoke-direct {v1, v4, v3}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->isOrientationAngleAcceptableLocked(II)Z
    ...
    .line 816
    invoke-direct {v1, v8, v9, v4}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->updatePredictedRotationLocked(JI)V
    ...
    .end local v4    # "nearestRotation":I
    .end local v5    # "y":F
    .local v0, "y":F
    .local v21, "nearestRotation":I
    ...
    .line 817
    .end local v20    # "x":F
    .end local v21    # "nearestRotation":I
    .local v0, "x":F
    .restart local v4    # "nearestRotation":I
    .restart local v5    # "y":F
    :cond_12
    move/from16 v20, v0
    ...
    .restart local v21    # "nearestRotation":I
    goto :goto_8
    ...
    .line 837
    .end local v2    # "tiltAngle":I
    .end local v3    # "orientationAngle":I
    .end local v15    # "magnitude":F
    .end local v20    # "x":F
    .end local v21    # "nearestRotation":I
    .end local v22    # "z":F
    .local v0, "x":F
    ...
    iget v3, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mPredictedRotation:I
    ...
    iput v3, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mProposedRotation:I

    .line 846
    :cond_18
    iget v3, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mProposedRotation:I
    ...
    const-string v7, "Result: currentRotation="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v7, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->this$0:Lcom/android/server/wm/WindowOrientationListener;

    invoke-static {v7}, Lcom/android/server/wm/WindowOrientationListener;->-$$Nest$fgetmCurrentRotation(Lcom/android/server/wm/WindowOrientationListener;)I

    move-result v7

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, ", proposedRotation="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, ", predictedRotation="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v7, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mPredictedRotation:I

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v7, ", timeDeltaMS="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v12}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string v7, ", isAccelerating="
    ...
    const-string v7, ", isSwinging="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v14}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v7, ", isOverhead="
    ...
    const-string v7, ", isTouched="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v7, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mTouched:Z

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v7, ", timeUntilSettledMS="
    ...
    .end local v6    # "isAccelerating":Z
    .local v15, "isAccelerating":Z
    iget-wide v6, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mPredictedRotationTimestampNanos:J

    const-wide/32 v23, 0x2625a00

    add-long v6, v6, v23

    .line 859
    invoke-direct {v1, v8, v9, v6, v7}, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->remainingMS(JJ)F
    ...
    iget-wide v6, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mAccelerationTimestampNanos:J

    const-wide/32 v23, 0x1dcd6500
    ...
    iget-wide v6, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mFlatTimestampNanos:J
    ...
    iget-wide v6, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mSwingTimestampNanos:J

    const-wide/32 v25, 0x11e1a300
    ...
    iget-wide v6, v1, Lcom/android/server/wm/WindowOrientationListener$AccelSensorJudge;->mTouchEndedTimestampNanos:J
    ...
    .line 849
    .end local v15    # "isAccelerating":Z
    .restart local v6    # "isAccelerating":Z
    :cond_19
    move v15, v6
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/wm/WindowOrientationListener;->onProposedRotationChanged(I)V
    ...
    .end local v3    # "proposedRotation":I
    :goto_b
    :try_start_2
    monitor-exit v19
    :try_end_2
