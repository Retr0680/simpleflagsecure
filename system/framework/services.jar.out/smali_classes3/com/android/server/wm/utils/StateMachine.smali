...
.method public constructor <init>(I)V
    ...
    .end local p1    # "initialState":I
    .local v3, "initialState":I
    ...
    .line 146
    iput v3, p0, Lcom/android/server/wm/utils/StateMachine;->mLastRequestedState:I
...
.method protected enter(I)V
    ...
    .line 197
    iget-object p1, p0, Lcom/android/server/wm/utils/StateMachine;->mStateHandlers:Landroid/util/SparseArray;

    invoke-virtual {p1, v2}, Landroid/util/SparseArray;->get(I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/android/server/wm/utils/StateMachine$Handler;

    .line 198
    .local p1, "h":Lcom/android/server/wm/utils/StateMachine$Handler;
    if-eqz p1, :cond_0

    .line 199
    invoke-interface {p1}, Lcom/android/server/wm/utils/StateMachine$Handler;->enter()V
...
.method protected exit(I)V
    ...
    .line 207
    invoke-interface {p1}, Lcom/android/server/wm/utils/StateMachine$Handler;->exit()V
...
.method public transit(I)V
    ...
    .line 242
    iget-object p1, p0, Lcom/android/server/wm/utils/StateMachine;->mCommands:Ljava/util/Queue;

    invoke-static {v2}, Lcom/android/server/wm/utils/StateMachine$Command;->newCommit(I)Lcom/android/server/wm/utils/StateMachine$Command;
    ...
    .line 243
    iget p1, p0, Lcom/android/server/wm/utils/StateMachine;->mLastRequestedState:I
    ...
    invoke-static {v2}, Lcom/android/server/wm/utils/StateMachine$Command;->newExit(I)Lcom/android/server/wm/utils/StateMachine$Command;
    ...
    .local p1, "s":I
    :goto_0
    invoke-static {v2, p1}, Lcom/android/server/wm/utils/StateMachine;->isIn(II)Z
    ...
    .line 252
    .end local p1    # "s":I
    iget-object p1, p0, Lcom/android/server/wm/utils/StateMachine;->mTmp:Landroid/util/IntArray;
    ...
    invoke-static {v1}, Lcom/android/server/wm/utils/StateMachine$Command;->newEnter(I)Lcom/android/server/wm/utils/StateMachine$Command;
    ...
    :cond_3
    :goto_3
    iput v2, p0, Lcom/android/server/wm/utils/StateMachine;->mLastRequestedState:I
    ...
    check-cast p1, Lcom/android/server/wm/utils/StateMachine$Command;

    .line 263
    .local p1, "cmd":Lcom/android/server/wm/utils/StateMachine$Command;
    iget v0, p1, Lcom/android/server/wm/utils/StateMachine$Command;->mType:I
    ...
    iget v1, p1, Lcom/android/server/wm/utils/StateMachine$Command;->mType:I
    ...
    .line 265
    :pswitch_0
    iget v0, p1, Lcom/android/server/wm/utils/StateMachine$Command;->mState:I

    invoke-virtual {p0, v0}, Lcom/android/server/wm/utils/StateMachine;->exit(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wm/utils/StateMachine;->enter(I)V
    ...
    iput v0, p0, Lcom/android/server/wm/utils/StateMachine;->mState:I

    .line 272
    nop

    .line 277
    .end local p1    # "cmd":Lcom/android/server/wm/utils/StateMachine$Command;
    :goto_5
    goto :goto_4
