...
.method private doTake(Landroid/os/IBinder;)V
    ...
    .end local p1    # "permissionOwner":Landroid/os/IBinder;
    .local v5, "permissionOwner":Landroid/os/IBinder;
    :try_start_1
    ...
    .end local v5    # "permissionOwner":Landroid/os/IBinder;
    .restart local p1    # "permissionOwner":Landroid/os/IBinder;
    :catchall_1
    move-exception v0
    ...
    .end local p1    # "permissionOwner":Landroid/os/IBinder;
    .restart local v5    # "permissionOwner":Landroid/os/IBinder;
    goto :goto_1
...
.method public release()V
    ...
    invoke-interface {v0, v1, v3, v4, v5}, Lcom/android/server/uri/UriGrantsManagerInternal;->revokeUriPermissionFromOwner(Landroid/os/IBinder;Landroid/net/Uri;II)V
