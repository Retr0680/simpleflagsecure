...
.field private final mPendingTargetProvidersMap:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Lcom/android/server/wm/InsetsControlTarget;",
...
.field private final mSurfaceTransactionIds:Landroid/util/SparseLongArray;
...
.method public static synthetic $r8$lambda$9P0lIIOEjVyKR81E86PJUW6hJRs(Lcom/android/server/wm/InsetsControlTarget;)Ljava/util/ArrayList;
    ...
    .line 0
    invoke-static {p0}, Lcom/android/server/wm/InsetsStateController;->lambda$addToPendingControlMaps$3(Lcom/android/server/wm/InsetsControlTarget;)Ljava/util/ArrayList;
...
.method public static synthetic $r8$lambda$a0HV9ad2Wd_wQT3ba_TprluaiHw(Lcom/android/server/wm/InsetsStateController;ILandroid/util/SparseLongArray;)V
    ...
    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/InsetsStateController;->lambda$notifyPendingInsetsControlChanged$4(ILandroid/util/SparseLongArray;)V
...
.method private addToPendingControlMaps(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsSourceProvider;)V
    .locals 2
    .param p1, "target"    # Lcom/android/server/wm/InsetsControlTarget;
    .param p2, "provider"    # Lcom/android/server/wm/InsetsSourceProvider;
    ...
    invoke-direct {v1}, Lcom/android/server/wm/InsetsStateController$$ExternalSyntheticLambda0;-><init>()V
...
.method private static synthetic lambda$addToPendingControlMaps$3(Lcom/android/server/wm/InsetsControlTarget;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "key"    # Lcom/android/server/wm/InsetsControlTarget;
...
.method private synthetic lambda$notifyPendingInsetsControlChanged$4(ILandroid/util/SparseLongArray;)V
    .locals 9
    .param p1, "size"    # I
    .param p2, "surfaceTransactionIds"    # Landroid/util/SparseLongArray;
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/wm/InsetsSourceProvider;->onSurfaceTransactionCommitted(J)V

    .line 416
    .end local v1    # "sourceId":I
    ...
    iget-object v2, p0, Lcom/android/server/wm/InsetsStateController;->mPendingTargetProvidersMap:Landroid/util/ArrayMap;

    .line 428
    .local v2, "pendingControlMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Lcom/android/server/wm/InsetsControlTarget;Ljava/util/ArrayList<Lcom/android/server/wm/InsetsSourceProvider;>;>;"
    ...
    .line 430
    .local v4, "target":Lcom/android/server/wm/InsetsControlTarget;
    ...
    .line 431
    .local v5, "providers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/wm/InsetsSourceProvider;>;"
    ...
    .line 433
    .local v7, "provider":Lcom/android/server/wm/InsetsSourceProvider;
    invoke-virtual {v7}, Lcom/android/server/wm/InsetsSourceProvider;->isLeashInitialized()Z

    move-result v8

    if-nez v8, :cond_2

    invoke-virtual {v7}, Lcom/android/server/wm/InsetsSourceProvider;->getControlTarget()Lcom/android/server/wm/InsetsControlTarget;
    ...
    .line 431
    .end local v7    # "provider":Lcom/android/server/wm/InsetsSourceProvider;
    :cond_3
    add-int/lit8 v6, v6, -0x1
    ...
    .line 442
    invoke-interface {v4, v1}, Lcom/android/server/wm/InsetsControlTarget;->notifyInsetsControlChanged(I)V

    .line 443
    iget-object v6, p0, Lcom/android/server/wm/InsetsStateController;->mControlTargetProvidersMap:Landroid/util/ArrayMap;
    ...
    .line 428
    .end local v4    # "target":Lcom/android/server/wm/InsetsControlTarget;
    .end local v5    # "providers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/wm/InsetsSourceProvider;>;"
    :cond_5
    add-int/lit8 v3, v3, -0x1
    ...
    check-cast v4, Lcom/android/server/wm/InsetsTarget;
    ...
    invoke-virtual {p0, v4, v5, v6}, Lcom/android/server/wm/InsetsStateController;->onRequestedVisibleTypesChanged(Lcom/android/server/wm/InsetsTarget;ILandroid/view/inputmethod/ImeTracker$Token;)V
...
.method private notifyPendingInsetsControlChanged()V
    ...
    .line 411
    .local v1, "surfaceTransactionIds":Landroid/util/SparseLongArray;
    const/4 v2, 0x0
...
.method private onControlTargetChanged(Lcom/android/server/wm/InsetsSourceProvider;Lcom/android/server/wm/InsetsControlTarget;Z)V
    ...
    .line 339
    invoke-direct {p0, v0, p1}, Lcom/android/server/wm/InsetsStateController;->addToPendingControlMaps(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsSourceProvider;)V
    ...
    .line 343
    invoke-direct {p0, p2, p1}, Lcom/android/server/wm/InsetsStateController;->addToPendingControlMaps(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsSourceProvider;)V
...
.method getFakeControllingTypes(Lcom/android/server/wm/InsetsTarget;)I
    .locals 5
...
.method getOrCreateSourceProvider(II)Lcom/android/server/wm/InsetsSourceProvider;
    ...
    .line 131
    invoke-virtual {v2, v0, v3}, Lcom/android/server/wm/InsetsSourceProvider;->setFlags(II)Z
...
.method notifyControlChanged(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsSourceProvider;)V
    .locals 0
    .param p1, "target"    # Lcom/android/server/wm/InsetsControlTarget;
    .param p2, "provider"    # Lcom/android/server/wm/InsetsSourceProvider;

    .line 384
    invoke-direct {p0, p1, p2}, Lcom/android/server/wm/InsetsStateController;->addToPendingControlMaps(Lcom/android/server/wm/InsetsControlTarget;Lcom/android/server/wm/InsetsSourceProvider;)V
...
.method notifyInsetsChanged(Landroid/util/ArraySet;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 473
    .local p1, "changedWindows":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Lcom/android/server/wm/WindowState;>;"
...
.method notifySurfaceTransactionReady(Lcom/android/server/wm/InsetsSourceProvider;JZ)V
    .locals 2
    .param p1, "provider"    # Lcom/android/server/wm/InsetsSourceProvider;
    .param p2, "id"    # J
    .param p4, "ready"    # Z
...
.method onAnimatingTypesChanged(Lcom/android/server/wm/InsetsControlTarget;Landroid/view/inputmethod/ImeTracker$Token;)V
    ...
    :goto_2
    invoke-virtual {v2, p1, v4}, Lcom/android/server/wm/InsetsSourceProvider;->onAnimatingTypesChanged(Lcom/android/server/wm/InsetsControlTarget;Landroid/view/inputmethod/ImeTracker$Token;)V

    .line 398
    .end local v2    # "provider":Lcom/android/server/wm/InsetsSourceProvider;
    .end local v3    # "isImeProvider":Z
    add-int/lit8 v0, v0, -0x1
...
.method onImeControlTargetChanged(Lcom/android/server/wm/InsetsControlTarget;)V
    ...
    const-wide v4, -0x5cc2f3394287cc11L    # -6.098552492072722E-139
...
.method onRequestedVisibleTypesChanged(Lcom/android/server/wm/InsetsTarget;ILandroid/view/inputmethod/ImeTracker$Token;)V
    ...
    .line 230
    :goto_2
    invoke-virtual {v3, p1, v7}, Lcom/android/server/wm/InsetsSourceProvider;->updateClientVisibility(Lcom/android/server/wm/InsetsTarget;Landroid/view/inputmethod/ImeTracker$Token;)Z
    ...
    .line 234
    invoke-virtual {v3}, Lcom/android/server/wm/InsetsSourceProvider;->getFakeControlTarget()Lcom/android/server/wm/InsetsControlTarget;
    ...
    invoke-interface {v6, p3, v7}, Landroid/view/inputmethod/ImeTracker;->onCancelled(Landroid/view/inputmethod/ImeTracker$Token;I)V

    .line 225
    .end local v3    # "provider":Lcom/android/server/wm/InsetsSourceProvider;
    .end local v4    # "type":I
    .end local v5    # "isImeProvider":Z
    :cond_5
    :goto_3
    add-int/lit8 v1, v1, -0x1
