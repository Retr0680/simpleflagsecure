...
.method private synthetic lambda$onPointerEvent$0(IIILjava/lang/Object;)V
    ...
    .line 268
    .local v12, "isAppWindowTouch":Z
    if-eqz v12, :cond_5

    .line 269
    iget-object v9, v1, Lcom/android/server/wm/RecentTasks$1;->this$0:Lcom/android/server/wm/RecentTasks;

    invoke-static {v9}, Lcom/android/server/wm/RecentTasks;->-$$Nest$fgetmService(Lcom/android/server/wm/RecentTasks;)Lcom/android/server/wm/ActivityTaskManagerService;

    move-result-object v9

    invoke-virtual {v9}, Lcom/android/server/wm/ActivityTaskManagerService;->getTopDisplayFocusedRootTask()Lcom/android/server/wm/Task;

    move-result-object v9

    .line 270
    .local v9, "stack":Lcom/android/server/wm/Task;
    if-eqz v9, :cond_3
    ...
    :goto_0
    sget-object v11, Lcom/android/internal/protolog/ProtoLogImpl_1767190652$Cache;->WM_DEBUG_TASKS_enabled:[Z
    ...
    .local v17, "protoLogParam2":J
    invoke-static/range {v17 .. v18}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v5

    filled-new-array {v11, v3, v5, v0}, [Ljava/lang/Object;

    move-result-object v3

    const-wide v5, -0x16c3e04da87cc1f6L    # -8.409136235686724E198

    move-object/from16 v19, v0

    .end local v0    # "protoLogParam3":Ljava/lang/String;
    .local v19, "protoLogParam3":Ljava/lang/String;
    const/16 v0, 0x14

    invoke-static {v2, v5, v6, v0, v3}, Lcom/android/internal/protolog/ProtoLogImpl_1767190652;->i(Lcom/android/internal/protolog/common/IProtoLogGroup;JI[Ljava/lang/Object;)V
    ...
    .end local v17    # "protoLogParam2":J
    .end local v19    # "protoLogParam3":Ljava/lang/String;
    .local v0, "rac":Lcom/android/server/wm/RootWindowContainer;
    .restart local v6    # "dc":Lcom/android/server/wm/DisplayContent;
    :cond_4
    move-object/from16 v16, v0
    ...
    invoke-virtual {v0, v10}, Lcom/android/server/wm/RecentTasks;->resetFreezeTaskListReordering(Lcom/android/server/wm/Task;)V

    goto :goto_2

    .line 268
    .end local v9    # "stack":Lcom/android/server/wm/Task;
    .end local v10    # "topTask":Lcom/android/server/wm/Task;
    .end local v15    # "dc":Lcom/android/server/wm/DisplayContent;
    .end local v16    # "rac":Lcom/android/server/wm/RootWindowContainer;
    .restart local v0    # "rac":Lcom/android/server/wm/RootWindowContainer;
    .restart local v6    # "dc":Lcom/android/server/wm/DisplayContent;
    ...
    .end local v12    # "isAppWindowTouch":Z
    :goto_2
    monitor-exit v4
    :try_end_2
