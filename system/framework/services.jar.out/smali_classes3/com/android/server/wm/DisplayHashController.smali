...
.method private connectAndRun(Lcom/android/server/wm/DisplayHashController$Command;)V
    ...
    invoke-direct {v5, p0, v6}, Lcom/android/server/wm/DisplayHashController$DisplayHashingServiceConnection;-><init>(Lcom/android/server/wm/DisplayHashController;Lcom/android/server/wm/DisplayHashController-IA;)V
...
.method private generateDisplayHash(Landroid/hardware/HardwareBuffer;Landroid/graphics/Rect;Ljava/lang/String;Landroid/os/RemoteCallback;)V
    ...
    .local v5, "callback":Landroid/os/RemoteCallback;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/wm/DisplayHashController;->connectAndRun(Lcom/android/server/wm/DisplayHashController$Command;)V
...
.method private synthetic lambda$generateDisplayHash$1(Landroid/hardware/HardwareBuffer;Landroid/graphics/Rect;Ljava/lang/String;Landroid/os/RemoteCallback;Landroid/service/displayhash/IDisplayHashingService;)V
    ...
    .end local p3    # "hashAlgorithm":Ljava/lang/String;
    .end local p4    # "callback":Landroid/os/RemoteCallback;
    .end local p5    # "service":Landroid/service/displayhash/IDisplayHashingService;
    .local v0, "service":Landroid/service/displayhash/IDisplayHashingService;
    .local v2, "buffer":Landroid/hardware/HardwareBuffer;
    .local v3, "bounds":Landroid/graphics/Rect;
    .local v4, "hashAlgorithm":Ljava/lang/String;
    .local v5, "callback":Landroid/os/RemoteCallback;
