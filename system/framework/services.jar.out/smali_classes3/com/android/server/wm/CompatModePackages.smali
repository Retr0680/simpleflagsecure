...
.method public constructor <init>(Lcom/android/server/wm/ActivityTaskManagerService;Ljava/io/File;Landroid/os/Handler;)V
    ...
    invoke-interface {v3, v9, v7}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public compatibilityInfoForPackageLocked(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/CompatibilityInfo;
    ...
    .line 475
    .local v7, "compatScale":Landroid/content/res/CompatibilityInfo$CompatScale;
    if-eqz v7, :cond_0

    .line 476
    iget v0, v7, Landroid/content/res/CompatibilityInfo$CompatScale;->mScaleFactor:F
    ...
    iget v0, v7, Landroid/content/res/CompatibilityInfo$CompatScale;->mDensityScaleFactor:F
...
.method setPackageScreenCompatModeLocked(Landroid/content/pm/ApplicationInfo;I)V
    ...
    .line 729
    invoke-direct {v1}, Lcom/android/server/wm/CompatModePackages;->scheduleWrite()V
    ...
    .line 732
    .local v11, "restartedApps":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/wm/WindowProcessController;>;"
    ...
    new-instance v12, Lcom/android/server/wm/CompatModePackages$$ExternalSyntheticLambda0;

    invoke-direct {v12, v4, v11}, Lcom/android/server/wm/CompatModePackages$$ExternalSyntheticLambda0;-><init>(Ljava/lang/String;Ljava/util/ArrayList;)V

    invoke-virtual {v0, v12, v7}, Lcom/android/server/wm/WindowContainer;->forAllWindows(Ljava/util/function/Consumer;Z)V
    ...
    .line 745
    .local v12, "pidMap":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/wm/WindowProcessController;>;"
    ...
    check-cast v14, Lcom/android/server/wm/WindowProcessController;

    .line 747
    .local v14, "app":Lcom/android/server/wm/WindowProcessController;
    invoke-virtual {v14, v4}, Lcom/android/server/wm/WindowProcessController;->containsPackage(Ljava/lang/String;)Z
    ...
    :cond_5
    :try_start_0
    invoke-virtual {v14}, Lcom/android/server/wm/WindowProcessController;->hasThread()Z
    ...
    iget-object v0, v14, Lcom/android/server/wm/WindowProcessController;->mName:Ljava/lang/String;
    ...
    const-wide v0, -0x10a45df3f51cef8L

    const/4 v2, 0x0

    :try_start_1
    invoke-static {v7, v0, v1, v2, v6}, Lcom/android/internal/protolog/ProtoLogImpl_1767190652;->v(Lcom/android/internal/protolog/common/IProtoLogGroup;JI[Ljava/lang/Object;)V
    ...
    .line 754
    :goto_5
    invoke-virtual {v14}, Lcom/android/server/wm/WindowProcessController;->getThread()Landroid/app/IApplicationThread;
    ...
    .line 745
    .end local v14    # "app":Lcom/android/server/wm/WindowProcessController;
    :goto_7
    ...
    .line 760
    .end local v11    # "restartedApps":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/wm/WindowProcessController;>;"
    .end local v12    # "pidMap":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/wm/WindowProcessController;>;"
    .end local v13    # "i":I
    :cond_9
    return-void
