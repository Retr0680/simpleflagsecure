...
.method private static retrieveTextureSizeFromGL()I
    ...
    .line 75
    .local v3, "eglDisplay":Landroid/opengl/EGLDisplay;
    if-eqz v3, :cond_5
    ...
    invoke-static {v3, v2, v1, v2, v11}, Landroid/opengl/EGL14;->eglInitialize(Landroid/opengl/EGLDisplay;[II[II)Z
    ...
    .line 86
    .local v2, "eglConfig":Landroid/opengl/EGLConfig;
    new-array v9, v11, [I
    ...
    .line 114
    .local v5, "attr_list":[I
    sget-object v7, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    invoke-static {v3, v2, v7, v5, v1}, Landroid/opengl/EGL14;->eglCreateContext(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;[II)Landroid/opengl/EGLContext;

    move-result-object v7

    .line 117
    .local v7, "eglContext":Landroid/opengl/EGLContext;
    if-eqz v7, :cond_1
    ...
    filled-new-array {v8, v11, v10, v11, v0}, [I
    ...
    invoke-static {v3, v8, v8, v7}, Landroid/opengl/EGL14;->eglMakeCurrent(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;)Z
    ...
    invoke-static {v11, v10, v1}, Landroid/opengl/GLES20;->glGetIntegerv(I[II)V
    ...
    invoke-static {v3, v11, v12, v13}, Landroid/opengl/EGL14;->eglMakeCurrent(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;Landroid/opengl/EGLSurface;Landroid/opengl/EGLContext;)Z

    .line 134
    invoke-static {v3, v8}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z
    ...
    .end local v5    # "attr_list":[I
    .end local v7    # "eglContext":Landroid/opengl/EGLContext;
    :cond_2
    ...
    .line 81
    .end local v0    # "err":Ljava/lang/String;
    .end local v2    # "eglConfig":Landroid/opengl/EGLConfig;
    .end local v4    # "configSpec":[I
    .end local v6    # "configs":[Landroid/opengl/EGLConfig;
    .end local v9    # "configsCount":[I
    :cond_4
    new-instance v0, Ljava/lang/StringBuilder;
    ...
    .line 138
    .end local v0    # "err":Ljava/lang/String;
    .end local v3    # "eglDisplay":Landroid/opengl/EGLDisplay;
    :catch_0
    move-exception v0
