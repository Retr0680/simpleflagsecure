...
.method private getOrCreateObserverAppDataLocked(I)Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;-><init>(Lcom/android/server/usage/AppTimeLimitController;ILcom/android/server/usage/AppTimeLimitController-IA;)V
...
.method private getOrCreateUserDataLocked(I)Lcom/android/server/usage/AppTimeLimitController$UserData;
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/android/server/usage/AppTimeLimitController$UserData;-><init>(Lcom/android/server/usage/AppTimeLimitController;ILcom/android/server/usage/AppTimeLimitController-IA;)V
...
.method public addAppUsageLimitObserver(II[Ljava/lang/String;JJLandroid/app/PendingIntent;I)V
    ...
    :try_start_0
    invoke-direct {p0, v12}, Lcom/android/server/usage/AppTimeLimitController;->getOrCreateUserDataLocked(I)Lcom/android/server/usage/AppTimeLimitController$UserData;

    move-result-object v2

    .line 867
    .local v2, "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    ...
    .line 868
    .local v3, "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    ...
    .line 869
    .local v13, "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    if-eqz v13, :cond_0

    .line 871
    invoke-virtual {v13}, Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;->remove()V

    goto :goto_0

    .line 889
    .end local v2    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .end local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .end local v13    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    :catchall_0
    move-exception v0
    ...
    .line 874
    .restart local v2    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .restart local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .restart local v13    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    :cond_0
    :goto_0
    iget-object v0, v3, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->appUsageLimitGroups:Landroid/util/SparseArray;
    ...
    .line 881
    .end local v13    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    .local v0, "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    iget-object v5, v3, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->appUsageLimitGroups:Landroid/util/SparseArray;
    ...
    invoke-direct {p0, v2, v0, v5, v6}, Lcom/android/server/usage/AppTimeLimitController;->noteActiveLocked(Lcom/android/server/usage/AppTimeLimitController$UserData;Lcom/android/server/usage/AppTimeLimitController$UsageGroup;J)V

    .line 889
    .end local v0    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    .end local v2    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .end local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .end local v14    # "observerIdCount":I
    monitor-exit v11
    ...
    .restart local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .restart local v13    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageLimitGroup;
    .restart local v14    # "observerIdCount":I
    :cond_2
    ...
    const-string v6, "Too many app usage observers added by uid "
...
.method public addAppUsageObserver(II[Ljava/lang/String;JLandroid/app/PendingIntent;I)V
    ...
    :try_start_0
    invoke-direct {p0, v2}, Lcom/android/server/usage/AppTimeLimitController;->getOrCreateUserDataLocked(I)Lcom/android/server/usage/AppTimeLimitController$UserData;
    ...
    .line 758
    .local v5, "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    invoke-direct/range {p0 .. p1}, Lcom/android/server/usage/AppTimeLimitController;->getOrCreateObserverAppDataLocked(I)Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;

    move-result-object v6

    .line 759
    .local v6, "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    iget-object v0, v6, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->appUsageGroups:Landroid/util/SparseArray;
    ...
    .line 760
    .local v0, "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    if-eqz v0, :cond_0
    ...
    .line 780
    .end local v0    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    .end local v5    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .end local v6    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    :catchall_0
    move-exception v0
    ...
    .line 765
    .restart local v0    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    .restart local v5    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .restart local v6    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    :cond_0
    :goto_0
    iget-object v3, v6, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->appUsageGroups:Landroid/util/SparseArray;
    ...
    .line 770
    new-instance v3, Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    ...
    invoke-direct/range {v3 .. v11}, Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;-><init>(Lcom/android/server/usage/AppTimeLimitController;Lcom/android/server/usage/AppTimeLimitController$UserData;Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;I[Ljava/lang/String;JLandroid/app/PendingIntent;)V

    .line 772
    .end local v0    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    .local v3, "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    iget-object v0, v6, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->appUsageGroups:Landroid/util/SparseArray;

    invoke-virtual {v0, p2, v3}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V

    .line 778
    invoke-virtual {v5, v3}, Lcom/android/server/usage/AppTimeLimitController$UserData;->addUsageGroup(Lcom/android/server/usage/AppTimeLimitController$UsageGroup;)V
    ...
    invoke-direct {p0, v5, v3, v8, v9}, Lcom/android/server/usage/AppTimeLimitController;->noteActiveLocked(Lcom/android/server/usage/AppTimeLimitController$UserData;Lcom/android/server/usage/AppTimeLimitController$UsageGroup;J)V

    .line 780
    .end local v3    # "group":Lcom/android/server/usage/AppTimeLimitController$AppUsageGroup;
    .end local v5    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .end local v6    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .end local v12    # "observerIdCount":I
    monitor-exit v1
    ...
    .restart local v5    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .restart local v6    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .restart local v12    # "observerIdCount":I
    :cond_1
    ...
    const-string v9, "Too many app usage observers added by uid "
...
.method public addUsageSessionObserver(II[Ljava/lang/String;JJLandroid/app/PendingIntent;Landroid/app/PendingIntent;I)V
    ...
    :try_start_0
    invoke-direct {v1, v13}, Lcom/android/server/usage/AppTimeLimitController;->getOrCreateUserDataLocked(I)Lcom/android/server/usage/AppTimeLimitController$UserData;
    ...
    .line 817
    .local v14, "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    if-eqz v14, :cond_0

    .line 819
    invoke-virtual {v14}, Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;->remove()V
    ...
    .end local v2    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .end local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .end local v14    # "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    :catchall_0
    move-exception v0
    ...
    .restart local v2    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .restart local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .restart local v14    # "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    :cond_0
    :goto_0
    iget-object v0, v3, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->sessionUsageGroups:Landroid/util/SparseArray;
    ...
    .line 829
    .end local v14    # "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    .local v0, "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    iget-object v5, v3, Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;->sessionUsageGroups:Landroid/util/SparseArray;
    ...
    invoke-direct {v1, v2, v0, v5, v6}, Lcom/android/server/usage/AppTimeLimitController;->noteActiveLocked(Lcom/android/server/usage/AppTimeLimitController$UserData;Lcom/android/server/usage/AppTimeLimitController$UsageGroup;J)V

    .line 833
    .end local v0    # "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    .end local v2    # "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .end local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .end local v15    # "observerIdCount":I
    monitor-exit v12
    ...
    .restart local v3    # "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .restart local v14    # "group":Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;
    .restart local v15    # "observerIdCount":I
    :cond_1
    new-instance v0, Ljava/lang/IllegalStateException;
