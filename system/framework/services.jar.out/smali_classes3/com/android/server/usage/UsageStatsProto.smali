...
.method private static readStringPool(Landroid/util/proto/ProtoInputStream;)Ljava/util/List;
    ...
    .local v4, "stringPool":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    goto :goto_0

    .line 50
    .end local v4    # "stringPool":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_0
    ...
    .line 52
    .restart local v4    # "stringPool":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :goto_0
    invoke-virtual {p0}, Landroid/util/proto/ProtoInputStream;->nextField()I
...
.method public static write(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    iget v4, v0, Lcom/android/server/usage/IntervalStats$EventTracker;->count:I

    iget-object v0, p1, Lcom/android/server/usage/IntervalStats;->interactiveTracker:Lcom/android/server/usage/IntervalStats$EventTracker;

    iget-wide v5, v0, Lcom/android/server/usage/IntervalStats$EventTracker;->duration:J
    ...
    .end local p1    # "stats":Lcom/android/server/usage/IntervalStats;
    ...
    .restart local p1    # "stats":Lcom/android/server/usage/IntervalStats;
    :catch_4
    move-exception v0
    ...
    .line 632
    .restart local v4    # "stats":Lcom/android/server/usage/IntervalStats;
    ...
    .end local v4    # "stats":Lcom/android/server/usage/IntervalStats;
    .local p1, "stats":Lcom/android/server/usage/IntervalStats;
    :cond_1
    move-object v4, p1
    ...
    .line 638
    :try_start_5
    iget-object v0, v4, Lcom/android/server/usage/IntervalStats;->events:Landroid/app/usage/EventList;

    invoke-virtual {v0, v2}, Landroid/app/usage/EventList;->get(I)Landroid/app/usage/UsageEvents$Event;

    move-result-object v0

    const-wide v5, 0x20b00000016L

    invoke-static {v1, v5, v6, v4, v0}, Lcom/android/server/usage/UsageStatsProto;->writeEvent(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageEvents$Event;)V
    :try_end_5
...
.method private static writeConfigStats(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/ConfigurationStats;Z)V
    ...
    .line 412
    .local v7, "token":J
    iget-object v1, p4, Landroid/app/usage/ConfigurationStats;->mConfiguration:Landroid/content/res/Configuration;
    ...
    .line 413
    iget-wide v3, p4, Landroid/app/usage/ConfigurationStats;->mLastTimeActive:J
    ...
    iget-wide v3, p4, Landroid/app/usage/ConfigurationStats;->mTotalTimeActive:J
    ...
    iget v3, p4, Landroid/app/usage/ConfigurationStats;->mActivationCount:I
    ...
    invoke-virtual {p0, v1, v2, p5}, Landroid/util/proto/ProtoOutputStream;->write(JZ)V
...
.method private static writeEvent(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageEvents$Event;)V
    ...
    iget-object v2, v7, Landroid/app/usage/UsageEvents$Event;->mPackage:Ljava/lang/String;
    ...
    iget-object v3, v7, Landroid/app/usage/UsageEvents$Event;->mPackage:Ljava/lang/String;

    invoke-virtual {p0, v1, v2, v3}, Landroid/util/proto/ProtoOutputStream;->write(JLjava/lang/String;)V

    .line 433
    :goto_0
    iget-object v1, v7, Landroid/app/usage/UsageEvents$Event;->mClass:Ljava/lang/String;
    ...
    iget-object v2, v7, Landroid/app/usage/UsageEvents$Event;->mClass:Ljava/lang/String;
    ...
    iget-object v4, v7, Landroid/app/usage/UsageEvents$Event;->mClass:Ljava/lang/String;
    ...
    .line 447
    iget-object v1, v7, Landroid/app/usage/UsageEvents$Event;->mTaskRootPackage:Ljava/lang/String;
    ...
    iget-object v2, v7, Landroid/app/usage/UsageEvents$Event;->mTaskRootPackage:Ljava/lang/String;
    ...
    .line 449
    .local v1, "taskRootPackageIndex":I
    if-ltz v1, :cond_3
    ...
    .line 454
    .end local v1    # "taskRootPackageIndex":I
    :cond_3
    iget-object v1, v7, Landroid/app/usage/UsageEvents$Event;->mTaskRootClass:Ljava/lang/String;
    ...
    iget-object v2, v7, Landroid/app/usage/UsageEvents$Event;->mTaskRootClass:Ljava/lang/String;
    ...
    .line 461
    .end local v1    # "taskRootClassIndex":I
    :cond_4
    ...
    .line 492
    :sswitch_0
    iget-object v1, v7, Landroid/app/usage/UsageEvents$Event;->mLocusId:Ljava/lang/String;
    ...
    iget-object v2, v7, Landroid/app/usage/UsageEvents$Event;->mLocusId:Ljava/lang/String;
    ...
    .line 478
    .end local v1    # "locusIdIndex":I
    :sswitch_1
    iget-object v1, v7, Landroid/app/usage/UsageEvents$Event;->mNotificationChannelId:Ljava/lang/String;
    ...
    iget-object v2, v7, Landroid/app/usage/UsageEvents$Event;->mNotificationChannelId:Ljava/lang/String;
    ...
    iget-object v4, v7, Landroid/app/usage/UsageEvents$Event;->mNotificationChannelId:Ljava/lang/String;
    ...
    iget v3, v7, Landroid/app/usage/UsageEvents$Event;->mBucketAndReason:I
    ...
    .line 468
    :sswitch_3
    iget-object v1, v7, Landroid/app/usage/UsageEvents$Event;->mShortcutId:Ljava/lang/String;
    ...
    iget-object v3, v7, Landroid/app/usage/UsageEvents$Event;->mShortcutId:Ljava/lang/String;
...
.method private static writeUsageStats(Landroid/util/proto/ProtoOutputStream;JLcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageStats;)V
    ...
    iget-object v2, v9, Landroid/app/usage/UsageStats;->mPackageName:Ljava/lang/String;
    ...
    .line 335
    :goto_0
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mLastTimeUsed:J
    ...
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mTotalTimeInForeground:J
    ...
    iget v0, v9, Landroid/app/usage/UsageStats;->mLastEvent:I

    invoke-virtual {p0, v2, v3, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    .line 342
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mLastTimeForegroundServiceUsed:J
    ...
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mTotalTimeForegroundServiceUsed:J

    invoke-virtual {p0, v2, v3, v4, v5}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    .line 347
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mLastTimeVisible:J
    ...
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mTotalTimeVisible:J

    invoke-virtual {p0, v2, v3, v4, v5}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    .line 352
    iget-wide v4, v9, Landroid/app/usage/UsageStats;->mLastTimeComponentUsed:J
    ...
    iget v0, v9, Landroid/app/usage/UsageStats;->mAppLaunchCount:I

    invoke-virtual {p0, v2, v3, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V

    .line 357
    :try_start_0
    invoke-static {p0, v9}, Lcom/android/server/usage/UsageStatsProto;->writeChooserCounts(Landroid/util/proto/ProtoOutputStream;Landroid/app/usage/UsageStats;)V
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v4, v9, Landroid/app/usage/UsageStats;->mPackageName:Ljava/lang/String;
