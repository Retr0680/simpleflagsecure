...
.method public constructor <init>(Lcom/android/server/usage/AppTimeLimitController;Lcom/android/server/usage/AppTimeLimitController$UserData;Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;I[Ljava/lang/String;JLandroid/app/PendingIntent;JLandroid/app/PendingIntent;)V
    ...
    .end local p1    # "this$0":Lcom/android/server/usage/AppTimeLimitController;
    .end local p8    # "limitReachedCallback":Landroid/app/PendingIntent;
    .local v0, "limitReachedCallback":Landroid/app/PendingIntent;
    .local p2, "this$0":Lcom/android/server/usage/AppTimeLimitController;
    .local p3, "user":Lcom/android/server/usage/AppTimeLimitController$UserData;
    .local p4, "observerApp":Lcom/android/server/usage/AppTimeLimitController$ObserverAppData;
    .local p5, "observerId":I
    .local p6, "observed":[Ljava/lang/String;
    .local p7, "timeLimitMs":J
    iput-wide p9, p1, Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;->mNewSessionThresholdMs:J

    .line 452
    iput-object p11, p1, Lcom/android/server/usage/AppTimeLimitController$SessionUsageGroup;->mSessionEndCallback:Landroid/app/PendingIntent;
