...
.method private deobfuscateUsageStats(Lcom/android/server/usage/PackagesTokenData;)Z
    ...
    .end local v2    # "dataOmitted":Z
    .local v16, "dataOmitted":Z
    ...
    .end local v3    # "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    .local v17, "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    invoke-virtual {v1, v6, v2}, Lcom/android/server/usage/PackagesTokenData;->getString(II)Ljava/lang/String;
    ...
    invoke-virtual {v10, v3, v1}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v16    # "dataOmitted":Z
    .end local v17    # "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    .local v2, "dataOmitted":Z
    .local v3, "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    :cond_3
    move/from16 v16, v2
    ...
    .restart local v16    # "dataOmitted":Z
    .restart local v17    # "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    ...
    .end local v16    # "dataOmitted":Z
    .end local v17    # "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    .restart local v2    # "dataOmitted":Z
    .restart local v3    # "omittedTokens":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    :cond_4
    move/from16 v16, v2
    ...
    iget-object v2, v7, Landroid/app/usage/UsageStats;->mPackageName:Ljava/lang/String;
    ...
    const-string v2, "Unable to parse usage stats packages: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    .line 505
    invoke-virtual/range {v17 .. v17}, Landroid/util/ArraySet;->toArray()[Ljava/lang/Object;
...
.method addEventStatsTo(Ljava/util/List;)V
    ...
    .end local p1    # "out":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/EventStats;>;"
    .local v1, "out":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/EventStats;>;"
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/usage/IntervalStats$EventTracker;->addToEventStats(Ljava/util/List;IJJ)V

    .line 426
    move-object v8, v1

    .end local v1    # "out":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/EventStats;>;"
    .local v8, "out":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/EventStats;>;"
...
.method public update(Ljava/lang/String;Ljava/lang/String;JII)V
    ...
    .restart local p5    # "eventType":I
    .restart local p6    # "instanceId":I
    :cond_1
    move-object v2, p2
    ...
    .restart local v6    # "instanceId":I
    :goto_0
    iget-object p2, p0, Lcom/android/server/usage/IntervalStats;->packageStats:Landroid/util/ArrayMap;
    ...
    .line 319
    iget-object p4, p0, Lcom/android/server/usage/IntervalStats;->packageStats:Landroid/util/ArrayMap;
    ...
    .line 320
    .local p4, "usageStats":Landroid/app/usage/UsageStats;
    move v7, v5
    ...
    .local v8, "instanceId":I
    const/4 v4, 0x0

    move-object v3, p4

    .end local p4    # "usageStats":Landroid/app/usage/UsageStats;
    ...
    .line 326
    :goto_2
    iget-wide p2, p0, Lcom/android/server/usage/IntervalStats;->endTime:J
    ...
    .line 327
    iput-wide v3, p0, Lcom/android/server/usage/IntervalStats;->endTime:J
