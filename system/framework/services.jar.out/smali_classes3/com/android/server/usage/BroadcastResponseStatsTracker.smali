...
.method private static getOrCreateBroadcastEvent(Landroid/util/ArraySet;ILjava/lang/String;IJ)Lcom/android/server/usage/BroadcastEvent;
    ...
    check-cast p2, Lcom/android/server/usage/BroadcastEvent;
...
.method private reportNotificationEvent(ILjava/lang/String;Landroid/os/UserHandle;J)V
    ...
    :try_start_0
    invoke-direct {v1, v4, v5}, Lcom/android/server/usage/BroadcastResponseStatsTracker;->getBroadcastEventsLocked(Ljava/lang/String;Landroid/os/UserHandle;)Landroid/util/ArraySet;
    ...
    :cond_0
    iget-object v6, v1, Lcom/android/server/usage/BroadcastResponseStatsTracker;->mAppStandby:Lcom/android/server/usage/AppStandbyInternal;
    ...
    .line 171
    .local v6, "broadcastResponseWindowDurationMs":J
    iget-object v8, v1, Lcom/android/server/usage/BroadcastResponseStatsTracker;->mAppStandby:Lcom/android/server/usage/AppStandbyInternal;
    ...
    .line 173
    .local v8, "broadcastsSessionWithResponseDurationMs":J
    iget-object v10, v1, Lcom/android/server/usage/BroadcastResponseStatsTracker;->mAppStandby:Lcom/android/server/usage/AppStandbyInternal;
    ...
    .line 175
    .local v10, "recordAllBroadcastsSessionsWithinResponseWindow":Z
    ...
    invoke-static {v12, v4}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v1, v4}, Landroid/app/usage/BroadcastResponseStats;->incrementNotificationsCancelledCount(I)V
    ...
    invoke-virtual {v1, v4}, Landroid/app/usage/BroadcastResponseStats;->incrementNotificationsUpdatedCount(I)V
    ...
    invoke-virtual {v1, v4}, Landroid/app/usage/BroadcastResponseStats;->incrementNotificationsPostedCount(I)V
    ...
    .line 223
    .end local v0    # "broadcastEvents":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Lcom/android/server/usage/BroadcastEvent;>;"
    .end local v6    # "broadcastResponseWindowDurationMs":J
    .end local v8    # "broadcastsSessionWithResponseDurationMs":J
    .end local v10    # "recordAllBroadcastsSessionsWithinResponseWindow":Z
    .end local v11    # "i":I
    monitor-exit v2
...
.method reportBroadcastDispatchEvent(ILjava/lang/String;Landroid/os/UserHandle;JJI)V
    ...
    .line 132
    :cond_2
    iget-object v9, p0, Lcom/android/server/usage/BroadcastResponseStatsTracker;->mLock:Ljava/lang/Object;
    ...
    .line 134
    :try_start_0
    invoke-direct {p0, p2, p3}, Lcom/android/server/usage/BroadcastResponseStatsTracker;->getOrCreateBroadcastEventsLocked(Ljava/lang/String;Landroid/os/UserHandle;)Landroid/util/ArraySet;
    ...
    :try_start_1
    invoke-virtual {v0, v2, v3}, Lcom/android/server/usage/BroadcastEvent;->addTimestampMs(J)V
