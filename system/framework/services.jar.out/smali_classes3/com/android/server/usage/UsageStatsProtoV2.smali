...
.method public static write(Ljava/io/OutputStream;Lcom/android/server/usage/IntervalStats;)V
    ...
    invoke-virtual {v2, v3, v4, v0}, Landroid/util/proto/ProtoOutputStream;->write(JI)V
    ...
    iget v5, v0, Lcom/android/server/usage/IntervalStats$EventTracker;->count:I
    ...
    .line 586
    .local v7, "token":J
    iget-wide v9, p1, Lcom/android/server/usage/IntervalStats;->beginTime:J
    ...
    invoke-static {v2, v9, v10, v0, v6}, Lcom/android/server/usage/UsageStatsProtoV2;->writeConfigStats(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/ConfigurationStats;Z)V
    ...
    invoke-virtual {v0, v6}, Landroid/app/usage/EventList;->get(I)Landroid/app/usage/UsageEvents$Event;

    move-result-object v0

    invoke-static {v2, v9, v10, v0}, Lcom/android/server/usage/UsageStatsProtoV2;->writeEvent(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/UsageEvents$Event;)V
...
.method private static writeConfigStats(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/ConfigurationStats;Z)V
    ...
    .end local p1    # "statsBeginTime":J
    .local v3, "proto":Landroid/util/proto/ProtoOutputStream;
    .local v8, "statsBeginTime":J
...
.method private static writeEvent(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/UsageEvents$Event;)V
    ...
    .line 427
    const-wide p0, 0x10500000008L

    iget p2, p3, Landroid/app/usage/UsageEvents$Event;->mBucketAndReason:I
    ...
    .line 448
    const-wide p0, 0x10b0000000eL

    iget-object p2, p3, Landroid/app/usage/UsageEvents$Event;->mUserInteractionExtrasToken:Landroid/app/usage/UsageEvents$Event$UserInteractionEventExtrasToken;

    invoke-static {v4, p0, p1, p2}, Lcom/android/server/usage/UsageStatsProtoV2;->writeUserInteractionEventExtras(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/UsageEvents$Event$UserInteractionEventExtrasToken;)V
...
.method private static writeUsageStats(Landroid/util/proto/ProtoOutputStream;JLandroid/app/usage/UsageStats;)V
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mLastTimeUsed:J
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mTotalTimeInForeground:J
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mLastTimeForegroundServiceUsed:J
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mTotalTimeForegroundServiceUsed:J
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mLastTimeVisible:J
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mTotalTimeVisible:J
    ...
    iget-wide v4, p3, Landroid/app/usage/UsageStats;->mLastTimeComponentUsed:J
    ...
    iget-object v3, p3, Landroid/app/usage/UsageStats;->mPackageName:Ljava/lang/String;
