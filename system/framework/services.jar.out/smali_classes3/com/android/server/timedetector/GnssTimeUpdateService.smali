...
.method private handleLocationAvailable()V
    ...
    .line 213
    .local v1, "locationTime":Landroid/location/LocationTime;
    if-eqz v1, :cond_0
    ...
    .line 217
    invoke-direct {p0, v1}, Lcom/android/server/timedetector/GnssTimeUpdateService;->suggestGnssTime(Landroid/location/LocationTime;)V
    ...
    .line 222
    :goto_0
    iget-object v2, p0, Lcom/android/server/timedetector/GnssTimeUpdateService;->mLock:Ljava/lang/Object;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/timedetector/GnssTimeUpdateService;->logWarning(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/server/timedetector/GnssTimeUpdateService;->mAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    .line 239
    iget-object v7, p0, Lcom/android/server/timedetector/GnssTimeUpdateService;->mAlarmManager:Landroid/app/AlarmManager;

    const-string v11, "GnssTimeUpdateService"

    iget-object v12, p0, Lcom/android/server/timedetector/GnssTimeUpdateService;->mAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    iget-object v13, p0, Lcom/android/server/timedetector/GnssTimeUpdateService;->mHandler:Landroid/os/Handler;
...
.method private startGnssListeningLocked()V
    ...
    .line 193
    const-string v0, "startGnssListeningLocked()"
...
.method private suggestGnssTime(Landroid/location/LocationTime;)V
    ...
    .line 261
    const-string v0, "suggestGnssTime()"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 280
    const-string v1, "time updates enabled"
...
.method startGnssListening()Z
    ...
    const-string v1, "startGnssListening() called"
