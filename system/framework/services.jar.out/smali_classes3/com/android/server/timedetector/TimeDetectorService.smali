...
.method private enforceSuggestNetworkTimePermission()V
    ...
    const-string v2, "suggest network time"
...
.method setNetworkTimeForSystemClockForTests(Landroid/app/time/UnixEpochTime;I)V
    ...
    .line 460
    const-string v0, "time.set.for.tests"
    ...
    .end local p2    # "uncertaintyMillis":I
    ...
    .line 461
    .local v2, "timeResult":Landroid/util/NtpTrustedTime$TimeResult;
    iget-object p2, p0, Lcom/android/server/timedetector/TimeDetectorService;->mNtpTrustedTime:Landroid/util/NtpTrustedTime;

    invoke-virtual {p2, v2}, Landroid/util/NtpTrustedTime;->setCachedTimeResult(Landroid/util/NtpTrustedTime$TimeResult;)V

    .line 463
    .end local v2    # "timeResult":Landroid/util/NtpTrustedTime$TimeResult;
    :goto_0
    return-void
.end method
