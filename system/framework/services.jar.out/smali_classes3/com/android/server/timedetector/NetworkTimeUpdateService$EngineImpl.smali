...
.method constructor <init>(Ljava/util/function/Supplier;IIILandroid/util/NtpTrustedTime;)V
    ...
    .line 401
    const-string v2, "shortPollingIntervalMillis (%s) > normalPollingIntervalMillis (%s)"
...
.method public dump(Ljava/io/PrintWriter;)V
    ...
    const-string v2, "mNormalPollingIntervalMillis="
    ...
    const-string v2, "mShortPollingIntervalMillis="
    ...
    const-string v2, "mTryAgainTimesMax="
    ...
    const-string v3, "mLastRefreshAttemptElapsedRealtimeMillis="
    ...
    const-string v3, "mTryAgainCounter="
...
.method public forceRefreshForTests(Landroid/net/Network;Lcom/android/server/timedetector/NetworkTimeUpdateService$Engine$RefreshCallbacks;)Z
    ...
    const-string v2, "forceRefreshForTests: refreshSuccessful="
    ...
    .line 420
    const-string v2, "forceRefreshForTests: cachedTimeResult unexpectedly null"
...
.method public refreshAndRescheduleIfRequired(Landroid/net/Network;Ljava/lang/String;Lcom/android/server/timedetector/NetworkTimeUpdateService$Engine$RefreshCallbacks;)V
    ...
    const-string v5, "refreshIfRequiredAndReschedule: reason="
    ...
    .end local v14    # "nextRefreshElapsedRealtimeMillis":J
    :cond_a
    const-string v14, "mLastRefreshAttemptElapsedRealtimeMillis unexpectedly missing. Scheduling using currentElapsedRealtimeMillis"
    ...
    .line 595
    const-string v16, "nextRefreshElapsedRealtimeMillis is a time in the past. Scheduling using currentElapsedRealtimeMillis instead"
    ...
    .end local v8    # "currentElapsedRealtimeMillis":J
    .local v18, "currentElapsedRealtimeMillis":J
    ...
    .line 598
    invoke-direct {v1, v9}, Lcom/android/server/timedetector/NetworkTimeUpdateService$EngineImpl;->logToDebugAndDumpsys(Ljava/lang/String;)V
    ...
    .end local v18    # "currentElapsedRealtimeMillis":J
    .restart local v8    # "currentElapsedRealtimeMillis":J
    :cond_b
    move-wide/from16 v18, v8
    ...
    .line 602
    .end local v8    # "currentElapsedRealtimeMillis":J
    .restart local v18    # "currentElapsedRealtimeMillis":J
    :goto_6
    ...
    const-string v9, "refreshIfRequiredAndReschedule: network="
    ...
    const-string v9, ", initialTimeResult="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v9, ", shouldAttemptRefresh="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v9, ", refreshSuccessful="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v7}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    const-string v9, ", currentElapsedRealtimeMillis="
    ...
    const-string v9, ", latestTimeResult="
    ...
    iget v9, v1, Lcom/android/server/timedetector/NetworkTimeUpdateService$EngineImpl;->mTryAgainCounter:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v9, ", refreshAttemptDelayMillis="

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v10, v11}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v9, ", nextRefreshElapsedRealtimeMillis="
    ...
    .line 604
    invoke-direct {v1, v8}, Lcom/android/server/timedetector/NetworkTimeUpdateService$EngineImpl;->logToDebugAndDumpsys(Ljava/lang/String;)V
