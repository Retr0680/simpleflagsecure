...
.method private updateTwilightState()V
    ...
    invoke-static {v3, v1, v2}, Lcom/android/server/twilight/TwilightService;->calculateTwilightState(Landroid/location/Location;J)Lcom/android/server/twilight/TwilightState;
    ...
    .line 224
    iput-object v4, p0, Lcom/android/server/twilight/TwilightService;->mLastTwilightState:Lcom/android/server/twilight/TwilightState;
    ...
    invoke-direct {v8, v6, v4}, Lcom/android/server/twilight/TwilightService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/twilight/TwilightListener;Lcom/android/server/twilight/TwilightState;)V
    ...
    .line 237
    invoke-virtual {v4}, Lcom/android/server/twilight/TwilightState;->sunriseTimeMillis()J
    ...
    :cond_2
    invoke-virtual {v4}, Lcom/android/server/twilight/TwilightState;->sunsetTimeMillis()J
    ...
    .line 238
    .local v9, "triggerAtMillis":J
    iget-object v7, p0, Lcom/android/server/twilight/TwilightService;->mAlarmManager:Landroid/app/AlarmManager;

    const-string v11, "TwilightService"

    iget-object v13, p0, Lcom/android/server/twilight/TwilightService;->mHandler:Landroid/os/Handler;
    ...
    .line 240
    .end local v9    # "triggerAtMillis":J
    :cond_3
    return-void
