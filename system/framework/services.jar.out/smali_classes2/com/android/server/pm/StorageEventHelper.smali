...
.method private loadPrivatePackagesInner(Landroid/os/storage/VolumeInfo;)V
    ...
    .end local v18    # "pflags":I
    .local v2, "pflags":I
    :try_start_5
    invoke-virtual {v11, v3, v0, v2}, Landroid/os/storage/StorageManager;->prepareUserStorage(Ljava/lang/String;II)V
    ...
    .end local v2    # "pflags":I
    .local v19, "pflags":I
    :try_start_7
    invoke-virtual {v4, v3, v0, v15, v2}, Lcom/android/server/pm/AppDataHelper;->reconcileAppsDataLI(Ljava/lang/String;IIZ)V
    :try_end_7
    ...
    .end local v19    # "pflags":I
    .restart local v2    # "pflags":I
    :catchall_3
    move-exception v0
    ...
    .end local v5    # "freezers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PackageFreezer;>;"
    .local v20, "freezers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PackageFreezer;>;"
    ...
    .end local v20    # "freezers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PackageFreezer;>;"
    .restart local v4    # "appDataHelper":Lcom/android/server/pm/AppDataHelper;
    .restart local v5    # "freezers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PackageFreezer;>;"
    .restart local v8    # "user":Landroid/content/pm/UserInfo;
    :cond_9
    ...
    .restart local v20    # "freezers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/PackageFreezer;>;"
    move-object/from16 v2, p1
    ...
    iget-object v5, v9, Lcom/android/server/pm/Settings$VersionInfo;->fingerprint:Ljava/lang/String;
    ...
    const-string v5, "; regranting permissions for "
    ...
    invoke-virtual {v0, v4, v5, v2, v6}, Lcom/android/server/pm/BroadcastHelper;->sendResourcesChangedBroadcastAndNotify(Ljava/util/function/Supplier;ZZLjava/util/ArrayList;)V
...
.method private unloadPrivatePackagesInner(Landroid/os/storage/VolumeInfo;)V
    ...
    .line 254
    .local v12, "unloaded":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/pkg/AndroidPackage;>;"
    iget-object v0, v1, Lcom/android/server/pm/StorageEventHelper;->mPm:Lcom/android/server/pm/PackageManagerService;
    ...
    .line 258
    .local v15, "packages":Ljava/util/List;, "Ljava/util/List<+Lcom/android/server/pm/pkg/PackageStateInternal;>;"
    ...
    iget-object v5, v1, Lcom/android/server/pm/StorageEventHelper;->mPm:Lcom/android/server/pm/PackageManagerService;

    invoke-interface/range {v16 .. v16}, Lcom/android/server/pm/pkg/PackageState;->getPackageName()Ljava/lang/String;

    move-result-object v19

    const-string/jumbo v22, "unloadPrivatePackagesInner"
    ...
    invoke-virtual/range {v18 .. v23}, Lcom/android/server/pm/PackageManagerService;->freezePackageForDelete(Ljava/lang/String;IILjava/lang/String;I)Lcom/android/server/pm/PackageFreezer;
    ...
    .line 267
    .local v18, "freezer":Lcom/android/server/pm/PackageFreezer;
    move-object v5, v4
    ...
    .end local v15    # "packages":Ljava/util/List;, "Ljava/util/List<+Lcom/android/server/pm/pkg/PackageStateInternal;>;"
    .end local v16    # "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
    .end local v17    # "deleteFlags":I
    .end local v18    # "freezer":Lcom/android/server/pm/PackageFreezer;
    :catchall_1
    move-exception v0
    ...
    .restart local v15    # "packages":Ljava/util/List;, "Ljava/util/List<+Lcom/android/server/pm/pkg/PackageStateInternal;>;"
    .restart local v16    # "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
    ...
    .restart local v16    # "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
    .restart local v17    # "deleteFlags":I
    .restart local v18    # "freezer":Lcom/android/server/pm/PackageFreezer;
    :catchall_2
    move-exception v0
    ...
    .end local v12    # "unloaded":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/pkg/AndroidPackage;>;"
    ...
    .restart local v12    # "unloaded":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/pm/pkg/AndroidPackage;>;"
    ...
    invoke-virtual {v0, v4, v2, v2, v12}, Lcom/android/server/pm/BroadcastHelper;->sendResourcesChangedBroadcastAndNotify(Ljava/util/function/Supplier;ZZLjava/util/ArrayList;)V
...
.method public reconcileApps(Lcom/android/server/pm/Computer;Ljava/lang/String;)V
    ...
    .line 308
    invoke-direct/range {p0 .. p1}, Lcom/android/server/pm/StorageEventHelper;->collectAbsoluteCodePaths(Lcom/android/server/pm/Computer;)Ljava/util/List;
    ...
    .line 346
    iget-object v6, p0, Lcom/android/server/pm/StorageEventHelper;->mRemovePackageHelper:Lcom/android/server/pm/RemovePackageHelper;

    invoke-virtual {v6, v5}, Lcom/android/server/pm/RemovePackageHelper;->removeCodePath(Ljava/io/File;)V
