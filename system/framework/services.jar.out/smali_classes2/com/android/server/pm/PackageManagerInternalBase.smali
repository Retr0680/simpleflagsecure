...
.method public final getSuspendedDialogInfo(Ljava/lang/String;Landroid/content/pm/UserPackage;I)Landroid/content/pm/SuspendDialogInfo;
    ...
    .end local p1    # "suspendedPackage":Ljava/lang/String;
    .end local p2    # "suspendingPackage":Landroid/content/pm/UserPackage;
    .end local p3    # "userId":I
...
.method public final grantImplicitAccess(ILandroid/content/Intent;IIZ)V
    ...
    .end local p3    # "recipientAppId":I
    .end local p4    # "visibleUid":I
    .end local p5    # "direct":Z
    .local v1, "userId":I
    .local v2, "intent":Landroid/content/Intent;
    .local v3, "recipientAppId":I
    .local v4, "visibleUid":I
    .local v5, "direct":Z
...
.method public final grantImplicitAccess(ILandroid/content/Intent;IIZZ)V
    ...
    .end local p4    # "visibleUid":I
    .end local p5    # "direct":Z
    .end local p6    # "retainOnUpdate":Z
    .local v2, "userId":I
    .local v3, "intent":Landroid/content/Intent;
    .local v4, "recipientAppId":I
    .local v5, "visibleUid":I
    .local v6, "direct":Z
    .local v7, "retainOnUpdate":Z
...
.method public notifyComponentUsed(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    .end local p3    # "recentCallingPackage":Ljava/lang/String;
    .end local p4    # "debugInfo":Ljava/lang/String;
    .local v2, "packageName":Ljava/lang/String;
    .local v3, "userId":I
    .local v4, "recentCallingPackage":Ljava/lang/String;
    .local v5, "debugInfo":Ljava/lang/String;
...
.method public final unsuspendAdminSuspendedPackages(I)V
    ...
    invoke-virtual {v1, v2, v3, v0, p1}, Lcom/android/server/pm/PackageManagerService;->unsuspendForSuspendingPackage(Lcom/android/server/pm/Computer;Ljava/lang/String;II)V
