...
.method private approvalLevelForDomain(Lcom/android/server/pm/pkg/PackageStateInternal;Ljava/lang/String;ZIZLjava/lang/Object;)I
    ...
    .end local p1    # "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .local v0, "approvalLevel":I
    .local v1, "debugObject":Ljava/lang/Object;
    .local p2, "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .local p3, "host":Ljava/lang/String;
    .local p4, "includeNegative":Z
    .local p5, "userId":I
    .local p6, "debug":Z
    if-eqz p4, :cond_2
    ...
    .line 1902
    invoke-interface {p2, p5}, Lcom/android/server/pm/pkg/PackageStateInternal;->getUserStateOrDefault(I)Lcom/android/server/pm/pkg/PackageUserStateInternal;

    move-result-object v2

    .line 1903
    .local v2, "pkgUserState":Lcom/android/server/pm/pkg/PackageUserStateInternal;
    ...
    .line 1909
    invoke-static {v2, v3}, Lcom/android/server/pm/pkg/PackageUserStateUtils;->isPackageEnabled(Lcom/android/server/pm/pkg/PackageUserState;Lcom/android/server/pm/pkg/AndroidPackage;)Z
    ...
    .line 1911
    :cond_1
    iget-object v4, p1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mCollector:Lcom/android/server/pm/verify/domain/DomainVerificationCollector;

    invoke-interface {p2}, Lcom/android/server/pm/pkg/PackageStateInternal;->getPkg()Lcom/android/internal/pm/parsing/pkg/AndroidPackageInternal;

    move-result-object v5

    invoke-virtual {v4, v5, p3}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->containsAutoVerifyDomain(Lcom/android/server/pm/pkg/AndroidPackage;Ljava/lang/String;)Z
    ...
    .line 1917
    .end local v2    # "pkgUserState":Lcom/android/server/pm/pkg/PackageUserStateInternal;
...
.method private approvalLevelForDomainInternal(Lcom/android/server/pm/pkg/PackageStateInternal;Ljava/lang/String;ZIZLjava/lang/Object;)I
    ...
    invoke-virtual {v0, v8, v7}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->containsWebDomain(Lcom/android/server/pm/pkg/AndroidPackage;Ljava/lang/String;)Z
    ...
    .line 1935
    .local v9, "pkgUserState":Lcom/android/server/pm/pkg/PackageUserStateInternal;
    const/4 v0, 0x0
    ...
    .line 1951
    :cond_5
    invoke-static {v9, v8}, Lcom/android/server/pm/pkg/PackageUserStateUtils;->isPackageEnabled(Lcom/android/server/pm/pkg/PackageUserState;Lcom/android/server/pm/pkg/AndroidPackage;)Z
    ...
    iget-object v5, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mPlatformCompat:Lcom/android/server/compat/PlatformCompat;

    const-wide/32 v10, 0xa9dc3bd

    invoke-static {v5, v8, v10, v11}, Lcom/android/server/pm/verify/domain/DomainVerificationUtils;->isChangeEnabled(Lcom/android/server/compat/PlatformCompat;Lcom/android/server/pm/pkg/AndroidPackage;J)Z
    ...
    .line 1970
    iget-object v5, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLegacySettings:Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;

    invoke-virtual {v5, v2, v4}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;->getUserState(Ljava/lang/String;I)I
    ...
    :cond_a
    :goto_2
    iget-object v10, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLock:Ljava/lang/Object;

    monitor-enter v10

    .line 1985
    :try_start_0
    iget-object v5, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mAttachedPkgStates:Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;
    ...
    .line 1986
    .local v11, "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    if-nez v11, :cond_c
    ...
    .line 2077
    .end local v11    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    :catchall_0
    move-exception v0
    ...
    .line 1990
    .restart local v11    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    :cond_b
    :goto_4
    monitor-exit v10
    ...
    .line 1993
    :cond_c
    invoke-virtual {v11, v4}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getUserState(I)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    :try_start_1
    invoke-virtual {v12}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->isLinkHandlingAllowed()Z
    ...
    .line 1996
    .restart local v11    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    .restart local v12    # "userState":Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    :cond_d
    move-object/from16 v1, p0
    ...
    iget-object v5, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mCollector:Lcom/android/server/pm/verify/domain/DomainVerificationCollector;

    .line 2009
    invoke-virtual {v5, v8}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    .line 2019
    const-string/jumbo v6, "host verified exactly"
    ...
    .line 2035
    const-string/jumbo v6, "host verified by wildcard"
    ...
    .end local v1    # "stateMapSize":I
    .end local v4    # "index":I
    .local v17, "stateMapSize":I
    .local v18, "index":I
    ...
    .line 2034
    .end local v17    # "stateMapSize":I
    .end local v18    # "index":I
    .end local v19    # "domain":Ljava/lang/String;
    .restart local v1    # "stateMapSize":I
    ...
    .end local v4    # "index":I
    .end local v5    # "domain":Ljava/lang/String;
    .restart local v17    # "stateMapSize":I
    ...
    .line 2051
    :cond_18
    invoke-virtual {v12}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->getEnabledHosts()Landroid/util/ArraySet;
    ...
    .line 2054
    const-string/jumbo v6, "host enabled by user exactly"
    ...
    .line 2057
    .end local v1    # "enabledHosts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v0    # "enabledHosts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    :goto_9
    monitor-exit v10
    ...
    .local v0, "domain":Ljava/lang/String;
    const-string/jumbo v6, "host enabled by user through wildcard"
    ...
    .end local v4    # "enabledHostsSize":I
    .local v0, "enabledHosts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    ...
    .restart local v1    # "enabledHosts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v4    # "enabledHostsSize":I
...
.method private fillMapWithApprovalLevels(Landroid/util/ArrayMap;Landroid/net/Uri;ILjava/util/function/Function;)I
    ...
    .line 1757
    .local v9, "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    if-eqz v9, :cond_2

    .line 1758
    move-object/from16 v7, p2

    invoke-direct {p0, v7, v5}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->matchUriRelativeFilterGroups(Landroid/net/Uri;Ljava/lang/String;)Z
    ...
    .line 1764
    .local v10, "approval":I
    invoke-static {v1, v10}, Ljava/lang/Math;->max(II)I

    move-result v1

    .line 1765
    invoke-direct {p0, v0, v5, v10}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->fillInfoMapForSamePackage(Landroid/util/ArrayMap;Ljava/lang/String;I)V

    goto :goto_2

    .line 1757
    .end local v10    # "approval":I
    :cond_2
    move-object/from16 v7, p2
    ...
    .end local v9    # "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    :goto_2
...
.method private getApprovedPackagesLocked(Ljava/lang/String;IILcom/android/server/pm/Computer;)Landroid/util/Pair;
    ...
    invoke-virtual {v4}, Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;->size()I
    ...
    .local v11, "highestApproval":I
    .local v12, "approvedPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v13, "index":I
    :goto_1
    ...
    check-cast v14, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;

    .line 2094
    .local v14, "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    invoke-virtual {v14}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getPackageName()Ljava/lang/String;
    ...
    .line 2109
    .end local v12    # "approvedPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v0, "approvedPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    move v2, v5
    ...
    .end local v11    # "highestApproval":I
    .local v2, "highestApproval":I
    goto :goto_2

    .line 2110
    .end local v0    # "approvedPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v2    # "highestApproval":I
    .restart local v11    # "highestApproval":I
    .restart local v12    # "approvedPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_3
    if-ne v5, v11, :cond_4
    ...
    .line 2124
    .local v6, "packageName":Ljava/lang/String;
    invoke-interface {v8, v6}, Lcom/android/server/pm/Computer;->getPackageStateInternal(Ljava/lang/String;)Lcom/android/server/pm/pkg/PackageStateInternal;
    ...
    invoke-interface {v9, v13}, Lcom/android/server/pm/pkg/PackageStateInternal;->getUserStateOrDefault(I)Lcom/android/server/pm/pkg/PackageUserStateInternal;
...
.method private getOwnersForDomainInternal(Ljava/lang/String;ZILcom/android/server/pm/Computer;)Landroid/util/SparseArray;
    ...
    iget-object v10, p0, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v11}, Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;->valueAt(I)Ljava/lang/Object;
    ...
    invoke-interface {v8, v13}, Lcom/android/server/pm/Computer;->getPackageStateInternal(Ljava/lang/String;)Lcom/android/server/pm/pkg/PackageStateInternal;
    ...
    .restart local v12    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    ...
    invoke-direct {v3, v8, v5}, Lcom/android/server/pm/verify/domain/DomainVerificationService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/pm/Computer;I)V
...
.method public addPackage(Lcom/android/server/pm/pkg/PackageStateInternal;Landroid/content/pm/verify/domain/DomainSet;)V
    ...
    invoke-virtual {v0, v6}, Landroid/util/ArrayMap;->retainAll(Ljava/util/Collection;)Z

    .line 1093
    iget-object v0, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mCollector:Lcom/android/server/pm/verify/domain/DomainVerificationCollector;

    invoke-virtual {v0, v5}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/pkg/AndroidPackage;)Landroid/util/ArraySet;

    move-result-object v0

    .line 1094
    .local v0, "webDomains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    invoke-virtual {v10}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getUserStates()Landroid/util/SparseArray;
    ...
    invoke-virtual {v14, v0}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->retainHosts(Ljava/util/Set;)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    .line 1099
    .end local v0    # "webDomains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 1103
    .end local v0    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    .restart local v10    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    :goto_3
    invoke-virtual {v10}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getStateMap()Landroid/util/ArrayMap;
    ...
    .local v17, "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    invoke-virtual {v13, v14}, Landroid/util/SparseIntArray;->valueAt(I)I

    move-result v0

    .line 1120
    .local v0, "legacyStatus":I
    move/from16 v18, v4

    const/4 v4, 0x2

    .end local v4    # "sendBroadcast":Z
    .local v18, "sendBroadcast":Z
    if-ne v0, v4, :cond_7
    ...
    .line 1123
    iget-object v4, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mCollector:Lcom/android/server/pm/verify/domain/DomainVerificationCollector;

    invoke-virtual {v4, v5}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/pkg/AndroidPackage;)Landroid/util/ArraySet;

    move-result-object v4

    .end local v17    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .local v4, "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    goto :goto_6

    .line 1122
    .end local v4    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v17    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    :cond_6
    move-object/from16 v4, v17

    .line 1126
    .end local v17    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v4    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    :goto_6
    move/from16 v16, v0

    .end local v0    # "legacyStatus":I
    .local v16, "legacyStatus":I
    ...
    invoke-virtual {v0, v4}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->addHosts(Landroid/util/ArraySet;)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    .line 1120
    .end local v4    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v16    # "legacyStatus":I
    .restart local v0    # "legacyStatus":I
    .restart local v17    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    :cond_7
    move/from16 v16, v0

    .end local v0    # "legacyStatus":I
    .restart local v16    # "legacyStatus":I
    ...
    .restart local v17    # "webDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v18    # "sendBroadcast":Z
    iget-object v0, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mLegacySettings:Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;

    invoke-virtual {v0, v3}, Lcom/android/server/pm/verify/domain/DomainVerificationLegacySettings;->remove(Ljava/lang/String;)Landroid/content/pm/IntentFilterVerificationInfo;

    move-result-object v0

    .line 1131
    .local v0, "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    if-eqz v0, :cond_b
    ...
    .end local v0    # "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    .local v19, "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    ...
    .end local v19    # "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    .end local v20    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .restart local v0    # "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    ...
    .end local v0    # "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    .end local v5    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .restart local v19    # "legacyInfo":Landroid/content/pm/IntentFilterVerificationInfo;
    ...
    invoke-direct {v1, v0, v6, v4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->applyPreVerifiedState(Landroid/util/ArrayMap;Landroid/util/ArraySet;Landroid/content/pm/verify/domain/DomainSet;)V
...
.method public approvalLevelForDomain(Lcom/android/server/pm/pkg/PackageStateInternal;Landroid/content/Intent;JI)I
    ...
    invoke-direct/range {v7 .. v13}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->approvalLevelForDomain(Lcom/android/server/pm/pkg/PackageStateInternal;Ljava/lang/String;ZIZLjava/lang/Object;)I
    ...
    const-string v3, "Final approval level for "
    ...
    .line 1884
    const-string v3, "DomainVerificationServiceApproval"
...
.method public getDomainVerificationUserState(Ljava/lang/String;I)Landroid/content/pm/verify/domain/DomainVerificationUserState;
    ...
    .line 813
    invoke-virtual {v0, v2, v3, v4, v8}, Lcom/android/server/pm/verify/domain/DomainVerificationEnforcer;->assertApprovedUserStateQuerent(IILjava/lang/String;I)Z
    ...
    .line 820
    :try_start_0
    invoke-interface {v9, v4}, Lcom/android/server/pm/Computer;->getPackageStateInternal(Ljava/lang/String;)Lcom/android/server/pm/pkg/PackageStateInternal;
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;->get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v11}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/pkg/AndroidPackage;)Landroid/util/ArraySet;
    ...
    .line 836
    .local v15, "stateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    invoke-virtual {v12, v8}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getUserState(I)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    .line 840
    .local v2, "enabledHosts":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    const/4 v3, 0x0
    ...
    .end local v2    # "enabledHosts":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .local v0, "enabledHosts":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    new-instance v2, Landroid/content/pm/verify/domain/DomainVerificationUserState;
    ...
    .end local v15    # "stateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
...
.method public migrateState(Lcom/android/server/pm/pkg/PackageStateInternal;Lcom/android/server/pm/pkg/PackageStateInternal;Landroid/content/pm/verify/domain/DomainSet;)V
    ...
    invoke-interface {v2}, Lcom/android/server/pm/pkg/PackageStateInternal;->getDomainSetId()Ljava/util/UUID;

    move-result-object v5

    .line 972
    .local v5, "newDomainSetId":Ljava/util/UUID;
    iget-object v3, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mAttachedPkgStates:Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;
    ...
    .line 974
    .local v12, "oldPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    invoke-interface/range {p1 .. p1}, Lcom/android/server/pm/pkg/PackageStateInternal;->getPkg()Lcom/android/internal/pm/parsing/pkg/AndroidPackageInternal;
    ...
    .line 975
    .local v13, "oldPkg":Lcom/android/server/pm/pkg/AndroidPackage;
    invoke-interface {v2}, Lcom/android/server/pm/pkg/PackageStateInternal;->getPkg()Lcom/android/internal/pm/parsing/pkg/AndroidPackageInternal;
    ...
    .line 977
    .local v14, "newPkg":Lcom/android/server/pm/pkg/AndroidPackage;
    new-instance v7, Landroid/util/ArrayMap;

    invoke-direct {v7}, Landroid/util/ArrayMap;-><init>()V

    .line 978
    .local v7, "newStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    .line 996
    .local v15, "oldStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    nop

    .line 997
    invoke-virtual {v12}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getUriRelativeFilterGroupMap()Landroid/util/ArrayMap;
    ...
    .line 999
    invoke-virtual {v3, v14}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectValidAutoVerifyDomains(Lcom/android/server/pm/pkg/AndroidPackage;)Landroid/util/ArraySet;

    move-result-object v3

    .line 1000
    .local v3, "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    ...
    .line 1002
    .local v6, "newDomainsSize":I
    const/4 v9, 0x0

    .local v9, "newDomainsIndex":I
    :goto_0
    if-ge v9, v6, :cond_3
    ...
    .line 1049
    .end local v0    # "domain":Ljava/lang/String;
    .end local v3    # "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v5    # "newDomainSetId":Ljava/util/UUID;
    .end local v6    # "newDomainsSize":I
    .end local v7    # "newStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    .end local v9    # "newDomainsIndex":I
    ...
    .end local v12    # "oldPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    .end local v13    # "oldPkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .end local v14    # "newPkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .end local v15    # "oldStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    .restart local v3    # "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v4    # "pkgName":Ljava/lang/String;
    .restart local v5    # "newDomainSetId":Ljava/util/UUID;
    .restart local v6    # "newDomainsSize":I
    .restart local v7    # "newStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    .restart local v9    # "newDomainsIndex":I
    ...
    .restart local v12    # "oldPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    .restart local v13    # "oldPkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .restart local v14    # "newPkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .restart local v15    # "oldStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    invoke-virtual {v9, v14}, Lcom/android/server/pm/verify/domain/DomainVerificationCollector;->collectAllWebDomains(Lcom/android/server/pm/pkg/AndroidPackage;)Landroid/util/ArraySet;

    move-result-object v9

    .line 1022
    .local v9, "newWebDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    const/16 v17, 0x0
    ...
    .local v5, "oldUserStatesIndex":I
    .local v18, "newDomainSetId":Ljava/util/UUID;
    :goto_2
    if-ge v5, v4, :cond_4
    ...
    invoke-virtual {v0, v9}, Landroid/util/ArraySet;->retainAll(Ljava/util/Collection;)Z

    .line 1030
    move-object/from16 v22, v4

    .end local v4    # "oldEnabledHosts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .restart local v22    # "oldEnabledHosts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    new-instance v4, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;

    .line 1032
    move/from16 v24, v5

    .end local v5    # "oldUserStatesIndex":I
    .local v24, "oldUserStatesIndex":I
    ...
    .local v6, "userId":I
    .local v25, "newDomainsSize":I
    invoke-direct {v4, v6, v0, v5}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;-><init>(ILandroid/util/ArraySet;Z)V

    .line 1033
    .local v4, "newUserState":Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    .end local v4    # "newUserState":Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    .end local v24    # "oldUserStatesIndex":I
    .restart local v5    # "oldUserStatesIndex":I
    goto :goto_2
    ...
    .end local v25    # "newDomainsSize":I
    .local v0, "oldUserStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .local v4, "oldUserStatesSize":I
    .local v6, "newDomainsSize":I
    :cond_4
    ...
    .restart local v24    # "oldUserStatesIndex":I
    .restart local v25    # "newDomainsSize":I
    goto :goto_3

    .line 1020
    .end local v9    # "newWebDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v18    # "newDomainSetId":Ljava/util/UUID;
    .end local v21    # "oldUserStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .end local v23    # "oldUserStatesSize":I
    .end local v24    # "oldUserStatesIndex":I
    .end local v25    # "newDomainsSize":I
    ...
    .end local v5    # "newDomainSetId":Ljava/util/UUID;
    .end local v6    # "newDomainsSize":I
    .restart local v18    # "newDomainSetId":Ljava/util/UUID;
    .restart local v21    # "oldUserStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .restart local v23    # "oldUserStatesSize":I
    .restart local v25    # "newDomainsSize":I
    :goto_3
    ...
    .line 1038
    .local v6, "hasAutoVerifyDomains":Z
    :goto_4
    nop

    .line 1039
    :try_start_5
    invoke-direct {v1, v2, v7, v3}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->applyImmutableState(Lcom/android/server/pm/pkg/PackageStateInternal;Landroid/util/ArrayMap;Landroid/util/ArraySet;)Z
    ...
    invoke-direct {v1, v7, v3, v4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->applyPreVerifiedState(Landroid/util/ArrayMap;Landroid/util/ArraySet;Landroid/content/pm/verify/domain/DomainSet;)V
    ...
    .end local v3    # "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .local v9, "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    ...
    .end local v9    # "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .local v20, "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    const/4 v9, 0x0
    ...
    invoke-virtual {v0, v4, v5, v3}, Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;->put(Ljava/lang/String;Ljava/util/UUID;Ljava/lang/Object;)V

    .line 1049
    .end local v5    # "newDomainSetId":Ljava/util/UUID;
    .end local v6    # "hasAutoVerifyDomains":Z
    .end local v7    # "newStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .end local v8    # "newUserStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .end local v10    # "oldGroups":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/content/UriRelativeFilterGroup;>;>;"
    .end local v12    # "oldPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    ...
    .end local v20    # "newAutoVerifyDomains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v21    # "oldUserStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .end local v23    # "oldUserStatesSize":I
    .end local v25    # "newDomainsSize":I
    monitor-exit v11
    ...
    .line 1052
    invoke-direct {v1, v4}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->sendBroadcast(Ljava/lang/String;)V
    ...
    const-string v6, "Invalid state nullability old state = "

    invoke-virtual {v3, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v6, ", old pkgSetting = "
    ...
    const-string v6, ", new pkgSetting = "

    invoke-virtual {v3, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v6, ", old pkg = "
    ...
    invoke-static {v0, v3, v6}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .line 991
    .local v3, "newPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    iget-object v0, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mAttachedPkgStates:Lcom/android/server/pm/verify/domain/models/DomainVerificationStateMap;
    ...
    .line 1049
    .end local v3    # "newPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    .end local v5    # "newDomainSetId":Ljava/util/UUID;
    .end local v7    # "newStateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .end local v8    # "newUserStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .end local v12    # "oldPkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
...
.method public printState(Lcom/android/server/pm/Computer;Landroid/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    .end local p2    # "writer":Landroid/util/IndentingPrintWriter;
    .end local p3    # "packageName":Ljava/lang/String;
    .end local p4    # "userId":Ljava/lang/Integer;
    .local v3, "writer":Landroid/util/IndentingPrintWriter;
    .local v4, "packageName":Ljava/lang/String;
    .local v5, "userId":Ljava/lang/Integer;
    .local v6, "snapshot":Lcom/android/server/pm/Computer;
    :try_start_1
    ...
    .end local v3    # "writer":Landroid/util/IndentingPrintWriter;
    .end local v4    # "packageName":Ljava/lang/String;
    .end local v5    # "userId":Ljava/lang/Integer;
    .end local v6    # "snapshot":Lcom/android/server/pm/Computer;
    .restart local p1    # "snapshot":Lcom/android/server/pm/Computer;
    .restart local p2    # "writer":Landroid/util/IndentingPrintWriter;
    .restart local p3    # "packageName":Ljava/lang/String;
    .restart local p4    # "userId":Ljava/lang/Integer;
    :catchall_1
    move-exception v0
    ...
    .end local p3    # "packageName":Ljava/lang/String;
    .end local p4    # "userId":Ljava/lang/Integer;
    .restart local v3    # "writer":Landroid/util/IndentingPrintWriter;
    .restart local v4    # "packageName":Ljava/lang/String;
    .restart local v5    # "userId":Ljava/lang/Integer;
    .restart local v6    # "snapshot":Lcom/android/server/pm/Computer;
    :goto_0
    monitor-exit v1
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public setDomainVerificationStatusInternal(ILjava/util/UUID;Ljava/util/Set;I)I
    ...
    .line 425
    .local v0, "newlyVerifiedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    const/4 v4, 0x1
    ...
    .end local p2    # "domainSetId":Ljava/util/UUID;
    .end local p3    # "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .local v2, "domainSetId":Ljava/util/UUID;
    .local v3, "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 427
    .local p1, "result":Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    ...
    .line 458
    .end local v0    # "newlyVerifiedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local p1    # "result":Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    :catchall_0
    move-exception v0
    ...
    .line 431
    .restart local v0    # "newlyVerifiedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local p1    # "result":Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    :cond_0
    ...
    .line 432
    .local p2, "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    ...
    .line 433
    .local p3, "stateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    ...
    .line 436
    .local v9, "previousState":Ljava/lang/Integer;
    if-eqz v9, :cond_2
    ...
    invoke-static {v10}, Landroid/content/pm/verify/domain/DomainVerificationState;->isModifiable(I)Z
    ...
    invoke-virtual {p3, v6, v10}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 451
    nop

    .end local v6    # "domain":Ljava/lang/String;
    .end local v9    # "previousState":Ljava/lang/Integer;
    goto :goto_0
    ...
    invoke-direct {p0, p2, v9}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->removeUserStatesForDomain(Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;Ljava/lang/String;)V
    ...
    .end local v6    # "index":I
    .end local p1    # "result":Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    .end local p2    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    .end local p3    # "stateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    monitor-exit v8
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 460
    iget-object p1, v1, Lcom/android/server/pm/verify/domain/DomainVerificationService;->mConnection:Lcom/android/server/pm/verify/domain/DomainVerificationManagerInternal$Connection;
    ...
    .line 458
    .end local v2    # "domainSetId":Ljava/util/UUID;
    .end local v3    # "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .end local v5    # "callingUid":I
    .local p1, "callingUid":I
    .local p2, "domainSetId":Ljava/util/UUID;
    .local p3, "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :catchall_1
    move-exception v0
    ...
    .end local p2    # "domainSetId":Ljava/util/UUID;
    .end local p3    # "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .restart local v2    # "domainSetId":Ljava/util/UUID;
    .restart local v3    # "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
...
.method public setDomainVerificationUserSelection(Ljava/util/UUID;Ljava/util/Set;ZI)I
    ...
    .end local p1    # "domainSetId":Ljava/util/UUID;
    .end local p2    # "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .local v2, "domainSetId":Ljava/util/UUID;
    .local v3, "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :try_start_1
    invoke-direct/range {v1 .. v7}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->getAndValidateAttachedLocked(Ljava/util/UUID;Ljava/util/Set;ZILjava/lang/Integer;Lcom/android/server/pm/Computer;)Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    ...
    .line 684
    .local p2, "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    invoke-virtual {p2, p4}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;->getOrCreateUserState(I)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    ...
    .line 691
    invoke-direct {p0, v0, p4, v3, v7}, Lcom/android/server/pm/verify/domain/DomainVerificationService;->revokeOtherUserSelectionsLocked(Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;ILjava/util/Set;Lcom/android/server/pm/Computer;)I
    ...
    .line 699
    invoke-virtual {v0, v3}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->addHosts(Ljava/util/Set;)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;

    goto :goto_0

    .line 701
    :cond_3
    invoke-virtual {v0, v3}, Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;->removeHosts(Ljava/util/Set;)Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;

    .line 703
    .end local v0    # "userState":Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;
    .end local p1    # "result":Lcom/android/server/pm/verify/domain/DomainVerificationService$GetAttachedResult;
    .end local p2    # "pkgState":Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    :goto_0
    monitor-exit v8
    ...
    .end local v2    # "domainSetId":Ljava/util/UUID;
    .end local v3    # "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .local p1, "domainSetId":Ljava/util/UUID;
    .local p2, "domains":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :catchall_1
    move-exception v0
