...
.method private hasActiveNetwork(Ljava/util/List;I)Z
    ...
    .line 143
    .local v2, "nsm":Landroid/app/usage/NetworkStatsManager;
    ...
    .line 144
    .local v7, "endTime":J
    sget-wide v3, Lcom/android/server/pm/AppStateHelper;->ACTIVE_NETWORK_DURATION_MILLIS:J
    ...
    .line 146
    .local p2, "stats":Landroid/app/usage/NetworkStats;
    :try_start_1
    ...
    .end local v0    # "bucket":Landroid/app/usage/NetworkStats$Bucket;
    .end local v4    # "packageName":Ljava/lang/String;
    .end local p2    # "stats":Landroid/app/usage/NetworkStats;
    :catch_0
    move-exception v0
    ...
    .line 147
    .restart local v0    # "bucket":Landroid/app/usage/NetworkStats$Bucket;
    .restart local p2    # "stats":Landroid/app/usage/NetworkStats;
    :cond_3
    nop
    ...
    .end local v2    # "nsm":Landroid/app/usage/NetworkStatsManager;
    ...
    .restart local v2    # "nsm":Landroid/app/usage/NetworkStatsManager;
