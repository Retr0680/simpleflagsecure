...
.method static create(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;I)Lcom/android/server/pm/InstallSource;
    ...
    .end local p0    # "initiatingPackageName":Ljava/lang/String;
    .end local p1    # "originatingPackageName":Ljava/lang/String;
    .end local p2    # "installerPackageName":Ljava/lang/String;
    .end local p3    # "installerPackageUid":I
    .end local p4    # "updateOwnerPackageName":Ljava/lang/String;
    .end local p5    # "installerAttributionTag":Ljava/lang/String;
    .end local p6    # "packageSource":I
    ...
    .local v4, "updateOwnerPackageName":Ljava/lang/String;
    .local v5, "installerAttributionTag":Ljava/lang/String;
    .local v6, "packageSource":I
...
.method removeInstallerPackage(Ljava/lang/String;)Lcom/android/server/pm/InstallSource;
    ...
    .end local v3    # "isInitiatingPackageUninstalled":Z
    .local v17, "isInitiatingPackageUninstalled":Z
    :goto_0
    ...
    .line 277
    .end local v4    # "originatingPackageName":Ljava/lang/String;
    .local v10, "originatingPackageName":Ljava/lang/String;
    :goto_1
    ...
    .end local v8    # "isOrphaned":Z
    .local v11, "installerPackageName":Ljava/lang/String;
    .local v12, "installerPackageUid":I
    .local v16, "isOrphaned":Z
    :goto_2
    ...
    .line 288
    .end local v6    # "updateOwnerPackageName":Ljava/lang/String;
    .local v13, "updateOwnerPackageName":Ljava/lang/String;
    :goto_3
    if-nez v2, :cond_5
    ...
    iget-object v3, v0, Lcom/android/server/pm/InstallSource;->mInitiatingPackageSignatures:Lcom/android/server/pm/PackageSignatures;
...
.method setInitiatingPackageSignatures(Lcom/android/server/pm/PackageSignatures;)Lcom/android/server/pm/InstallSource;
    ...
    .end local p1    # "signatures":Lcom/android/server/pm/PackageSignatures;
    .local v10, "signatures":Lcom/android/server/pm/PackageSignatures;
...
.method setInstallerPackage(Ljava/lang/String;I)Lcom/android/server/pm/InstallSource;
    ...
    .end local p2    # "installerPackageUid":I
    .local v4, "installerPackageUid":I
    invoke-static/range {v1 .. v10}, Lcom/android/server/pm/InstallSource;->createInternal(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;IZZLcom/android/server/pm/PackageSignatures;)Lcom/android/server/pm/InstallSource;
