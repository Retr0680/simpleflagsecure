...
.method public getInstantAppIntentFilterList(Landroid/content/pm/InstantAppRequestInfo;Lcom/android/server/pm/InstantAppResolverConnection$PhaseTwoCallback;Landroid/os/Handler;J)V
    ...
    .end local p2    # "callback":Lcom/android/server/pm/InstantAppResolverConnection$PhaseTwoCallback;
    .end local p3    # "callbackHandler":Landroid/os/Handler;
    .end local p4    # "startTime":J
    ...
    .line 129
    .local p2, "remoteCallback":Landroid/os/IRemoteCallback;
    :try_start_0
    ...
    .line 130
    invoke-interface {p3, p1, p2}, Landroid/app/IInstantAppResolver;->getInstantAppIntentFilterList(Landroid/content/pm/InstantAppRequestInfo;Landroid/os/IRemoteCallback;)V
    :try_end_0
    ...
    new-instance p4, Lcom/android/server/pm/InstantAppResolverConnection$ConnectionException;

    const/4 p5, 0x3

    invoke-direct {p4, p5}, Lcom/android/server/pm/InstantAppResolverConnection$ConnectionException;-><init>(I)V
    ...
    .line 132
    .local p3, "e":Ljava/util/concurrent/TimeoutException;
    new-instance p4, Lcom/android/server/pm/InstantAppResolverConnection$ConnectionException;
