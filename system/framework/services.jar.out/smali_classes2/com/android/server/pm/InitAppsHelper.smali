...
.method private scanApexPackagesTraced(Lcom/android/internal/pm/parsing/PackageParser2;)Ljava/util/List;
    ...
    .end local p1    # "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    .local v7, "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    :try_start_1
    ...
    .end local v7    # "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    .restart local p1    # "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    :catchall_1
    move-exception v0
    ...
    .end local p1    # "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    .restart local v7    # "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    :goto_0
    invoke-static {v1, v2}, Landroid/os/Trace;->traceEnd(J)V
...
.method private scanSystemDirs(Lcom/android/internal/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 324
    .local v7, "frameworkDir":Ljava/io/File;
    ...
    iget v4, v9, Lcom/android/server/pm/ScanPartition;->scanFlag:I
    ...
    .end local v7    # "frameworkDir":Ljava/io/File;
    .local v1, "frameworkDir":Ljava/io/File;
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/InitAppsHelper;->scanDirTracedLI(Ljava/io/File;IILcom/android/internal/pm/parsing/PackageParser2;Ljava/util/concurrent/ExecutorService;Lcom/android/server/pm/ApexManager$ActiveApexInfo;)V

    .line 337
    .end local v1    # "frameworkDir":Ljava/io/File;
    .restart local v7    # "frameworkDir":Ljava/io/File;
    iget-object v1, p0, Lcom/android/server/pm/InitAppsHelper;->mPm:Lcom/android/server/pm/PackageManagerService;
    ...
    .local v1, "i":I
    iget-object v2, p0, Lcom/android/server/pm/InitAppsHelper;->mDirsToScanAsSystem:Ljava/util/List;
    ...
    check-cast v11, Lcom/android/server/pm/ScanPartition;

    .line 344
    .local v11, "partition":Lcom/android/server/pm/ScanPartition;
    invoke-virtual {v11}, Landroid/content/pm/PackagePartitions$SystemPartition;->getPrivAppFolder()Ljava/io/File;
    ...
    iget v4, v11, Lcom/android/server/pm/ScanPartition;->scanFlag:I

    or-int/2addr v3, v4

    iget-object v6, v11, Lcom/android/server/pm/ScanPartition;->apexInfo:Lcom/android/server/pm/ApexManager$ActiveApexInfo;
    ...
    .line 350
    :cond_2
    invoke-virtual {v11}, Landroid/content/pm/PackagePartitions$SystemPartition;->getAppFolder()Ljava/io/File;
    ...
    .line 342
    .end local v11    # "partition":Lcom/android/server/pm/ScanPartition;
...
.method public initNonSystemApps(Lcom/android/internal/pm/parsing/PackageParser2;[IJ)V
    ...
    .end local p1    # "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    .local v5, "packageParser":Lcom/android/internal/pm/parsing/PackageParser2;
    ...
    .line 264
    iget-object p1, v1, Lcom/android/server/pm/InitAppsHelper;->mExecutorService:Ljava/util/concurrent/ExecutorService;
    ...
    .line 265
    .local p1, "unfinishedTasks":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Runnable;>;"
