...
.method private static createPkgStateFromXml(Lcom/android/server/pm/SettingsXml$ReadSection;)Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;
    ...
    .line 183
    .local v4, "hasAutoVerifyDomains":Z
    ...
    .line 191
    .local v6, "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    new-instance v8, Landroid/util/ArrayMap;

    invoke-direct {v8}, Landroid/util/ArrayMap;-><init>()V

    .line 193
    .local v8, "groupMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/content/UriRelativeFilterGroup;>;>;"
    ...
    .line 194
    .local v9, "child":Lcom/android/server/pm/SettingsXml$ChildSection;
    :goto_0
    invoke-interface {v9}, Lcom/android/server/pm/SettingsXml$ChildSection;->moveToNext()Z
    ...
    .line 195
    invoke-interface {v9}, Lcom/android/server/pm/SettingsXml$ReadSection;->getName()Ljava/lang/String;
    ...
    :sswitch_0
    const-string/jumbo v10, "uri-relative-filter-groups"
    ...
    :sswitch_2
    const-string/jumbo v10, "user-states"
    ...
    .line 203
    :pswitch_0
    invoke-static {v9, v8}, Lcom/android/server/pm/verify/domain/DomainVerificationPersistence;->readUriRelativeFilterGroups(Lcom/android/server/pm/SettingsXml$ReadSection;Landroid/util/ArrayMap;)V

    goto :goto_3

    .line 200
    :pswitch_1
    invoke-static {v9, v6}, Lcom/android/server/pm/verify/domain/DomainVerificationPersistence;->readUserStates(Lcom/android/server/pm/SettingsXml$ReadSection;Landroid/util/SparseArray;)V
    ...
    .line 197
    :pswitch_2
    invoke-static {v9, v5}, Lcom/android/server/pm/verify/domain/DomainVerificationPersistence;->readDomainStates(Lcom/android/server/pm/SettingsXml$ReadSection;Landroid/util/ArrayMap;)V
    ...
    .end local v6    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .end local v8    # "groupMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/content/UriRelativeFilterGroup;>;>;"
    .end local v9    # "child":Lcom/android/server/pm/SettingsXml$ChildSection;
    :goto_4
    const/4 v1, 0x0
