...
.method public shouldFilterApplication(Lcom/android/server/pm/snapshot/PackageDataSnapshot;ILjava/lang/Object;Lcom/android/server/pm/pkg/PackageStateInternal;I)Z
    ...
    .local v7, "callingSetting":Ljava/lang/Object;
    .local v8, "targetPkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .local v9, "userId":I
    :try_start_5
    ...
    :cond_5
    :goto_1
    iget-object p2, v4, Lcom/android/server/pm/AppsFilterBase;->mFeatureConfig:Lcom/android/server/pm/FeatureConfig;
    ...
    invoke-static {v7, v8, p2}, Lcom/android/server/pm/AppsFilterBase;->log(Ljava/lang/Object;Lcom/android/server/pm/pkg/PackageStateInternal;Ljava/lang/String;)V
    :try_end_5
    ...
    .end local v7    # "callingSetting":Ljava/lang/Object;
    .end local v8    # "targetPkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    ...
    .restart local v7    # "callingSetting":Ljava/lang/Object;
    .restart local v8    # "targetPkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
...
.method protected shouldFilterApplicationInternal(Lcom/android/server/pm/Computer;ILjava/lang/Object;Lcom/android/server/pm/pkg/PackageStateInternal;I)Z
    ...
    .line 673
    .end local v11    # "featureEnabled":Z
    :catchall_0
    move-exception v0
    ...
    .line 415
    .restart local v11    # "featureEnabled":Z
    :cond_1
    ...
    :try_start_1
    invoke-interface {v13, v5}, Lcom/android/server/pm/Computer;->getSharedUser(I)Lcom/android/server/pm/pkg/SharedUserApi;
    ...
    invoke-virtual {v4, v14}, Landroid/util/ArraySet;->addAll(Landroid/util/ArraySet;)V
    ...
    invoke-interface {v2, v5}, Lcom/android/server/pm/FeatureConfig;->packageIsEnabled(Lcom/android/server/pm/pkg/AndroidPackage;)Z
    ...
    iget-object v14, v1, Lcom/android/server/pm/AppsFilterBase;->mFeatureConfig:Lcom/android/server/pm/FeatureConfig;

    invoke-interface {v14, v5}, Lcom/android/server/pm/FeatureConfig;->packageIsEnabled(Lcom/android/server/pm/pkg/AndroidPackage;)Z
    ...
    invoke-virtual {v1, v8, v2}, Lcom/android/server/pm/AppsFilterBase;->isImplicitlyQueryable(II)Z
    ...
    invoke-virtual {v1, v8, v2}, Lcom/android/server/pm/AppsFilterBase;->isRetainedImplicitlyQueryable(II)Z
    ...
    iget-object v0, v1, Lcom/android/server/pm/AppsFilterBase;->mOverlayReferenceMapper:Lcom/android/server/om/OverlayReferenceMapper;
    ...
    .line 614
    invoke-virtual {v0, v2, v12}, Lcom/android/server/om/OverlayReferenceMapper;->isValidActor(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 612
    .restart local v2    # "targetName":Ljava/lang/String;
