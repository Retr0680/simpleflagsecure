...
.method public constructor <init>(Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;Ljava/util/UUID;Z)V
    ...
    .end local p3    # "hasAutoVerifyDomains":Z
    .local v2, "id":Ljava/util/UUID;
    .local v3, "hasAutoVerifyDomains":Z
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/UUID;ZLandroid/util/ArrayMap;Landroid/util/SparseArray;Ljava/lang/String;)V
    ...
    .end local p2    # "id":Ljava/util/UUID;
    .end local p3    # "hasAutoVerifyDomains":Z
    .end local p4    # "stateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .end local p5    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .end local p6    # "backupSignatureHash":Ljava/lang/String;
    .local v1, "packageName":Ljava/lang/String;
    .local v2, "id":Ljava/util/UUID;
    .local v3, "hasAutoVerifyDomains":Z
    .local v4, "stateMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    .local v5, "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Lcom/android/server/pm/verify/domain/models/DomainVerificationInternalUserState;>;"
    .local v6, "backupSignatureHash":Ljava/lang/String;
    invoke-direct/range {v0 .. v7}, Lcom/android/server/pm/verify/domain/models/DomainVerificationPkgState;-><init>(Ljava/lang/String;Ljava/util/UUID;ZLandroid/util/ArrayMap;Landroid/util/SparseArray;Ljava/lang/String;Landroid/util/ArrayMap;)V
