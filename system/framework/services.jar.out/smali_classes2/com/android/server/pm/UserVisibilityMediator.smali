...
.method private getUserAssignedToDisplay(IZ)I
    ...
    .line 928
    .local v1, "userAssignedToExtraDisplay":I
    if-eq v1, v2, :cond_7
    ...
    .line 931
    .end local v1    # "userAssignedToExtraDisplay":I
    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v1, "getUserAssignedToDisplay(%d): no user assigned to display, returning USER_NULL instead"
    ...
    const-string v2, "getUserAssignedToDisplay(%d): no user assigned to display, returning current user (%d) instead"
...
.method private getUserVisibilityOnStartLocked(IIII)I
    ...
    .line 386
    const-string v4, "getUserVisibilityOnStartLocked(%d, %d, %s, %d) failed: cannot start foreground user on secondary display"
    ...
    .line 392
    const-string v4, "getUserVisibilityOnStartLocked(%d, %d, %s, %d) failed: called on device that doesn\'t support multiple users on multiple displays"
    ...
    .line 414
    const-string v4, "getUserVisibilityOnStartLocked(%d, %d, %s, %d) failed: cannot start profile user visible when its parent is not visible in that display"
...
.method public assignUserToDisplayOnStart(IIIIZ)I
    ...
    .line 332
    .end local v4    # "mappingResult":I
    .local v5, "visibleUsersAfter":Landroid/util/IntArray;
    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 334
    invoke-direct {p0, v3, v5}, Lcom/android/server/pm/UserVisibilityMediator;->dispatchVisibilityChanged(Landroid/util/IntArray;Landroid/util/IntArray;)V
    ...
    const-string/jumbo v4, "returning %s"
    ...
    invoke-static {v1, v4, v6}, Lcom/android/server/utils/Slogf;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .end local v5    # "visibleUsersAfter":Landroid/util/IntArray;
    :goto_3
    :try_start_1
    monitor-exit v1
...
.method public assignUserToExtraDisplay(II)Z
    ...
    .local v4, "userAssignedToDisplay":I
    if-eq v4, v3, :cond_8

    .line 585
    sget-object v2, Lcom/android/server/pm/UserVisibilityMediator;->TAG:Ljava/lang/String;

    const-string v3, "assignUserToExtraDisplay(%d, %d): failed because user %d was already assigned to extra display"
    ...
    .line 585
    invoke-static {v2, v3, v5}, Lcom/android/server/utils/Slogf;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v2, "addding %d -> %d to mExtraDisplaysAssignedToUsers"
    ...
    .line 594
    .end local v4    # "userAssignedToDisplay":I
    monitor-exit v0
