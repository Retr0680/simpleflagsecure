...
.method private runList()I
    ...
    .local v31, "deviceOwner":Ljava/lang/String;
    .local v32, "profileOwner":Ljava/lang/String;
    :goto_8
    iget v6, v13, Landroid/content/pm/UserInfo;->id:I
    ...
    .local v17, "visible":Z
    iget-object v1, v13, Landroid/content/pm/UserInfo;->userType:Ljava/lang/String;

    .line 233
    move/from16 v18, v3

    .end local v3    # "hasParent":Z
    .local v18, "hasParent":Z
    ...
    iget v1, v13, Landroid/content/pm/UserInfo;->flags:I
    ...
    .line 237
    :goto_c
    iget-boolean v1, v13, Landroid/content/pm/UserInfo;->partial:Z
    ...
    .line 238
    :goto_d
    iget-boolean v1, v13, Landroid/content/pm/UserInfo;->preCreated:Z
    ...
    .line 239
    :goto_e
    iget-boolean v1, v13, Landroid/content/pm/UserInfo;->convertedFromPreCreated:Z
    ...
    filled-new-array/range {v21 .. v34}, [Ljava/lang/Object;

    move-result-object v0

    .line 229
    const-string v1, "%d: id=%d, name=%s, type=%s, flags=%s%s%s%s%s%s%s%s%s%s\n"
    ...
    .end local v18    # "hasParent":Z
    .end local v31    # "deviceOwner":Ljava/lang/String;
    .end local v32    # "profileOwner":Ljava/lang/String;
    goto :goto_11
