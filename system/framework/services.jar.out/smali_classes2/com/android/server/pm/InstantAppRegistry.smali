...
.method private createInstantAppInfoForPackage(Lcom/android/server/pm/pkg/PackageStateInternal;IZ)Landroid/content/pm/InstantAppInfo;
    ...
    invoke-direct {p2, p1, v1, v3}, Landroid/content/pm/InstantAppInfo;-><init>(Landroid/content/pm/ApplicationInfo;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lcom/android/server/pm/InstantAppRegistry;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p2, v4, v5, v1, v3}, Landroid/content/pm/InstantAppInfo;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .local p1, "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
...
.method private pruneInstantApps(Lcom/android/server/pm/Computer;JJJ)Z
    ...
    .line 821
    .local v0, "userId":I
    invoke-interface {v14, v0}, Lcom/android/server/pm/pkg/PackageStateInternal;->getUserStateOrDefault(I)Lcom/android/server/pm/pkg/PackageUserStateInternal;
    ...
    .line 886
    .local v20, "packageToDelete":Ljava/lang/String;
    ...
    .line 884
    .end local v20    # "packageToDelete":Ljava/lang/String;
    :cond_b
    add-int/lit8 v6, v6, 0x1
    ...
    .end local v6    # "i":I
    :cond_c
    iget-object v6, v1, Lcom/android/server/pm/InstantAppRegistry;->mLock:Ljava/lang/Object;
    ...
    invoke-direct {v0, v2, v3}, Lcom/android/server/pm/InstantAppRegistry$$ExternalSyntheticLambda3;-><init>(J)V

    invoke-direct {v1, v0, v15}, Lcom/android/server/pm/InstantAppRegistry;->removeUninstalledInstantAppStateLPw(Ljava/util/function/Predicate;I)V

    .line 908
    invoke-static {v15}, Lcom/android/server/pm/InstantAppRegistry;->getInstantApplicationsDir(I)Ljava/io/File;

    move-result-object v0

    .line 909
    .local v0, "instantAppsDir":Ljava/io/File;
    invoke-virtual {v0}, Ljava/io/File;->exists()Z
    ...
    .local v0, "files":[Ljava/io/File;
    .local v19, "instantAppsDir":Ljava/io/File;
    array-length v1, v0
    ...
    .line 917
    .local v22, "instantDir":Ljava/io/File;
    ...
    .end local v22    # "instantDir":Ljava/io/File;
    ...
    .line 928
    .local v24, "elapsedCachingMillis":J
    cmp-long v1, v24, p6

    if-lez v1, :cond_12

    .line 929
    invoke-static {v2}, Lcom/android/server/pm/InstantAppRegistry;->deleteDir(Ljava/io/File;)V
    ...
    .end local v19    # "instantAppsDir":Ljava/io/File;
    .end local v20    # "files":[Ljava/io/File;
    .end local v24    # "elapsedCachingMillis":J
    :catchall_0
    move-exception v0
    ...
    .restart local v2    # "instantDir":Ljava/io/File;
    .restart local v15    # "userId":I
    .restart local v19    # "instantAppsDir":Ljava/io/File;
    .restart local v20    # "files":[Ljava/io/File;
    .restart local v24    # "elapsedCachingMillis":J
    :cond_11
    const/16 v18, 0x1
...
.method private writeUninstalledInstantAppMetadata(Landroid/content/pm/InstantAppInfo;I)V
    ...
    .line 1265
    invoke-virtual {v14}, Landroid/content/pm/InstantAppInfo;->getRequestedPermissions()[Ljava/lang/String;
    ...
    .line 1268
    invoke-virtual {v14}, Landroid/content/pm/InstantAppInfo;->getGrantedPermissions()[Ljava/lang/String;
...
.method public getInstantAppAndroidId(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .end local v5    # "idFile":Ljava/io/File;
    .end local p0    # "this":Lcom/android/server/pm/InstantAppRegistry;
    ...
    .restart local v5    # "idFile":Ljava/io/File;
    .restart local p0    # "this":Lcom/android/server/pm/InstantAppRegistry;
...
.method pruneInstalledInstantApps(Lcom/android/server/pm/Computer;JJ)Z
    ...
    .end local p2    # "neededSpace":J
    .end local p4    # "maxInstalledCacheDuration":J
    .local v2, "computer":Lcom/android/server/pm/Computer;
    .local v3, "neededSpace":J
    .local v5, "maxInstalledCacheDuration":J
    :try_start_0
    invoke-direct/range {v1 .. v8}, Lcom/android/server/pm/InstantAppRegistry;->pruneInstantApps(Lcom/android/server/pm/Computer;JJJ)Z
...
.method pruneInstantApps(Lcom/android/server/pm/Computer;)V
    ...
    .line 739
    .local v8, "maxInstalledCacheDuration":J
    iget-object v0, p0, Lcom/android/server/pm/InstantAppRegistry;->mContext:Landroid/content/Context;
    ...
    .line 745
    .local v10, "maxUninstalledCacheDuration":J
    ...
    .end local p1    # "computer":Lcom/android/server/pm/Computer;
    .local v5, "computer":Lcom/android/server/pm/Computer;
    :try_start_0
    ...
    const-string v1, "Error pruning installed and uninstalled instant apps"
...
.method pruneUninstalledInstantApps(Lcom/android/server/pm/Computer;JJ)Z
    ...
    .end local p1    # "computer":Lcom/android/server/pm/Computer;
    .end local p2    # "neededSpace":J
    .end local p4    # "maxUninstalledCacheDuration":J
    .local v2, "computer":Lcom/android/server/pm/Computer;
    .local v3, "neededSpace":J
    .local v7, "maxUninstalledCacheDuration":J
    :try_start_0
    invoke-direct/range {v1 .. v8}, Lcom/android/server/pm/InstantAppRegistry;->pruneInstantApps(Lcom/android/server/pm/Computer;JJJ)Z
