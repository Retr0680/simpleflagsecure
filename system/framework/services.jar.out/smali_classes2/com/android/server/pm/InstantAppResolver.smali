...
.method private static computeResolveFilters(Lcom/android/server/pm/Computer;Lcom/android/server/pm/UserManagerService;Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Landroid/content/pm/InstantAppResolveInfo;)Ljava/util/List;
    ...
    .line 504
    .local v8, "instantAppResolver":Lcom/android/server/pm/resolution/ComponentResolver$InstantAppIntentResolver;
    ...
    invoke-virtual {v8, v4, v14}, Lcom/android/server/IntentResolver;->addFilter(Lcom/android/server/pm/snapshot/PackageDataSnapshot;Ljava/lang/Object;)V
    ...
    .line 533
    .local v4, "matchedResolveInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    ...
    const-string v9, "] Found match(es); "
    ...
    const-string v9, "] No matches found package: "
    ...
    .line 491
    .end local v4    # "matchedResolveInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    .end local v8    # "instantAppResolver":Lcom/android/server/pm/resolution/ComponentResolver$InstantAppIntentResolver;
    :cond_d
    move-object/from16 v7, p1
...
.method public static doInstantAppResolutionPhaseOne(Lcom/android/server/pm/Computer;Lcom/android/server/pm/UserManagerService;Lcom/android/server/pm/InstantAppResolverConnection;Landroid/content/pm/InstantAppRequest;)Landroid/content/pm/AuxiliaryResolveInfo;
    ...
    .line 149
    .local v15, "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    const/16 v16, 0x0
    ...
    .line 152
    .local v7, "origIntent":Landroid/content/Intent;
    nop
    ...
    .end local v15    # "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    .local v6, "instantAppResolveInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/InstantAppResolveInfo;>;"
    .local v11, "token":Ljava/lang/String;
    .local v17, "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    :try_start_1
    ...
    .end local v7    # "origIntent":Landroid/content/Intent;
    .end local v11    # "token":Ljava/lang/String;
    .end local v17    # "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    ...
    .end local v5    # "token":Ljava/lang/String;
    .end local v6    # "instantAppResolveInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/InstantAppResolveInfo;>;"
    .end local v10    # "origIntent":Landroid/content/Intent;
    .restart local v7    # "origIntent":Landroid/content/Intent;
    .restart local v11    # "token":Ljava/lang/String;
    .restart local v17    # "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    :catch_0
    move-exception v0
    ...
    .end local v17    # "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    .restart local v7    # "origIntent":Landroid/content/Intent;
    .restart local v15    # "resolveInfo":Landroid/content/pm/AuxiliaryResolveInfo;
    :catch_1
    move-exception v0
    ...
    invoke-static {v4, v2, v3, v5, v0}, Lcom/android/server/pm/InstantAppResolver;->logMetrics(IJLjava/lang/String;I)V
    ...
    invoke-static {v10, v5}, Lcom/android/server/pm/InstantAppResolver;->createFailureIntent(Landroid/content/Intent;Ljava/lang/String;)Landroid/content/Intent;
...
.method public static doInstantAppResolutionPhaseTwo(Landroid/content/Context;Lcom/android/server/pm/Computer;Lcom/android/server/pm/UserManagerService;Lcom/android/server/pm/InstantAppResolverConnection;Landroid/content/pm/InstantAppRequest;Landroid/content/pm/ActivityInfo;Landroid/os/Handler;)V
    ...
    .line 203
    .local v3, "origIntent":Landroid/content/Intent;
    ...
    .line 205
    .local v6, "sanitizedIntent":Landroid/content/Intent;
    ...
    .end local v3    # "origIntent":Landroid/content/Intent;
    .end local v4    # "token":Ljava/lang/String;
    .end local v6    # "sanitizedIntent":Landroid/content/Intent;
    .local v7, "token":Ljava/lang/String;
    .local v8, "origIntent":Landroid/content/Intent;
    ...
    invoke-static {v2, v5, v6, v7, v1}, Lcom/android/server/pm/InstantAppResolver;->logMetrics(IJLjava/lang/String;I)V
...
.method private static filterInstantAppIntent(Lcom/android/server/pm/Computer;Lcom/android/server/pm/UserManagerService;Ljava/util/List;Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[I)Landroid/content/pm/AuxiliaryResolveInfo;
    ...
    .end local v3    # "requiresSecondPhase":Z
    .end local v4    # "filters":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    .local v10, "requiresSecondPhase":Z
    ...
    check-cast v20, Landroid/content/pm/InstantAppResolveInfo;

    .line 409
    .local v20, "instantAppResolveInfo":Landroid/content/pm/InstantAppResolveInfo;
    if-eqz v5, :cond_2

    invoke-virtual/range {v20 .. v20}, Landroid/content/pm/InstantAppResolveInfo;->shouldLetInstallerDecide()Z
    ...
    const-string v4, "InstantAppResolveInfo with mShouldLetInstallerDecide=true when digest required; ignoring"
    ...
    .line 414
    :cond_2
    invoke-virtual/range {v20 .. v20}, Landroid/content/pm/InstantAppResolveInfo;->getDigestBytes()[B

    move-result-object v3

    .line 417
    .local v3, "filterDigestBytes":[B
    array-length v4, v1
    ...
    invoke-static/range {v13 .. v20}, Lcom/android/server/pm/InstantAppResolver;->computeResolveFilters(Lcom/android/server/pm/Computer;Lcom/android/server/pm/UserManagerService;Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Landroid/content/pm/InstantAppResolveInfo;)Ljava/util/List;

    move-result-object v4

    .line 434
    .local v4, "matchFilters":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    if-eqz v4, :cond_9
    ...
    .local v8, "filters":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    goto :goto_5

    .line 441
    .end local v8    # "filters":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    ...
    .line 444
    .end local v3    # "filterDigestBytes":[B
    .end local v4    # "matchFilters":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/AuxiliaryResolveInfo$AuxiliaryFilter;>;"
    .end local v20    # "instantAppResolveInfo":Landroid/content/pm/InstantAppResolveInfo;
    :cond_9
    :goto_5
    goto :goto_2
    ...
    invoke-static {v15, v9}, Lcom/android/server/pm/InstantAppResolver;->createFailureIntent(Landroid/content/Intent;Ljava/lang/String;)Landroid/content/Intent;
