...
.method private runGetAppLinks(Lcom/android/modules/utils/BasicShellCommandHandler;)Z
    ...
    invoke-interface {v5, v4, v0, v1}, Lcom/android/server/pm/verify/domain/DomainVerificationShell$Callback;->printState(Landroid/util/IndentingPrintWriter;Ljava/lang/String;Ljava/lang/Integer;)V
    :try_end_1
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private runResetAppLinks(Lcom/android/modules/utils/BasicShellCommandHandler;)Z
    ...
    .line 334
    .local v0, "pkgNameArg":Ljava/lang/String;
    invoke-static {v0}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z
...
.method private translateUserId(ILjava/lang/String;)I
    ...
    .end local p2    # "logContext":Ljava/lang/String;
    .local v2, "userId":I
    .local v5, "logContext":Ljava/lang/String;
