...
.method notifyDexLoadInternal(Landroid/content/pm/ApplicationInfo;Ljava/util/Map;Ljava/lang/String;IZ)V
    ...
    .local v8, "loadingPackageAmendedName":Ljava/lang/String;
    :goto_0
    ...
    .line 213
    .local v13, "mapping":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    invoke-direct {v0, v1, v4, v5}, Lcom/android/server/pm/dex/DexManager;->getDexPackage(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;I)Lcom/android/server/pm/dex/DexManager$DexSearchResult;

    move-result-object v14

    .line 217
    .local v14, "searchResult":Lcom/android/server/pm/dex/DexManager$DexSearchResult;
    sget-boolean v2, Lcom/android/server/pm/dex/DexManager;->DEBUG:Z
    ...
    .line 222
    :cond_4
    invoke-static {v14}, Lcom/android/server/pm/dex/DexManager$DexSearchResult;->-$$Nest$fgetmOutcome(Lcom/android/server/pm/dex/DexManager$DexSearchResult;)I
    ...
    .line 226
    invoke-static {v14}, Lcom/android/server/pm/dex/DexManager$DexSearchResult;->-$$Nest$fgetmOwningPackageName(Lcom/android/server/pm/dex/DexManager$DexSearchResult;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v5, v4, v3, v9}, Lcom/android/server/pm/dex/DynamicCodeLogger;->recordDex(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 257
    .local v9, "classLoaderContext":Ljava/lang/String;
    invoke-static {v14}, Lcom/android/server/pm/dex/DexManager$DexSearchResult;->-$$Nest$fgetmOwningPackageName(Lcom/android/server/pm/dex/DexManager$DexSearchResult;)Ljava/lang/String;
    ...
    .line 270
    .end local v7    # "primaryOrSplit":Z
    .end local v9    # "classLoaderContext":Ljava/lang/String;
    .end local v10    # "overwriteCLC":Z
    ...
    .end local v13    # "mapping":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v14    # "searchResult":Lcom/android/server/pm/dex/DexManager$DexSearchResult;
    :cond_b
    :goto_3
    move-object/from16 v6, p3
...
.method public notifyPackageUpdated(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .end local p3    # "splitCodePaths":[Ljava/lang/String;
    ...
    .line 341
    iget-object p1, v0, Lcom/android/server/pm/dex/DexManager;->mPackageDexUsage:Lcom/android/server/pm/dex/PackageDexUsage;

    invoke-virtual {p1, v1}, Lcom/android/server/pm/dex/PackageDexUsage;->clearUsedByOtherApps(Ljava/lang/String;)Z
