...
.method public static getChecksums(Ljava/util/List;IILjava/lang/String;[Ljava/security/cert/Certificate;Landroid/content/pm/IOnChecksumsReadyListener;Lcom/android/server/pm/ApkChecksums$Injector;)V
    ...
    .line 323
    .local v3, "result":Ljava/util/List;, "Ljava/util/List<Ljava/util/Map<Ljava/lang/Integer;Landroid/content/pm/ApkChecksum;>;>;"
    const/4 v0, 0x0
    ...
    .line 327
    .local v9, "checksums":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Landroid/content/pm/ApkChecksum;>;"
    ...
    .end local v9    # "checksums":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Landroid/content/pm/ApkChecksum;>;"
    :goto_1
    add-int/lit8 v2, v2, 0x1
    ...
    invoke-static/range {v2 .. v8}, Lcom/android/server/pm/ApkChecksums;->processRequiredChecksums(Ljava/util/List;Ljava/util/List;ILandroid/content/pm/IOnChecksumsReadyListener;Lcom/android/server/pm/ApkChecksums$Injector;J)V
...
.method private static getInstallerChecksums(Ljava/lang/String;Ljava/io/File;ILjava/lang/String;[Ljava/security/cert/Certificate;Ljava/util/Map;Lcom/android/server/pm/ApkChecksums$Injector;)V
    ...
    invoke-static {v1}, Lcom/android/server/pm/PackageManagerServiceUtils;->isInstalledByAdb(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/android/server/pm/ApkChecksums;->convertToSet([Ljava/security/cert/Certificate;)Ljava/util/Set;
...
.method private static processRequiredChecksums(Ljava/util/List;Ljava/util/List;ILandroid/content/pm/IOnChecksumsReadyListener;Lcom/android/server/pm/ApkChecksums$Injector;J)V
    ...
    .line 351
    .local v9, "allChecksums":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ApkChecksum;>;"
    const/4 v0, 0x0
    ...
    .line 357
    .local v15, "checksums":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Landroid/content/pm/ApkChecksum;>;"
    if-eqz v8, :cond_1
    ...
    :try_start_0
    invoke-static {v14, v3, v15, v5}, Lcom/android/server/pm/ApkChecksums;->needToWait(Ljava/io/File;ILjava/util/Map;Lcom/android/server/pm/ApkChecksums$Injector;)Z
    ...
    .end local v8    # "timeout":Z
    .restart local v16    # "timeout":Z
    invoke-static {v13, v14, v3, v15}, Lcom/android/server/pm/ApkChecksums;->getRequiredApkChecksums(Ljava/lang/String;Ljava/io/File;ILjava/util/Map;)V
    ...
    .end local v15    # "checksums":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Landroid/content/pm/ApkChecksum;>;"
    :goto_5
