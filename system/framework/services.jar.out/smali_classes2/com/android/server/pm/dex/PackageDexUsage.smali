...
.method private clonePackageUseInfoMap()Ljava/util/Map;
    ...
    invoke-direct {v5, v6, v7}, Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;-><init>(Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;Lcom/android/server/pm/dex/PackageDexUsage-IA;)V
...
.method getPackageUseInfo(Ljava/lang/String;)Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    ...
    invoke-direct {v3, v1, v2}, Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;-><init>(Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;Lcom/android/server/pm/dex/PackageDexUsage-IA;)V
...
.method read(Ljava/io/Reader;)V
    ...
    .local v17, "currentPackageData":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    array-length v9, v12
    ...
    .line 394
    .local v9, "isa":Ljava/lang/String;
    ...
    .local v19, "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 400
    .end local v18    # "i":I
    .end local v19    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .restart local v7    # "i":I
    .restart local v8    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_3
    move/from16 v18, v7
    ...
    .restart local v19    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    const-string v11, "Unsupported ISA when parsing PackageDexUsage: "
    ...
    .line 392
    .end local v9    # "isa":Ljava/lang/String;
    :goto_3
    ...
    .restart local v8    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .restart local v11    # "isUsedByOtherApps":Z
    :cond_4
    move/from16 v18, v7
    ...
    .end local v11    # "isUsedByOtherApps":Z
    .restart local v19    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .restart local v20    # "isUsedByOtherApps":Z
    ...
    const-string v9, "Ignore dexPath when parsing PackageDexUsage because of unsupported isas. dexPath="
    ...
    .line 408
    :cond_5
    invoke-static/range {v17 .. v17}, Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;->-$$Nest$fgetmDexUseInfoMap(Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;)Ljava/util/Map;
    ...
    .end local v17    # "currentPackageData":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    .end local v19    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    const-string v8, "Invalid PackageDexUsage line: "
    ...
    .end local v9    # "currentPackageData":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    .restart local v16    # "currentPackage":Ljava/lang/String;
    .restart local v17    # "currentPackageData":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    .restart local v19    # "supportedIsas":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    const-string v0, "+"
    ...
    invoke-static/range {v17 .. v17}, Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;->-$$Nest$fgetmPrimaryCodePaths(Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;)Ljava/util/Map;
...
.method record(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ZLjava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v5}, Lcom/android/server/pm/PackageManagerServiceUtils;->checkISA(Ljava/lang/String;)Z
    ...
    .line 148
    invoke-static {v8, v3, v6}, Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;->-$$Nest$mmergePrimaryCodePaths(Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 152
    .restart local v8    # "packageUseInfo":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    :cond_1
    new-instance v0, Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;

    invoke-direct {v0, v10, v4, v7, v5}, Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;-><init>(ZILjava/lang/String;Ljava/lang/String;)V

    .line 154
    .local v0, "newData":Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;
    ...
    .line 155
    invoke-static {v0}, Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;->-$$Nest$fgetmLoadingPackages(Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;)Ljava/util/Set;
    ...
    .line 158
    .end local v0    # "newData":Lcom/android/server/pm/dex/PackageDexUsage$DexUseInfo;
    :goto_0
    iget-object v0, v1, Lcom/android/server/pm/dex/PackageDexUsage;->mPackageUseInfoMap:Ljava/util/Map;
...
.method syncData(Ljava/util/Map;Ljava/util/Map;Ljava/util/List;)V
    ...
    .local v0, "recordedLoadingPackage":Ljava/lang/String;
    .local v17, "pIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;>;>;"
    ...
    .line 528
    .end local v0    # "recordedLoadingPackage":Ljava/lang/String;
    :cond_5
    ...
    .line 522
    .end local v17    # "pIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;>;>;"
    .local v0, "pIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;>;>;"
    :cond_6
    move-object/from16 v17, v0
    ...
    .restart local v17    # "pIt":Ljava/util/Iterator;, "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;>;>;"
    :goto_4
    move-object/from16 v0, v17
