...
.method freeCacheForInstallation(ILandroid/content/pm/parsing/PackageLite;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v10, v7, v8, v9}, Lcom/android/server/pm/Installer;->freeCache(Ljava/lang/String;JI)V
    ...
    :try_start_2
    invoke-static {v0, p2, p3, v9, v8}, Lcom/android/server/pm/PackageManagerServiceUtils;->getMinimalPackageInfo(Landroid/content/Context;Landroid/content/pm/parsing/PackageLite;Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/PackageInfoLite;
    ...
    iput v10, v0, Landroid/content/pm/PackageInfoLite;->recommendedInstallLocation:I
    ...
    .restart local v2    # "lowThreshold":J
    ...
    const-string v10, "Failed to free cache"
...
.method freeStorage(Ljava/lang/String;JI)V
    ...
    invoke-virtual {v9, v2}, Landroid/os/storage/StorageManager;->findPathForUuid(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v0, v2, v5, v6, v4}, Lcom/android/server/pm/Installer;->freeCache(Ljava/lang/String;JI)V
    :try_end_1
    ...
    .end local v11    # "internalVolume":Z
    .end local v12    # "aggressive":Z
    .end local p0    # "this":Lcom/android/server/pm/FreeStorageHelper;
    ...
    .restart local v11    # "internalVolume":Z
    .restart local v12    # "aggressive":Z
    .restart local p0    # "this":Lcom/android/server/pm/FreeStorageHelper;
    ...
    .line 119
    .local v3, "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    if-eqz v11, :cond_8
    ...
    const-string/jumbo v7, "unused_static_shared_lib_min_cache_period"

    sget-wide v13, Lcom/android/server/pm/FreeStorageHelper;->FREE_STORAGE_UNUSED_STATIC_SHARED_LIB_MIN_CACHE_PERIOD:J

    invoke-static {v0, v7, v13, v14}, Landroid/provider/Settings$Global;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    .end local v3    # "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    .local v13, "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    if-eqz v0, :cond_9
    ...
    .line 119
    .end local v13    # "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    .restart local v3    # "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    :cond_8
    move-object v13, v3

    .line 130
    .end local v3    # "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    .restart local v13    # "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    :cond_9
    ...
    .line 132
    const-string/jumbo v5, "installed_instant_app_min_cache_period"
    ...
    invoke-virtual {v0, v2, v5, v6, v7}, Lcom/android/server/pm/Installer;->freeCache(Ljava/lang/String;JI)V
    :try_end_6
    ...
    .end local v4    # "computer":Lcom/android/server/pm/Computer;
    .end local v9    # "storage":Landroid/os/storage/StorageManager;
    .end local v10    # "file":Ljava/io/File;
    .end local v11    # "internalVolume":Z
    .end local v12    # "aggressive":Z
    ...
    .line 147
    .end local v3    # "installLock":Lcom/android/server/pm/PackageManagerTracedLock;
    .restart local v4    # "computer":Lcom/android/server/pm/Computer;
    .restart local v9    # "storage":Landroid/os/storage/StorageManager;
    .restart local v10    # "file":Ljava/io/File;
    .restart local v11    # "internalVolume":Z
    .restart local v12    # "aggressive":Z
    ...
    .line 155
    const-string/jumbo v7, "uninstalled_instant_app_min_cache_period"

    invoke-static {v0, v7, v14, v15}, Landroid/provider/Settings$Global;->getLong(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    .line 169
    invoke-virtual {v0, v2, v7, v8}, Landroid/os/storage/StorageManagerInternal;->freeCache(Ljava/lang/String;J)V

    .line 173
    :cond_10
    iget-object v3, v1, Lcom/android/server/pm/FreeStorageHelper;->mPm:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/pm/PackageInstallerService;->freeStageDirs(Ljava/lang/String;)V

    .line 174
    .end local v0    # "smInternal":Landroid/os/storage/StorageManagerInternal;
    .end local v4    # "computer":Lcom/android/server/pm/Computer;
    .end local v7    # "freeBytesRequired":J
    .end local v11    # "internalVolume":Z
    .end local v12    # "aggressive":Z
    .end local v13    # "sharedLibraries":Lcom/android/server/pm/SharedLibrariesImpl;
    goto :goto_9
    ...
    invoke-virtual {v0, v2, v5, v6, v3}, Lcom/android/server/pm/Installer;->freeCache(Ljava/lang/String;JI)V
    :try_end_b
