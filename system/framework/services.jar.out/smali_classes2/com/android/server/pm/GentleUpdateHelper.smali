...
.method private synthetic lambda$checkInstallConstraints$2(Ljava/util/List;Landroid/content/pm/PackageInstaller$InstallConstraints;Ljava/util/concurrent/CompletableFuture;J)V
    ...
    .end local p1    # "packageNames":Ljava/util/List;
    .end local p2    # "constraints":Landroid/content/pm/PackageInstaller$InstallConstraints;
    .end local p3    # "resultFuture":Ljava/util/concurrent/CompletableFuture;
    .end local p4    # "timeoutMillis":J
    .local v1, "packageNames":Ljava/util/List;
    .local v2, "constraints":Landroid/content/pm/PackageInstaller$InstallConstraints;
    .local v3, "resultFuture":Ljava/util/concurrent/CompletableFuture;
    ...
    .line 170
    .local p1, "deviceIdleFuture":Ljava/util/concurrent/CompletableFuture;, "Ljava/util/concurrent/CompletableFuture<Ljava/lang/Boolean;>;"
    :goto_0
    new-instance p2, Lcom/android/server/pm/GentleUpdateHelper$$ExternalSyntheticLambda2;

    invoke-direct {p2, p0, v0}, Lcom/android/server/pm/GentleUpdateHelper$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/pm/GentleUpdateHelper;Lcom/android/server/pm/GentleUpdateHelper$PendingInstallConstraintsCheck;)V
...
.method checkInstallConstraints(Ljava/util/List;Landroid/content/pm/PackageInstaller$InstallConstraints;J)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 165
    .local v5, "resultFuture":Ljava/util/concurrent/CompletableFuture;, "Ljava/util/concurrent/CompletableFuture<Landroid/content/pm/PackageInstaller$InstallConstraintsResult;>;"
    iget-object v0, p0, Lcom/android/server/pm/GentleUpdateHelper;->mHandler:Landroid/os/Handler;

    new-instance v1, Lcom/android/server/pm/GentleUpdateHelper$$ExternalSyntheticLambda6;
