...
.method private collectDomains(Lcom/android/server/pm/pkg/AndroidPackage;ZZ)Landroid/util/ArraySet;
    ...
    .line 142
    .local v5, "domains":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    ...
    .end local p2    # "checkAutoVerify":Z
    .end local p3    # "valid":Z
    .local v2, "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .local v3, "checkAutoVerify":Z
    .local v4, "valid":Z
...
.method private collectDomainsInternal(Lcom/android/server/pm/pkg/AndroidPackage;ZZLjava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v3, v15}, Ljava/util/function/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private collectDomainsLegacy(Lcom/android/server/pm/pkg/AndroidPackage;ZZLjava/lang/Object;Ljava/util/function/BiFunction;)Ljava/lang/Object;
    ...
    invoke-interface {v6}, Lcom/android/internal/pm/pkg/component/ParsedActivity;->getIntents()Ljava/util/List;
    ...
    .line 212
    invoke-virtual {v13, v4}, Landroid/content/IntentFilter;->getDataAuthority(I)Landroid/content/IntentFilter$AuthorityEntry;
    ...
    .end local v1    # "activities":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
    ...
    invoke-interface {v0, v6, v14}, Ljava/util/function/BiFunction;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v19

    .line 217
    .local v19, "returnValue":Ljava/lang/Object;, "TReturnValue;"
    if-eqz v19, :cond_5
    ...
    .end local v19    # "returnValue":Ljava/lang/Object;, "TReturnValue;"
    .restart local v6    # "underMaxSize":Z
    :cond_6
    move-object/from16 v0, p5
    ...
    .local v1, "activities":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
    .restart local v2    # "activitiesSize":I
    :cond_7
    move-object/from16 v0, p5
    ...
    .end local v17    # "activities":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
    .end local v18    # "activitiesSize":I
    .restart local v1    # "activities":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
    .restart local v2    # "activitiesSize":I
    :cond_8
    move-object/from16 v0, p5
