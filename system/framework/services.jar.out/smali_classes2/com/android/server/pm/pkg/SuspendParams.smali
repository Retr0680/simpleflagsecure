...
.method public static restoreFromXml(Lcom/android/modules/utils/TypedXmlPullParser;)Lcom/android/server/pm/pkg/SuspendParams;
    ...
    .line 165
    .end local v3    # "readLauncherExtras":Landroid/os/PersistableBundle;
    .local v7, "readLauncherExtras":Landroid/os/PersistableBundle;
    move-object v3, v7

    goto :goto_4

    .line 161
    .end local v7    # "readLauncherExtras":Landroid/os/PersistableBundle;
    .restart local v3    # "readLauncherExtras":Landroid/os/PersistableBundle;
    :pswitch_1
    invoke-static {p0}, Landroid/os/PersistableBundle;->restoreFromXml(Lcom/android/modules/utils/TypedXmlPullParser;)Landroid/os/PersistableBundle;
    ...
    .line 162
    .end local v2    # "readAppExtras":Landroid/os/PersistableBundle;
    .local v7, "readAppExtras":Landroid/os/PersistableBundle;
    move-object v2, v7

    goto :goto_4

    .line 158
    .end local v7    # "readAppExtras":Landroid/os/PersistableBundle;
    .restart local v2    # "readAppExtras":Landroid/os/PersistableBundle;
    :pswitch_2
    ...
    .line 159
    .end local v1    # "readDialogInfo":Landroid/content/pm/SuspendDialogInfo;
    .local v7, "readDialogInfo":Landroid/content/pm/SuspendDialogInfo;
    move-object v1, v7

    .line 170
    .end local v7    # "readDialogInfo":Landroid/content/pm/SuspendDialogInfo;
    .restart local v1    # "readDialogInfo":Landroid/content/pm/SuspendDialogInfo;
    :goto_4
    goto :goto_0
