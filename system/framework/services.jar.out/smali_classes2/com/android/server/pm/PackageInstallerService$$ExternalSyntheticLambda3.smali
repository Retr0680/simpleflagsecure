...
.method public synthetic constructor <init>(Lcom/android/server/pm/PackageInstallerService;Ljava/util/List;Landroid/content/pm/PackageInstaller$InstallConstraints;Landroid/content/IntentSender;)V
    ...
    iput-object p2, p0, Lcom/android/server/pm/PackageInstallerService$$ExternalSyntheticLambda3;->f$1:Ljava/util/List;

    iput-object p3, p0, Lcom/android/server/pm/PackageInstallerService$$ExternalSyntheticLambda3;->f$2:Landroid/content/pm/PackageInstaller$InstallConstraints;

    iput-object p4, p0, Lcom/android/server/pm/PackageInstallerService$$ExternalSyntheticLambda3;->f$3:Landroid/content/IntentSender;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/android/server/pm/PackageInstallerService$$ExternalSyntheticLambda3;->f$1:Ljava/util/List;

    iget-object v2, p0, Lcom/android/server/pm/PackageInstallerService$$ExternalSyntheticLambda3;->f$2:Landroid/content/pm/PackageInstaller$InstallConstraints;

    iget-object v3, p0, Lcom/android/server/pm/PackageInstallerService$$ExternalSyntheticLambda3;->f$3:Landroid/content/IntentSender;

    check-cast p1, Landroid/content/pm/PackageInstaller$InstallConstraintsResult;

    invoke-static {v0, v1, v2, v3, p1}, Lcom/android/server/pm/PackageInstallerService;->$r8$lambda$mF4Pn7tOjO0TfGLhqagHksstTYE(Lcom/android/server/pm/PackageInstallerService;Ljava/util/List;Landroid/content/pm/PackageInstaller$InstallConstraints;Landroid/content/IntentSender;Landroid/content/pm/PackageInstaller$InstallConstraintsResult;)V
