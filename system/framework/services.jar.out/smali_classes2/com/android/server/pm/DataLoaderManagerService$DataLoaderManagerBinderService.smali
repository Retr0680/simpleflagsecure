...
.method private synthetic lambda$bindToDataLoader$0(Landroid/content/Intent;Lcom/android/server/pm/DataLoaderManagerService$DataLoaderServiceConnection;Landroid/content/ComponentName;I)V
    ...
    .end local p2    # "connection":Lcom/android/server/pm/DataLoaderManagerService$DataLoaderServiceConnection;
    .local v2, "intent":Landroid/content/Intent;
    .local v3, "connection":Lcom/android/server/pm/DataLoaderManagerService$DataLoaderServiceConnection;
...
.method public bindToDataLoader(ILandroid/content/pm/DataLoaderParamsParcel;JLandroid/content/pm/IDataLoaderStatusListener;)Z
    ...
    iget-object v2, p2, Landroid/content/pm/DataLoaderParamsParcel;->className:Ljava/lang/String;
    ...
    .line 83
    .local v5, "dataLoaderComponent":Landroid/content/ComponentName;
    if-nez v5, :cond_1
    ...
    invoke-direct {v4, v1, p1, p5}, Lcom/android/server/pm/DataLoaderManagerService$DataLoaderServiceConnection;-><init>(Lcom/android/server/pm/DataLoaderManagerService;ILandroid/content/pm/IDataLoaderStatusListener;)V
    ...
    new-instance v1, Lcom/android/server/pm/DataLoaderManagerService$DataLoaderManagerBinderService$$ExternalSyntheticLambda0;
    ...
    invoke-virtual {v7, v1, p3, p4}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z
    ...
    .end local v5    # "dataLoaderComponent":Landroid/content/ComponentName;
    .end local v6    # "dataLoaderId":I
    ...
    .end local p1    # "dataLoaderId":I
    .restart local v6    # "dataLoaderId":I
    :goto_0
    :try_start_3
    monitor-exit v1
    :try_end_3
