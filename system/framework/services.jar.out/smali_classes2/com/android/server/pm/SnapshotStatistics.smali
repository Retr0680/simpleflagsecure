...
.method public dump(Ljava/io/PrintWriter;Ljava/lang/String;JIZ)V
    ...
    .line 648
    iget-object v2, p0, Lcom/android/server/pm/SnapshotStatistics;->mLock:Ljava/lang/Object;
    ...
    check-cast v6, [Lcom/android/server/pm/SnapshotStatistics$Stats;

    .line 650
    .local v6, "l":[Lcom/android/server/pm/SnapshotStatistics$Stats;
    new-instance v0, Lcom/android/server/pm/SnapshotStatistics$Stats;
    ...
    invoke-direct {v0, p0, v4, v5}, Lcom/android/server/pm/SnapshotStatistics$Stats;-><init>(Lcom/android/server/pm/SnapshotStatistics;Lcom/android/server/pm/SnapshotStatistics$Stats;Lcom/android/server/pm/SnapshotStatistics-IA;)V
    ...
    check-cast v7, [Lcom/android/server/pm/SnapshotStatistics$Stats;

    .line 652
    .local v7, "s":[Lcom/android/server/pm/SnapshotStatistics$Stats;
    new-instance v0, Lcom/android/server/pm/SnapshotStatistics$Stats;
    ...
    invoke-virtual {p1, v0, v2, v3}, Ljava/io/PrintWriter;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    ...
    .line 653
    .end local v6    # "l":[Lcom/android/server/pm/SnapshotStatistics$Stats;
    .end local v7    # "s":[Lcom/android/server/pm/SnapshotStatistics$Stats;
    :catchall_0
    move-exception v0
...
.method public final rebuild(JJII)V
    ...
    .line 563
    .local v7, "reportEvent":Z
    iget-object v8, p0, Lcom/android/server/pm/SnapshotStatistics;->mLock:Ljava/lang/Object;
    ...
    :try_start_0
    iput v9, p0, Lcom/android/server/pm/SnapshotStatistics;->mPackageCount:I
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/pm/SnapshotStatistics$BinMap;->getBin(I)I
    ...
    .local v6, "quick":Z
    :goto_1
    iget-object v5, p0, Lcom/android/server/pm/SnapshotStatistics;->mShort:[Lcom/android/server/pm/SnapshotStatistics$Stats;
    ...
    iput v10, p0, Lcom/android/server/pm/SnapshotStatistics;->mEventsReported:I
    ...
    .line 578
    .end local v3    # "timeBin":I
    .end local v4    # "useBin":I
    .end local v5    # "big":Z
    .end local v6    # "quick":Z
    :catchall_0
    move-exception v0
    ...
    invoke-static {v0, v2}, Lcom/android/server/EventLogTags;->writePmSnapshotRebuild(II)V
