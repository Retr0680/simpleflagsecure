...
.method synthetic constructor <init>(Lcom/android/server/pm/SnapshotStatistics;JLcom/android/server/pm/SnapshotStatistics-IA;)V
    .locals 0
...
.method synthetic constructor <init>(Lcom/android/server/pm/SnapshotStatistics;Lcom/android/server/pm/SnapshotStatistics$Stats;Lcom/android/server/pm/SnapshotStatistics-IA;)V
    .locals 0
...
.method private dumpStats(Ljava/io/PrintWriter;Ljava/lang/String;JZ)V
    ...
    const-string v7, "TotTime"

    const-string v8, "MaxTime"

    const-string v3, "TotBlds"

    const-string v4, "TotUsed"

    const-string v5, "BigBlds"

    const-string v6, "ShortLvd"

    filled-new-array/range {v3 .. v8}, [Ljava/lang/Object;

    move-result-object v3

    const-string v4, "  %10s  %10s  %10s  %10s  %10s  %10s"
    ...
    iget v3, p0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mTotalBuilds:I
    ...
    iget v3, p0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mBigBuilds:I
    ...
    iget-wide v8, p0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mTotalTimeUs:J
    ...
    iget v3, p0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mMaxBuildTimeUs:I
    ...
    .line 401
    const-string v4, "  %10d  %10d  %10d  %10d  %10d  %10d"
...
.method private dumpTimes(Ljava/io/PrintWriter;Ljava/lang/String;JZ)V
    ...
    invoke-static {v6, p5}, Landroid/text/TextUtils;->formatSimple(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 417
    invoke-virtual {v1, p3, p4, p5}, Ljava/io/PrintWriter;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    ...
    .line 420
    invoke-virtual {v1, p2, p4, p3}, Ljava/io/PrintWriter;->format(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/PrintWriter;
    ...
    .local p1, "i":I
    :goto_1
    iget-object p2, v0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mTimes:[I
    ...
    iget-object p3, v0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mTimes:[I
...
.method private dumpUsage(Ljava/io/PrintWriter;Ljava/lang/String;JZ)V
    ...
    .local p1, "i":I
    :goto_1
    iget-object p2, v0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mUsed:[I
    ...
    iget-object p3, v0, Lcom/android/server/pm/SnapshotStatistics$Stats;->mUsed:[I
