...
.method waitAppProcessGone(Landroid/app/ActivityManagerInternal;Lcom/android/server/pm/Computer;Lcom/android/server/pm/UserManagerService;Ljava/lang/String;)V
    ...
    .end local p2    # "snapshot":Lcom/android/server/pm/Computer;
    ...
    .restart local v0    # "users":[I
    .restart local v1    # "i":I
    .restart local p2    # "snapshot":Lcom/android/server/pm/Computer;
    .restart local p4    # "packageName":Ljava/lang/String;
    :cond_2
    move-object v3, p2
    ...
    .restart local v4    # "packageName":Ljava/lang/String;
    :goto_2
    iget-object p2, p0, Lcom/android/server/pm/KillAppBlocker;->mActiveUids:Ljava/util/List;
    ...
    .line 113
    :try_start_2
    iget-object p2, p0, Lcom/android/server/pm/KillAppBlocker;->mUidsGoneCountDownLatch:Ljava/util/concurrent/CountDownLatch;

    sget-object p4, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    const-wide/16 v0, 0x3e8

    invoke-virtual {p2, v0, v1, p4}, Ljava/util/concurrent/CountDownLatch;->await(JLjava/util/concurrent/TimeUnit;)Z
    :try_end_2
