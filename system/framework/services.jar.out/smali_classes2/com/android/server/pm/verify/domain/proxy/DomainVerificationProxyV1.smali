...
.method public static queueLegacyVerifyResult(Landroid/content/Context;Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxyV1$Connection;IILjava/util/List;I)V
    ...
    .end local p2    # "verificationId":I
    .end local p3    # "verificationCode":I
    .end local p4    # "failedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local p5    # "callingUid":I
    .local v3, "callingUid":I
    .local v4, "verificationId":I
    .local v5, "verificationCode":I
    .local v6, "failedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    invoke-interface {p1, p2, v2}, Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxy$BaseConnection;->schedule(ILjava/lang/Object;)V
...
.method private sendBroadcasts(Landroid/util/ArrayMap;)V
    ...
    .end local v2    # "allowListTimeout":J
    ...
    iget-object v1, p0, Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxyV1;->mConnection:Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxyV1$Connection;

    invoke-interface {v1, v9}, Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxyV1$Connection;->getPackage(Ljava/lang/String;)Lcom/android/server/pm/pkg/AndroidPackage;
    ...
    .line 265
    :cond_0
    invoke-direct {p0, v10}, Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxyV1;->buildHostsString(Lcom/android/server/pm/pkg/AndroidPackage;)Ljava/lang/String;

    move-result-object v11

    .line 267
    .local v11, "hostsString":Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/pm/verify/domain/proxy/DomainVerificationProxyV1;->mVerifierComponent:Landroid/content/ComponentName;
    ...
    .restart local v2    # "allowListTimeout":J
    const/16 v5, 0x133
    ...
    invoke-virtual {v2, v12, v3, v6, v13}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;Landroid/os/Bundle;)V

    .line 252
    .end local v1    # "options":Landroid/app/BroadcastOptions;
    .end local v8    # "verificationId":I
    .end local v9    # "packageName":Ljava/lang/String;
    .end local v10    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .end local v11    # "hostsString":Ljava/lang/String;
