...
.method removeDistractingPackageRestrictions(Lcom/android/server/pm/Computer;[Ljava/lang/String;I)V
    ...
    new-instance v3, Lcom/android/server/pm/DistractingPackageHelper$$ExternalSyntheticLambda2;

    invoke-direct {v3, v0, p3}, Lcom/android/server/pm/DistractingPackageHelper$$ExternalSyntheticLambda2;-><init>(Ljava/util/List;I)V
    ...
    .local v7, "userId":I
    invoke-virtual/range {v3 .. v8}, Lcom/android/server/pm/BroadcastHelper;->sendDistractingPackagesChanged(Ljava/util/function/Supplier;[Ljava/lang/String;[III)V

    .line 203
    iget-object p3, p0, Lcom/android/server/pm/DistractingPackageHelper;->mPm:Lcom/android/server/pm/PackageManagerService;

    invoke-virtual {p3, v7}, Lcom/android/server/pm/PackageManagerService;->scheduleWritePackageRestrictions(I)V
...
.method setDistractingPackageRestrictionsAsUser(Lcom/android/server/pm/Computer;[Ljava/lang/String;III)[Ljava/lang/String;
    ...
    .line 75
    invoke-virtual {v4, v1, v7, v9}, Lcom/android/server/pm/SuspendPackageHelper;->isSuspendAllowedForUser(Lcom/android/server/pm/Computer;II)Z
    ...
    .line 82
    .local v10, "changedPackagesList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 85
    .local v12, "unactionedPackages":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 86
    .local v13, "changesToCommit":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    if-eqz v8, :cond_2
    ...
    invoke-virtual {v5, v1, v2, v7, v9}, Lcom/android/server/pm/SuspendPackageHelper;->canSuspendPackageForUser(Lcom/android/server/pm/Computer;[Ljava/lang/String;II)[Z
    ...
    .line 92
    invoke-interface {v1, v6, v9, v7}, Lcom/android/server/pm/Computer;->getPackageStateForInstalledAndFiltered(Ljava/lang/String;II)Lcom/android/server/pm/pkg/PackageStateInternal;
    ...
    .line 107
    .local v1, "oldDistractionFlags":I
    if-eq v8, v1, :cond_5
    ...
    invoke-static {v7, v4}, Landroid/os/UserHandle;->getUid(II)I

    move-result v4

    invoke-virtual {v11, v4}, Landroid/util/IntArray;->add(I)V

    .line 110
    invoke-virtual {v13, v6}, Landroid/util/ArraySet;->add(Ljava/lang/Object;)Z

    .line 89
    .end local v1    # "oldDistractionFlags":I
    ...
    invoke-direct {v3, v13, v7, v8}, Lcom/android/server/pm/DistractingPackageHelper$$ExternalSyntheticLambda0;-><init>(Landroid/util/ArraySet;II)V

    const/4 v4, 0x0

    invoke-virtual {v1, v4, v3}, Lcom/android/server/pm/PackageManagerService;->commitPackageStateMutation(Lcom/android/server/pm/pkg/mutate/PackageStateMutator$InitialState;Ljava/util/function/Consumer;)Lcom/android/server/pm/pkg/mutate/PackageStateMutator$Result;
