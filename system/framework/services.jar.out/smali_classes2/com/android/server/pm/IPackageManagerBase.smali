...
.method public final addCrossProfileIntentFilter(Landroid/content/IntentFilter;Ljava/lang/String;III)V
    ...
    .end local p2    # "ownerPackage":Ljava/lang/String;
...
.method public final getInstalledApplications(JI)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {v6, p1}, Landroid/content/pm/ParceledListSlice;-><init>(Ljava/util/List;)V
...
.method public final getPropertyAsUser(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Landroid/content/pm/PackageManager$Property;
    ...
    .line 718
    .local p4, "packageState":Lcom/android/server/pm/pkg/PackageStateInternal;
    if-nez p4, :cond_0
    ...
    .line 721
    :cond_0
    iget-object v3, p0, Lcom/android/server/pm/IPackageManagerBase;->mPackageProperty:Lcom/android/server/pm/PackageProperty;

    invoke-virtual {v3, p1, p2, p3}, Lcom/android/server/pm/PackageProperty;->getProperty(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/content/pm/PackageManager$Property;
...
.method public final performDexOptMode(Ljava/lang/String;ZLjava/lang/String;ZZLjava/lang/String;)Z
    ...
    const-string v2, "Ignored checkProfiles=false flag"
...
.method public final queryContentProviders(Ljava/lang/String;IJLjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    .end local p5    # "metaDataKey":Ljava/lang/String;
...
.method public final setLastChosenActivity(Landroid/content/Intent;Ljava/lang/String;ILandroid/content/IntentFilter;ILandroid/content/ComponentName;)V
    ...
    .end local p5    # "match":I
    .end local p6    # "activity":Landroid/content/ComponentName;
    .local v2, "intent":Landroid/content/Intent;
    .local v3, "resolvedType":Ljava/lang/String;
    .local v4, "flags":I
    .local v6, "match":I
...
.method public final verifyIntentFilter(IILjava/util/List;)V
    ...
    .end local p1    # "id":I
    .end local p2    # "verificationCode":I
    .end local p3    # "failedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v2, "id":I
    .local v3, "verificationCode":I
    .local v4, "failedDomains":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
