...
.method constructor <init>(Lcom/android/server/pm/Installer;Lcom/android/server/pm/PackageManagerTracedLock;Landroid/content/Context;Ljava/lang/String;)V
    ...
    .end local p4    # "wakeLockTag":Ljava/lang/String;
    .local v2, "installer":Lcom/android/server/pm/Installer;
    .local v3, "installLock":Lcom/android/server/pm/PackageManagerTracedLock;
    .local v4, "context":Landroid/content/Context;
    .local v5, "wakeLockTag":Ljava/lang/String;
...
.method private dexOptPath(Lcom/android/server/pm/pkg/AndroidPackage;Lcom/android/server/pm/pkg/PackageStateInternal;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;IILcom/android/server/pm/CompilerStats$PackageStats;ZLjava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-direct {v1, v12, v11}, Lcom/android/server/pm/PackageDexOptimizer;->getPackageOatDirIfSupported(Lcom/android/server/pm/pkg/PackageState;Lcom/android/server/pm/pkg/AndroidPackage;)Ljava/lang/String;
    ...
    invoke-direct {v1, v9}, Lcom/android/server/pm/PackageDexOptimizer;->printDexoptFlags(I)Ljava/lang/String;
    ...
    invoke-interface {v12}, Lcom/android/server/pm/pkg/PackageState;->getSeInfo()Ljava/lang/String;
    ...
    .end local v2    # "dexoptNeeded":I
    .local v7, "dexoptNeeded":I
    :try_start_1
    invoke-direct {v1}, Lcom/android/server/pm/PackageDexOptimizer;->getInstallerLI()Lcom/android/server/pm/Installer;
    ...
    invoke-direct {v1, v14, v4}, Lcom/android/server/pm/PackageDexOptimizer;->getAugmentedReasonName(IZ)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3, v9, v10}, Lcom/android/server/pm/CompilerStats$PackageStats;->setCompileTime(Ljava/lang/String;J)V
    :try_end_2
    ...
    :try_start_3
    iget-object v5, v4, Lcom/android/server/pm/PackageDexOptimizer;->mContext:Landroid/content/Context;
    ...
    invoke-static {v5, v6}, Lcom/android/internal/content/F2fsUtils;->releaseCompressedBlocks(Landroid/content/ContentResolver;Ljava/io/File;)V
    :try_end_3
...
.method private getDexFlags(Landroid/content/pm/ApplicationInfo;Ljava/lang/String;Lcom/android/server/pm/dex/DexoptOptions;)I
    ...
    .end local p3    # "options":Lcom/android/server/pm/dex/DexoptOptions;
    .local v6, "compilerFilter":Ljava/lang/String;
    .local v8, "options":Lcom/android/server/pm/dex/DexoptOptions;
...
.method private getDexFlags(Lcom/android/server/pm/pkg/AndroidPackage;Lcom/android/server/pm/pkg/PackageStateInternal;Ljava/lang/String;ZLcom/android/server/pm/dex/DexoptOptions;)I
    ...
    .end local p3    # "compilerFilter":Ljava/lang/String;
    .end local p4    # "useCloudProfile":Z
    .end local p5    # "options":Lcom/android/server/pm/dex/DexoptOptions;
    .local v5, "compilerFilter":Ljava/lang/String;
    .local v6, "useCloudProfile":Z
    .local v7, "options":Lcom/android/server/pm/dex/DexoptOptions;
...
.method private getDexoptNeeded(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IZILjava/lang/String;)I
    ...
    .line 732
    .local v11, "isProfileGuidedFilter":Z
    if-ne v8, v4, :cond_2

    move v3, v4

    .line 734
    .local v3, "newProfile":Z
    :cond_2
    if-nez v3, :cond_3
    ...
    .end local v3    # "newProfile":Z
    .local v0, "newProfile":Z
    invoke-direct {v1, v12, v2, v3, v13}, Lcom/android/server/pm/PackageDexOptimizer;->isOdexPrivate(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 752
    .end local v3    # "newProfile":Z
    .restart local v0    # "newProfile":Z
    :cond_4
    move v6, v0

    .end local v0    # "newProfile":Z
    .local v6, "newProfile":Z
    :goto_2
    ...
    :try_start_0
    invoke-direct {v1, v15}, Lcom/android/server/pm/PackageDexOptimizer;->compilerFilterDependsOnProfiles(Ljava/lang/String;)Z
    ...
    .end local v0    # "actualCompilerFilter":Ljava/lang/String;
    .local v4, "actualCompilerFilter":Ljava/lang/String;
    :goto_3
    move-object/from16 v5, p5
    ...
    .line 765
    .end local v4    # "actualCompilerFilter":Ljava/lang/String;
    ...
    invoke-static {v9, v3, v0}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .end local v6    # "newProfile":Z
    .end local v10    # "shouldBePublic":Z
    .end local v11    # "isProfileGuidedFilter":Z
    :cond_6
    move-object/from16 v12, p1
...
.method private performDexOptLI(Lcom/android/server/pm/pkg/AndroidPackage;Lcom/android/server/pm/pkg/PackageStateInternal;[Ljava/lang/String;Lcom/android/server/pm/CompilerStats$PackageStats;Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;Lcom/android/server/pm/dex/DexoptOptions;)I
    ...
    .line 259
    .local v7, "sharedLibraries":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/SharedLibraryInfo;>;"
    if-eqz p3, :cond_0
    ...
    .line 277
    .local v12, "pathsWithCode":[Z
    invoke-interface {v2}, Lcom/android/server/pm/pkg/AndroidPackage;->isDeclaredHavingCode()Z

    move-result v0

    const/16 v17, 0x0

    aput-boolean v0, v12, v17
    ...
    .line 279
    invoke-interface {v2}, Lcom/android/server/pm/pkg/AndroidPackage;->getSplitFlags()[I
    ...
    .line 281
    .end local v0    # "i":I
    invoke-static {v2, v7, v12}, Lcom/android/server/pm/dex/DexoptUtils;->getClassLoaderContexts(Lcom/android/server/pm/pkg/AndroidPackage;Ljava/util/List;[Z)[Ljava/lang/String;
    ...
    const-string v5, "Inconsistent information between AndroidPackage and its ApplicationInfo. pkg.getAllCodePaths="

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v5, " pkg.getBaseCodePath="
    ...
    const-string v5, " pkg.getSplitCodePaths="
    ...
    :cond_8
    invoke-interface {v2}, Lcom/android/server/pm/pkg/AndroidPackage;->getSplitNames()[Ljava/lang/String;
    ...
    .line 330
    .end local v5    # "isUsedByOtherApps":Z
    :cond_9
    const/4 v5, 0x0
    ...
    .line 333
    .local v32, "isUsedByOtherApps":Z
    :goto_8
    invoke-virtual/range {p6 .. p6}, Lcom/android/server/pm/dex/DexoptOptions;->getCompilerFilter()Ljava/lang/String;

    move-result-object v5

    invoke-direct {v1, v2, v5}, Lcom/android/server/pm/PackageDexOptimizer;->getRealCompilerFilter(Lcom/android/server/pm/pkg/AndroidPackage;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 343
    .local v10, "dexMetadataFile":Ljava/io/File;
    if-nez v10, :cond_d
    ...
    .local v10, "dexMetadataPath":Ljava/lang/String;
    :goto_c
    const/4 v0, 0x2
    ...
    .line 353
    invoke-direct {v1, v2, v11, v4, v5}, Lcom/android/server/pm/PackageDexOptimizer;->analyseProfiles(Lcom/android/server/pm/pkg/AndroidPackage;ILjava/lang/String;Ljava/lang/String;)I
    ...
    .local v19, "profileAnalysisResult":I
    :goto_d
    const/16 v21, 0x0
    ...
    .local v5, "cloudProfileName":Ljava/lang/String;
    :try_start_2
    invoke-direct {v1, v2, v5, v3, v10}, Lcom/android/server/pm/PackageDexOptimizer;->prepareCloudProfile(Lcom/android/server/pm/pkg/AndroidPackage;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .end local v5    # "cloudProfileName":Ljava/lang/String;
    ...
    .end local v3    # "path":Ljava/lang/String;
    .end local v6    # "useCloudProfile":Z
    .local v5, "useCloudProfile":Z
    ...
    .end local v5    # "useCloudProfile":Z
    ...
    :try_start_5
    aget-object v30, v8, v2
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_b

    .line 382
    .local v30, "dexCodeIsa":Ljava/lang/String;
    move-object v3, v8
    ...
    .end local v12    # "pathsWithCode":[Z
    .local v5, "pathsWithCode":[Z
    :try_start_7
    ...
    .local v36, "dexCodeInstructionSets":[Ljava/lang/String;
    .local v37, "paths":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v39, "pathsWithCode":[Z
    ...
    .local v26, "dexMetadataPath":Ljava/lang/String;
    .local v28, "newResult":I
    .restart local v30    # "dexCodeIsa":Ljava/lang/String;
    if-eqz v11, :cond_11
    ...
    iget-object v2, v1, Lcom/android/server/pm/PackageDexOptimizer;->mArtStatsLogger:Lcom/android/server/pm/dex/ArtStatsLogUtils$ArtStatsLogger;
    ...
    .line 396
    invoke-virtual {v11, v4}, Lcom/android/server/pm/CompilerStats$PackageStats;->getCompileTime(Ljava/lang/String;)J
    ...
    .line 400
    invoke-static {v4, v3, v5}, Lcom/android/server/pm/dex/ArtStatsLogUtils;->getApkType(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 405
    .end local v4    # "compilerFilter":Ljava/lang/String;
    .restart local v9    # "dexoptFlags":I
    .restart local v22    # "compilerFilter":Ljava/lang/String;
    .restart local v28    # "newResult":I
    .restart local v30    # "dexCodeIsa":Ljava/lang/String;
    :catchall_4
    move-exception v0
    ...
    .end local v22    # "compilerFilter":Ljava/lang/String;
    .end local v28    # "newResult":I
    .restart local v2    # "newResult":I
    .restart local v4    # "compilerFilter":Ljava/lang/String;
    goto :goto_11
    ...
    .end local v26    # "dexMetadataPath":Ljava/lang/String;
    .end local v31    # "path":Ljava/lang/String;
    .end local v32    # "isUsedByOtherApps":Z
    .end local v33    # "cloudProfileName":Ljava/lang/String;
    ...
    .end local v36    # "dexCodeInstructionSets":[Ljava/lang/String;
    .end local v37    # "paths":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v39    # "pathsWithCode":[Z
    ...
    .restart local v26    # "dexMetadataPath":Ljava/lang/String;
    .restart local v32    # "isUsedByOtherApps":Z
    .restart local v33    # "cloudProfileName":Ljava/lang/String;
    ...
    .restart local v36    # "dexCodeInstructionSets":[Ljava/lang/String;
    .restart local v37    # "paths":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v39    # "pathsWithCode":[Z
    ...
    .end local v40    # "classLoaderContexts":[Ljava/lang/String;
    .end local v41    # "i":I
    .restart local v3    # "dexCodeInstructionSets":[Ljava/lang/String;
    .local v5, "pathsWithCode":[Z
    .local v6, "i":I
    .local v9, "paths":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v10, "dexMetadataPath":Ljava/lang/String;
    .restart local v11    # "sharedGid":I
    .local v13, "classLoaderContexts":[Ljava/lang/String;
    .restart local v19    # "profileName":Ljava/lang/String;
    .restart local v21    # "sharedLibraries":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/SharedLibraryInfo;>;"
    :catchall_8
    move-exception v0
    ...
    .end local v41    # "i":I
    .restart local v3    # "dexCodeInstructionSets":[Ljava/lang/String;
    .restart local v5    # "pathsWithCode":[Z
    ...
    .local v10, "dexMetadataPath":Ljava/lang/String;
    .restart local v11    # "sharedGid":I
    .restart local v12    # "pathsWithCode":[Z
    .local v13, "classLoaderContexts":[Ljava/lang/String;
    .restart local v15    # "i":I
    .restart local v19    # "profileName":Ljava/lang/String;
    .restart local v21    # "sharedLibraries":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/SharedLibraryInfo;>;"
    ...
    .end local v40    # "classLoaderContexts":[Ljava/lang/String;
    .end local v41    # "i":I
    .restart local v8    # "dexCodeInstructionSets":[Ljava/lang/String;
    .restart local v9    # "paths":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v10, "dexMetadataPath":Ljava/lang/String;
    .restart local v11    # "sharedGid":I
    .restart local v12    # "pathsWithCode":[Z
    ...
    .end local v40    # "classLoaderContexts":[Ljava/lang/String;
    .end local v41    # "i":I
    .restart local v1    # "dexoptFlags":I
    .restart local v8    # "dexCodeInstructionSets":[Ljava/lang/String;
    .restart local v9    # "paths":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v10, "dexMetadataPath":Ljava/lang/String;
    .restart local v11    # "sharedGid":I
    ...
    .end local v11    # "sharedGid":I
    .end local v12    # "pathsWithCode":[Z
    .end local v13    # "classLoaderContexts":[Ljava/lang/String;
    .end local v15    # "i":I
    .end local v33    # "cloudProfileName":Ljava/lang/String;
    .local v4, "profileName":Ljava/lang/String;
    .local v5, "compilerFilter":Ljava/lang/String;
    ...
    .end local v6    # "i":I
    .end local v10    # "sharedGid":I
    .end local v19    # "profileAnalysisResult":I
    .end local v21    # "cloudProfileName":Ljava/lang/String;
    .end local v26    # "dexMetadataPath":Ljava/lang/String;
    .end local v31    # "path":Ljava/lang/String;
    .end local v32    # "isUsedByOtherApps":Z
    ...
    .restart local v11    # "sharedGid":I
    .restart local v12    # "pathsWithCode":[Z
    .restart local v13    # "classLoaderContexts":[Ljava/lang/String;
    .restart local v15    # "i":I
    :cond_1a
    move-object/from16 v37, v9
...
.method performDexOpt(Lcom/android/server/pm/pkg/AndroidPackage;Lcom/android/server/pm/pkg/PackageStateInternal;[Ljava/lang/String;Lcom/android/server/pm/CompilerStats$PackageStats;Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;Lcom/android/server/pm/dex/DexoptOptions;)I
    ...
    invoke-direct {p0, v0}, Lcom/android/server/pm/PackageDexOptimizer;->acquireWakeLockLI(I)J
    ...
    .line 240
    .end local p1    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .local v4, "options":Lcom/android/server/pm/dex/DexoptOptions;
    .local p2, "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .local p3, "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .local p4, "instructionSets":[Ljava/lang/String;
    .local p5, "packageStats":Lcom/android/server/pm/CompilerStats$PackageStats;
    .local p6, "packageUseInfo":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    :try_start_2
    invoke-direct {p0, v2, v3}, Lcom/android/server/pm/PackageDexOptimizer;->releaseWakeLockLI(J)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    .line 240
    .end local v4    # "options":Lcom/android/server/pm/dex/DexoptOptions;
    .restart local v2    # "acquireTime":J
    .restart local p1    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .local p2, "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .local p3, "instructionSets":[Ljava/lang/String;
    .local p4, "packageStats":Lcom/android/server/pm/CompilerStats$PackageStats;
    .local p5, "packageUseInfo":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    .local p6, "options":Lcom/android/server/pm/dex/DexoptOptions;
    :catchall_1
    move-exception v0
    ...
    .end local p1    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .restart local v4    # "options":Lcom/android/server/pm/dex/DexoptOptions;
    .local p2, "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .local p3, "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .local p4, "instructionSets":[Ljava/lang/String;
    .local p5, "packageStats":Lcom/android/server/pm/CompilerStats$PackageStats;
    ...
    .end local p3    # "pkgSetting":Lcom/android/server/pm/pkg/PackageStateInternal;
    .end local p4    # "instructionSets":[Ljava/lang/String;
    .end local p5    # "packageStats":Lcom/android/server/pm/CompilerStats$PackageStats;
    .end local p6    # "packageUseInfo":Lcom/android/server/pm/dex/PackageDexUsage$PackageUseInfo;
    throw v0
    :try_end_3
