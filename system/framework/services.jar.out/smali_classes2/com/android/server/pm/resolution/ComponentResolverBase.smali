...
.method public queryActivities(Lcom/android/server/pm/Computer;Landroid/content/Intent;Ljava/lang/String;JLjava/util/List;I)Ljava/util/List;
    ...
    .end local p3    # "resolvedType":Ljava/lang/String;
    .end local p4    # "flags":J
    .end local p6    # "activities":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
...
.method public queryProvider(Lcom/android/server/pm/Computer;Ljava/lang/String;JI)Landroid/content/pm/ProviderInfo;
    ...
    .line 158
    :cond_2
    invoke-interface {v8, p5}, Lcom/android/server/pm/pkg/PackageStateInternal;->getUserStateOrDefault(I)Lcom/android/server/pm/pkg/PackageUserStateInternal;
    ...
    .local p3, "appInfo":Landroid/content/pm/ApplicationInfo;
    if-nez p3, :cond_3
    ...
    .end local p3    # "appInfo":Landroid/content/pm/ApplicationInfo;
...
.method public queryProviders(Lcom/android/server/pm/Computer;Landroid/content/Intent;Ljava/lang/String;JLjava/util/List;I)Ljava/util/List;
    ...
    .end local p3    # "resolvedType":Ljava/lang/String;
    .end local p4    # "flags":J
    .end local p6    # "providers":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedProvider;>;"
    .end local p7    # "userId":I
    .local v1, "computer":Lcom/android/server/pm/Computer;
    .local v2, "intent":Landroid/content/Intent;
    .local v3, "resolvedType":Ljava/lang/String;
    .local v4, "flags":J
    .local v6, "providers":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedProvider;>;"
    .local v7, "userId":I
...
.method public queryProviders(Lcom/android/server/pm/Computer;Ljava/lang/String;Ljava/lang/String;IJI)Ljava/util/List;
    ...
    .local v11, "providerList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ProviderInfo;>;"
    .local v12, "i":I
    :goto_0
    if-ltz v12, :cond_c
    ...
    .line 196
    .local v10, "p":Lcom/android/internal/pm/pkg/component/ParsedProvider;
    ...
    .local v3, "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    ...
    .local v16, "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    if-nez v15, :cond_9
    ...
    .local v15, "info":Landroid/content/pm/ProviderInfo;
    if-nez v15, :cond_a
    ...
    .end local v9    # "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
    .end local v15    # "info":Landroid/content/pm/ProviderInfo;
    :goto_1
    ...
    .restart local v4    # "p":Lcom/android/internal/pm/pkg/component/ParsedProvider;
    ...
    .restart local v9    # "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
    .restart local v15    # "info":Landroid/content/pm/ProviderInfo;
    :cond_a
    if-nez v11, :cond_b
    ...
    .end local v9    # "ps":Lcom/android/server/pm/pkg/PackageStateInternal;
    .end local v15    # "info":Landroid/content/pm/ProviderInfo;
    .end local v16    # "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    .local v4, "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    :goto_2
...
.method public queryReceivers(Lcom/android/server/pm/Computer;Landroid/content/Intent;Ljava/lang/String;JLjava/util/List;I)Ljava/util/List;
    ...
    .end local p3    # "resolvedType":Ljava/lang/String;
    .end local p4    # "flags":J
    .end local p6    # "receivers":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
    .end local p7    # "userId":I
    .local v1, "computer":Lcom/android/server/pm/Computer;
    .local v2, "intent":Landroid/content/Intent;
    .local v3, "resolvedType":Ljava/lang/String;
    .local v4, "flags":J
    .local v6, "receivers":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedActivity;>;"
    .local v7, "userId":I
    invoke-virtual/range {v0 .. v7}, Lcom/android/server/pm/resolution/ComponentResolver$ActivityIntentResolver;->queryIntentForPackage(Lcom/android/server/pm/Computer;Landroid/content/Intent;Ljava/lang/String;JLjava/util/List;I)Ljava/util/List;
...
.method public queryServices(Lcom/android/server/pm/Computer;Landroid/content/Intent;Ljava/lang/String;JLjava/util/List;I)Ljava/util/List;
    ...
    .end local p3    # "resolvedType":Ljava/lang/String;
    .end local p4    # "flags":J
    .end local p6    # "services":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedService;>;"
    .end local p7    # "userId":I
    .local v1, "computer":Lcom/android/server/pm/Computer;
    .local v2, "intent":Landroid/content/Intent;
    .local v3, "resolvedType":Ljava/lang/String;
    .local v4, "flags":J
    .local v6, "services":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/pm/pkg/component/ParsedService;>;"
    .local v7, "userId":I
...
.method public querySyncProviders(Lcom/android/server/pm/Computer;Ljava/util/List;Ljava/util/List;ZI)V
    ...
    .line 279
    .local v5, "p":Lcom/android/internal/pm/pkg/component/ParsedProvider;
    ...
    .line 277
    .end local v5    # "p":Lcom/android/internal/pm/pkg/component/ParsedProvider;
    ...
    .line 296
    .restart local v5    # "p":Lcom/android/internal/pm/pkg/component/ParsedProvider;
    ...
    .line 299
    .end local v1    # "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    .local v13, "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    :goto_2
    move/from16 v10, p5
    ...
    .local v4, "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .local v8, "state":Lcom/android/server/pm/pkg/PackageUserStateInternal;
    ...
    .line 308
    .end local v4    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .end local v8    # "state":Lcom/android/server/pm/pkg/PackageUserStateInternal;
    .local v1, "info":Landroid/content/pm/ProviderInfo;
    .restart local v14    # "pkg":Lcom/android/server/pm/pkg/AndroidPackage;
    .restart local v17    # "state":Lcom/android/server/pm/pkg/PackageUserStateInternal;
    if-nez v1, :cond_6
    ...
    .end local v13    # "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    .local v1, "appInfoGenerator":Lcom/android/server/pm/parsing/PackageInfoUtils$CachedApplicationInfoGenerator;
    :goto_4
    add-int/lit8 v2, v2, -0x1
