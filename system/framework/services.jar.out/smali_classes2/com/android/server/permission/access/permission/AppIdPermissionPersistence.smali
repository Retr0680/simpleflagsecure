...
.method private final parseAppIdPermissions(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/MutableAccessState;I)V
    ...
    .line 53
    invoke-virtual {v1, v7}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->keyAt(I)I

    move-result v5

    .local v5, "appId":I
    invoke-virtual {v1, v7}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->valueAt(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    invoke-virtual {v11, v5}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->contains(I)Z
    ...
    .line 166
    invoke-virtual {v3, v6}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->removeAt(I)Lcom/android/server/permission/access/immutable/Immutable;
...
.method private final parsePermission(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/immutable/MutableIndexedMap;)V
    ...
    .local v3, "$this$parsePermission_u24lambda_u242":Landroid/content/pm/PermissionInfo;
    const/4 v4, 0x0

    .line 97
    .local v4, "$i$a$-apply-AppIdPermissionPersistence$parsePermission$permissionInfo$1":I
    ...
    .local v7, "$this$getAttributeValueOrThrow$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    const/4 v8, 0x0
    ...
    invoke-virtual {v9, v5, v6}, Lcom/android/modules/utils/BinaryXmlPullParser;->getAttributeIndexOrThrow(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v7, v9}, Lcom/android/modules/utils/BinaryXmlPullParser;->getAttributeValue(I)Ljava/lang/String;

    move-result-object v6

    .line 98
    .end local v6    # "name$iv":Ljava/lang/String;
    .end local v7    # "$this$getAttributeValueOrThrow$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    ...
    iput-object v6, v3, Landroid/content/pm/PermissionInfo;->packageName:Ljava/lang/String;
    ...
    .local v6, "$this$getAttributeIntHexOrThrow$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    const/4 v7, 0x0

    .line 191
    .local v7, "$i$f$getAttributeIntHexOrThrow":I
    invoke-virtual {v6, v5, v1}, Lcom/android/modules/utils/BinaryXmlPullParser;->getAttributeIntHex(Ljava/lang/String;Ljava/lang/String;)I

    move-result v1

    .line 99
    .end local v1    # "name$iv":Ljava/lang/String;
    .end local v6    # "$this$getAttributeIntHexOrThrow$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    .end local v7    # "$i$f$getAttributeIntHexOrThrow":I
    ...
    .line 96
    .end local v3    # "$this$parsePermission_u24lambda_u242":Landroid/content/pm/PermissionInfo;
    .end local v4    # "$i$a$-apply-AppIdPermissionPersistence$parsePermission$permissionInfo$1":I
    nop
    ...
    const-string v3, " with unknown type "
    ...
    .local v1, "$this$parsePermission_u24lambda_u243":Landroid/content/pm/PermissionInfo;
    const/4 v2, 0x0

    .line 106
    .local v2, "$i$a$-apply-AppIdPermissionPersistence$parsePermission$1":I
    const-string/jumbo v3, "icon"

    .local v3, "name$iv":Ljava/lang/String;
    const/4 v4, 0x0

    .local v4, "defaultValue$iv":I
    move-object/from16 v6, p1

    .local v6, "$this$getAttributeIntHexOrDefault$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    const/4 v8, 0x0

    .line 185
    .local v8, "$i$f$getAttributeIntHexOrDefault":I
    invoke-virtual {v6, v5, v3, v4}, Lcom/android/modules/utils/BinaryXmlPullParser;->getAttributeIntHex(Ljava/lang/String;Ljava/lang/String;I)I

    move-result v3

    .line 106
    .end local v3    # "name$iv":Ljava/lang/String;
    .end local v4    # "defaultValue$iv":I
    .end local v6    # "$this$getAttributeIntHexOrDefault$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    .end local v8    # "$i$f$getAttributeIntHexOrDefault":I
    iput v3, v1, Landroid/content/pm/PermissionInfo;->icon:I
    ...
    .local v4, "$this$getAttributeValue$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    const/4 v6, 0x0

    .line 141
    .local v6, "$i$f$getAttributeValue":I
    invoke-virtual {v4, v5, v3}, Lcom/android/modules/utils/BinaryXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 107
    .end local v3    # "name$iv":Ljava/lang/String;
    .end local v4    # "$this$getAttributeValue$iv":Lcom/android/modules/utils/BinaryXmlPullParser;
    .end local v6    # "$i$f$getAttributeValue":I
    iput-object v3, v1, Landroid/content/pm/PermissionInfo;->nonLocalizedLabel:Ljava/lang/CharSequence;

    .line 108
    nop

    .line 105
    .end local v1    # "$this$parsePermission_u24lambda_u243":Landroid/content/pm/PermissionInfo;
    .end local v2    # "$i$a$-apply-AppIdPermissionPersistence$parsePermission$1":I
    nop
    ...
    .line 126
    .local v2, "$i$f$set":I
    invoke-virtual {v1, v0, v6}, Lcom/android/server/permission/access/immutable/MutableIndexedMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private final parsePermissions(Lcom/android/modules/utils/BinaryXmlPullParser;Lcom/android/server/permission/access/MutableAccessState;Z)V
    ...
    .line 54
    invoke-virtual {v3, v8}, Lcom/android/server/permission/access/immutable/IndexedMap;->keyAt(I)Ljava/lang/Object;

    move-result-object v5

    invoke-virtual {v3, v8}, Lcom/android/server/permission/access/immutable/IndexedMap;->valueAt(I)Ljava/lang/Object;
    ...
    .line 84
    invoke-virtual {v2, v5}, Lcom/android/server/permission/access/immutable/MutableIndexedMap;->removeAt(I)Ljava/lang/Object;
