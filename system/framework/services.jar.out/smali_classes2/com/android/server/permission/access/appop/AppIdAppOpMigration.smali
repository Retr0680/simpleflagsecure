...
.method public final migrateUserState(Lcom/android/server/permission/access/MutableAccessState;I)V
    ...
    .local v22, "appOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    move-object/from16 v0, v21

    check-cast v0, Ljava/lang/Integer;

    .local v0, "appOpMode":Ljava/lang/Integer;
    ...
    .local v24, "$this$forEach$iv":Ljava/util/Map;
    ...
    .line 66
    .end local v0    # "appOpMode":Ljava/lang/Integer;
    ...
    .line 69
    .end local v22    # "appOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .end local v24    # "$this$forEach$iv":Ljava/util/Map;
    .local v0, "appOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .local v1, "$this$forEach$iv":Ljava/util/Map;
    :cond_2
    move-object/from16 v22, v0
    ...
    .restart local v22    # "appOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    if-eqz v6, :cond_4
    ...
    .local v18, "packageVersions":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    ...
    .local v2, "index$iv":I
    .local v19, "legacyAppIdAppOpModes":Ljava/util/Map;
    :goto_2
    if-ge v2, v0, :cond_3
    ...
    .local v23, "$this$set$iv":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    const/16 v24, 0x0
    ...
    .end local v23    # "$this$set$iv":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .local v2, "$this$set$iv":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .local v25, "index$iv":I
    invoke-virtual {v2, v0, v1}, Lcom/android/server/permission/access/immutable/MutableIndexedMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v2    # "$this$set$iv":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .end local v24    # "$i$f$set":I
    nop
    ...
    .restart local v21    # "$this$forEachIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    goto :goto_3

    .line 51
    .end local v15    # "$i$f$forEachIndexed":I
    .end local v18    # "packageVersions":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .end local v19    # "legacyAppIdAppOpModes":Ljava/util/Map;
    .end local v21    # "$this$forEachIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    .local v2, "legacyAppIdAppOpModes":Ljava/util/Map;
    :cond_4
    move-object/from16 v19, v2
    ...
    .end local v22    # "appOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    .restart local v19    # "legacyAppIdAppOpModes":Ljava/util/Map;
    :goto_3
    nop
