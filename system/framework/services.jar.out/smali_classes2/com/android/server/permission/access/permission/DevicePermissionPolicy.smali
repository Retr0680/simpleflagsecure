...
.method private final trimPermissionStates(Lcom/android/server/permission/access/MutateStateScope;I)V
    ...
    invoke-virtual {v3, v2}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->get(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 39
    invoke-virtual {v4, v6}, Lcom/android/server/permission/access/immutable/IndexedListSet;->elementAt(I)Ljava/lang/Object;
    ...
    .line 158
    .local v14, "$i$a$-forEachIndexed-DevicePermissionPolicy$trimPermissionStates$2":I
    invoke-virtual {v13}, Lcom/android/server/permission/access/UserState;->getAppIdDevicePermissionFlags()Lcom/android/server/permission/access/immutable/IntReferenceMap;
    ...
    .local v15, "$this$forEachReversedIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedReferenceMap;
    const/16 v16, 0x0
    ...
    .line 53
    invoke-virtual {v15, v0}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->keyAt(I)Ljava/lang/Object;

    move-result-object v3

    invoke-virtual {v15, v0}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->valueAt(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    invoke-virtual {v8, v1}, Lcom/android/server/permission/access/immutable/IndexedSet;->contains(Ljava/lang/Object;)Z
    ...
    .local v23, "$this$forEachReversedIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedMap;
    ...
    .end local v23    # "$this$forEachReversedIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedMap;
    .end local v24    # "index$iv":I
    .restart local v0    # "index$iv":I
    .restart local v1    # "permissionName":Ljava/lang/String;
    .local v5, "$this$forEachReversedIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedMap;
    ...
    .restart local v23    # "$this$forEachReversedIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedMap;
    ...
    .line 168
    .end local v15    # "$this$forEachReversedIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedReferenceMap;
    ...
    .end local v14    # "$i$a$-forEachIndexed-DevicePermissionPolicy$trimPermissionStates$2":I
    nop
...
.method private final updatePermissionFlags(Lcom/android/server/permission/access/MutateStateScope;ILjava/lang/String;ILjava/lang/String;II)Z
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->contains(I)Z
    ...
    const-string v8, "Unable to update permission flags for missing user "
    ...
    .line 273
    invoke-virtual {v0, v3}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->get(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 274
    :goto_0
    invoke-static {v0, v4, v6}, Lcom/android/server/permission/access/immutable/IndexedMapExtensionsKt;->getWithDefault(Lcom/android/server/permission/access/immutable/IndexedMap;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 275
    .local v0, "oldFlags":I
    invoke-static {v0, v7}, Lcom/android/server/permission/access/util/IntExtensionsKt;->andInv(II)I
    ...
    invoke-static {v10, v2, v5, v11, v8}, Lcom/android/server/permission/access/MutableAccessState;->mutateUserState$default(Lcom/android/server/permission/access/MutableAccessState;IIILjava/lang/Object;)Lcom/android/server/permission/access/MutableUserState;

    move-result-object v5

    invoke-static {v5}, Lcom/android/server/permission/jarjar/kotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-virtual {v5}, Lcom/android/server/permission/access/MutableUserState;->mutateAppIdDevicePermissionFlags()Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    ...
    .line 75
    .local v11, "$i$f$mutateOrPut":I
    invoke-virtual {v5, v1}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->mutate(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .local v12, "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    const/4 v14, 0x0

    .line 76
    .local v14, "$i$a$-let-IntReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    goto :goto_1

    .line 78
    .end local v12    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    .end local v14    # "$i$a$-let-IntReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    :cond_3
    const/4 v12, 0x0

    .line 282
    .local v12, "$i$a$-mutateOrPut-DevicePermissionPolicy$updatePermissionFlags$devicePermissionFlags$1":I
    new-instance v14, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;

    invoke-direct {v14, v8, v13, v8}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;-><init>(Landroid/util/ArrayMap;ILcom/android/server/permission/jarjar/kotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 78
    .end local v12    # "$i$a$-mutateOrPut-DevicePermissionPolicy$updatePermissionFlags$devicePermissionFlags$1":I
    move-object v12, v14
    ...
    .line 78
    .local v15, "$i$a$-also-IntReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    invoke-virtual {v5, v1, v12}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->put(ILcom/android/server/permission/access/immutable/Immutable;)Lcom/android/server/permission/access/immutable/Immutable;

    .line 282
    .end local v5    # "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    .end local v11    # "$i$f$mutateOrPut":I
    .end local v12    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    .end local v15    # "$i$a$-also-IntReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    :goto_1
    ...
    .line 283
    .local v12, "devicePermissionFlags":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    nop

    .line 291
    move-object v5, v12

    .local v5, "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    const/4 v11, 0x0

    .line 75
    .restart local v11    # "$i$f$mutateOrPut":I
    invoke-virtual {v5, v3}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->mutate(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 76
    .local v8, "$i$a$-let-IndexedReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    goto :goto_2

    .line 78
    .end local v8    # "$i$a$-let-IndexedReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    .end local v14    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    :cond_4
    const/4 v14, 0x0

    .line 291
    .local v14, "$i$a$-mutateOrPut-DevicePermissionPolicy$updatePermissionFlags$permissionFlags$1":I
    new-instance v15, Lcom/android/server/permission/access/immutable/MutableIndexedMap;

    invoke-direct {v15, v8, v13, v8}, Lcom/android/server/permission/access/immutable/MutableIndexedMap;-><init>(Landroid/util/ArrayMap;ILcom/android/server/permission/jarjar/kotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 78
    .end local v14    # "$i$a$-mutateOrPut-DevicePermissionPolicy$updatePermissionFlags$permissionFlags$1":I
    move-object v8, v15

    .line 476
    .local v8, "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    const/4 v14, 0x0

    .line 78
    .local v14, "$i$a$-also-IndexedReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    invoke-virtual {v5, v3, v8}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->put(Ljava/lang/Object;Lcom/android/server/permission/access/immutable/Immutable;)Lcom/android/server/permission/access/immutable/Immutable;

    move-object v14, v15

    .line 291
    .end local v5    # "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    .end local v8    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    .end local v11    # "$i$f$mutateOrPut":I
    .end local v14    # "$i$a$-also-IndexedReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    :goto_2
    move-object v8, v14

    check-cast v8, Lcom/android/server/permission/access/immutable/MutableIndexedMap;

    .line 292
    .local v8, "permissionFlags":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    invoke-static {v9}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v5

    invoke-static {v8, v4, v5, v6}, Lcom/android/server/permission/access/immutable/IndexedMapExtensionsKt;->putWithDefault(Lcom/android/server/permission/access/immutable/MutableIndexedMap;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 293
    invoke-virtual {v8}, Lcom/android/server/permission/access/immutable/IndexedMap;->isEmpty()Z
    ...
    .local v5, "$this$minusAssign$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    const/4 v6, 0x0

    .line 85
    .local v6, "$i$f$minusAssign":I
    invoke-virtual {v5, v3}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->remove(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;

    .line 86
    nop

    .line 295
    .end local v5    # "$this$minusAssign$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    .end local v6    # "$i$f$minusAssign":I
    invoke-virtual {v12}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->isEmpty()Z
    ...
    .line 296
    invoke-static {v10, v1}, Lcom/android/server/permission/access/immutable/IntReferenceMapExtensionsKt;->minusAssign(Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;I)V

    .line 299
    :cond_5
    move-object/from16 v11, p0

    iget-object v14, v11, Lcom/android/server/permission/access/permission/DevicePermissionPolicy;->listeners:Lcom/android/server/permission/access/immutable/IndexedListSet;

    .local v14, "$this$forEachIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    const/4 v15, 0x0
    ...
    .line 39
    invoke-virtual {v14, v5}, Lcom/android/server/permission/access/immutable/IndexedListSet;->elementAt(I)Ljava/lang/Object;

    move-result-object v16

    check-cast v16, Lcom/android/server/permission/access/permission/DevicePermissionPolicy$OnDevicePermissionFlagsChangedListener;

    .local v16, "it":Lcom/android/server/permission/access/permission/DevicePermissionPolicy$OnDevicePermissionFlagsChangedListener;
    const/16 v17, 0x0

    .line 300
    .local v17, "$i$a$-forEachIndexed-DevicePermissionPolicy$updatePermissionFlags$1":I
    nop
    ...
    .local v0, "it":Lcom/android/server/permission/access/permission/DevicePermissionPolicy$OnDevicePermissionFlagsChangedListener;
    .local v5, "oldFlags":I
    .local v6, "newFlags":I
    ...
    .line 39
    .end local v0    # "it":Lcom/android/server/permission/access/permission/DevicePermissionPolicy$OnDevicePermissionFlagsChangedListener;
    .end local v17    # "$i$a$-forEachIndexed-DevicePermissionPolicy$updatePermissionFlags$1":I
    nop
    ...
    .line 309
    .end local v14    # "$this$forEachIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
...
.method public final onDeviceIdRemoved(Lcom/android/server/permission/access/MutateStateScope;Ljava/lang/String;)V
    ...
    .line 53
    invoke-virtual {v7, v11}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->keyAt(I)I

    move-result v9

    .local v9, "appId":I
    invoke-virtual {v7, v11}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->valueAt(I)Lcom/android/server/permission/access/immutable/Immutable;

    move-result-object v10

    check-cast v10, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;

    const/4 v10, 0x0

    .line 83
    .local v10, "$i$a$-forEachReversedIndexed-DevicePermissionPolicy$onDeviceIdRemoved$1$1":I
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/permission/access/MutateStateScope;->getNewState()Lcom/android/server/permission/access/MutableAccessState;
    ...
    invoke-virtual {v12, v9}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->mutate(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .end local v10    # "$i$a$-forEachReversedIndexed-DevicePermissionPolicy$onDeviceIdRemoved$1$1":I
...
.method public final resetRuntimePermissions(Lcom/android/server/permission/access/MutateStateScope;Ljava/lang/String;I)V
    ...
    invoke-virtual {v3, v7}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->get(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 135
    .local v10, "userState":Lcom/android/server/permission/access/UserState;
    invoke-virtual {v10}, Lcom/android/server/permission/access/UserState;->getAppIdDevicePermissionFlags()Lcom/android/server/permission/access/immutable/IntReferenceMap;

    move-result-object v3

    invoke-virtual {v3, v5}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->get(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 136
    .local v11, "devicePermissionFlags":Lcom/android/server/permission/access/immutable/IndexedReferenceMap;
    ...
    .line 138
    .local v16, "$i$a$-forEach-DevicePermissionPolicy$resetRuntimePermissions$1":I
    nop
    ...
    invoke-virtual {v6, v5}, Lcom/android/server/permission/access/immutable/IntReferenceMap;->get(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 177
    .local v6, "packageNames$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    move-object v9, v6

    .local v9, "$this$anyIndexed$iv$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    const/16 v17, 0x0
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/permission/access/immutable/IndexedListSet;->elementAt(I)Ljava/lang/Object;
    ...
    .line 177
    .end local v9    # "$this$anyIndexed$iv$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    ...
    .end local v6    # "packageNames$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    nop
    ...
    .line 142
    .local v20, "isRequestedByOtherPackages":Z
    if-eqz v20, :cond_9
    ...
    .line 45
    invoke-virtual {v1, v3}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->keyAt(I)Ljava/lang/Object;

    move-result-object v6

    invoke-virtual {v1, v3}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->valueAt(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 146
    .local v17, "$i$a$-forEachIndexed-DevicePermissionPolicy$resetRuntimePermissions$1$1":I
    const/4 v9, 0x0
    ...
    .end local v17    # "$i$a$-forEachIndexed-DevicePermissionPolicy$resetRuntimePermissions$1$1":I
    nop
    ...
    .end local v16    # "$i$a$-forEach-DevicePermissionPolicy$resetRuntimePermissions$1":I
    .end local v20    # "isRequestedByOtherPackages":Z
    :goto_6
    move/from16 v7, p3
...
.method public final setPermissionFlags(Lcom/android/server/permission/access/MutateStateScope;ILjava/lang/String;ILjava/lang/String;I)Z
    ...
    .end local p1    # "$this$setPermissionFlags":Lcom/android/server/permission/access/MutateStateScope;
    ...
    .local v1, "$this$setPermissionFlags":Lcom/android/server/permission/access/MutateStateScope;
    .local v2, "appId":I
    .local v3, "deviceId":Ljava/lang/String;
    .local v4, "userId":I
    .local v5, "permissionName":Ljava/lang/String;
...
.method public final trimDevicePermissionStates(Lcom/android/server/permission/access/MutateStateScope;Ljava/util/Set;)V
    ...
    invoke-static {v13, v4, v9, v14, v15}, Lcom/android/server/permission/access/MutableAccessState;->mutateUserState$default(Lcom/android/server/permission/access/MutableAccessState;IIILjava/lang/Object;)Lcom/android/server/permission/access/MutableUserState;

    move-result-object v9

    invoke-static {v9}, Lcom/android/server/permission/jarjar/kotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-virtual {v9}, Lcom/android/server/permission/access/MutableUserState;->mutateAppIdDevicePermissionFlags()Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    ...
    .line 68
    .local v9, "appIdDevicePermissionFlags":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    invoke-virtual {v9, v10}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->mutate(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->remove(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 53
    .end local v9    # "appIdDevicePermissionFlags":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
