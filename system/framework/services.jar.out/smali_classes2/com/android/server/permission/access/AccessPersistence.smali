...
.method private final readSystemState(Lcom/android/server/permission/access/MutableAccessState;)V
    ...
    invoke-direct {v1}, Lcom/android/server/permission/access/AccessPersistence;->getSystemFile()Ljava/io/File;
...
.method private final write(Lcom/android/server/permission/access/WritableState;Lcom/android/server/permission/access/AccessState;I)V
    ...
    .line 126
    .local v12, "pendingMutationTimeMillis":J
    sub-long v10, v8, v12

    .line 127
    .local v10, "currentDelayMillis":J
    iget-object v6, v1, Lcom/android/server/permission/access/AccessPersistence;->writeHandler:Lcom/android/server/permission/access/AccessPersistence$WriteHandler;
    ...
    iget-object v9, v1, Lcom/android/server/permission/access/AccessPersistence;->writeHandler:Lcom/android/server/permission/access/AccessPersistence$WriteHandler;

    if-nez v9, :cond_4

    const-string/jumbo v9, "writeHandler"
    ...
    .end local v10    # "currentDelayMillis":J
    .end local v12    # "pendingMutationTimeMillis":J
...
.method private final writeSystemState(Lcom/android/server/permission/access/AccessState;)V
    ...
    .line 167
    const-string v1, "AccessPersistence"
    ...
    .local v2, "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    move-object v3, v0
    ...
    .local v5, "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    const/4 v6, 0x0

    .line 51
    .local v6, "$i$f$writeWithReserveCopy":I
    move-object v7, v5

    .local v7, "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    const/4 v8, 0x0

    .line 76
    .local v8, "$i$f$writeInlined":I
    ...
    .local v10, "it$iv$iv$iv":Ljava/io/FileOutputStream;
    const/4 v11, 0x0

    .line 77
    .local v11, "$i$a$-use-AtomicFileExtensionsKt$writeInlined$1$iv$iv$iv":I
    nop
    ...
    .line 176
    .local v12, "$i$a$-writeWithReserveCopy-AccessPersistence$serialize$1$iv":I
    move-object v13, v0

    .local v13, "$this$serializeBinaryXml$iv$iv":Ljava/io/OutputStream;
    const/4 v14, 0x0

    .line 26
    .local v14, "$i$f$serializeBinaryXml":I
    :try_start_1
    new-instance v15, Lcom/android/modules/utils/BinaryXmlSerializer;

    invoke-direct {v15}, Lcom/android/modules/utils/BinaryXmlSerializer;-><init>()V

    .local v15, "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/16 v16, 0x0
    ...
    .local v17, "it$iv":Ljava/io/FileOutputStream;
    const/4 v0, 0x0

    invoke-virtual {v15, v13, v0}, Lcom/android/modules/utils/BinaryXmlSerializer;->setOutput(Ljava/io/OutputStream;Ljava/lang/String;)V

    .line 28
    move-object/from16 v18, v15

    .local v18, "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/16 v19, 0x0

    .line 40
    .local v19, "$i$f$document":I
    const/16 v20, 0x1
    ...
    .end local v2    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .local v4, "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .local v18, "$i$f$serialize":I
    .local v20, "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    :try_start_2
    invoke-virtual {v4, v2, v0}, Lcom/android/modules/utils/BinaryXmlSerializer;->startDocument(Ljava/lang/String;Ljava/lang/Boolean;)V

    .line 41
    move-object v0, v4

    .local v0, "$this$writeSystemState_u24lambda_u2414":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/4 v2, 0x0

    .line 167
    .local v2, "$i$a$-serialize-AccessPersistence$writeSystemState$1":I
    move/from16 v21, v2
    ...
    .end local v2    # "$i$a$-serialize-AccessPersistence$writeSystemState$1":I
    .end local v4    # "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .local v21, "$i$a$-serialize-AccessPersistence$writeSystemState$1":I
    .local v22, "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    iget-object v4, v2, Lcom/android/server/permission/access/AccessPersistence;->policy:Lcom/android/server/permission/access/AccessPolicy;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_6

    .line 216
    .local v4, "$this$writeSystemState_u24lambda_u2414_u24lambda_u2413":Lcom/android/server/permission/access/AccessPolicy;
    const/16 v23, 0x0

    .line 167
    .local v23, "$i$a$-with-AccessPersistence$writeSystemState$1$1":I
    move-object/from16 v2, p1

    :try_start_3
    invoke-virtual {v4, v0, v2}, Lcom/android/server/permission/access/AccessPolicy;->serializeSystemState(Lcom/android/modules/utils/BinaryXmlSerializer;Lcom/android/server/permission/access/AccessState;)V

    .line 41
    .end local v0    # "$this$writeSystemState_u24lambda_u2414":Lcom/android/modules/utils/BinaryXmlSerializer;
    .end local v4    # "$this$writeSystemState_u24lambda_u2414_u24lambda_u2413":Lcom/android/server/permission/access/AccessPolicy;
    .end local v21    # "$i$a$-serialize-AccessPersistence$writeSystemState$1":I
    .end local v23    # "$i$a$-with-AccessPersistence$writeSystemState$1$1":I
    nop

    .line 42
    invoke-virtual/range {v22 .. v22}, Lcom/android/modules/utils/BinaryXmlSerializer;->endDocument()V

    .line 43
    nop

    .line 29
    .end local v19    # "$i$f$document":I
    .end local v22    # "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    nop

    .line 26
    .end local v15    # "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    ...
    .line 176
    .end local v13    # "$this$serializeBinaryXml$iv$iv":Ljava/io/OutputStream;
    .end local v14    # "$i$f$serializeBinaryXml":I
    nop

    .line 78
    .end local v12    # "$i$a$-writeWithReserveCopy-AccessPersistence$serialize$1$iv":I
    .end local v17    # "it$iv":Ljava/io/FileOutputStream;
    nop

    .line 79
    invoke-virtual {v7, v10}, Landroid/util/AtomicFile;->finishWrite(Ljava/io/FileOutputStream;)V
    :try_end_3
    ...
    .end local v10    # "it$iv$iv$iv":Ljava/io/FileOutputStream;
    .end local v11    # "$i$a$-use-AtomicFileExtensionsKt$writeInlined$1$iv$iv$iv":I
    :try_start_4
    sget-object v0, Lcom/android/server/permission/jarjar/kotlin/Unit;->INSTANCE:Lcom/android/server/permission/jarjar/kotlin/Unit;
    :try_end_4
    ...
    :try_start_5
    invoke-static {v9, v0}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    .line 85
    nop

    .line 52
    .end local v7    # "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    .end local v8    # "$i$f$writeInlined":I
    new-instance v0, Ljava/io/File;
    ...
    .line 55
    :try_start_a
    invoke-static {v7, v0}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_a
    ...
    .end local v5    # "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    .end local v6    # "$i$f$writeWithReserveCopy":I
    .end local v8    # "inputStream$iv$iv":Ljava/io/FileInputStream;
    .end local v9    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    .end local v18    # "$i$f$serialize":I
    .end local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .end local p0    # "this":Lcom/android/server/permission/access/AccessPersistence;
    ...
    .restart local v5    # "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    .restart local v6    # "$i$f$writeWithReserveCopy":I
    .restart local v8    # "inputStream$iv$iv":Ljava/io/FileInputStream;
    .restart local v9    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    .restart local v18    # "$i$f$serialize":I
    .restart local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p0    # "this":Lcom/android/server/permission/access/AccessPersistence;
    ...
    :try_start_e
    invoke-static {v7, v8}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0}, Lcom/android/server/security/FileIntegrity;->setUpFsVerity(Ljava/io/File;)V

    .line 66
    invoke-static {v4}, Lcom/android/server/security/FileIntegrity;->setUpFsVerity(Ljava/io/File;)V
    :try_end_10
    ...
    .line 68
    .restart local v0    # "e$iv$iv":Ljava/lang/Exception;
    :try_start_11
    const-string v7, "Failed to verity-protect runtime-permissions"
    ...
    .restart local v5    # "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    .restart local v6    # "$i$f$writeWithReserveCopy":I
    .restart local v7    # "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    .local v8, "$i$f$writeInlined":I
    :catchall_4
    move-exception v0
    ...
    .line 80
    .restart local v10    # "it$iv$iv$iv":Ljava/io/FileOutputStream;
    .local v11, "$i$a$-use-AtomicFileExtensionsKt$writeInlined$1$iv$iv$iv":I
    :catchall_5
    move-exception v0
    ...
    .line 81
    .end local v2    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .end local v4    # "$i$f$serialize":I
    .local v0, "t$iv$iv$iv":Ljava/lang/Throwable;
    .restart local v18    # "$i$f$serialize":I
    .restart local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    :goto_4
    :try_start_12
    invoke-virtual {v7, v10}, Landroid/util/AtomicFile;->failWrite(Ljava/io/FileOutputStream;)V
    ...
    .restart local v6    # "$i$f$writeWithReserveCopy":I
    .restart local v7    # "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    .restart local v8    # "$i$f$writeInlined":I
    .restart local v18    # "$i$f$serialize":I
    .restart local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p0    # "this":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p1    # "state":Lcom/android/server/permission/access/AccessState;
    ...
    :try_start_14
    invoke-static {v9, v1}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    .end local v7    # "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    .end local v8    # "$i$f$writeInlined":I
    .restart local v2    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .restart local v3    # "$this$serialize$iv":Ljava/io/File;
    .restart local v4    # "$i$f$serialize":I
    .restart local p0    # "this":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p1    # "state":Lcom/android/server/permission/access/AccessState;
    :catch_3
    move-exception v0
    ...
    .line 178
    .local v0, "e$iv":Ljava/lang/Exception;
    sget-object v1, Lcom/android/server/permission/access/AccessPersistence;->LOG_TAG:Ljava/lang/String;
...
.method private final writeUserState(Lcom/android/server/permission/access/AccessState;I)V
    ...
    .local v4, "$this$serialize$iv":Ljava/io/File;
    move-object/from16 v5, p0

    .local v5, "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    const/4 v6, 0x0

    .line 175
    .local v6, "$i$f$serialize":I
    nop
    ...
    .local v7, "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    const/4 v8, 0x0

    .line 51
    .local v8, "$i$f$writeWithReserveCopy":I
    move-object v9, v7

    .local v9, "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    const/4 v10, 0x0

    .line 76
    .local v10, "$i$f$writeInlined":I
    ...
    .local v12, "it$iv$iv$iv":Ljava/io/FileOutputStream;
    const/4 v13, 0x0

    .line 77
    .local v13, "$i$a$-use-AtomicFileExtensionsKt$writeInlined$1$iv$iv$iv":I
    nop
    ...
    .line 176
    .local v14, "$i$a$-writeWithReserveCopy-AccessPersistence$serialize$1$iv":I
    move-object v15, v0

    .local v15, "$this$serializeBinaryXml$iv$iv":Ljava/io/OutputStream;
    const/16 v16, 0x0

    .line 26
    .local v16, "$i$f$serializeBinaryXml":I
    :try_start_1
    new-instance v17, Lcom/android/modules/utils/BinaryXmlSerializer;

    invoke-direct/range {v17 .. v17}, Lcom/android/modules/utils/BinaryXmlSerializer;-><init>()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_8

    move-object/from16 v18, v17

    .local v18, "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/16 v17, 0x0

    .line 27
    .local v17, "$i$a$-apply-BinaryXmlSerializerExtensionsKt$serializeBinaryXml$1$iv$iv":I
    move-object/from16 v19, v0

    .end local v0    # "it$iv":Ljava/io/FileOutputStream;
    .local v19, "it$iv":Ljava/io/FileOutputStream;
    const/4 v0, 0x0
    ...
    .end local v18    # "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .local v5, "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .local v20, "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    :try_start_2
    invoke-virtual {v5, v15, v0}, Lcom/android/modules/utils/BinaryXmlSerializer;->setOutput(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    .end local v5    # "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .local v6, "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .local v18, "$i$f$serialize":I
    .local v22, "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    :try_start_3
    invoke-virtual {v6, v5, v0}, Lcom/android/modules/utils/BinaryXmlSerializer;->startDocument(Ljava/lang/String;Ljava/lang/Boolean;)V

    .line 41
    move-object v0, v6

    .local v0, "$this$writeUserState_u24lambda_u2416":Lcom/android/modules/utils/BinaryXmlSerializer;
    const/4 v5, 0x0

    .line 171
    .local v5, "$i$a$-serialize-AccessPersistence$writeUserState$1":I
    move/from16 v23, v5

    .end local v5    # "$i$a$-serialize-AccessPersistence$writeUserState$1":I
    .local v23, "$i$a$-serialize-AccessPersistence$writeUserState$1":I
    ...
    .line 216
    .local v5, "$this$writeUserState_u24lambda_u2416_u24lambda_u2415":Lcom/android/server/permission/access/AccessPolicy;
    const/16 v24, 0x0

    .line 171
    .local v24, "$i$a$-with-AccessPersistence$writeUserState$1$1":I
    move-object/from16 v1, p1

    :try_start_4
    invoke-virtual {v5, v0, v1, v2}, Lcom/android/server/permission/access/AccessPolicy;->serializeUserState(Lcom/android/modules/utils/BinaryXmlSerializer;Lcom/android/server/permission/access/AccessState;I)V

    .line 41
    .end local v0    # "$this$writeUserState_u24lambda_u2416":Lcom/android/modules/utils/BinaryXmlSerializer;
    .end local v5    # "$this$writeUserState_u24lambda_u2416_u24lambda_u2415":Lcom/android/server/permission/access/AccessPolicy;
    .end local v23    # "$i$a$-serialize-AccessPersistence$writeUserState$1":I
    .end local v24    # "$i$a$-with-AccessPersistence$writeUserState$1$1":I
    nop

    .line 42
    invoke-virtual {v6}, Lcom/android/modules/utils/BinaryXmlSerializer;->endDocument()V

    .line 43
    nop

    .line 29
    .end local v6    # "$this$document$iv$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    .end local v21    # "$i$f$document":I
    nop

    .line 26
    .end local v17    # "$i$a$-apply-BinaryXmlSerializerExtensionsKt$serializeBinaryXml$1$iv$iv":I
    .end local v22    # "$this$serializeBinaryXml_u24lambda_u240$iv$iv":Lcom/android/modules/utils/BinaryXmlSerializer;
    nop
    ...
    .line 176
    .end local v15    # "$this$serializeBinaryXml$iv$iv":Ljava/io/OutputStream;
    .end local v16    # "$i$f$serializeBinaryXml":I
    nop

    .line 78
    .end local v14    # "$i$a$-writeWithReserveCopy-AccessPersistence$serialize$1$iv":I
    .end local v19    # "it$iv":Ljava/io/FileOutputStream;
    nop

    .line 79
    invoke-virtual {v9, v12}, Landroid/util/AtomicFile;->finishWrite(Ljava/io/FileOutputStream;)V
    :try_end_4
    ...
    .end local v12    # "it$iv$iv$iv":Ljava/io/FileOutputStream;
    .end local v13    # "$i$a$-use-AtomicFileExtensionsKt$writeInlined$1$iv$iv$iv":I
    :try_start_5
    sget-object v0, Lcom/android/server/permission/jarjar/kotlin/Unit;->INSTANCE:Lcom/android/server/permission/jarjar/kotlin/Unit;
    :try_end_5
    ...
    :try_start_6
    invoke-static {v11, v5}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    .line 85
    nop

    .line 52
    .end local v9    # "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    .end local v10    # "$i$f$writeInlined":I
    new-instance v0, Ljava/io/File;
    ...
    .line 53
    .local v5, "reserveFile$iv$iv":Ljava/io/File;
    ...
    .local v9, "inputStream$iv$iv":Ljava/io/FileInputStream;
    const/4 v10, 0x0

    .line 56
    .local v10, "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    :try_start_8
    ...
    .line 57
    .local v12, "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$1$iv$iv":I
    :try_start_9
    invoke-static {v9, v0}, Landroid/os/FileUtils;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .end local v0    # "outputStream$iv$iv":Ljava/io/FileOutputStream;
    .end local v12    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$1$iv$iv":I
    sget-object v0, Lcom/android/server/permission/jarjar/kotlin/Unit;->INSTANCE:Lcom/android/server/permission/jarjar/kotlin/Unit;
    :try_end_9
    ...
    :try_start_a
    invoke-static {v11, v0}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    .line 60
    nop

    .end local v9    # "inputStream$iv$iv":Ljava/io/FileInputStream;
    .end local v10    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    ...
    .line 55
    :try_start_b
    invoke-static {v6, v0}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_b
    ...
    .line 56
    .restart local v9    # "inputStream$iv$iv":Ljava/io/FileInputStream;
    .restart local v10    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    :catchall_1
    move-exception v0

    move-object v12, v0

    .end local v4    # "$this$serialize$iv":Ljava/io/File;
    .end local v5    # "reserveFile$iv$iv":Ljava/io/File;
    .end local v7    # "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    .end local v8    # "$i$f$writeWithReserveCopy":I
    .end local v9    # "inputStream$iv$iv":Ljava/io/FileInputStream;
    .end local v10    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    .end local v18    # "$i$f$serialize":I
    .end local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    ...
    .restart local v4    # "$this$serialize$iv":Ljava/io/File;
    .restart local v5    # "reserveFile$iv$iv":Ljava/io/File;
    .restart local v7    # "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    .restart local v8    # "$i$f$writeWithReserveCopy":I
    .restart local v9    # "inputStream$iv$iv":Ljava/io/FileInputStream;
    .restart local v10    # "$i$a$-use-AtomicFileExtensionsKt$writeWithReserveCopy$1$iv$iv":I
    .restart local v18    # "$i$f$serialize":I
    .restart local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    ...
    :try_start_d
    invoke-static {v11, v12}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_f
    invoke-static {v6, v9}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    .line 66
    invoke-static {v5}, Lcom/android/server/security/FileIntegrity;->setUpFsVerity(Ljava/io/File;)V
    :try_end_11
    ...
    .restart local v0    # "e$iv$iv":Ljava/lang/Exception;
    :try_start_12
    const-string v6, "Failed to verity-protect runtime-permissions"
    ...
    .line 80
    .local v12, "it$iv$iv$iv":Ljava/io/FileOutputStream;
    .restart local v13    # "$i$a$-use-AtomicFileExtensionsKt$writeInlined$1$iv$iv$iv":I
    :catchall_5
    move-exception v0
    ...
    .end local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .local v5, "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .restart local v6    # "$i$f$serialize":I
    :catchall_8
    move-exception v0
    ...
    .line 81
    .end local v5    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .end local v6    # "$i$f$serialize":I
    .local v0, "t$iv$iv$iv":Ljava/lang/Throwable;
    .restart local v18    # "$i$f$serialize":I
    .restart local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    :goto_4
    :try_start_13
    invoke-virtual {v9, v12}, Landroid/util/AtomicFile;->failWrite(Ljava/io/FileOutputStream;)V
    ...
    .restart local v7    # "$this$writeWithReserveCopy$iv$iv":Landroid/util/AtomicFile;
    .restart local v8    # "$i$f$writeWithReserveCopy":I
    .restart local v9    # "$this$writeInlined$iv$iv$iv":Landroid/util/AtomicFile;
    .restart local v10    # "$i$f$writeInlined":I
    .restart local v18    # "$i$f$serialize":I
    .restart local v20    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p0    # "this":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p1    # "state":Lcom/android/server/permission/access/AccessState;
    ...
    :try_start_15
    invoke-static {v11, v3}, Lcom/android/server/permission/jarjar/kotlin/io/CloseableKt;->closeFinally(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    .end local v10    # "$i$f$writeInlined":I
    .restart local v4    # "$this$serialize$iv":Ljava/io/File;
    .restart local v5    # "this_$iv":Lcom/android/server/permission/access/AccessPersistence;
    .restart local v6    # "$i$f$serialize":I
    .restart local p0    # "this":Lcom/android/server/permission/access/AccessPersistence;
    .restart local p1    # "state":Lcom/android/server/permission/access/AccessState;
    .restart local p2    # "userId":I
...
.method public final shutdown(Lcom/android/server/permission/access/immutable/IntSet;)V
    .locals 6
    .param p1, "userIds"    # Lcom/android/server/permission/access/immutable/IntSet;

    .line 108
    const/4 v0, -0x1

    invoke-direct {p0, v0}, Lcom/android/server/permission/access/AccessPersistence;->writePendingState(I)V
    ...
    .line 110
    .local v5, "$i$a$-forEachIndexed-AccessPersistence$shutdown$1":I
    invoke-direct {p0, v4}, Lcom/android/server/permission/access/AccessPersistence;->writePendingState(I)V
    ...
    .line 39
    .end local v4    # "userId":I
    .end local v5    # "$i$a$-forEachIndexed-AccessPersistence$shutdown$1":I
    nop
