...
.method public final setAppOpMode(Lcom/android/server/permission/access/MutateStateScope;Ljava/lang/String;ILjava/lang/String;I)Z
    ...
    const-string v6, "Unable to set app op mode for missing user "
    ...
    .line 95
    :cond_0
    invoke-static {v3}, Landroid/app/AppOpsManager;->opToDefaultMode(Ljava/lang/String;)I
    ...
    .line 97
    invoke-virtual {v0, v1}, Lcom/android/server/permission/access/immutable/IndexedReferenceMap;->get(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    invoke-static {v0, v3, v5}, Lcom/android/server/permission/access/immutable/IndexedMapExtensionsKt;->getWithDefault(Lcom/android/server/permission/access/immutable/IndexedMap;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v7, v2, v4, v8, v9}, Lcom/android/server/permission/access/MutableAccessState;->mutateUserState$default(Lcom/android/server/permission/access/MutableAccessState;IIILjava/lang/Object;)Lcom/android/server/permission/access/MutableUserState;
    ...
    .line 104
    .local v7, "packageAppOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    move-object v4, v7

    .local v4, "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    const/4 v8, 0x0

    .line 75
    .local v8, "$i$f$mutateOrPut":I
    invoke-virtual {v4, v1}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->mutate(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .local v10, "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    const/4 v9, 0x0

    .line 76
    .local v9, "$i$a$-let-IndexedReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    goto :goto_0

    .line 78
    .end local v9    # "$i$a$-let-IndexedReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    .end local v10    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    :cond_2
    const/4 v10, 0x0

    .line 104
    .local v10, "$i$a$-mutateOrPut-PackageAppOpPolicy$setAppOpMode$appOpModes$1":I
    new-instance v12, Lcom/android/server/permission/access/immutable/MutableIndexedMap;

    invoke-direct {v12, v9, v11, v9}, Lcom/android/server/permission/access/immutable/MutableIndexedMap;-><init>(Landroid/util/ArrayMap;ILcom/android/server/permission/jarjar/kotlin/jvm/internal/DefaultConstructorMarker;)V

    .line 78
    .end local v10    # "$i$a$-mutateOrPut-PackageAppOpPolicy$setAppOpMode$appOpModes$1":I
    move-object v9, v12

    .line 181
    .local v9, "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    const/4 v10, 0x0

    .line 78
    .local v10, "$i$a$-also-IndexedReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    invoke-virtual {v4, v1, v9}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->put(Ljava/lang/Object;Lcom/android/server/permission/access/immutable/Immutable;)Lcom/android/server/permission/access/immutable/Immutable;

    move-object v10, v12

    .line 104
    .end local v4    # "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    .end local v8    # "$i$f$mutateOrPut":I
    .end local v9    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    .end local v10    # "$i$a$-also-IndexedReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    :goto_0
    move-object v8, v10
    ...
    .line 105
    .local v8, "appOpModes":Lcom/android/server/permission/access/immutable/MutableIndexedMap;
    ...
    invoke-static {v8, v3, v4, v9}, Lcom/android/server/permission/access/immutable/IndexedMapExtensionsKt;->putWithDefault(Lcom/android/server/permission/access/immutable/MutableIndexedMap;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v4, "$this$minusAssign$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    const/4 v9, 0x0

    .line 85
    .local v9, "$i$f$minusAssign":I
    invoke-virtual {v4, v1}, Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;->remove(Ljava/lang/Object;)Lcom/android/server/permission/access/immutable/Immutable;

    .line 86
    nop

    .line 109
    .end local v4    # "$this$minusAssign$iv":Lcom/android/server/permission/access/immutable/MutableIndexedReferenceMap;
    .end local v9    # "$i$f$minusAssign":I
    :cond_3
    move-object/from16 v9, p0

    iget-object v10, v9, Lcom/android/server/permission/access/appop/PackageAppOpPolicy;->onAppOpModeChangedListeners:Lcom/android/server/permission/access/immutable/IndexedListSet;

    .local v10, "$this$forEachIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
    const/4 v12, 0x0
    ...
    .line 39
    invoke-virtual {v10, v14}, Lcom/android/server/permission/access/immutable/IndexedListSet;->elementAt(I)Ljava/lang/Object;
    ...
    .line 110
    .local v15, "$i$a$-forEachIndexed-PackageAppOpPolicy$setAppOpMode$1":I
    ...
    .local v0, "it":Lcom/android/server/permission/access/appop/PackageAppOpPolicy$OnAppOpModeChangedListener;
    .local v4, "oldMode":I
    ...
    .line 39
    .end local v0    # "it":Lcom/android/server/permission/access/appop/PackageAppOpPolicy$OnAppOpModeChangedListener;
    .end local v15    # "$i$a$-forEachIndexed-PackageAppOpPolicy$setAppOpMode$1":I
    nop
    ...
    .line 112
    .end local v10    # "$this$forEachIndexed$iv":Lcom/android/server/permission/access/immutable/IndexedListSet;
