...
.method public final setAppOpMode(Lcom/android/server/permission/access/MutateStateScope;IILjava/lang/String;I)Z
    ...
    .line 101
    .local v7, "appIdAppOpModes":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    move-object v4, v7

    .local v4, "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    const/4 v8, 0x0

    .line 75
    .local v8, "$i$f$mutateOrPut":I
    invoke-virtual {v4, v1}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->mutate(I)Lcom/android/server/permission/access/immutable/Immutable;
    ...
    .line 76
    .local v9, "$i$a$-let-IntReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    goto :goto_0

    .line 78
    .end local v9    # "$i$a$-let-IntReferenceMapExtensionsKt$mutateOrPut$1$iv":I
    .end local v10    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    :cond_2
    const/4 v10, 0x0

    .line 101
    .local v10, "$i$a$-mutateOrPut-AppIdAppOpPolicy$setAppOpMode$appOpModes$1":I
    ...
    .line 78
    .end local v10    # "$i$a$-mutateOrPut-AppIdAppOpPolicy$setAppOpMode$appOpModes$1":I
    move-object v9, v12
    ...
    .line 78
    .local v10, "$i$a$-also-IntReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    invoke-virtual {v4, v1, v9}, Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;->put(ILcom/android/server/permission/access/immutable/Immutable;)Lcom/android/server/permission/access/immutable/Immutable;

    move-object v10, v12

    .line 101
    .end local v4    # "$this$mutateOrPut$iv":Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;
    .end local v8    # "$i$f$mutateOrPut":I
    .end local v9    # "it$iv":Lcom/android/server/permission/access/immutable/Immutable;
    .end local v10    # "$i$a$-also-IntReferenceMapExtensionsKt$mutateOrPut$2$iv":I
    :goto_0
    move-object v8, v10
    ...
    .line 104
    invoke-static {v7, v1}, Lcom/android/server/permission/access/immutable/IntReferenceMapExtensionsKt;->minusAssign(Lcom/android/server/permission/access/immutable/MutableIntReferenceMap;I)V

    .line 106
    :cond_3
    move-object/from16 v9, p0

    iget-object v10, v9, Lcom/android/server/permission/access/appop/AppIdAppOpPolicy;->onAppOpModeChangedListeners:Lcom/android/server/permission/access/immutable/IndexedListSet;
    ...
    .line 107
    .local v15, "$i$a$-forEachIndexed-AppIdAppOpPolicy$setAppOpMode$1":I
    ...
    .local v0, "it":Lcom/android/server/permission/access/appop/AppIdAppOpPolicy$OnAppOpModeChangedListener;
    .local v4, "oldMode":I
    ...
    .line 39
    .end local v0    # "it":Lcom/android/server/permission/access/appop/AppIdAppOpPolicy$OnAppOpModeChangedListener;
    .end local v15    # "$i$a$-forEachIndexed-AppIdAppOpPolicy$setAppOpMode$1":I
    nop
