...
.method private csr()I
    ...
    .line 182
    .local v3, "binder":Landroid/hardware/security/keymint/IRemotelyProvisionedComponent;
    invoke-interface {v3}, Landroid/hardware/security/keymint/IRemotelyProvisionedComponent;->getHardwareInfo()Landroid/hardware/security/keymint/RpcHardwareInfo;

    move-result-object v10

    .line 183
    .local v10, "info":Landroid/hardware/security/keymint/RpcHardwareInfo;
    new-array v4, v0, [Landroid/hardware/security/keymint/MacedPublicKey;

    .line 185
    .local v4, "emptyKeys":[Landroid/hardware/security/keymint/MacedPublicKey;
    iget v5, v10, Landroid/hardware/security/keymint/RpcHardwareInfo;->versionNumber:I
    ...
    const-string v7, "error: unsupported hwVersion: "

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v7, v10, Landroid/hardware/security/keymint/RpcHardwareInfo;->versionNumber:I
    ...
    .line 197
    :pswitch_2
    invoke-interface {v3, v4, v6}, Landroid/hardware/security/keymint/IRemotelyProvisionedComponent;->generateCertificateRequestV2([Landroid/hardware/security/keymint/MacedPublicKey;[B)[B
    ...
    .line 189
    .local v7, "deviceInfo":Landroid/hardware/security/keymint/DeviceInfo;
    ...
    .line 190
    .local v8, "protectedData":Landroid/hardware/security/keymint/ProtectedData;
    iget v2, v10, Landroid/hardware/security/keymint/RpcHardwareInfo;->supportedEekCurve:I

    invoke-direct {p0, v2}, Lcom/android/server/security/rkp/RemoteProvisioningShellCommand;->getEekChain(I)[B
    ...
    .end local v3    # "binder":Landroid/hardware/security/keymint/IRemotelyProvisionedComponent;
    .local v2, "binder":Landroid/hardware/security/keymint/IRemotelyProvisionedComponent;
    const/4 v3, 0x0
    ...
    invoke-direct {p0, v7, v6, v8, v3}, Lcom/android/server/security/rkp/RemoteProvisioningShellCommand;->composeCertificateRequestV1(Landroid/hardware/security/keymint/DeviceInfo;[BLandroid/hardware/security/keymint/ProtectedData;[B)[B

    move-result-object v11

    .line 195
    .local v11, "csrBytes":[B
    nop

    .line 203
    .end local v3    # "keysToSignMac":[B
    .end local v5    # "eek":[B
    .end local v7    # "deviceInfo":Landroid/hardware/security/keymint/DeviceInfo;
    .end local v8    # "protectedData":Landroid/hardware/security/keymint/ProtectedData;
    :goto_3
    invoke-virtual {p0}, Landroid/os/ShellCommand;->getOutPrintWriter()Ljava/io/PrintWriter;
    ...
    invoke-virtual {v5, v11}, Ljava/util/Base64$Encoder;->encodeToString([B)Ljava/lang/String;
