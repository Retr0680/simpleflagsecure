...
.field private final mHandlePollEventCallback:Ljava/lang/Runnable;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/input/NativeInputManagerService;Landroid/os/Looper;Lcom/android/server/input/UEventManager;)V
    ...
    .end local p2    # "nativeService":Lcom/android/server/input/NativeInputManagerService;
    .end local p3    # "looper":Landroid/os/Looper;
    .end local p4    # "uEventManager":Lcom/android/server/input/UEventManager;
    .local v1, "context":Landroid/content/Context;
    .local v2, "nativeService":Lcom/android/server/input/NativeInputManagerService;
    .local v3, "looper":Landroid/os/Looper;
    .local v4, "uEventManager":Lcom/android/server/input/UEventManager;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/input/NativeInputManagerService;Landroid/os/Looper;Lcom/android/server/input/UEventManager;Lcom/android/server/input/BatteryController$BluetoothBatteryManager;)V
    ...
    .line 86
    new-instance v0, Lcom/android/server/input/BatteryController$$ExternalSyntheticLambda8;

    invoke-direct {v0, p0}, Lcom/android/server/input/BatteryController$$ExternalSyntheticLambda8;-><init>(Lcom/android/server/input/BatteryController;)V
...
.method private handlePollEvent()V
    ...
    iget-object v4, p0, Lcom/android/server/input/BatteryController;->mHandlePollEventCallback:Ljava/lang/Runnable;
...
.method private queryBatteryStateFromNative(IJZ)Lcom/android/server/input/BatteryController$State;
    ...
    invoke-interface {v1, p1}, Lcom/android/server/input/NativeInputManagerService;->getBatteryCapacity(I)I
    ...
    .end local p2    # "updateTime":J
    .end local p4    # "isPresent":Z
    .local v1, "deviceId":I
    .local v2, "updateTime":J
...
.method private updatePollingLocked(Z)V
    ...
    iget-object v1, p0, Lcom/android/server/input/BatteryController;->mHandlePollEventCallback:Ljava/lang/Runnable;
