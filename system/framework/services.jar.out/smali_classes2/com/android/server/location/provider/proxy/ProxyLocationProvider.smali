...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;III)V
    ...
    .param p4, "enableOverlayResId"    # I
    .param p5, "nonOverlayPackageResId"    # I
    .param p6, "unstableOverlayFallbackResId"    # I
    ...
    .line 139
    .local v0, "unstableFallbackEnabled":Z
    nop
    ...
    .line 139
    invoke-static {p1, p2, v0, v1, p0}, Lcom/android/server/servicewatcher/ServiceWatcher;->create(Landroid/content/Context;Ljava/lang/String;ZLcom/android/server/servicewatcher/ServiceWatcher$ServiceSupplier;Lcom/android/server/servicewatcher/ServiceWatcher$ServiceListener;)Lcom/android/server/servicewatcher/ServiceWatcher;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/location/provider/proxy/ProxyLocationProvider;->mServiceWatcher:Lcom/android/server/servicewatcher/ServiceWatcher;
    ...
    iput-object v1, p0, Lcom/android/server/location/provider/proxy/ProxyLocationProvider;->mRequest:Landroid/location/provider/ProviderRequest;
...
.method public static create(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;II)Lcom/android/server/location/provider/proxy/ProxyLocationProvider;
    ...
    .end local p3    # "enableOverlayResId":I
    .end local p4    # "nonOverlayPackageResId":I
    .local v1, "context":Landroid/content/Context;
    .local v2, "provider":Ljava/lang/String;
    .local v3, "action":Ljava/lang/String;
    .local v4, "enableOverlayResId":I
    .local v5, "nonOverlayPackageResId":I
...
.method public static create(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;III)Lcom/android/server/location/provider/proxy/ProxyLocationProvider;
    ...
    .param p3, "enableOverlayResId"    # I
    .param p4, "nonOverlayPackageResId"    # I
    .param p5, "unstableOverlayFallbackResId"    # I
    ...
    .end local p3    # "enableOverlayResId":I
    .end local p4    # "nonOverlayPackageResId":I
    .end local p5    # "unstableOverlayFallbackResId":I
    .local v1, "context":Landroid/content/Context;
    .local v2, "provider":Ljava/lang/String;
    .local v3, "action":Ljava/lang/String;
    .local v4, "enableOverlayResId":I
    .local v5, "nonOverlayPackageResId":I
    .local v6, "unstableOverlayFallbackResId":I
