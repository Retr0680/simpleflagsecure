...
.method onMessageFromNanoApp(ISLandroid/hardware/location/NanoAppMessage;Ljava/util/List;Ljava/util/List;)B
    ...
    const-string v1, "Received reliable broadcast message from 0x"
    ...
    const-string v1, "Received broadcast message with permissions from 0x"
...
.method registerClient(Landroid/hardware/location/ContextHubInfo;Landroid/app/PendingIntent;JLjava/lang/String;Lcom/android/server/location/contexthub/ContextHubTransactionManager;)Landroid/hardware/location/IContextHubClient;
    ...
    .line 195
    const-string v1, "Regenerated"

    .line 196
    .local v1, "registerString":Ljava/lang/String;
    monitor-enter p0
    ...
    invoke-direct {p0, v0, p2, v9, v10}, Lcom/android/server/location/contexthub/ContextHubClientManager;->getClientBroker(ILandroid/app/PendingIntent;J)Lcom/android/server/location/contexthub/ContextHubClientBroker;
    ...
    .line 201
    .local v7, "hostEndPointId":S
    new-instance v2, Lcom/android/server/location/contexthub/ContextHubClientBroker;

    iget-object v3, p0, Lcom/android/server/location/contexthub/ContextHubClientManager;->mContext:Landroid/content/Context;

    iget-object v4, p0, Lcom/android/server/location/contexthub/ContextHubClientManager;->mContextHubProxy:Lcom/android/server/location/contexthub/IContextHubWrapper;
    ...
    invoke-direct {v3, p0, v4, v6}, Lcom/android/server/location/contexthub/ContextHubClientManager$RegistrationRecord;-><init>(Lcom/android/server/location/contexthub/ContextHubClientManager;Ljava/lang/String;I)V
    ...
    :try_start_1
    invoke-virtual {v0, v11}, Lcom/android/server/location/contexthub/ContextHubClientBroker;->setAttributionTag(Ljava/lang/String;)V
...
.method registerClient(Landroid/hardware/location/ContextHubInfo;Landroid/hardware/location/IContextHubClientCallback;Ljava/lang/String;Lcom/android/server/location/contexthub/ContextHubTransactionManager;Ljava/lang/String;)Landroid/hardware/location/IContextHubClient;
    ...
    invoke-direct {v2, p0, v4, v6}, Lcom/android/server/location/contexthub/ContextHubClientManager$RegistrationRecord;-><init>(Lcom/android/server/location/contexthub/ContextHubClientManager;Ljava/lang/String;I)V
    ...
    const-string v4, "Registered client with host endpoint ID "
    ...
    const-string v4, "Failed to attach death recipient to client"
