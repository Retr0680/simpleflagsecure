...
.method constructor <init>(Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper$Environment;Lcom/android/server/location/gnss/NetworkTimeHelper$InjectTimeCallback;)V
    ...
    iput-object p1, p0, Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper;->mEnvironment:Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper$Environment;
...
.method private maybeInjectNetworkTime(Lcom/android/server/timedetector/NetworkTimeSuggestion;Ljava/lang/String;)V
    ...
    .line 232
    invoke-direct {p0, p1}, Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper;->calculateTimeSignalAgeMillis(Lcom/android/server/timedetector/NetworkTimeSuggestion;)J
    ...
    const-string/jumbo v2, "maybeInjectNetworkTime: Not injecting latest network time latestNetworkTime="
    ...
    invoke-direct {p0, v0}, Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper;->logToDumpLog(Ljava/lang/String;)V

    .line 237
    return-void

    .line 240
    .end local v0    # "debugMsg":Ljava/lang/String;
    :cond_0
    invoke-virtual {p1}, Lcom/android/server/timedetector/NetworkTimeSuggestion;->getUnixEpochTime()Landroid/app/time/UnixEpochTime;
    ...
    .line 242
    .local v3, "unixEpochTimeMillis":J
    ...
    const-string/jumbo v5, "maybeInjectNetworkTime: Injecting latest network time latestNetworkTime="
    ...
    const-string v1, " System time offset millis="
    ...
    invoke-direct {p0, v1}, Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper;->logToDumpLog(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/android/server/timedetector/NetworkTimeSuggestion;->getUncertaintyMillis()I

    move-result v7

    .line 251
    .local v7, "uncertaintyMillis":I
    iget-object v2, p0, Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper;->mInjectTimeCallback:Lcom/android/server/location/gnss/NetworkTimeHelper$InjectTimeCallback;

    invoke-interface/range {v2 .. v7}, Lcom/android/server/location/gnss/NetworkTimeHelper$InjectTimeCallback;->injectTime(JJI)V

    .line 252
    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/server/location/gnss/TimeDetectorNetworkTimeHelper;->mNetworkTimeInjected:Z
