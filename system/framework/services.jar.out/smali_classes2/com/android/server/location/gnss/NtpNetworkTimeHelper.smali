...
.method private synthetic lambda$maybeInjectCachedNtpTime$1(JJI)V
    ...
    .end local p3    # "timeReferenceMillis":J
    .end local p5    # "uncertaintyMillis":I
    .local v1, "unixEpochTimeMillis":J
    .local v3, "timeReferenceMillis":J
...
.method private declared-synchronized maybeInjectCachedNtpTime(Ljava/lang/String;)Z
    ...
    .line 236
    .local v5, "unixEpochTimeMillis":J
    ...
    const-string/jumbo v4, "maybeInjectCachedNtpTime: Injecting latest NTP time, reason="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v4, ", ntpResult="
    ...
    .line 241
    .local v10, "debugMsg":Ljava/lang/String;
    invoke-direct {p0, v10}, Lcom/android/server/location/gnss/NtpNetworkTimeHelper;->logDebug(Ljava/lang/String;)V
    ...
    .line 244
    .local v7, "timeReferenceMillis":J
    invoke-virtual {v0}, Landroid/util/NtpTrustedTime$TimeResult;->getUncertaintyMillis()I

    move-result v9

    .line 245
    .local v9, "uncertaintyMillis":I
    iget-object v11, p0, Lcom/android/server/location/gnss/NtpNetworkTimeHelper;->mHandler:Landroid/os/Handler;
    ...
    :try_start_1
    invoke-direct/range {v3 .. v9}, Lcom/android/server/location/gnss/NtpNetworkTimeHelper$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/location/gnss/NtpNetworkTimeHelper;JJI)V
    ...
    .line 224
    .end local v0    # "ntpResult":Landroid/util/NtpTrustedTime$TimeResult;
    .end local v1    # "currentTimeMillis":J
    .end local v5    # "unixEpochTimeMillis":J
    .end local v7    # "timeReferenceMillis":J
    .end local v9    # "uncertaintyMillis":I
    .end local v10    # "debugMsg":Ljava/lang/String;
    ...
    .line 226
    .restart local v0    # "ntpResult":Landroid/util/NtpTrustedTime$TimeResult;
    ...
    invoke-direct {p0, v1}, Lcom/android/server/location/gnss/NtpNetworkTimeHelper;->logDebug(Ljava/lang/String;)V
    :try_end_2
