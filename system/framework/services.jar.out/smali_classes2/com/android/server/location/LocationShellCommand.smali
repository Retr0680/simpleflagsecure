...
.method private handleAddTestProvider()V
    ...
    .line 234
    .end local v0    # "requiresNetwork":Z
    .end local v2    # "requiresSatellite":Z
    .end local v4    # "hasMonetaryCost":Z
    .end local v5    # "supportsAltitude":Z
    .local v3, "extraAttributionTags":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v6, "requiresNetwork":Z
    .local v7, "requiresSatellite":Z
    .local v8, "requiresCell":Z
    .local v9, "hasMonetaryCost":Z
    .local v10, "supportsAltitude":Z
    .local v11, "supportsSpeed":Z
    .local v12, "supportsBearing":Z
    .local v13, "powerRequirement":I
    .local v14, "accuracy":I
    :goto_0
    ...
    .line 286
    invoke-virtual {v0, v6}, Landroid/location/provider/ProviderProperties$Builder;->setHasNetworkRequirement(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 287
    invoke-virtual {v0, v7}, Landroid/location/provider/ProviderProperties$Builder;->setHasSatelliteRequirement(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 288
    invoke-virtual {v0, v8}, Landroid/location/provider/ProviderProperties$Builder;->setHasCellRequirement(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 289
    invoke-virtual {v0, v9}, Landroid/location/provider/ProviderProperties$Builder;->setHasMonetaryCost(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 290
    invoke-virtual {v0, v10}, Landroid/location/provider/ProviderProperties$Builder;->setHasAltitudeSupport(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 291
    invoke-virtual {v0, v11}, Landroid/location/provider/ProviderProperties$Builder;->setHasSpeedSupport(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 292
    invoke-virtual {v0, v12}, Landroid/location/provider/ProviderProperties$Builder;->setHasBearingSupport(Z)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 293
    invoke-virtual {v0, v13}, Landroid/location/provider/ProviderProperties$Builder;->setPowerUsage(I)Landroid/location/provider/ProviderProperties$Builder;

    move-result-object v0

    .line 294
    invoke-virtual {v0, v14}, Landroid/location/provider/ProviderProperties$Builder;->setAccuracy(I)Landroid/location/provider/ProviderProperties$Builder;
    ...
    .line 296
    .local v2, "properties":Landroid/location/provider/ProviderProperties;
    ...
    .line 238
    .end local v2    # "properties":Landroid/location/provider/ProviderProperties;
    ...
    const-string v5, "Received unexpected option: "
    ...
    .line 277
    .end local v3    # "extraAttributionTags":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .restart local v3    # "extraAttributionTags":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :pswitch_1
    invoke-virtual {p0}, Lcom/android/modules/utils/BasicShellCommandHandler;->getNextArgRequired()Ljava/lang/String;
    ...
    .line 269
    .end local v13    # "powerRequirement":I
    ...
    .restart local v13    # "powerRequirement":I
    :pswitch_3
    const/4 v2, 0x1

    .line 265
    .end local v12    # "supportsBearing":Z
    ...
    .restart local v12    # "supportsBearing":Z
    :pswitch_4
    const/4 v2, 0x1

    .line 261
    .end local v11    # "supportsSpeed":Z
    ...
    .restart local v11    # "supportsSpeed":Z
    :pswitch_5
    const/4 v2, 0x1

    .line 257
    .end local v10    # "supportsAltitude":Z
    ...
    .restart local v10    # "supportsAltitude":Z
    :pswitch_6
    const/4 v2, 0x1

    .line 253
    .end local v9    # "hasMonetaryCost":Z
    ...
    .restart local v9    # "hasMonetaryCost":Z
    :pswitch_7
    const/4 v2, 0x1

    .line 249
    .end local v8    # "requiresCell":Z
    ...
    .restart local v8    # "requiresCell":Z
    :pswitch_8
    const/4 v2, 0x1

    .line 245
    .end local v7    # "requiresSatellite":Z
    .local v2, "requiresSatellite":Z
    move v7, v2
    ...
    .line 240
    .end local v2    # "requiresSatellite":Z
    .restart local v7    # "requiresSatellite":Z
    :pswitch_9
    const/4 v2, 0x1

    .line 241
    .end local v6    # "requiresNetwork":Z
    ...
    .restart local v6    # "requiresNetwork":Z
    :goto_3
    goto/16 :goto_0
