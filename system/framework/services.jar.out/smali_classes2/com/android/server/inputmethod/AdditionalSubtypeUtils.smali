...
.field private static final ATTR_LAYOUT_LABEL:Ljava/lang/String; = "layoutLabel"

.field private static final ATTR_LAYOUT_LABEL_NON_LOCALIZED:Ljava/lang/String; = "layoutLabelNonLocalized"
...
.method static loadFromFile(Landroid/util/AtomicFile;)Lcom/android/server/inputmethod/AdditionalSubtypeMap;
    ...
    .local v13, "tempSubtypesArray":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/inputmethod/InputMethodSubtype;>;"
    ...
    .line 270
    .end local v13    # "tempSubtypesArray":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/inputmethod/InputMethodSubtype;>;"
    ...
    .line 282
    const-string/jumbo v7, "layoutLabel"

    invoke-interface {v4, v14, v7}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;)I

    move-result v7

    .line 283
    .local v7, "layoutLabelResource":I
    const-string/jumbo v14, "layoutLabelNonLocalized"
    :try_end_8
    ...
    .local v16, "allSubtypes":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    :try_start_9
    invoke-interface {v4, v2, v14}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v14

    .line 289
    .local v14, "layoutLabelNonLocalized":Ljava/lang/String;
    const-string/jumbo v2, "pkLanguageTag"
    :try_end_9
    ...
    .line 291
    .local v2, "pkLanguageTag":Ljava/lang/String;
    const-string/jumbo v3, "pkLayoutType"
    ...
    .end local v5    # "type":I
    .local v18, "type":I
    invoke-interface {v4, v5, v3}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 293
    .local v3, "pkLayoutType":Ljava/lang/String;
    ...
    .end local v3    # "pkLayoutType":Ljava/lang/String;
    .local v19, "pkLayoutType":Ljava/lang/String;
    invoke-interface {v4, v3, v5}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .line 295
    .local v5, "imeSubtypeLocale":Ljava/lang/String;
    const-string/jumbo v3, "languageTag"
    ...
    .local v20, "firstNodeName":Ljava/lang/String;
    ...
    const-string/jumbo v9, "imeSubtypeExtraValue"
    ...
    const-string/jumbo v12, "isAsciiCapable"
    ...
    .local v24, "currentImiId":Ljava/lang/String;
    invoke-interface {v4, v10, v12}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 307
    invoke-virtual {v12, v15}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setSubtypeNameResId(I)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;

    move-result-object v12

    .line 308
    invoke-virtual {v12, v7}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setLayoutLabelResource(I)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;
    ...
    .end local v2    # "pkLanguageTag":Ljava/lang/String;
    ...
    .end local v7    # "layoutLabelResource":I
    .end local v8    # "imeSubtypeMode":Ljava/lang/String;
    .end local v9    # "imeSubtypeExtraValue":Ljava/lang/String;
    .end local v10    # "isAsciiCapable":Z
    .end local v11    # "tempSubtypesArray":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/inputmethod/InputMethodSubtype;>;"
    .end local v13    # "icon":I
    .end local v14    # "layoutLabelNonLocalized":Ljava/lang/String;
    .end local v15    # "label":I
    .end local v18    # "type":I
    .end local v19    # "pkLayoutType":Ljava/lang/String;
    .end local v20    # "firstNodeName":Ljava/lang/String;
    .end local v21    # "depth":I
    .end local v22    # "nodeName":Ljava/lang/String;
    .end local v24    # "currentImiId":Ljava/lang/String;
    :catchall_1
    move-exception v0
    ...
    .line 311
    .restart local v1    # "isAuxiliary":Z
    .restart local v2    # "pkLanguageTag":Ljava/lang/String;
    .restart local v3    # "languageTag":Ljava/lang/String;
    .restart local v4    # "parser":Lcom/android/modules/utils/TypedXmlPullParser;
    .restart local v5    # "imeSubtypeLocale":Ljava/lang/String;
    .restart local v6    # "untranslatableName":Ljava/lang/String;
    .restart local v7    # "layoutLabelResource":I
    .restart local v8    # "imeSubtypeMode":Ljava/lang/String;
    .restart local v9    # "imeSubtypeExtraValue":Ljava/lang/String;
    .restart local v10    # "isAsciiCapable":Z
    .restart local v11    # "tempSubtypesArray":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/view/inputmethod/InputMethodSubtype;>;"
    .restart local v13    # "icon":I
    .restart local v14    # "layoutLabelNonLocalized":Ljava/lang/String;
    .restart local v15    # "label":I
    .restart local v18    # "type":I
    .restart local v19    # "pkLayoutType":Ljava/lang/String;
    .restart local v20    # "firstNodeName":Ljava/lang/String;
    .restart local v21    # "depth":I
    .restart local v22    # "nodeName":Ljava/lang/String;
    .restart local v24    # "currentImiId":Ljava/lang/String;
    :cond_8
    move-object/from16 v26, v2
    ...
    .line 309
    .end local v2    # "pkLanguageTag":Ljava/lang/String;
    .local v26, "pkLanguageTag":Ljava/lang/String;
    :goto_4
    invoke-virtual {v12, v0, v2}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setPhysicalKeyboardHint(Landroid/icu/util/ULocale;Ljava/lang/String;)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;
    ...
    .line 314
    invoke-virtual {v0, v3}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setLanguageTag(Ljava/lang/String;)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;

    move-result-object v0

    .line 315
    invoke-virtual {v0, v8}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setSubtypeMode(Ljava/lang/String;)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;
    ...
    .line 318
    invoke-virtual {v0, v10}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setIsAsciiCapable(Z)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;
    ...
    .end local v1    # "isAuxiliary":Z
    .local v27, "isAuxiliary":Z
    invoke-interface {v4, v1, v2, v12}, Lcom/android/modules/utils/TypedXmlPullParser;->getAttributeInt(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    .line 328
    invoke-virtual {v0, v14}, Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;->setLayoutLabelNonLocalized(Ljava/lang/CharSequence;)Landroid/view/inputmethod/InputMethodSubtype$InputMethodSubtypeBuilder;
    ...
    .end local v22    # "nodeName":Ljava/lang/String;
    .end local v24    # "currentImiId":Ljava/lang/String;
    .end local v26    # "pkLanguageTag":Ljava/lang/String;
    .end local v27    # "isAuxiliary":Z
    :catchall_2
    move-exception v0
    ...
    .end local v16    # "allSubtypes":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .end local v17    # "fis":Ljava/io/FileInputStream;
    .local v2, "allSubtypes":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    ...
    .end local v2    # "allSubtypes":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .end local v3    # "fis":Ljava/io/FileInputStream;
    .restart local v16    # "allSubtypes":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .restart local v17    # "fis":Ljava/io/FileInputStream;
    goto/16 :goto_b
...
.method static saveToFile(Lcom/android/server/inputmethod/AdditionalSubtypeMap;Lcom/android/server/inputmethod/InputMethodMap;Landroid/util/AtomicFile;)V
    ...
    invoke-virtual {v1}, Lcom/android/server/inputmethod/InputMethodMap;->size()I
    ...
    .line 184
    const-string/jumbo v1, "layoutLabel"

    invoke-virtual {v7}, Landroid/view/inputmethod/InputMethodSubtype;->getLayoutLabelResource()I
    ...
    .line 185
    const-string/jumbo v1, "layoutLabelNonLocalized"

    .line 186
    invoke-virtual {v7}, Landroid/view/inputmethod/InputMethodSubtype;->getLayoutLabelNonLocalized()Ljava/lang/CharSequence;
    ...
    invoke-interface {v10, v12, v3}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {v10, v12, v4}, Lcom/android/modules/utils/TypedXmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
