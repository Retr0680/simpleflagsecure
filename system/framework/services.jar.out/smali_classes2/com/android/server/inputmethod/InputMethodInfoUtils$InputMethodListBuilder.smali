...
.method synthetic constructor <init>(Lcom/android/server/inputmethod/InputMethodInfoUtils-IA;)V
    .locals 0
...
.method fillImes(Ljava/util/List;Landroid/content/Context;ZLjava/util/Locale;ZLjava/lang/String;)Lcom/android/server/inputmethod/InputMethodInfoUtils$InputMethodListBuilder;
    ...
    .end local p3    # "checkDefaultAttribute":Z
    .end local p4    # "locale":Ljava/util/Locale;
    .end local p5    # "checkCountry":Z
    .end local p6    # "requiredSubtypeMode":Ljava/lang/String;
    .local v3, "context":Landroid/content/Context;
    .local v4, "checkDefaultAttribute":Z
    .local v5, "locale":Ljava/util/Locale;
    .local v6, "checkCountry":Z
    .local v7, "requiredSubtypeMode":Ljava/lang/String;
    ...
    .end local v4    # "checkDefaultAttribute":Z
    .end local v5    # "locale":Ljava/util/Locale;
    .end local v6    # "checkCountry":Z
    .end local v7    # "requiredSubtypeMode":Ljava/lang/String;
    .restart local p2    # "context":Landroid/content/Context;
    .restart local p3    # "checkDefaultAttribute":Z
    .restart local p4    # "locale":Ljava/util/Locale;
    .restart local p5    # "checkCountry":Z
    .restart local p6    # "requiredSubtypeMode":Ljava/lang/String;
    :cond_1
    nop
