...
.method private runFabricate()I
    ...
    .line 268
    .local v6, "err":Ljava/io/PrintWriter;
    ...
    .local v9, "targetOverlayable":Ljava/lang/String;
    ...
    .line 286
    .end local v9    # "targetOverlayable":Ljava/lang/String;
    .local v1, "targetOverlayable":Ljava/lang/String;
    move-object v9, v1

    goto :goto_3

    .line 282
    .end local v1    # "targetOverlayable":Ljava/lang/String;
    .restart local v9    # "targetOverlayable":Ljava/lang/String;
    :pswitch_4
    invoke-virtual {v0}, Landroid/os/ShellCommand;->getNextArgRequired()Ljava/lang/String;
    ...
    .line 299
    .end local v1    # "targetPackage":Ljava/lang/String;
    .restart local v8    # "targetPackage":Ljava/lang/String;
    :goto_3
    goto :goto_0
    ...
    .line 312
    const-string v1, "Error: When passing --file don\'t pass resource name, type, and value as well"
    ...
    .line 317
    .local v14, "overlayPackageName":Ljava/lang/String;
    new-instance v1, Landroid/content/om/FabricatedOverlay;

    invoke-direct {v1, v10, v8}, Landroid/content/om/FabricatedOverlay;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 318
    .local v1, "overlay":Landroid/content/om/FabricatedOverlay;
    invoke-virtual {v1, v9}, Landroid/content/om/FabricatedOverlay;->setTargetOverlayable(Ljava/lang/String;)V

    .line 319
    const-string v2, "com.android.shell"

    invoke-virtual {v1, v2}, Landroid/content/om/FabricatedOverlay;->setOwningPackage(Ljava/lang/String;)V

    .line 320
    if-eqz v11, :cond_7

    .line 321
    invoke-direct {v0, v1, v8, v11}, Lcom/android/server/om/OverlayManagerShellCommand;->addOverlayValuesFromXml(Landroid/content/om/FabricatedOverlay;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v4, v15}, Ljava/lang/String;->join(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    :cond_8
    :goto_4
    iget-object v2, v0, Lcom/android/server/om/OverlayManagerShellCommand;->mInterface:Landroid/content/om/IOverlayManager;
    ...
    .line 335
    invoke-virtual {v3, v1}, Landroid/content/om/OverlayManagerTransaction$Builder;->registerFabricatedOverlay(Landroid/content/om/FabricatedOverlay;)Landroid/content/om/OverlayManagerTransaction$Builder;
    ...
    .line 334
    invoke-interface {v2, v3}, Landroid/content/om/IOverlayManager;->commit(Landroid/content/om/OverlayManagerTransaction;)V
...
.method private runLookup()I
    ...
    .line 525
    :cond_2
    const-string/jumbo v0, "runLookup"

    invoke-static {v3, v0}, Lcom/android/server/om/OverlayManagerService;->handleIncomingUser(ILjava/lang/String;)I

    move-result v12

    .line 528
    .local v12, "realUserId":I
    move-object/from16 v13, p0
    ...
    .end local v19    # "resolvedString":Ljava/lang/CharSequence;
    .local v0, "resolvedString":Ljava/lang/CharSequence;
    .local v6, "valueString":Ljava/lang/CharSequence;
    .local v17, "value":Landroid/util/TypedValue;
    :try_start_4
    invoke-interface {v6, v0}, Ljava/lang/CharSequence;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v15, v3}, Landroid/content/res/AssetManager;->setResourceResolutionLoggingEnabled(Z)V

    .line 560
    return v3

    .line 592
    .end local v0    # "resolvedString":Ljava/lang/CharSequence;
    .end local v6    # "valueString":Ljava/lang/CharSequence;
    .end local v7    # "resolution":Ljava/lang/String;
    ...
    invoke-virtual {v14, v4, v3, v0}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .restart local v7    # "array":Landroid/content/res/TypedArray;
    :cond_5
    move-object/from16 v17, v0
    ...
    .line 581
    invoke-virtual {v7, v3, v0}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z
    ...
    .restart local v12    # "realUserId":I
    ...
    const-string v4, "Error: failed to get the resource "
    ...
    .line 533
    const-string v4, "Error: failed to get resources for package %s for user %d"
...
.method public onHelp()V
    ...
    .line 149
    const-string v1, "  fabricate [--target-name OVERLAYABLE] --target PACKAGE"
