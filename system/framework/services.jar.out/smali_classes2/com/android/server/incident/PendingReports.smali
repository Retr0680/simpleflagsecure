...
.method private authorizeReportImpl(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/IIncidentAuthListener;)V
    ...
    const-string v4, " doesn\'t match package "
    ...
    .line 281
    invoke-direct {v1, v6, v2}, Lcom/android/server/incident/PendingReports;->denyReportBeforeAddingRec(Landroid/os/IIncidentAuthListener;Ljava/lang/String;)V
    ...
    .line 286
    :cond_0
    invoke-direct {v1}, Lcom/android/server/incident/PendingReports;->getCurrentUserIfAdmin()I

    move-result v8

    .line 287
    .local v8, "currentAdminUser":I
    ...
    .line 292
    invoke-direct {v1, v9, v8}, Lcom/android/server/incident/PendingReports;->isSameProfileGroupUser(II)Z
    ...
    .line 300
    :cond_1
    invoke-direct {v1, v8}, Lcom/android/server/incident/PendingReports;->getApproverComponent(I)Landroid/content/ComponentName;
    ...
    invoke-direct {v0, v7}, Landroid/content/AttributionSource$Builder;-><init>(I)V

    .line 309
    invoke-virtual {v0, v2}, Landroid/content/AttributionSource$Builder;->setPackageName(Ljava/lang/String;)Landroid/content/AttributionSource$Builder;
    ...
    .line 317
    iget-object v3, v1, Lcom/android/server/incident/PendingReports;->mPermissionManager:Landroid/permission/PermissionManager;

    const-string v13, "android.permission.CAPTURE_CONSENTLESS_BUGREPORT_ON_USERDEBUG_BUILD"

    .line 318
    invoke-virtual {v3, v13, v11, v5}, Landroid/permission/PermissionManager;->checkPermissionForDataDelivery(Ljava/lang/String;Landroid/content/AttributionSource;Ljava/lang/String;)I
    ...
    .local v13, "captureConsentlessBugreportOnUserdebugBuildGranted":Z
    :goto_1
    iget-object v0, v1, Lcom/android/server/incident/PendingReports;->mPermissionManager:Landroid/permission/PermissionManager;

    const-string v3, "android.permission.CAPTURE_CONSENTLESS_BUGREPORT_DELEGATED_CONSENT"

    .line 328
    invoke-virtual {v0, v3, v11, v5}, Landroid/permission/PermissionManager;->checkPermissionForDataDelivery(Ljava/lang/String;Landroid/content/AttributionSource;Ljava/lang/String;)I
    ...
    .line 334
    .local v14, "captureConsentlessBugreportDelegatedConsentGranted":Z
    if-nez v13, :cond_7
    ...
    .line 343
    .restart local v0    # "rec":Lcom/android/server/incident/PendingReports$PendingReportRec;
    :cond_8
    :goto_3
    if-eqz v14, :cond_9
    ...
    const-string v4, "delegating consent for report: "
    ...
    const-string v3, "authorizeReportImpl listener.onReportApproved RemoteException: "
    ...
    .line 355
    .local v15, "rec":Lcom/android/server/incident/PendingReports$PendingReportRec;
    iget-object v2, v1, Lcom/android/server/incident/PendingReports;->mLock:Ljava/lang/Object;
    ...
    .line 357
    iget-object v0, v1, Lcom/android/server/incident/PendingReports;->mPending:Ljava/util/ArrayList;
    ...
    new-instance v3, Lcom/android/server/incident/PendingReports$$ExternalSyntheticLambda2;

    invoke-direct {v3, v1, v6, v10, v8}, Lcom/android/server/incident/PendingReports$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/incident/PendingReports;Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V

    invoke-interface {v0, v3, v12}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_3
    ...
    const-string v5, "Remote died while trying to register death listener: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v15}, Lcom/android/server/incident/PendingReports$PendingReportRec;->getUri()Landroid/net/Uri;
    ...
    .line 368
    invoke-direct {v1, v6, v10, v8}, Lcom/android/server/incident/PendingReports;->cancelReportImpl(Landroid/os/IIncidentAuthListener;Landroid/content/ComponentName;I)V

    .line 372
    .end local v0    # "ex":Landroid/os/RemoteException;
    :goto_5
    invoke-direct {v1, v10, v8}, Lcom/android/server/incident/PendingReports;->sendBroadcast(Landroid/content/ComponentName;I)V
    ...
    .end local v13    # "captureConsentlessBugreportOnUserdebugBuildGranted":Z
    .end local v14    # "captureConsentlessBugreportDelegatedConsentGranted":Z
    .end local v15    # "rec":Lcom/android/server/incident/PendingReports$PendingReportRec;
    :cond_b
    :goto_7
    const-string v0, "IncidentCompanionService"
    ...
    const-string v4, " doesn\'t belong to the same profile group of the current admin user "
...
.method private findAndRemovePendingReportRecLocked(Ljava/lang/String;)Lcom/android/server/incident/PendingReports$PendingReportRec;
    ...
    .local v2, "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/incident/PendingReports$PendingReportRec;>;"
    :goto_0
    ...
    .line 455
    .end local v2    # "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/server/incident/PendingReports$PendingReportRec;>;"
    return-object v1
