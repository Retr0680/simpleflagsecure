...
.method private createService(ILandroid/content/ComponentName;)Lcom/android/server/speech/RemoteSpeechRecognitionService;
    ...
    .line 278
    .local v0, "servicesForClient":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    const/4 v2, 0x0
    ...
    .line 343
    .end local v0    # "servicesForClient":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    :catchall_0
    move-exception v0
    ...
    .line 287
    .restart local v0    # "servicesForClient":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    :cond_0
    :try_start_2
    ...
    :goto_0
    new-instance v3, Lcom/android/server/speech/RemoteSpeechRecognitionService;
    ...
    .end local p2    # "serviceComponent":Landroid/content/ComponentName;
    ...
    new-instance v2, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda1;

    invoke-direct {v2}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda1;-><init>()V

    invoke-interface {p1, p2, v2}, Ljava/util/Map;->computeIfAbsent(Ljava/lang/Object;Ljava/util/function/Function;)Ljava/lang/Object;
    ...
    .line 335
    .local p1, "valuesByCaller":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    ...
    check-cast p2, Lcom/android/server/speech/SpeechRecognitionManagerService;

    iget-boolean p2, p2, Lcom/android/server/infra/AbstractMasterSystemService;->debug:Z
    ...
    const-string v4, "Creating a new connection to "
    ...
    .end local p1    # "valuesByCaller":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    :catchall_1
    move-exception v0
    ...
    .line 341
    .restart local v0    # "servicesForClient":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    .restart local v3    # "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .restart local v8    # "isPrivileged":Z
    .restart local p1    # "valuesByCaller":Ljava/util/Set;, "Ljava/util/Set<Lcom/android/server/speech/RemoteSpeechRecognitionService;>;"
    :cond_6
    :goto_1
    invoke-direct {p0, v7}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->incrementSessionCountForUidLocked(I)V
    ...
    .restart local p2    # "serviceComponent":Landroid/content/ComponentName;
    :catchall_2
    move-exception v0
...
.method private synthetic lambda$createSessionLocked$1(Landroid/speech/IRecognitionServiceManagerCallback;Lcom/android/server/speech/RemoteSpeechRecognitionService;Landroid/os/IBinder;ILandroid/os/IBinder$DeathRecipient;Landroid/speech/IRecognitionService;)V
    ...
    .end local p2    # "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .end local p3    # "clientToken":Landroid/os/IBinder;
    .end local p4    # "creatorCallingUid":I
    .end local p5    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    .local v4, "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .local v5, "clientToken":Landroid/os/IBinder;
    .local v6, "creatorCallingUid":I
    ...
    .end local v4    # "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .end local v5    # "clientToken":Landroid/os/IBinder;
    .end local v6    # "creatorCallingUid":I
    .end local v7    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    .restart local p2    # "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .restart local p3    # "clientToken":Landroid/os/IBinder;
    .restart local p4    # "creatorCallingUid":I
    .restart local p5    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    :catch_1
    move-exception v0
    ...
    .end local p4    # "creatorCallingUid":I
    .end local p5    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    .restart local v4    # "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .restart local v5    # "clientToken":Landroid/os/IBinder;
    .restart local v6    # "creatorCallingUid":I
    .restart local v7    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    ...
    .end local v6    # "creatorCallingUid":I
    .end local v7    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    .local p2, "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    .restart local p3    # "clientToken":Landroid/os/IBinder;
    .restart local p4    # "creatorCallingUid":I
    .restart local p5    # "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    :cond_0
...
.method createSessionLocked(Landroid/content/ComponentName;Landroid/os/IBinder;ZLandroid/speech/IRecognitionServiceManagerCallback;)V
    ...
    const-string v3, "Isolated process can only start on device speech recognizer."
    ...
    const-string v3, "Service component is undefined, responding with error."
    ...
    .line 131
    .local v9, "creatorCallingUid":I
    invoke-direct {p0, v9, v1}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->createService(ILandroid/content/ComponentName;)Lcom/android/server/speech/RemoteSpeechRecognitionService;

    move-result-object v7

    .line 133
    .local v7, "service":Lcom/android/server/speech/RemoteSpeechRecognitionService;
    if-nez v7, :cond_5
    ...
    .line 138
    :cond_5
    new-instance v10, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda2;

    invoke-direct {v10, p0, p2, v9, v7}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;Landroid/os/IBinder;ILcom/android/server/speech/RemoteSpeechRecognitionService;)V

    .line 143
    .local v10, "deathRecipient":Landroid/os/IBinder$DeathRecipient;
    const/4 v0, 0x0

    :try_start_0
    invoke-interface {p2, v10, v0}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 150
    invoke-virtual {v7}, Lcom/android/internal/infra/ServiceConnector$Impl;->connect()Lcom/android/internal/infra/AndroidFuture;
    ...
    .end local p4    # "callback":Landroid/speech/IRecognitionServiceManagerCallback;
    .local v6, "callback":Landroid/speech/IRecognitionServiceManagerCallback;
    .local v8, "clientToken":Landroid/os/IBinder;
    invoke-direct/range {v4 .. v10}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;Landroid/speech/IRecognitionServiceManagerCallback;Lcom/android/server/speech/RemoteSpeechRecognitionService;Landroid/os/IBinder;ILandroid/os/IBinder$DeathRecipient;)V

    invoke-virtual {v0, v4}, Lcom/android/internal/infra/AndroidFuture;->thenAccept(Ljava/util/function/Consumer;)Ljava/util/concurrent/CompletableFuture;

    .line 218
    return-void

    .line 144
    .end local v6    # "callback":Landroid/speech/IRecognitionServiceManagerCallback;
    .end local v8    # "clientToken":Landroid/os/IBinder;
    .restart local p2    # "clientToken":Landroid/os/IBinder;
    .restart local p4    # "callback":Landroid/speech/IRecognitionServiceManagerCallback;
    :catch_0
    move-exception v0
    ...
    .line 146
    .end local p4    # "callback":Landroid/speech/IRecognitionServiceManagerCallback;
    .restart local v6    # "callback":Landroid/speech/IRecognitionServiceManagerCallback;
    .restart local v8    # "clientToken":Landroid/os/IBinder;
    .local p2, "e":Landroid/os/RemoteException;
    const/4 p4, 0x1

    invoke-direct {p0, v8, v9, v7, p4}, Lcom/android/server/speech/SpeechRecognitionManagerServiceImpl;->handleClientDeath(Landroid/os/IBinder;ILcom/android/server/speech/RemoteSpeechRecognitionService;Z)V
