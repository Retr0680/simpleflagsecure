...
.method public getHealthInfo()Landroid/hardware/health/HealthInfo;
    ...
    invoke-direct {v2, v1}, Lcom/android/server/health/HealthServiceWrapperHidl$Mutable;-><init>(Lcom/android/server/health/HealthServiceWrapperHidl-IA;)V

    .line 157
    .local v2, "ret":Lcom/android/server/health/HealthServiceWrapperHidl$Mutable;, "Lcom/android/server/health/HealthServiceWrapperHidl$Mutable<Landroid/hardware/health/HealthInfo;>;"
    new-instance v1, Lcom/android/server/health/HealthServiceWrapperHidl$$ExternalSyntheticLambda0;

    invoke-direct {v1, v2}, Lcom/android/server/health/HealthServiceWrapperHidl$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/health/HealthServiceWrapperHidl$Mutable;)V

    invoke-interface {v0, v1}, Landroid/hardware/health/V2_0/IHealth;->getHealthInfo(Landroid/hardware/health/V2_0/IHealth$getHealthInfoCallback;)V

    .line 163
    iget-object v1, v2, Lcom/android/server/health/HealthServiceWrapperHidl$Mutable;->value:Ljava/lang/Object;
