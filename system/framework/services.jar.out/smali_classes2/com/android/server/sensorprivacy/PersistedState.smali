...
.method private static readPVersion2(Lcom/android/modules/utils/TypedXmlPullParser;Lcom/android/server/sensorprivacy/PersistedState$PVersion2;)V
    ...
    .line 225
    .local v6, "state":I
    const-string/jumbo v0, "last-change"
    ...
    .end local p1    # "version2":Lcom/android/server/sensorprivacy/PersistedState$PVersion2;
    .local v2, "version2":Lcom/android/server/sensorprivacy/PersistedState$PVersion2;
    ...
    .line 229
    .end local v2    # "version2":Lcom/android/server/sensorprivacy/PersistedState$PVersion2;
    .restart local p1    # "version2":Lcom/android/server/sensorprivacy/PersistedState$PVersion2;
    :cond_0
    move-object v2, p1

    .end local p1    # "version2":Lcom/android/server/sensorprivacy/PersistedState$PVersion2;
    .restart local v2    # "version2":Lcom/android/server/sensorprivacy/PersistedState$PVersion2;
    invoke-static {p0}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private readState()V
    ...
    invoke-direct {v9, v8, v6}, Lcom/android/server/sensorprivacy/PersistedState$PVersion0;-><init>(ILcom/android/server/sensorprivacy/PersistedState-IA;)V
    ...
    invoke-direct {v9, v8, v6}, Lcom/android/server/sensorprivacy/PersistedState$PVersion1;-><init>(ILcom/android/server/sensorprivacy/PersistedState-IA;)V
    ...
    invoke-direct {v9, v8, v6}, Lcom/android/server/sensorprivacy/PersistedState$PVersion2;-><init>(ILcom/android/server/sensorprivacy/PersistedState-IA;)V
    ...
    invoke-direct {v2, v5, v6}, Lcom/android/server/sensorprivacy/PersistedState$PVersion2;-><init>(ILcom/android/server/sensorprivacy/PersistedState-IA;)V
...
.method dump(Lcom/android/internal/util/dump/DualDumpOutputStream;)V
    ...
    .line 329
    .local v7, "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    ...
    .line 336
    .local v6, "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    if-nez v6, :cond_0
    ...
    .end local v4    # "userId":I
    .end local v5    # "sensor":I
    .end local v6    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    ...
    invoke-virtual {v1, v3, v4, v5, v2}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JLjava/lang/String;)V
    ...
    .line 351
    .local v12, "userToken":J
    const-string/jumbo v2, "user_id"

    const-wide v14, 0x10500000001L

    invoke-virtual {v1, v2, v14, v15, v11}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V
    ...
    .line 353
    .local v2, "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    ...
    check-cast v14, Lcom/android/server/sensorprivacy/SensorState;

    .line 358
    .local v14, "sensorState":Lcom/android/server/sensorprivacy/SensorState;
    const-string/jumbo v15, "sensors"

    move-object/from16 v16, v2

    move/from16 v19, v3

    .end local v2    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    .end local v3    # "numSensors":I
    .local v16, "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    .local v19, "numSensors":I
    const-wide v2, 0x20b00000004L

    invoke-virtual {v1, v15, v2, v3}, Lcom/android/internal/util/dump/DualDumpOutputStream;->start(Ljava/lang/String;J)J

    move-result-wide v2

    .line 359
    .local v2, "sensorToken":J
    const-string/jumbo v15, "sensor"
    ...
    .end local v2    # "sensorToken":J
    .end local v4    # "j":I
    .local v20, "j":I
    .local v21, "sensorToken":J
    invoke-virtual {v1, v15, v3, v4, v5}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V
    ...
    .line 361
    .local v2, "toggleToken":J
    const-string/jumbo v4, "toggle_type"

    move-wide/from16 v23, v2

    .end local v2    # "toggleToken":J
    .local v23, "toggleToken":J
    const-wide v2, 0x10e00000004L

    invoke-virtual {v1, v4, v2, v3, v6}, Lcom/android/internal/util/dump/DualDumpOutputStream;->write(Ljava/lang/String;JI)V

    .line 364
    nop

    .line 366
    invoke-virtual {v14}, Lcom/android/server/sensorprivacy/SensorState;->getState()I
    ...
    .end local v6    # "toggleType":I
    .local v2, "toggleType":I
    invoke-virtual {v14}, Lcom/android/server/sensorprivacy/SensorState;->getLastChange()J
    ...
    .end local v10    # "i":I
    .local v7, "sensorToken":J
    .local v9, "toggleToken":J
    .local v21, "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    .local v22, "numStates":I
    .local v23, "numUsers":I
    .local v24, "i":I
    ...
    .line 354
    .end local v7    # "sensorToken":J
    .end local v9    # "toggleToken":J
    .end local v14    # "sensorState":Lcom/android/server/sensorprivacy/SensorState;
    .end local v15    # "sensor":I
    .end local v25    # "toggleType":I
    ...
    .end local v16    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    .end local v19    # "numSensors":I
    .end local v21    # "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    .end local v22    # "numStates":I
    .end local v23    # "numUsers":I
    .end local v24    # "i":I
    .local v2, "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    .local v3, "numSensors":I
    .local v7, "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    .restart local v8    # "numStates":I
    .local v9, "numUsers":I
    ...
    .end local v3    # "numSensors":I
    .end local v4    # "j":I
    .end local v7    # "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    .end local v8    # "numStates":I
    .end local v9    # "numUsers":I
    .end local v10    # "i":I
    .restart local v16    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    .restart local v19    # "numSensors":I
    .restart local v21    # "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    .restart local v22    # "numStates":I
    .restart local v23    # "numUsers":I
    .restart local v24    # "i":I
    invoke-virtual {v1, v12, v13}, Lcom/android/internal/util/dump/DualDumpOutputStream;->end(J)V

    .line 348
    .end local v11    # "userId":I
    .end local v12    # "userToken":J
    .end local v16    # "userStates":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;"
    .end local v19    # "numSensors":I
    ...
    .end local v22    # "numStates":I
    .end local v23    # "numUsers":I
    .restart local v7    # "statesMatrix":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/util/SparseArray<Landroid/util/Pair<Ljava/lang/Integer;Lcom/android/server/sensorprivacy/SensorState;>;>;>;"
    .restart local v8    # "numStates":I
