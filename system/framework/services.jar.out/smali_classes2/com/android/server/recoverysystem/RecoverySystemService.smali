...
.method private armRebootEscrow(Ljava/lang/String;Z)Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;
    ...
    const-string v4, "Failure to escrow key for reboot, providerErrorCode: "
    ...
    invoke-direct {v0, v5, v6}, Lcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;-><init>(II)V
    ...
    .line 871
    .end local v6    # "providerErrorCode":I
    :goto_0
    invoke-static {v2, v3}, Landroid/os/Binder;->restoreCallingIdentity(J)V
...
.method private reportMetricsOnRebootWithLskf(Ljava/lang/String;ZLcom/android/server/recoverysystem/RecoverySystemService$RebootPreparationError;)V
    ...
    .line 898
    .local v5, "uid":I
    invoke-direct {v1}, Lcom/android/server/recoverysystem/RecoverySystemService;->useServerBasedRoR()Z

    move-result v9

    .line 900
    .local v9, "serverBased":Z
    monitor-enter p0
    ...
    .line 907
    .local v14, "prefs":Lcom/android/server/recoverysystem/RecoverySystemService$PreferencesManager;
    const-string/jumbo v3, "lskf_captured_timestamp"

    const-wide/16 v7, -0x1

    invoke-virtual {v14, v3, v7, v8}, Lcom/android/server/recoverysystem/RecoverySystemService$PreferencesManager;->getLong(Ljava/lang/String;J)J

    move-result-wide v15

    .line 908
    .local v15, "lskfCapturedTimestamp":J
    cmp-long v3, v15, v7
    ...
    const-string v3, "_request_lskf_count"
    ...
    invoke-virtual {v14, v0, v3}, Lcom/android/server/recoverysystem/RecoverySystemService$PreferencesManager;->getInt(Ljava/lang/String;I)I
    ...
    .line 915
    .local v11, "lskfCapturedCount":I
    const-string v0, "RecoverySystemService"

    const-string v3, "Reporting reboot with lskf, package name %s, client count %d, request count %d, lskf captured count %d, duration since lskf captured %d seconds."
    ...
    .local v18, "preparedClientCount":I
    invoke-static {v10}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v6

    filled-new-array {v2, v4, v8, v5, v6}, [Ljava/lang/Object;
    ...
    .end local v17    # "uid":I
    .end local v18    # "preparedClientCount":I
    .restart local v5    # "uid":I
    .restart local v6    # "preparedClientCount":I
    ...
    .restart local v18    # "preparedClientCount":I
    return-void

    .line 902
    .end local v7    # "requestCount":I
    .end local v10    # "durationSeconds":I
    .end local v11    # "lskfCapturedCount":I
    .end local v12    # "currentTimestamp":J
    .end local v14    # "prefs":Lcom/android/server/recoverysystem/RecoverySystemService$PreferencesManager;
    .end local v15    # "lskfCapturedTimestamp":J
    .end local v17    # "uid":I
    .end local v18    # "preparedClientCount":I
    .restart local v5    # "uid":I
    :catchall_0
...
.method private sendPreparedForRebootIntentIfNeeded(Landroid/content/IntentSender;)V
    ...
    .local p1, "intentSender":Landroid/content/IntentSender;
    :cond_0
    move-object v1, p1
