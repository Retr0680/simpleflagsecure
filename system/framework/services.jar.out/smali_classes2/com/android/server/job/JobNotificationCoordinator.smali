...
.method enqueueNotification(Lcom/android/server/job/JobServiceContext;Ljava/lang/String;IIILandroid/app/Notification;I)V
    ...
    invoke-direct {v1, v4, v8, v3, v11}, Lcom/android/server/job/JobNotificationCoordinator;->validateNotification(Ljava/lang/String;ILandroid/app/Notification;I)V
    ...
    const-string v5, "enqueueNotification called with no running job"
    ...
    check-cast v13, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;

    .line 123
    .local v13, "oldDetails":Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;
    if-nez v13, :cond_2

    .line 124
    iget-boolean v0, v12, Lcom/android/server/job/controllers/JobStatus;->startedAsUserInitiatedJob:Z
    ...
    .line 143
    :goto_0
    iget v0, v13, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->notificationId:I
    ...
    invoke-virtual {v1, v2, v0, v12}, Lcom/android/server/job/JobNotificationCoordinator;->removeNotificationAssociation(Lcom/android/server/job/JobServiceContext;ILcom/android/server/job/controllers/JobStatus;)V
    ...
    .line 155
    iget-object v5, v1, Lcom/android/server/job/JobNotificationCoordinator;->mUijLock:Ljava/lang/Object;

    monitor-enter v5

    .line 156
    :try_start_0
    invoke-direct {v1, v14, v4}, Lcom/android/server/job/JobNotificationCoordinator;->maybeCreateUijNotificationSetsLocked(ILjava/lang/String;)V

    .line 157
    iget-object v0, v1, Lcom/android/server/job/JobNotificationCoordinator;->mUijNotifications:Landroid/util/SparseArrayMap;

    invoke-virtual {v0, v14, v4}, Landroid/util/SparseArrayMap;->get(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .line 159
    invoke-virtual {v0, v9}, Landroid/util/IntArray;->add(I)V
    ...
    :cond_5
    :goto_2
    iget-object v6, v1, Lcom/android/server/job/JobNotificationCoordinator;->mUijNotificationChannels:Landroid/util/SparseArrayMap;

    invoke-virtual {v6, v14, v4}, Landroid/util/SparseArrayMap;->get(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_6
    :goto_4
    invoke-static {v14, v4}, Landroid/content/pm/UserPackage;->of(ILjava/lang/String;)Landroid/content/pm/UserPackage;

    move-result-object v6

    .line 165
    .local v6, "userPackage":Landroid/content/pm/UserPackage;
    new-instance v5, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;-><init>(Landroid/content/pm/UserPackage;IIILjava/lang/String;I)V

    move-object v0, v6

    .end local v6    # "userPackage":Landroid/content/pm/UserPackage;
    .local v0, "userPackage":Landroid/content/pm/UserPackage;
    move-object v15, v5

    .line 168
    .local v15, "details":Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;
    ...
    .line 169
    .local v5, "appNotifications":Landroid/util/SparseSetArray;, "Landroid/util/SparseSetArray<Lcom/android/server/job/JobServiceContext;>;"
    if-nez v5, :cond_7

    .line 170
    new-instance v6, Landroid/util/SparseSetArray;

    invoke-direct {v6}, Landroid/util/SparseSetArray;-><init>()V

    move-object v5, v6

    .line 171
    iget-object v6, v1, Lcom/android/server/job/JobNotificationCoordinator;->mCurrentAssociations:Landroid/util/ArrayMap;

    invoke-virtual {v6, v0, v5}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 173
    :cond_7
    invoke-virtual {v5, v9, v2}, Landroid/util/SparseSetArray;->add(ILjava/lang/Object;)Z

    .line 174
    iget-object v6, v1, Lcom/android/server/job/JobNotificationCoordinator;->mNotificationDetails:Landroid/util/ArrayMap;

    invoke-virtual {v6, v2, v15}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v5    # "appNotifications":Landroid/util/SparseSetArray;, "Landroid/util/SparseSetArray<Lcom/android/server/job/JobServiceContext;>;"
    .local v6, "appNotifications":Landroid/util/SparseSetArray;, "Landroid/util/SparseSetArray<Lcom/android/server/job/JobServiceContext;>;"
    ...
    .end local v6    # "appNotifications":Landroid/util/SparseSetArray;, "Landroid/util/SparseSetArray<Lcom/android/server/job/JobServiceContext;>;"
    .local v11, "userId":I
    .local v14, "appNotifications":Landroid/util/SparseSetArray;, "Landroid/util/SparseSetArray<Lcom/android/server/job/JobServiceContext;>;"
...
.method removeNotificationAssociation(Lcom/android/server/job/JobServiceContext;ILcom/android/server/job/controllers/JobStatus;)V
    ...
    .line 185
    .local v0, "details":Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;
    if-nez v0, :cond_0
    ...
    .line 194
    :cond_2
    iget v2, v0, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->appUid:I
    ...
    iget v9, v0, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->notificationId:I
    ...
    .line 198
    .local v2, "stripUijFlag":Z
    invoke-virtual {v1, v9}, Landroid/util/SparseSetArray;->get(I)Landroid/util/ArraySet;

    move-result-object v11

    .line 199
    .local v11, "associatedContexts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Lcom/android/server/job/JobServiceContext;>;"
    const/4 v3, 0x1
    ...
    .line 215
    :cond_4
    invoke-direct {p0, v10, v4, v9}, Lcom/android/server/job/JobNotificationCoordinator;->isNotificationUsedForAnyUij(ILjava/lang/String;I)Z
    ...
    .line 205
    :goto_0
    iget v5, v0, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->jobEndNotificationPolicy:I
    ...
    .line 208
    :cond_5
    iget-object v3, p0, Lcom/android/server/job/JobNotificationCoordinator;->mNotificationManagerInternal:Lcom/android/server/notification/NotificationManagerInternal;

    iget v6, v0, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->appUid:I

    iget v7, v0, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->appPid:I

    const/4 v8, 0x0

    move-object v5, v4

    invoke-interface/range {v3 .. v10}, Lcom/android/server/notification/NotificationManagerInternal;->cancelNotification(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;II)V
    ...
    invoke-interface {v3, v4, v9, v10}, Lcom/android/server/notification/NotificationManagerInternal;->removeUserInitiatedJobFlagFromNotification(Ljava/lang/String;II)V

    .line 223
    :cond_7
    if-eqz p3, :cond_8

    iget-boolean v3, p3, Lcom/android/server/job/controllers/JobStatus;->startedAsUserInitiatedJob:Z

    if-eqz v3, :cond_8

    .line 224
    invoke-direct {p0, v10, v4, v9}, Lcom/android/server/job/JobNotificationCoordinator;->maybeDeleteNotificationIdAssociation(ILjava/lang/String;I)V

    .line 225
    iget-object v3, v0, Lcom/android/server/job/JobNotificationCoordinator$NotificationDetails;->notificationChannel:Ljava/lang/String;

    invoke-direct {p0, v10, v4, v3}, Lcom/android/server/job/JobNotificationCoordinator;->maybeDeleteNotificationChannelAssociation(ILjava/lang/String;Ljava/lang/String;)V
    ...
    .line 191
    .end local v2    # "stripUijFlag":Z
    .end local v4    # "packageName":Ljava/lang/String;
    .end local v9    # "notificationId":I
    .end local v10    # "userId":I
    .end local v11    # "associatedContexts":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Lcom/android/server/job/JobServiceContext;>;"
    :goto_2
    const-string v2, "JobNotificationCoordinator"

    const-string v3, "Association data structures not in sync"
