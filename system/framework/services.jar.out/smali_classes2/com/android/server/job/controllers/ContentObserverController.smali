...
.method public dumpControllerStateLocked(Landroid/util/proto/ProtoOutputStream;JLjava/util/function/Predicate;)V
    ...
    .local v19, "userIdx":I
    iget-object v8, v14, Lcom/android/server/job/controllers/ContentObserverController$ObserverInstance;->mJobs:Landroid/util/ArraySet;

    invoke-virtual {v8, v7}, Landroid/util/ArraySet;->valueAt(I)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;

    .line 509
    .local v8, "inst":Lcom/android/server/job/controllers/ContentObserverController$JobInstance;
    move/from16 v21, v7

    .end local v7    # "j":I
    .local v21, "j":I
    iget-object v7, v8, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mJobStatus:Lcom/android/server/job/controllers/JobStatus;

    invoke-interface {v2, v7}, Ljava/util/function/Predicate;->test(Ljava/lang/Object;)Z
    ...
    .line 507
    .end local v8    # "inst":Lcom/android/server/job/controllers/ContentObserverController$JobInstance;
    ...
    check-cast v4, Landroid/app/job/JobInfo$TriggerContentUri;

    .line 521
    .local v4, "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    ...
    .end local v4    # "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    .local v22, "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    ...
    .line 522
    .end local v22    # "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    .restart local v4    # "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    :cond_5
    move-object/from16 v22, v4

    .line 525
    .end local v4    # "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    .restart local v22    # "trigger":Landroid/app/job/JobInfo$TriggerContentUri;
    :goto_6
    invoke-virtual/range {v22 .. v22}, Landroid/app/job/JobInfo$TriggerContentUri;->getFlags()I
    ...
    .line 531
    .local v0, "inst":Lcom/android/server/job/controllers/ContentObserverController$JobInstance;
    move/from16 v24, v4

    .end local v4    # "j":I
    .local v24, "j":I
    iget-object v4, v0, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mJobStatus:Lcom/android/server/job/controllers/JobStatus;
    ...
    .local v26, "numbOfObserversPerUser":I
    invoke-virtual {v4, v1, v11, v12}, Lcom/android/server/job/controllers/JobStatus;->writeToShortProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    .line 539
    :cond_6
    iget-boolean v4, v0, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mTriggerPending:Z
    ...
    .line 541
    invoke-virtual {v4}, Lcom/android/server/job/controllers/JobStatus;->getTriggerContentUpdateDelay()J
    ...
    .line 542
    iget-object v11, v0, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mJobStatus:Lcom/android/server/job/controllers/JobStatus;

    .line 543
    invoke-virtual {v11}, Lcom/android/server/job/controllers/JobStatus;->getTriggerContentMaxDelay()J
    ...
    .end local v13    # "observerIdx":I
    .end local v14    # "obs":Lcom/android/server/job/controllers/ContentObserverController$ObserverInstance;
    .restart local v4    # "observerIdx":I
    ...
    .local v11, "k":I
    :goto_9
    iget-object v12, v0, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mChangedAuthorities:Landroid/util/ArraySet;
    ...
    .line 549
    .end local v11    # "k":I
    iget-object v11, v0, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mChangedUris:Landroid/util/ArraySet;
    ...
    :goto_a
    iget-object v12, v0, Lcom/android/server/job/controllers/ContentObserverController$JobInstance;->mChangedUris:Landroid/util/ArraySet;
    ...
    .line 527
    .end local v0    # "inst":Lcom/android/server/job/controllers/ContentObserverController$JobInstance;
    .end local v7    # "jToken":J
    :goto_b
    ...
    .end local v26    # "numbOfObserversPerUser":I
    .end local v27    # "obs":Lcom/android/server/job/controllers/ContentObserverController$ObserverInstance;
    .local v0, "m":I
    .local v4, "j":I
    .local v11, "observersOfUser":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Landroid/app/job/JobInfo$TriggerContentUri;Lcom/android/server/job/controllers/ContentObserverController$ObserverInstance;>;"
    ...
    .restart local v26    # "numbOfObserversPerUser":I
    .restart local v27    # "obs":Lcom/android/server/job/controllers/ContentObserverController$ObserverInstance;
    invoke-virtual {v1, v2, v3}, Landroid/util/proto/ProtoOutputStream;->end(J)V

    .line 503
    .end local v2    # "tToken":J
