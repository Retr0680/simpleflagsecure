...
.method dump(Landroid/util/IndentingPrintWriter;Ljava/lang/String;JJI)V
    ...
    .line 340
    :cond_0
    iget-object v5, v0, Lcom/android/server/job/JobPackageTracker$DataSet;->mEntries:Landroid/util/SparseArray;
    ...
    .line 341
    .local v5, "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
    ...
    .line 344
    .local v10, "pe":Lcom/android/server/job/JobPackageTracker$PackageEntry;
    invoke-static {v1, v4}, Landroid/os/UserHandle;->formatUid(Ljava/io/PrintWriter;I)V
    ...
    .end local v4    # "uid":I
    .end local v5    # "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
    .local v0, "uid":I
    .local v16, "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
    invoke-virtual {v10, v8, v9}, Lcom/android/server/job/JobPackageTracker$PackageEntry;->getPendingTime(J)J
    ...
    .end local v6    # "NP":I
    .local v17, "NP":I
    iget v6, v10, Lcom/android/server/job/JobPackageTracker$PackageEntry;->pendingCount:I
    ...
    .line 342
    .end local v10    # "pe":Lcom/android/server/job/JobPackageTracker$PackageEntry;
    ...
    .restart local v5    # "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
...
.method dump(Landroid/util/proto/ProtoOutputStream;JJJI)V
    ...
    iget-wide v4, v0, Lcom/android/server/job/JobPackageTracker$DataSet;->mStartClockTime:J

    invoke-virtual {v1, v2, v3, v4, v5}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V

    .line 400
    iget-wide v2, v0, Lcom/android/server/job/JobPackageTracker$DataSet;->mStartElapsedTime:J
    ...
    invoke-virtual {v1, v2, v3, v12, v13}, Landroid/util/proto/ProtoOutputStream;->write(JJ)V
    ...
    .line 409
    :cond_0
    iget-object v3, v0, Lcom/android/server/job/JobPackageTracker$DataSet;->mEntries:Landroid/util/SparseArray;
    ...
    .local v15, "uid":I
    .local v20, "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
    ...
    .local v2, "NP":I
    .local v3, "j":I
    invoke-virtual {v6, v7, v8}, Lcom/android/server/job/JobPackageTracker$PackageEntry;->getPendingTime(J)J
    ...
    .local v14, "pe":Lcom/android/server/job/JobPackageTracker$PackageEntry;
    iget v6, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->pendingCount:I
    ...
    .line 421
    invoke-virtual {v14, v7, v8}, Lcom/android/server/job/JobPackageTracker$PackageEntry;->getActiveTime(J)J

    move-result-wide v4

    iget v6, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->activeCount:I
    ...
    .line 423
    invoke-virtual {v14, v7, v8}, Lcom/android/server/job/JobPackageTracker$PackageEntry;->getActiveTopTime(J)J

    move-result-wide v4

    iget v6, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->activeTopCount:I
    ...
    .line 425
    iget v2, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->pendingNesting:I
    ...
    iget-boolean v2, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->hadPending:Z
    ...
    .line 427
    iget v2, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->activeNesting:I

    if-gtz v2, :cond_3

    iget-boolean v2, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->hadActive:Z
    ...
    .line 429
    iget v2, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->activeTopNesting:I

    if-gtz v2, :cond_5

    iget-boolean v2, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->hadActiveTop:Z
    ...
    .local v2, "k":I
    :goto_6
    iget-object v3, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->stopReasons:Landroid/util/SparseIntArray;
    ...
    .line 436
    .local v3, "srcToken":J
    iget-object v5, v14, Lcom/android/server/job/JobPackageTracker$PackageEntry;->stopReasons:Landroid/util/SparseIntArray;
    ...
    .line 411
    .end local v12    # "peToken":J
    .end local v14    # "pe":Lcom/android/server/job/JobPackageTracker$PackageEntry;
    ...
    .end local v18    # "NE":I
    .end local v19    # "i":I
    .end local v20    # "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
    .end local v21    # "NP":I
    .local v2, "uid":I
    .local v3, "uidMap":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/server/job/JobPackageTracker$PackageEntry;>;"
    ...
    .end local v14    # "NE":I
    .end local v15    # "i":I
    .restart local v16    # "period":J
    .restart local v18    # "NE":I
    ...
    .end local v16    # "period":J
    .end local v18    # "NE":I
    .restart local v12    # "period":J
    .restart local v14    # "NE":I
    :cond_9
    nop
