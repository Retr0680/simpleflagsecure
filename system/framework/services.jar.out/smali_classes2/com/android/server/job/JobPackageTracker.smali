...
.method dump(Landroid/util/IndentingPrintWriter;I)V
    ...
    invoke-direct {v0, v2}, Lcom/android/server/job/JobPackageTracker$DataSet;-><init>(Lcom/android/server/job/JobPackageTracker$DataSet;)V

    .line 542
    .local v0, "total":Lcom/android/server/job/JobPackageTracker$DataSet;
    iget-object v2, p0, Lcom/android/server/job/JobPackageTracker;->mLastDataSets:[Lcom/android/server/job/JobPackageTracker$DataSet;
    ...
    .line 544
    .end local v0    # "total":Lcom/android/server/job/JobPackageTracker$DataSet;
    :cond_0
    new-instance v0, Lcom/android/server/job/JobPackageTracker$DataSet;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/job/JobPackageTracker$DataSet;-><init>(Lcom/android/server/job/JobPackageTracker$DataSet;)V

    .line 546
    .restart local v0    # "total":Lcom/android/server/job/JobPackageTracker$DataSet;
    :goto_0
    iget-object v1, p0, Lcom/android/server/job/JobPackageTracker;->mCurDataSet:Lcom/android/server/job/JobPackageTracker$DataSet;
    ...
    .end local p2    # "filterAppId":I
    .local v2, "pw":Landroid/util/IndentingPrintWriter;
    .local v8, "filterAppId":I
    ...
    .end local v8    # "filterAppId":I
    .restart local p1    # "pw":Landroid/util/IndentingPrintWriter;
    .restart local p2    # "filterAppId":I
    :cond_1
    move-object v2, p1
    ...
    .restart local v8    # "filterAppId":I
    :goto_2
...
.method public dump(Landroid/util/proto/ProtoOutputStream;JI)V
    ...
    invoke-direct {v2, v4}, Lcom/android/server/job/JobPackageTracker$DataSet;-><init>(Lcom/android/server/job/JobPackageTracker$DataSet;)V

    .line 564
    .local v2, "total":Lcom/android/server/job/JobPackageTracker$DataSet;
    iget-object v4, p0, Lcom/android/server/job/JobPackageTracker;->mLastDataSets:[Lcom/android/server/job/JobPackageTracker$DataSet;

    aget-object v3, v4, v3

    invoke-virtual {v3, v2, v7, v8}, Lcom/android/server/job/JobPackageTracker$DataSet;->addTo(Lcom/android/server/job/JobPackageTracker$DataSet;J)V

    goto :goto_0

    .line 566
    .end local v2    # "total":Lcom/android/server/job/JobPackageTracker$DataSet;
    :cond_0
    new-instance v2, Lcom/android/server/job/JobPackageTracker$DataSet;
    ...
    .line 568
    .restart local v2    # "total":Lcom/android/server/job/JobPackageTracker$DataSet;
    :goto_0
    iget-object v3, p0, Lcom/android/server/job/JobPackageTracker;->mCurDataSet:Lcom/android/server/job/JobPackageTracker$DataSet;
...
.method public noteInactive(Lcom/android/server/job/controllers/JobStatus;ILjava/lang/String;)V
    ...
    .local v8, "now":J
    :goto_0
    invoke-virtual {p0, v8, v9}, Lcom/android/server/job/JobPackageTracker;->rebatchIfNeeded(J)V
