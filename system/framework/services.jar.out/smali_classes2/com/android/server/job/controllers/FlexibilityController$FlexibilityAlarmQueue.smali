...
.method synthetic constructor <init>(Lcom/android/server/job/controllers/FlexibilityController;Landroid/content/Context;Landroid/os/Looper;Lcom/android/server/job/controllers/FlexibilityController-IA;)V
    .locals 0
...
.method public scheduleDropNumConstraintsAlarm(Lcom/android/server/job/controllers/JobStatus;J)V
    ...
    iget-object v0, v1, Lcom/android/server/job/controllers/FlexibilityController$FlexibilityAlarmQueue;->this$0:Lcom/android/server/job/controllers/FlexibilityController;

    iget-object v8, v0, Lcom/android/server/job/controllers/StateController;->mLock:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/job/controllers/FlexibilityController;->getLifeCycleBeginningElapsedLocked(Lcom/android/server/job/controllers/JobStatus;)J

    move-result-wide v4

    .line 975
    .local v4, "earliest":J
    iget-object v2, v1, Lcom/android/server/job/controllers/FlexibilityController$FlexibilityAlarmQueue;->this$0:Lcom/android/server/job/controllers/FlexibilityController;
    :try_end_0
    ...
    .end local v6    # "earliest":J
    .restart local v4    # "earliest":J
    move-wide v6, v9
    ...
    invoke-virtual {v10}, Landroid/app/job/JobInfo;->isPrefetch()Z
    ...
    iget-object v0, v0, Lcom/android/server/job/controllers/FlexibilityController;->mFlexibilityTracker:Lcom/android/server/job/controllers/FlexibilityController$FlexibilityTracker;
    ...
    .line 984
    invoke-virtual {v0, v3, v2}, Lcom/android/server/job/controllers/FlexibilityController$FlexibilityTracker;->setNumDroppedFlexibleConstraints(Lcom/android/server/job/controllers/JobStatus;I)V
    ...
    iget-object v10, v1, Lcom/android/server/job/controllers/FlexibilityController$FlexibilityAlarmQueue;->this$0:Lcom/android/server/job/controllers/FlexibilityController;

    iget v10, v10, Lcom/android/server/job/controllers/FlexibilityController;->mSatisfiedFlexibleConstraints:I

    iget-object v15, v1, Lcom/android/server/job/controllers/FlexibilityController$FlexibilityAlarmQueue;->this$0:Lcom/android/server/job/controllers/FlexibilityController;

    .line 1000
    invoke-virtual {v15, v3}, Lcom/android/server/job/controllers/FlexibilityController;->getRelevantAppliedConstraintsLocked(Lcom/android/server/job/controllers/JobStatus;)I
    ...
    const-string v10, "deadline proximity met: "
    ...
    const-string/jumbo v9, "last alarm set: "
    ...
    invoke-virtual {v1, v3, v9, v10}, Lcom/android/server/utils/AlarmQueue;->addAlarm(Ljava/lang/Object;J)V
    ...
    .line 1028
    :cond_6
    invoke-virtual {v1, v3, v13, v14}, Lcom/android/server/utils/AlarmQueue;->addAlarm(Ljava/lang/Object;J)V

    .line 1029
    .end local v4    # "earliest":J
    .end local v6    # "latest":J
    .end local v13    # "nextTimeElapsed":J
    monitor-exit v8
