...
.method public startDream(Landroid/os/Binder;Landroid/content/ComponentName;ZZILandroid/os/PowerManager$WakeLock;Landroid/content/ComponentName;Ljava/lang/String;)V
    ...
    iget-object v2, v1, Lcom/android/server/dreams/DreamController;->mCloseNotificationShadeIntent:Landroid/content/Intent;

    sget-object v4, Landroid/os/UserHandle;->ALL:Landroid/os/UserHandle;

    iget-object v5, v1, Lcom/android/server/dreams/DreamController;->mCloseNotificationShadeOptions:Landroid/os/Bundle;

    const/4 v7, 0x0

    invoke-virtual {v0, v2, v4, v7, v5}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 188
    .local v13, "oldDream":Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    iput-object v0, v1, Lcom/android/server/dreams/DreamController;->mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    .line 190
    iget-object v0, v13, Lcom/android/server/dreams/DreamController$DreamRecord;->mName:Landroid/content/ComponentName;
    ...
    iget-object v4, v4, Lcom/android/server/dreams/DreamController$DreamRecord;->mName:Landroid/content/ComponentName;
    ...
    invoke-direct {v1, v2, v0, v13}, Lcom/android/server/dreams/DreamController;->stopDreamInstance(ZLjava/lang/String;Lcom/android/server/dreams/DreamController$DreamRecord;)V

    goto :goto_0

    .line 227
    .end local v13    # "oldDream":Lcom/android/server/dreams/DreamController$DreamRecord;
    :catchall_0
    move-exception v0
    ...
    .line 197
    .restart local v13    # "oldDream":Lcom/android/server/dreams/DreamController$DreamRecord;
    :cond_0
    iget-object v0, v1, Lcom/android/server/dreams/DreamController;->mPreviousDreams:Ljava/util/ArrayList;
    ...
    iget-boolean v4, v4, Lcom/android/server/dreams/DreamController$DreamRecord;->mCanDoze:Z
    ...
    .line 202
    :goto_1
    invoke-static {v0, v4}, Lcom/android/internal/logging/MetricsLogger;->visible(Landroid/content/Context;I)V
    ...
    :try_start_2
    invoke-static {v4, v5}, Landroid/service/dreams/DreamService;->setDreamOverlayComponent(Landroid/content/Intent;Landroid/content/ComponentName;)V
    :try_end_2
    ...
    iget-object v7, v1, Lcom/android/server/dreams/DreamController;->mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;
    ...
    invoke-virtual {v0, v4, v7, v15, v14}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    .line 224
    iget-object v0, v1, Lcom/android/server/dreams/DreamController;->mHandler:Landroid/os/Handler;

    iget-object v2, v1, Lcom/android/server/dreams/DreamController;->mCurrentDream:Lcom/android/server/dreams/DreamController$DreamRecord;

    invoke-static {v2}, Lcom/android/server/dreams/DreamController$DreamRecord;->-$$Nest$fgetmStopUnconnectedDreamRunnable(Lcom/android/server/dreams/DreamController$DreamRecord;)Ljava/lang/Runnable;
    ...
    .line 219
    const-string/jumbo v7, "unable to bind service: SecExp."

    invoke-virtual {v1, v2, v7}, Lcom/android/server/dreams/DreamController;->stopDream(ZLjava/lang/String;)V
    :try_end_5
