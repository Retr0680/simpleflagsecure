...
.method constructor <init>(Landroid/content/Context;Landroid/os/Looper;)V
    ...
    .line 126
    new-instance v0, Lcom/android/server/slice/SliceManagerService$RoleObserver;

    invoke-direct {v0, p0}, Lcom/android/server/slice/SliceManagerService$RoleObserver;-><init>(Lcom/android/server/slice/SliceManagerService;)V

    iput-object v0, p0, Lcom/android/server/slice/SliceManagerService;->mRoleObserver:Lcom/android/server/slice/SliceManagerService$RoleObserver;
...
.method private checkSlicePermissionInternal(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/String;)I
    ...
    invoke-direct {v6, v7, v8}, Lcom/android/server/slice/SliceManagerService;->hasFullSliceAccess(Ljava/lang/String;I)Z
    ...
    .line 249
    :cond_3
    iget-object v3, v6, Lcom/android/server/slice/SliceManagerService;->mPermissions:Lcom/android/server/slice/SlicePermissionManager;

    invoke-virtual {v3, v7, v8, v1}, Lcom/android/server/slice/SlicePermissionManager;->hasPermission(Ljava/lang/String;ILandroid/net/Uri;)Z
    ...
    .line 254
    invoke-direct {v6, v15, v1, v8}, Lcom/android/server/slice/SliceManagerService;->enforceOwner(Ljava/lang/String;Landroid/net/Uri;I)V

    .line 256
    invoke-direct {v6, v15}, Lcom/android/server/slice/SliceManagerService;->verifyCaller(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v11, v12, v0}, Landroid/content/Context;->checkPermission(Ljava/lang/String;II)I
    ...
    .line 259
    invoke-static {v1, v8}, Landroid/content/ContentProvider;->getUserIdFromUri(Landroid/net/Uri;I)I

    move-result v4

    .line 260
    .local v4, "providerUser":I
    invoke-direct {v6, v1, v4}, Lcom/android/server/slice/SliceManagerService;->getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;
...
.method protected getDefaultHome(I)Ljava/lang/String;
    ...
    .line 542
    .end local v5    # "detected":Landroid/content/ComponentName;
    .local v11, "detected":Landroid/content/ComponentName;
    ...
    .end local v11    # "detected":Landroid/content/ComponentName;
    .restart local v5    # "detected":Landroid/content/ComponentName;
    :goto_2
...
.method public grantPermissionFromUser(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, p2, v3}, Lcom/android/server/slice/SlicePermissionManager;->grantFullAccess(Ljava/lang/String;I)V
    ...
    .line 282
    .local v6, "grantUri":Landroid/net/Uri;
    invoke-static {v6, v3}, Landroid/content/ContentProvider;->getUserIdFromUri(Landroid/net/Uri;I)I

    move-result v5

    .line 283
    .local v5, "providerUser":I
    invoke-direct {p0, v6, v5}, Lcom/android/server/slice/SliceManagerService;->getProviderPkg(Landroid/net/Uri;I)Ljava/lang/String;

    move-result-object v4

    .line 284
    .local v4, "providerPkg":Ljava/lang/String;
    iget-object v1, p0, Lcom/android/server/slice/SliceManagerService;->mPermissions:Lcom/android/server/slice/SlicePermissionManager;
    ...
    .line 286
    .end local v4    # "providerPkg":Ljava/lang/String;
    .end local v5    # "providerUser":I
    .end local v6    # "grantUri":Landroid/net/Uri;
    :goto_0
    invoke-static {}, Landroid/os/Binder;->clearCallingIdentity()J
    ...
    .local v4, "ident":J
    :try_start_0
    iget-object p2, p0, Lcom/android/server/slice/SliceManagerService;->mContext:Landroid/content/Context;
...
.method public grantSlicePermission(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .line 215
    .local v3, "user":I
    invoke-direct {p0, p1, p3, v3}, Lcom/android/server/slice/SliceManagerService;->enforceOwner(Ljava/lang/String;Landroid/net/Uri;I)V
    ...
    .end local p1    # "pkg":Ljava/lang/String;
    .end local p2    # "toPkg":Ljava/lang/String;
