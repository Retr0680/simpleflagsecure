...
.field private static final DEBUG_GLYPH:Z

.field private static final SYS_PROR_GLYPH_DUMP_STATUS:Ljava/lang/String; = "sys.glyph.drv.dump"
...
.field final mNtGlyphService:Lcom/android/server/lights/INtGlyphService;
...
.method static bridge synthetic -$$Nest$sfgetDEBUG_GLYPH()Z
    .locals 1

    .line 0
    sget-boolean v0, Lcom/android/server/lights/LightsService;->DEBUG_GLYPH:Z
...
.method static constructor <clinit>()V
    ...
    :goto_1
    sput-boolean v0, Lcom/android/server/lights/LightsService;->DEBUG_GLYPH:Z
...
.method constructor <init>(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/android/server/lights/LightsService;->mNtGlyphService:Lcom/android/server/lights/INtGlyphService;
...
.method private populateAvailableLightsFromAidl(Landroid/content/Context;)V
    ...
    .line 601
    .local v5, "hwLight":Landroid/hardware/light/HwLight;
    ...
    invoke-direct {v8, p0, p1, v5, v4}, Lcom/android/server/lights/LightsService$LightImpl;-><init>(Lcom/android/server/lights/LightsService;Landroid/content/Context;Landroid/hardware/light/HwLight;Lcom/android/server/lights/LightsService-IA;)V

    invoke-virtual {v6, v7, v8}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    .line 600
    .end local v5    # "hwLight":Landroid/hardware/light/HwLight;
    ...
    .line 605
    :cond_0
    iget-object v0, p0, Lcom/android/server/lights/LightsService;->mNtGlyphService:Lcom/android/server/lights/INtGlyphService;
    ...
    invoke-interface {v0}, Lcom/android/server/lights/INtGlyphService;->getNtLights()[Landroid/hardware/light/HwLight;

    move-result-object v0

    .line 607
    .local v0, "hwLights":[Landroid/hardware/light/HwLight;
    if-eqz v0, :cond_1
    ...
    iget v6, v3, Landroid/hardware/light/HwLight;->id:I

    new-instance v7, Lcom/android/server/lights/LightsService$LightImpl;

    invoke-direct {v7, p0, p1, v3, v4}, Lcom/android/server/lights/LightsService$LightImpl;-><init>(Lcom/android/server/lights/LightsService;Landroid/content/Context;Landroid/hardware/light/HwLight;Lcom/android/server/lights/LightsService-IA;)V
    ...
    .line 617
    .end local v0    # "hwLights":[Landroid/hardware/light/HwLight;
    :cond_1
    goto :goto_3
...
.method public onBootPhase(I)V
    ...
    invoke-interface {v0}, Lcom/android/server/lights/INtGlyphService;->onSystemReady()V
