...
.method private getListLocked(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v3, " from DeviceConfig"
    ...
    .end local v4    # "listString":Ljava/lang/String;
    .restart local v3    # "listString":Ljava/lang/String;
    :catchall_0
    move-exception v0
...
.method private updateConfigs(Landroid/provider/DeviceConfig$Properties;)V
    ...
    .line 138
    .end local v1    # "newList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .local v4, "newList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    if-nez v4, :cond_2
    ...
    .line 139
    :cond_2
    iput-object v4, p0, Lcom/android/server/media/metrics/MediaMetricsManagerService;->mNoUidAllowlist:Ljava/util/List;

    .line 141
    :cond_3
    const-string/jumbo v1, "player_metrics_app_blocklist"
    ...
    .line 142
    .end local v4    # "newList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v1    # "newList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    if-nez v1, :cond_4
    ...
    .line 147
    :cond_6
    iput-object v3, p0, Lcom/android/server/media/metrics/MediaMetricsManagerService;->mNoUidBlocklist:Ljava/util/List;

    .line 149
    .end local v3    # "newList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    :cond_7
    monitor-exit v0
