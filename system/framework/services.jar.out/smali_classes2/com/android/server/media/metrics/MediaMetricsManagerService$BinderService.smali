...
.method synthetic constructor <init>(Lcom/android/server/media/metrics/MediaMetricsManagerService;Lcom/android/server/media/metrics/MediaMetricsManagerService-IA;)V
    .locals 0
...
.method public reportEditingEndedEvent(Ljava/lang/String;Landroid/media/metrics/EditingEndedEvent;I)V
    ...
    .line 409
    .local v19, "outputVideoResolution":I
    if-nez v19, :cond_6
    ...
    .end local v1    # "inputMediaItemInfo":Landroid/media/metrics/MediaItemInfo;
    .local v22, "inputMediaItemInfo":Landroid/media/metrics/MediaItemInfo;
    ...
    .end local v22    # "inputMediaItemInfo":Landroid/media/metrics/MediaItemInfo;
    .restart local v0    # "level":I
    .restart local v1    # "inputMediaItemInfo":Landroid/media/metrics/MediaItemInfo;
    :cond_6
    move/from16 v21, v0
    ...
    .restart local v22    # "inputMediaItemInfo":Landroid/media/metrics/MediaItemInfo;
    move/from16 v0, v19

    .line 415
    .end local v19    # "outputVideoResolution":I
    ...
    .line 417
    .local v1, "outputCodecNames":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-interface {v1}, Ljava/util/List;->isEmpty()Z
    ...
    .line 419
    .local v20, "outputFirstCodecName":Ljava/lang/String;
    ...
    .line 420
    .local v13, "outputSecondCodecName":Ljava/lang/String;
    :cond_8
    ...
    invoke-virtual {v2, v4}, Landroid/util/StatsEvent$Builder;->setAtomId(I)Landroid/util/StatsEvent$Builder;
    ...
    invoke-virtual {v2, v3}, Landroid/util/StatsEvent$Builder;->writeFloat(F)Landroid/util/StatsEvent$Builder;
    ...
    .line 429
    :goto_6
    invoke-virtual {v2, v3}, Landroid/util/StatsEvent$Builder;->writeBoolean(Z)Landroid/util/StatsEvent$Builder;
    ...
    invoke-static {v3}, Lcom/android/server/media/metrics/MediaMetricsManagerService;->-$$Nest$smgetFilteredLibraryName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 464
    invoke-virtual/range {v22 .. v22}, Landroid/media/metrics/MediaItemInfo;->getSourceType()I
    ...
    .line 508
    invoke-static {v3, v7}, Lcom/android/server/media/metrics/MediaMetricsManagerService;->-$$Nest$smgetVideoHdrFormatEnum(ILjava/lang/String;)I
    ...
    .line 514
    invoke-virtual {v2, v14}, Landroid/util/StatsEvent$Builder;->writeString(Ljava/lang/String;)Landroid/util/StatsEvent$Builder;
    ...
    .end local v20    # "outputFirstCodecName":Ljava/lang/String;
