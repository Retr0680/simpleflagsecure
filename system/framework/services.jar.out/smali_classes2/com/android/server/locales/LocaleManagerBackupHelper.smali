...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/locales/LocaleManagerService;Landroid/content/pm/PackageManager;Ljava/time/Clock;Landroid/os/HandlerThread;Landroid/util/SparseArray;Ljava/io/File;Landroid/content/SharedPreferences;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/locales/LocaleManagerBackupHelper$UserMonitor;-><init>(Lcom/android/server/locales/LocaleManagerBackupHelper;Lcom/android/server/locales/LocaleManagerBackupHelper-IA;)V
...
.method constructor <init>(Lcom/android/server/locales/LocaleManagerService;Landroid/content/pm/PackageManager;Landroid/os/HandlerThread;)V
    ...
    .end local p1    # "localeManagerService":Lcom/android/server/locales/LocaleManagerService;
    .end local p2    # "packageManager":Landroid/content/pm/PackageManager;
    .end local p3    # "broadcastHandlerThread":Landroid/os/HandlerThread;
    .local v2, "localeManagerService":Lcom/android/server/locales/LocaleManagerService;
    .local v3, "packageManager":Landroid/content/pm/PackageManager;
    .local v5, "broadcastHandlerThread":Landroid/os/HandlerThread;
...
.method private checkExistingLocalesAndApplyRestore(Ljava/lang/String;Lcom/android/server/locales/LocaleManagerBackupHelper$LocalesInfo;I)V
    ...
    .line 427
    .local v0, "currLocales":Landroid/os/LocaleList;
    ...
    .line 432
    .end local v0    # "currLocales":Landroid/os/LocaleList;
    goto :goto_0
    ...
    iget-object v0, p2, Lcom/android/server/locales/LocaleManagerBackupHelper$LocalesInfo;->mLocales:Ljava/lang/String;
    ...
    const-string v0, "Could not restore locales for "
...
.method public stageAndApplyRestoredPayload([BI)V
    ...
    .local v2, "pkgStates":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/locales/LocaleManagerBackupHelper$LocalesInfo;>;"
    nop

    .line 252
    iget-object v1, p0, Lcom/android/server/locales/LocaleManagerBackupHelper;->mStagedDataLock:Ljava/lang/Object;
    ...
    .line 243
    .end local v2    # "pkgStates":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/locales/LocaleManagerBackupHelper$LocalesInfo;>;"
    :catch_0
    move-exception v1
