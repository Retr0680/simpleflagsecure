...
.method static computeScore(Ljava/util/List;IJ)V
    ...
    invoke-direct {v8, v9}, Lcom/android/server/people/prediction/SharesheetModelScorer$ShareTargetRankingScore;-><init>(Lcom/android/server/people/prediction/SharesheetModelScorer-IA;)V
    ...
    invoke-virtual {v13, v6}, Lcom/android/server/people/prediction/SharesheetModelScorer$ShareTargetRankingScore;->setMimeFrequencyScore(F)V
    ...
    invoke-static {v6, v7}, Lcom/android/server/people/prediction/SharesheetModelScorer;->probOR(FF)F
    ...
    .line 143
    invoke-virtual {v13, v6}, Lcom/android/server/people/prediction/SharesheetModelScorer$ShareTargetRankingScore;->setTotalScore(F)V
    ...
    invoke-virtual {v12, v6}, Lcom/android/server/people/prediction/ShareTargetPredictor$ShareTarget;->setScore(F)V
...
.method private static findSharingForegroundApp(Ljava/util/Map;Lcom/android/server/people/data/DataManager;ILjava/lang/String;)Ljava/lang/String;
    ...
    .end local p1    # "dataManager":Lcom/android/server/people/data/DataManager;
    .end local p2    # "callingUserId":I
    .local v1, "dataManager":Lcom/android/server/people/data/DataManager;
    ...
    .line 306
    .local p2, "sourceApp":Ljava/lang/String;
...
.method private static promoteMostChosenAndFrequentlyUsedApps(Ljava/util/Map;ILcom/android/server/people/data/DataManager;I)V
    ...
    .line 221
    .local v9, "now":J
    sget-wide v2, Lcom/android/server/people/prediction/SharesheetModelScorer;->ONE_MONTH_WINDOW:J
    ...
    .end local p2    # "dataManager":Lcom/android/server/people/data/DataManager;
    .end local p3    # "callingUserId":I
    .local v5, "dataManager":Lcom/android/server/people/data/DataManager;
    ...
    .line 225
    .local p2, "appStatsMap":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/android/server/people/data/AppUsageStatsData;>;"
    new-instance p3, Lcom/android/server/people/prediction/SharesheetModelScorer$$ExternalSyntheticLambda0;

    invoke-direct {p3}, Lcom/android/server/people/prediction/SharesheetModelScorer$$ExternalSyntheticLambda0;-><init>()V

    const v2, 0x3f666666    # 0.9f

    mul-float/2addr v2, v1

    invoke-static {p0, p2, p3, v2, v1}, Lcom/android/server/people/prediction/SharesheetModelScorer;->promoteApp(Ljava/util/Map;Ljava/util/Map;Ljava/util/function/Function;FF)F

    move-result p3

    .line 228
    .end local v1    # "minValidScore":F
    .local p3, "minValidScore":F
    new-instance v1, Lcom/android/server/people/prediction/SharesheetModelScorer$$ExternalSyntheticLambda1;

    invoke-direct {v1}, Lcom/android/server/people/prediction/SharesheetModelScorer$$ExternalSyntheticLambda1;-><init>()V

    const v2, 0x3e99999a    # 0.3f

    mul-float/2addr v2, p3

    invoke-static {p0, p2, v1, v2, p3}, Lcom/android/server/people/prediction/SharesheetModelScorer;->promoteApp(Ljava/util/Map;Ljava/util/Map;Ljava/util/function/Function;FF)F
