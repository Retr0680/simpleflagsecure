...
.method static queryAppMovingToForegroundEvents(IJJ)Ljava/util/List;
    ...
    .line 133
    .local p0, "usageEvents":Landroid/app/usage/UsageEvents;
    if-nez p0, :cond_0
    ...
    .line 138
    .local p1, "e":Landroid/app/usage/UsageEvents$Event;
    ...
    .line 142
    .end local p1    # "e":Landroid/app/usage/UsageEvents$Event;
    :cond_1
    goto :goto_0
...
.method static queryAppUsageStats(IJJLjava/util/Set;)Ljava/util/Map;
    ...
    .line 157
    .local p0, "stats":Ljava/util/List;, "Ljava/util/List<Landroid/app/usage/UsageStats;>;"
    new-instance p1, Landroid/util/ArrayMap;

    invoke-direct {p1}, Landroid/util/ArrayMap;-><init>()V

    .line 158
    .local p1, "aggregatedStats":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lcom/android/server/people/data/AppUsageStatsData;>;"
    if-nez p0, :cond_0
    ...
    .line 162
    .local p3, "stat":Landroid/app/usage/UsageStats;
    ...
    invoke-interface {p1, p4, v0}, Ljava/util/Map;->computeIfAbsent(Ljava/lang/Object;Ljava/util/function/Function;)Ljava/lang/Object;
    ...
    .line 166
    .local v0, "packageStats":Lcom/android/server/people/data/AppUsageStatsData;
    iget-object v2, p3, Landroid/app/usage/UsageStats;->mChooserCounts:Landroid/util/ArrayMap;

    invoke-static {v2}, Lcom/android/server/people/data/UsageStatsQueryHelper;->sumChooserCounts(Landroid/util/ArrayMap;)I

    move-result v2

    invoke-virtual {v0, v2}, Lcom/android/server/people/data/AppUsageStatsData;->incrementChosenCountBy(I)V

    .line 167
    invoke-virtual {p3}, Landroid/app/usage/UsageStats;->getAppLaunchCount()I

    move-result v2

    invoke-virtual {v0, v2}, Lcom/android/server/people/data/AppUsageStatsData;->incrementLaunchCountBy(I)V

    .line 169
    .end local v0    # "packageStats":Lcom/android/server/people/data/AppUsageStatsData;
    .end local p3    # "stat":Landroid/app/usage/UsageStats;
...
.method querySince(J)Z
    ...
    .line 75
    .local p1, "usageEvents":Landroid/app/usage/UsageEvents;
    if-nez p1, :cond_0
    ...
    .line 81
    .local v0, "e":Landroid/app/usage/UsageEvents$Event;
    ...
    .line 84
    iget-wide v4, p0, Lcom/android/server/people/data/UsageStatsQueryHelper;->mLastEventTimestamp:J
    ...
    iput-wide v4, p0, Lcom/android/server/people/data/UsageStatsQueryHelper;->mLastEventTimestamp:J
    ...
    .line 96
    :sswitch_0
    invoke-direct {p0, v4, v0}, Lcom/android/server/people/data/UsageStatsQueryHelper;->onInAppConversationEnded(Lcom/android/server/people/data/PackageData;Landroid/app/usage/UsageEvents$Event;)V
    ...
    .line 113
    .end local v0    # "e":Landroid/app/usage/UsageEvents$Event;
