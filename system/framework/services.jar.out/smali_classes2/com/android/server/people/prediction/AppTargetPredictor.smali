...
.method public static create(Landroid/app/prediction/AppPredictionContext;Ljava/util/function/Consumer;Lcom/android/server/people/data/DataManager;ILandroid/content/Context;)Lcom/android/server/people/prediction/AppTargetPredictor;
    ...
    .end local p0    # "predictionContext":Landroid/app/prediction/AppPredictionContext;
    .end local p1    # "updatePredictionsMethod":Ljava/util/function/Consumer;, "Ljava/util/function/Consumer<Ljava/util/List<Landroid/app/prediction/AppTarget;>;>;"
    ...
    .local v2, "predictionContext":Landroid/app/prediction/AppPredictionContext;
    .local v3, "updatePredictionsMethod":Ljava/util/function/Consumer;, "Ljava/util/function/Consumer<Ljava/util/List<Landroid/app/prediction/AppTarget;>;>;"
    .local v4, "dataManager":Lcom/android/server/people/data/DataManager;
    ...
    .line 52
    .end local v2    # "predictionContext":Landroid/app/prediction/AppPredictionContext;
    .end local v3    # "updatePredictionsMethod":Ljava/util/function/Consumer;, "Ljava/util/function/Consumer<Ljava/util/List<Landroid/app/prediction/AppTarget;>;>;"
    .end local v4    # "dataManager":Lcom/android/server/people/data/DataManager;
    .end local v5    # "callingUserId":I
    .end local v6    # "context":Landroid/content/Context;
    .restart local p0    # "predictionContext":Landroid/app/prediction/AppPredictionContext;
    .restart local p1    # "updatePredictionsMethod":Ljava/util/function/Consumer;, "Ljava/util/function/Consumer<Ljava/util/List<Landroid/app/prediction/AppTarget;>;>;"
    .restart local p2    # "dataManager":Lcom/android/server/people/data/DataManager;
    ...
    .end local p2    # "dataManager":Lcom/android/server/people/data/DataManager;
    .end local p3    # "callingUserId":I
    .restart local v2    # "predictionContext":Landroid/app/prediction/AppPredictionContext;
    .restart local v3    # "updatePredictionsMethod":Ljava/util/function/Consumer;, "Ljava/util/function/Consumer<Ljava/util/List<Landroid/app/prediction/AppTarget;>;>;"
    .restart local v4    # "dataManager":Lcom/android/server/people/data/DataManager;
