...
.method public queryEvents(Ljava/util/Set;JJ)Ljava/util/List;
    ...
    .line 62
    .local v3, "eventHistory":Lcom/android/server/people/data/EventHistory;
    ...
    .local v4, "eventTypes":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    ...
    .line 67
    .local p1, "queryResults":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/people/data/Event;>;"
    invoke-direct {p0, v0, p1}, Lcom/android/server/people/data/AggregateEventHistoryImpl;->combineEventLists(Ljava/util/List;Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    .line 68
    .end local v2    # "eventIndex":Lcom/android/server/people/data/EventIndex;
    .end local v3    # "eventHistory":Lcom/android/server/people/data/EventHistory;
    .end local p1    # "queryResults":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/people/data/Event;>;"
    move-object p1, v4

    goto :goto_0

    .line 69
    .end local v4    # "eventTypes":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
