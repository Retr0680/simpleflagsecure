...
.method private synthetic lambda$newSoundTriggerHelper$1(ILandroid/media/permission/Identity;Landroid/media/permission/Identity;ZLandroid/hardware/soundtrigger/SoundTrigger$StatusListener;)Landroid/hardware/soundtrigger/SoundTriggerModule;
    ...
    .end local p2    # "middlemanIdentity":Landroid/media/permission/Identity;
    .end local p3    # "originatorIdentity":Landroid/media/permission/Identity;
    .end local p4    # "isTrusted":Z
    .end local p5    # "statusListener":Landroid/hardware/soundtrigger/SoundTrigger$StatusListener;
    .local v2, "moduleId":I
    .local v3, "statusListener":Landroid/hardware/soundtrigger/SoundTrigger$StatusListener;
    .local v5, "middlemanIdentity":Landroid/media/permission/Identity;
...
.method private newSoundTriggerHelper(Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;Lcom/android/server/utils/EventLogger;Z)Lcom/android/server/soundtrigger/SoundTriggerHelper;
    ...
    iput-object v0, v4, Landroid/media/permission/Identity;->packageName:Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, Lcom/android/server/soundtrigger/SoundTriggerService;->listUnderlyingModuleProperties(Landroid/media/permission/Identity;)Ljava/util/List;

    move-result-object v0

    .line 330
    .local v0, "moduleList":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/soundtrigger/SoundTrigger$ModuleProperties;>;"
    const/4 v1, -0x1
    ...
    const-string v2, "Invalid module properties"
    ...
    :cond_2
    :goto_1
    new-instance v7, Lcom/android/server/soundtrigger/SoundTriggerHelper;

    move-object v8, v7

    iget-object v7, p0, Lcom/android/server/soundtrigger/SoundTriggerService;->mContext:Landroid/content/Context;

    new-instance v1, Lcom/android/server/soundtrigger/SoundTriggerService$$ExternalSyntheticLambda1;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/server/soundtrigger/SoundTriggerService$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/soundtrigger/SoundTriggerService;ILandroid/media/permission/Identity;Landroid/media/permission/Identity;Z)V

    .end local v6    # "isTrusted":Z
    .restart local p3    # "isTrusted":Z
    new-instance v11, Lcom/android/server/soundtrigger/SoundTriggerService$$ExternalSyntheticLambda2;

    invoke-direct {v11, p0, v5}, Lcom/android/server/soundtrigger/SoundTriggerService$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/soundtrigger/SoundTriggerService;Landroid/media/permission/Identity;)V
    ...
    .end local p2    # "eventLogger":Lcom/android/server/utils/EventLogger;
    .local v8, "eventLogger":Lcom/android/server/utils/EventLogger;
    .local v10, "moduleId":I
    invoke-direct/range {v6 .. v11}, Lcom/android/server/soundtrigger/SoundTriggerHelper;-><init>(Landroid/content/Context;Lcom/android/server/utils/EventLogger;Ljava/util/function/Function;ILjava/util/function/Supplier;)V

    .end local v10    # "moduleId":I
