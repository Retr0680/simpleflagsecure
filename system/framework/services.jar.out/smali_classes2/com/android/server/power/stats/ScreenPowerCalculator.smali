...
.method private smearScreenBatteryDrain(Landroid/util/SparseArray;Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;J)V
    ...
    .local v5, "activityTimeArray":Landroid/util/SparseLongArray;
    ...
    invoke-virtual {v12, v3, v13, v14}, Landroid/os/UidBatteryConsumer$Builder;->setUsageDurationMillis(IJ)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    invoke-virtual {v4, v3, v6, v7, v15}, Landroid/os/UidBatteryConsumer$Builder;->setConsumedPower(IDI)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .end local v5    # "activityTimeArray":Landroid/util/SparseLongArray;
    ...
    .end local v3    # "activityTimeArray":Landroid/util/SparseLongArray;
    .end local v6    # "totalScreenPowerMah":D
    .restart local v5    # "activityTimeArray":Landroid/util/SparseLongArray;
...
.method public calculate(Landroid/os/BatteryUsageStats$Builder;Landroid/os/BatteryStats;JJLandroid/os/BatteryUsageStatsQuery;)V
    ...
    .line 76
    .local v1, "totalPowerAndDuration":Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;
    ...
    invoke-static {v7, v8, v11}, Lcom/android/server/power/stats/PowerCalculator;->getPowerModel(JLandroid/os/BatteryUsageStatsQuery;)I
    ...
    .line 82
    .local v12, "totalAppPower":D
    const-wide/16 v14, 0x0

    .line 87
    .local v14, "totalAppDuration":J
    nop
    ...
    .line 108
    invoke-direct {v0, v3, v1, v4, v5}, Lcom/android/server/power/stats/ScreenPowerCalculator;->smearScreenBatteryDrain(Landroid/util/SparseArray;Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;J)V

    .line 110
    iget-wide v12, v1, Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;->powerMah:D

    .line 111
    iget-wide v14, v1, Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;->durationMs:J
    ...
    .line 92
    .local v6, "appPowerAndDuration":Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;
    ...
    .end local v3    # "uidBatteryConsumerBuilders":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/os/UidBatteryConsumer$Builder;>;"
    ...
    .line 94
    .local v3, "app":Landroid/os/UidBatteryConsumer$Builder;
    nop
    ...
    .local v19, "consumptionUC":J
    invoke-virtual {v3}, Landroid/os/UidBatteryConsumer$Builder;->getBatteryStatsUid()Landroid/os/BatteryStats$Uid;

    move-result-object v7

    .line 94
    invoke-direct {v0, v6, v7, v4, v5}, Lcom/android/server/power/stats/ScreenPowerCalculator;->calculateAppUsingEnergyConsumption(Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;Landroid/os/BatteryStats$Uid;J)V

    .line 96
    iget-wide v7, v6, Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;->durationMs:J
    ...
    .end local v3    # "app":Landroid/os/UidBatteryConsumer$Builder;
    ...
    .line 98
    invoke-virtual {v7, v0, v3, v4, v2}, Landroid/os/UidBatteryConsumer$Builder;->setConsumedPower(IDI)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .end local v19    # "consumptionUC":J
    .local v3, "uidBatteryConsumerBuilders":Landroid/util/SparseArray;, "Landroid/util/SparseArray<Landroid/os/UidBatteryConsumer$Builder;>;"
    .restart local v7    # "consumptionUC":J
    :cond_1
    move-object/from16 v18, v3
    ...
    .restart local v19    # "consumptionUC":J
    nop

    .line 114
    .end local v6    # "appPowerAndDuration":Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;
    :goto_1
    const/4 v0, 0x0
    ...
    iget-wide v4, v1, Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;->powerMah:D
    ...
    .line 116
    invoke-virtual {v3, v0, v4, v5, v2}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(IDI)Landroid/os/BatteryConsumer$BaseBuilder;

    move-result-object v3

    check-cast v3, Landroid/os/AggregateBatteryConsumer$Builder;

    iget-wide v4, v1, Lcom/android/server/power/stats/ScreenPowerCalculator$PowerAndDuration;->durationMs:J

    .line 118
    invoke-virtual {v3, v0, v4, v5}, Landroid/os/AggregateBatteryConsumer$Builder;->setUsageDurationMillis(IJ)Landroid/os/BatteryConsumer$BaseBuilder;

    .line 121
    move/from16 v3, v16

    invoke-virtual {v9, v3}, Landroid/os/BatteryUsageStats$Builder;->getAggregateBatteryConsumerBuilder(I)Landroid/os/AggregateBatteryConsumer$Builder;

    move-result-object v3

    .line 123
    invoke-virtual {v3, v0, v12, v13, v2}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(IDI)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .line 124
    invoke-virtual {v3, v0, v14, v15}, Landroid/os/AggregateBatteryConsumer$Builder;->setUsageDurationMillis(IJ)Landroid/os/BatteryConsumer$BaseBuilder;
