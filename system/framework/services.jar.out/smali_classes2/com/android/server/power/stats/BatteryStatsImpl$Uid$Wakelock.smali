...
.method private readDualTimerFromParcel(ILjava/util/ArrayList;Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Landroid/os/Parcel;)Lcom/android/server/power/stats/BatteryStatsImpl$DualTimer;
    ...
    .end local p1    # "type":I
    .end local p2    # "pool":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;>;"
    .end local p3    # "timeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .end local p4    # "bgTimeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .end local p5    # "in":Landroid/os/Parcel;
    .local v4, "type":I
    .local v5, "pool":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;>;"
    .local v6, "timeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .local v7, "bgTimeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
...
.method private readStopwatchTimerFromParcel(ILjava/util/ArrayList;Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Landroid/os/Parcel;)Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;
    ...
    .end local p2    # "pool":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;>;"
    .end local p3    # "timeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .end local p4    # "in":Landroid/os/Parcel;
    .local v4, "type":I
    .local v5, "pool":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;>;"
    .local v6, "timeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
...
.method readFromParcelLocked(Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Landroid/os/Parcel;)V
    ...
    .end local p2    # "screenOffTimeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .end local p3    # "screenOffBgTimeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .end local p4    # "in":Landroid/os/Parcel;
    .local v4, "screenOffTimeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    .local v5, "screenOffBgTimeBase":Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;
    ...
    iput-object p2, v1, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->mTimerPartial:Lcom/android/server/power/stats/BatteryStatsImpl$DualTimer;

    .line 10238
    iget-object p2, v1, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->mBsi:Lcom/android/server/power/stats/BatteryStatsImpl;

    invoke-static {p2}, Lcom/android/server/power/stats/BatteryStatsImpl;->-$$Nest$fgetmFullTimers(Lcom/android/server/power/stats/BatteryStatsImpl;)Ljava/util/ArrayList;

    move-result-object p2

    const/4 p3, 0x1

    invoke-direct {p0, p3, p2, p1, v6}, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->readStopwatchTimerFromParcel(ILjava/util/ArrayList;Lcom/android/server/power/stats/BatteryStatsImpl$TimeBase;Landroid/os/Parcel;)Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;

    move-result-object p2

    iput-object p2, v1, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->mTimerFull:Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;

    .line 10240
    iget-object p2, v1, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->mBsi:Lcom/android/server/power/stats/BatteryStatsImpl;

    invoke-static {p2}, Lcom/android/server/power/stats/BatteryStatsImpl;->-$$Nest$fgetmWindowTimers(Lcom/android/server/power/stats/BatteryStatsImpl;)Ljava/util/ArrayList;
    ...
    iput-object p2, v1, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->mTimerWindow:Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;
    ...
    iput-object p2, v1, Lcom/android/server/power/stats/BatteryStatsImpl$Uid$Wakelock;->mTimerDraw:Lcom/android/server/power/stats/BatteryStatsImpl$StopwatchTimer;
