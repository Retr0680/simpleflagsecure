...
.method private calculateApp(Landroid/os/UidBatteryConsumer$Builder;Landroid/os/BatteryStats$Uid;[D)[D
    ...
    invoke-virtual {p1, v3, v4, v5}, Landroid/os/UidBatteryConsumer$Builder;->setConsumedPower(ID)Landroid/os/BatteryConsumer$BaseBuilder;
...
.method public calculate(Landroid/os/BatteryUsageStats$Builder;Landroid/os/BatteryStats;JJLandroid/os/BatteryUsageStatsQuery;)V
    ...
    .line 55
    .local v4, "app":Landroid/os/UidBatteryConsumer$Builder;
    invoke-virtual {v4}, Landroid/os/UidBatteryConsumer$Builder;->getBatteryStatsUid()Landroid/os/BatteryStats$Uid;

    move-result-object v5

    invoke-direct {p0, v4, v5, v0}, Lcom/android/server/power/stats/CustomEnergyConsumerPowerCalculator;->calculateApp(Landroid/os/UidBatteryConsumer$Builder;Landroid/os/BatteryStats$Uid;[D)[D

    move-result-object v0

    .line 53
    .end local v4    # "app":Landroid/os/UidBatteryConsumer$Builder;
    add-int/lit8 v2, v2, -0x1
    ...
    .line 58
    invoke-direct {p0, v2}, Lcom/android/server/power/stats/CustomEnergyConsumerPowerCalculator;->uCtoMah([J)[D

    move-result-object v2

    .line 60
    .local v2, "customEnergyConsumerPowerMah":[D
    if-eqz v2, :cond_1
    ...
    .line 64
    .local v4, "deviceBatteryConsumerBuilder":Landroid/os/AggregateBatteryConsumer$Builder;
    const/4 v5, 0x0
    ...
    .line 65
    add-int/lit16 v6, v5, 0x3e8

    aget-wide v7, v2, v5

    invoke-virtual {v4, v6, v7, v8}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(ID)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .line 70
    .end local v4    # "deviceBatteryConsumerBuilder":Landroid/os/AggregateBatteryConsumer$Builder;
    .end local v5    # "i":I
    :cond_1
    if-eqz v0, :cond_2
    ...
    .line 74
    .local v3, "appsBatteryConsumerBuilder":Landroid/os/AggregateBatteryConsumer$Builder;
    const/4 v4, 0x0
    ...
    invoke-virtual {v3, v5, v6, v7}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(ID)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .line 80
    .end local v3    # "appsBatteryConsumerBuilder":Landroid/os/AggregateBatteryConsumer$Builder;
    .end local v4    # "i":I
    :cond_2
    return-void
.end method
