...
.method public parseProcWakelocks([BIZLcom/android/server/power/stats/KernelWakelockStats;)Lcom/android/server/power/stats/KernelWakelockStats;
    ...
    .line 284
    .restart local v17    # "activeTime":J
    aget-wide v21, v7, v0
    ...
    .end local v19    # "activeTime":J
    .local v12, "activeTime":J
    ...
    .line 292
    .end local v12    # "activeTime":J
    .end local v14    # "totalTime":J
    .restart local v13    # "count":I
    .local v17, "totalTime":J
    .restart local v19    # "activeTime":J
    :cond_7
    move-wide/from16 v14, v17
    ...
    .end local v13    # "count":I
    .end local v19    # "activeTime":J
    .restart local v12    # "activeTime":J
    ...
    .end local v2    # "parsed":Z
    .local v18, "parsed":Z
    iget v2, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->version:I
    :try_end_9
    ...
    .line 294
    iget v2, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->count:I

    add-int v2, v2, v17

    iput v2, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->count:I
    ...
    .end local v6    # "nameStringArray":[Ljava/lang/String;
    .end local v7    # "wlData":[J
    .local v2, "nameStringArray":[Ljava/lang/String;
    .local v4, "wlData":[J
    iget-wide v6, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->totalTimeUs:J

    add-long/2addr v6, v14

    iput-wide v6, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->totalTimeUs:J

    .line 296
    iput-wide v12, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->activeTimeUs:J
    ...
    .end local v2    # "nameStringArray":[Ljava/lang/String;
    .end local v4    # "wlData":[J
    .end local v8    # "name":Ljava/lang/String;
    .end local v12    # "activeTime":J
    .end local v14    # "totalTime":J
    .end local v17    # "count":I
    .end local v18    # "parsed":Z
    :catchall_2
    move-exception v0
    ...
    .end local v6    # "nameStringArray":[Ljava/lang/String;
    .end local v7    # "wlData":[J
    .restart local v2    # "nameStringArray":[Ljava/lang/String;
    .restart local v4    # "wlData":[J
    move/from16 v6, v17

    .end local v17    # "count":I
    .local v6, "count":I
    iput v6, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->count:I

    .line 299
    iput-wide v14, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->totalTimeUs:J
    ...
    iput v7, v0, Lcom/android/server/power/stats/KernelWakelockStats$Entry;->version:I
    :try_end_a
    ...
    .end local v2    # "nameStringArray":[Ljava/lang/String;
    .local v17, "nameStringArray":[Ljava/lang/String;
    :try_start_c
    ...
    .end local v4    # "wlData":[J
    .restart local v20    # "wlData":[J
    goto :goto_7

    .end local v17    # "nameStringArray":[Ljava/lang/String;
    .end local v20    # "wlData":[J
    .restart local v2    # "nameStringArray":[Ljava/lang/String;
    .restart local v4    # "wlData":[J
    :catch_2
    ...
    .end local v2    # "nameStringArray":[Ljava/lang/String;
    .end local v4    # "wlData":[J
    .restart local v17    # "nameStringArray":[Ljava/lang/String;
    .restart local v20    # "wlData":[J
    :goto_7
    nop
