...
.method public calculate(Landroid/os/BatteryUsageStats$Builder;Landroid/os/BatteryStats;JJLandroid/os/BatteryUsageStatsQuery;)V
    ...
    .line 53
    new-instance v0, Lcom/android/server/power/stats/VideoPowerCalculator$PowerAndDuration;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/android/server/power/stats/VideoPowerCalculator$PowerAndDuration;-><init>(Lcom/android/server/power/stats/VideoPowerCalculator-IA;)V

    move-object v4, v0

    .line 55
    .local v4, "total":Lcom/android/server/power/stats/VideoPowerCalculator$PowerAndDuration;
    nop
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/power/stats/VideoPowerCalculator;->calculateApp(Landroid/os/UidBatteryConsumer$Builder;Lcom/android/server/power/stats/VideoPowerCalculator$PowerAndDuration;Landroid/os/BatteryStats$Uid;J)V
    ...
    iget-wide v2, v4, Lcom/android/server/power/stats/VideoPowerCalculator$PowerAndDuration;->durationMs:J

    .line 64
    const/4 v5, 0x5

    invoke-virtual {v1, v5, v2, v3}, Landroid/os/AggregateBatteryConsumer$Builder;->setUsageDurationMillis(IJ)Landroid/os/BatteryConsumer$BaseBuilder;

    move-result-object v1

    check-cast v1, Landroid/os/AggregateBatteryConsumer$Builder;

    iget-wide v2, v4, Lcom/android/server/power/stats/VideoPowerCalculator$PowerAndDuration;->powerMah:D

    .line 65
    invoke-virtual {v1, v5, v2, v3}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(ID)Landroid/os/BatteryConsumer$BaseBuilder;
