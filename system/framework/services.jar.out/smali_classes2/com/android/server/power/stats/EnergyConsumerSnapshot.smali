...
.method private updateAndGetDeltaForTypeOther(Landroid/hardware/power/stats/EnergyConsumer;[Landroid/hardware/power/stats/EnergyConsumerAttribution;I)Landroid/util/SparseLongArray;
    ...
    .local v7, "uidOldEnergyMap":Landroid/util/SparseLongArray;
    iget-object v6, v0, Lcom/android/server/power/stats/EnergyConsumerSnapshot;->mAttributionSnapshots:Landroid/util/SparseArray;
    ...
    invoke-virtual {v7, v9, v10, v11}, Landroid/util/SparseLongArray;->put(IJ)V
    ...
    .line 321
    .end local v7    # "uidOldEnergyMap":Landroid/util/SparseLongArray;
    ...
    invoke-direct {v0, v12, v13, v2}, Lcom/android/server/power/stats/EnergyConsumerSnapshot;->calculateChargeConsumedUC(JI)J

    move-result-wide v5

    .line 342
    .local v5, "deltaChargeUC":J
    ...
    .end local v5    # "newAttributions":[Landroid/hardware/power/stats/EnergyConsumerAttribution;
    .end local v6    # "uidOldEnergyMap":Landroid/util/SparseLongArray;
    .restart local v16    # "newAttributions":[Landroid/hardware/power/stats/EnergyConsumerAttribution;
    .restart local p2    # "uidOldEnergyMap":Landroid/util/SparseLongArray;
    :goto_3
...
.method public updateAndGetDelta([Landroid/hardware/power/stats/EnergyConsumerResult;I)Lcom/android/server/power/stats/EnergyConsumerSnapshot$EnergyConsumerDeltaData;
    ...
    .line 215
    .local v19, "otherUidCharges":Landroid/util/SparseLongArray;
    ...
    .local v22, "ecr":Landroid/hardware/power/stats/EnergyConsumerResult;
    .local v23, "consumerId":I
    sub-long v8, v10, v6
    ...
    .line 260
    .end local v21    # "avgVoltageMV":I
    .end local v24    # "deltaUJ":J
    ...
    .end local v1    # "avgVoltageMV":I
    .end local v8    # "deltaUJ":J
    .restart local v21    # "avgVoltageMV":I
    .restart local v24    # "deltaUJ":J
    ...
    .end local v3    # "oldVoltageMV":I
    .end local v8    # "deltaUJ":J
    .restart local v20    # "oldVoltageMV":I
    .restart local v21    # "avgVoltageMV":I
    .restart local v24    # "deltaUJ":J
    :goto_1
    new-instance v1, Ljava/lang/StringBuilder;
    ...
    .end local v19    # "otherUidCharges":Landroid/util/SparseLongArray;
    .end local v21    # "avgVoltageMV":I
    .end local v22    # "ecr":Landroid/hardware/power/stats/EnergyConsumerResult;
    .end local v23    # "consumerId":I
    .end local v24    # "deltaUJ":J
    :goto_2
