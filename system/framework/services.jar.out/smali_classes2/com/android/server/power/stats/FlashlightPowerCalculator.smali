...
.method public calculate(Landroid/os/BatteryUsageStats$Builder;Landroid/os/BatteryStats;JJLandroid/os/BatteryUsageStatsQuery;)V
    ...
    .end local p7    # "query":Landroid/os/BatteryUsageStatsQuery;
    .local v0, "query":Landroid/os/BatteryUsageStatsQuery;
    .local p2, "builder":Landroid/os/BatteryUsageStats$Builder;
    .local p3, "batteryStats":Landroid/os/BatteryStats;
    .local p4, "rawRealtimeUs":J
    .local p6, "rawUptimeUs":J
    const/4 v1, 0x0

    invoke-virtual {p3, p4, p5, v1}, Landroid/os/BatteryStats;->getFlashlightOnTime(JI)J
    ...
    iget-object v4, p1, Lcom/android/server/power/stats/FlashlightPowerCalculator;->mPowerEstimator:Lcom/android/server/power/stats/UsageBasedPowerEstimator;
    ...
    .line 52
    .local v4, "powerMah":D
    invoke-virtual {p2, v1}, Landroid/os/BatteryUsageStats$Builder;->getAggregateBatteryConsumerBuilder(I)Landroid/os/AggregateBatteryConsumer$Builder;
    ...
    invoke-virtual {v1, v6, v2, v3}, Landroid/os/AggregateBatteryConsumer$Builder;->setUsageDurationMillis(IJ)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .line 55
    invoke-virtual {v1, v6, v4, v5}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(ID)Landroid/os/BatteryConsumer$BaseBuilder;
