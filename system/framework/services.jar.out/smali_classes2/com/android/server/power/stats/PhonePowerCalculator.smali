...
.method public calculate(Landroid/os/BatteryUsageStats$Builder;Landroid/os/BatteryStats;JJLandroid/os/BatteryUsageStatsQuery;)V
    ...
    .line 58
    iget-object v10, p0, Lcom/android/server/power/stats/PhonePowerCalculator;->mPowerEstimator:Lcom/android/server/power/stats/UsageBasedPowerEstimator;

    invoke-virtual {v10, v8, v9}, Lcom/android/server/power/stats/UsageBasedPowerEstimator;->calculatePower(J)D

    move-result-wide v10

    .local v10, "phoneOnPower":D
    goto :goto_0

    .line 54
    .end local v10    # "phoneOnPower":D
    :pswitch_0
    ...
    .line 55
    .restart local v10    # "phoneOnPower":D
    nop
    ...
    invoke-virtual {v4, v13, v10, v11, v3}, Landroid/os/AggregateBatteryConsumer$Builder;->setConsumedPower(IDI)Landroid/os/BatteryConsumer$BaseBuilder;
    ...
    .line 66
    invoke-virtual {v4, v13, v8, v9}, Landroid/os/AggregateBatteryConsumer$Builder;->setUsageDurationMillis(IJ)Landroid/os/BatteryConsumer$BaseBuilder;
