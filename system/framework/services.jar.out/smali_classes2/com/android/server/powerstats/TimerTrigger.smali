...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/powerstats/PowerStatsLogger;Z)V
    ...
    .line 72
    invoke-direct/range {p0 .. p2}, Lcom/android/server/powerstats/PowerStatsLogTrigger;-><init>(Landroid/content/Context;Lcom/android/server/powerstats/PowerStatsLogger;)V
    ...
    .line 80
    .local v6, "logDataLowFrequency":Lcom/android/server/powerstats/TimerTrigger$PeriodicTimer;
    new-instance v0, Lcom/android/server/powerstats/TimerTrigger$PeriodicTimer;
    ...
    const-string v2, "PowerStatsHighFreqLog"

    invoke-direct/range {v0 .. v5}, Lcom/android/server/powerstats/TimerTrigger$PeriodicTimer;-><init>(Lcom/android/server/powerstats/TimerTrigger;Ljava/lang/String;JI)V

    .line 83
    .local v0, "logDataHighFrequency":Lcom/android/server/powerstats/TimerTrigger$PeriodicTimer;
    ...
    .line 86
    .end local v0    # "logDataHighFrequency":Lcom/android/server/powerstats/TimerTrigger$PeriodicTimer;
    .end local v6    # "logDataLowFrequency":Lcom/android/server/powerstats/TimerTrigger$PeriodicTimer;
    :cond_0
    return-void
.end method
