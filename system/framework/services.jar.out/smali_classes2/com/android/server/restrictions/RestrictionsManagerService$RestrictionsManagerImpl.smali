...
.method public createLocalApprovalIntent()Landroid/content/Intent;
    ...
    .line 153
    invoke-interface {v0, v5}, Landroid/app/admin/IDevicePolicyManager;->getRestrictionsProvider(I)Landroid/content/ComponentName;
    ...
    .line 155
    .local v8, "restrictionsProvider":Landroid/content/ComponentName;
    if-eqz v8, :cond_1
    ...
    .end local v8    # "restrictionsProvider":Landroid/content/ComponentName;
    .end local v9    # "providerPackageName":Ljava/lang/String;
    :catchall_0
    move-exception v0
    ...
    .line 156
    .restart local v8    # "restrictionsProvider":Landroid/content/ComponentName;
    :cond_1
    :try_start_1
