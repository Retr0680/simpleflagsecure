...
.method handlePackageBroadcast(Landroid/content/Intent;)V
    ...
    .line 67
    .local v1, "packageData":Landroid/net/Uri;
    if-nez v1, :cond_0
    ...
    .line 84
    :cond_3
    const-string v0, "android.settings.global"
    ...
    .line 89
    iput-object v3, v8, Lcom/android/server/signedconfig/SignedConfigEvent;->fromPackage:Ljava/lang/String;
    ...
    .line 106
    :try_start_2
    new-instance v4, Lcom/android/server/signedconfig/GlobalSettingsConfigApplicator;

    iget-object v9, p0, Lcom/android/server/signedconfig/SignedConfigService;->mContext:Landroid/content/Context;

    invoke-direct {v4, v9, v3, v8}, Lcom/android/server/signedconfig/GlobalSettingsConfigApplicator;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/server/signedconfig/SignedConfigEvent;)V

    invoke-virtual {v4, v0, v6}, Lcom/android/server/signedconfig/GlobalSettingsConfigApplicator;->applyConfig(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    .restart local v9    # "config":Ljava/lang/String;
    :catch_0
    move-exception v0
