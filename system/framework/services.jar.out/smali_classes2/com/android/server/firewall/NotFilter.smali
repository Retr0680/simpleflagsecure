...
.method public matches(Lcom/android/server/firewall/IntentFirewall;Landroid/content/ComponentName;Landroid/content/Intent;IILjava/lang/String;I)Z
    ...
    .end local p1    # "ifw":Lcom/android/server/firewall/IntentFirewall;
    .end local p2    # "resolvedComponent":Landroid/content/ComponentName;
    .end local p3    # "intent":Landroid/content/Intent;
    .end local p4    # "callerUid":I
    .end local p5    # "callerPid":I
    .end local p6    # "resolvedType":Ljava/lang/String;
    .end local p7    # "receivingUid":I
    .local v1, "ifw":Lcom/android/server/firewall/IntentFirewall;
    .local v2, "resolvedComponent":Landroid/content/ComponentName;
    .local v3, "intent":Landroid/content/Intent;
    .local v4, "callerUid":I
    .local v5, "callerPid":I
    .local v6, "resolvedType":Ljava/lang/String;
    .local v7, "receivingUid":I
