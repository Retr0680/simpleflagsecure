...
.field private final mRulesByComponentClassExact:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field private final mRulesWithComponentClassPattern:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/android/server/firewall/IntentFirewall$Rule;",
...
# direct methods
.method static bridge synthetic -$$Nest$maddComponentClassExactFilter(Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;Ljava/lang/String;Lcom/android/server/firewall/IntentFirewall$Rule;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->addComponentClassExactFilter(Ljava/lang/String;Lcom/android/server/firewall/IntentFirewall$Rule;)V

    return-void
.end method

.method static bridge synthetic -$$Nest$maddComponentClassPatternFilter(Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;Lcom/android/server/firewall/IntentFirewall$Rule;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->addComponentClassPatternFilter(Lcom/android/server/firewall/IntentFirewall$Rule;)V

    return-void
.end method

.method static bridge synthetic -$$Nest$mqueryByComponentClass(Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;Ljava/lang/String;Ljava/util/List;)V
    .locals 0

    .line 0
    invoke-direct {p0, p1, p2}, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->queryByComponentClass(Ljava/lang/String;Ljava/util/List;)V
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->mRulesByComponentClassExact:Landroid/util/ArrayMap;
    ...
    iput-object v0, p0, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->mRulesWithComponentClassPattern:Ljava/util/List;

    return-void
.end method

.method synthetic constructor <init>(Lcom/android/server/firewall/IntentFirewall-IA;)V
    .locals 0
...
.method private addComponentClassExactFilter(Ljava/lang/String;Lcom/android/server/firewall/IntentFirewall$Rule;)V
    .locals 2
    .param p1, "className"    # Ljava/lang/String;
    .param p2, "rule"    # Lcom/android/server/firewall/IntentFirewall$Rule;

    .line 689
    iget-object v0, p0, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->mRulesByComponentClassExact:Landroid/util/ArrayMap;
    ...
    .line 691
    iget-object v1, p0, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->mRulesByComponentClassExact:Landroid/util/ArrayMap;
...
.method private addComponentClassPatternFilter(Lcom/android/server/firewall/IntentFirewall$Rule;)V
    .locals 1
    .param p1, "rule"    # Lcom/android/server/firewall/IntentFirewall$Rule;

    .line 695
    iget-object v0, p0, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->mRulesWithComponentClassPattern:Ljava/util/List;
...
.method private queryByComponentClass(Ljava/lang/String;Ljava/util/List;)V
    .locals 5
    .param p1, "className"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .local v1, "i":I
    :goto_0
    iget-object v2, p0, Lcom/android/server/firewall/IntentFirewall$FirewallIntentResolver;->mRulesWithComponentClassPattern:Ljava/util/List;
    ...
    .local v3, "j":I
    :goto_1
    invoke-virtual {v2}, Lcom/android/server/firewall/IntentFirewall$Rule;->getComponentClassPatternFilterCount()I
    ...
    .line 675
    invoke-virtual {v2, v3}, Lcom/android/server/firewall/IntentFirewall$Rule;->getComponentClassPatternMatcher(I)Landroid/os/PatternMatcher;
