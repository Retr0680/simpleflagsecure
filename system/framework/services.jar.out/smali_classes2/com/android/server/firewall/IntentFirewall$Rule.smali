...
# static fields
.field private static final ATTR_ADVANCED_PATTERN:Ljava/lang/String; = "advancedPattern"

.field private static final ATTR_BLOCK:Ljava/lang/String; = "block"

.field private static final ATTR_ENDS_WITH:Ljava/lang/String; = "endsWith"
...
.field private static final TAG_COMPONENT_CLASS_FILTER:Ljava/lang/String; = "component-class-filter"
...
.field private final mComponentClassExactFilters:Ljava/util/ArrayList;
...
.field private final mComponentClassPatternMatchers:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mComponentClassExactFilters:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mComponentClassPatternMatchers:Ljava/util/ArrayList;
...
.method public getComponentClassExactFilter(I)Ljava/lang/String;
    .locals 1
    .param p1, "index"    # I

    .line 593
    iget-object v0, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mComponentClassExactFilters:Ljava/util/ArrayList;
...
.method public getComponentClassExactFilterCount()I
    .locals 1
...
.method public getComponentClassPatternFilterCount()I
    .locals 1

    .line 597
    iget-object v0, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mComponentClassPatternMatchers:Ljava/util/ArrayList;
...
.method public getComponentClassPatternMatcher(I)Landroid/os/PatternMatcher;
    .locals 1
    .param p1, "index"    # I
...
.method protected readChild(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .end local v1    # "componentStr":Ljava/lang/String;
    :cond_3
    iget v1, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mRuleType:I
    ...
    .line 542
    const-string v1, "component-class-filter"
    ...
    .line 548
    .local v3, "newAttrName":Ljava/lang/String;
    ...
    :sswitch_1
    const-string v1, "advancedPattern"
    ...
    const-string v2, "component-class-filter only supports \'equals\', \'startsWith\' and \'endsWith\' attribute."
    ...
    .line 561
    :pswitch_0
    iget-object v1, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mComponentClassPatternMatchers:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, v4, v8}, Landroid/os/PatternMatcher;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v2, v4, v7}, Landroid/os/PatternMatcher;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v5, v4, v2}, Landroid/os/PatternMatcher;-><init>(Ljava/lang/String;I)V
    ...
    .line 554
    :pswitch_4
    iget-object v1, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mComponentClassExactFilters:Ljava/util/ArrayList;

    invoke-virtual {v1, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 567
    .end local v3    # "newAttrName":Ljava/lang/String;
    .end local v4    # "attrValue":Ljava/lang/String;
    :goto_2
    goto :goto_3

    .line 550
    .restart local v3    # "newAttrName":Ljava/lang/String;
    .restart local v4    # "attrValue":Ljava/lang/String;
    :cond_5
    new-instance v1, Lorg/xmlpull/v1/XmlPullParserException;

    const-string v2, "Attribute value cannot be empty in component-class-filter"
    ...
    const-string v2, "component-class-filter must have one and only one attributes."
    ...
    :sswitch_data_0
    .sparse-switch
        -0x5cb7a349 -> :sswitch_4
        -0x4d378041 -> :sswitch_3
        -0x2f271470 -> :sswitch_2
        -0x24d2eef2 -> :sswitch_1
...
.method public setRuleType(I)V
    ...
    .line 613
    iput p1, p0, Lcom/android/server/firewall/IntentFirewall$Rule;->mRuleType:I
