...
.method private ensureUserCanTakeBugReport(I)V
    ...
    .local v5, "isAdminUser":Z
    goto :goto_0

    .line 740
    .end local v4    # "profileParent":Landroid/content/pm/UserInfo;
    .end local v5    # "isAdminUser":Z
    .restart local v1    # "isAdminUser":Z
    :catchall_0
    move-exception v4
    ...
    .end local v1    # "isAdminUser":Z
    .end local v4    # "profileParent":Landroid/content/pm/UserInfo;
    .restart local v5    # "isAdminUser":Z
    :goto_0
    ...
    .line 747
    const-string v4, "Calling user %s is not an admin user. Only admin users and their profiles are allowed to take bugreport."
...
.method private synthetic lambda$startBugreport$0(Landroid/util/MutableBoolean;ILjava/lang/String;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;IILandroid/os/IDumpstateListener;Z)V
    ...
    :try_start_3
    invoke-direct/range {v2 .. v10}, Lcom/android/server/os/BugreportManagerServiceImpl;->startBugreportLocked(ILjava/lang/String;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;IILandroid/os/IDumpstateListener;Z)V
    ...
    const-string v3, "Cannot start a new bugreport due to an unknown error"
    ...
    invoke-direct {p0, v9, v1}, Lcom/android/server/os/BugreportManagerServiceImpl;->reportError(Landroid/os/IDumpstateListener;I)V
...
.method private startBugreportLocked(ILjava/lang/String;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;IILandroid/os/IDumpstateListener;Z)V
    ...
    invoke-direct {v1}, Lcom/android/server/os/BugreportManagerServiceImpl;->isDumpstateBinderServiceRunningLocked()Z
    ...
    .line 811
    const-string v3, "\'dumpstate\' is already running. Cannot start a new bugreport while another operation is currently in progress."
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/os/BugreportManagerServiceImpl;->reportError(Landroid/os/IDumpstateListener;I)V
    ...
    .line 818
    iget-object v3, v1, Lcom/android/server/os/BugreportManagerServiceImpl;->mPreDumpedDataUid:Ljava/util/OptionalInt;
    ...
    .line 819
    invoke-direct {v1, v0, v5}, Lcom/android/server/os/BugreportManagerServiceImpl;->clearBugreportFlag(II)I
    ...
    .line 834
    .local v6, "isDeferredConsentReport":Z
    ...
    invoke-direct {v1}, Lcom/android/server/os/BugreportManagerServiceImpl;->startAndGetDumpstateBinderServiceLocked()Landroid/os/IDumpstate;

    move-result-object v3

    .line 838
    .local v3, "ds":Landroid/os/IDumpstate;
    if-nez v3, :cond_6
    ...
    invoke-direct {v1, v2, v0}, Lcom/android/server/os/BugreportManagerServiceImpl;->reportError(Landroid/os/IDumpstateListener;I)V
    ...
    :goto_3
    invoke-virtual {v4, v9, v8}, Lcom/android/server/os/BugreportManagerServiceImpl$BugreportFileManager;->canSkipConsentScreen(Ljava/lang/String;Z)Z

    move-result v12

    .line 845
    .local v12, "skipUserConsent":Z
    ...
    invoke-direct {v4, v13, v9}, Landroid/util/Pair;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .end local v7    # "keepBugreportOnRetrieval":Z
    .local v5, "isDeferredConsentReport":Z
    .local v6, "keepBugreportOnRetrieval":Z
    ...
    .end local v3    # "ds":Landroid/os/IDumpstate;
    .end local v5    # "isDeferredConsentReport":Z
    .end local v6    # "keepBugreportOnRetrieval":Z
    .local v1, "ds":Landroid/os/IDumpstate;
    .local v14, "isDeferredConsentReport":Z
    .local v15, "keepBugreportOnRetrieval":Z
    move-object v8, v0

    .line 850
    .local v8, "myListener":Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;
    invoke-direct {v13, v8}, Lcom/android/server/os/BugreportManagerServiceImpl;->setCurrentDumpstateListenerLocked(Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;)V
    ...
    .end local v11    # "bugreportFlags":I
    .end local v12    # "skipUserConsent":Z
    .local v7, "bugreportFlags":I
    .local v10, "skipUserConsent":Z
    :try_start_0
...
.method public retrieveBugreport(ILjava/lang/String;ILjava/io/FileDescriptor;Ljava/lang/String;ZZLandroid/os/IDumpstateListener;)V
    ...
    invoke-direct {v1, v8, v9, v0}, Lcom/android/server/os/BugreportManagerServiceImpl;->enforcePermission(Ljava/lang/String;IZ)V
    ...
    iget-object v3, v1, Lcom/android/server/os/BugreportManagerServiceImpl;->mContext:Landroid/content/Context;
    ...
    const-string v4, "Unable to get bugreport service"
    ...
    .line 621
    .local v2, "myListener":Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;
    const/4 v0, 0x0
    ...
    .line 623
    :try_start_6
    iget-object v3, v12, Lcom/android/server/os/BugreportManagerServiceImpl;->mBugreportFileManager:Lcom/android/server/os/BugreportManagerServiceImpl$BugreportFileManager;

    iget-object v3, v3, Lcom/android/server/os/BugreportManagerServiceImpl$BugreportFileManager;->mBugreportFilesToPersist:Ljava/util/Set;
    ...
    .local v7, "keepBugreportOnRetrieval":Z
    invoke-direct {v12, v2}, Lcom/android/server/os/BugreportManagerServiceImpl;->setCurrentDumpstateListenerLocked(Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;)V
    :try_end_6
    ...
    .end local v11    # "skipUserConsent":Z
    .local v2, "callingUid":I
    .local v8, "skipUserConsent":Z
    .local v9, "myListener":Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;
    :try_start_7
    invoke-interface/range {v1 .. v9}, Landroid/os/IDumpstate;->retrieveBugreport(ILjava/lang/String;ILjava/io/FileDescriptor;Ljava/lang/String;ZZLandroid/os/IDumpstateListener;)V
    :try_end_7
    ...
    .end local v7    # "keepBugreportOnRetrieval":Z
    .end local v8    # "skipUserConsent":Z
    .end local v9    # "myListener":Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;
    :catchall_1
    move-exception v0
    ...
    .line 631
    .restart local v1    # "ds":Landroid/os/IDumpstate;
    .restart local v7    # "keepBugreportOnRetrieval":Z
    .restart local v8    # "skipUserConsent":Z
    .restart local v9    # "myListener":Lcom/android/server/os/BugreportManagerServiceImpl$DumpstateListener;
    :catch_0
    move-exception v0
    ...
    const-string v4, "RemoteException in retrieveBugreport"
    ...
    invoke-direct {v12, v13, v1}, Lcom/android/server/os/BugreportManagerServiceImpl;->reportError(Landroid/os/IDumpstateListener;I)V
...
.method public startBugreport(ILjava/lang/String;Ljava/io/FileDescriptor;Ljava/io/FileDescriptor;IILandroid/os/IDumpstateListener;ZZ)V
    ...
    .line 494
    invoke-direct {p0, v6}, Lcom/android/server/os/BugreportManagerServiceImpl;->validateBugreportMode(I)V

    .line 495
    move/from16 v7, p6

    invoke-direct {p0, v7}, Lcom/android/server/os/BugreportManagerServiceImpl;->validateBugreportFlags(I)V
    ...
    :goto_0
    invoke-direct {p0, p2, v2, v0}, Lcom/android/server/os/BugreportManagerServiceImpl;->enforcePermission(Ljava/lang/String;IZ)V

    .line 500
    invoke-direct {p0, v6}, Lcom/android/server/os/BugreportManagerServiceImpl;->ensureUserCanTakeBugReport(I)V

    .line 502
    const-string v0, "BugreportManagerService"

    const-string v3, "Starting bugreport for %s / %d"
    ...
    .line 504
    .local v10, "handoffLock":Landroid/util/MutableBoolean;
    nop

    .line 537
    iget-object v11, p0, Lcom/android/server/os/BugreportManagerServiceImpl;->mLock:Ljava/lang/Object;
