...
.method commitPendingBackupAndRestoreForUser(ILcom/android/server/rollback/Rollback;)Z
    ...
    iget-object v1, p2, Lcom/android/server/rollback/Rollback;->info:Landroid/content/rollback/RollbackInfo;
    ...
    .line 229
    .local v2, "hasPendingBackup":Z
    const/4 v3, 0x0

    .line 230
    .local v3, "hasPendingRestore":Z
    invoke-virtual {v4}, Landroid/content/rollback/PackageRollbackInfo;->getPendingBackups()Ljava/util/List;

    move-result-object v10

    .line 231
    .local v10, "pendingBackupUsers":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    if-eqz v10, :cond_0
    ...
    .line 238
    :cond_0
    invoke-virtual {v4, p1}, Landroid/content/rollback/PackageRollbackInfo;->getRestoreInfo(I)Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;

    move-result-object v11

    .line 239
    .local v11, "ri":Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;
    if-eqz v11, :cond_1
    ...
    .line 244
    .end local v3    # "hasPendingRestore":Z
    .local v12, "hasPendingRestore":Z
    :goto_1
    if-eqz v2, :cond_2
    ...
    .line 247
    invoke-virtual {v4, p1}, Landroid/content/rollback/PackageRollbackInfo;->removePendingBackup(I)V

    .line 248
    invoke-virtual {v4, p1}, Landroid/content/rollback/PackageRollbackInfo;->removePendingRestoreInfo(I)V
    ...
    .line 254
    .local v3, "idx":I
    iget-object v5, p2, Lcom/android/server/rollback/Rollback;->info:Landroid/content/rollback/RollbackInfo;
    ...
    invoke-direct {p0, v4, p1, v5, v6}, Lcom/android/server/rollback/AppDataRollbackHelper;->doSnapshot(Landroid/content/rollback/PackageRollbackInfo;III)Z
    ...
    iget v7, v11, Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;->appId:I

    iget-object v8, v11, Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;->seInfo:Ljava/lang/String;
    ...
    .line 262
    invoke-virtual {v4, v11}, Landroid/content/rollback/PackageRollbackInfo;->removeRestoreInfo(Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;)V
    ...
    .line 264
    .end local v2    # "hasPendingBackup":Z
    .end local v4    # "info":Landroid/content/rollback/PackageRollbackInfo;
    .end local v10    # "pendingBackupUsers":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    .end local v11    # "ri":Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;
    .end local v12    # "hasPendingRestore":Z
    .end local p1    # "userId":I
...
.method public restoreAppData(ILandroid/content/rollback/PackageRollbackInfo;IILjava/lang/String;)Z
    ...
    .line 92
    .local v7, "pendingBackups":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Integer;>;"
    invoke-virtual {p2}, Landroid/content/rollback/PackageRollbackInfo;->getPendingRestores()Ljava/util/ArrayList;

    move-result-object v8

    .line 93
    .local v8, "pendingRestores":Ljava/util/List;, "Ljava/util/List<Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;>;"
    const/4 v1, 0x0
    ...
    invoke-direct {v4, p3, p4, p5}, Landroid/content/rollback/PackageRollbackInfo$RestoreInfo;-><init>(IILjava/lang/String;)V
