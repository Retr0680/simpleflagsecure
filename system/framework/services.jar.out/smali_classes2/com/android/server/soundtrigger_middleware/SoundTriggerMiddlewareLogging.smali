...
.method public attach(ILandroid/media/soundtrigger_middleware/ISoundTriggerCallback;Z)Landroid/media/soundtrigger_middleware/ISoundTriggerModule;
    ...
    .line 157
    .local v0, "packageIdentification":Ljava/lang/String;
    new-instance v2, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ModuleLogging;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ModuleLogging;-><init>(Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging;Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging-IA;)V

    move-object v8, v2

    .line 158
    .local v8, "result":Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ModuleLogging;
    ...
    .line 161
    .local v5, "eventLogger":Lcom/android/server/utils/EventLogger;
    ...
    .local v4, "callback":Landroid/media/soundtrigger_middleware/ISoundTriggerCallback;
    :try_start_3
    ...
    iget-object p2, v3, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging;->mDelegate:Lcom/android/server/soundtrigger_middleware/ISoundTriggerMiddlewareInternal;

    invoke-interface {p2, p1, v2, p3}, Lcom/android/server/soundtrigger_middleware/ISoundTriggerMiddlewareInternal;->attach(ILandroid/media/soundtrigger_middleware/ISoundTriggerCallback;Z)Landroid/media/soundtrigger_middleware/ISoundTriggerModule;

    move-result-object p2

    invoke-virtual {v8, p2, v5}, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ModuleLogging;->attach(Landroid/media/soundtrigger_middleware/ISoundTriggerModule;Lcom/android/server/utils/EventLogger;)V

    .line 165
    iget-object p2, v3, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging;->mServiceEventLogger:Lcom/android/server/utils/EventLogger;
    ...
    .line 165
    invoke-static {v7, v0, v8, v9}, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ServiceEvent;->createForReturn(Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ServiceEvent$Type;Ljava/lang/String;Ljava/lang/Object;[Ljava/lang/Object;)Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ServiceEvent;
    ...
    invoke-virtual {v7, v9, v1}, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ServiceEvent;->printLog(ILjava/lang/String;)Lcom/android/server/utils/EventLogger$Event;

    move-result-object v7

    .line 165
    invoke-virtual {p2, v7}, Lcom/android/server/utils/EventLogger;->enqueue(Lcom/android/server/utils/EventLogger$Event;)V

    .line 170
    iget-object p2, v3, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging;->mSessionEventLoggers:Ljava/util/Set;
    ...
    .line 172
    .end local v0    # "packageIdentification":Ljava/lang/String;
    .end local v2    # "callbackWrapper":Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$CallbackLogging;
    .end local v5    # "eventLogger":Lcom/android/server/utils/EventLogger;
    .end local v6    # "originatorIdentity":Landroid/media/permission/Identity;
    .end local v8    # "result":Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ModuleLogging;
    :catch_1
    move-exception v0

    goto :goto_1

    .end local v4    # "callback":Landroid/media/soundtrigger_middleware/ISoundTriggerCallback;
    ...
    .end local p2    # "callback":Landroid/media/soundtrigger_middleware/ISoundTriggerCallback;
    .restart local v4    # "callback":Landroid/media/soundtrigger_middleware/ISoundTriggerCallback;
    :goto_1
    nop
    ...
    invoke-virtual {v2, v5, v1}, Lcom/android/server/soundtrigger_middleware/SoundTriggerMiddlewareLogging$ServiceEvent;->printLog(ILjava/lang/String;)Lcom/android/server/utils/EventLogger$Event;
