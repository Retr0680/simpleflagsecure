...
.method private listCmd([Ljava/lang/String;Ljava/io/PrintWriter;Ljava/io/PrintWriter;)I
    ...
    .line 97
    iget-object v2, v0, Lcom/android/server/flags/FlagsShellCommand;->mFlagStore:Lcom/android/server/flags/FlagOverrideStore;

    const/4 v3, 0x1

    aget-object v3, v1, v3

    invoke-virtual {v2, v3}, Lcom/android/server/flags/FlagOverrideStore;->getFlagsForNamespace(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v2

    .local v2, "overrides":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;>;"
    goto :goto_0

    .line 99
    .end local v2    # "overrides":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;>;"
    :cond_1
    iget-object v2, v0, Lcom/android/server/flags/FlagsShellCommand;->mFlagStore:Lcom/android/server/flags/FlagOverrideStore;

    invoke-virtual {v2}, Lcom/android/server/flags/FlagOverrideStore;->getFlags()Ljava/util/Map;

    move-result-object v2

    .line 101
    .restart local v2    # "overrides":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;>;"
    :goto_0
    ...
    .line 102
    const-string v3, "No overrides set"
    ...
    .line 105
    .local v4, "longestNamespaceLen":I
    ...
    invoke-virtual {v6, v3}, Ljava/io/PrintWriter;->print(C)V
    ...
    .line 120
    invoke-virtual {v6, v8}, Ljava/io/PrintWriter;->print(C)V
    ...
    .line 132
    .local v8, "namespace":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;>;"
    ...
    .line 140
    .end local v8    # "namespace":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;>;"
    :cond_8
    goto :goto_6

    .line 142
    .end local v4    # "longestNamespaceLen":I
    .end local v9    # "longestFlagLen":I
...
.method private validateNumArguments([Ljava/lang/String;ILjava/lang/String;Ljava/io/PrintWriter;)Z
    ...
    .end local p2    # "exactly":I
    .end local p3    # "cmdName":Ljava/lang/String;
    .end local p4    # "errPw":Ljava/io/PrintWriter;
    .local v1, "args":[Ljava/lang/String;
    .local v2, "exactly":I
    .local v4, "cmdName":Ljava/lang/String;
    .local v5, "errPw":Ljava/io/PrintWriter;
    invoke-direct/range {v0 .. v5}, Lcom/android/server/flags/FlagsShellCommand;->validateNumArguments([Ljava/lang/String;IILjava/lang/String;Ljava/io/PrintWriter;)Z
