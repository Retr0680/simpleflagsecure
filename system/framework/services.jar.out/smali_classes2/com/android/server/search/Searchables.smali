...
.method private queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
    ...
    iget v7, p0, Lcom/android/server/search/Searchables;->mUserId:I
    :try_end_0
...
.method public getSearchableInfo(Landroid/content/ComponentName;)Landroid/app/SearchableInfo;
    ...
    .line 163
    .local v2, "refActivityName":Ljava/lang/String;
...
.method public updateSearchableListIfNeeded()V
    ...
    invoke-static {v0, v6, v7}, Landroid/app/SearchableInfo;->getActivityMetaData(Landroid/content/Context;Landroid/content/pm/ActivityInfo;I)Landroid/app/SearchableInfo;
    ...
    .restart local v19    # "ident":J
    :goto_6
    invoke-direct {v1}, Lcom/android/server/search/Searchables;->findGlobalSearchActivities()Ljava/util/List;
    ...
    .line 299
    .local v7, "newGlobalSearchActivity":Landroid/content/ComponentName;
    invoke-direct {v1, v7}, Lcom/android/server/search/Searchables;->findWebSearchActivity(Landroid/content/ComponentName;)Landroid/content/ComponentName;
    ...
    .line 302
    .local v8, "newWebSearchActivity":Landroid/content/ComponentName;
    monitor-enter p0
    :try_end_5
    ...
    .line 308
    iput-object v7, v1, Lcom/android/server/search/Searchables;->mCurrentGlobalSearchActivity:Landroid/content/ComponentName;

    .line 309
    iput-object v8, v1, Lcom/android/server/search/Searchables;->mWebSearchActivity:Landroid/content/ComponentName;
    ...
    .end local v7    # "newGlobalSearchActivity":Landroid/content/ComponentName;
    .end local v8    # "newWebSearchActivity":Landroid/content/ComponentName;
    .end local v10    # "webSearchIntent":Landroid/content/Intent;
    .end local v11    # "webSearchInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .restart local v7    # "newGlobalSearchActivity":Landroid/content/ComponentName;
    .restart local v8    # "newWebSearchActivity":Landroid/content/ComponentName;
    .restart local v10    # "webSearchIntent":Landroid/content/Intent;
    .restart local v11    # "webSearchInfoList":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    :goto_8
    :try_start_7
