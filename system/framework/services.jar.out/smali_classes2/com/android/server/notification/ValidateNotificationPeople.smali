...
.method private validatePeople(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/List;[FLandroid/util/ArraySet;)Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;
    ...
    .line 271
    .local v8, "people":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    ...
    .line 272
    .local v9, "notificationPeople":[Ljava/lang/String;
    if-eqz v9, :cond_1
    ...
    .line 276
    :cond_1
    sget-boolean v4, Lcom/android/server/notification/ValidateNotificationPeople;->VERBOSE:Z
    ...
    .line 282
    :cond_3
    iget-object v13, v1, Lcom/android/server/notification/ValidateNotificationPeople;->mPeopleCache:Landroid/util/LruCache;
    ...
    invoke-static {v0, v12}, Lcom/android/server/notification/ValidateNotificationPeople;->getCacheKey(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 284
    .local v0, "cacheKey":Ljava/lang/String;
    iget-object v14, v1, Lcom/android/server/notification/ValidateNotificationPeople;->mPeopleCache:Landroid/util/LruCache;
    ...
    .line 297
    .local v2, "phoneNumbers":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    if-eqz v2, :cond_7
    ...
    .line 298
    invoke-virtual {v6, v2}, Landroid/util/ArraySet;->addAll(Landroid/util/ArraySet;)V

    .line 302
    .end local v0    # "cacheKey":Ljava/lang/String;
    .end local v2    # "phoneNumbers":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v14    # "lookupResult":Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;
    :cond_7
    monitor-exit v13
    ...
    .line 309
    .end local v5    # "affinity":F
    .local v10, "affinity":F
    :goto_4
    const/4 v0, 0x0
    ...
    const-string v5, "final affinity: "
    ...
    const-string v5, "Pending: future work scheduled for: "
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;-><init>(Lcom/android/server/notification/ValidateNotificationPeople;Landroid/content/Context;Ljava/lang/String;Ljava/util/LinkedList;Lcom/android/server/notification/ValidateNotificationPeople-IA;)V
...
.method public getContactAffinity(Landroid/os/UserHandle;Landroid/os/Bundle;IF)F
    ...
    invoke-direct/range {v5 .. v11}, Lcom/android/server/notification/ValidateNotificationPeople;->validatePeople(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/util/List;[FLandroid/util/ArraySet;)Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;

    move-result-object v3

    .line 196
    .local v3, "prr":Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;
    const/4 v0, 0x0
    ...
    .line 202
    .local v8, "s":Ljava/util/concurrent/Semaphore;
    sget-object v0, Landroid/os/AsyncTask;->THREAD_POOL_EXECUTOR:Ljava/util/concurrent/Executor;

    new-instance v9, Lcom/android/server/notification/ValidateNotificationPeople$2;

    invoke-direct {v9, p0, v3, v8}, Lcom/android/server/notification/ValidateNotificationPeople$2;-><init>(Lcom/android/server/notification/ValidateNotificationPeople;Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;Ljava/util/concurrent/Semaphore;)V
    ...
    invoke-virtual {v8, v11, v12, v0}, Ljava/util/concurrent/Semaphore;->tryAcquire(JLjava/util/concurrent/TimeUnit;)Z
    ...
    const-string v11, "Timeout while waiting for affinity: "

    invoke-virtual {v0, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v11, ". Returning timeoutAffinity="
    ...
    .line 222
    invoke-virtual {v3}, Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;->getContactAffinity()F
    ...
    .end local v8    # "s":Ljava/util/concurrent/Semaphore;
    :cond_4
    move/from16 v9, p3
...
.method protected validatePeople(Landroid/content/Context;Lcom/android/server/notification/NotificationRecord;)Lcom/android/server/notification/RankingReconsideration;
    ...
    .line 247
    .local v6, "phoneNumbersOut":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    nop
    ...
    .line 250
    .local p1, "rr":Lcom/android/server/notification/ValidateNotificationPeople$PeopleRankingReconsideration;
    const/4 v4, 0x0
    ...
    .line 251
    .local v8, "affinity":F
    invoke-virtual {p2, v8}, Lcom/android/server/notification/NotificationRecord;->setContactAffinity(F)V
    ...
    .line 256
    iget-object v9, v0, Lcom/android/server/notification/ValidateNotificationPeople;->mUsageStats:Lcom/android/server/notification/NotificationUsageStats;
    ...
    :cond_2
    invoke-virtual {v9, p2, v10, v4, v7}, Lcom/android/server/notification/NotificationUsageStats;->registerPeopleAffinity(Lcom/android/server/notification/NotificationRecord;ZZZ)V
