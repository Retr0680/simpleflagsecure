...
.method synthetic constructor <init>(Lcom/android/server/notification/ValidateNotificationPeople;Landroid/content/Context;Ljava/lang/String;Ljava/util/LinkedList;Lcom/android/server/notification/ValidateNotificationPeople-IA;)V
    .locals 0
...
.method private static addContacts(Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 696
    :try_start_2
    const-string v0, "Null cursor from contacts query."
    ...
    .line 700
    invoke-virtual {p0, p2}, Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;->mergeContact(Landroid/database/Cursor;)V
    :try_end_4
    ...
    const-string v0, "Problem getting content resolver or performing contacts query."
...
.method static searchContactsAndLookupNumbers(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;
    ...
    .line 644
    .local v2, "lookupResult":Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;
    invoke-virtual {v2}, Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;->getPhoneLookupKey()Ljava/lang/String;

    move-result-object v3

    .line 645
    .local v3, "phoneLookupKey":Ljava/lang/String;
    if-eqz v3, :cond_4
    ...
    sget-object v6, Lcom/android/server/notification/ValidateNotificationPeople;->PHONE_LOOKUP_PROJECTION:[Ljava/lang/String;
    ...
    .line 657
    invoke-virtual {v2, v4}, Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;->mergePhoneNumber(Landroid/database/Cursor;)V
    :try_end_3
    ...
    .end local v2    # "lookupResult":Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;
    .end local v3    # "phoneLookupKey":Ljava/lang/String;
    ...
    .line 659
    .end local v4    # "cursor":Landroid/database/Cursor;
    .restart local v2    # "lookupResult":Lcom/android/server/notification/ValidateNotificationPeople$LookupResult;
    .restart local v3    # "phoneLookupKey":Ljava/lang/String;
