...
.field private mBundleType:I

.field private mCanceledAfterLifetimeExtension:Z
...
.field private mSummarization:Ljava/lang/String;
...
.method private calculateSound()Landroid/net/Uri;
    ...
    .line 287
    .end local v3    # "useDefaultSound":Z
    :cond_3
    :goto_1
    return-object v1
.end method
...
.method public applyAdjustments()V
    ...
    .local v8, "importance":I
    invoke-static {v7, v8}, Ljava/lang/Math;->min(II)I

    move-result v6

    .line 778
    .end local v8    # "importance":I
    ...
    const-class v7, Landroid/app/NotificationChannel;
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/notification/NotificationRecord;->updateNotificationChannel(Landroid/app/NotificationChannel;)V
    ...
    iget-object v8, p0, Lcom/android/server/notification/NotificationRecord;->mChannel:Landroid/app/NotificationChannel;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;Landroid/content/Context;Z)V
    ...
    iget-boolean v2, p0, Lcom/android/server/notification/NotificationRecord;->mCanceledAfterLifetimeExtension:Z
    ...
    const-string/jumbo v2, "hasSummarization="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v2, p0, Lcom/android/server/notification/NotificationRecord;->mSummarization:Ljava/lang/String;
...
.method public getBundleType()I
    ...
    .line 1663
    iget v0, p0, Lcom/android/server/notification/NotificationRecord;->mBundleType:I
...
.method public setCanceledAfterLifetimeExtension(Z)V
    .locals 0
    .param p1, "canceledAfterLifetimeExtension"    # Z
...
.method public setVisibility(ZIILcom/android/server/notification/NotificationRecordLogger;)V
    ...
    .line 1137
    invoke-interface {p4, p0, v6}, Lcom/android/server/notification/NotificationRecordLogger;->logNotificationVisibility(Lcom/android/server/notification/NotificationRecord;Z)V
