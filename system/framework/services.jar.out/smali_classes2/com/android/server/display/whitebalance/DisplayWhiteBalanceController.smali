...
.method public constructor <init>(Lcom/android/server/display/whitebalance/AmbientSensor$AmbientBrightnessSensor;Lcom/android/server/display/utils/AmbientFilter;Lcom/android/server/display/whitebalance/AmbientSensor$AmbientColorTemperatureSensor;Lcom/android/server/display/utils/AmbientFilter;Lcom/android/server/display/whitebalance/DisplayWhiteBalanceThrottler;[F[F[F[FFF[F[F[F[FFF[F[F[F[FZ)V
    ...
    .restart local v0    # "e":Ljava/lang/Exception;
    :goto_4
    const-string v4, "failed to create high light ambient brightness to bias spline."
    ...
    iput-object v4, v1, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;->mHighLightAmbientBrightnessToBiasSpline:Landroid/util/Spline$LinearSpline;
    ...
    invoke-virtual {v0, v4}, Landroid/util/Spline$LinearSpline;->interpolate(F)F
    ...
    :try_start_7
    invoke-direct {v0, v5, v4}, Landroid/util/Spline$LinearSpline;-><init>([F[F)V
    ...
    .restart local v0    # "e":Ljava/lang/Exception;
    :goto_6
    const-string v4, "failed to create strong high light ambient brightness to bias spline."
    ...
    iput-object v4, v1, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;->mHighLightAmbientBrightnessToBiasSplineStrong:Landroid/util/Spline$LinearSpline;
    ...
    iput-object v4, v1, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;->mLowLightAmbientBrightnessToBiasSpline:Landroid/util/Spline$LinearSpline;
    ...
    .line 305
    :goto_8
    iget-object v4, v1, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;->mLowLightAmbientBrightnessToBiasSplineStrong:Landroid/util/Spline$LinearSpline;

    if-eqz v4, :cond_a

    iget-object v4, v1, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;->mHighLightAmbientBrightnessToBiasSplineStrong:Landroid/util/Spline$LinearSpline;
    ...
    iput-object v4, v1, Lcom/android/server/display/whitebalance/DisplayWhiteBalanceController;->mLowLightAmbientBrightnessToBiasSplineStrong:Landroid/util/Spline$LinearSpline;
    ...
    :try_start_9
    invoke-direct {v0, v4, v2}, Landroid/util/Spline$LinearSpline;-><init>([F[F)V
