...
.method constructor <init>(Lcom/android/server/display/DisplayAdapter;Landroid/os/IBinder;Ljava/lang/String;Landroid/content/Context;)V
    ...
    .end local p1    # "displayAdapter":Lcom/android/server/display/DisplayAdapter;
    .end local p2    # "displayToken":Landroid/os/IBinder;
    .end local p3    # "uniqueId":Ljava/lang/String;
    .end local p4    # "context":Landroid/content/Context;
    .local v1, "displayAdapter":Lcom/android/server/display/DisplayAdapter;
...
.method public configureDisplaySizeLocked(Landroid/view/SurfaceControl$Transaction;)V
    ...
    :goto_2
    invoke-virtual {p0, p1, v1, v3}, Lcom/android/server/display/DisplayDevice;->setDisplaySizeLocked(Landroid/view/SurfaceControl$Transaction;II)V
...
.method public final setDisplaySizeLocked(Landroid/view/SurfaceControl$Transaction;II)V
    ...
    invoke-virtual {p1, v0, p2, p3}, Landroid/view/SurfaceControl$Transaction;->setDisplaySize(Landroid/os/IBinder;II)Landroid/view/SurfaceControl$Transaction;
