...
.method private static createHysteresisLevels(Lcom/android/server/display/config/Thresholds;III[F[F[FLandroid/content/res/Resources;Z)Lcom/android/server/display/config/HysteresisLevels;
    ...
    .line 319
    .local v2, "brighteningThresholds":Lcom/android/server/display/config/BrightnessThresholds;
    if-nez p0, :cond_1
    ...
    .line 327
    .local v1, "brighteningPair":Landroid/util/Pair;, "Landroid/util/Pair<[F[F>;"
    move v4, p1
    ...
    .end local v0    # "darkeningThresholds":Lcom/android/server/display/config/BrightnessThresholds;
    .local v3, "darkeningThresholds":Lcom/android/server/display/config/BrightnessThresholds;
    ...
    .line 334
    .local v0, "darkeningPair":Landroid/util/Pair;, "Landroid/util/Pair<[F[F>;"
    const/4 v4, 0x0
    ...
    .line 337
    .local v12, "brighteningMinThreshold":F
    if-eqz v3, :cond_3
    ...
    .line 340
    .local v11, "darkeningMinThreshold":F
    new-instance v6, Lcom/android/server/display/config/HysteresisLevels;
    ...
    invoke-direct/range {v6 .. v12}, Lcom/android/server/display/config/HysteresisLevels;-><init>([F[F[F[FFF)V
