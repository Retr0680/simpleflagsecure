...
.method getBrightnessClamperController(Landroid/os/Handler;Lcom/android/server/display/brightness/clamper/BrightnessClamperController$ClamperChangeListener;Lcom/android/server/display/brightness/clamper/BrightnessClamperController$DisplayDeviceData;Landroid/content/Context;Lcom/android/server/display/feature/DisplayManagerFlags;Landroid/hardware/SensorManager;F)Lcom/android/server/display/brightness/clamper/BrightnessClamperController;
    ...
    .line 3995
    new-instance v0, Lcom/android/server/display/brightness/clamper/BrightnessClamperController;
    ...
    .end local p2    # "clamperChangeListener":Lcom/android/server/display/brightness/clamper/BrightnessClamperController$ClamperChangeListener;
    .end local p3    # "data":Lcom/android/server/display/brightness/clamper/BrightnessClamperController$DisplayDeviceData;
    ...
    .end local p7    # "currentBrightness":F
    .local v1, "handler":Landroid/os/Handler;
    .local v2, "clamperChangeListener":Lcom/android/server/display/brightness/clamper/BrightnessClamperController$ClamperChangeListener;
    .local v3, "data":Lcom/android/server/display/brightness/clamper/BrightnessClamperController$DisplayDeviceData;
...
.method getBrightnessRangeController(Lcom/android/server/display/HighBrightnessModeController;Ljava/lang/Runnable;Lcom/android/server/display/DisplayDeviceConfig;Landroid/os/Handler;Lcom/android/server/display/feature/DisplayManagerFlags;Landroid/os/IBinder;Lcom/android/server/display/DisplayDeviceInfo;)Lcom/android/server/display/BrightnessRangeController;
    ...
    .line 3986
    new-instance v0, Lcom/android/server/display/BrightnessRangeController;
    ...
    .end local p1    # "hbmController":Lcom/android/server/display/HighBrightnessModeController;
    .end local p2    # "modeChangeCallback":Ljava/lang/Runnable;
    .end local p3    # "displayDeviceConfig":Lcom/android/server/display/DisplayDeviceConfig;
    .end local p4    # "handler":Landroid/os/Handler;
    .end local p5    # "flags":Lcom/android/server/display/feature/DisplayManagerFlags;
    .end local p6    # "displayToken":Landroid/os/IBinder;
    .end local p7    # "info":Lcom/android/server/display/DisplayDeviceInfo;
    .local v1, "hbmController":Lcom/android/server/display/HighBrightnessModeController;
    .local v2, "modeChangeCallback":Ljava/lang/Runnable;
    .local v3, "displayDeviceConfig":Lcom/android/server/display/DisplayDeviceConfig;
...
.method getDisplayPowerProximityStateController(Lcom/android/server/display/WakelockController;Lcom/android/server/display/DisplayDeviceConfig;Landroid/os/Looper;Ljava/lang/Runnable;ILandroid/hardware/SensorManager;)Lcom/android/server/display/DisplayPowerProximityStateController;
    ...
    .line 3912
    new-instance v0, Lcom/android/server/display/DisplayPowerProximityStateController;
    ...
    .local v6, "sensorManager":Landroid/hardware/SensorManager;
    invoke-direct/range {v0 .. v6}, Lcom/android/server/display/DisplayPowerProximityStateController;-><init>(Lcom/android/server/display/WakelockController;Lcom/android/server/display/DisplayDeviceConfig;Landroid/os/Looper;Ljava/lang/Runnable;ILandroid/hardware/SensorManager;)V
...
.method getHighBrightnessModeController(Landroid/os/Handler;IILandroid/os/IBinder;Ljava/lang/String;FFLcom/android/server/display/config/HighBrightnessModeData;Lcom/android/server/display/HighBrightnessModeController$HdrBrightnessDeviceConfig;Ljava/lang/Runnable;Lcom/android/server/display/HighBrightnessModeMetadata;Landroid/content/Context;)Lcom/android/server/display/HighBrightnessModeController;
    .locals 13
    .param p1, "handler"    # Landroid/os/Handler;
    .param p2, "width"    # I
    .param p3, "height"    # I
    ...
    .line 3977
    new-instance v0, Lcom/android/server/display/HighBrightnessModeController;
