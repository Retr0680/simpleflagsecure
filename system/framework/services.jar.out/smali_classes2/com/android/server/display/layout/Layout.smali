...
.method public createDefaultDisplayLocked(Landroid/view/DisplayAddress;Lcom/android/server/display/layout/DisplayIdProducer;)V
    ...
    .end local p1    # "address":Landroid/view/DisplayAddress;
    .end local p2    # "idProducer":Lcom/android/server/display/layout/DisplayIdProducer;
    .local v1, "address":Landroid/view/DisplayAddress;
    .local v5, "idProducer":Lcom/android/server/display/layout/DisplayIdProducer;
...
.method public createDisplayLocked(Landroid/view/DisplayAddress;ZZLjava/lang/String;Lcom/android/server/display/layout/DisplayIdProducer;ILandroid/view/DisplayAddress;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/display/layout/Layout;->getById(I)Lcom/android/server/display/layout/Layout$Display;
    ...
    .line 127
    .end local p4    # "displayGroupName":Ljava/lang/String;
    .local v5, "displayGroupName":Ljava/lang/String;
    :goto_0
    if-eqz v0, :cond_3
    ...
    invoke-interface {v13, v0}, Lcom/android/server/display/layout/DisplayIdProducer;->getId(Z)I

    move-result v3

    .line 143
    .local v3, "logicalDisplayId":I
    ...
    invoke-direct/range {v1 .. v12}, Lcom/android/server/display/layout/Layout$Display;-><init>(Landroid/view/DisplayAddress;IZLjava/lang/String;Ljava/lang/String;ILandroid/view/DisplayAddress;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/server/display/layout/Layout-IA;)V
    ...
    .end local v3    # "logicalDisplayId":I
    :cond_7
    move-object/from16 v13, p5
