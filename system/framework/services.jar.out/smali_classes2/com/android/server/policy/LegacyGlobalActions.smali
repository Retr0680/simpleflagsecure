...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/policy/WindowManagerPolicy$WindowManagerFuncs;Ljava/lang/Runnable;)V
    ...
    .line 150
    .local p1, "telephonyManager":Landroid/telephony/TelephonyManager;
    iget-object v1, p0, Lcom/android/server/policy/LegacyGlobalActions;->mPhoneStateListener:Landroid/telephony/PhoneStateListener;
    ...
    invoke-direct {v0, v2}, Lcom/android/internal/util/EmergencyAffordanceManager;-><init>(Landroid/content/Context;)V
...
.method private addUsersToMenu(Ljava/util/ArrayList;)V
    ...
    :cond_1
    :goto_2
    iget-object v5, v10, Landroid/content/pm/UserInfo;->iconPath:Ljava/lang/String;
    ...
    new-instance v5, Lcom/android/server/policy/LegacyGlobalActions$8;
...
.method private createDialog()Lcom/android/internal/globalactions/ActionsDialog;
    ...
    iput-object v0, v5, Lcom/android/server/policy/LegacyGlobalActions;->mItems:Ljava/util/ArrayList;
    ...
    .line 285
    const-string v8, "bugreport_in_power_menu"

    invoke-static {v6, v8, v4, v7}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 295
    const-string v6, "fw.power_user_switcher"
    ...
    .line 315
    .end local v2    # "i":I
    iget-object v2, v5, Lcom/android/server/policy/LegacyGlobalActions;->mEmergencyAffordanceManager:Lcom/android/internal/util/EmergencyAffordanceManager;
    ...
    iget-object v6, v5, Lcom/android/server/policy/LegacyGlobalActions;->mItems:Ljava/util/ArrayList;

    new-instance v7, Lcom/android/server/policy/LegacyGlobalActions$$ExternalSyntheticLambda0;

    invoke-direct {v7, p0}, Lcom/android/server/policy/LegacyGlobalActions$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V

    new-instance v8, Lcom/android/server/policy/LegacyGlobalActions$$ExternalSyntheticLambda1;

    invoke-direct {v8, p0}, Lcom/android/server/policy/LegacyGlobalActions$$ExternalSyntheticLambda1;-><init>(Lcom/android/server/policy/LegacyGlobalActions;)V

    invoke-direct {v2, v3, v6, v7, v8}, Lcom/android/internal/globalactions/ActionsAdapter;-><init>(Landroid/content/Context;Ljava/util/List;Ljava/util/function/BooleanSupplier;Ljava/util/function/BooleanSupplier;)V

    iput-object v2, v5, Lcom/android/server/policy/LegacyGlobalActions;->mAdapter:Lcom/android/internal/globalactions/ActionsAdapter;
    ...
    iget-object v3, v5, Lcom/android/server/policy/LegacyGlobalActions;->mAdapter:Lcom/android/internal/globalactions/ActionsAdapter;
    ...
    .line 327
    new-instance v6, Lcom/android/internal/globalactions/ActionsDialog;

    iget-object v7, v5, Lcom/android/server/policy/LegacyGlobalActions;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7, v2}, Lcom/android/internal/globalactions/ActionsDialog;-><init>(Landroid/content/Context;Lcom/android/internal/app/AlertController$AlertParams;)V

    .line 328
    .local v6, "dialog":Lcom/android/internal/globalactions/ActionsDialog;
    invoke-virtual {v6, v4}, Lcom/android/internal/globalactions/ActionsDialog;->setCanceledOnTouchOutside(Z)V

    .line 330
    invoke-virtual {v6}, Lcom/android/internal/globalactions/ActionsDialog;->getListView()Landroid/widget/ListView;
    ...
    .line 344
    invoke-virtual {v6}, Lcom/android/internal/globalactions/ActionsDialog;->getWindow()Landroid/view/Window;
    ...
    .line 348
    invoke-virtual {v6, p0}, Lcom/android/internal/globalactions/ActionsDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
