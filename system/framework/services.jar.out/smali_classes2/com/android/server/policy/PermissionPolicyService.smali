...
.method static bridge synthetic -$$Nest$fgetmActivityTaskManagerInternal(Lcom/android/server/policy/PermissionPolicyService;)Lcom/android/server/wm/ActivityTaskManagerInternal;
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/server/policy/PermissionPolicyService$Internal;-><init>(Lcom/android/server/policy/PermissionPolicyService;Lcom/android/server/policy/PermissionPolicyService-IA;)V
...
.method private resetAppOpPermissionsIfNotRequestedForUid(I)V
    ...
    .line 734
    invoke-static {v8, v0}, Lcom/android/server/policy/PermissionPolicyService;->getUserContext(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/Context;
    ...
    .line 736
    .local v9, "userPackageManager":Landroid/content/pm/PackageManager;
    ...
    .line 742
    .local v11, "requestedPermissions":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    array-length v2, v10
    ...
    .line 758
    .local v2, "appOpsManagerInternal":Landroid/app/AppOpsManagerInternal;
    iget-object v3, v1, Lcom/android/server/policy/PermissionPolicyService;->mAppOpPermissions:Ljava/util/List;
    ...
    .line 759
    .local v13, "appOpPermissionsSize":I
    const/4 v3, 0x0
    ...
    .line 762
    .local v15, "appOpPermission":Ljava/lang/String;
    ...
    invoke-virtual {v0, v3, v4, v5}, Landroid/app/AppOpsManager;->unsafeCheckOpRawNoThrow(IILjava/lang/String;)I

    move-result v12

    .line 768
    .local v12, "appOpMode":I
    if-eq v12, v6, :cond_5
    ...
    invoke-virtual {v2, v3, v4, v6, v0}, Landroid/app/AppOpsManagerInternal;->setUidModeFromPermissionPolicy(IIILcom/android/internal/app/IAppOpsCallback;)V

    .line 771
    move v0, v7

    iget-object v7, v1, Lcom/android/server/policy/PermissionPolicyService;->mAppOpsCallback:Lcom/android/internal/app/IAppOpsCallback;
    ...
    .end local v6    # "defaultAppOpMode":I
    .end local v17    # "appOpsManager":Landroid/app/AppOpsManager;
    .restart local v0    # "appOpsManager":Landroid/app/AppOpsManager;
    :cond_7
    move-object/from16 v17, v0
    ...
    .line 759
    .end local v0    # "appOpsManager":Landroid/app/AppOpsManager;
    .end local v15    # "appOpPermission":Ljava/lang/String;
    .restart local v17    # "appOpsManager":Landroid/app/AppOpsManager;
    :goto_5
    ...
    .line 738
    .end local v0    # "appOpsManager":Landroid/app/AppOpsManager;
    .end local v2    # "appOpsManagerInternal":Landroid/app/AppOpsManagerInternal;
    .end local v11    # "requestedPermissions":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/String;>;"
    .end local v13    # "appOpPermissionsSize":I
    :goto_6
    return-void

    .line 731
    .end local v8    # "context":Landroid/content/Context;
    .end local v9    # "userPackageManager":Landroid/content/pm/PackageManager;
...
.method public onStart()V
    ...
    iput-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    iput-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mPermissionManagerInternal:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;
    ...
    iput-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mActivityTaskManagerInternal:Lcom/android/server/wm/ActivityTaskManagerInternal;
    ...
    iget-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mPackageManagerInternal:Landroid/content/pm/PackageManagerInternal;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/PackageManagerInternal;->getPackageList(Landroid/content/pm/PackageManagerInternal$PackageListObserver;)Lcom/android/server/pm/PackageList;
    ...
    invoke-virtual {v0, v3}, Landroid/content/pm/PackageManager;->addOnPermissionsChangeListener(Landroid/content/pm/PackageManager$OnPermissionsChangedListener;)V
    ...
    iput-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mAppOpsCallback:Lcom/android/internal/app/IAppOpsCallback;

    .line 255
    iget-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mPermissionManagerInternal:Lcom/android/server/pm/permission/PermissionManagerServiceInternal;

    .line 256
    const/4 v3, 0x1

    invoke-interface {v0, v3}, Lcom/android/server/pm/permission/PermissionManagerServiceInternal;->getAllPermissionsWithProtection(I)Ljava/util/List;

    move-result-object v4

    .line 259
    .local v4, "dangerousPerms":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/PermissionInfo;>;"
    const/4 v5, -0x1
    ...
    invoke-interface {v2, v9, v6, v10}, Lcom/android/internal/app/IAppOpsService;->startWatchingMode(ILjava/lang/String;Lcom/android/internal/app/IAppOpsCallback;)V
    ...
    .line 266
    .restart local v0    # "numDangerousPerms":I
    ...
    invoke-interface {v2, v10, v6, v11}, Lcom/android/internal/app/IAppOpsService;->startWatchingMode(ILjava/lang/String;Lcom/android/internal/app/IAppOpsCallback;)V
    :try_end_0
    ...
    invoke-interface {v0, v7}, Lcom/android/server/pm/permission/PermissionManagerServiceInternal;->getAllPermissionsWithProtectionFlags(I)Ljava/util/List;

    move-result-object v7

    .line 283
    .local v7, "appOpPermissionInfos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/PermissionInfo;>;"
    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mAppOpPermissions:Ljava/util/List;
    ...
    .line 285
    .local v8, "appOpPermissionInfosSize":I
    const/4 v0, 0x0
    ...
    .line 288
    .local v10, "appOpPermissionInfo":Landroid/content/pm/PermissionInfo;
    iget-object v0, v10, Landroid/content/pm/PermissionInfo;->name:Ljava/lang/String;
    ...
    .line 300
    .local v11, "appOpCode":I
    if-eq v11, v5, :cond_4

    .line 301
    iget-object v0, p0, Lcom/android/server/policy/PermissionPolicyService;->mAppOpPermissions:Ljava/util/List;
    ...
    invoke-interface {v2, v11, v6, v0}, Lcom/android/internal/app/IAppOpsService;->startWatchingMode(ILjava/lang/String;Lcom/android/internal/app/IAppOpsCallback;)V
    :try_end_1
    ...
    invoke-static {v12, v1, v0}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    goto :goto_7

    .line 296
    .end local v0    # "e":Landroid/os/RemoteException;
    .end local v11    # "appOpCode":I
    :pswitch_0
    goto :goto_7
    ...
    .line 285
    .end local v10    # "appOpPermissionInfo":Landroid/content/pm/PermissionInfo;
    :cond_4
    :goto_7
    ...
    invoke-static {v1, v3}, Lcom/android/server/policy/PermissionPolicyService;->getUserContext(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/content/Context;
    ...
    invoke-direct {v0, v1, v3}, Landroid/permission/PermissionControllerManager;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    .line 378
    .local v0, "manager":Landroid/permission/PermissionControllerManager;
    invoke-static {}, Lcom/android/server/PermissionThread;->getHandler()Landroid/os/Handler;

    move-result-object v1

    new-instance v3, Lcom/android/server/policy/PermissionPolicyService$$ExternalSyntheticLambda1;

    invoke-direct {v3, v0}, Lcom/android/server/policy/PermissionPolicyService$$ExternalSyntheticLambda1;-><init>(Landroid/permission/PermissionControllerManager;)V
