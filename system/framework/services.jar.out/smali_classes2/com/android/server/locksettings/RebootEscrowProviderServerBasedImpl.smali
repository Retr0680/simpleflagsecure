...
.method private wrapEscrowKey([BLjavax/crypto/SecretKey;)[B
    ...
    .line 177
    .local v1, "serviceConnection":Lcom/android/server/locksettings/ResumeOnRebootServiceProvider$ResumeOnRebootServiceConnection;
    const/4 v0, 0x0
    ...
    .line 178
    const-string v2, "Failed to encrypt the reboot escrow key: resume on reboot server service is unavailable"
    ...
    .end local p1    # "escrowKeyBytes":[B
    .local v2, "escrowKeyBytes":[B
    ...
    .line 187
    .local p1, "serverEncryptedBlob":[B
    ...
    .line 190
    const-string v3, "Server encrypted reboot escrow key cannot be null"
