...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
    ...
    .line 135
    .local v4, "db":Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    .end local v4    # "db":Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    .line 139
    .restart local v4    # "db":Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    ...
    .line 144
    .local v13, "lockscreenCheckSessions":Lcom/android/server/locksettings/recoverablekeystore/storage/RemoteLockscreenValidationSessionStorage;
    :goto_0
    :try_start_1
    ...
    .line 155
    .local v7, "snapshotStorage":Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;
    nop
    ...
    .line 149
    .end local v7    # "snapshotStorage":Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverySnapshotStorage;
    ...
    invoke-direct {v2, v5, v3}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V
    ...
    .end local v0    # "e":Ljava/security/NoSuchAlgorithmException;
    .end local v4    # "db":Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    .end local v13    # "lockscreenCheckSessions":Lcom/android/server/locksettings/recoverablekeystore/storage/RemoteLockscreenValidationSessionStorage;
    :cond_1
    :goto_3
    sget-object v0, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->mInstance:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
    :try_end_2
...
.method public generateKeyWithMetadata(Ljava/lang/String;[B)Ljava/lang/String;
    ...
    .line 764
    .local v1, "encryptionKey":Lcom/android/server/locksettings/recoverablekeystore/PlatformEncryptionKey;
    nop
    ...
    .catch Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStorageException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .line 770
    invoke-direct {p0, v2, v3, v4}, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->getAlias(IILjava/lang/String;)Ljava/lang/String;

    move-result-object p2
    :try_end_2
    .catch Ljava/security/KeyStoreException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Ljava/security/InvalidKeyException; {:try_start_2 .. :try_end_2} :catch_0
    .catch Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStorageException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-direct {p2, v6, v0}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V

    throw p2

    .line 762
    .end local v1    # "encryptionKey":Lcom/android/server/locksettings/recoverablekeystore/PlatformEncryptionKey;
    .end local v4    # "alias":Ljava/lang/String;
    .end local v5    # "metadata":[B
    .local p1, "alias":Ljava/lang/String;
    .restart local p2    # "metadata":[B
    ...
    .line 763
    .local p1, "e":Lcom/android/server/locksettings/recoverablekeystore/InsecureUserException;
    new-instance p2, Landroid/os/ServiceSpecificException;
    ...
    invoke-direct {p2, v0, v1}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V

    throw p2

    .line 760
    .end local p1    # "e":Lcom/android/server/locksettings/recoverablekeystore/InsecureUserException;
    :goto_2
    nop
    ...
    .line 759
    .local p1, "e":Ljava/security/NoSuchAlgorithmException;
...
.method public importKeyWithMetadata(Ljava/lang/String;[B[B)Ljava/lang/String;
    ...
    .line 842
    invoke-direct {p0, v4, v5, v6}, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->getAlias(IILjava/lang/String;)Ljava/lang/String;
    ...
    .restart local v7    # "keyBytes":[B
    .restart local v8    # "metadata":[B
    .local p1, "e":Ljava/lang/Exception;
    :goto_0
    new-instance p2, Landroid/os/ServiceSpecificException;
    ...
    invoke-direct {p2, v1, p3}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p2, p3, v0}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V
...
.method initRecoveryService(Ljava/lang/String;[B)V
    ...
    invoke-direct {v1}, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->checkRecoverKeyStorePermission()V
    ...
    .local v5, "rootCertificateAlias":Ljava/lang/String;
    iget-object v0, v1, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;

    invoke-virtual {v0, v5}, Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;->isValidRootCertificateAlias(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->getActiveRootOfTrust(II)Ljava/lang/String;

    move-result-object v8

    .line 234
    .local v8, "activeRootAlias":Ljava/lang/String;
    ...
    const-string v6, "Root of trust for recovery agent + "

    invoke-virtual {v0, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v6, " is assigned for the first time to "
    ...
    invoke-virtual {v0, v3, v4, v5}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->setActiveRootOfTrust(IILjava/lang/String;)J

    move-result-wide v10

    .line 242
    .local v10, "updatedRows":J
    ...
    move-result-object v0
    :try_end_0
    .catch Lcom/android/server/locksettings/recoverablekeystore/certificate/CertParsingException; {:try_start_0 .. :try_end_0} :catch_4

    move-object v6, v0

    .line 254
    .local v6, "certXml":Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;
    nop

    .line 257
    move-wide/from16 v16, v12

    invoke-virtual {v6}, Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;->getSerial()J

    move-result-wide v12

    .line 258
    .local v12, "newSerial":J
    iget-object v0, v1, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;

    invoke-virtual {v0, v3, v4, v5}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->getRecoveryServiceCertSerial(IILjava/lang/String;)Ljava/lang/Long;

    move-result-object v18

    .line 259
    .local v18, "oldSerial":Ljava/lang/Long;
    if-eqz v18, :cond_3
    ...
    invoke-direct {v2, v7, v0}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V
    ...
    const-string v7, "Updating the certificate with the new serial number "
    ...
    .line 275
    invoke-virtual {v0, v5}, Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;->getRootCertificate(Ljava/lang/String;)Ljava/security/cert/X509Certificate;
    ...
    invoke-virtual {v0, v5}, Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;->getValidationDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    .line 279
    invoke-virtual {v6, v7, v15}, Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;->getRandomEndpointCert(Ljava/security/cert/X509Certificate;Ljava/util/Date;)Ljava/security/cert/CertPath;

    move-result-object v0
    :try_end_1
    .catch Lcom/android/server/locksettings/recoverablekeystore/certificate/CertValidationException; {:try_start_1 .. :try_end_1} :catch_3
    ...
    invoke-virtual {v0, v3, v4, v5, v2}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->setRecoveryServiceCertPath(IILjava/lang/String;Ljava/security/cert/CertPath;)J
    ...
    .line 290
    .local v19, "updatedCertPathRows":J
    cmp-long v0, v19, v16
    ...
    .local v21, "certPath":Ljava/security/cert/CertPath;
    :try_start_3
    ...
    .local v6, "newSerial":J
    .local v12, "certXml":Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;
    ...
    .line 293
    .local v22, "updatedCertSerialRows":J
    cmp-long v0, v22, v16
    ...
    invoke-virtual {v0, v3, v4}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->getSnapshotVersion(II)Ljava/lang/Long;
    ...
    invoke-virtual {v0, v3, v4, v2}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->setShouldCreateSnapshot(IIZ)J
    ...
    .line 315
    .end local v19    # "updatedCertPathRows":J
    .end local v22    # "updatedCertSerialRows":J
    :catch_0
    move-exception v0
    ...
    .line 304
    .restart local v19    # "updatedCertPathRows":J
    .restart local v22    # "updatedCertSerialRows":J
    :cond_4
    ...
    invoke-virtual {v0, v3, v4, v1, v2}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->setCounterId(IIJ)J

    move-result-wide v0

    .line 308
    .local v0, "updatedCounterIdRows":J
    cmp-long v2, v0, v16

    if-gez v2, :cond_5

    .line 309
    const-string v2, "Failed to set the counter id in the local DB."

    invoke-static {v9, v2}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 311
    .end local v0    # "updatedCounterIdRows":J
    .end local v22    # "updatedCertSerialRows":J
    :cond_5
    :goto_2
    goto :goto_3
    ...
    invoke-direct {v0, v14, v1}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V

    .end local v3    # "userId":I
    .end local v4    # "uid":I
    .end local v5    # "rootCertificateAlias":Ljava/lang/String;
    .end local v6    # "newSerial":J
    .end local v8    # "activeRootAlias":Ljava/lang/String;
    .end local v10    # "updatedRows":J
    .end local v12    # "certXml":Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;
    .end local v13    # "rootCert":Ljava/security/cert/X509Certificate;
    .end local v15    # "validationDate":Ljava/util/Date;
    .end local v18    # "oldSerial":Ljava/lang/Long;
    .end local v21    # "certPath":Ljava/security/cert/CertPath;
    ...
    .restart local v5    # "rootCertificateAlias":Ljava/lang/String;
    .local v6, "certXml":Lcom/android/server/locksettings/recoverablekeystore/certificate/CertXml;
    .restart local v7    # "rootCert":Ljava/security/cert/X509Certificate;
    .restart local v8    # "activeRootAlias":Ljava/lang/String;
    .restart local v10    # "updatedRows":J
    .local v12, "newSerial":J
    .restart local v15    # "validationDate":Ljava/util/Date;
    .restart local v18    # "oldSerial":Ljava/lang/Long;
    .restart local v21    # "certPath":Ljava/security/cert/CertPath;
    ...
    invoke-direct {v1, v9, v2}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v1, v2, v9}, Landroid/os/ServiceSpecificException;-><init>(ILjava/lang/String;)V
...
.method public lockScreenSecretAvailable(I[BI)V
    ...
    .end local p1    # "credentialType":I
    .end local p2    # "credential":[B
    .end local p3    # "userId":I
    .local v6, "userId":I
    .local v7, "credentialType":I
    .local v8, "credential":[B
    :try_start_1
    ...
    invoke-interface {v0, p1, v2, v3, p2}, Ljava/util/concurrent/ScheduledExecutorService;->schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/ScheduledFuture;
    :try_end_1
    ...
    .end local v7    # "credentialType":I
    .end local v8    # "credential":[B
    .restart local p1    # "credentialType":I
    .restart local p2    # "credential":[B
    ...
    .restart local v7    # "credentialType":I
    .restart local v8    # "credential":[B
    goto :goto_1
    ...
    .end local p1    # "e":Ljava/security/NoSuchAlgorithmException;
    goto :goto_0
...
.method public startRecoverySessionWithCertPath(Ljava/lang/String;Ljava/lang/String;Landroid/security/keystore/recovery/RecoveryCertPath;[B[BLjava/util/List;)[B
    ...
    .local v7, "rootCertificateAlias":Ljava/lang/String;
    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;
    ...
    .line 604
    .local v8, "certPath":Ljava/security/cert/CertPath;
    nop
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;->getValidationDate(Ljava/lang/String;)Ljava/util/Date;

    move-result-object v0

    .line 608
    .local v0, "validationDate":Ljava/util/Date;
    iget-object v4, p0, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->mTestCertHelper:Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;

    invoke-virtual {v4, v7}, Lcom/android/server/locksettings/recoverablekeystore/TestOnlyInsecureCertificateHelper;->getRootCertificate(Ljava/lang/String;)Ljava/security/cert/X509Certificate;

    move-result-object v4

    invoke-static {v4, v8, v0}, Lcom/android/server/locksettings/recoverablekeystore/certificate/CertUtils;->validateCertPath(Ljava/security/cert/X509Certificate;Ljava/security/cert/CertPath;Ljava/util/Date;)V
    :try_end_1
    .catch Lcom/android/server/locksettings/recoverablekeystore/certificate/CertValidationException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .end local v3    # "verifierPublicKey":[B
    .local v1, "verifierPublicKey":[B
    return-object v0

    .line 617
    .end local v1    # "verifierPublicKey":[B
    .restart local v0    # "verifierPublicKey":[B
    :cond_0
    move-object v1, v0

    .end local v0    # "verifierPublicKey":[B
    .restart local v1    # "verifierPublicKey":[B
    const-string v0, "Failed to encode verifierPublicKey"
    ...
    .line 611
    .local v0, "e":Lcom/android/server/locksettings/recoverablekeystore/certificate/CertValidationException;
    const-string v1, "Failed to validate the given cert path"
    ...
    .line 602
    .end local v0    # "e":Lcom/android/server/locksettings/recoverablekeystore/certificate/CertValidationException;
    .end local v8    # "certPath":Ljava/security/cert/CertPath;
    :catch_1
    move-exception v0
...
.method public declared-synchronized validateRemoteLockscreen([BLcom/android/server/locksettings/LockSettingsService;)Landroid/app/RemoteLockscreenValidationResult;
    ...
    :try_start_5
    invoke-static {v4}, Lcom/android/internal/widget/LockPatternUtils;->zeroize([B)V
