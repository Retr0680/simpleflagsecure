...
.method private processPendingLockoutsForFace(Ljava/util/List;)V
    ...
    .line 249
    .local v7, "sensorIds":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    ...
    .line 250
    .local v3, "prop":Landroid/hardware/face/FaceSensorPropertiesInternal;
    ...
    .line 251
    .end local v3    # "prop":Landroid/hardware/face/FaceSensorPropertiesInternal;
    goto :goto_0

    .line 253
    :cond_1
    new-instance v3, Lcom/android/server/locksettings/BiometricDeferredQueue$FaceResetLockoutTask;
    ...
    .end local p1    # "pendingResetLockouts":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;>;"
    .local v8, "pendingResetLockouts":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;>;"
    ...
    iput-object v3, p0, Lcom/android/server/locksettings/BiometricDeferredQueue;->mFaceResetLockoutTask:Lcom/android/server/locksettings/BiometricDeferredQueue$FaceResetLockoutTask;
    ...
    iget v9, v4, Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;->userId:I
    ...
    invoke-virtual {v5, v6, v9, v10}, Landroid/hardware/face/FaceManager;->generateChallenge(IILandroid/hardware/face/FaceManager$GenerateChallengeCallback;)V
    ...
    invoke-static {v5, v4, v9, v10}, Lcom/android/server/locksettings/BiometricDeferredQueue;->requestHatFromGatekeeperPassword(Lcom/android/server/locksettings/SyntheticPasswordManager;Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;J)[B
    ...
    iget v10, v4, Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;->userId:I

    invoke-virtual {v6, v9, v10, v5}, Landroid/hardware/face/FaceManager;->resetLockout(II[B)V
    ...
    .end local v7    # "sensorIds":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    .end local v8    # "pendingResetLockouts":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;>;"
    .restart local p1    # "pendingResetLockouts":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;>;"
    :cond_6
    move-object v8, p1

    .line 279
    .end local p1    # "pendingResetLockouts":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;>;"
    .restart local v8    # "pendingResetLockouts":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;>;"
    :cond_7
    return-void
.end method
...
.method private static requestHatFromGatekeeperPassword(Lcom/android/server/locksettings/SyntheticPasswordManager;Lcom/android/server/locksettings/BiometricDeferredQueue$UserAuthInfo;J)[B
    ...
    .end local p0    # "spManager":Lcom/android/server/locksettings/SyntheticPasswordManager;
    .end local p2    # "challenge":J
    .local v0, "spManager":Lcom/android/server/locksettings/SyntheticPasswordManager;
    ...
    .line 299
    .local p0, "response":Lcom/android/internal/widget/VerifyCredentialResponse;
    const/4 p2, 0x0

    const-string p3, "BiometricDeferredQueue"

    if-nez p0, :cond_0

    .line 300
    const-string v1, "VerifyChallenge failed, null response"
    ...
    const-string v2, "VerifyChallenge failed, response: "
