...
.method private handleScheduleNonStrongBiometricTimeout(I)V
    ...
    .line 300
    const-string v2, "There is an existing alarm for non-strong biometric fallback timeout, so do not re-schedule"
    ...
    .line 305
    const-string v2, "Schedule a new alarm for non-strong biometric fallback timeout"

    invoke-static {v1, v2}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 307
    :cond_2
    new-instance v9, Lcom/android/server/locksettings/LockSettingsStrongAuth$NonStrongBiometricTimeoutAlarmListener;

    invoke-direct {v9, p0, p1}, Lcom/android/server/locksettings/LockSettingsStrongAuth$NonStrongBiometricTimeoutAlarmListener;-><init>(Lcom/android/server/locksettings/LockSettingsStrongAuth;I)V
...
.method private rescheduleStrongAuthTimeoutAlarm(JI)V
    ...
    .line 265
    .end local v1    # "alarm":Lcom/android/server/locksettings/LockSettingsStrongAuth$StrongAuthTimeoutAlarmListener;
