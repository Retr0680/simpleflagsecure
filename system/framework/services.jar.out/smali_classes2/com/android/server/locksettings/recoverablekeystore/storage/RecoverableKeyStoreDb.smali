...
.method private getBytes(IILjava/lang/String;)[B
    ...
    const-string/jumbo v5, "user_id = ? AND uid = ?"
...
.method private getBytes(IILjava/lang/String;Ljava/lang/String;)[B
    ...
    const-string/jumbo v5, "root_alias"

    const-string v6, "_id"

    const-string/jumbo v7, "user_id"

    filled-new-array {v6, v7, v0, v5, v2}, [Ljava/lang/String;

    move-result-object v6

    .line 1139
    .local v6, "projection":[Ljava/lang/String;
    const-string/jumbo v7, "user_id = ? AND uid = ? AND root_alias = ?"
    ...
    .line 1160
    :try_start_1
    const-string v10, "RecoverableKeyStoreDb"

    sget-object v11, Ljava/util/Locale;->US:Ljava/util/Locale;

    const-string v12, "%d entries found for userId=%d uid=%d. Should only ever be 0 or 1."
...
.method public getAllKeys(III)Ljava/util/Map;
    ...
    .line 299
    .local v8, "nonce":[B
    const-string/jumbo v6, "wrapped_key"
    ...
    .line 315
    .local v10, "keyMetadata":[B
    :goto_1
    new-instance v7, Lcom/android/server/locksettings/recoverablekeystore/WrappedKey;

    move/from16 v11, p3

    invoke-direct/range {v7 .. v12}, Lcom/android/server/locksettings/recoverablekeystore/WrappedKey;-><init>([B[B[BII)V
    ...
    .end local v10    # "keyMetadata":[B
    .end local v12    # "recoveryStatus":I
    .end local v13    # "metadataIdx":I
    goto :goto_0
...
.method public getBadRemoteGuessCounter(I)I
    ...
    .line 416
    .local v1, "db":Landroid/database/sqlite/SQLiteDatabase;
    const-string v0, "bad_remote_guess_counter"
...
.method public getKey(ILjava/lang/String;)Lcom/android/server/locksettings/recoverablekeystore/WrappedKey;
    ...
    filled-new-array {v10, v11, p2}, [Ljava/lang/Object;
    ...
    .line 136
    .end local v0    # "count":I
    .end local v6    # "metadataIdx":I
    .end local v8    # "nonce":[B
    .end local v9    # "keyMaterial":[B
    .end local v10    # "keyMetadata":[B
    .end local v11    # "generationId":I
    .end local v12    # "recoveryStatus":I
    :goto_1
    if-eqz v2, :cond_3
...
.method public getRecoveryAgents(I)Ljava/util/List;
    ...
    .end local v7    # "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    :catchall_0
    move-exception v0
    ...
    .restart local v7    # "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    :cond_0
    nop
...
.method public getRecoverySecretTypes(II)[I
    ...
    const-string/jumbo v10, "secret_types"

    filled-new-array {v0, v3, v4, v10}, [Ljava/lang/String;
    ...
    const-string v10, "%d deviceId entries found for userId=%d uid=%d. Should only ever be 0 or 1."
    ...
    .line 733
    .local v10, "csv":Ljava/lang/String;
    ...
    invoke-static {v8, v14}, Landroid/util/Log;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_6
    ...
    .end local v7    # "count":I
    .end local v9    # "idx":I
    .end local v10    # "csv":Ljava/lang/String;
...
.method public getStatusForAllKeys(I)Ljava/util/Map;
    ...
    .line 223
    .local v0, "statuses":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    :goto_0
    invoke-interface {v2}, Landroid/database/Cursor;->moveToNext()Z
    ...
    .line 212
    .end local v0    # "statuses":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    :catchall_0
    move-exception v0
    ...
    .line 230
    .restart local v0    # "statuses":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Integer;>;"
    :cond_0
    nop
...
.method public getUserSerialNumbers()Ljava/util/Map;
    ...
    .line 366
    .local v6, "serialNumbers":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Ljava/lang/Long;>;"
    :goto_0
    invoke-interface {v2}, Landroid/database/Cursor;->moveToNext()Z
    ...
    .end local v10    # "serialNumber":J
    goto :goto_0

    .line 355
    .end local v6    # "serialNumbers":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Ljava/lang/Long;>;"
    :catchall_0
    move-exception v0
    ...
    .line 373
    .restart local v6    # "serialNumbers":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/Integer;Ljava/lang/Long;>;"
    :cond_0
    nop
...
.method public setCounterId(IIJ)J
    ...
    .end local p2    # "uid":I
    .end local p3    # "counterId":J
    .local v1, "userId":I
    .local v2, "uid":I
    .local v4, "counterId":J
...
.method public setRecoveryServiceCertPath(IILjava/lang/String;Ljava/security/cert/CertPath;)J
    ...
    .local v2, "userId":I
    .local v3, "uid":I
    .local v4, "rootAlias":Ljava/lang/String;
    ...
    .end local v3    # "uid":I
    .end local v4    # "rootAlias":Ljava/lang/String;
    .restart local p1    # "userId":I
    .restart local p2    # "uid":I
    .restart local p3    # "rootAlias":Ljava/lang/String;
    :cond_0
    move v2, p1
...
.method public setSnapshotVersion(IIJ)J
    ...
    .end local p1    # "userId":I
    .end local p2    # "uid":I
    .end local p3    # "snapshotVersion":J
    .local v1, "userId":I
    .local v2, "uid":I
    .local v4, "snapshotVersion":J
    invoke-direct/range {v0 .. v5}, Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;->setLong(IILjava/lang/String;J)J
