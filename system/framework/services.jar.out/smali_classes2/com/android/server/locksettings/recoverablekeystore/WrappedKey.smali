...
.method public constructor <init>([B[B[BI)V
    ...
    .end local p2    # "keyMaterial":[B
    .end local p3    # "keyMetadata":[B
    .end local p4    # "platformKeyGenerationId":I
    .local v1, "nonce":[B
    .local v2, "keyMaterial":[B
    .local v3, "keyMetadata":[B
    .local v4, "platformKeyGenerationId":I
...
.method public static fromSecretKey(Lcom/android/server/locksettings/recoverablekeystore/PlatformEncryptionKey;Ljavax/crypto/SecretKey;[B)Lcom/android/server/locksettings/recoverablekeystore/WrappedKey;
    ...
    .line 98
    .local v4, "encryptedKeyMaterial":[B
    nop
    ...
    .line 84
    .end local v4    # "encryptedKeyMaterial":[B
    ...
    .local p2, "e":Ljavax/crypto/IllegalBlockSizeException;
    invoke-virtual {p2}, Ljavax/crypto/IllegalBlockSizeException;->getCause()Ljava/lang/Throwable;
    ...
    check-cast v2, Ljava/security/KeyStoreException;
    ...
    const-string v3, "IllegalBlockSizeException should not be thrown by AES/GCM/NoPadding mode."

    invoke-direct {v2, v3, p2}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 76
    .restart local v5    # "metadata":[B
    .local p2, "e":Ljava/security/GeneralSecurityException;
    new-instance v0, Ljava/lang/RuntimeException;

    const-string v1, "Android does not support AES/GCM/NoPadding. This should never happen."
    ...
    const-string/jumbo v0, "key does not expose encoded material. It cannot be wrapped."
