...
.method public static build(IILjava/util/List;ILjava/util/List;Landroid/hardware/hdmi/DeviceFeatures;)Lcom/android/server/hdmi/HdmiCecMessage;
    ...
    .line 86
    .local v13, "deviceFeaturesBytes":[B
    array-length v3, v2
    ...
    invoke-static {v13, v1, v6, v3, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v15, v1}, Lcom/android/server/hdmi/ReportFeaturesMessage;->validateAddress(II)I

    move-result v19

    .line 93
    .local v19, "addressValidationResult":I
    if-eqz v19, :cond_3

    .line 94
    new-instance v14, Lcom/android/server/hdmi/HdmiCecMessage;
    ...
    .local v18, "params":[B
    invoke-direct/range {v14 .. v19}, Lcom/android/server/hdmi/HdmiCecMessage;-><init>(III[BI)V

    return-object v14

    .line 97
    .end local v18    # "params":[B
...
.method static build(II[B)Lcom/android/server/hdmi/HdmiCecMessage;
    ...
    .line 138
    .local v0, "invalidMessage":Ljava/util/function/Function;, "Ljava/util/function/Function<Ljava/lang/Integer;Lcom/android/server/hdmi/HdmiCecMessage;>;"
    ...
    invoke-static {p2, v2}, Lcom/android/server/hdmi/HdmiUtils;->getEndOfSequence([BI)I

    move-result v10

    .line 150
    .local v10, "rcProfileEnd":I
    const/4 v4, -0x1
    ...
    invoke-static {p2, v5}, Lcom/android/server/hdmi/HdmiUtils;->getEndOfSequence([BI)I

    move-result v11

    .line 155
    .local v11, "deviceFeaturesEnd":I
    if-ne v11, v4, :cond_3
    ...
    .line 159
    .local v2, "deviceFeaturesStart":I
    array-length v3, p2
    ...
    .line 160
    .local v3, "deviceFeaturesBytes":[B
    invoke-static {v3}, Landroid/hardware/hdmi/DeviceFeatures;->fromOperand([B)Landroid/hardware/hdmi/DeviceFeatures;
