...
.method private addDeviceLocked(III[Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;Landroid/media/midi/IMidiDeviceServer;Landroid/content/pm/ServiceInfo;ZIII)Landroid/media/midi/MidiDeviceInfo;
    ...
    const-string v4, "addDeviceLocked() "
    ...
    iget-object v2, v1, Lcom/android/server/midi/MidiService;->mDevicesByInfo:Ljava/util/HashMap;
    ...
    .line 1325
    iget v4, v1, Lcom/android/server/midi/MidiService;->mNextDeviceId:I

    add-int/lit8 v0, v4, 0x1

    iput v0, v1, Lcom/android/server/midi/MidiService;->mNextDeviceId:I
    ...
    .line 1332
    :try_start_0
    invoke-interface {v12, v3}, Landroid/media/midi/IMidiDeviceServer;->setDeviceInfo(Landroid/media/midi/MidiDeviceInfo;)V
    :try_end_0
    ...
    const-string v4, "RemoteException in setDeviceInfo()"
    ...
    invoke-virtual {v9, v4, v5}, Landroid/os/Bundle;->getParcelable(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 1344
    iget-object v4, v1, Lcom/android/server/midi/MidiService;->mBluetoothDevices:Ljava/util/HashMap;
    ...
    .line 1346
    invoke-virtual {v0, v3}, Lcom/android/server/midi/MidiService$Device;->setDeviceInfo(Landroid/media/midi/MidiDeviceInfo;)V
    ...
    .local v10, "device":Lcom/android/server/midi/MidiService$Device;
    .local v11, "bluetoothDevice":Landroid/bluetooth/BluetoothDevice;
    :goto_2
    if-nez v10, :cond_5
    ...
    .line 1352
    :goto_3
    iget-object v0, v1, Lcom/android/server/midi/MidiService;->mDevicesByInfo:Ljava/util/HashMap;
    ...
    .line 1354
    iget-object v0, v1, Lcom/android/server/midi/MidiService;->mBluetoothDevices:Ljava/util/HashMap;

    invoke-virtual {v0, v11, v10}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 1357
    :cond_6
    iget-object v2, v1, Lcom/android/server/midi/MidiService;->mClients:Ljava/util/HashMap;

    monitor-enter v2

    .line 1358
    :try_start_1
    iget-object v0, v1, Lcom/android/server/midi/MidiService;->mClients:Ljava/util/HashMap;
    ...
    check-cast v4, Lcom/android/server/midi/MidiService$Client;

    .line 1359
    .local v4, "c":Lcom/android/server/midi/MidiService$Client;
    invoke-virtual {v4, v10}, Lcom/android/server/midi/MidiService$Client;->deviceAdded(Lcom/android/server/midi/MidiService$Device;)V

    .line 1360
    .end local v4    # "c":Lcom/android/server/midi/MidiService$Client;
    goto :goto_4
    ...
    .end local v8    # "id":I
    .end local v10    # "device":Lcom/android/server/midi/MidiService$Device;
    .end local v11    # "bluetoothDevice":Landroid/bluetooth/BluetoothDevice;
    :cond_8
    move-object/from16 v9, p6
...
.method private addLegacyPackageDeviceServer(Landroid/content/pm/ServiceInfo;I)V
    ...
    const-string v3, "Skipping null service info"
    ...
    iget-object v3, v9, Landroid/content/pm/ServiceInfo;->permission:Ljava/lang/String;
    ...
    :cond_3
    :try_start_2
    iget-object v0, v1, Lcom/android/server/midi/MidiService;->mPackageManager:Landroid/content/pm/PackageManager;

    const-string v3, "android.media.midi.MidiDeviceService"

    invoke-virtual {v9, v0, v3}, Landroid/content/pm/ServiceInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    const-string/jumbo v2, "loading xml metadata failed"
    ...
    .line 1427
    .local v2, "numInputPorts":I
    const/4 v3, 0x0

    .line 1428
    .local v3, "numOutputPorts":I
    const/4 v4, 0x0
    ...
    .end local v2    # "numInputPorts":I
    .local v3, "numInputPorts":I
    .local v4, "numOutputPorts":I
    .local v5, "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .end local v5    # "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v7    # "properties":Landroid/os/Bundle;
    .end local v10    # "isPrivate":Z
    ...
    .restart local v3    # "numInputPorts":I
    .restart local v4    # "numOutputPorts":I
    .restart local v5    # "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v7    # "properties":Landroid/os/Bundle;
    .restart local v10    # "isPrivate":Z
    ...
    const-string/jumbo v11, "nested <device> elements in metadata for "
    ...
    .line 1445
    const-string/jumbo v6, "service_info"
    ...
    .line 1452
    invoke-interface {v14, v10}, Landroid/content/res/XmlResourceParser;->getAttributeName(I)Ljava/lang/String;

    move-result-object v11

    .line 1453
    .local v11, "name":Ljava/lang/String;
    invoke-interface {v14, v10}, Landroid/content/res/XmlResourceParser;->getAttributeValue(I)Ljava/lang/String;
    ...
    .local v10, "isPrivate":Z
    :cond_a
    const-string/jumbo v6, "input-port"
    ...
    const-string v11, "<input-port> outside of <device> in metadata for "
    ...
    .line 1469
    .local v6, "portName":Ljava/lang/String;
    invoke-interface {v14}, Landroid/content/res/XmlResourceParser;->getAttributeCount()I
    ...
    .end local v3    # "numInputPorts":I
    .end local v11    # "i":I
    .restart local v16    # "numInputPorts":I
    :goto_4
    ...
    .end local v6    # "portName":Ljava/lang/String;
    .end local v8    # "count":I
    goto :goto_7
    ...
    .restart local v3    # "numInputPorts":I
    :cond_e
    const-string/jumbo v6, "output-port"
    ...
    const-string v11, "<output-port> outside of <device> in metadata for "
    ...
    .line 1488
    .restart local v6    # "portName":Ljava/lang/String;
    invoke-interface {v14}, Landroid/content/res/XmlResourceParser;->getAttributeCount()I
    ...
    const-string v11, "<device> with no ports in metadata for "
    ...
    iget-object v8, v9, Landroid/content/pm/ServiceInfo;->packageName:Ljava/lang/String;

    const/4 v11, 0x0

    move/from16 v13, p2

    invoke-virtual {v0, v8, v11, v13}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    .line 1520
    :try_start_7
    iget-object v8, v1, Lcom/android/server/midi/MidiService;->mDevicesByInfo:Ljava/util/HashMap;
    ...
    sget-object v12, Lcom/android/server/midi/MidiService;->EMPTY_STRING_ARRAY:[Ljava/lang/String;
    ...
    .end local v5    # "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .local v16, "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .end local v16    # "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .end local v5    # "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v6    # "tagName":Ljava/lang/String;
    .restart local v16    # "outputPortNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    const-string v5, "could not fetch ApplicationInfo for "
    ...
    invoke-virtual {v9}, Landroid/content/pm/ServiceInfo;->toString()Ljava/lang/String;
...
.method private addUmpPackageDeviceServer(Landroid/content/pm/ServiceInfo;I)V
    ...
    invoke-virtual {v0, v3, v14}, Landroid/content/pm/PackageManager;->getProperty(Ljava/lang/String;Landroid/content/ComponentName;)Landroid/content/pm/PackageManager$Property;
    ...
    .line 1570
    .local v15, "property":Landroid/content/pm/PackageManager$Property;
    if-nez v15, :cond_5

    .line 1571
    const-string v0, "MidiService"

    const-string v3, "Getting MidiUmpDeviceService property failed"
    ...
    :cond_5
    :try_start_3
    invoke-virtual {v15}, Landroid/content/pm/PackageManager$Property;->getResourceId()I
    ...
    const-string v4, "Getting MidiUmpDeviceService resourceId failed"
    ...
    iget-object v4, v9, Landroid/content/pm/ServiceInfo;->packageName:Ljava/lang/String;
    ...
    const-string v6, "Getting resource failed "
    ...
    const-string v6, "Getting XML failed "
    ...
    .end local v0    # "properties":Landroid/os/Bundle;
    .local v3, "numPorts":I
    .local v5, "properties":Landroid/os/Bundle;
    .local v6, "resId":I
    .local v7, "portNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .local v10, "isPrivate":Z
    :goto_0
    ...
    .end local v5    # "properties":Landroid/os/Bundle;
    .end local v6    # "resId":I
    .end local v7    # "portNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .end local v8    # "eventType":I
    .end local v10    # "isPrivate":Z
    .end local v14    # "componentName":Landroid/content/ComponentName;
    .end local v15    # "property":Landroid/content/pm/PackageManager$Property;
    nop
    ...
    .restart local v5    # "properties":Landroid/os/Bundle;
    .restart local v6    # "resId":I
    .restart local v7    # "portNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    .restart local v8    # "eventType":I
    .restart local v10    # "isPrivate":Z
    .restart local v14    # "componentName":Landroid/content/ComponentName;
    .restart local v15    # "property":Landroid/content/pm/PackageManager$Property;
    :cond_c
    const/4 v0, 0x2
    ...
    .line 1604
    const-string v11, "MidiService"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "nested <device> elements in metadata for "
    ...
    .line 1609
    const-string/jumbo v11, "service_info"
    ...
    .line 1615
    invoke-interface {v2, v12}, Landroid/content/res/XmlResourceParser;->getAttributeName(I)Ljava/lang/String;

    move-result-object v13

    .line 1616
    .local v13, "name":Ljava/lang/String;
    invoke-interface {v2, v12}, Landroid/content/res/XmlResourceParser;->getAttributeValue(I)Ljava/lang/String;
    ...
    const-string v12, "<port> outside of <device> in metadata for "
    ...
    .line 1632
    .local v4, "portName":Ljava/lang/String;
    invoke-interface {v2}, Landroid/content/res/XmlResourceParser;->getAttributeCount()I
    ...
    .line 1623
    .end local v4    # "portName":Ljava/lang/String;
    .end local v11    # "count":I
    .end local v17    # "tagName":Ljava/lang/String;
    .restart local v0    # "tagName":Ljava/lang/String;
    :cond_14
    ...
    const-string v12, "<device> with no ports in metadata for "
    ...
    invoke-virtual {v0, v11, v12, v13}, Landroid/content/pm/PackageManager;->getApplicationInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    .line 1664
    :try_start_b
    iget-object v12, v1, Lcom/android/server/midi/MidiService;->mDevicesByInfo:Ljava/util/HashMap;
    ...
    .local v7, "properties":Landroid/os/Bundle;
    .local v16, "resId":I
    .local v19, "portNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .end local v18    # "resources":Landroid/content/res/Resources;
    .end local v19    # "portNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .restart local v18    # "resources":Landroid/content/res/Resources;
    .restart local v19    # "portNames":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
...
.method protected onUnhandledException(IILjava/lang/Exception;)V
    .locals 2
    .param p1, "code"    # I
    .param p2, "flags"    # I
    ...
    const-string v1, "Uncaught exception in AudioService: "
    ...
    invoke-static {v1, v0, p3}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public registerDeviceServer(Landroid/media/midi/IMidiDeviceServer;II[Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;II)Landroid/media/midi/MidiDeviceInfo;
    ...
    .line 1229
    :goto_1
    iget-object v14, p0, Lcom/android/server/midi/MidiService;->mDevicesByInfo:Ljava/util/HashMap;
